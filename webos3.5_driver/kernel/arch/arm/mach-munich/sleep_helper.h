...
#define SCU_A12_DATA_SIZE            4
#define L2_DATA_SIZE                 96
#define GLOBAL_TIMER_DATA_SIZE      128
#define A12_GENERIC_TIMER_DATA_SIZE 20
...
extern void save_a12_scu(appf_u32 *pointer);
extern void restore_a12_scu(appf_u32 *pointer);
extern void save_a12_generic_timer(appf_u32 *pointer);
extern void restore_a12_generic_timer(appf_u32 *pointer);
