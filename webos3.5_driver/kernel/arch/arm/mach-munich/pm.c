...
{
	// stephen add to measure booting time
//	unsigned int u32Timer_b0, u32Timer_b1, u32Timer_b2, u32Timer_b3, u32Timer_b4, u32Timer_b5;
	unsigned int u32Timer_b4;
#ifdef CONFIG_MSTAR_PORTING_KERNEL_4_4_3
	unsigned int u32Timer_p, u32Timer_c;
#else
	unsigned int u32Timer_p, u32Timer_b, u32Timer_c;
#endif /* CONFIG_MSTAR_PORTING_KERNEL_4_4_3 */
	//u32Timer_b1 = (*((volatile unsigned int *)0xFD206728)) | ((*((volatile unsigned int *)0xFD20672C)) << 16);
	//u32Timer_b2 = (*((volatile unsigned int *)0xFD206730)) | ((*((volatile unsigned int *)0xFD206734)) << 16);
	//u32Timer_b3 = (*((volatile unsigned int *)0xFD206748)) | ((*((volatile unsigned int *)0xFD20674C)) << 16);
	u32Timer_b4 = (*((volatile unsigned int *)0xFD206760)) | ((*((volatile unsigned int *)0xFD206764)) << 16);
	//printk("\033[0;31m[time] eMMC_LoadImages (HASH) takes %d.%03dms \033[0m\n", (u32Timer_b2 - u32Timer_b1)/12000, ((u32Timer_b2 - u32Timer_b1)/12)%1000);
	//printk("\033[0;31m[time] launch TEE - FastBootTEE takes %d.%03dms \033[0m\n", (u32Timer_b4 - u32Timer_b3)/12000, ((u32Timer_b4 - u32Timer_b3)/12)%1000);
	//u32Timer_b0 = ((u32Timer_b4) - ((u32Timer_b4 - u32Timer_b3) + (u32Timer_b2 - u32Timer_b1)));
        //printk("\033[0;31m[time] others (only access registers) takes %d.%03dms \033[0m\n", u32Timer_b0/12000, (u32Timer_b0/12)%1000);
	printk("\033[0;31m[time] total boot resume takes %d.%03dms \033[0m\n", u32Timer_b4/12000, (u32Timer_b4/12)%1000);
	//u32Timer_b5 = (*((volatile unsigned int *)0xFD206708)) | ((*((volatile unsigned int *)0xFD20670c)) << 16);
	//printk("\033[0;31m[time] tee memcpy takes %d.%03dms \033[0m\n", u32Timer_b5/12000, (u32Timer_b5/12)%1000);

	u32Timer_c = (*((volatile unsigned int *)0xFD006090)) | ((*((volatile unsigned int *)0xFD006094)) << 16);
	*(volatile unsigned int *)(0xFD001CE0) = u32Timer_c;
	*(volatile unsigned int *)(0xFD001CE4) = (u32Timer_c >> 16);
	u32Timer_p = (u32Timer_c - u32Timer_b4);
	*(volatile unsigned int *)(0xFD204130) = u32Timer_p;
	*(volatile unsigned int *)(0xFD204138) = (u32Timer_p >> 16);
}
#endif
