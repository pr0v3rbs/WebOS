...
#define ARM_MIU3_BASE_ADDR                     0xFFFFFFFF
      ...
      defined(CONFIG_MSTAR_MUNICH) || defined(CONFIG_MSTAR_MUSTANG)
...
#if defined(CONFIG_MSTAR_KENYA) || defined(CONFIG_MSTAR_AMBER1) || defined(CONFIG_MSTAR_KERES) || defined(CONFIG_MSTAR_NUGGET)
// in <include/mstar/mstar_chip.h>
#else
...
U32 MDrv_SYS_PCMCIA_WRITE(unsigned long arg);
U32 MDrv_SYS_PCMCIA_READ(unsigned long arg);
U32 MDrv_SYS_PCMCIA_WRITE_DATA(unsigned long arg);
U32 MDrv_SYS_PCMCIA_READ_DATA(unsigned long arg);
