...
MS_BOOL IDEnables[MIU_MAX_DEVICE][MIU_MAX_PROTECT_BLOCK][MIU_MAX_PROTECT_ID] = {{{0}}};
//MS_U8 IDs[MIU_MAX_DEVICE][MIU_MAX_PROTECT_ID] = {{0}, {0}, {0}}; //IDs for protection
MS_U8 IDs[MIU_MAX_DEVICE][MIU_MAX_PROTECT_ID] = {{0}};
                         ...
                         )
{
    ...
    if ( bSetFlag )
    {
        ...
        u16Data2 = u16Data2 | (MS_U16)((u32Start >> 29) << (u8Blockx*4));
        u16Data1 = u16Data3 | (MS_U16)(((u32End - 1) >> 29) << (u8Blockx*4+2)) | u16Data2;
