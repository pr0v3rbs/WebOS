...
void MHal_WOL_WritReg16( u32 xoffset, u16 xval )
{
    u32 address = 0xFD006800 + xoffset*2;
    *( ( volatile u16 * ) address ) = ( u16 ) ( xval & 0x0000FFFFUL );
}
...
void MHal_EMAC_Write_WOL_MAC_Address( u8 m0, u8 m1, u8 m2, u8 m3, u8 m4, u8 m5 )
{
    u16 w0 = ( u16 ) m4 << 8 | m5;
    u16 w1 = ( u16 ) m2 << 8 | m3;
    u16 w2 = ( u16 ) m0 << 8 | m1;
    MHal_WOL_WritReg16( 0x00000040, w0 );
    MHal_WOL_WritReg16( 0x00000042, w1 );
    MHal_WOL_WritReg16( 0x00000044, w2 );
}
