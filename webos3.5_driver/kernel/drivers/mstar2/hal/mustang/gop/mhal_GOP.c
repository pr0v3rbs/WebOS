...
B16 MHal_GOP_MaskIRQ( void )
{
    ...
    U16 u16GopMux;
    _HAL_GOP_Read16Reg(GOP_4G_INT, &u16GopMux);

    //u32RegVal = REG(REG_GOP_INT);
    //u16GopMux = u16GopMux|0x1;
    _HAL_GOP_Write16Reg(GOP_4G_INT,(u16GopMux|0x1),GOP_REG_WORD_MASK);
    //REG(REG_GOP_INT)=u32RegVal|0x1; // clear vs0 and vs1
