...
#undef REG_CHIP_NAND_MODE
#undef REG_CHIP_NAND_MODE_MASK
#define REG_CHIP_NAND_MODE						0x1EA0
	#define REG_CHIP_NAND_MODE_MASK				0x0380

#undef REG_CHIP_PCMCFG
#undef REG_CHIP_PCMCFG_MASK
#undef REG_CHIP_PCMCFG_CTRL_EN
...
#undef REG_SD_CONFIG2
#undef REG_SD_CONFIG2_MASK
#define REG_SD_CONFIG2                          0x1EAE
    #define REG_SD_CONFIG2_MASK                 0x0F00 //reg_sd_config & reg_sd_config2

#undef REG_EMMC_CONFIG
#undef REG_EMMC_CONFIG_MASK
#define REG_EMMC_CONFIG                         0x1EDC
    #define REG_EMMC_CONFIG_MASK                0x0040

#undef REG_EMMC_CONFIG2
#undef REG_EMMC_CONFIG2_MASK
#define REG_EMMC_CONFIG2                        0x1E3A
    #define REG_EMMC_CONFIG2_MASK               0x0100

#undef REG_CHIP_PCM_PE
#undef REG_CHIP_PCM_PE_MASK
#undef REG_CHIP_PCM_CTL_MASK
#undef REG_CHIP_PCM_PE1
#undef REG_CHIP_PCM_PE1_MASK
#undef REG_CHIP_PCM_D_PE
#undef REG_CHIP_PCM_D_PE_MASK
...
#undef REG_CHIP_PCM_NAND_BYPASS
#undef REG_CHIP_PCM_NAND_BYPASS_MASK
#undef REG_CHIP_PCM_NAND_BYPASS_ENABLE
#undef REG_CHIP_PCM_NAND_BYPASS_DISABLE
...
#undef ARM_MIU0_BUS_BASE
#undef ARM_MIU1_BUS_BASE
#undef ARM_MIU0_BASE
#undef ARM_MIU1_BASE
...
#undef ARM_MIU2_BUS_BASE
#undef ARM_MIU3_BUS_BASE
#undef ARM_MIU2_BASE
#undef ARM_MIU3_BASE
