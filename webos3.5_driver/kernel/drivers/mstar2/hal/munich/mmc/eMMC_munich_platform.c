...
extern U32 gu32_cmd23_t1, gu32_cmd23_t2,gu32_cmd23_t3;
extern U32 gu32_write_t1,gu32_write_t2,gu32_write_t3;
extern U32 gu32_read_t1,gu32_read_t2,gu32_read_t3;
...
irqreturn_t eMMC_FCIE_IRQ(int irq, void *dummy)
{
    ...
    if(u16_Events & BIT_DMA_END)
    {
        ...
        {
           if((g_eMMCDrv.u8_emmc_cmd ==24) || (g_eMMCDrv.u8_emmc_cmd ==25))
           {
               gu32_write_t2 +=  ((U32)jiffies_64 - gu32_write_t1);
           }
           else if((g_eMMCDrv.u8_emmc_cmd ==17) || (g_eMMCDrv.u8_emmc_cmd ==18))
           {
               gu32_read_t2 += ((U32)jiffies_64  - gu32_read_t1);
           }
        }
        fcie_int = 1;
        wake_up(&fcie_wait);
    ...
    else if(u16_Events & BIT_CMD_END)
    {
        ...
        if(gu32_eMMC_monitor_enable)
        {
            if(g_eMMCDrv.u8_emmc_cmd ==23)
                gu32_cmd23_t2 += ((U32)jiffies_64 -gu32_cmd23_t1);
        }
...
eMMC_ALIGN0 eMMC_DRIVER g_eMMCDrv_Bakup eMMC_ALIGN1;
static U32 sgu32_MemGuard1 = 0x1289;
eMMC_ALIGN0 eMMC_RESUME_RESP g_eMMC_resume_resp eMMC_ALIGN1;
eMMC_ALIGN0 U8 gau8_eMMC_SectorBuf[eMMC_SECTOR_BUF_16KB] eMMC_ALIGN1; //16K bytes
