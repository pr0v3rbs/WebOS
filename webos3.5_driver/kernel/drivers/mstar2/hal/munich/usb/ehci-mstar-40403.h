...
#ifndef _EHCI_MSTAR_40403_H
#define _EHCI_MSTAR_40403_H
...
#define PM_ADDR_USB(addr)           (*((volatile unsigned short*)(0xFD000000 + ((addr) << 1))))
#define REG_WR_USB(_reg_, _val_)        do{ PM_ADDR_USB(_reg_) = (_val_);  }while(0)
#define REG_RR_USB(_reg_)               ({ PM_ADDR_USB(_reg_);})
#define REG_PIU_TIMER0_USB(_x_)         (0x003020 | (_x_ << 1))
#endif
...
/* enable LEG user resume for M2 */
#define USB_LG_USERRESUME 1

#endif	/* _EHCI_MSTAR_40403_H */
