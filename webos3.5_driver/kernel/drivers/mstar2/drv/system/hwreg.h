...
#ifndef _HWREG_S4LE_H
#define _HWREG_S4LE_H
...
#define IRQ_AEON_1_REG_BASE                     0x0540  // 0x0540 - 0x057F
...
// FIXME for drvvop backward compatible
#define REG_CKG_AEON1DC0        REG_CKG_DC0
#define DC0_CLK_DISABLE         CKG_DC0_GATED
#define DC0_CLK_MASK            CKG_DC0_MASK
...
#define SVD_CLK_DISABLE         CKG_SVD_GATED   // for compatiable to S4
...
#define REG_MIU_MUX                 0x1E5A
    #define MIU_MUX_MASK                BITMASK(15:6)

    #define MIU_MUX_G07_MASK            BITMASK(7:6)
    #define MIU_MUX_G07_OD_LSB_R        (0 << 6)
    #define MIU_MUX_G07_GOP2_R          (1 << 6)

    #define MIU_MUX_G08_MASK            BITMASK(9:8)
    #define MIU_MUX_G08_OD_LSB_W        (0 << 8)
    #define MIU_MUX_G08_VE_W            (1 << 8)

    #define MIU_MUX_G15_MASK            BITMASK(11:10)
    #define MIU_MUX_G15_GOP2_R          (0 << 10)
    #define MIU_MUX_G15_OD_LSB_R        (1 << 10)

    #define MIU_MUX_G1A_MASK            BITMASK(13:12)
    #define MIU_MUX_G1A_VE_W            (0 << 12)
    #define MIU_MUX_G1A_OD_LSB_W        (1 << 12)

    #define MIU_MUX_G26_MASK            BITMASK(15:14)
    #define MIU_MUX_G26_RVD_RW          (0 << 14)
    #define MIU_MUX_G26_MVD_R           (1 << 14)
...
#define PM_VIF_DAC                              0x1CA0
#define PM_VIF_IF_TOP                           0x1C01
...
#if 1   //(USE_PM_SLEEP)
#define PM_OFF_FLAG                             (0x0E54) //(0x3C1E)  // U02(0x3C1C)  /U030x3C1E)
#else
...
//#define GOP_1G_VSTRCH_INI                   __ERIS_GOP_REG(7, 0x39)
//#define GOP_1G_RBLK0_VOFFL                  __ERIS_GOP_REG(7, 0x60)
//#define GOP_1G_RBLK0_VOFFH                  __ERIS_GOP_REG(7, 0x61)
//#define GOP_1G_RBLK1_VOFFL                  __ERIS_GOP_REG(7, 0x62)
//#define GOP_1G_RBLK1_VOFFH                  __ERIS_GOP_REG(7, 0x63)
//#define GOP_1G_RBLK2_VOFFL                  __ERIS_GOP_REG(7, 0x64)
//#define GOP_1G_RBLK2_VOFFH                  __ERIS_GOP_REG(7, 0x65)
//#define GOP_1G_RBLK3_VOFFL                  __ERIS_GOP_REG(7, 0x66)
//#define GOP_1G_RBLK3_VOFFH                  __ERIS_GOP_REG(7, 0x67)
//#define GOP_1G_RBLK0_HOFF                   __ERIS_GOP_REG(7, 0x70)
//#define GOP_1G_RBLK1_HOFF                   __ERIS_GOP_REG(7, 0x71)
//#define GOP_1G_RBLK2_HOFF                   __ERIS_GOP_REG(7, 0x72)
//#define GOP_1G_RBLK3_HOFF                   __ERIS_GOP_REG(7, 0x73)
//#define GOP_1G_REGDMA_EN                    __ERIS_GOP_REG(7, 0x78)
...
//#define GOP_1G_DRAM_VSTR_L(id)              __ERIS_GOP_REG(7, 0x4c)// 1+((id)/4), 0x0c+(0x20*((id)%4)))
//#define GOP_1G_DRAM_VSTR_H(id)              __ERIS_GOP_REG(7, 0x4d)// 1+((id)/4), 0x0d+(0x20*((id)%4)))
//#define GOP_1G_DRAM_HSTR(id)                __ERIS_GOP_REG(7, 0x4e)// 1+((id)/4), 0x0e+(0x20*((id)%4)))
//#define GOP_1G_DRAM_RBLK_SIZE_L(id)         __ERIS_GOP_REG(7, 0x50)// 1+((id)/4), 0x10+(0x20*((id)%4)))
//#define GOP_1G_DRAM_RBLK_SIZE_H(id)         __ERIS_GOP_REG(7, 0x51)// 1+((id)/4), 0x11+(0x20*((id)%4)))
//#define GOP_1G_DRAM_RLEN(id)                __ERIS_GOP_REG(7, 0x52)// 1+((id)/4), 0x12+(0x20*((id)%4)))
//#define GOP_1G_DRAM_HVSTOP_L(id)            __ERIS_GOP_REG(7, 0x54)// 1+((id)/4), 0x14+(0x20*((id)%4)))
//#define GOP_1G_DRAM_HVSTOP_H(id)            __ERIS_GOP_REG(7, 0x55)// 1+((id)/4), 0x15+(0x20*((id)%4)))
#define GOP_1G_DRAM_FADE(id)                __ERIS_GOP_REG(7, 0x56)// 1+((id)/4), 0x16+(0x20*((id)%4)))
//#define GOP_1G_BG_CLR(id)                   __ERIS_GOP_REG(7, 0x58)// 1+((id)/4), 0x18+(0x20*((id)%4)))
//#define GOP_1G_BG_HSTR(id)                  __ERIS_GOP_REG(7, 0x59)// 1+((id)/4), 0x19+(0x20*((id)%4)))
//#define GOP_1G_BG_HEND(id)                  __ERIS_GOP_REG(7, 0x5a)// 1+((id)/4), 0x1a+(0x20*((id)%4)))
//#define GOP_1G_BG_VSTR(id)                  __ERIS_GOP_REG(7, 0x5c)// 1+((id)/4), 0x1c+(0x20*((id)%4)))
//#define GOP_1G_BG_VEND(id)                  __ERIS_GOP_REG(7, 0x5d)// 1+((id)/4), 0x1d+(0x20*((id)%4)))
...
#if 1   // FIXME, SAR is moved to PM_SLEEP, remove later
//------------------------------------------------------------------------------
// SAR define
...
//DDC2BI for interrupt MASK
#define DDC2BI_INT_MASK                         0x0558
