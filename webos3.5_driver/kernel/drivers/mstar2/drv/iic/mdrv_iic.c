...
{
    {0, 217, 218, 4, 1}, // external demod, TCON6, TCON7
};
...
void MDrv_SW_IIC_SetSpeed(U8 u8ChIIC, U8 u8Speed)
{
    if( ((IIC_NUM_OF_HW > 0) && (u8ChIIC <= IIC_NUM_OF_HW)) || (u8ChIIC >= IIC_NUM_OF_MAX) )
    {
        return;
...
B16 MDrv_SW_IIC_ConfigBus(I2C_BusCfg_t* pBusCfg)
{
    ...
    if(((IIC_NUM_OF_HW > 0) && (pBusCfg->u8ChIdx <= IIC_NUM_OF_HW)) || (pBusCfg->u8ChIdx >= IIC_NUM_OF_MAX))
    {
