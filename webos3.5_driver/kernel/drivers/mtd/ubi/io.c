...
#if defined(CONFIG_MTD_UBI_WRITE_CALLBACK) && defined(CONFIG_MP_NAND_UBI)
...
#endif /* CONFIG_MTD_UBI_WRITE_CALLBACK && CONFIG_MP_NAND_UBI */
...
#if (defined(CONFIG_MSTAR_NAND) || defined(CONFIG_MSTAR_SPI_NAND)) && defined(CONFIG_MP_NAND_UBI)
		/*
...
#endif /* (CONFIG_MSTAR_NAND || CONFIG_MSTAR_SPI_NAND) && CONFIG_MP_NAND_UBI */
...
#ifdef CONFIG_MSTAR_PORTING_KERNEL_4_4_3
			ubi_err(ubi, "err(%d), retlen(%d), len(%d)", err, ops.retlen, ops.len);
#else
