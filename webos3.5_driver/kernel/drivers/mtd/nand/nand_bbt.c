...
#if ((defined(CONFIG_MSTAR_NAND) || defined(CONFIG_MSTAR_SPI_NAND)) && \
    defined(CONFIG_MP_NAND_MTD)) || defined(CONFIG_MTD_UBI_BACKUP_LSB)
#include <linux/crc32.h>
#ifdef CONFIG_MSTAR_NAND
#include "drvNAND.h"
#endif /* CONFIG_MSTAR_NAND */
#ifdef CONFIG_MSTAR_SPI_NAND
#include "spinand.h"
extern SPI_NAND_DRIVER_t gtSpiNandDrv;
#endif /* CONFIG_MSTAR_SPI_NAND */
#endif /* (CONFIG_MSTAR_NAND || CONFIG_MSTAR_SPI_NAND) && CONFIG_MP_NAND_MTD || CONFIG_MTD_UBI_BACKUP_LSB */
...
#if (defined(CONFIG_MSTAR_NAND) || defined(CONFIG_MSTAR_SPI_NAND)) && \
    (defined(CONFIG_MP_NAND_MTD) || defined(CONFIG_MP_NAND_BBT))
...
#endif /* (CONFIG_MSTAR_NAND || CONFIG_MSTAR_SPI_NAND) &&
          (CONFIG_MP_NAND_MTD || CONFIG_MP_NAND_BBT) */
...
#endif /* CONFIG_MTD_UBI_BACKUP_LSB */
#else
			 ...
			 size_t len)
{
	...
	int res, ret = 0;
#if defined(CONFIG_MSTAR_NAND)  && defined(CONFIG_MP_NAND_MTD)
	...
	ops.ooboffs = 0;
	ops.ooblen = mtd->oobsize;
#endif /* CONFIG_MSTAR_NAND  && CONFIG_MP_NAND_MTD */
...
#ifdef CONFIG_MP_NAND_BBT_SIZE
		if(bd->options & NAND_BBT_SCANASSIGNEDPAGES)
...
#endif /* CONFIG_MSTAR_PORTING_PLAT */
{
	...
	struct nand_bbt_descr *td = this->bbt_td;
	struct nand_bbt_descr *md = this->bbt_md;
#if defined(CONFIG_MSTAR_SPI_NAND) && defined(CONFIG_MP_NAND_MTD)
	int i;
#endif /* CONFIG_MSTAR_SPI_NAND && CONFIG_MP_NAND_MTD */
...
#if (defined(CONFIG_MSTAR_NAND) || defined(CONFIG_MSTAR_SPI_NAND)) && \
    defined(CONFIG_MP_NAND_MTD)
	this->bbt_crc = crc32(BBT_CRC32_INIT, this->bbt, (mtd->size >> (this->bbt_erase_shift + 2)));
#endif /* (CONFIG_MSTAR_NAND || CONFIG_MSTAR_SPI_NAND) && CONFIG_MP_NAND_MTD */
