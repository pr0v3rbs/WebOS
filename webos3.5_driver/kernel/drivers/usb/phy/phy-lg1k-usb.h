...
union usb2_mix_phy_ctrl {
	...
	struct usb2_phy_param_ctrl phy_param;
};
...
#define phy_param_offset(n, m) offsetof(struct usb##n##_phy_param_ctrl, usb##n##_phy_##m)
...
extern int lg1k_usbphy_set_reset_ctl_mask(struct usb_phy *phy, int on);
