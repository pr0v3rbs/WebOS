...
static int __ref kernel_init(void *unused)
{
...
#if !defined(CONFIG_MP_MSTAR_STR_BASE) && !defined(CONFIG_LG_SNAPSHOT_BOOT)
	free_initmem();
#endif /* !CONFIG_MP_MSTAR_STR_BASE && !CONFIG_LG_SNAPSHOT_BOOT */
	mark_rodata_ro();
    ...
    printk("\033[31m[Error]Function = %s, Line = %d, while using ARM chips and SPARSE_MEMORY, you need to enable CONFIG_HOLES_IN_ZONE\033[m\n", __PRETTY_FUNCTION__, __LINE__);
    printk("\033[31m[Error]Function = %s, Line = %d, while using ARM chips and SPARSE_MEMORY, you need to enable CONFIG_HOLES_IN_ZONE\033[m\n", __PRETTY_FUNCTION__, __LINE__);
#endif /* !defined(CONFIG_HOLES_IN_ZONE) && !defined(CONFIG_ARM64) */
#endif /* CONFIG_MP_SPARSE_MEM_ENABLE_HOLES_IN_ZONE_CHECK */
