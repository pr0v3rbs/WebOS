...
->SIZE_input_device_id #228 sizeof(struct input_device_id)	@
@ 0 "" 2
	.loc 1 94 0
...
->OFF_input_device_id_relbit #180 offsetof(struct input_device_id, relbit)	@
@ 0 "" 2
	.loc 1 102 0
@ 102 "scripts/mod/devicetable-offsets.c" 1
	
->OFF_input_device_id_absbit #184 offsetof(struct input_device_id, absbit)	@
@ 0 "" 2
	.loc 1 103 0
@ 103 "scripts/mod/devicetable-offsets.c" 1
	
->OFF_input_device_id_mscbit #192 offsetof(struct input_device_id, mscbit)	@
@ 0 "" 2
	.loc 1 104 0
@ 104 "scripts/mod/devicetable-offsets.c" 1
	
->OFF_input_device_id_ledbit #196 offsetof(struct input_device_id, ledbit)	@
@ 0 "" 2
	.loc 1 105 0
@ 105 "scripts/mod/devicetable-offsets.c" 1
	
->OFF_input_device_id_sndbit #200 offsetof(struct input_device_id, sndbit)	@
@ 0 "" 2
	.loc 1 106 0
@ 106 "scripts/mod/devicetable-offsets.c" 1
	
->OFF_input_device_id_ffbit #204 offsetof(struct input_device_id, ffbit)	@
@ 0 "" 2
	.loc 1 107 0
@ 107 "scripts/mod/devicetable-offsets.c" 1
	
->OFF_input_device_id_swbit #220 offsetof(struct input_device_id, swbit)	@
@ 0 "" 2
	.loc 1 109 0
