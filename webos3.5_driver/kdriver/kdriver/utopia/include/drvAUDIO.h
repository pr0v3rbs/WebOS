...
typedef struct
{
    MS_U8 u8Name[32]; /* PCM name (only 32 bytes, if change this length, must change u8Name of AUDIO_PCM_INFO_t as well!) */
    AUDIO_PCM_OPS_t tPcmOps;  /* PCM operators */
    AUDIO_PCM_CAPS_t tPcmCaps;  /* PCM operators */
    AUDIO_PCM_INFO_t *tPcmInfo; /* PCM information */
...
typedef struct
{
    ...
    MS_U8   g_u8Adec0R2CodeType;
    MS_U8   g_u8Adec1R2CodeType;
...
void MDrv_AUDIO_SetCaptureEnable(MS_BOOL bEnable, void * PCM_CB); // [LM14]
...
//=====================================================
void    MDrv_AUDIO_ARC_HWEN(MS_U8 arc_hwen); // [LM14]
void    MDrv_AUDIO_ARC_HWEN_BY_PORT(AUDIO_HDMI_INDEX_T hdmiIndex, MS_BOOL bOnOff);//[M2]
...
// [LM14]
MS_U32 MDrv_AUDIO_Decoded_Frame_Cnt(MS_BOOL);
