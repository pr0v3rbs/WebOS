...
typedef enum
{
    ...
    E_VDEC_EX_V2_USER_CMD_PTS_DISCONTINUE_AUTO_DETECT,
    E_VDEC_EX_V2_USER_CMD_SET_FRAMEBUFF2,               //Param: Addr and size for the second frame buffer
    ...
    E_VDEC_EX_V2_USER_CMD_SET_GST_TIMING,
    //E_VDEC_EX_V2_USER_CMD_DISABLE_DIVX,
    E_VDEC_EX_V2_USER_CMD_SET_PUSI_SETTING,
    ...
    E_VDEC_EX_V2_USER_CMD_GET_NEXT_DISP_FRAME_INFO_EXT,    //replace of E_VDEC_EX_USER_CMD_GET_FRAME_INFO_EX
    E_VDEC_EX_V2_USER_CMD_GET_VSYNC_BRIDGE_EXT_ADDR,       //get vsync bridge ext addr
    E_VDEC_EX_V2_USER_CMD_GET_IS_STR_RESUME,               //get str is resume or not
    E_VDEC_EX_V2_USER_CMD_GET_IS_STR,                      //get str case or not
    E_VDEC_EX_V2_USER_CMD_GET_IS_SEAMLESS_MODE,                // Report the current Decoder is running DS or not
    E_VDEC_EX_V2_USER_CMD_GET_GST_TIMING,
    E_VDEC_EX_V2_USER_CMD_IS_MORE_FRAME,
    E_VDEC_EX_V2_USER_CMD_GET_SIMPLE_FRAME,
    ...
    E_VDEC_EX_V2_USER_CMD_FORCE_START_NON_I_SLICE,       // Param: Force to start decode from non I slice, 0: disable, 1: enable

    E_VDEC_EX_V2_USER_CMD_HVD_TS_IN_BBU_MODE,
    E_VDEC_EX_V2_USER_CMD_MFCODEC_MODE,
    E_VDEC_EX_V2_USER_CMD_THUMBNAIL_MODE,
    E_VDEC_EX_V2_USER_CMD_ENABLE_SEAMLESS_MODE,
...
} VDEC_EX_V2_IapGnBufShareBWMode;
