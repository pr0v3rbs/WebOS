...
{
    E_HWI2C_VHIGH = 0, /// very high speed
    E_HWI2C_HIGH,      /// high speed
...
MS_BOOL MDrv_HWI2C_WriteBytes_Customer(MS_U16 u16SlaveCfg, MS_U32 uAddrCnt, MS_U8 *pRegAddr, MS_U32 uSize, MS_U8 *pData, HWI2C_PORT ePort, HWI2C_CLKSEL eClk);
...
MS_BOOL MDrv_HWI2C_ReadBytes_Customer(MS_U16 u16SlaveCfg, MS_U32 uAddrCnt, MS_U8 *pRegAddr, MS_U32 uSize, MS_U8 *pData, HWI2C_PORT ePort, HWI2C_CLKSEL eClk);
...
MS_BOOL MDrv_HWI2C_WriteBytes_U2K_CUST(MS_U16 u16SlaveCfg, MS_U32 uAddrCnt, MS_U8 *pRegAddr, MS_U32 uSize, MS_U8 *pData, HWI2C_PORT ePort, HWI2C_CLKSEL eClk);
MS_BOOL MDrv_HWI2C_ReadBytes_U2K(MS_U16 u16SlaveCfg, MS_U32 uAddrCnt, MS_U8 *pRegAddr, MS_U32 uSize, MS_U8 *pData);
MS_BOOL MDrv_HWI2C_ReadBytes_U2K_CUST(MS_U16 u16SlaveCfg, MS_U32 uAddrCnt, MS_U8 *pRegAddr, MS_U32 uSize, MS_U8 *pData, HWI2C_PORT ePort, HWI2C_CLKSEL eClk);
MS_BOOL MDrv_HWI2C_SelectPort_U2K(HWI2C_PORT ePort);
MS_BOOL MDrv_HWI2C_SetClk_U2K(HWI2C_CLKSEL eClk);
//MS_BOOL MDrv_HWI2C_WriteBytesP1_U2K(MS_U16 u16SlaveCfg, MS_U32 uAddrCnt, MS_U8 *pRegAddr, MS_U32 uSize, MS_U8 *pData);
//MS_BOOL MDrv_HWI2C_ReadBytesP1_U2K(MS_U16 u16SlaveCfg, MS_U32 uAddrCnt, MS_U8 *pRegAddr, MS_U32 uSize, MS_U8 *pData);
