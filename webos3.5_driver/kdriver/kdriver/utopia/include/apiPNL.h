...
INTERFACE void* pu32PNL_Kernel_Inst;
...
typedef enum
{
    ...
    E_PNL_4V2O,
    E_PNL_2V2O,
    E_PNL_VIDEO_OSD_CONFIG_MAX,
} E_PNL_VIDEO_OSD_CONFIG;

typedef enum
{
    E_PNL_1_DIVISIONMODE,
    E_PNL_2_DIVISIONMODE,
    E_PNL_4_DIVISIONMODE,
    E_PNL_8_DIVISIONMODE,
    E_PNL_DIVISIONMODE_CONFIG_MAX,
} E_PNL_DIVISIONMODE_CONFIG;
...
#define             MApi_PNL_Init(x, y) MApi_PNL_Init_Ex(x, y, (MSIF_Version){{ PNL_API_VERSION },});
#endif
...
MS_BOOL             MApi_PNL_Control_Preemphasis_Level(MS_BOOL bEnable, MS_U16 U16pre_emphasis_level);
...
//-------------------------------------------------------------------------------------------------
/// set video and OSD panel output config
/// @return APIPNL_Result
//-------------------------------------------------------------------------------------------------
