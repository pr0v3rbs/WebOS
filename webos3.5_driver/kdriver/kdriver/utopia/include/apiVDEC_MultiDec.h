...
#define AUTO_ASSIGN_FRAMEBUFFER  1//math
...
typedef enum
{
    ...
    /// PTS_DISCONTINUE.
    E_VDEC_EX_EVENT_PTS_DISCONTINUE    = VDEC_EX_BIT(17)
} VDEC_EX_EventFlag;
...
typedef enum
{
    E_VDEC_EX_DISPLAY_PATH_NONE = 0,//display by DIP
    E_VDEC_EX_DISPLAY_PATH_MVOP_MAIN,
...
typedef enum
{
    ...
    E_VDEC_EX_USER_CMD_PTS_DISCONTINUE_AUTO_DETECT,
    ...
    E_VDEC_EX_USER_CMD_SET_GST_TIMING,
    //E_VDEC_EX_USER_CMD_DISABLE_DIVX,
    E_VDEC_EX_USER_CMD_SET_PUSI_SETTING,
    ...
    E_VDEC_EX_USER_CMD_SET_MBX_PARAM,
    ...
    E_VDEC_EX_USER_CMD_GET_EVENT_FLAG,
    ...
    E_VDEC_EX_USER_CMD_GET_IS_STR_RESUME,               //get str is resume or not
    E_VDEC_EX_USER_CMD_GET_IS_STR,
    E_VDEC_EX_USER_CMD_GET_IS_SEAMLESS_MODE,                // Report the current Decoder is running DS or not
    E_VDEC_EX_USER_CMD_GET_GST_TIMING,
    ...
    E_VDEC_EX_USER_CMD_GET_SECURE_MODE,
    ...
    E_VDEC_EX_USER_CMD_FORCE_START_NON_I_SLICE,         // Param: Force to start decode from non I slice, 0: disable, 1: enable
    ...
    E_VDEC_EX_USER_CMD_ENABLE_SEAMLESS_MODE,
...
//define for storing mvop information for single mvop case
//designed for the GST mvop timing setting
typedef struct
{
    MS_U8 u8Interlace;
    MS_U16 u16HorSize;
