...
typedef MS_BOOL (*IOCTL_VBI_GETCOMPLETEVPS_DATA)(MS_U8*, MS_U32*);
typedef void    (*IOCTL_VBI_CC_SETVIDEOSTANDARD)(VBI_VIDEO_STANDARD);
...
{    
    ...
    IOCTL_VBI_GETCOMPLETEVPS_DATA              fpVBIGetCompleteVPSData;
