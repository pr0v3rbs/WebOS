...
typedef enum
{
    ...
    E_ACE_CMD_SETICC,
    E_ACE_CMD_SETIBC,
    E_ACE_CMD_SETBT2020_Colormetry,
...
typedef struct _stACE_SetBT2020_Colormetry
{
    XC_ACE_BT2020_TYPE eValue;
    MS_BOOL bReturn;
} stACE_SetBT2020_Colormetry,*pstACE_SetBT2020_Colormetry;
...
typedef struct _stACE_PicSetHSC
{
    MS_BOOL eWindow;
    MS_BOOL bUseYUVSpace;
    MS_U8 u8Contrast;
    MS_U8 u8Hue;
    MS_U8 u8Saturation;
} stACE_PicSetHSC,*pstACE_PicSetHSC;
