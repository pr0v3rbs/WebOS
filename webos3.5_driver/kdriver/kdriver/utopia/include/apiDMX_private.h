...
typedef DMX_FILTER_STATUS (*IOCTL_DMX_GET_CAP_EX)(char*, int, void*, int*);
...
// File-in API (Old)
typedef DMX_FILTER_STATUS (*IOCTL_DMX_FILE_START)(DMX_FILEIN_PATH, DMX_FILEIN_DST, MS_PHYADDR, MS_U32);
...
typedef DMX_FILTER_STATUS (*IOCTL_DMX_FILE_GET_READADDR)(DMX_FILEIN_PATH, MS_U32*);
...
typedef DMX_FILTER_STATUS (*IOCTL_DMX_TSO_SVQBUF_SET)(MS_U8, MS_PHYADDR, MS_U32);
...
typedef DMX_FILTER_STATUS (*IOCTL_DMX_SET_FWDBGPARAM)(MS_U32, MS_U32, MS_U32);
