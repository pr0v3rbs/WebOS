...
typedef MS_BOOL  (*IOCTL_MDrv_HWI2C_WriteBytes_CUST)(MS_U16 ,MS_U32 ,MS_U8 *,MS_U32 ,MS_U8 * , HWI2C_PORT ,HWI2C_CLKSEL );
...
typedef MS_BOOL  (*IOCTL_MDrv_HWI2C_ReadBytes_CUST)(MS_U16 ,MS_U32 ,MS_U8 *,MS_U32 ,MS_U8 * , HWI2C_PORT ,HWI2C_CLKSEL );
...
typedef struct _HWI2C_INSTANT_PRIVATE
{
    ...
    IOCTL_MDrv_HWI2C_WriteBytes_CUST    fpHWI2CWriteBytes_CUST ;
    IOCTL_MDrv_HWI2C_ReadByte          	fpHWI2CReadByte;
    IOCTL_MDrv_HWI2C_ReadBytes   		fpHWI2CReadBytes;
    IOCTL_MDrv_HWI2C_ReadBytes_CUST     fpHWI2CReadBytes_CUST;
