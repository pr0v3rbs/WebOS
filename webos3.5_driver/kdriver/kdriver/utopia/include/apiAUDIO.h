...
{
    void *pAudioAddr;
    MS_U32 u32AudioLoopCounts;
    MS_U32 u32AudioLength;
    MS_U8  u8AudioIsInfinite;
    MS_U32 u32AudioFileIndex;
    MS_U32 clip_dsp;
} AUDIO_FILE_PARAMS;
...
//============================================================
 ...
 MS_U8   MApi_Audio_Monitor(void);	//LG
...
//=============================================================
 ...
 void    MApi_AUDIO_ARC_HWEN(MS_BOOL arc_hwen);
...
// RM
 ...
 void    MApi_AUDIO_DmaReader_Init(PCM_OUTPUT_FORMAT* pSettings); // [LM14]
...
MS_U32 MApi_AUDIO_Decoded_Frame_Cnt(MS_BOOL);
...
//CLIP
void MApi_AUDIO_LoadAudioClip(MS_U32 , void *, MS_U32);
...
MS_BOOL MApi_AUDIO_SIF_SetModeSetup(MS_U8);
void MApi_AUDIO_SIF_SetHDEVMode(MS_U8);
MS_BOOL MApi_AUDIO_SIF_GetBandDetect(MS_U8, MS_U32 *);
MS_BOOL MApi_AUDIO_SIF_GetBandDetect_Amp(MS_U8, MS_U32 *);
MS_BOOL MApi_AUDIO_SIF_SetBandSetup(MS_U8);
MS_BOOL MApi_AUDIO_SIF_CheckAvailableSystem(MS_U8, MS_U8 *);
MS_BOOL MApi_AUDIO_SIF_CheckA2DK(MS_U8, MS_U8 *);
void MApi_AUDIO_CheckNicamDigital(MS_U8 *);
MS_BOOL MApi_AUDIO_SIF_GetSoundStandard(MS_U8 *);
void MApi_AUDIO_SIF_RedoSetStandard(void);
MS_BOOL MApi_AUDIO_SetBtscA2ThresholdLevel(MS_U16, MS_U16 *);
void MApi_AUDIO_SetThresholdType(THR_TBL_TYPE_C code *, MS_U8 ,  MS_U8 );
