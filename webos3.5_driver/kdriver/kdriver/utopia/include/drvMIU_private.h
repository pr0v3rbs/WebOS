...
typedef MS_BOOL (*IOCTL_MIU_GET_LOADING)(MS_U8, MS_U32*);
...
typedef MS_BOOL (*IOCTL_MIU_PROTECT)(MS_U8, MS_U8*, MS_U32, MS_U32, MS_BOOL);
...
typedef struct _MIU_INSTANT_PRIVATE
{
    ...
    IOCTL_MIU_GET_LOADING fpMIU_GetLoading;
...
MS_BOOL _MDrv_MIU_Protect(MS_U8 u8Blockx, MS_U8 *pu8ProtectId, MS_U32 u32Start, MS_U32 u32End, MS_BOOL  bSetFlag);
