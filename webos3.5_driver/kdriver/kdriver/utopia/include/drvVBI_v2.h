...
#ifndef __VBI_V2_H__
#define __VBI_V2_H__
typedef enum E_VBI_POOL_ID
{
    VBI_POOL_ID_VBI0 = 0,
    VBI_POOL_ID_VBI1 = 1,
} eVBIPoolID;

typedef enum E_VBI_IOCTL_OPT {
    ...
    MDrv_CMD_VBI_GetCompleteVPS_Data,   // 35
    MDrv_CMD_VBI_CC_SetVideoStandard,
    
    MDrv_CMD_DMX_TTX_RingBuffer_Reset,  
    MDrv_CMD_DMX_TTX_Init,
    MDrv_CMD_DMX_TTX_SetFilterID,
    MDrv_CMD_DMX_TTX_SetCB,             // 40
...
typedef struct _VBI_GET_COMPLETE_VPS_DATA
{
    MS_U8  pBuffer[VPS_PACKET_LEN];
    MS_U32 *length;
