...
typedef enum
{
    ...
    E_MVOP_CMD_SET_RESET_SETTING,        ////<0x117 Reset mvop setting from for exit.
    E_MVOP_CMD_SET_VDEC_SOURCE,          ////Set the mvop source to check dynamic mvop
    ...
    E_MVOP_CMD_GET_VDEC_SOURCE,                 ////Get the mvop source to check dynamic mvop
    E_MVOP_CMD_GET_OUTPUT_CFG,                  ////Get the mvop output cfg to check mvop setting.
} MVOP_Command;
