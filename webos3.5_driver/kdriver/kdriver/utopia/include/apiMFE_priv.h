...
typedef MS_BOOL (*IOCTL_MFE_SETVUI)(PVR_Info* mfe_Info);
typedef MS_BOOL (*IOCTL_MFE_GETPOWERSUPSPEND)(PVR_Info* mfe_Info, MS_U32 *pwr_bits);
typedef MS_BOOL (*IOCTL_MFE_CLEARPOWERSUPSPEND)(PVR_Info* mfe_Info);

typedef struct _MFE_INSTANCE_PRIVATE
{
    // instance variable
    ...
    IOCTL_MFE_GETPOWERSUPSPEND                  fpMFEGetPowerSuspend;
    IOCTL_MFE_CLEARPOWERSUPSPEND                fpMFEClearPowerSuspend;
}MFE_INSTANCE_PRIVATE;

typedef struct _MFE_RESOURCE_PRIVATE
{
...
MS_BOOL _MApi_MFE_GetConf_PowerSuspend(PVR_Info *mfe_Info,MS_U32 *pwr_bits);
