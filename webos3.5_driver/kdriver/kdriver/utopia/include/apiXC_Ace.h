...
INTERFACE void* pu32ACEInst ;
INTERFACE void* pu32ACE_Kernel_Inst ;
INTERFACE void* pu32ACE_Kernel_Inst_1 ;
...
//-------------------------------------------------------------------------------------------------
/// Set BT2020 Colormetry
/// @param  eValue                  \b IN: Indicates the Colormetry .
...
/// @param  u8Val                        \b IN: The value set to the color(0 ~ 32).
//-------------------------------------------------------------------------------------------------
