...
//================================================================
#define AUDIO_PCM_INFO_VERSION    4
...
typedef struct
{
    ...
    MS_U32 u32BigEndien; /* PCM endien, TRUE means Big Endien, FALSE means Little Endien */
...
typedef enum
{
    ...
    AU_DVB_STANDARD_DTSXLL,             //0x19
    AU_DVB_STANDARD_DTSHD_ADO,          //0x1A
    AU_DVB_STANDARD_MAX,
    ...
    AU_DEC_SYSTEM                       = 0x50,
    AU_SE_SYSTEM                        = 0x60,    //!!! IMPORTANT NOTE: 0x61 is used as AU_SE_SYSTEM_STR, dont use 0x61 anymore!!!
...
typedef enum
{
    ...
    AUDIO_PCM_CMD_BIGENDIEN, /* SET/GET */
...
typedef enum
{
    ...
    Sound_SET_PARAM_Ease_A_TargetCH,
    Sound_SET_PARAM_Ease_B_TargetCH,
...
typedef enum
{
    ...
    Sound_GET_PARAM_Curr_Ease_Gain_A,
    Sound_GET_PARAM_Curr_Ease_Gain_B,
