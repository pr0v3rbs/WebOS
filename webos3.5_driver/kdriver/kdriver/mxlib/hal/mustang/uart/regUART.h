...
#if defined(MCU_MIPS_4KE)
#define PIU_UART_VER                2
#endif

#if defined(MCU_MIPS_34K)
#define PIU_UART_VER                2
#endif

#if defined(MCU_MIPS_74K)
#define PIU_UART_VER                2
#endif

#if defined(MCU_ARM_CA53)
#define PIU_UART_VER                2
#endif
...
#define UART3_PIU_ADDR              0x1280
#define UART3_PIU_IRQ               E_INT_IRQ_UART3
...
#define UART_SEL_AEON_R2        0x0C //virtual, this does not exist, direct to secure-r2
...
#define CHIP_REG_FastUART                  (CHIP_REG_BASE+ (0x02*2))
    #define CHIP_FastUART_PAD_1            (BIT4)
	#define CHIP_FastUART_PAD_2            (BIT5)
	#define CHIP_FastUART_PAD_3            (BIT4|BIT5)
	#define CHIP_FastUART_PAD_MASK            (BIT4|BIT5)
#define CHIP_REG_FourthUART                  (CHIP_REG_BASE+ (0x02*2))
    #define CHIP_FourthUART_PAD_1            (BIT6)
	#define CHIP_FourthUART_PAD_2            (BIT7)
	#define CHIP_FourthUART_PAD_3            (BIT6|BIT7)
	#define CHIP_FourthUART_PAD_MASK            (BIT6|BIT7)
#define CHIP_REG_SecondUART                  (CHIP_REG_BASE+ (0x02*2) + 1)
...
#define CHIP_REG_ThirdUART                  (CHIP_REG_BASE+ (0x02*2) + 1)
    #define CHIP_ThirdUART_PAD_1            (BIT2)
	#define CHIP_ThirdUART_PAD_2            (BIT3)
	#define CHIP_ThirdUART_PAD_3            (BIT2|BIT3)
	#define CHIP_ThirdUART_PAD_MASK            (BIT2|BIT3)
