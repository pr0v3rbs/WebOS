...
static MS_U32 _gMIO_PM_MapBase = 0;
...
static void _HAL_PWM_VDBen_SW(PWM_ChNum index, MS_BOOL bSwitch)
{
	if(_gPWM_VDBen)
	{
		...
		switch(index)
        	...
        	case E_PWM_CH9:
		default:
				printf("[ERROR] No Support PWM%d in Miami Platform\n", (int)index);
				UNUSED(bSwitch);
		break;
		}
	}
...
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function   \b Name: MHAL_PWM_SetIOMapBase
...
void MHAL_PWM_SetIOMapBase(MS_U32 u32Base,MS_U32 u32Base1)
{
    ...
    _gMIO_PM_MapBase = u32Base1;
}

////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function   \b Name: MHAL_PWM_SetChipTopIOMapBase
...
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function   \b Name: MHAL_PWM_GetIOMapBase
...
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function   \b Name: MHAL_PWM_Init
...
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function  \b Name: MHAL_PWM_Oen
...
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function   \b Name : MHAL_PWM_UnitDiv
...
{
    UNUSED(u16DivPWM);
    printf("[ERROR] No Support PWM Clock Unit Divider in Miami Platform\n");
    return FALSE;
}

////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function   \b Name : MHAL_PWM_Period
...
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function   \b Name : MHAL_PWM_DutyCycle
...
MS_U32 MHAL_PWM_GetDutyCycle(PWM_ChNum index)
{
    ...
    switch(index)
    {
        ...
        case E_PWM_CH4:
            ...
            Duty_H = (HAL_PWM_ReadByte(REG_PWM4_DUTY_EXT) & BMASK(9:8)) >> 8;
            break;
        case E_PWM_CH5:
        case E_PWM_CH6:
        case E_PWM_CH7:
...
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function   \b Name : MHAL_PWM_Div
...
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function   \b Name : MHAL_PWM_Polarity
...
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function   \b Name : MHAL_PWM_VDBen
...
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function   \b Name : MHAL_PWM_Vrest
...
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function   \b Name : MHAL_PWM_DBen
...
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function   \b Name : MHAL_PWM_RstMux
...
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function   \b Name : MHAL_PWM_RstCnt
...
void MHAL_PWM_RstCnt(PWM_ChNum index, MS_U8 u8RstCntPWM)
{
	if( u8RstCntPWM & 0x10 )
	{
		printf("PWM%d Reset Count is too large\n", index);
	}
...
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function   \b Name : MHAL_PWM_BypassUnit
...
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function   \b Name : MHAL_PWM01_CntMode
...
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function   \b Name : MHAL_PWM23_CntMode
...
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function   \b Name : MHAL_PWM67_CntMode
...
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function   \b Name : MHAL_PWM_Shift
...
MS_BOOL MHAL_PWM_Set3D_DiffWaveform(PWM_ChNum index, MS_U8 u8WaveformIndex, MS_U32 u32Shift, MS_U32 u32Duty)
{
    ...
    {
        bReturn &= MHAL_PWM_Shift(index, u32Shift);
        MHAL_PWM_DutyCycle(index, u32Duty);
    }
    else
    {
        HAL_SUBBANK1;
...
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function   \b Name : MHAL_PWM_INV_3D_Flag
