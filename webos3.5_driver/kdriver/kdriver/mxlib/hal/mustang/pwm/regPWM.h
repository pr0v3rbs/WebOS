...
#define REG_PWM0_ForceShift     (0x35)  //bit6
#define REG_PWM1_ForceShift     (0x35)  //bit7
#define REG_PWM2_ForceShift     (0x35)  //bit8
#define REG_PWM3_ForceShift     (0x35)  //bit9
#define REG_PWM4_ForceShift     (0x35)  //bit10
