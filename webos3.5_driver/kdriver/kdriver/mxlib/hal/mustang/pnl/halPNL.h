...
#define PNL_SUPPORT_DEVICE_NUM	1
...
#define REG_CLKGEN0_4F_L            (REG_CHIPTOP_BASE + 0x9E)
...
#define REG_CLKGEN0_5B_L            (REG_CHIPTOP_BASE + 0xB6)
...
#define REG_CKG_ODCLK               REG_CLKGEN0_53_L
    ...
    #define CKG_ODCLK_MASK          (BIT(5) | BIT(4) | BIT(3) | BIT(2))
    #define CKG_ODCLK_CLK_SC_PLL    (0 << 2)
    #define CKG_ODCLK_CLK_LPLL_DIV2 (5 << 2)
...
#define REG_CKG_BT656               REG_CLKGEN0_53_L
    ...
    #define CKG_BT656_MASK          (BIT(13) | BIT(12) | BIT(11) | BIT(10))
    #define CKG_BT656_CLK_SC_PLL    (0 << 10)
    #define CKG_BT656_CLK_LPLL_DIV_2 (5 << 10)
    #define CKG_BT656_27M           (6 << 10)
    #define CKG_BT656_CLK_LPLL      (7 << 10)
...
typedef enum
{
    ...
    E_HALPNL_DEVICE1_XC_BANK_OFFSET    = 0
...
//**************MUNICH FOR LGE*************************//
#define MHal_PNL_MOD_Control_Vreg_Level(args...) 0
void MHal_PNL_SetModPattern(MS_BOOL b);
#define MHal_PNL_SetSkipInitFlag(args...)
#define MHal_PNL_DivisionModeConfig(args...)
#define MHal_PNL_VideoOSDConfig(args...)
#define MHal_PNL_OSDC_Init_Status(args...)
#define MHal_PNL_VBY1_Packer_Check(args...)
#define MHal_PNL_VB1_Video_Protect(args...)
#define MHal_PNL_MOD_Control_Preemphasis_Level(args...) 0
#define MHal_PNL_GetSkipInitFlag(args...) 0
//*****************************************************//
#ifdef __cplusplus
}
#endif
