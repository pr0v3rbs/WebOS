...
typedef enum
{
    ...
    E_PNL_SUPPORTED_LPLL_EXT_MAX,          //4
...
{
    24,           //E_PNL_SUPPORTED_LPLL_EXT_HS_LVDS_1CH_115to150MHz    NO.0
    24,           //E_PNL_SUPPORTED_LPLL_EXT_HS_LVDS_1CH_57to115MHz    NO.1
    24,           //E_PNL_SUPPORTED_LPLL_EXT_HS_LVDS_1CH_25to57MHz    NO.2
    24,           //E_PNL_SUPPORTED_LPLL_EXT_HS_LVDS_1CH_25to25MHz    NO.3
};
MS_U16 u16EXT_LoopDiv[E_PNL_SUPPORTED_LPLL_EXT_MAX]=
{
    14,           //E_PNL_SUPPORTED_LPLL_EXT_HS_LVDS_1CH_115to150MHz    NO.0
    28,           //E_PNL_SUPPORTED_LPLL_EXT_HS_LVDS_1CH_57to115MHz    NO.1
    56,           //E_PNL_SUPPORTED_LPLL_EXT_HS_LVDS_1CH_25to57MHz    NO.2
    56,           //E_PNL_SUPPORTED_LPLL_EXT_HS_LVDS_1CH_25to25MHz    NO.3
};
