...
// TCON Excel update date    : 2009/10/15 23:08
//****************************************************
...
//#define _PK_L_(bank, addr)     ((U16)(bank << 8) | (addr))
//#define _PK_H_(bank, addr)     ((U16)((bank|0x80) << 8) | (addr))
...
typedef enum
{
    ...
    TCON_SIGNAL_GCLK,
    TCON_SIGNAL_NUMS,
} E_TCON_POWER_SEQUENCE_SIGNAL_TYPE;
...
typedef enum
{
    TCON_TAB_LG42v5_Init_ALL,
    TCON_TAB_LG42v5_Init_NUMS
} E_TCON_LG42v5_Init_TYPE;

typedef enum
{
    TCON_TAB_LG42v5_Init_GPIO_ALL,
    TCON_TAB_LG42v5_Init_GPIO_NUMS
} E_TCON_LG42v5_Init_GPIO_TYPE;

typedef enum
{
    TCON_TAB_LG42v5_Init_SC_ALL,
    TCON_TAB_LG42v5_Init_SC_NUMS
} E_TCON_LG42v5_Init_SC_TYPE;

typedef enum
{
    TCON_TAB_LG42v5_Init_MOD_ALL,
    TCON_TAB_LG42v5_Init_MOD_NUMS
} E_TCON_LG42v5_Init_MOD_TYPE;

typedef enum
{
    TCON_TAB_LG42v5_Power_Sequence_On_ALL,
    TCON_TAB_LG42v5_Power_Sequence_On_Delay_Ready,
    TCON_TAB_LG42v5_Power_Sequence_On_Delay_Time,
    TCON_TAB_LG42v5_Power_Sequence_On_Signal_Type,
    TCON_TAB_LG42v5_Power_Sequence_On_NUMS
} E_TCON_LG42v5_Power_Sequence_On_TYPE;

typedef enum
{
    TCON_TAB_LG42v5_Power_Sequence_Off_ALL,
    TCON_TAB_LG42v5_Power_Sequence_Off_Delay_Ready,
    TCON_TAB_LG42v5_Power_Sequence_Off_Delay_Time,
    TCON_TAB_LG42v5_Power_Sequence_Off_Signal_Type,
    TCON_TAB_LG42v5_Power_Sequence_Off_NUMS
} E_TCON_LG42v5_Power_Sequence_Off_TYPE;

typedef enum
{
    TCON_TAB_LG47v5_Init_ALL,
    TCON_TAB_LG47v5_Init_NUMS
} E_TCON_LG47v5_Init_TYPE;

typedef enum
{
    TCON_TAB_LG47v5_Init_GPIO_ALL,
    TCON_TAB_LG47v5_Init_GPIO_NUMS
} E_TCON_LG47v5_Init_GPIO_TYPE;

typedef enum
{
    TCON_TAB_LG47v5_Init_SC_ALL,
    TCON_TAB_LG47v5_Init_SC_NUMS
} E_TCON_LG47v5_Init_SC_TYPE;

typedef enum
{
    TCON_TAB_LG47v5_Init_MOD_ALL,
    TCON_TAB_LG47v5_Init_MOD_NUMS
} E_TCON_LG47v5_Init_MOD_TYPE;

typedef enum
{
    TCON_TAB_LG47v5_Power_Sequence_On_ALL,
    TCON_TAB_LG47v5_Power_Sequence_On_Delay_Ready,
    TCON_TAB_LG47v5_Power_Sequence_On_Delay_Time,
    TCON_TAB_LG47v5_Power_Sequence_On_Signal_Type,
    TCON_TAB_LG47v5_Power_Sequence_On_NUMS
} E_TCON_LG47v5_Power_Sequence_On_TYPE;

typedef enum
{
    TCON_TAB_LG47v5_Power_Sequence_Off_ALL,
    TCON_TAB_LG47v5_Power_Sequence_Off_Delay_Ready,
    TCON_TAB_LG47v5_Power_Sequence_Off_Delay_Time,
    TCON_TAB_LG47v5_Power_Sequence_Off_Signal_Type,
    TCON_TAB_LG47v5_Power_Sequence_Off_NUMS
} E_TCON_LG47v5_Power_Sequence_Off_TYPE;

typedef enum
{
    TCON_TAB_LG47LTD_Init_ALL,
    TCON_TAB_LG47LTD_Init_NUMS
} E_TCON_LG47LTD_Init_TYPE;

typedef enum
{
    TCON_TAB_LG47LTD_Init_GPIO_ALL,
    TCON_TAB_LG47LTD_Init_GPIO_NUMS
} E_TCON_LG47LTD_Init_GPIO_TYPE;

typedef enum
{
    TCON_TAB_LG47LTD_Init_SC_ALL,
    TCON_TAB_LG47LTD_Init_SC_NUMS
} E_TCON_LG47LTD_Init_SC_TYPE;

typedef enum
{
    TCON_TAB_LG47LTD_Init_MOD_ALL,
    TCON_TAB_LG47LTD_Init_MOD_NUMS
} E_TCON_LG47LTD_Init_MOD_TYPE;

typedef enum
{
    TCON_TAB_LG47LTD_Power_Sequence_On_ALL,
    TCON_TAB_LG47LTD_Power_Sequence_On_Delay_Ready,
    TCON_TAB_LG47LTD_Power_Sequence_On_Delay_Time,
    TCON_TAB_LG47LTD_Power_Sequence_On_Signal_Type,
    TCON_TAB_LG47LTD_Power_Sequence_On_NUMS
} E_TCON_LG47LTD_Power_Sequence_On_TYPE;

typedef enum
{
    TCON_TAB_LG47LTD_Power_Sequence_Off_ALL,
    TCON_TAB_LG47LTD_Power_Sequence_Off_Delay_Ready,
    TCON_TAB_LG47LTD_Power_Sequence_Off_Delay_Time,
    TCON_TAB_LG47LTD_Power_Sequence_Off_Signal_Type,
    TCON_TAB_LG47LTD_Power_Sequence_Off_NUMS
} E_TCON_LG47LTD_Power_Sequence_Off_TYPE;
...
#define  REG_TC_SC_BK10_00_L       _PK_L_(0x10, 0x00)
#define  REG_TC_SC_BK10_00_H       _PK_H_(0x10, 0x00)
#define  REG_TC_SC_BK10_01_L       _PK_L_(0x10, 0x01)
#define  REG_TC_SC_BK10_01_H       _PK_H_(0x10, 0x01)
#define  REG_TC_SC_BK10_02_L       _PK_L_(0x10, 0x02)
#define  REG_TC_SC_BK10_02_H       _PK_H_(0x10, 0x02)
#define  REG_TC_SC_BK10_03_L       _PK_L_(0x10, 0x03)
#define  REG_TC_SC_BK10_03_H       _PK_H_(0x10, 0x03)
#define  REG_TC_SC_BK10_04_L       _PK_L_(0x10, 0x04)
#define  REG_TC_SC_BK10_04_H       _PK_H_(0x10, 0x04)
#define  REG_TC_SC_BK10_05_L       _PK_L_(0x10, 0x05)
#define  REG_TC_SC_BK10_05_H       _PK_H_(0x10, 0x05)
#define  REG_TC_SC_BK10_06_L       _PK_L_(0x10, 0x06)
#define  REG_TC_SC_BK10_06_H       _PK_H_(0x10, 0x06)
#define  REG_TC_SC_BK10_07_L       _PK_L_(0x10, 0x07)
#define  REG_TC_SC_BK10_07_H       _PK_H_(0x10, 0x07)
#define  REG_TC_SC_BK10_08_L       _PK_L_(0x10, 0x08)
#define  REG_TC_SC_BK10_08_H       _PK_H_(0x10, 0x08)
#define  REG_TC_SC_BK10_09_L       _PK_L_(0x10, 0x09)
#define  REG_TC_SC_BK10_09_H       _PK_H_(0x10, 0x09)
#define  REG_TC_SC_BK10_0A_L       _PK_L_(0x10, 0x0A)
#define  REG_TC_SC_BK10_0A_H       _PK_H_(0x10, 0x0A)
#define  REG_TC_SC_BK10_0B_L       _PK_L_(0x10, 0x0B)
#define  REG_TC_SC_BK10_0B_H       _PK_H_(0x10, 0x0B)
#define  REG_TC_SC_BK10_0C_L       _PK_L_(0x10, 0x0C)
#define  REG_TC_SC_BK10_0C_H       _PK_H_(0x10, 0x0C)
#define  REG_TC_SC_BK10_0D_L       _PK_L_(0x10, 0x0D)
#define  REG_TC_SC_BK10_0D_H       _PK_H_(0x10, 0x0D)
#define  REG_TC_SC_BK10_0E_L       _PK_L_(0x10, 0x0E)
#define  REG_TC_SC_BK10_0E_H       _PK_H_(0x10, 0x0E)
#define  REG_TC_SC_BK10_0F_L       _PK_L_(0x10, 0x0F)
#define  REG_TC_SC_BK10_0F_H       _PK_H_(0x10, 0x0F)
#define  REG_TC_SC_BK10_10_L       _PK_L_(0x10, 0x10)
#define  REG_TC_SC_BK10_10_H       _PK_H_(0x10, 0x10)
#define  REG_TC_SC_BK10_11_L       _PK_L_(0x10, 0x11)
#define  REG_TC_SC_BK10_11_H       _PK_H_(0x10, 0x11)
#define  REG_TC_SC_BK10_12_L       _PK_L_(0x10, 0x12)
#define  REG_TC_SC_BK10_12_H       _PK_H_(0x10, 0x12)
#define  REG_TC_SC_BK10_13_L       _PK_L_(0x10, 0x13)
#define  REG_TC_SC_BK10_13_H       _PK_H_(0x10, 0x13)
#define  REG_TC_SC_BK10_14_L       _PK_L_(0x10, 0x14)
#define  REG_TC_SC_BK10_14_H       _PK_H_(0x10, 0x14)
#define  REG_TC_SC_BK10_15_L       _PK_L_(0x10, 0x15)
#define  REG_TC_SC_BK10_15_H       _PK_H_(0x10, 0x15)
#define  REG_TC_SC_BK10_16_L       _PK_L_(0x10, 0x16)
#define  REG_TC_SC_BK10_16_H       _PK_H_(0x10, 0x16)
#define  REG_TC_SC_BK10_17_L       _PK_L_(0x10, 0x17)
#define  REG_TC_SC_BK10_17_H       _PK_H_(0x10, 0x17)
#define  REG_TC_SC_BK10_18_L       _PK_L_(0x10, 0x18)
#define  REG_TC_SC_BK10_18_H       _PK_H_(0x10, 0x18)
#define  REG_TC_SC_BK10_19_L       _PK_L_(0x10, 0x19)
#define  REG_TC_SC_BK10_19_H       _PK_H_(0x10, 0x19)
#define  REG_TC_SC_BK10_1A_L       _PK_L_(0x10, 0x1A)
#define  REG_TC_SC_BK10_1A_H       _PK_H_(0x10, 0x1A)
#define  REG_TC_SC_BK10_1B_L       _PK_L_(0x10, 0x1B)
#define  REG_TC_SC_BK10_1B_H       _PK_H_(0x10, 0x1B)
#define  REG_TC_SC_BK10_1C_L       _PK_L_(0x10, 0x1C)
#define  REG_TC_SC_BK10_1C_H       _PK_H_(0x10, 0x1C)
#define  REG_TC_SC_BK10_1D_L       _PK_L_(0x10, 0x1D)
#define  REG_TC_SC_BK10_1D_H       _PK_H_(0x10, 0x1D)
#define  REG_TC_SC_BK10_1E_L       _PK_L_(0x10, 0x1E)
#define  REG_TC_SC_BK10_1E_H       _PK_H_(0x10, 0x1E)
#define  REG_TC_SC_BK10_1F_L       _PK_L_(0x10, 0x1F)
#define  REG_TC_SC_BK10_1F_H       _PK_H_(0x10, 0x1F)
#define  REG_TC_SC_BK10_20_L       _PK_L_(0x10, 0x20)
#define  REG_TC_SC_BK10_20_H       _PK_H_(0x10, 0x20)
#define  REG_TC_SC_BK10_21_L       _PK_L_(0x10, 0x21)
#define  REG_TC_SC_BK10_21_H       _PK_H_(0x10, 0x21)
#define  REG_TC_SC_BK10_22_L       _PK_L_(0x10, 0x22)
#define  REG_TC_SC_BK10_22_H       _PK_H_(0x10, 0x22)
#define  REG_TC_SC_BK10_23_L       _PK_L_(0x10, 0x23)
#define  REG_TC_SC_BK10_23_H       _PK_H_(0x10, 0x23)
#define  REG_TC_SC_BK10_24_L       _PK_L_(0x10, 0x24)
#define  REG_TC_SC_BK10_24_H       _PK_H_(0x10, 0x24)
#define  REG_TC_SC_BK10_25_L       _PK_L_(0x10, 0x25)
#define  REG_TC_SC_BK10_25_H       _PK_H_(0x10, 0x25)
#define  REG_TC_SC_BK10_26_L       _PK_L_(0x10, 0x26)
#define  REG_TC_SC_BK10_26_H       _PK_H_(0x10, 0x26)
#define  REG_TC_SC_BK10_27_L       _PK_L_(0x10, 0x27)
#define  REG_TC_SC_BK10_27_H       _PK_H_(0x10, 0x27)
#define  REG_TC_SC_BK10_28_L       _PK_L_(0x10, 0x28)
#define  REG_TC_SC_BK10_28_H       _PK_H_(0x10, 0x28)
#define  REG_TC_SC_BK10_29_L       _PK_L_(0x10, 0x29)
#define  REG_TC_SC_BK10_29_H       _PK_H_(0x10, 0x29)
#define  REG_TC_SC_BK10_2A_L       _PK_L_(0x10, 0x2A)
#define  REG_TC_SC_BK10_2A_H       _PK_H_(0x10, 0x2A)
#define  REG_TC_SC_BK10_2B_L       _PK_L_(0x10, 0x2B)
#define  REG_TC_SC_BK10_2B_H       _PK_H_(0x10, 0x2B)
#define  REG_TC_SC_BK10_2C_L       _PK_L_(0x10, 0x2C)
#define  REG_TC_SC_BK10_2C_H       _PK_H_(0x10, 0x2C)
#define  REG_TC_SC_BK10_2D_L       _PK_L_(0x10, 0x2D)
#define  REG_TC_SC_BK10_2D_H       _PK_H_(0x10, 0x2D)
#define  REG_TC_SC_BK10_2E_L       _PK_L_(0x10, 0x2E)
#define  REG_TC_SC_BK10_2E_H       _PK_H_(0x10, 0x2E)
#define  REG_TC_SC_BK10_2F_L       _PK_L_(0x10, 0x2F)
#define  REG_TC_SC_BK10_2F_H       _PK_H_(0x10, 0x2F)
#define  REG_TC_SC_BK10_30_L       _PK_L_(0x10, 0x30)
#define  REG_TC_SC_BK10_30_H       _PK_H_(0x10, 0x30)
#define  REG_TC_SC_BK10_31_L       _PK_L_(0x10, 0x31)
#define  REG_TC_SC_BK10_31_H       _PK_H_(0x10, 0x31)
#define  REG_TC_SC_BK10_32_L       _PK_L_(0x10, 0x32)
#define  REG_TC_SC_BK10_32_H       _PK_H_(0x10, 0x32)
#define  REG_TC_SC_BK10_33_L       _PK_L_(0x10, 0x33)
#define  REG_TC_SC_BK10_33_H       _PK_H_(0x10, 0x33)
#define  REG_TC_SC_BK10_34_L       _PK_L_(0x10, 0x34)
#define  REG_TC_SC_BK10_34_H       _PK_H_(0x10, 0x34)
#define  REG_TC_SC_BK10_35_L       _PK_L_(0x10, 0x35)
#define  REG_TC_SC_BK10_35_H       _PK_H_(0x10, 0x35)
#define  REG_TC_SC_BK10_36_L       _PK_L_(0x10, 0x36)
#define  REG_TC_SC_BK10_36_H       _PK_H_(0x10, 0x36)
#define  REG_TC_SC_BK10_37_L       _PK_L_(0x10, 0x37)
#define  REG_TC_SC_BK10_37_H       _PK_H_(0x10, 0x37)
#define  REG_TC_SC_BK10_38_L       _PK_L_(0x10, 0x38)
#define  REG_TC_SC_BK10_38_H       _PK_H_(0x10, 0x38)
#define  REG_TC_SC_BK10_39_L       _PK_L_(0x10, 0x39)
#define  REG_TC_SC_BK10_39_H       _PK_H_(0x10, 0x39)
#define  REG_TC_SC_BK10_3A_L       _PK_L_(0x10, 0x3A)
#define  REG_TC_SC_BK10_3A_H       _PK_H_(0x10, 0x3A)
#define  REG_TC_SC_BK10_3B_L       _PK_L_(0x10, 0x3B)
#define  REG_TC_SC_BK10_3B_H       _PK_H_(0x10, 0x3B)
#define  REG_TC_SC_BK10_3C_L       _PK_L_(0x10, 0x3C)
#define  REG_TC_SC_BK10_3C_H       _PK_H_(0x10, 0x3C)
#define  REG_TC_SC_BK10_3D_L       _PK_L_(0x10, 0x3D)
#define  REG_TC_SC_BK10_3D_H       _PK_H_(0x10, 0x3D)
#define  REG_TC_SC_BK10_3E_L       _PK_L_(0x10, 0x3E)
#define  REG_TC_SC_BK10_3E_H       _PK_H_(0x10, 0x3E)
#define  REG_TC_SC_BK10_3F_L       _PK_L_(0x10, 0x3F)
#define  REG_TC_SC_BK10_3F_H       _PK_H_(0x10, 0x3F)
#define  REG_TC_SC_BK10_40_L       _PK_L_(0x10, 0x40)
#define  REG_TC_SC_BK10_40_H       _PK_H_(0x10, 0x40)
#define  REG_TC_SC_BK10_41_L       _PK_L_(0x10, 0x41)
#define  REG_TC_SC_BK10_41_H       _PK_H_(0x10, 0x41)
#define  REG_TC_SC_BK10_42_L       _PK_L_(0x10, 0x42)
#define  REG_TC_SC_BK10_42_H       _PK_H_(0x10, 0x42)
#define  REG_TC_SC_BK10_43_L       _PK_L_(0x10, 0x43)
#define  REG_TC_SC_BK10_43_H       _PK_H_(0x10, 0x43)
#define  REG_TC_SC_BK10_44_L       _PK_L_(0x10, 0x44)
#define  REG_TC_SC_BK10_44_H       _PK_H_(0x10, 0x44)
#define  REG_TC_SC_BK10_45_L       _PK_L_(0x10, 0x45)
#define  REG_TC_SC_BK10_45_H       _PK_H_(0x10, 0x45)
#define  REG_TC_SC_BK10_46_L       _PK_L_(0x10, 0x46)
#define  REG_TC_SC_BK10_46_H       _PK_H_(0x10, 0x46)
#define  REG_TC_SC_BK10_47_L       _PK_L_(0x10, 0x47)
#define  REG_TC_SC_BK10_47_H       _PK_H_(0x10, 0x47)
#define  REG_TC_SC_BK10_48_L       _PK_L_(0x10, 0x48)
#define  REG_TC_SC_BK10_48_H       _PK_H_(0x10, 0x48)
#define  REG_TC_SC_BK10_49_L       _PK_L_(0x10, 0x49)
#define  REG_TC_SC_BK10_49_H       _PK_H_(0x10, 0x49)
#define  REG_TC_SC_BK10_4A_L       _PK_L_(0x10, 0x4A)
#define  REG_TC_SC_BK10_4A_H       _PK_H_(0x10, 0x4A)
#define  REG_TC_SC_BK10_4B_L       _PK_L_(0x10, 0x4B)
#define  REG_TC_SC_BK10_4B_H       _PK_H_(0x10, 0x4B)
#define  REG_TC_SC_BK10_4C_L       _PK_L_(0x10, 0x4C)
#define  REG_TC_SC_BK10_4C_H       _PK_H_(0x10, 0x4C)
#define  REG_TC_SC_BK10_4D_L       _PK_L_(0x10, 0x4D)
#define  REG_TC_SC_BK10_4D_H       _PK_H_(0x10, 0x4D)
#define  REG_TC_SC_BK10_4E_L       _PK_L_(0x10, 0x4E)
#define  REG_TC_SC_BK10_4E_H       _PK_H_(0x10, 0x4E)
#define  REG_TC_SC_BK10_4F_L       _PK_L_(0x10, 0x4F)
#define  REG_TC_SC_BK10_4F_H       _PK_H_(0x10, 0x4F)
#define  REG_TC_SC_BK10_50_L       _PK_L_(0x10, 0x50)
#define  REG_TC_SC_BK10_50_H       _PK_H_(0x10, 0x50)
#define  REG_TC_SC_BK10_51_L       _PK_L_(0x10, 0x51)
#define  REG_TC_SC_BK10_51_H       _PK_H_(0x10, 0x51)
#define  REG_TC_SC_BK10_52_L       _PK_L_(0x10, 0x52)
#define  REG_TC_SC_BK10_52_H       _PK_H_(0x10, 0x52)
#define  REG_TC_SC_BK10_53_L       _PK_L_(0x10, 0x53)
#define  REG_TC_SC_BK10_53_H       _PK_H_(0x10, 0x53)
#define  REG_TC_SC_BK10_54_L       _PK_L_(0x10, 0x54)
#define  REG_TC_SC_BK10_54_H       _PK_H_(0x10, 0x54)
#define  REG_TC_SC_BK10_55_L       _PK_L_(0x10, 0x55)
#define  REG_TC_SC_BK10_55_H       _PK_H_(0x10, 0x55)
#define  REG_TC_SC_BK10_56_L       _PK_L_(0x10, 0x56)
#define  REG_TC_SC_BK10_56_H       _PK_H_(0x10, 0x56)
#define  REG_TC_SC_BK10_57_L       _PK_L_(0x10, 0x57)
#define  REG_TC_SC_BK10_57_H       _PK_H_(0x10, 0x57)
#define  REG_TC_SC_BK10_58_L       _PK_L_(0x10, 0x58)
#define  REG_TC_SC_BK10_58_H       _PK_H_(0x10, 0x58)
#define  REG_TC_SC_BK10_59_L       _PK_L_(0x10, 0x59)
#define  REG_TC_SC_BK10_59_H       _PK_H_(0x10, 0x59)
#define  REG_TC_SC_BK10_5A_L       _PK_L_(0x10, 0x5A)
#define  REG_TC_SC_BK10_5A_H       _PK_H_(0x10, 0x5A)
#define  REG_TC_SC_BK10_5B_L       _PK_L_(0x10, 0x5B)
#define  REG_TC_SC_BK10_5B_H       _PK_H_(0x10, 0x5B)
#define  REG_TC_SC_BK10_5C_L       _PK_L_(0x10, 0x5C)
#define  REG_TC_SC_BK10_5C_H       _PK_H_(0x10, 0x5C)
#define  REG_TC_SC_BK10_5D_L       _PK_L_(0x10, 0x5D)
#define  REG_TC_SC_BK10_5D_H       _PK_H_(0x10, 0x5D)
#define  REG_TC_SC_BK10_5E_L       _PK_L_(0x10, 0x5E)
#define  REG_TC_SC_BK10_5E_H       _PK_H_(0x10, 0x5E)
#define  REG_TC_SC_BK10_5F_L       _PK_L_(0x10, 0x5F)
#define  REG_TC_SC_BK10_5F_H       _PK_H_(0x10, 0x5F)
#define  REG_TC_SC_BK10_60_L       _PK_L_(0x10, 0x60)
#define  REG_TC_SC_BK10_60_H       _PK_H_(0x10, 0x60)
#define  REG_TC_SC_BK10_61_L       _PK_L_(0x10, 0x61)
#define  REG_TC_SC_BK10_61_H       _PK_H_(0x10, 0x61)
#define  REG_TC_SC_BK10_62_L       _PK_L_(0x10, 0x62)
#define  REG_TC_SC_BK10_62_H       _PK_H_(0x10, 0x62)
#define  REG_TC_SC_BK10_63_L       _PK_L_(0x10, 0x63)
#define  REG_TC_SC_BK10_63_H       _PK_H_(0x10, 0x63)
#define  REG_TC_SC_BK10_64_L       _PK_L_(0x10, 0x64)
#define  REG_TC_SC_BK10_64_H       _PK_H_(0x10, 0x64)
#define  REG_TC_SC_BK10_65_L       _PK_L_(0x10, 0x65)
#define  REG_TC_SC_BK10_65_H       _PK_H_(0x10, 0x65)
#define  REG_TC_SC_BK10_66_L       _PK_L_(0x10, 0x66)
#define  REG_TC_SC_BK10_66_H       _PK_H_(0x10, 0x66)
#define  REG_TC_SC_BK10_67_L       _PK_L_(0x10, 0x67)
#define  REG_TC_SC_BK10_67_H       _PK_H_(0x10, 0x67)
#define  REG_TC_SC_BK10_68_L       _PK_L_(0x10, 0x68)
#define  REG_TC_SC_BK10_68_H       _PK_H_(0x10, 0x68)
#define  REG_TC_SC_BK10_69_L       _PK_L_(0x10, 0x69)
#define  REG_TC_SC_BK10_69_H       _PK_H_(0x10, 0x69)
#define  REG_TC_SC_BK10_6A_L       _PK_L_(0x10, 0x6A)
#define  REG_TC_SC_BK10_6A_H       _PK_H_(0x10, 0x6A)
#define  REG_TC_SC_BK10_6B_L       _PK_L_(0x10, 0x6B)
#define  REG_TC_SC_BK10_6B_H       _PK_H_(0x10, 0x6B)
#define  REG_TC_SC_BK10_6C_L       _PK_L_(0x10, 0x6C)
#define  REG_TC_SC_BK10_6C_H       _PK_H_(0x10, 0x6C)
#define  REG_TC_SC_BK10_6D_L       _PK_L_(0x10, 0x6D)
#define  REG_TC_SC_BK10_6D_H       _PK_H_(0x10, 0x6D)
#define  REG_TC_SC_BK10_6E_L       _PK_L_(0x10, 0x6E)
#define  REG_TC_SC_BK10_6E_H       _PK_H_(0x10, 0x6E)
#define  REG_TC_SC_BK10_6F_L       _PK_L_(0x10, 0x6F)
#define  REG_TC_SC_BK10_6F_H       _PK_H_(0x10, 0x6F)
#define  REG_TC_SC_BK10_70_L       _PK_L_(0x10, 0x70)
#define  REG_TC_SC_BK10_70_H       _PK_H_(0x10, 0x70)
#define  REG_TC_SC_BK10_71_L       _PK_L_(0x10, 0x71)
#define  REG_TC_SC_BK10_71_H       _PK_H_(0x10, 0x71)
#define  REG_TC_SC_BK10_72_L       _PK_L_(0x10, 0x72)
#define  REG_TC_SC_BK10_72_H       _PK_H_(0x10, 0x72)
#define  REG_TC_SC_BK10_73_L       _PK_L_(0x10, 0x73)
#define  REG_TC_SC_BK10_73_H       _PK_H_(0x10, 0x73)
#define  REG_TC_SC_BK10_74_L       _PK_L_(0x10, 0x74)
#define  REG_TC_SC_BK10_74_H       _PK_H_(0x10, 0x74)
#define  REG_TC_SC_BK10_75_L       _PK_L_(0x10, 0x75)
#define  REG_TC_SC_BK10_75_H       _PK_H_(0x10, 0x75)
#define  REG_TC_SC_BK10_76_L       _PK_L_(0x10, 0x76)
#define  REG_TC_SC_BK10_76_H       _PK_H_(0x10, 0x76)
#define  REG_TC_SC_BK10_77_L       _PK_L_(0x10, 0x77)
#define  REG_TC_SC_BK10_77_H       _PK_H_(0x10, 0x77)
#define  REG_TC_SC_BK10_78_L       _PK_L_(0x10, 0x78)
#define  REG_TC_SC_BK10_78_H       _PK_H_(0x10, 0x78)
#define  REG_TC_SC_BK10_79_L       _PK_L_(0x10, 0x79)
#define  REG_TC_SC_BK10_79_H       _PK_H_(0x10, 0x79)
#define  REG_TC_SC_BK10_7A_L       _PK_L_(0x10, 0x7A)
#define  REG_TC_SC_BK10_7A_H       _PK_H_(0x10, 0x7A)
#define  REG_TC_SC_BK10_7B_L       _PK_L_(0x10, 0x7B)
#define  REG_TC_SC_BK10_7B_H       _PK_H_(0x10, 0x7B)
#define  REG_TC_SC_BK10_7C_L       _PK_L_(0x10, 0x7C)
#define  REG_TC_SC_BK10_7C_H       _PK_H_(0x10, 0x7C)
#define  REG_TC_SC_BK10_7D_L       _PK_L_(0x10, 0x7D)
#define  REG_TC_SC_BK10_7D_H       _PK_H_(0x10, 0x7D)
#define  REG_TC_SC_BK10_7E_L       _PK_L_(0x10, 0x7E)
#define  REG_TC_SC_BK10_7E_H       _PK_H_(0x10, 0x7E)
#define  REG_TC_SC_BK10_7F_L       _PK_L_(0x10, 0x7F)
#define  REG_TC_SC_BK10_7F_H       _PK_H_(0x10, 0x7F)
