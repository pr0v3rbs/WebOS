...
#define MIU0_SEL1_L                     (MIU0_REG_BASE + 0xF2)
#define MIU0_SEL1_H                     (MIU0_REG_BASE + 0xF3)
...
#define REG_CKG_MVD             (REG_CHIPTOP_BASE + 0x39*2)
    ...
    #define CKG_MVD_108MHZ          (4 << 2)    //clk_miu_p
    #define CKG_MVD_123MHZ          (5 << 2)
    #define CKG_MVD_72MHZ           (6 << 2)    //mempll_clk_buf_div2
