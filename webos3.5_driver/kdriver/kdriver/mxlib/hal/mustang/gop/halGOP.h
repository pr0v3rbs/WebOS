...
//  Macro and Define
//-------------------------------------------------------------------------------------------------
#define Gop23_GwinCtl_Ofet                  0

#define MAX_GOP_SUPPORT                     3
#define MAX_GOP_MUX                         4
#define MAX_GOP_MUX_SEL                     4
...
#define MAX_GOP5_GWIN                       0

#define GOP0_Gwin0Id                        0
#define GOP0_Gwin1Id                        1
#define GOP1_Gwin0Id                        2
#define GOP2_Gwin0Id                        3
#define GOP3_Gwin0Id                        4
#define GOP4_Gwin0Id                        5
#define GOP5_Gwin0Id                        6
...
#define GOP_WordUnit                         0x20
#define GOP_DWIN_WordUnit    16
...
#define GOP_FIFO_BURST_ALL                  (GOP_BIT8|GOP_BIT9|GOP_BIT10|GOP_BIT11|GOP_BIT12|GOP_BIT13)
#define GOP_FIFO_BURST_MIDDLE               (GOP_BIT8|GOP_BIT10)
#define GOP_FIFO_BURST_SHORT                (GOP_BIT9)

#define GOP_FIFO_BURST_MASK                 (GOP_BIT8|GOP_BIT9|GOP_BIT10|GOP_BIT11|GOP_BIT12|GOP_BIT13)

#define GOP_FIFO_THRESHOLD                  0x70
...
#define GOP_BANK_SHIFT                      1
#define GOP_PUBLIC_UPDATE MAX_GOP_SUPPORT

#define CHIPID_MUSTANG_SERIES  0xBD
#define MUSTANG_PD_OFFSET    19

#define ENABLE_GOP_T3DPATCH
#ifdef ENABLE_GOP_T3DPATCH
#define GOP_PD_T3D                              0x82UL
#define GOP_PD_NORMAL                           0x02UL
#endif
...
typedef enum
{
    E_GOP_POWERON_TYPE_NONE,
    E_GOP_POWERON_TYPE_COLD_BOOT,
    E_GOP_POWERON_TYPE_STD_SUSPEND,
    E_GOP_POWERON_TYPE_STD_RESUME,
    E_GOP_POWERON_TYPE_STR_SUSPEND,
    E_GOP_POWERON_TYPE_STR_RESUME,
}E_GOP_POWERON_TYPE;

typedef struct
{
    GOP_CTX_HAL_LOCAL GOPHalSTRCtx;
    MS_U16 u16PowerOnMode; // 0: STD suspend 1:STD resume 2: STR:suspend 3: STR:resume
