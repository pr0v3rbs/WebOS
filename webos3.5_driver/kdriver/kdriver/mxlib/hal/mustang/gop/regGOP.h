...
#define CKG_REG_BASE                           0x0B00
#define MIU_REG_BASE                           0x1200
#define MVOP_REG_BASE                          0x1400
#define SC1_DIRREG_BASE                        0x130000
//----------------------------------------------------------------------------
// Scaler Reg
//----------------------------------------------------------------------------
...
#define REG_SC_BK20_10_L                        XC_REG(0x20, 0x10)
...
#define GOP_SC_CHANNELSYNC                      REG_SC_BK00_05_L
    #define IPMUX0_BLENDING_ENABLE  GOP_BIT13
    #define IPMUX1_BLENDING_ENABLE  GOP_BIT12
...
// MVOP Reg
//----------------------------------------------------------------------------
#define GOP_MVOP_MIRRORCFG                      (MVOP_REG_BASE+0x76)
...
#define CKG_GOPG4_MIXERCLK_VE   (4 << 10)
#define CKG_GOPG4_MASK          (GOP_BIT12 | GOP_BIT11 | GOP_BIT10)


/* SRAM CLK */
#define GOP_SRAMCLK             (CKG_REG_BASE+0x84)
...
// MIU Reg
//----------------------------------------------------------------------------
#define GOP_CLIENT_REG          0x7D
#define GOP_MIU_GROUP1          REG_SC_BK7F_10_L

/*Define each gop miu clint bit*/
#define GOP_MIU_CLIENT_DWIN     0xff
#define GOP_MIU_CLIENT_GOP0     0x5
#define GOP_MIU_CLIENT_GOP1     0x6
#define GOP_MIU_CLIENT_GOP2     0x7
#define GOP_MIU_CLIENT_GOP3     0xF
...
#define GOP_1G_OFST                           0x8
#define GOP_1GX_OFST                          0xB
#define GOP_DW_OFST                           0x6
...
#define GOP_4G_DUMMY_22                     GOP_REG(GOP_4G_OFST, 0x22)
...
#define GOP_MUX_BYPASS                      __GOP_REG(0x7B)
...
#define GOP_DW_FRAME_OFT_H                      GOP_REG(GOP_DW_OFST, 0x29)
...
#define MASK_TSTCLR_ALPHA_EN                0
#define MASK_TSTCLR_ALPHA                   0
#define MASK_RGB_STC_VALID                  BMASK(1:0)
#define MASK_R_STC                          BMASK(9:8)
#define MASK_G_STC                          BMASK(11:10)
#define MASK_B_STC                          BMASK(1:0)
#define MASK_INI_TSTCLR_EN                  GOP_BIT15
#define MASK_TSTCLR_HDUP                    BMASK(9:8)
#define MASK_TSTCLR_VDUP                    BMASK(3:2)
#define MASK_HR_INC                         BMASK(14:8)
#define MASK_HR_INC_SIGNZ                   GOP_BIT15
#define MASK_HG_INC                         BMASK(6:0)
#define MASK_HG_INC_SIGNZ                   GOP_BIT7
#define MASK_HB_INC                         BMASK(6:0)
#define MASK_HB_INC_SIGNZ                   GOP_BIT7
#define MASK_HR_STEP                        BMASK(7:0)
#define MASK_HG_STEP                        BMASK(15:8)
#define MASK_HB_STEP                        BMASK(7:0)
#define MASK_VR_INC                         BMASK(14:8)
#define MASK_VR_INC_SIGNZ                   GOP_BIT4
#define MASK_VG_INC                         BMASK(6:0)
#define MASK_VG_INC_SIGNZ                   GOP_BIT7
#define MASK_VB_INC                         BMASK(14:8)
#define MASK_VB_INC_SIGNZ                   GOP_BIT15
#define MASK_VR_STEP                        BMASK(7:0)
#define MASK_VG_STEP                        BMASK(7:0)
#define MASK_VB_STEP                        BMASK(7:0)

#define SHIFT_TSTCLR_EN                     6
#define SHIFT_TSTCLR_ALPHA_EN               0
#define SHIFT_TSTCLR_ALPHA                  0
#define SHIFT_R_STC                         8
#define SHIFT_G_STC                         10
#define SHIFT_B_STC                         0
#define SHIFT_INI_TSTCLR_EN                 15
#define SHIFT_TSTCLR_HDUP                   8
#define SHIFT_TSTCLR_VDUP                   2
#define SHIFT_HR_INC                        8
#define SHIFT_HR_INC_SIGNZ                  15
#define SHIFT_HG_INC                        0
#define SHIFT_HG_INC_SIGNZ                  7
#define SHIFT_HB_INC                        0
#define SHIFT_HB_INC_SIGNZ                  7
#define SHIFT_HR_STEP                       0
#define SHIFT_HG_STEP                       8
#define SHIFT_HB_STEP                       0
#define SHIFT_VR_INC                        8
#define SHIFT_VR_INC_SIGNZ                  4
#define SHIFT_VG_INC                        0
#define SHIFT_VG_INC_SIGNZ                  7
#define SHIFT_VB_INC                        8
#define SHIFT_VB_INC_SIGNZ                  15
