...
#define GROUP0_MAP_PID_START      0UL
#define GROUP0_MAP_PID_LENGTH     MAX_DSCMB_PIDFLT_NUM
#define GROUP1_MAP_PID_START      0UL
#define GROUP1_MAP_PID_LENGTH     MAX_DSCMB_PIDFLT_NUM
#define GROUP2_MAP_PID_START      0UL
#define GROUP2_MAP_PID_LENGTH     MAX_DSCMB_PIDFLT_NUM
//#define GROUP3_MAP_PID_START      DSCMB3_FLT_START_ID
//#define GROUP3_MAP_PID_LENGTH     16

// Share key filter range definition
// CA0
#define DSCMB0_SHARE0_FLT_START_ID  0UL
#define DSCMB0_SHARE0_FLT_END_ID    MAX_DSCMB_PIDFLT_NUM
#define DSCMB0_SHARE1_FLT_START_ID  0UL
#define DSCMB0_SHARE1_FLT_END_ID    MAX_DSCMB_PIDFLT_NUM
#define DSCMB0_SHARE2_FLT_START_ID  0UL
#define DSCMB0_SHARE2_FLT_END_ID    MAX_DSCMB_PIDFLT_NUM
// CA1
#define DSCMB1_SHARE0_FLT_START_ID  0UL
#define DSCMB1_SHARE0_FLT_END_ID    MAX_DSCMB_PIDFLT_NUM
#define DSCMB1_SHARE1_FLT_START_ID  0UL
#define DSCMB1_SHARE1_FLT_END_ID    MAX_DSCMB_PIDFLT_NUM
#define DSCMB1_SHARE2_FLT_START_ID  0UL
#define DSCMB1_SHARE2_FLT_END_ID    MAX_DSCMB_PIDFLT_NUM
// CA2
#define DSCMB2_SHARE0_FLT_START_ID  0UL
#define DSCMB2_SHARE0_FLT_END_ID	MAX_DSCMB_PIDFLT_NUM
#define DSCMB2_SHARE1_FLT_START_ID  0UL
#define DSCMB2_SHARE1_FLT_END_ID	MAX_DSCMB_PIDFLT_NUM
#define DSCMB2_SHARE2_FLT_START_ID  0UL
#define DSCMB2_SHARE2_FLT_END_ID	MAX_DSCMB_PIDFLT_NUM
// CA3
//#define DSCMB3_SHARE0_FLT_START_ID  0UL
//#define DSCMB3_SHARE0_FLT_END_ID	143UL
//#define DSCMB3_SHARE1_FLT_START_ID  0UL
//#define DSCMB3_SHARE1_FLT_END_ID	143UL
//#define DSCMB3_SHARE2_FLT_START_ID  0UL
//#define DSCMB3_SHARE2_FLT_END_ID	143UL
...
#define REG_DSCMB_CTRL                          (REG_DSCMB_BANK+ 0x0000UL) // ESA + CSA control
    ...
    #define REG_DSCMB_CTRL_KEEP_TS_SCRMB        0x0004UL
    #define REG_DSCMB_CTRL_BYPASS_SCP           0x0008UL   //start_code_prefix
    ...
    #define REG_DSCMB_CTRL_KEEP_PES_SCRMB       0x0100UL
    #define REG_DSCMB_CTRL_OLD_PES_TSC          0x0200UL
    #define REG_DSCMB_CTRL_VLR_OVF_CAS          0x0400UL
...
#define REG_DSCMB_CTRL1                         (REG_DSCMB_BANK+ 0x0001UL)
    ...
    #define REG_DSCMB_CTRL1_CIPHER3_SW_RST      0x0080UL
...
#define REG_DSCMB_KT_CTRL_EXT                   (REG_DSCMB_BANK+ 0x002fUL)
    ...
    #define REG_DSCMB_ESA_HDCP_RESIDUE_FIX_EN   0x0020UL
    #define REG_DSCMB_ESA_PES_FIX_EN            0x0040UL
...
//        #define REG_DSCMB1_SEL_2RD_GROUP_11      0x00C0UL
    ...
    #define REG_ESA2_CTRL_USE_CSA_PARSER       0x4000UL
    #define REG_ESA2_CTRL_USE_ESA_PARSER       0x8000UL
...
#define REG_DSCMB1_KT_CTRL_EXT                   (REG_DSCMB1_BANK + 0x000dUL)
    ...
    #define REG_DSCMB1_ESA_HDCP_RESIDUE_FIX_EN   0x0020UL
    #define REG_DSCMB1_ESA_PES_FIX_EN            0x0040UL
...
#define REG_DSCMB2_KT_CTRL_EXT                  (REG_DSCMB1_BANK+ 0x001DUL)
    ...
    #define REG_DSCMB2_ESA_HDCP_RESIDUE_FIX_EN   0x0020UL
    #define REG_DSCMB2_ESA_PES_FIX_EN            0x0040UL
...
#define REG_ESA3_CTRL                            (REG_DSCMB1_BANK + 0x0010UL)
    #define REG_ESA3_CTRL_CORRECT_SCRMBFLAG      0x0002UL
    #define REG_ESA3_CTRL_OLD_TSC                0x0004UL
    #define REG_ESA3_CTRL_NEW_TSC_MASK           0x0030UL
    #define REG_ESA3_CTRL_NEW_TSC_EVEN           0x0020UL
    #define REG_ESA3_CTRL_NEW_TSC_ODD            0x0030UL
//    #define REG_DSCMB1_SEL_2RD_GROUP_MASK        0x00C0UL
//        #define REG_DSCMB1_SEL_2RD_GROUP_00      0x0000UL
//        #define REG_DSCMB1_SEL_2RD_GROUP_01      0x0040UL
//        #define REG_DSCMB1_SEL_2RD_GROUP_10      0x0080UL
//        #define REG_DSCMB1_SEL_2RD_GROUP_11      0x00C0UL
    #define REG_ESA3_CTRL_SWITCH_KEY_VALID     0x2000UL
...
#define REG_DSCMB3_KT_CTRL                      (REG_DSCMB1_BANK + 0x0063UL)
    ...
    #define REG_DSCMB3_CIP_ESA_TDES_MODE         0x0002UL
...
#define REG_CSA3_CTRL                           (REG_DSCMB1_BANK+ 0x0068UL)
    #define REG_DSCMB3_CTRL_CSA_MODE             0x0001UL
    #define REG_DSCMB3_CTRL_CONFORMANCE_MECH     0x0002UL
    #define REG_DSCMB3_CTRL_CLR_OVERFLOW_CSA     0x0004UL


#define REG_DSCMB3_KT_CTRL_EXT                  (REG_DSCMB1_BANK+ 0x006DUL)
    #define REG_DSCMB3_ESA_OC_MODE               0x0001UL
    #define REG_DSCMB3_ESA_HDCP_RESIDUE_FIX_EN   0x0020UL
    #define REG_DSCMB3_ESA_PES_FIX_EN            0x0040UL
