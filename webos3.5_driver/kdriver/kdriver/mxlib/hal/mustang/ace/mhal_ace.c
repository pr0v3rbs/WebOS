...
MS_BOOL Hal_ACE_SetIHC(void* pInstance,MS_BOOL bScalerWin, XC_ACE_IHC_COLOR_TYPE eIHC, MS_U8 u8Val)
{
    ...
    MS_U16 u16Direction = (u8Val > 63?1:0) << 6;
    ...
    if (bScalerWin == MAIN_WINDOW)
    {
        switch(eIHC)
        {
            case E_ACE_IHC_COLOR_R:
                SC_W2BYTEMSK(0,REG_SC_BK18_61_L, u16Val, BITMASK(6:0));
                break;
            case E_ACE_IHC_COLOR_G:
                SC_W2BYTEMSK(0,REG_SC_BK18_61_L, u16Val<<8, BITMASK(14:8));
                break;
            case E_ACE_IHC_COLOR_B:
                SC_W2BYTEMSK(0,REG_SC_BK18_62_L, u16Val, BITMASK(6:0));
                break;
            case E_ACE_IHC_COLOR_C:
                SC_W2BYTEMSK(0,REG_SC_BK18_62_L, u16Val<<8, BITMASK(14:8));
                break;
            case E_ACE_IHC_COLOR_M:
                SC_W2BYTEMSK(0,REG_SC_BK18_63_L, u16Val, BITMASK(6:0));
                break;
            case E_ACE_IHC_COLOR_Y:
                SC_W2BYTEMSK(0,REG_SC_BK18_63_L, u16Val<<8, BITMASK(14:8));
                break;
            case E_ACE_IHC_COLOR_F:
                SC_W2BYTEMSK(0,REG_SC_BK18_64_L, u16Val, BITMASK(6:0));
                break;
            default:
            break;
        }
    ...
    else
    {
        ...
        {
            case E_ACE_IHC_COLOR_R:
                SC_W2BYTEMSK(0,REG_SC_BK18_65_L, u16Val, BITMASK(6:0));
                break;
            case E_ACE_IHC_COLOR_G:
                SC_W2BYTEMSK(0,REG_SC_BK18_65_L, u16Val<<8, BITMASK(14:8));
                break;
            case E_ACE_IHC_COLOR_B:
                SC_W2BYTEMSK(0,REG_SC_BK18_66_L, u16Val, BITMASK(6:0));
                break;
            case E_ACE_IHC_COLOR_C:
                SC_W2BYTEMSK(0,REG_SC_BK18_66_L, u16Val<<8, BITMASK(14:8));
                break;
            case E_ACE_IHC_COLOR_M:
                SC_W2BYTEMSK(0,REG_SC_BK18_67_L, u16Val, BITMASK(6:0));
                break;
            case E_ACE_IHC_COLOR_Y:
                SC_W2BYTEMSK(0,REG_SC_BK18_67_L, u16Val<<8, BITMASK(14:8));
                break;
            case E_ACE_IHC_COLOR_F:
                SC_W2BYTEMSK(0,REG_SC_BK18_68_L, u16Val, BITMASK(6:0));
                break;
            default:
            break;
        }
...
void Hal_ACE_Set_IHC_SRAM(void* pInstance,MS_U16 *pBuf, MS_U8 u8SRAM_Idx, MS_U16 u16Cnt)
{
    ...
    SC_W2BYTEMSK(0,REG_SC_BK18_7C_L, BIT(0), BIT(0)); // io_en enable
    ...
    SC_W2BYTEMSK(0,REG_SC_BK18_7C_L, 0, BIT(0)); // io_en disable
}

void Hal_ACE_Set_ICC_SRAM(void* pInstance,MS_U16 *pBuf, MS_U16 u16Cnt)
{
    MS_U16 i;
    SC_W2BYTEMSK(0,REG_SC_BK18_78_L, BIT(0), BIT(0)); // io_en enable
    ...
    SC_W2BYTEMSK(0,REG_SC_BK18_78_L, 0, BIT(0)); // io_en disable
}
...
{
    if(MApi_XC_MLoad_GetStatus_U2(pInstance) == E_MLOAD_ENABLED && !Hal_ACE_GetSkipWaitVsync(pInstance, SUB_WINDOW))
    {

        MApi_XC_MLoad_WriteCmd(pInstance,REG_SC_BK0F_07_L, u16hstart, 0xFFF);
        MApi_XC_MLoad_WriteCmd(pInstance,REG_SC_BK0F_08_L, u16hend,   0xFFF);
    ...
    {
        SC_W2BYTEMSK(0,REG_SC_BK0F_07_L, u16hstart, 0xFFF);
        SC_W2BYTEMSK(0,REG_SC_BK0F_08_L, u16hend,   0xFFF);
...
void Hal_ACE_3DClonePQMap(void* pInstance,XC_ACE_WEAVETYPE enWeaveType)
{
    ...
    //MemFormat
    {
        ...
        value = SC_R2BYTE(0,REG_SC_BK12_19_L);
        SC_W2BYTEMSK(0,REG_SC_BK12_59_L, value, 0x00FF);
    ...
    //disable dms_v12
    SC_W2BYTEMSK(0,REG_SC_BK26_10_L, 0x0000 ,BIT(15));
}
...
void Hal_ACE_Write_BT2020_Matrix_Burst(void* pInstance, MS_BOOL bWindow, MS_U16* psMatrix )
{
    MS_U8 i,j;
    MS_U32 ucAddr = 0;
    MS_S16 sTmp = 0;
    ...
    for(i=0; i!=2; i++)
    {
        for(j=0; j!=2; j++)
        {
            ...
            MApi_XC_MLoad_WriteCmd(pInstance, ucAddr, sTmp , 0xFFFF);
