...
void HAL_SC_SetClk(MS_U8 u8SCID,MS_U16 u16clk)
{
    ...
    if (u8SCID == 0)
    {
        ...
        HW_WRITE(REG_TOP_CKG_SM_CACLK_M,HW_READ(REG_TOP_CKG_SM_CACLK_M)&0xFFFD);
        switch (u16clk)
        {
            case E_SC_CLK_3M :
            ...
            case E_SC_CLK_4M:
                ...
                HW_WRITE(REG_TOP_CKG_SM_CACLK_M,HW_READ(REG_TOP_CKG_SM_CACLK_M)|0x0100);
                HW_WRITE(REG_TOP_CKG_SM_CACLK_M,HW_READ(REG_TOP_CKG_SM_CACLK_M)&0xFFFE);
                HW_WRITE(REG_TOP_CKG_SM_CACLK_M,HW_READ(REG_TOP_CKG_SM_CACLK_M)|0x1);
                HW_WRITE(REG_TOP_CKG_SM_CACLK_M,HW_READ(REG_TOP_CKG_SM_CACLK_M)&0xFFFE);
                HW_WRITE(REG_TOP_CKG_SM_CACLK_M,HW_READ(REG_TOP_CKG_SM_CACLK_M)|0x2);
                break;
            default:
...
void HAL_SC_Init(MS_U8 u8SCID)
{
    ...
    if (u8SCID == 0)
    {
        ...
        HW_WRITE(REG_TOP_SM0, HW_READ(REG_TOP_SM0) & ~0x30);
        HW_WRITE(REG_TOP_SM0, HW_READ(REG_TOP_SM0) | 0x10);
        HW_WRITE(REG_TOP_PCMCTRLCONFIG, HW_READ(REG_TOP_PCMCTRLCONFIG) & ~0x20);
