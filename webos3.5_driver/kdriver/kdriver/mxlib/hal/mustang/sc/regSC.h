...
#define REG_TOP_PCMCTRLCONFIG               (REG_CHIP_TOP_BASE + (0x00000064UL << 1))
...
#define REG_TOP_CKG_SM_CACLK_M          (REG_CLK_GEN_BASE + (0x0000006DUL << 1))
#define REG_TOP_CKG_SM_CACLK_N          (REG_CLK_GEN_BASE + (0x0000006EUL << 1))
