...
#define BK_JPD_DEBUG_BUS_H          (JPD_REG_BASE+JPD_OFFSET(0x22))
#define BK_JPD_DEBUG_BUS_L          (JPD_REG_BASE+JPD_OFFSET(0x23))
...
#define BK_JPD_GENERAL(x)           (JPD_REG_BASE+JPD_OFFSET(x))
...
#define JPD_CHIP_REG_BASE           0x1E00
#define JPD_MIU_GROUP1_I64          (JPD_CHIP_REG_BASE + JPD_OFFSET(0x21))
#define JPD_MIU_CLIENT_JPD          JPD_BIT(7) // bit 7 of the first byte

#define BK_CHIPTOP_GENERAL(x)       (JPD_CHIP_REG_BASE+JPD_OFFSET(x))

// MIU
#define JPD_MIU0_BASE               0x1200
#define JPD_MIU1_BASE               0x0600
#define JPD_MIU0_RQ1_MASK           (JPD_MIU0_BASE+JPD_OFFSET(0x33)) //group1
#define JPD_MIU1_RQ1_MASK           (JPD_MIU1_BASE+JPD_OFFSET(0x33)) //group1
#define JPD_MIU0_MIU_SEL1           (JPD_MIU0_BASE+JPD_OFFSET(0x79)) //group1
#define JPD_MIU1_MIU_SEL1           (JPD_MIU1_BASE+JPD_OFFSET(0x79)) //group1
#define JPD_MIU0_CLIENT_JPD         JPD_BIT(7) //group1, bit7 of the first byte
#define JPD_MIU1_CLIENT_JPD         JPD_BIT(7) //group1, bit7 of the first byte

#define BK_MIU0_GENERAL(x)          (JPD_MIU0_BASE+JPD_OFFSET(x))
#define BK_MIU1_GENERAL(x)          (JPD_MIU1_BASE+JPD_OFFSET(x))

#define JPD_TZPC_NONPM_BASE         0x23900

#define JPD_NONPM_SECURE_21         (JPD_TZPC_NONPM_BASE + JPD_OFFSET(0x21)+1)
#define JPD_SECURE_RANGE_JPD        JPD_BIT(1) // bit 1 of the second byte
#define BK_TZPC_GENERAL(x)          (JPD_TZPC_NONPM_BASE+JPD_OFFSET(x))
