...
#define EVD_REG_BBU_MIU_WIDTH                   (REG_EVD_BASE + ((0x0040) << 1)) // Miami, Clippers use 128 bits BBU
    #define EVD_REG_BBU_MIU_128                 BITS(1:0,1)
    #define EVD_REG_BBU_MIU_256                 BITS(1:0,2)
...
#define REG_TOP_VPU             (CLKGEN0_REG_BASE+(0x0030<<1))
    ...
    #define TOP_CKG_VPU_XTALI                 BITS(4:2, 3)
...
#define REG_TOP_HVD_IDB         (CLKGEN0_REG_BASE+(0x0030<<1))
    ...
    #define TOP_CKG_HVD_IDB_288MHZ            BITS(10:8, 0)
    #define TOP_CKG_HVD_IDB_240MHZ            BITS(10:8, 1)
    #define TOP_CKG_HVD_IDB_216MHZ            BITS(10:8, 2)
    #define TOP_CKG_HVD_IDB_172MHZ            BITS(10:8, 3)
...
#define REG_TOP_HVD             (CLKGEN0_REG_BASE+(0x0031<<1))
    ...
    #define TOP_CKG_HVD_240MHZ                  BITS(3:2,0)
    #define TOP_CKG_HVD_216MHZ                  BITS(3:2,1)
    #define TOP_CKG_HVD_172MHZ                  BITS(3:2,2)
    #define TOP_CKG_HVD_288MHZ                  BITS(3:2,3)
...
#define REG_TOP_MVD             (CLKGEN0_REG_BASE+(0x0039<<1))
    ...
    #define TOP_CKG_MVD_108MHZ                BITS(4:2, 4)
    #define TOP_CKG_MVD_123MHZ                BITS(4:2, 5)
    #define TOP_CKG_MVD_72MHZ                 BITS(4:2, 6)
...
#define REG_TOP_MVD2             (CLKGEN0_REG_BASE+(0x0039<<1))
    ...
    #define TOP_CKG_MVD2_XTAL                  BITS(12:10, 3)
    #define TOP_CKG_MVD2_123MHZ                BITS(12:10, 4)
    #define TOP_CKG_MVD2_MEMPLL                BITS(12:10, 5)
    #define TOP_CKG_MVD2_RESRVD                BITS(12:10, 6)
    #define TOP_CKG_MVD2_MIU_P                 BITS(12:10, 7)

#define REG_TOP_CKG_EVD_PPU             (CLKGEN0_REG_BASE+(0x0033<<1))
    #define TOP_CKG_EVD_PPU_MASK                    BMASK(12:10)
    #define TOP_CKG_EVD_PPU_DIS                     BIT(8)
    #define TOP_CKG_EVD_PPU_INV                     BIT(9)
    #define TOP_CKG_EVD_PPU_288MHZ                  BITS(12:10, 0)
    #define TOP_CKG_EVD_PPU_240MHZ                  BITS(12:10, 1)
    #define TOP_CKG_EVD_PPU_216MHZ                  BITS(12:10, 2)
    #define TOP_CKG_EVD_PPU_172MHZ                  BITS(12:10, 3)
    #define TOP_CKG_EVD_PPU_320MHZ                  BITS(12:10, 4)


#define REG_TOP_CKG_EVD             (CLKGEN0_REG_BASE+(0x0034<<1))
    #define TOP_CKG_EVD_MASK                        BMASK(12:10)
    #define TOP_CKG_EVD_DIS                         BIT(8)
    #define TOP_CKG_EVD_INV                         BIT(9)
    #define TOP_CKG_EVD_240MHZ                      BITS(12:10, 0)
    #define TOP_CKG_EVD_216MHZ                      BITS(12:10, 1)
    #define TOP_CKG_EVD_172MHZ                      BITS(12:10, 2)
    #define TOP_CKG_EVD_160MHZ                      BITS(12:10, 3)
    #define TOP_CKG_EVD_288MHZ                      BITS(12:10, 4)

#define UART_SEL_0 0
#define REG_TOP_UART_SEL             (CHIPTOP_REG_BASE+(0x0053<<1))
#if UART_SEL_0
    #define REG_TOP_UART_SEL_0_MASK            BMASK(3:0)
    #define REG_TOP_UART_SEL_0_MHEG5             BITS(3:0, 1)
    #define REG_TOP_UART_SEL_0_VD_MHEG5          BITS(3:0, 2)
    #define REG_TOP_UART_SEL_0_TSP               BITS(3:0, 3)
    #define REG_TOP_UART_SEL_0_PIU_0             BITS(3:0, 4)
    #define REG_TOP_UART_SEL_0_PIU_1             BITS(3:0, 5)
    #define REG_TOP_UART_SEL_0_PIU_FAST          BITS(3:0, 7)
    #define REG_TOP_UART_SEL_0_VD_MCU_51_TXD0    BITS(3:0, 10)
    #define REG_TOP_UART_SEL_0_VD_MCU_51_TXD1    BITS(3:0, 11)
#else
    #define REG_TOP_UART_SEL_1_MASK            BMASK(7:4)
    #define REG_TOP_UART_SEL_1_MHEG5             BITS(7:4, 1)
    #define REG_TOP_UART_SEL_1_VD_MHEG5          BITS(7:4, 2)
    #define REG_TOP_UART_SEL_1_TSP               BITS(7:4, 3)
    #define REG_TOP_UART_SEL_1_PIU_0             BITS(7:4, 4)
    #define REG_TOP_UART_SEL_1_PIU_1             BITS(7:4, 5)
    #define REG_TOP_UART_SEL_1_PIU_FAST          BITS(7:4, 7)
    #define REG_TOP_UART_SEL_1_VD_MCU_51_TXD0    BITS(7:4, 10)
    #define REG_TOP_UART_SEL_1_VD_MCU_51_TXD1    BITS(7:4, 11)
#endif
//------------------------------------------------------------------------------
// MIU Reg
//------------------------------------------------------------------------------
