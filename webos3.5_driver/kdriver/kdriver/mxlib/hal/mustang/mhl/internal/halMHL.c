...
MS_U8 ucChipIDValue = MHL_CHIP_ID_MUSTANG;
...
void mhal_mhl_LoadEDID(MS_U8 *edid)
{
    ...
    {
        // Load EDID
        msg_mhl(printf("** Mustang Load MHL EDID...\r\n"));
...
void mhal_mhl_ReadEDID(MS_U16 usSize, MS_U8 *edid)
{
    ...
    {
        // Read EDID
        msg_mhl(printf("** Mustang Read MHL EDID...\r\n"));
...
void mhal_mhl_LoadDeviceCapability(MS_U8 *devcap)
{
    ...
    if(devcap != NULL)
    {
        msg_mhl(printf("** Mustang Load DevCap...\r\n"));
