...
//  Macro and Define
//-------------------------------------------------------------------------------------------------
#define MHL_FUNCTION_SUPPORT_PORTA      0
#define MHL_FUNCTION_SUPPORT_PORTB      0
#define MHL_FUNCTION_SUPPORT_PORTC      1
#define MHL_FUNCTION_SUPPORT_PORTD      1

#define DMHL_CDR_SW_MODE                0 // MHL CDR  SW mode
#define DMHL_CDR_HW_MODE                (!DMHL_CDR_SW_MODE)    // power down dvi pll till clock stable

#define MHL_ICONTROL_VALUE              0
#define MHL_IMPEDANCE_VALUE             0
#define MHL_PHASE_CODE_VALUE            0x60
#define MHL_DIGITAL_UNLOCK_RANGE        0x3E8
#define MHL_LOCK_RESOLUTION             0x1
#define MHL_UNLOCK_RESOLUTION           0x1E

#define MHL_EQ_SETTING_VALUE            13
#define MHL_HDMI_EQ_SETTING_VALUE       13

#define MHL_CHIP_ID_MUSTANG              0

#define MHL_CDR_STABLE_COUNTER          10
...
#define MHL_CBUS_SW_ISR_MODE            1   // Use SW interrupt to reply MSC command
#define MHL_CBUS_HW_ISR_MODE            2   // Use SW interrupt to clear MSC receiver flag to trigger HW auto reply
...
#define MHL_VBUS_INVERSE_MODE           2
#define MHL_VBUS_LOW_ENABLE_MODE        4
#define MHL_VBUS_HIGH_ENABLE_MODE       8

#define MHL_SCALER_MUX_SELECT_DVI       0x1
#define MHL_SCALER_MUX_SELECT_MHL       0xD

#define MHL_EFUSE_FUNCTION_CONTROL      0

#define MHL_TMDS_MULTIPLE_ENGINE        1
#define MHL_INTERRUPT_USE_PM_IRQ        0
#define MHL_ECBUS_ENGINE_SUPPORT        0
