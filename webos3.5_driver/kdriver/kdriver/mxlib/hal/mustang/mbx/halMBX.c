...
static MS_U32 _u32RIUBaseAddrMBX = 0;
//=============================================================================
// Global Variables
//=============================================================================
...
/// <b>[MXLIB] <em> </em></b>
//-------------------------------------------------------------------------------------------------
MBX_Result MHAL_MBX_Init(MBX_ROLE_ID eHostRole, MS_U32 u32RIUBaseAddrMBX)
{
    _u32RIUBaseAddrMBX = u32RIUBaseAddrMBX;
...
//-------------------------------------------------------------------------------------------------
MBX_Result  MHAL_MBX_SetInformation(MBX_ROLE_ID eTargetRole, MS_U32 u32RIUBaseAddrMBX, MS_U8 *pU8Info, MS_U8 u8Size)
{
    MS_S32 s32Idx;
...
/// <b>[MXLIB] <em>It is used for speciall need when Init-Coprocesser.</em></b>
//-------------------------------------------------------------------------------------------------
MBX_Result  MHAL_MBX_GetInformation(MBX_ROLE_ID eTargetRole, MS_U32 u32RIUBaseAddrMBX, MS_U8 *pU8Info, MS_U8 u8Size)
{
    MS_S32 s32Idx;
