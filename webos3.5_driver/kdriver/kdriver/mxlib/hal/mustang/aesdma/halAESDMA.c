...
//--------------------------------------------------------------------------------------------------
static MS_U32                _u32RegBase = NULL;
static MS_U32                _u32PmRegBase = NULL;
...
//  Inline Function
//--------------------------------------------------------------------------------------------------
void HAL_AESDMA_SetBank(MS_U32 u32NonPmBankAddr, MS_U32 u32PmBankAddr)
{
...
MS_U32 AESDMA_GetMIU1Base(void)
{
    return HAL_MIU1_BASE;
}

MS_U32 AESDMA_GetMIU2Base(void)
{
    //not support
    return FALSE;
}
...
void AESDMA_Reset(void)
{
    MS_U32 Reg_AESDMA;
    int i = 0;
    Reg_AESDMA = (MS_U32)(&_AESDMACtrl[0].Dma_Ctrl);
...
void AESDMA_Set_FileinDesc(MS_U32 FileinAddr , MS_U32 FileinNum)
{
    REG32_W((&_AESDMACtrl[0].Dma_Filein_Addr), FileinAddr);
    REG32_W((&_AESDMACtrl[0].Dma_Filein_Num), FileinNum);
}

void AESDMA_Set_FileoutDesc(MS_U32 FileoutSAddr , MS_U32 FileoutEAddr)
{
...
{
    REG32_W((&_AESDMACtrl[0].Dma_Ctrl2) , _AESDMA_REG32_R(&_AESDMACtrl[0].Dma_Ctrl2)|AESDMA_WADR_ERR_CLR);
    REG32_W((&_AESDMACtrl[0].Dma_Ctrl2) , _AESDMA_REG32_R(&_AESDMACtrl[0].Dma_Ctrl2)&~AESDMA_WADR_ERR_CLR);
}
...
void AESDMA_Enable_Clk(void)
{
    ...
    u32Val &= ~0xF0000; //Set Clk to 172M, Enable Clk
    ...
    //2. clk_rc
    //Enable 0x1239_0x03[3:0] = 4b'1111
...
{
    REG32_W((&_AESDMAClk[0].Reg_Gate_Clk_AESDMA) , _AESDMA_REG32_R(&_AESDMAClk[0].Reg_Gate_Clk_AESDMA) | AESDMA_CLK_DISABLE);
}
...
void SHA_Reset(void)
{
    MS_U32 Reg_SHARNG;
    int i = 0;
    Reg_SHARNG = (MS_U32)(&_SHARNGCtrl[0].Sha_Ctrl);
...
void SHA_SetAddress(MS_U32 u32Addr)
{
...
void SHA_SetByPassTable(MS_BOOL bEnable)
{
    // not implemented yet

}

void SHA_SetInitialHashEn(MS_BOOL bEnable)
{
    // not implemented yet

}

void SHA_SetShaManualMode(MS_BOOL bEnable)
{
    // not implemented yet

}

void SHA_SetInitialSha(MS_U32 u32Buf)
{
    // not implemented yet
...
/// @param  pu8Data              \b IN: Data array
/// @param  pu8privData          \b IN: Private data array
/// @note : Set HDCP2.2
//-------------------------------------------------------------------------------------------------
