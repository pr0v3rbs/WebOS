...
#ifndef _MHAL_LD_SPI_C_
#define _MHAL_LD_SPI_C_

#include "mhal_ld.h"
#include "mhal_ld_spi.h"

extern StuMSPICtrlInfo s_MSPICtrlInfo;

void MHal_MSPI_SetClockGen( EnuMSPI_CLOCK_GEN eClockGen )
{
    MDrv_WriteByteMask(REG_1E98, eClockGen<<2, 0x3C);// bit2~5
    MDrv_WriteByteMask(REG_1E98, 0 , BIT(0)) ; // clock enable
}
