...
INTERFACE void Hal_SC_UpdateDynamicScalingCurrentIndex(void *pInstance, SCALER_WIN eWindow);
INTERFACE void Hal_XC_Set_ReadFrameBufferFrameCount(void* pInstance, MS_U16 value, SCALER_WIN eWindow);
INTERFACE void Hal_XC_Set_ReadFrameBufferFrameCount_FRC(void* pInstance, MS_U16 value, SCALER_WIN eWindow);
INTERFACE void Hal_XC_Set_RWPointerDiff(void* pInstance, MS_U16 value, SCALER_WIN eWindow);
INTERFACE void Hal_XC_Set_RWPointerDiff_FRC(void* pInstance, MS_U16 value, SCALER_WIN eWindow);
INTERFACE MS_U16 Hal_XC_Get_ReadFrameBufferFrameCount(void* pInstance, SCALER_WIN eWindow);
#define Hal_XC_Get_ReadFrameBufferFrameCount_FRC(args...) 0;
INTERFACE MS_U16 Hal_XC_Get_RWPointerDiff(void* pInstance, SCALER_WIN eWindow);
INTERFACE MS_U16 Hal_XC_Get_RWPointerDiff_FRC(void* pInstance, SCALER_WIN eWindow);
//#define HAL_SC_Set_IsGstreamerProcess(args...)
//#define HAL_SC_Get_IsGstreamerProcess(args...) 0;
INTERFACE void HAL_SC_Set_IsGstreamerProcess(MS_BOOL bEnable);
INTERFACE MS_BOOL HAL_SC_Get_IsGstreamerProcess(void);
INTERFACE void HAL_SC_Set_IsCaptureProcess(MS_BOOL bEnable);
INTERFACE MS_BOOL HAL_SC_Get_IsCaptureProcess(void);
INTERFACE MS_U32 H_PostScalingRatio_adv(MS_U16 u16Input, MS_U16 u16Output);
INTERFACE MS_BOOL MHal_XC_Force_Mute_IPW(void *pInstance, MS_BOOL bEnable, SCALER_WIN eWindow);
INTERFACE void Hal_SC_ds_db(void *pInstance, P_SC_SWDB_INFO pDBreg, SCALER_WIN eWindow, XC_InternalStatus *pSrcInfo, XC_SETWIN_INFO *pstXC_SetWin_Info);
INTERFACE void MHal_XC_DetectLBErr_Rst(void *pInstance);
INTERFACE void MHal_SC_OP1_Pattern_backup_setting(void *pInstance);
INTERFACE MS_BOOL MHal_SC_OP1_Pattern_set_patgen_mode(void *pInstance,EN_XC_OP1_PATGEN_MODE mode);
INTERFACE void MHal_SC_OP1_Pattern_init_setting(void *pInstance);
INTERFACE void MHal_SC_OP1_Pattern_sram_writedone(void *pInstance);
INTERFACE void MHal_SC_OP1_Pattern_set_frame_size(void *pInstance,MS_U16 u16HSize, MS_U16 u16VSize);
INTERFACE void MHal_SC_OP1_Pattern_enable(void *pInstance,MS_BOOL bEnable);
INTERFACE void MHAL_SC_set_r2y_en(void *pInstance, MS_BOOL bEnable, SCALER_WIN eWindow);
INTERFACE void MHal_SC_OP1_Pattern_restore_setting(void *pInstance);
INTERFACE void MHal_SC_OP1_Pattern_pure_color(void *pInstance,MS_U8 u8Color);
INTERFACE void MHal_SC_OP1_Pattern_enable_border(void *pInstance,MS_BOOL bEnable,MS_U16 RVal, MS_U16 GVal, MS_U16 BVal);
INTERFACE void MHal_SC_OP1_PatGen_adjust_frame_size(void *pInstance,MS_U16 u16HSize, MS_U16 u16VSize);
INTERFACE void MHal_SC_OP1_Pattern_sram_writestart(void *pInstance);
INTERFACE void MHal_SC_OP1_Pattern_define_tile(void *pInstance,MS_U16 hTile,MS_U16 vTile);
INTERFACE void MHal_SC_OP1_Pattern_set_border_sram(void *pInstance,XC_OP1_PatGen_Border tile1, XC_OP1_PatGen_Border tile2, XC_OP1_PatGen_Border tile3, XC_OP1_PatGen_Border tile4, XC_OP1_PatGen_Border tile5);
INTERFACE void MHal_SC_OP1_Pattern_set_dotfade_value(void *pInstance,MS_U8 RVal, MS_U8 GVal, MS_U8 BVal);
INTERFACE void MHal_SC_OP1_Pattern_set_dotfade_overfollow_protection(void *pInstance,MS_BOOL REn, MS_BOOL GEn, MS_BOOL BEn);
INTERFACE void MHal_SC_OP1_Pattern_set_border_sram(void *pInstance,XC_OP1_PatGen_Border tile1, XC_OP1_PatGen_Border tile2, XC_OP1_PatGen_Border tile3, XC_OP1_PatGen_Border tile4, XC_OP1_PatGen_Border tile5);
INTERFACE void MHal_SC_OP1_Pattern_sram_write_enable(void *pInstance,MS_BOOL bEn);
INTERFACE void MHal_SC_OP1_Pattern_sram_write_fastmode(void *pInstance,MS_BOOL bEn);
INTERFACE void MHal_SC_OP1_Pattern_set_wraddr(void *pInstance,MS_U16 u16Addr);
INTERFACE void MHal_SC_OP1_Pattern_set_jump_threshold(void *pInstance,MS_U16 u16Threshold);
INTERFACE void MHal_SC_OP1_Pattern_customize_blcok(void *pInstance,MS_U8 block_Size,MS_U8 repeat_Num,MS_BOOL isLineStart,MS_BOOL isLineEnd,MS_U16 RVal, MS_U16 GVal, MS_U16 BVal, E_XC_OP1_PATTERN_DTAT_TYPE eType);
INTERFACE void MHal_SC_OP1_Pattern_set_sram(void *pInstance,MS_U16 u16Tbl0, MS_U16 u16Tbl1, MS_U16 u16Tbl2, MS_U16 u16Tbl3);
...
#define Hal_SC_get_Frc_framebuf_Info(args...)
#define Hal_XC_MLoad_set_trigger_sync(args...)
#undef INTERFACE
#endif /* MHAL_SC_H */
