...
#define SUPPORT_IMMESWITCH_DVI_POWERSAVING  0
...
#define ENABLE_ENABLE_OPW_WITH_FRAMELOCK    0
#define SUPPORT_DS_FAST_SWITCHING           0
...
//Use DS code in driver instead of FW/AN DS
#define ENABLE_SW_DS                        1
#define _ENABLE_SW_DS                      0
#define DS_BUFFER_NUM_EX                     6
#define DS_MAX_INDEX                         6
#define FW_DS_MAX_INDEX                      0x10
...
#define REG_CKG_FCLK            (REG_CLKGEN0_BASE + 0xA5 ) // after memory, before fodclk
    ...
    #define CKG_FCLK_DEFAULT        CKG_FCLK_192MHZ
...
#define REG_CKG_PRE_IDCLK0       (REG_CHIPTOP_BASE + 0xBC ) // pre-main window idclk
    #define CKG_PRE_IDCLK0_MASK         BMASK(2:0)
    #define CKG_PRE_IDCLK0_CLK_ADC      (0 )
    #define CKG_PRE_IDCLK0_CLK_DVI      (1 )
    #define CKG_PRE_IDCLK0_CLK_MHL      (2 )
...
#define ADC_HARDWARE_AUTOGAIN_SUPPORTED     DISABLE
