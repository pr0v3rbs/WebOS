...
typedef enum
{
    ...
    ADC_TABLE_MUX_DVI2,
    ADC_TABLE_MUX_DVI3,
    ADC_TABLE_MUX_CVBSX0,
    ADC_TABLE_MUX_CVBSX1,
    ADC_TABLE_MUX_CVBSX2,
    ADC_TABLE_MUX_CVBSX3,
    ADC_TABLE_MUX_NUMS
} ADC_MUX_TYPE;
...
typedef enum
{
    ADC_TABLE_AdcCal_AV_OFF_ALL,
    ADC_TABLE_AdcCal_AV_OFF_NUMS
} ADC_AdcCal_AV_OFF_TYPE;
...
typedef enum
{
    ADC_TABLE_CVBSOX_ADCX_ON,
    ADC_TABLE_CVBSOX_ADCX_OFF,
    ADC_TABLE_CVBSOX_NUMS
} ADC_CVBSOX_TYPE;
