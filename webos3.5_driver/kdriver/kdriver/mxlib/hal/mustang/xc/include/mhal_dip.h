...
#define DIP_BUS_WIDTH  32
#define DWIN0_BUS_WIDTH  32
...
INTERFACE void HAL_XC_DIP_SetBase0(void *pInstance, MS_U32 u32BufStart,MS_U32 u32BufEnd,SCALER_DIP_WIN eWindow);
INTERFACE void HAL_XC_DIP_SetBase1(void *pInstance, MS_U32 u32BufStart,MS_U32 u32BufEnd,SCALER_DIP_WIN eWindow);
INTERFACE void HAL_XC_DIP_SetWinProperty(void *pInstance, MS_U8 u8BufCnt,MS_U16 u16Width,MS_U16 u16LineOft,MS_U16 u16Height,MS_U32 u32OffSet, SCALER_DIP_SOURCE_TYPE eSource,MS_BOOL bPIP,SCALER_DIP_WIN eWindow);
INTERFACE void HAL_XC_DIP_SetWinProperty1(void *pInstance, MS_U32 u16Offset,SCALER_DIP_WIN eWindow);
...
INTERFACE void HAL_XC_DIP_Rotation(void *pInstance, MS_BOOL bRotation,EN_XC_DIP_ROTATION eRoDirection,MS_U32 u32StartAddr,SCALER_DIP_WIN eTmpWindow);
INTERFACE void HAL_XC_DIP_SetPinpon(void *pInstance, MS_BOOL bPinpon,MS_U32 u32PinponAddr,MS_U32 u32OffSet,SCALER_DIP_WIN eWindow);
//==============Get===================
