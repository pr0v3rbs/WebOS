...
typedef enum
{
    ...
    HAL_OUTPUTPORT_OFFLINE = OUTPUT_PORT_OFFLINE_DETECT,
...
typedef enum
{
    ...
    SC_SUBWIN_IPMUX_MHL      = 0xD,            ///< MHL
} SC_SUBWIN_IPMUX_TYPE;
typedef enum
{
    SC_PRE_CLK_ADC_A      = 0,            ///< ADC A
    SC_PRE_CLK_HDMI_DVI   = 1,            ///< DVI
    SC_PRE_CLK_MHL        = 2,            ///< MHL
} SC_PRE_IDCLK_TYPE;
typedef enum
{
    ...
    SC_CLK_ODCLK      = 4,            ///< Scaler VOP output
    SC_CLK_XTAL       = 5,            ///< Scaler VOP output
    SC_CLK_VD_ADC     = 6,            ///< External VD
    SC_CLK_DC1        = 7,            ///< MPEG/DC1
...
#define Hal_SC_EnableCLK_for_DIP(args...)
