...
INTERFACE MS_BOOL MHAL_SC_Set_DynamicScaling(void *pInstance, MS_U32 u32DSMemAddr, MS_U32 u32DSMemSize, MS_U32 u32MemBaseAddr, MS_U8 u8MIU_Select, MS_U8 u8IdxDepth, MS_BOOL bOP_On, MS_BOOL bIPS_On, MS_BOOL bIPM_On, SCALER_WIN eWindow);
...
INTERFACE void Hal_SC_WriteSWDSCommand(void *pInstance,SCALER_WIN eWindow, MS_U16 u16CmdRegAddr, MS_U16 u16CmdRegValue,ds_reg_ip_op_sel IPOP_Sel);
INTERFACE void Hal_SC_UpdateDynamicScalingCurrentIndex(void *pInstance, SCALER_WIN eWindow);
INTERFACE void Hal_SC_UpdateDynamicScalingIPcommand(void *pInstance, SCALER_WIN eWindow, MS_U16 u8index);
...
INTERFACE void MHal_XC_Set_DS_ForceI_DeInterlaceMode(void *pInstance, MS_BOOL bPmode,  MS_BOOL bIsTopField, MS_U16 u16FrameRate, SCALER_WIN eWindow);
INTERFACE void MHAL_SC_Set_DynamiScaling_OPIP_OnOff(void *pInstance, MS_BOOL bOP_On,MS_BOOL bIPS_On,MS_BOOL bIPM_On, SCALER_WIN eWindow);
#undef INTERFACE
