...
static MS_BOOL bDipIsr = FALSE,bDwin0Isr = FALSE,bDIPRotation = FALSE,bAttached = FALSE;
...
void HAL_XC_DIP_Init(void *pInstance, SCALER_DIP_WIN eWindow)
{
    ...
    {
        SC_W2BYTEMSK(0, REG_SC_BK20_18_L,BIT(15),BIT(15));
        //[15]intlac. src;[12:8]422to420 ratio;[6]dwin_en;[5:4]format(rgb888);[3]intlac_w;[2:0]frm_buf_num
        ...
        //Double buffer enable
        SC_W2BYTEMSK(0, REG_SC_BK3B_72_L,0,BIT(0));
        //enable dwin0 clk
...
void HAL_XC_DIP_EnableCaptureStream(void *pInstance, MS_BOOL bEnable,SCALER_DIP_WIN eWindow)
{
    ...
    if(bEnable == TRUE)
    {
        ...
        {
            MDrv_XC_MLoad_WriteCmd(pInstance, REG_SC_BK20_2F_L, BIT(11), BIT(11));
            MDrv_XC_MLoad_WriteCmd(pInstance, REG_SC_BK3B_73_L, BIT(1), BIT(1));
        ...
        MDrv_XC_MLoad_WriteCmd(pInstance, REG_SC_BK20_2F_L, 0, BIT(11));
...
void HAL_XC_DIP_CpatureOneFrame2(void *pInstance, SCALER_DIP_WIN eWindow)//MS_BOOL benable, SCALER_DIP_WIN eWindow)
{
    ...
    if(eWindowSource == SCALER_DIP_SOURCE_TYPE_OP_SUB)
    {
        if(bPIPmode == TRUE)
        {
            SC_W2BYTEMSK(0, REG_SC_BK20_10_L, 0 ,BIT(3));
            SC_W2BYTEMSK(0, REG_SC_BK20_18_L, (BIT(2)|BIT(13)|BIT(15)),BIT(2)|BIT(13)|BIT(15));
        }
        else
        {
            SC_W2BYTEMSK(0, REG_SC_BK20_10_L, BIT(3) ,BIT(3));
            SC_W2BYTEMSK(0, REG_SC_BK20_18_L, (BIT(13)|BIT(15)),BIT(2)|BIT(13)|BIT(15));
        }
    ...
    {
        SC_W2BYTEMSK(0, REG_SC_BK20_10_L, 0 ,BIT(3));
        SC_W2BYTEMSK(0, REG_SC_BK20_18_L, BIT(2) ,BIT(2)|BIT(13)|BIT(15));
    }
    else if(eWindowSource == SCALER_DIP_SOURCE_TYPE_DRAM)
    {
    ...
    if( eWindow == DIP_WINDOW )
    {
        ...
        {
            if(bDIPRotation)
                SC_W2BYTEMSK(0, REG_SC_BK34_6F_L, 0x0 ,BIT(15));
            //Dipr trigger
        ...
        else
        {
            ...
            SC_W2BYTEMSK(0, REG_SC_BK36_03_L, BIT(8)|BIT(9), BIT(8)|BIT(9));
        }
    }
    else if( eWindow == DWIN0_WINDOW )
    {
        ...
        {
            // Set the dwin write once   (0x03 bit:8)
            SC_W2BYTEMSK(0, REG_SC_BK3B_03_L, BIT(8)|BIT(9), BIT(8)|BIT(9));
        }
    }
...
void HAL_XC_DIP_SetDataFmt(void *pInstance, EN_DRV_XC_DWIN_DATA_FMT fmt,SCALER_DIP_WIN eWindow)
{
    ...
    else if( eWindow == DWIN0_WINDOW )
    {
        ...
        {
            //disable yc swap setting
            SC_W2BYTEMSK(0, REG_SC_BK3B_02_L,BIT(10),BIT(15)|BIT(14)|BIT(10));
            //disable 444 to 422
...
void HAL_XC_DIP_SetMiuSel(void *pInstance, MS_U8 u8MIUSel,SCALER_DIP_WIN eWindow)
{
    ...
    else if( eWindow == DWIN0_WINDOW )
    {
        // Scaler control MIU by itself
        // So MIU1 IP-select is set to 1. At this moment, MIU0 Miu select is not working.
        SC_W2BYTEMSK(0, REG_SC_BK3B_02_L, (u8MIUSel?BIT(13)|BIT(10):BIT(10)), BIT(13)|BIT(10));
...
void HAL_XC_DIP_SetAlphaValue(void *pInstance, MS_U8 u8AlphaVal,SCALER_DIP_WIN eWindow)
{
    ...
    {
        SC_W2BYTEMSK(0, REG_SC_BK3B_02_L, (u8AlphaVal)|BIT(10),BMASK(7:0)|BIT(10));
    }
    else
    {
        return;
...
void HAL_XC_DIP_SetUVSwap(void *pInstance, MS_BOOL bEnable,SCALER_DIP_WIN eWindow)
{
    ...
    SC_W2BYTEMSK(0, REG_SC_BK3B_02_L, (bDWIN0HMirror?(!bDWIN0UVSwap?BIT(14)|BIT(10):BIT(10)):(bDWIN0UVSwap?BIT(14)|BIT(10):BIT(10))) ,BIT(10)|BIT(14));
    }
    else
    {
        return;
...
void HAL_XC_DIP_SetYCSwap(void *pInstance, MS_BOOL bEnable,SCALER_DIP_WIN eWindow)
{
    ...
    SC_W2BYTEMSK(0, REG_SC_BK3B_02_L, (bDWIN0HMirror?(!bDWIN0YCSwap?BIT(15)|BIT(10):BIT(10)):(bDWIN0YCSwap?BIT(15)|BIT(10):BIT(10))) ,BIT(10)|BIT(15));
    }
    else
    {
        return;
...
void HAL_XC_DIP_CallBack(InterruptNum eIntNum)
{    
