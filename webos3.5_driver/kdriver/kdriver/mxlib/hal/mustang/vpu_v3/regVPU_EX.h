...
#define MAU1_REG_MIU_RW_TAG1                (REG_MAU1_BASE+(0x0010<<1)) //[7:0]=> read index,   [15:8]=> write index
#define MAU1_REG_REGION_MASK0_L             (REG_MAU1_BASE+(0x0013<<1))
#define MAU1_REG_REGION_MASK0_H             (REG_MAU1_BASE+(0x0014<<1))
#define MAU1_REG_REGION_START0_L            (REG_MAU1_BASE+(0x0015<<1))
#define MAU1_REG_REGION_START0_H            (REG_MAU1_BASE+(0x0016<<1))
#define MAU1_REG_REGION_END0_L              (REG_MAU1_BASE+(0x0017<<1))
#define MAU1_REG_REGION_END0_H              (REG_MAU1_BASE+(0x0018<<1))
#define MAU1_REG_REGION_MASK1_L             (REG_MAU1_BASE+(0x0019<<1))
#define MAU1_REG_REGION_MASK1_H             (REG_MAU1_BASE+(0x001a<<1))
#define MAU1_REG_REGION_START1_L            (REG_MAU1_BASE+(0x001b<<1))
#define MAU1_REG_REGION_START1_H            (REG_MAU1_BASE+(0x001c<<1))
#define MAU1_REG_REGION_END1_L              (REG_MAU1_BASE+(0x001d<<1))
#define MAU1_REG_REGION_END1_H              (REG_MAU1_BASE+(0x001e<<1))

#define MAU1_REG_REGION_EN                    (REG_MAU1_BASE+(0x001f<<1))
    #define MAU1_REG_REGION0_EN                BIT(0)
    #define MAU1_REG_REGION1_EN                BIT(1)
