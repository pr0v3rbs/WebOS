...
// Linux/TV-specific
    ...
    //#define _MFE_EAGLE_ //must define _MFE_A3_ and _MFE_AGATE_
    #define _MFE_EDISON_ //must define _MFE_A3_ and _MFE_AGATE_
    //#define _MFE_KAISER_ //must define _MFE_EDISON_
    //#define _MFE_EINSTEIN_ //must define _MFE_A3_ and _MFE_AGATE_ and _MFE_EDISON_
    #define _MFE_MUSTANG_ //must define _MFE_A3_ and _MFE_AGATE_ and _MFE_EDISON_
    //#define _MFE_NIKE_ //must define _MFE_A3_ and _MFE_AGATE_ and _MFE_EDISON_
    #define _NON_THREAD_
...
#endif
#if defined(_MFE_MUJI_)
 #define OBUF_SIZE   (2UL*1024UL*1024UL)	// Bytes
#else
 #define OBUF_SIZE   (1024UL*1024UL)	// Bytes
#endif
 #define OBUF_NUM    1UL
//#define OBUF_SIZE   306000UL	// Bytes
//#define OBUF_SIZE   128000UL	// Bytes
//#define OBUF_NUM    4UL
