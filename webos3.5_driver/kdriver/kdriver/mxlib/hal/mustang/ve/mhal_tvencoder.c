...
{
    MS_U32 u32MIUAddress;
    if(pu32RDAddress != NULL)
    {
        // { reg_miu_radr_h, reg_miu_radr_l }
        u32MIUAddress = *pu32RDAddress/BYTE_PER_WORD;
        MDrv_Write2Byte(L_BK_VE_SRC(0x01), (MS_U16)(u32MIUAddress >> 0));
        MDrv_Write2Byte(L_BK_VE_SRC(0x02), (MS_U16)(u32MIUAddress >> 16));
    }
    if(pu32WRAddress != NULL)
    {
        // { reg_miu_wadr_h, reg_miu_wadr_l }
        u32MIUAddress = *pu32WRAddress/BYTE_PER_WORD;
        MDrv_Write2Byte(L_BK_VE_SRC(0x7B), (MS_U16)(u32MIUAddress >> 0));
        MDrv_Write2Byte(L_BK_VE_SRC(0x7C), (MS_U16)(u32MIUAddress >> 16));
    }
}
