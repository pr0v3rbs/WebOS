...
//  Local Variables
//-------------------------------------------------------------------------------------------------
static MS_U32 _gMIU_MapBase = 0x1f200000;
static MS_U32 _gPM_MapBase = 0x1f000000;
...
MS_BOOL HAL_MIU_ParseOccupiedResource(void)
{
    ...
    for(u8MiuSel = E_MIU_0; u8MiuSel < MIU_MAX_DEVICE; u8MiuSel++)
    {
        ...
        for(u32index = 0; u32index < MIU_MAX_PROTECT_ID; u32index++)
        {
            u8ClientID = HAL_MIU_ReadByte(u32RegAddr + u32index) & REG_MIU_PROTECT_ID_MASK_BYTE;
...
void HAL_MIU_PrintMIUProtectArea(MS_U8 u8Blockx,MS_U8 miu_dev)
{
    ...
    if( miu_dev == 1 )
    {
        ...
        val_16 = HAL_MIU_Read2Byte(u32RegAddrStar);
        val_32 = (  ( val_16 ) | (( val1_16  ) << 4 )) << MIU_PAGE_SHIFT;
        printf("miu1 protect%d startaddr is 0x%lx\n",u8Blockx,val_32);

        //protect end address
        val_16 = HAL_MIU_Read2Byte(u32RegAddrStar+0x2);

        val_32 = ((( val_16 + 1 ) | (( val1_16  ) << 4 ) ) << MIU_PAGE_SHIFT ) - 1;
        printf("miu1 protect%d endaddr   is 0x%lx\n",u8Blockx,val_32);
...
void HAL_MIU_PrintMIUProtectInfo(void)
{
    ...
    if ( (val_8 & 0xf) != 0 )
    {
        ...
        val_16 =HAL_MIU_Read2Byte(u32MiuProtectIdEn) & REG_MIU_PROTECT_ID_MASK_2BYTE;
        if ( val_16 != 0 )
        {
    ...
    if ( (val_8 & 0xf) != 0x0 )
    {
        ...
        //protect_ID_enable information   
        u32MiuProtectIdEn= MIU1_PROTECT0_ID_ENABLE & REG_MIU_PROTECT_ID_MASK_2BYTE;
        ...
        u32MiuProtectIdEn= MIU1_PROTECT1_ID_ENABLE & REG_MIU_PROTECT_ID_MASK_2BYTE;
        val_16 =HAL_MIU_Read2Byte(u32MiuProtectIdEn);
        if ( val_16 != 0 )
        {
        ...
        u32MiuProtectIdEn= MIU1_PROTECT2_ID_ENABLE & REG_MIU_PROTECT_ID_MASK_2BYTE;
        val_16 =HAL_MIU_Read2Byte(u32MiuProtectIdEn);
        if ( val_16 != 0 )
        {
        ...
        u32MiuProtectIdEn= MIU1_PROTECT3_ID_ENABLE & REG_MIU_PROTECT_ID_MASK_2BYTE;
        val_16 =HAL_MIU_Read2Byte(u32MiuProtectIdEn);
        if ( val_16 != 0 )
        {
