...
#define REG_HWI2C_ADV_CTL               (HWI2C_REG_BASE+0x10*2)
    #define _ADV_DMA_PASS_INT               	(__BIT0)
    //start to byte delay
    #define _ADV_BYTE2BYTE_DELAY        		(__BIT3)
    //byte to stop delay 
    #define _ADV_START2B_DELAY               	(__BIT4)
    //byte to byte delay
    #define _ADV_B2STOP_DELAY              		(__BIT5)    
    //clock stregch mode and push oen 1T
    #define _ADV_CLK_STRETCH_OEN              	(__BIT6)
    #define _ADV_I2C_RSTZ                     	(__BIT8)
//byte to byte delay counter
#define REG_HWI2C_START2B_DELAY_COUNTER         (HWI2C_REG_BASE+0x11*2)
//byte to stop delay counter
#define REG_HWI2C_B2STOP_DELAY_COUNTER       	(HWI2C_REG_BASE+0x12*2)
//start to byte delay counter
#define REG_HWI2C_BYTE2BYTE_DELAY_COUNTER   	(HWI2C_REG_BASE+0x13*2)
...
#define REG_HWI2C_DMA_CMDDAT7           (HWI2C_REG_BASE+0x28*2+1)
    #define _DMA_CMDDAT7_MSK             (__BIT7)//SDA delay 2T
...
#define REG_HWI2C_DMA_RESERV            (HWI2C_REG_BASE+0x30*2)
    #define _DMA_RESERV_CTL              (__BIT4 |__BIT5 |__BIT6 |__BIT7)
//End CHIP porting
