...
static MS_PHY         _phyTSOVQiMiuOffset = 0UL;

static HalTSO_OutPad  _stOutPadCtrl;

#ifdef MSOS_TYPE_LINUX_KERNEL
static MS_U16         _u16TSORegArray[2][128];
static MS_U16         _u16TSOTopReg[3][8];
#endif
...
#define TSO0_REG(addr)              (*((volatile MS_U16*)(_virtTSORegBase + REG_CTRL_BASE_TSO + ((addr)<<2UL))))
#define TSO1_REG(addr)              (*((volatile MS_U16*)(_virtTSORegBase + REG_CTRL_BASE_TSO1 + ((addr)<<2UL))))
...
#define TSO_CLKGEN1_REG(addr)       (*((volatile MS_U16*)(_virtTSORegBase + 0x6600UL + ((addr)<<2UL))))
    #define REG_CLKGEN1_TSO_IN                          0x22UL
        #define REG_CLKGEN1_TSO_TRACE_MASK              0x000FUL
            #define REG_CLKGEN1_TSO_TRACE_DISABLE       0x0001UL
            #define REG_CLKGEN1_TSO_TRACE_INVERT        0x0002UL
            #define REG_CLKGEN1_TSO_TRACE_216M          0x0000UL
        #define REG_CLKGEN1_TSO_IN_MASK                 0x1F00UL
        #define REG_CLKGEN1_TSO_IN_SHIFT                8UL
        #define REG_CLKGEN1_TSO_IN_DISABLE              0x0100UL
        #define REG_CLKGEN1_TSO_IN_INVERT               0x0200UL
        ...
        //                                     101: Sel TS5 Clk
        //                                     110: Sel Dmd Clk
    #define REG_CLKGEN1_TSO_OUT_PHASE                   0x24UL
        #define REG_CLKGEN1_TSO_OUT_DIVNUM_MASK         0x001FUL
        #define REG_CLKGEN1_TSO_OUT_PH_TUN_NUM_MASK     0x1F00UL
        #define REG_CLKGEN1_TSO_OUT_PH_TUN_NUM_SHIFT    8UL

    #define REG_CLKGEN1_TSO_OUT_CLK                     0x25UL
        #define REG_CLKGEN1_TSO_OUT_DIV_SEL_MASK        0x0001UL
        // bit[0]    ->  0: CLK_DMPLLDIV2
        //                   1: CLK_DMPLLDIV3
        #define REG_CLKGEN1_TSO_OUT_INV                 0x0002UL
        #define REG_CLKGEN1_TSO_OUT_PHASE_TUN_ENABLE    0x0004UL
        ...
        //                     100:CLK_TS4_IN
        //                     101:CLK_TS5_IN
        #define REG_CLKGEN1_TSO_OUT_CLK_MASK            0x1F00UL
            #define REG_CLKGEN1_TSO_OUT_CLK_DISABLE     0x0100UL
            #define REG_CLKGEN1_TSO_OUT_CLK_INVERT      0x0200UL
        // bit[12:8]  ->  0: disable clock
        //                     1: invert clock
...
//#define TSO_CLKGEN2_REG(addr)       (*((volatile MS_U16*)(_virtTSORegBase + 0x1400UL + ((addr)<<2UL))))
    #define REG_CLKGEN1_TSO1_IN                         0x23UL
        #define REG_CLKGEN1_TSO1_IN_MASK                0x1F00UL
        #define REG_CLKGEN1_TSO1_IN_SHIFT               8UL
        #define REG_CLKGEN1_TSO1_IN_DISABLE             0x0100UL
        #define REG_CLKGEN1_TSO1_IN_INVERT              0x0200UL
...
#define TSO_TOP_REG(addr)           (*((volatile MS_U16*)(_virtTSORegBase + 0x3c00UL + ((addr)<<2UL))))
    #define REG_TOP_TS_OUT_CFG                          0x51UL
        #define REG_TOP_TS_OUT_MODE_MASK                0x0100UL

    #define REG_TOP_TS_CONFIG                           0x51UL
        #define REG_TOP_TS0_CONFIG_MASK                 0x0600UL
            #define REG_TOP_TS0_CONFIG_PARALLEL_IN      0x0200UL
            #define REG_TOP_TS0_CONFIG_SERIAL_IN        0x0400UL
        ...
        #define REG_TOP_TS1_CONFIG_MASK                 0x3800UL
            ...
            #define REG_TOP_TS1_CONFIG_3WIRE_MODE       0x1800UL

    #define REG_TOP_TS2_CONFIG                          0x54UL
        #define REG_TOP_TS2_CONFIG_MASK                 0x7000UL
            #define REG_TOP_TS2_CONFIG_PARALLEL_IN      0x1000UL
            #define REG_TOP_TS2_CONFIG_SERIAL_IN        0x2000UL
...
void HAL_TSO_Init(void)
{
   ...
   //enable eco bit
   _HAL_REG16_W(&(_TSOCtrl->TSO_CFG4), SET_FLAG1(_HAL_REG16_R(&(_TSOCtrl->TSO_CFG4)), TSO_TIMESTAMP_RING_BACK | TSO_LPCR_RING_BACK | TSO_INIT_STAMP_RSTART));
...
void HAL_TSO_PowerCtrl(MS_BOOL bOn)
{
    ...
    if (bOn)
    {
        // Enable TSO Trace Clock        
        s32ClkHandle = Drv_Clkm_Get_Handle("g_clk_tso_trace");      
        Drv_Clkm_Set_Clk_Source(s32ClkHandle , "CLK_TSO_TRACE_NORMAL");
...
void HAL_TSO_PowerCtrl(MS_BOOL bOn)
{
    if (bOn)
    {
        TSO_CLKGEN1_REG(REG_CLKGEN1_TSO_IN) &= ~REG_CLKGEN1_TSO_TRACE_MASK;
        TSO_CLKGEN1_REG(REG_CLKGEN1_TSO_OUT_CLK) &= ~REG_CLKGEN1_TSO_OUT_CLK_MASK;
        TSO_CLKGEN1_REG(REG_CLKGEN1_TSO_IN) &= ~REG_CLKGEN1_TSO_IN_MASK;
        TSO_CLKGEN1_REG(REG_CLKGEN1_TSO1_IN) &= ~REG_CLKGEN1_TSO1_IN_MASK;
    }
    else
    {
        TSO_CLKGEN1_REG(REG_CLKGEN1_TSO_OUT_CLK) |= REG_CLKGEN1_TSO_OUT_CLK_DISABLE;
        TSO_CLKGEN1_REG(REG_CLKGEN1_TSO_IN) |= REG_CLKGEN1_TSO_TRACE_DISABLE;
        TSO_CLKGEN1_REG(REG_CLKGEN1_TSO_IN) |= REG_CLKGEN1_TSO_IN_DISABLE;
        TSO_CLKGEN1_REG(REG_CLKGEN1_TSO1_IN) |= REG_CLKGEN1_TSO1_IN_DISABLE; 
    }
}
#endif
...
{
    if(_stOutPadCtrl.u16OutPad[u8Eng] != HAL_TSOOUT_MUX_TS1)
        return;
    
    TSO_TOP_REG(REG_TOP_TS_CONFIG) = (TSO_TOP_REG(REG_TOP_TS_CONFIG) & ~REG_TOP_TS1_CONFIG_MASK) | _stOutPadCtrl.u16TSCfgOld[u8Eng];
    TSO_TOP_REG(REG_TOP_TS_OUT_CFG) = (TSO_TOP_REG(REG_TOP_TS_OUT_CFG) & ~REG_TOP_TS_OUT_MODE_MASK) | _stOutPadCtrl.u16TSOutModeOld[u8Eng];
}
...
MS_BOOL HAL_TSO_OutPad(MS_U8 u8Eng, MS_U16* pu16OutPad, MS_BOOL bSet)
{
    if(bSet)
    {
        if(*pu16OutPad != HAL_TSOOUT_MUX_TS1)
            return FALSE;

        _stOutPadCtrl.u16OutPad[u8Eng]   = *pu16OutPad;
        _stOutPadCtrl.u16TSCfgOld[u8Eng] = TSO_TOP_REG(REG_TOP_TS_CONFIG) & REG_TOP_TS1_CONFIG_MASK;
        _stOutPadCtrl.u16TSOutModeOld[u8Eng] = TSO_TOP_REG(REG_TOP_TS_OUT_CFG) & REG_TOP_TS_OUT_MODE_MASK;
        TSO_TOP_REG(REG_TOP_TS_CONFIG)   = TSO_TOP_REG(REG_TOP_TS_CONFIG) & ~REG_TOP_TS1_CONFIG_MASK;
        TSO_TOP_REG(REG_TOP_TS_OUT_CFG)  = (TSO_TOP_REG(REG_TOP_TS_OUT_CFG) & ~REG_TOP_TS_OUT_MODE_MASK);
    }
    else
    {
...
MS_BOOL HAL_TSO_SelPad(MS_U8 u8Eng, MS_U8 u8TsIf, MS_U16 u16InPadSel, MS_BOOL bParallel)
{
    ...
    MS_U16 u16MuxReg, u16MuxRegMask;
    MS_U16 u16data = 0;

    //printf("[%s][%d] u8Eng %d, u8TsIf %d, u16InPadSel %d, bParallel %d\n", __FUNCTION__, __LINE__, (int)u8Eng, (int)u8TsIf, (int)u16InPadSel, (int)bParallel);

    // Set pad mux
    switch(u8TsIf)
    {
        case HAL_TSO_TSIF_LIVE1:
            u16MuxReg = REG_TSP5_TSOIN_MUX;
            u16MuxRegMask = REG_TSP5_TSOIN_MUX_MASK;
    ...
    switch(u16InPadSel)
    {
        ...
        case HAL_TSOIN_MUX_TSDEMOD0:
            TSP_TSP5_REG(u16MuxReg) = (TSP_TSP5_REG(u16MuxReg) & ~(u16MuxRegMask << u16RegShift)) | (u16InPadSel << u16RegShift);
            return TRUE;
    ...
    TSO_TOP_REG(u16Reg) = (TSO_TOP_REG(u16Reg) & ~u16RegMask) | u16data;
...
MS_BOOL HAL_TSO_Set_InClk(MS_U8 u8Eng, MS_U8 u8TsIf, MS_U16 u16ClkSel, MS_BOOL bClkInvert, MS_BOOL bEnable)
{
    ...
    {
        case HAL_TSO_TSIF_LIVE1:
            u16Reg = REG_CLKGEN1_TSO_IN;
            u16RegMask = REG_CLKGEN1_TSO_IN_MASK;
            u16RegShift = REG_CLKGEN1_TSO_IN_SHIFT;
            u16value = TSO_CLKGEN1_REG(u16Reg) & ~u16RegMask;
            break;
        case HAL_TSO_TSIF_LIVE2:
            u16Reg = REG_CLKGEN1_TSO1_IN;
            u16RegMask = REG_CLKGEN1_TSO1_IN_MASK;
            u16RegShift = REG_CLKGEN1_TSO1_IN_SHIFT;
            u16value = TSO_CLKGEN1_REG(u16Reg) & ~u16RegMask;
            break;
        default:
            return FALSE;
    ...
    if(!bEnable)
    {
        u16value |= ((REG_CLKGEN1_TSO1_IN_DISABLE << u16RegShift) & 0xFFFFUL);
    }
    else
    {
        ...
        if(bClkInvert)
        {
            u16value |= ((REG_CLKGEN1_TSO1_IN_INVERT << u16RegShift) & 0xFFFFUL);
        }
    }
    ...
    {
        case HAL_TSO_TSIF_LIVE1:
            TSO_CLKGEN1_REG(u16Reg) = u16value;
            break;
        case HAL_TSO_TSIF_LIVE2:
            TSO_CLKGEN1_REG(u16Reg) = u16value;
            break;
...
MS_BOOL HAL_TSO_GetInputTSIF_Status(MS_U8 u8Eng, MS_U8 u8TsIf, MS_U16* pu16Pad, MS_BOOL* pbClkInvert, MS_BOOL* pbExtSync, MS_BOOL* pbParl)
{
    ...
    {
        case HAL_TSO_TSIF_LIVE1:
            u16Reg = REG_TSP5_TSOIN_MUX;
            u16RegMask = REG_TSP5_TSOIN_MUX_MASK;
            u16RegShift = REG_TSP5_TSOIN0_MUX_SHIFT;
            break;
        case HAL_TSO_TSIF_LIVE2:
            u16Reg = REG_TSP5_TSOIN_MUX;
    ...
    *pu16Pad = (TSP_TSP5_REG(u16Reg) & (u16RegMask << u16RegShift)) >> u16RegShift;

    switch(u8TsIf)
    {
        case HAL_TSO_TSIF_LIVE1:
            u16data = (TSO_CLKGEN1_REG(REG_CLKGEN1_TSO_IN) & REG_CLKGEN1_TSO_IN_MASK) >> REG_CLKGEN1_TSO_IN_SHIFT;
            reg16 = &(_TSOCtrl->TSO_CH0_IF1_CFG2);
            break;
        case HAL_TSO_TSIF_LIVE2:
            u16data = (TSO_CLKGEN1_REG(REG_CLKGEN1_TSO1_IN) & REG_CLKGEN1_TSO1_IN_MASK) >> REG_CLKGEN1_TSO1_IN_SHIFT;
    ...
    *pbClkInvert = ((u16data & REG_CLKGEN1_TSO1_IN_INVERT) == REG_CLKGEN1_TSO1_IN_INVERT);
...
MS_BOOL HAL_TSO_Set_TSOOut_Phase_Tune(MS_U8 u8Eng, MS_U16 u16ClkOutPhase, MS_BOOL bPhaseEnable)
{
    ...
    if(!bPhaseEnable)
    {
        TSO_CLKGEN1_REG(REG_CLKGEN1_TSO_OUT_CLK) &= ~REG_CLKGEN1_TSO_OUT_PHASE_TUN_ENABLE;
    }
    else
    {
        u16value = (TSO_CLKGEN1_REG(REG_CLKGEN1_TSO_OUT_PHASE) & ~REG_CLKGEN1_TSO_OUT_PH_TUN_NUM_MASK)
                    | (u16ClkOutPhase << REG_CLKGEN1_TSO_OUT_PH_TUN_NUM_SHIFT);

        TSO_CLKGEN1_REG(REG_CLKGEN1_TSO_OUT_PHASE) = u16value;
        TSO_CLKGEN1_REG(REG_CLKGEN1_TSO_OUT_CLK) |= REG_CLKGEN1_TSO_OUT_PHASE_TUN_ENABLE;
    }
...
MS_BOOL HAL_TSO_PreTsoOutClk(MS_U8 u8Eng, MS_U16* pu16PreTsoOutSel, MS_BOOL bSet)
{
    if(bSet == TRUE)
    {
        if(*pu16PreTsoOutSel > HAL_PRE_TSO_OUT_SEL_TS2IN)
        {
            return FALSE;
        }

        TSO_CLKGEN1_REG(REG_CLKGEN1_TSO_OUT_CLK) =
        (TSO_CLKGEN1_REG(REG_CLKGEN1_TSO_OUT_CLK) & ~REG_CLKGEN1_TSO_OUT_PRE_CLK_MASK) | (*pu16PreTsoOutSel << REG_CLKGEN1_TSO_OUT_PRE_CLK_SHIFT);
    }
    else
    {
        *pu16PreTsoOutSel = (TSO_CLKGEN1_REG(REG_CLKGEN1_TSO_OUT_CLK) & REG_CLKGEN1_TSO_OUT_PRE_CLK_MASK) >> REG_CLKGEN1_TSO_OUT_PRE_CLK_SHIFT;
    }
...
MS_BOOL HAL_TSO_TSOOutDiv(MS_U8 u8Eng, MS_U16* pu16ClkOutDivSrcSel, MS_U16 *pu16ClkOutDivNum, MS_BOOL bSet)
{
    ...
    if(bSet == TRUE)
    {
        TSO_CLKGEN1_REG(REG_CLKGEN1_TSO_IN) =
            (TSO_CLKGEN1_REG(REG_CLKGEN1_TSO_IN) & ~REG_CLKGEN1_TSO_TRACE_MASK) | REG_CLKGEN1_TSO_TRACE_216M;

        TSO_CLKGEN1_REG(REG_CLKGEN1_TSO_OUT_CLK) =
            (TSO_CLKGEN1_REG(REG_CLKGEN1_TSO_OUT_CLK) & ~REG_CLKGEN1_TSO_OUT_DIV_SEL_MASK) | (*pu16ClkOutDivSrcSel);
        
        TSO_CLKGEN1_REG(REG_CLKGEN1_TSO_OUT_PHASE) =
            (TSO_CLKGEN1_REG(REG_CLKGEN1_TSO_OUT_PHASE) & ~REG_CLKGEN1_TSO_OUT_DIVNUM_MASK) | (*pu16ClkOutDivNum);
    }
    else
    {
        *pu16ClkOutDivSrcSel = TSO_CLKGEN1_REG(REG_CLKGEN1_TSO_OUT_CLK) & REG_CLKGEN1_TSO_OUT_DIV_SEL_MASK;
        *pu16ClkOutDivNum = TSO_CLKGEN1_REG(REG_CLKGEN1_TSO_OUT_PHASE) & REG_CLKGEN1_TSO_OUT_DIVNUM_MASK;
    }
...
{
    MS_U16 u16Clk = TSO_CLKGEN1_REG(REG_CLKGEN1_TSO_OUT_CLK) & ~REG_CLKGEN1_TSO_OUT_CLK_MASK;

    if(bSet == TRUE)
    {
        if(*pbEnable == FALSE)
        {
            u16Clk |= REG_CLKGEN1_TSO_OUT_CLK_DISABLE;
        }
        else
        {
            TSO_CLKGEN1_REG(REG_CLKGEN1_TSO_IN) =
            ...
            if(*pbClkInvert)
            u16Clk |= REG_CLKGEN1_TSO_OUT_CLK_INVERT;

        }
        TSO_CLKGEN1_REG(REG_CLKGEN1_TSO_OUT_CLK) = u16Clk;
    }
    else
    {
        *pbEnable = ((u16Clk & REG_CLKGEN1_TSO_OUT_CLK_DISABLE) == 0);
        *pbClkInvert = ((u16Clk & REG_CLKGEN1_TSO_OUT_CLK_INVERT) == REG_CLKGEN1_TSO_OUT_CLK_INVERT);
...
{
    MS_U16 u32data = (((MS_U32)u16OldPid) & REP_PIDFLT_ORG_PID_MASK) | (((MS_U32)u8TsIf) << REP_PIDFLT_SRC_SHIFT) |
                        ((((MS_U32)u16NewPid) << REP_PIDFLT_NEW_PID_SHIFT) & REP_PIDFLT_NEW_PID_MASK);

    _HAL_REG32_W(&(_TSOCtrl->REP_PidFlt[u16FltId]), u32data);
...
MS_BOOL HAL_TSO_Set_Filein_MOBFKey(MS_U8 u8FileEng, MS_U32 u32Key, MS_BOOL bSecured)
{
    ...
    REG16* pReg = &(_TSOCtrl->TSO_Filein_Ctrl);
...
MS_BOOL HAL_TSO_Filein_Enable(MS_U8 u8Eng, MS_U8 u8FileEng, MS_BOOL bEnable)
{
    if(bEnable)
    {
        _HAL_REG16_W(&(_TSOCtrl->TSO_CFG1), SET_FLAG1(_HAL_REG16_R(&(_TSOCtrl->TSO_CFG1)), TSO_CFG1_TSO_TSIF5_EN));
    ...
    {
        _HAL_REG16_W(&(_TSOCtrl->TSO_CFG1), RESET_FLAG1(_HAL_REG16_R(&(_TSOCtrl->TSO_CFG1)), TSO_CFG1_TSO_TSIF5_EN));
        _HAL_REG16_W(&(_TSOCtrl->TSO_FILE_CFG[u8FileEng]),
...
void HAL_TSO_Filein_192Mode_Enable(MS_U8 u8Eng, MS_U8 u8FileEng, MS_BOOL bEnable)
{
    ...
    {
        //init timestamp
        _HAL_REG16_W(&(_TSOCtrl->TSO_FILE_CFG[u8FileEng]), SET_FLAG1(_HAL_REG16_R(&_TSOCtrl->TSO_FILE_CFG[u8FileEng]), TSO_FICFG_INIT_TIMESTAMP));
        _HAL_REG16_W(&(_TSOCtrl->TSO_FILE_CFG[u8FileEng]), RESET_FLAG1(_HAL_REG16_R(&_TSOCtrl->TSO_FILE_CFG[u8FileEng]), TSO_FICFG_INIT_TIMESTAMP));
...
{
    return (_HAL_REG16_R(&(_TSOCtrl->TSO_CMDQ_STATUS)) & TSO_CMDQ_STS_WCNT_MASK);
}

MS_BOOL HAL_TSO_CmdQ_FIFO_IsFull(MS_U8 u8Eng, MS_U8 u8FileEng)
{
    return (MS_BOOL)(_HAL_REG16_R(&(_TSOCtrl->TSO_CMDQ_STATUS)) & TSO_CMDQ_STS_FIFO_FULL);
}

MS_BOOL HAL_TSO_CmdQ_FIFO_IsEmpty(MS_U8 u8Eng, MS_U8 u8FileEng)
{
    return (MS_BOOL)(_HAL_REG16_R(&(_TSOCtrl->TSO_CMDQ_STATUS)) & TSO_CMDQ_STS_FIFO_EMPTY);
}

MS_U8 HAL_TSO_CmdQ_FIFO_Get_WRLevel(MS_U8 u8Eng, MS_U8 u8FileEng)
{
    return (MS_U8)(_HAL_REG16_R(&(_TSOCtrl[u8Eng].TSO_CMDQ_STATUS)) & TSO_CMDQ_STS_WLEVEL_MASK);
}

MS_BOOL HAL_TSO_CmdQ_Reset(MS_U8 u8Eng, MS_U8 u8FileEng)
{
    _HAL_REG16_W(&(_TSOCtrl->SW_RSTZ), SET_FLAG1(_HAL_REG16_R(&(_TSOCtrl->SW_RSTZ)), TSO_SW_RSTZ_CMDQ));
    _HAL_REG16_W(&(_TSOCtrl->SW_RSTZ), RESET_FLAG1(_HAL_REG16_R(&(_TSOCtrl->SW_RSTZ)), TSO_SW_RSTZ_CMDQ));
...
void HAL_TSO_Filein_PktChkSize_Set(MS_U8 u8Eng, MS_U8 u8FileEng, MS_U8 u8size)
{
    ...
    u16temp = _HAL_REG16_R(&(_TSOCtrl->TSO_PKT_CHKSIZE_FI)) & ~(TSO_PKT_CHKSIZE_FI_MASK);
    u16temp |= ((MS_U16)(u8size & 0xFF));
...
MS_BOOL HAL_TSO_ChIf_Enable(MS_U8 u8Eng, MS_U8 u8ChIf, MS_BOOL bEnable)
{
    ...
    if(bEnable)
    {
        _HAL_REG16_W(pReg, SET_FLAG1(_HAL_REG16_R(pReg), u16data));
    }
    else
    {
        _HAL_REG16_W(pReg, RESET_FLAG1(_HAL_REG16_R(pReg), u16data));
    }
...
MS_BOOL HAL_TSO_ChIf_Ng_Protocol_ID(MS_U8 u8Eng, MS_U8 u8ChIf, MS_U16 u16ID)
{
    REG32* p32Reg = NULL;
    ...
    {
        case HAL_TSO_TSIF_LIVE1:
            p32Reg = &(_TSOCtrl1->TSO_DONGLE_TSIF1);            
            break;
        case HAL_TSO_TSIF_LIVE2:
            p32Reg = &(_TSOCtrl1->TSO_DONGLE_TSIF5);
            break;
        default:
            return FALSE;
    }
    _HAL_REG32_W(p32Reg, (_HAL_REG32_R(p32Reg) & ~TSO_DONGLE_PROTOCAL_ID_MASK) | (u16ID<<TSO_DONGLE_PROTOCAL_ID_SHIFT));

    return TRUE;    
}

MS_BOOL HAL_TSO_ChIf_Ng_Stream_ID(MS_U8 u8Eng, MS_U8 u8ChIf, MS_U16 u16ID)
{
    REG32* p32Reg = NULL;
    ...
    _HAL_REG32_W(p32Reg, (_HAL_REG32_R(p32Reg) & ~TSO_DONGLE_STREAM_ID_MASK) | (u16ID<<TSO_DONGLE_STREAM_ID_SHIFT));
    return TRUE;    
}
...
MS_BOOL HAL_TSO_SaveRegs(void)
{
    ...
    _u16TSORegArray[0][0x04] = TSO0_REG(0x04);
    _u16TSORegArray[0][0x05] = TSO0_REG(0x05);
    _u16TSORegArray[0][0x06] = TSO0_REG(0x06);

    _u16TSORegArray[0][0x14] = TSO0_REG(0x14);
    _u16TSORegArray[0][0x15] = TSO0_REG(0x15);
    _u16TSORegArray[0][0x16] = TSO0_REG(0x16);

    _u16TSORegArray[0][0x18] = TSO0_REG(0x18);
    _u16TSORegArray[0][0x19] = TSO0_REG(0x19);
    _u16TSORegArray[0][0x1a] = TSO0_REG(0x1a);
    
    for(u32ii = 0x1c; u32ii <= 0x44; u32ii++)
    {
        _u16TSORegArray[0][u32ii] = TSO0_REG(u32ii);
    }

    _u16TSORegArray[0][0x4c] = TSO0_REG(0x4c);
    _u16TSORegArray[0][0x4d] = TSO0_REG(0x4d);

    for(u32ii = 0x60; u32ii <= 0x6f; u32ii++)
    {
        _u16TSORegArray[0][u32ii] = TSO0_REG(u32ii);
    }

    _u16TSORegArray[0][0x79] = TSO0_REG(0x79);
    _u16TSORegArray[0][0x7a] = TSO0_REG(0x7a);
    _u16TSORegArray[0][0x7b] = TSO0_REG(0x7b);
    _u16TSORegArray[0][0x7c] = TSO0_REG(0x7c);

    //TSO1
    _u16TSORegArray[1][0x00] = TSO1_REG(0x00);
    _u16TSORegArray[1][0x10] = TSO1_REG(0x10);
    _u16TSORegArray[1][0x14] = TSO1_REG(0x14);

    for(u32ii = 0x18; u32ii <= 0x1b; u32ii++)
    {
        _u16TSORegArray[1][u32ii] = TSO1_REG(u32ii);
    }

    for(u32ii = 0x28; u32ii <= 0x33; u32ii++)
    {
        _u16TSORegArray[1][u32ii] = TSO1_REG(u32ii);
    }

    _u16TSOTopReg[0][0] =  TSO_CLKGEN1_REG(REG_CLKGEN1_TSO_IN);
    _u16TSOTopReg[0][1] =  TSO_CLKGEN1_REG(REG_CLKGEN1_TSO_OUT_PHASE);
    _u16TSOTopReg[0][2] =  TSO_CLKGEN1_REG(REG_CLKGEN1_TSO_OUT_CLK);
    _u16TSOTopReg[0][3] =  TSO_CLKGEN1_REG(REG_CLKGEN1_TSO1_IN);
    _u16TSOTopReg[0][4] =  TSP_TS_SAMPLE_REG(REG_TSO_OUT_CLK_SEL);

    _u16TSOTopReg[1][1] =  TSO_TOP_REG(REG_TOP_TS_OUT_CFG);
    _u16TSOTopReg[1][2] =  TSO_TOP_REG(REG_TOP_TS_CONFIG);
    _u16TSOTopReg[1][3] =  TSO_TOP_REG(REG_TOP_TS2_CONFIG);

    _u16TSOTopReg[2][0] =  TSP_TSP5_REG(REG_TSP5_TSOIN_MUX);
    _u16TSOTopReg[2][1] =  TSP_TSP5_REG(REG_TSP5_TSOOUT_MUX);
...
{
    MS_U32 u32ii = 0, u32jj, u32temp = 0;

    
    TSO_CLKGEN1_REG(REG_CLKGEN1_TSO_IN) = _u16TSOTopReg[0][0];
    TSO_CLKGEN1_REG(REG_CLKGEN1_TSO_OUT_PHASE) = _u16TSOTopReg[0][1];
    TSO_CLKGEN1_REG(REG_CLKGEN1_TSO_OUT_CLK) = _u16TSOTopReg[0][2];
    TSO_CLKGEN1_REG(REG_CLKGEN1_TSO1_IN) = _u16TSOTopReg[0][3];
    TSP_TS_SAMPLE_REG(REG_TSO_OUT_CLK_SEL) = _u16TSOTopReg[0][4];

    TSO_TOP_REG(REG_TOP_TS_OUT_CFG) = _u16TSOTopReg[1][1];
    TSO_TOP_REG(REG_TOP_TS_CONFIG) = _u16TSOTopReg[1][2] ;
    TSO_TOP_REG(REG_TOP_TS2_CONFIG) = _u16TSOTopReg[1][3];

    TSP_TSP5_REG(REG_TSP5_TSOIN_MUX) = _u16TSOTopReg[2][0];
    TSP_TSP5_REG(REG_TSP5_TSOOUT_MUX) = _u16TSOTopReg[2][1];

    TSO0_REG(0x04) = _u16TSORegArray[0][0x04];
    TSO0_REG(0x05) = _u16TSORegArray[0][0x05];
    TSO0_REG(0x06) = _u16TSORegArray[0][0x06];

    for(u32ii = 0; u32ii < TSO_FILE_IF_NUM; u32ii++)
    {
        TSO0_REG(u32temp+0x14) = _u16TSORegArray[0][u32temp+0x14];
        TSO0_REG(u32temp+0x15) = _u16TSORegArray[0][u32temp+0x15];
        TSO0_REG(u32temp+0x16) = _u16TSORegArray[0][u32temp+0x16];
        u32temp += 4;
    }
    
    for(u32ii = 0x1c; u32ii <= 0x3f; u32ii++)
    {
        TSO0_REG(u32ii) = _u16TSORegArray[0][u32ii];
    }
    
    TSO0_REG(0x43) = _u16TSORegArray[0][0x43] & ~0x0004;
    TSO0_REG(0x44) = _u16TSORegArray[0][0x44];

    for(u32ii = 0; u32ii < TSO_FILE_IF_NUM; u32ii++)
    {
        TSO0_REG(u32ii+0x4c) = _u16TSORegArray[0][u32ii+0x4c];
    }

    u32temp = 0;
    for(u32ii = 0; u32ii < TSO_FILE_IF_NUM; u32ii++)
    {
        TSO0_REG(u32temp+0x60) = _u16TSORegArray[0][u32temp+0x60];
        TSO0_REG(u32temp+0x61) = _u16TSORegArray[0][u32temp+0x61];
        TSO0_REG(u32temp+0x62) = _u16TSORegArray[0][u32temp+0x62];    
        TSO0_REG(u32temp+0x63) = _u16TSORegArray[0][u32temp+0x63];
        u32temp += 5;
    }

    TSO0_REG(0x6a) = _u16TSORegArray[0][0x6a];
    TSO0_REG(0x6b) = _u16TSORegArray[0][0x6b];

    for(u32ii = 0; u32ii < TSO_FILE_IF_NUM; u32ii++)
    {
        TSO0_REG(u32ii+0x79) = _u16TSORegArray[0][u32ii+0x79];
    }
    TSO0_REG(0x7b) = _u16TSORegArray[0][0x7b];
    TSO0_REG(0x7c) = _u16TSORegArray[0][0x7c];

    //TSO1     
    TSO1_REG(0x00) = _u16TSORegArray[1][0x00];

    for(u32ii = 0; u32ii < TSO_FILE_IF_NUM; u32ii++)
    {
        TSO1_REG(u32temp+0x10) = _u16TSORegArray[1][u32temp+0x10];
        u32temp += 4;
    }

    TSO1_REG(0x18) = _u16TSORegArray[1][0x18];
    TSO1_REG(0x19) = _u16TSORegArray[1][0x19];
    TSO1_REG(0x1a) = _u16TSORegArray[1][0x1a];
    TSO1_REG(0x1b) = _u16TSORegArray[1][0x1b] & ~TSO_SVQ_TX_CFG_SVQ_EN;  //disable SVQ fisr    

    u32temp =0;
    for(u32ii = 0; u32ii < TSO_FILE_IF_NUM; u32ii++)
    {
        TSO1_REG(u32temp+0x28) = _u16TSORegArray[1][u32temp+0x28];
        TSO1_REG(u32temp+0x29) = _u16TSORegArray[1][u32temp+0x29];
        TSO1_REG(u32temp+0x2a) = _u16TSORegArray[1][u32temp+0x2a];        
        TSO1_REG(u32temp+0x2b) = _u16TSORegArray[1][u32temp+0x2b] & ~TSO_SVQ_TX_CFG_SVQ_EN;  //disable SVQ first    
        u32temp += 4;
    }
    for(u32ii = 0x30; u32ii <= 0x33; u32ii++)
    {
        TSO1_REG(u32ii) = _u16TSORegArray[1][u32ii];
    }

    //enable SVQ
    if(_u16TSORegArray[1][0x1b] & TSO_SVQ_TX_CFG_SVQ_EN)
    {
        TSO1_REG(0x1b) |= TSO_SVQ_TX_CFG_TX_RESET;
        TSO1_REG(0x1b) &= ~TSO_SVQ_TX_CFG_TX_RESET;
        TSO1_REG(0x2b) |= TSO_SVQ_TX_CFG_TX_RESET;
        TSO1_REG(0x2b) &= ~TSO_SVQ_TX_CFG_TX_RESET;
        TSO1_REG(0x2f) |= TSO_SVQ_TX_CFG_TX_RESET;
        TSO1_REG(0x2f) &= ~TSO_SVQ_TX_CFG_TX_RESET;
        
        TSO1_REG(0x1b) |= TSO_SVQ_TX_CFG_SVQ_EN;
    }
    
    if(_u16TSORegArray[0][0x43] & 0x0004)
    {
        TSO0_REG(0x43) |= 0x0004;
        TSO0_REG(0x43) &= ~0x0004;
    }

    //enable TSO setting
    TSO0_REG(0x1d) |= TSO_CFG1_PKT_PARAM_LD;
    TSO0_REG(0x1d) &= ~TSO_CFG1_PKT_PARAM_LD;
    
    //set lpcr2, TSO file in start
    u32temp = 0;
    u32jj = 0;
    for(u32ii = 0; u32ii < TSO_FILE_IF_NUM; u32ii++)
    {
        if(_u16TSORegArray[0][u32temp+0x64] & 0x0003)
        {
            TSO0_REG(u32ii+0x79) = _u16TSORegArray[0][u32ii+0x79] | TSO_FICFG_LPCR2_WLD;
            TSO0_REG(u32jj+0x6c) = _u16TSORegArray[0][u32jj+0x6c];
            TSO0_REG(u32jj+0x6d) = _u16TSORegArray[0][u32jj+0x6d];
            TSO0_REG(u32ii+0x79) = _u16TSORegArray[0][u32ii+0x79] & ~TSO_FICFG_LPCR2_WLD;
            TSO0_REG(u32temp+0x64) = _u16TSORegArray[0][u32temp+0x64];
        }
        u32temp += 5;
        u32jj += 2;
    }
