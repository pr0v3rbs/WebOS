...
#define OutOfRange_PWS_Items 94
...
static const MS_U16 pws_table[] =
{
  ...
  0xFFEF, /*P1_PD_CLKIN*/
  0xFFF7, /*P2_PD_CLKIN*/
  0xFFDF, /*P0_PD_CLKIN_OFFL*/
  0xFFEF, /*P1_PD_CLKIN_OFFL*/
  0xFFF7, /*P2_PD_CLKIN_OFFL*/
  0xFFDF, /*P0_PD_DM[2:0]*/
  0xFFEF, /*P1_PD_DM[2:0]*/
  0xFFF7, /*P2_PD_DM[2:0]*/
  0xFFDF, /*PD_RD0[2:0]*/
  ...
  0xFFEF, /*PD_RCK[1]*/
  0xFFF7, /*PD_RCK[2]*/
  0xFFDF, /*PD_P0_DPLPHI[2:0]*/
  0xFFEF, /*PD_P1_DPLPHI[2:0]*/
  0xFFF7, /*PD_P2_DPLPHI[2:0]*/
  0xFFDF, /*PD_P0_DPLPHQ[2:0]*/
  0xFFEF, /*PD_P1_DPLPHQ[2:0]*/
  0xFFF7, /*PD_P2_DPLPHQ[2:0]*/
  0xFFDF, /*P0_PD_CAL*/
  0xFFEF, /*P1_PD_CAL*/
  0xFFF7, /*P2_PD_CAL*/
  0xFFDF, /*P0_PD_IBIAS*/
...
#define OutOfRange_PWS_Init_Items 16
...
static const MS_U16 pws_init_table[] =
{
  ...
  0xFFFF, /*P3_PD_DVIPLL*/
  0xFFFF, /*P3_PD_CLKIN*/
  0xFFFF, /*P3_PD_CLKIN_OFFL*/
  0xFFFF, /*P3_PD_DM[2:0]*/
  0xFFFF, /*PD_RD3[2:0]*/
  0xFFFF, /*PD_RCK[3]*/
  0xFFFF, /*PD_P3_DPLPHI[2:0]*/
  0xFFFF, /*PD_P3_DPLPHQ[2:0]*/
  0xFFFF, /*P3_PD_CAL*/
  0xFFFF, /*P3_PD_IBIAS*/
};
