...
//-------------------------------------------------------------------------------------------------
#if defined (__aeon__)
#define RIU_MAP pGEHalLocal->u32_mmio_base
#else
#define RIU_MAP pGEHalLocal->u32_mmio_base
#endif
/* Chip Reversion*/
#define CHIP_REG_BASE               0x1E00  // 0x1E00 - 0x1EFF
#define CHIP_CLK_BASE               0x0B00  // 0x1E00 - 0x1EFF
#define GHIP_REVERSION              (0x02)
#define CHIP_GE_CLK                 (0x48)
#define MIU1_REG_BASE               0x0600
#define MIU_SELETE_OFFSET			31
...
#define REG_GE_BASE                 (0xBF800000+(0x1400<<2)) // 0xbf805000
//#define GE_REG(addr)                (*((volatile MS_U16*)(REG_GE_BASE + ((addr)<<2))))
#define MIU1_GEGROUP                 0x79
#define MIU1_GE_CLIENT             BIT(0)
#define MIU1_REG(addr)             RIU[ ((addr*2) + 0x600)]
#define GE_REG(addr)                 RIU[ ((addr*2) + 0x2800)]
#define GE2_REG(addr)                 RIU[ ((addr*2) + 0x62800)]

#define REG_GE_EN                   0x0000
...
#define REG_GE_TH                   0x0003
    #define GE_TH_STBB_MASK                     BMASK(3:0)
    #define GE_TH_CMDQ_MASK                     BMASK(7:4)              //[OBERON]
    #define GE_TH_CMDQ2_MASK                    BMASK(11:8)             //[OBERON]
#define REG_GE_VCMDQ_STAT           0x0004                              //[OBERON] virtual queue status [15:0]
#define REG_GE_BIST_STAT            0x0005
    #define GE_VCMDQ_STAT_H_MASK                BMASK(0:0)              //[OBERON] virtual queue status [16]
    #define GE_STAT_VCMDQ_MAX                    131071
#define REG_GE_STAT                 0x0007
    #define GE_STAT_BUSY                        BIT(0)
    #define GE_STAT_CMDQ2_MASK                  BMASK(7:3)
    #define GE_STAT_CMDQ2_SHFT                  3
    #define GE_STAT_CMDQ2_MAX                   16
    #define GE_STAT_CMDQ_MASK                   BMASK(15:11)
    #define GE_STAT_CMDQ_SHFT                   11
    #define GE_STAT_CMDQ_MAX                    16
#define REG_GE_MIU_PROT_LTH_L(_miu) (0x0008+(_miu<<2))
#define REG_GE_MIU_PROT_LTH_H(_miu) (0x0009+(_miu<<2))
    #define GE_MIU_PROT_LTH_H_MASK              BMASK(10:0)
    #define GE_MIU_PROT_MODE_MASK               BIT(15)
    #define GE_MIU_PROT_MODE_SHFT               15
...
#define REG_GE_ROP2                 0x0010
    #define GE_ROP2_MASK                        BMASK(3:0)
#define REG_GE_BLEND                0x0011 // source coefficient of alpha blending
...
#define REG_GE_ALPHA                0x0012
    #define GE_ALPHA_MASK                       BMASK(12:8)
    #define GE_ALPHA_SHFT                       8
    #define GE_ALPHA_CONST                      BITS(12:8, 0)
    #define GE_ALPHA_ASRC                       BITS(12:8, 1)
    #define GE_ALPHA_ADST                       BITS(12:8, 2)
    #define GE_ALPHA_ROP8_SRC                   BITS(12:8, 3)
    #define GE_ALPHA_ROP8_IN                    BITS(12:8, 4)           //[OBERON]
    #define GE_ALPHA_ROP8_DSTOUT                BITS(12:8, 5)           //[OBERON]
    #define GE_ALPHA_ROP8_SRCOUT                BITS(12:8, 6)           //[OBERON]
    #define GE_ALPHA_ROP8_OVER                  BITS(12:8, 7)           //[OBERON]
#if (EUCLID_BRINGUP==1)
    #define GE_ALPHA_N_CONST                    BITS(12:8, 8)           //[Euclid] Csrc*Aconst
    #define GE_ALPHA_N_ASRC                     BITS(12:8, 9)           //[Euclid] Csrc*Aconst
    #define GE_ALPHA_N_ADST                     BITS(12:8, 10)          //[Euclid] Csrc*Aconst
    #define GE_ALPHA_NEW1                       BITS(12:8, 11)          //[Euclid] Csrc*Aconst
    #define GE_ALPHA_NEW2                       BITS(12:8, 12)          //[Euclid] Csrc*Aconst
    #define GE_ALPHA_NEW3                       BITS(12:8, 13)          //[Euclid] Csrc*Aconst
    #define GE_ALPHA_NEW4                       BITS(12:8, 14)          //[Euclid] Csrc*Aconst
    #define GE_ALPHA_NEW5                       BITS(12:8, 15)          //[Euclid] Csrc*Aconst
#endif
#define REG_GE_ALPHA_CONST          0x0013
    #define GE_ALPHA_CONST_MASK                 BMASK(7:0)
    #define GE_ALPHA_SRCMASK_MASK               BMASK(15:8)

#define REG_GE_SCK_HTH_L            0x0014      //ARGB8888(32), CrYCb, BLINK(16), I8(8)
#define REG_GE_SCK_HTH_H            0x0015      //
#define REG_GE_SCK_LTH_L            0x0016      //ARGB8888(32), CrYCb, BLINK(16), I8(8)
#define REG_GE_SCK_LTH_H            0x0017      //
#define REG_GE_DCK_HTH_L            0x0018      //ARGB8888(32), CrYCb, BLINK(16), I8(8)
#define REG_GE_DCK_HTH_H            0x0019      //
#define REG_GE_DCK_LTH_L            0x001A      //ARGB8888(32), CrYCb, BLINK(16), I8(8)
#define REG_GE_DCK_LTH_H            0x001B      //
#define REG_GE_OP_MODE              0x001C
    #define GE_OP_SCK_SHFT                      0
    #define GE_OP_SCK_NE                        BIT(0) //
    #define GE_OP_DCK_SHFT                      1
    #define GE_OP_DCK_NE                        BIT(1) //
    #define GE_OP_ACMP_SHFT                     4
    #define GE_OP_ACMP_MIN                      BIT(4) // MIN(Asrc,Adst)
    #define GE_OP_ATEST_SHFT                    5
    #define GE_OP_ATEST_NE                      BIT(5)
    #define GE_SRCCOLOR_MASK_B                  BMASK(15:8)
    #define GE_SRCCOLOR_MASK_B_SHIFT            8
#define REG_GE_ATEST_TH             0x001D
    #define GE_ATEST_HTH_MASK                   BMASK(7:0)
    #define GE_ATEST_LTH_MASK                   BMASK(15:8)
#define REG_GE_SRCMASK_GB           0x001E
    #define GE_SRCCOLOR_MASK_G                  BMASK(7:0)
    #define GE_SRCCOLOR_MASK_G_SHIFT            0
    #define GE_SRCCOLOR_MASK_R                  BMASK(15:8)
    #define GE_SRCCOLOR_MASK_R_SHIFT            8
#define REG_GE_YUV_MODE             0x001F      //[URANUS] write only
    #define GE_FMT_YVYU                         0
    #define GE_FMT_YUYV                         1
    #define GE_FMT_VYUY                         2
    #define GE_FMT_UYVY                         3
    #define GE_YUV_RGB2YUV_MASK                 BMASK(1:0)
    #define GE_YUV_RGB2YUV_SHFT                 0
    #define GE_YUV_RGB2YUV_PC                   BITS(1:0, 0)
    #define GE_YUV_RGB2YUV_255                  BITS(1:0, 1)
    #define GE_YUV_OUT_RANGE_MASK               BMASK(2)
    #define GE_YUV_OUT_RANGE_SHFT               2
    #define GE_YUV_OUT_255                      BITS(2:2, 0)
    #define GE_YUV_OUT_PC                       BITS(2:2, 1)
    #define GE_YUV_IN_RANGE_MASK                BMASK(3)
    #define GE_YUV_IN_RANGE_SHFT                3
    #define GE_YUV_IN_255                       BITS(3:3, 0)
    #define GE_YUV_IN_127                       BITS(3:3, 1)
    #define GE_YUV_SRC_YUV422_MASK              BMASK(5:4)
    #define GE_YUV_SRC_YUV422_SHFT              4
    ...
    #define GE_YUV_DST_YUV422_SHFT              6
    ...
    #define GE_SRC_BUFFER_MIU_H_SHFT              13
    #define GE_DST_BUFFER_MIU_H_SHFT              14
#define REG_GE_SRC_BASE_L           0x0020
#define REG_GE_SRC_BASE_H           0x0021
#if (EUCLID_BRINGUP==1)
    #define GE_SB_MIU_SEL                       BIT(15) //[Euclid] Source Buffer MIU Selection
#endif
#define REG_GE_DST_BASE_L           0x0026
#define REG_GE_DST_BASE_H           0x0027
#if (EUCLID_BRINGUP==1)
    #define GE_DB_MIU_SEL                       BIT(15) //[Euclid] Destination Buffer MIU Selection
#endif

#define REG_GE_VCMDQ_BASE_L         0x0028
#define REG_GE_VCMDQ_BASE_H         0x0029
#if (EUCLID_BRINGUP==1)
    #define GE_VCMQ_MIU_SEL                     BIT(15) //[Euclid] Virtual Command Queue MIU Selection
#endif

#define REG_GE_VCMDQ_SIZE           0x002A
    #define GE_VCMDQ_SIZE_MASK                  BMASK(2:0)
    #define GE_VCMDQ_SIZE_MIN                   0x00001000 // 4KB
    #define GE_VCMDQ_SIZE_MAX                   0x00080000 // 512KB
    #define GE_VCMDQ_SIZE(_size)                ( (_size>>19) ? 7 :     \
                                                ...
                                                (_size>>14) ? 2 :     \
                                                (_size>>13) ? 1 : 0 )
#define REG_GE_DFB_BLD_OP            0x002A
    #define GE_DFB_SRC_COLORMASK                BIT(7)
    #define GE_DFB_SRC_COLORMASK_SHIFT          7
    #define GE_DFB_SRCBLD_OP_MASK               BMASK(11:8)
    #define GE_DFB_SRCBLD_OP_SHFT               8
    ...
    #define GE_DFB_DSTBLD_OP_SHFT               12
...
#define REG_GE_DFB_BLD_FLAGS        0x002B
...
#define REG_GE_B_CONST              0x002B
    #define GE_B_CONST_MASK                     BMASK(15:8)
    #define GE_B_CONST_SHIFT                    8
#define REG_GE_G_CONST              0x002C
    #define GE_G_CONST_MASK                     BMASK(7:0)
    #define GE_G_CONST_SHIFT                    0
#define REG_GE_R_CONST              0x002C
    #define GE_R_CONST_MASK                     BMASK(15:8)
    #define GE_R_CONST_SHIFT                    8
#define REG_GE_CLUT_L               0x002D
#define REG_GE_CLUT_H               0x002E
#define REG_GE_CLUT_CTRL            0x002F
    #define GE_CLUT_CTRL_IDX_MASK               BMASK(7:0)
    #define GE_CLUT_CTRL_RD                     BITS(8:8, 0)
    #define GE_CLUT_CTRL_WR                     BITS(8:8, 1)
#define REG_GE_SRC_PITCH            0x0030
#define REG_GE_TAG                  0x0032
#define REG_GE_DST_PITCH            0x0033
#define REG_GE_FMT                  0x0034
    #define GE_SRC_FMT_MASK                     BMASK(4:0)
    #define GE_SRC_FMT_SHFT                     0
    #define GE_DST_FMT_MASK                     BMASK(12:8)
    #define GE_DST_FMT_SHFT                     8
#define REG_GE_C_L(_idx)           (0x0035+(_idx<<1)) // [31:0]ARGB8888, [15:0]blink, [7:0]I8
#define REG_GE_C_H(_idx)           (0x0036+(_idx<<1))
#define REG_GE_CLIP_L               0x0055
#define REG_GE_CLIP_R               0x0056
#define REG_GE_CLIP_T               0x0057
#define REG_GE_CLIP_B               0x0058
#define REG_GE_ROT_MODE             0x0059
    #define REG_GE_ROT_MODE_MASK                BMASK(1:0)
    #define REG_GE_ROT_MODE_SHFT                0
...
#define REG_GE_BLT_SCK_MODE         0x0059
    ...
    #define GE_TRAP_DX0_MSB_SHFT                   8
    #define GE_TRAP_DX1_MSB                     BMASK(13:12)
    #define GE_TRAP_DX1_MSB_SHFT                   12

#define REG_GE_TRAPEZOID_DX0        0x005A
    #define GE_TRAP_DX0                         BMASK(15:0)
#define REG_GE_TRAPEZOID_DX1        0x005B
    #define GE_TRAP_DX1                         BMASK(15:0)
#else
#define REG_GE_BLT_SCK_MODE         0x005B
...
#endif
#define REG_GE_BLT_SCK_CONST_L      0x005C // GB
#define REG_GE_BLT_SCK_CONST_H      0x005D // R, Uranus doesn't have alpha key
#define REG_GE_BLT_DST_X_OFST       0x005E // (s.12)
#if (EUCLID_BRINGUP==1)
    #define GE_STBB_DX_MSB                    BIT(15)
    #define GE_STBB_DX_MSB_SHFT                 15
#endif
#define REG_GE_BLT_DST_Y_OFST       0x005F // (s.12)
#if (EUCLID_BRINGUP==1)
    #define GE_STBB_DY_MSB                    BIT(15)
    #define GE_STBB_DY_MSB_SHFT                 15
#endif
#define REG_GE_CMD                  0x0060
...
#define REG_GE_LINE_LENGTH          0x0063
    #define GE_LINE_LENGTH_MASK                 BMASK(11:0)
#define REG_GE_BLT_SRC_DX           0x0064  //[EUCLID] (5.12)
#define REG_GE_BLT_SRC_DY           0x0065  //[EUCLID] (5.12)
    #define GE_STBB_DXY_MASK                    BMASK(12:0)
#define REG_GE_ITALIC_OFFSET        0x0066
    #define GE_ITALIC_X_MASK                    BMASK(7:0)
    #define GE_ITALIC_X_SHFT                    0
    #define GE_ITALIC_Y_MASK                    BMASK(15:8)
    #define GE_ITALIC_Y_SHFT                    8
#define REG_GE_ITALIC_DELTA         0x0067
    #define GE_ITALIC_D_MASK                    BMASK(7:0) // (s1.3)
    #define GE_ITALIC_D_SHFT                    0
#define REG_GE_PRIM_V0_X            0x0068      //[EUCLID] COORDINATE X0 OF PRIMITIVE VERTEX 0
#define REG_GE_PRIM_V0_Y            0x0069      //[EUCLID] COORDINATE Y0 OF PRIMITIVE VERTEX 0
#define REG_GE_PRIM_V1_X            0x006A      //[EUCLID] COORDINATE X1 OF PRIMITIVE VERTEX 1
#define REG_GE_PRIM_V1_Y            0x006B      //[EUCLID] COORDINATE Y1 OF PRIMITIVE VERTEX 1
#define REG_GE_PRIM_V2_X            0x006C
#define REG_GE_PRIM_V2_Y            0x006D
#define REG_GE_BLT_SRC_W            0x006E
#define REG_GE_BLT_SRC_H            0x006F
#define REG_GE_PRIM_C_L             0x0070 // [L]:B,Bg(AXFB2355,AAFB2266),I8, [H]:G,Fg(AXFB2355,AAFB2266)
#define REG_GE_PRIM_C_H             0x0071 // [L]:R,AX(AXFB2355),Ba(AAFB2266), [H]:A,1(AXFB2355),Fa(AAFB2266)
#define REG_GE_PRIM_RDX_L           0x0072 // (s7.12)
#define REG_GE_PRIM_RDX_H           0x0073
#define REG_GE_PRIM_RDY_L           0x0074
#define REG_GE_PRIM_RDY_H           0x0075
#define REG_GE_PRIM_GDX_L           0x0076
#define REG_GE_PRIM_GDX_H           0x0077
#define REG_GE_PRIM_GDY_L           0x0078
#define REG_GE_PRIM_GDY_H           0x0079
#define REG_GE_PRIM_BDX_L           0x007A
#define REG_GE_PRIM_BDX_H           0x007B
#define REG_GE_PRIM_BDY_L           0x007C
#define REG_GE_PRIM_BDY_H           0x007D
#define REG_GE_PRIM_ADX             0x007E // (s4.11)
#define REG_GE_PRIM_ADY             0x007F

#define REG_GE_TLB_TYPE_EN             0x0000
#define GE_TLB_MODE_MASK                        BMASK(2:1)
    #define GE_TLB_SRC                          BIT(1)
    #define GE_TLB_DST                          BIT(2)
    #define GE_TLB_FLUSH                        BIT(3)

#define REG_GE_TLB_EN                  0x0001
    #define GE_TLB_EN                           BIT(0)

#define REG_GE_TLB_TAG             0x0010
    #define GE_TLB_TAG                        BMASK(5:0)

#define REG_GE_TLB_BASE_MIU_H       0x001F
    #define GE_SB_TLB_SRC_MIU_SEL_H     BIT(13)
    #define GE_SB_TLB_DST_MIU_SEL_H     BIT(14)

#define REG_GE_SRC_TLB_BASE_L           0x0020
#define REG_GE_SRC_TLB_BASE_H           0x0021
#if (EUCLID_BRINGUP==1)
    #define GE_SB_TLB_MIU_SEL                       BIT(15) //[Euclid] Source Buffer MIU Selection
#endif
#define REG_GE_DST_TLB_BASE_L           0x0022
#define REG_GE_DST_TLB_BASE_H           0x0023
#if (EUCLID_BRINGUP==1)
    #define GE_DB_TLB_MIU_SEL                       BIT(15) //[Euclid] Destination Buffer MIU Selection
#endif
