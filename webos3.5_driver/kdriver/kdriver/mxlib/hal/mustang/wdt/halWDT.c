...
MS_BOOL HAL_WDT_Write4Byte(MS_U32 u32RegAddr, MS_U32 u32Val)
{
    ...
    HAL_WDT_Write2Byte(u32RegAddr, u32Val & 0x0000FFFF);
...
//LG@LG
MS_U32 HAL_WDT_GetTimer(void)
{
    return HAL_WDT_Read4Byte(REG_WDT_MAX) / MST_XTAL_CLOCK_HZ;
}

//LG@LG
MS_U32 HAL_WDT_GetTimer_ms(void)
{
    return HAL_WDT_Read4Byte(REG_WDT_MAX) / MST_XTAL_CLOCK_KHZ;
}

//LG@LG
MS_U32 HAL_WDT_GetTimer_us(void)
{
    return HAL_WDT_Read4Byte(REG_WDT_MAX) / MST_XTAL_CLOCK_MHZ;
}
...
/// @param <GLOBAL>     \b None :
////////////////////////////////////////////////////////////////////////////////
void HAL_WDT_SetIOMapBase(MS_U32 u32Base)
{
...
/// @param <GLOBAL>     \b None :
////////////////////////////////////////////////////////////////////////////////
MS_U32 HAL_WDT_GetIOMapBase(void)
{
