...
#define FLASH_IC_EN25Q32        0x0908      // 4M
...
#define FLASH_IC_ESMT_F25L032PA 0x0A01      // 4M
#define FLASH_IC_ESMT_F25L032QA 0x0A02      // 4M

//#define FLASH_IC_EN25Q32        0x0A01      // 2M
#define FLASH_IC_EN25Q16        0x0A03      // 2M
#define FLASH_IC_GD25Q16        0x0B01      // 2M
#define FLASH_IC_GD25Q32        0x0B02      // 4M
#define FLASH_IC_GD25Q80B       0x0B03      // 8M
...
extern void HAL_SERFLASH_Config(MS_VIRT u32PMRegBaseAddr, MS_VIRT u32NonPMRegBaseAddr, MS_VIRT u32XiuBaseAddr);
...
extern MS_BOOL HAL_SERFLASH_SPSNDYB_UNLOCK(MS_U32 u32StartBlock, MS_U32 u32EndBlock);

extern MS_BOOL HAL_FSP_BlockErase(MS_U32 u32FlashAddr, EN_FLASH_ERASE eSize);

extern MS_BOOL HAL_FSP_Write(MS_U32 u32Addr, MS_U32 u32DataSize, MS_U8 *pu8Data);

extern MS_BOOL HAL_FSP_Write_Burst(MS_U32 u32Addr, MS_U32 u32Size, MS_U8 *pu8Data);

extern MS_BOOL HAL_FSP_Read(MS_U32 u32Addr, MS_U32 u32DataSize, MS_U8 *pu8Data);
extern void HAL_FSP_Entry(void);
extern void HAL_FSP_Exit(void);
