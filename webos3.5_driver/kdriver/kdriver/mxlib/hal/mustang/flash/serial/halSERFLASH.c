...
static ST_WRITE_PROTECT _pstWriteProtectTable_GD25Q80B_CMP0[] =
{
    //   BPX,                    Lower Bound         Upper Bound
    {   BITS(6:2, 1),   0x0F0000,     0x0FFFFF  }, // 63
    {   BITS(6:2, 2),   0x0E0000,     0x0FFFFF  }, // 62-63
    {   BITS(6:2, 3),   0x0C0000,     0x0FFFFF  }, // 60-63
    {   BITS(6:2, 4),   0x080000,     0x0FFFFF  }, // 56-63
    {   BITS(6:2, 9),   0x000000,     0x00FFFF  }, // 48-63
    {   BITS(6:2, 10),  0x000000,     0x01FFFF  }, // 32-63

    {   BITS(6:2, 11),  0x000000,     0x03FFFF  }, // 00
    {   BITS(6:2, 12),  0x000000,     0x07FFFF  }, // 00-01
    {   BITS(6:2, 13),  0x000000,     0x0FFFFF  }, // 00-03
    {   BITS(6:2, 15),  0x000000,     0x0FFFFF  }, // 00-07
    {   BITS(6:2, 17),  0x0FF000,     0x0FFFFF  }, // 00-15
    {   BITS(6:2, 18),  0x0FE000,     0x0FFFFF  }, // 00-31

    {   BITS(6:2, 19),  0x0FC000,     0x0FFFFF  }, // 63
    {   BITS(6:2, 21),  0x0F8000,     0x0FFFFF  }, // 63
    {   BITS(6:2, 25),  0x000000,     0x000FFF  }, // 63
    {   BITS(6:2, 26),  0x000000,     0x001FFF  }, // 63
    {   BITS(6:2, 27),  0x000000,     0x003FFF  }, // 63
    {   BITS(6:2, 29),  0x000000,     0x007FFF  }, // 63
    {   BITS(6:2, 0),   0x0FFFFF,     0x0FFFFF  }, // NONE
};

#if 0
static ST_WRITE_PROTECT _pstWriteProtectTable_GD25Q80B_CMP1[] =
{
    //   BPX,                    Lower Bound         Upper Bound
    {   BITS(6:2, 0),   0x000000,     0x0FFFFF  },
    {   BITS(6:2, 1),   0x000000,     0x0EFFFF  }, // 63
    {   BITS(6:2, 2),   0x000000,     0x0DFFFF  }, // 62-63
    {   BITS(6:2, 3),   0x000000,     0x0BFFFF  }, // 60-63
    {   BITS(6:2, 4),   0x000000,     0x07FFFF  }, // 56-63
    {   BITS(6:2, 9),   0x010000,     0x0FFFFF  }, // 48-63
    {   BITS(6:2, 10),  0x020000,     0x0FFFFF  }, // 32-63

    {   BITS(6:2, 11),  0x040000,     0x0FFFFF  }, // 00
    {   BITS(6:2, 12),  0x080000,     0x0FFFFF  }, // 00-01
    {   BITS(6:2, 13),  0x0FFFFF,     0x0FFFFF  }, // NONE
    {   BITS(6:2, 15),  0x0FFFFF,     0x0FFFFF  }, // NONE
    {   BITS(6:2, 17),  0x000000,     0x0FEFFF  }, // 00-15
    {   BITS(6:2, 18),  0x000000,     0x0FDFFF  }, // 00-31

    {   BITS(6:2, 19),  0x000000,     0x0FBFFF  }, // 63
    {   BITS(6:2, 21),  0x000000,     0x0F7FFF  }, // 63
    {   BITS(6:2, 25),  0x001000,     0x0FFFFF  }, // 63
    {   BITS(6:2, 26),  0x002000,     0x0FFFFF  }, // 63
    {   BITS(6:2, 27),  0x004000,     0x0FFFFF  }, // 63
    {   BITS(6:2, 29),  0x008000,     0x0FFFFF  }, // 63
    {   BITS(6:2, 13),  0x0FFFFF,     0x0FFFFF  }, // NONE
    {   BITS(6:2, 15),  0x0FFFFF,     0x0FFFFF  }, // NONE
};
#endif
...
static hal_SERFLASH_t _hal_SERFLASH_table[] =   // Need to Add more sample for robust
{
    ...
    { FLASH_IC_GD25Q80B,     MID_GD,     0x40,   0x14,   _pstWriteProtectTable_GD25Q80B_CMP0, NULL,                       0x100000,   16,     SIZE_64KB,  256,    50,     BITS(6:2, 0x1F),    ISP_DEV_ST,    ISP_SPI_ENDIAN_LITTLE, TRUE, NULL},
