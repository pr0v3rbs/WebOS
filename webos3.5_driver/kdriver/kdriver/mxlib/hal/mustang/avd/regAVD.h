...
#define CLKGEN0_REG_BASE            0x0B00UL  // 0x1E00 - 0x1EFF
#define CHIP_REG_BASE               0x1E00UL  // 0x1E00 - 0x1EFF
#define ADC_ATOP_REG_BASE           0x2500UL  // 0x2500 - 0x25FF
#define ADC_DTOP_REG_BASE           0x2600UL  // 0x2600 - 0x26EF
#define AFEC_REG_BASE               0x3500UL  // 0x3500 - 0x35FF
#define MIIC_REG_BASE               0x3400UL //0x3400 - 0x34FF
#define COMB_REG_BASE               0x3600UL  // 0x3600 - 0x36FF
#define VBI_REG_BASE                0x3700UL  // 0x3700 - 0x37FF
#define SCM_REG_BASE                0x3800UL  // 0x3800 - 0x38FF
...
#define BK_VBI_BF  (VBI_REG_BASE+0xBF)
...
#define VD_MCU_RST  0x3460UL
#define VD_MCU_SRAM_EN 0x3461UL
#define VD_MCU_KEY 0x3463UL
#define VD_MCU_ADDR_AUTO_INC 0x3463UL
#define VD_MCU_ADDR_L 0x3464UL
#define VD_MCU_ADDR_H 0x3465UL
#define VD_MCU_SRAM_WD 0x346CUL
#define VD_MCU_SRAM_RD 0x3470UL

#define VDMCU_MIU_MAP_CMD                       0x10C0UL
#define VDMCU_SDRAM_CODE_MAP                    0x10C1UL
#define VDMCU_SDRAM_CODE_MAP_H                  0x10C2UL
#define VDMCU_CACHE_ACCESS                      0x10C6UL
#define VDMCU_CACHE_HIT                         0x10C7UL
#define VDMCU_TAG_A0                            0x10C8UL
#define VDMCU_TAG_A1                            0x10C9UL
#define VDMCU_TAG_A2                            0x10CAUL
#define VDMCU_TAG_A3                            0x10CBUL
#define VDMCU_TAG_B0                            0x10CCUL
#define VDMCU_TAG_B1                            0x10CDUL
#define VDMCU_TAG_B2                            0x10CEUL
#define VDMCU_TAG_B3                            0x10CFUL
