...
typedef struct
{
    AVD_InputSourceType eSource_STR;
    MS_U8 u8ScartFB_STR;
    AVD_DemodType eDemodType_STR;
    MS_U32 u32XTAL_Clock_STR;
    MS_U8 g_u8DSPCodeSelect;
} AVD_STR_Info;
...
extern void HAL_AVD_AFEC_SetBlackLevel(MS_U8 u8FSCMode);
extern MS_U8 HAL_AVD_GetHsyncEdge(void);
extern void HAL_AVD_SetBurstWinStart(MS_U8 u8BusrtStartPosition);
extern void HAL_AVD_GetSTRInfo(AVD_STR_Info *eSTRInfo);
#endif // _HAL_AVD_H_
