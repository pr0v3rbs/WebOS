...
#define MVOP_SUB_REG_BASE                       0x1300  // 0x1300 - 0x13FF
#define CHIP_REG_BASE                           0x0B00  //chiptop CLKGEN0
#define SC_FE_REG_BASE                          0x00037F00  //SC_FE
...
#define VOP_REG_DUMMY                           (MVOP_REG_BASE + 0x7B)
    ...
    #define VOP_420_BW_SAVE       (BIT7) //420 bw saving mode             (MVOP_REG_BASE + 0x7B)
...
#define REG_STC1_CW_L                    (CHIP_REG_BASE + 0xE2)
#define REG_STC1_CW_H                    (CHIP_REG_BASE + 0xE4)


#define REG_UPDATE_DC0_CW                       (CHIP_REG_BASE + 0x0A)
    #define UPDATE_DC0_FREERUN_CW       BIT3
    #define UPDATE_DC0_SYNC_CW          BIT4

//#define REG_UPDATE_DC0_SYNC_CW                  (CHIP_REG_BASE + 0x0A)
#define REG_DC0_NUM                             (CHIP_REG_BASE + 0x14)
#define REG_DC0_DEN                             (CHIP_REG_BASE + 0x16)
#define REG_DC0_FREERUN_CW_L                    (CHIP_REG_BASE + 0x10)
#define REG_DC0_FREERUN_CW_H                    (CHIP_REG_BASE + 0x12)

//For sub mvop
#define REG_UPDATE_DC1_CW                       (CHIP_REG_BASE + 0xE0)
    #define UPDATE_DC1_FREERUN_CW       BIT3
    #define UPDATE_DC1_SYNC_CW          BIT4
#define REG_DC1_FREERUN_CW_L                    (CHIP_REG_BASE + 0xE6)
#define REG_DC1_FREERUN_CW_H                    (CHIP_REG_BASE + 0xE8)
#define REG_DC1_NUM                             (CHIP_REG_BASE + 0xEA)
#define REG_DC1_DEN                             (CHIP_REG_BASE + 0xEC)
