...
***********************************************************/
#define DEC_R2_DQMEM_SIZE                   32      //unit is kbytes
...
#define USE_SPDIF_REPLACE_HDMI          1

#define L2_CRC_ERR_MUTE_NUM             2
#define L2_SYNCWORD_ERR_MUTE_NUM        2
#define DDP_HDMI_FILL256_SAMPLE_BEFORE_FIRST_FRAME  0
#define SUPPORT_DRCLINE_MPEG_LEVEL_MODIFY           0
#define MS12_AAC_DRCLINE_DIALNORM_PRL_31DB
#define DTS_ENC_NOT_MIXER_SYSTEM_SOUND
...
***********************************************************/
    ...
    #define HAL_DCACHE_WAY              4
     ...
     /* D_PREFETCH */
    #define DC_WR_ALLOCATE_EN           1            // R2 D-Cache write-allocate
    #define D_PREFETCH_NUM              4            //Mustang has this feature, could be 0~4
    #define R2_SPRA_DCU_PREFETCH        (118)        //118 for DCU prefetch

    /* I_PREFETCH */
    #define I_PREFETCH_NUM              4            //Mustang has this feature, could be 0~4
    #define R2_SPRA_ICU_PREFETCH        (119)        //119 for ICU prefetch

    /* interrupt */
    #define NR_IRQS                     32
    #define IRQ13_UART			        0x1F//31
...
***********************************************************/
    ...
    #define SYS_DEC1_STOP_DECODE_PCM_LEVEL_OMX          3500*48
...
/* dec R2 <--> snd R2 */
    ...
    /* SND-DSP -> snd R2 */
        ...
        #define MBOX_S2D_PCM2_PLAYCNT               MBOX_S2D_IO_A
        #define MBOX_S2D_PCM2_FIFOCNT               MBOX_S2D_IO_B
        #define MBOX_S2D_PCM2_DRAM_RDPTR            MBOX_S2D_IO_C

      //#define MBOX_S2D_REG_DECODER_SEL            MBOX_S2D_IO_A
      //#define MBOX_S2D_REG_HDMI_IN_FREQ           MBOX_S2D_IO_B

        #define MBOX_S2D_DSPWORD_SPDIF_RDPTR        MBOX_S2D_IO_D
        #define MBOX_S2D_DSPWORD_HDMI_RDPTR         MBOX_S2D_IO_6
