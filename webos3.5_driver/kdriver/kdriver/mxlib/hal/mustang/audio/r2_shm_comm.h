...
typedef struct
{
    ...
    MS_S16  dap_leveler_enable;
    MS_S16  leveler_ignore_il;
    MS_U32  DOLBY_PARAM_Reserved[6];
} AUR2_DOLBY_PARAM;
...
typedef struct
{
    ...
    MS_U32  atmos_stream;
    MS_U32  DDP_71_stream;
    MS_U32  DOLBY_INFO_Reserved[3];    //reserved for new items
} AUR2_DOLBY_INFO;
...
typedef struct
{
    ...
    MS_U32 omx_no_mixing;
    MS_U32 omx_ES_bypass;
    MS_U32 mch_valid;			 	  // [0]: multi-channel [1]:downmix-channel
    MS_U32 ADEC_INFO_SHM_Reserved[16];    //reserved for new items
...
typedef struct
{
    ...
    MS_U32     TTS_On_flag;
    MS_U32     DAP_enable;
    MS_U32     speaker_enable;
    MS_U32     DDP_encode_enable;
    MS_U32     OMX_SPDIF_PAUSE;
    MS_U32     ADEC_PARAM_SHM_Reserved[16];    //reserved for new items
