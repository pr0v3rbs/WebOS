...
{=== 24-bit MailBox DM IO : SE_DSP to DEC_DSP ======================}
    .const SE2DEC_MAILBOX0  = MAIL_IO_BASE + 0x0200;     !
    .const SE2DEC_MAILBOX1  = MAIL_IO_BASE + 0x0201;     !
    .const SE2DEC_MAILBOX2  = MAIL_IO_BASE + 0x0202;     !
    .const SE2DEC_MAILBOX3  = MAIL_IO_BASE + 0x0203;     !
    .const SE2DEC_MAILBOX4  = MAIL_IO_BASE + 0x0210;     !
    .const SE2DEC_MAILBOX5  = MAIL_IO_BASE + 0x0211;     !
    .const SE2DEC_MAILBOX6  = MAIL_IO_BASE + 0x0212;     !
    .const SE2DEC_MAILBOX7  = MAIL_IO_BASE + 0x0213;     !

{=== 24-bit MailBox DM IO : DEC_DSP to SE_DSP ======================}
    .const DEC2SE_MAILBOX0  = MAIL_IO_BASE + 0x0300;     !
    .const DEC2SE_MAILBOX1  = MAIL_IO_BASE + 0x0301;     !
    .const DEC2SE_MAILBOX2  = MAIL_IO_BASE + 0x0302;     !
    .const DEC2SE_MAILBOX3  = MAIL_IO_BASE + 0x0303;     !
    .const DEC2SE_MAILBOX4  = MAIL_IO_BASE + 0x0310;     !
    .const DEC2SE_MAILBOX5  = MAIL_IO_BASE + 0x0311;     !
    .const DEC2SE_MAILBOX6  = MAIL_IO_BASE + 0x0312;     !
    .const DEC2SE_MAILBOX7  = MAIL_IO_BASE + 0x0313;     !

{=== 24-bit MailBox DM IO : SE_DSP to R2M to SE_DSP  ======================}
    .const SE2R2M_MAILBOX0  = MAIL_IO_BASE + 0x0100;
    .const SE2R2M_MAILBOX1  = MAIL_IO_BASE + 0x0101;
    .const SE2R2M_MAILBOX2  = MAIL_IO_BASE + 0x0102;
    .const SE2R2M_MAILBOX3  = MAIL_IO_BASE + 0x0103;
    .const SE2R2M_MAILBOX4  = MAIL_IO_BASE + 0x0104;
    .const SE2R2M_MAILBOX5  = MAIL_IO_BASE + 0x0105;
    .const SE2R2M_MAILBOX6  = MAIL_IO_BASE + 0x0106;
    .const SE2R2M_MAILBOX7  = MAIL_IO_BASE + 0x0107;
    .const SE2R2M_MAILBOX8  = MAIL_IO_BASE + 0x0108;
    .const SE2R2M_MAILBOX9  = MAIL_IO_BASE + 0x0109;

    .const R2M2SE_MAILBOX0  = MAIL_IO_BASE + 0x0110;
    .const R2M2SE_MAILBOX1  = MAIL_IO_BASE + 0x0111;
    .const R2M2SE_MAILBOX2  = MAIL_IO_BASE + 0x0112;
    .const R2M2SE_MAILBOX3  = MAIL_IO_BASE + 0x0113;
    .const R2M2SE_MAILBOX4  = MAIL_IO_BASE + 0x0114;
    .const R2M2SE_MAILBOX5  = MAIL_IO_BASE + 0x0115;
    .const R2M2SE_MAILBOX6  = MAIL_IO_BASE + 0x0116;
    .const R2M2SE_MAILBOX7  = MAIL_IO_BASE + 0x0117;
    .const R2M2SE_MAILBOX8  = MAIL_IO_BASE + 0x0118;
    .const R2M2SE_MAILBOX9  = MAIL_IO_BASE + 0x0119;
