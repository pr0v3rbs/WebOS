...
*   Version Control
*********************************************************/
#define  system_version_num              0x880D92
#define  dde_version_num                 0xD20058
#define  ms10_dde_version_num            0xD800E0
#define  palsum_version_num              0x544013
#define  btsc_version_num                0x046C0A
...
*********************************************************/
    ...
    /* DSP Audio Delay Setting */
        ...
        #define AUDIO_DELAY_LOWER_BOUND             0x40            // min main audio delay , 0x40 = 64 ms
...
************************************************/
    ...
    /* SND DSP DM vars */
        ...
        /* common */
            ...
            #define DSP2DmAddr_spdif_nonpcm_source      (DSP2_DM_MAIN_ADDR + 0x086F)
        ...
        /* basic sound effect */
            ...
            #define DSP2DmAddr_MixerGroup1_Ctrl_addr    (DSP2_DM_MAIN_ADDR + 0x087E)
            #define DSP2DmAddr_MixerGroup2_Ctrl_addr    (DSP2_DM_MAIN_ADDR + 0x087F)

        /* report HDMI PAPB lock */
            #define DSP2DmAddr_hdmi_npcm_lock           (DSP2_DM_MAIN_ADDR + 0x0880)

            #define DSP2DmAddr_clock_mute_time_ch5      (DSP2_DM_MAIN_ADDR + 0x0881)
            #define DSP2DmAddr_clock_mute_time_ch6      (DSP2_DM_MAIN_ADDR + 0x0882)

            #define DSP2DmAddr_event_mute_time_ch5      (DSP2_DM_MAIN_ADDR + 0x0883)
            #define DSP2DmAddr_event_mute_time_ch6      (DSP2_DM_MAIN_ADDR + 0x0884)
...
*************************************************/
    ...
    ************************************************/
    ...
    #define SE_R2_FRAME_SIZE                    64         //32 samples for R2_SE, refer to #define ASND_PROCESS_ITF_UNIT
...
********************************************************************/
    ...
    /* Mailbox with DEC R2 */
        #define D2S_MBOX_PCMISR_CTRL            DECR2M_2_DSP_MAILBOX1
            #define MBOX_R2_PCM1ISR_PLAY_START_BIT          0           //--> ³o¦U¥? playSmpFlag / stop / pause ¨M©w
