...
//---------------------------------------------------------------------------
#define REG_SOUND_MP3_ENCODE_CTRL                0x2E94
#define REG_MPEG_ENCODER_BUF_IDX                 0x2EB4
#define REG_MPEG_ENCODER_FRM_SIZE                0x2EB6

//---------------------------------------------------------------------------
// AUDIO 0x2F00 BANK Register
//---------------------------------------------------------------------------
/* SPDIF Channel Status */
// SPDIF_TX1_CS [40:191] = {0x112FD6[7:0], 0x112FD8[7:0], ..., 0x112FFA[7:0]}
// SPDIF_TX2_CS [40:191] = {0x112FD6[15:8], 0x112FD8[15:8], ..., 0x112FFA[15:8]}

#define REG_SPDIF_OUT_CS_PRO_00  0x2FD6
#define REG_SPDIF_OUT_CS_PRO_01  0x2FD8
#define REG_SPDIF_OUT_CS_PRO_02  0x2FDA
#define REG_SPDIF_OUT_CS_PRO_03  0x2FDC
#define REG_SPDIF_OUT_CS_PRO_04  0x2FDE
#define REG_SPDIF_OUT_CS_PRO_05  0x2FE0
#define REG_SPDIF_OUT_CS_PRO_06  0x2FE2
#define REG_SPDIF_OUT_CS_PRO_07  0x2FE4
#define REG_SPDIF_OUT_CS_PRO_08  0x2FE6
#define REG_SPDIF_OUT_CS_PRO_09  0x2FE8
#define REG_SPDIF_OUT_CS_PRO_10  0x2FEA
#define REG_SPDIF_OUT_CS_PRO_11  0x2FEC
#define REG_SPDIF_OUT_CS_PRO_12  0x2FEE
#define REG_SPDIF_OUT_CS_PRO_13  0x2FF0
#define REG_SPDIF_OUT_CS_PRO_14  0x2FF2
#define REG_SPDIF_OUT_CS_PRO_15  0x2FF4
#define REG_SPDIF_OUT_CS_PRO_16  0x2FF6
#define REG_SPDIF_OUT_CS_PRO_17  0x2FF8
#define REG_SPDIF_OUT_CS_PRO_18  0x2FFA

//---------------------------------------------------------------------------
// AUDIO 0x160300 BANK Register
// AUDIO Common Register
//---------------------------------------------------------------------------
...
#define REG_SOUND_MAIN_SNDEFFECT2                M2S_MBOX_SNDEFF_EN2
...
#define REG_SIF_CMD_FC_TRACK                     0x2DCA
...
//---------------------------------------------------------------------------
#define REG_DECR2_ICMEM_BASE_LO                  0x113082
#define REG_DECR2_ICMEM_BASE_HI                  0x113084

#define REG_DECR2_DCMEM_BASE_LO                  0x113086
#define REG_DECR2_DCMEM_BASE_HI                  0x113088

#define REG_DECR2_DQMEM_BASE_LO                  0x11309A
#define REG_DECR2_DQMEM_BASE_HI                  0x11309C
#define REG_DECR2_DQMEM_SIZE_MASK_LO             0x11309E
#define REG_DECR2_DQMEM_SIZE_MASK_HI             0x1130A0

#define REG_DECR2_IO0_MAPPING_BASE_HI            0x1130A8
#define REG_DECR2_IO1_MAPPING_BASE_HI            0x1130AA
#define REG_DECR2_IO2_MAPPING_BASE_HI            0x1130AC
#define REG_DECR2_IO3_MAPPING_BASE_HI            0x1130AE
#define REG_DECR2_MEM_CTRL                       0x1130B0
#define REG_DECR2_RESET_CTRL                     0x113080
#define REG_DECR2_SWITCH_CTRL                    0x1130d6
...
#define REG_DECR2_LGSE_SEL                       0x112E92
#define REG_SNDR2_MBOX_BYTE_DAP_SEL              0x112E93
#define REG_SNDR2_MBOX_BYTE_SRS_SEL              0x112E94
#define REG_SNDR2_MBOX_MAIN_SEL                  0x112E96
#define REG_SNDR2_MULTI_CHANNEL_VOLUME           0x112E98   // Bit[15]:mute     Bit[14:5]: 10-bit volume
#define REG_SNDR2_MAIN_COUNTER                   0x112EB2
#define REG_SNDR2_TIMER_COUNTER                  0x112EB3


//---------------------------------------------------------------------------
// Audio R2-DMA REGISTER SETTING
//---------------------------------------------------------------------------
#define R2_DMARDR1_REG_BASE                      0x160300
#define R2_DMARDR1_REG_SYNTH_H                   0x112BA8
#define R2_DMARDR1_REG_SYNTH_L                   0x112BAA
#define R2_DMARDR1_EN                            0x1603C0
#define R2_DMARDR1_DPGA_REG_L_CTRL               0x1603C6
#define R2_DMARDR1_DPGA_REG_R_CTRL               0x1603CC

#define R2_DMARDR_REG_SYNTH_UPDATE               0x112BCE
#define R2_DMARDR2_REG_BASE                      0x160320
#define R2_DMARDR2_REG_SYNTH_H                   0x112BB0
#define R2_DMARDR2_REG_SYNTH_L                   0x112BB2
#define R2_DMARDR2_EN                            0x1603E0
#define R2_DMARDR2_DPGA_REG_L_CTRL               0x1603E6
#define R2_DMARDR2_DPGA_REG_R_CTRL               0x1603EC
