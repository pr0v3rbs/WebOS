...
typedef enum
{
    DRA_ACMOD_MONO, //for DRA mono (DRA 1.0)
    DRA_ACMOD_STEREO, //for DRA stereo (DRA 2.0)
    DRA_ACMOD_2_1, //for DRA 2.1
    DRA_ACMOD_3_0, //for DRA 3.0
    DRA_ACMOD_3_1, //for DRA 3.1
    DRA_ACMOD_4_0, //for DRA 4.0
    DRA_ACMOD_4_1, //for DRA 4.1
    DRA_ACMOD_5_0, //for DRA 5.0
    DRA_ACMOD_5_1, //for DRA 5.1
} dra_acmod;
...
typedef enum
{
    R2_DMAreader1   = 0x00,     //audio decoder dma reader 1
    R2_DMAreader2   = 0x01,     //audio decoder dma reader 2
    R2_DMAreaderMAX   = 0xff,     //audio decoder_max
} R2_DMA_reader_id;
...
typedef enum
{
        ...
        AUR2_CommParam_ADEC_UNI_set_SPDIF_RdPtr,
        AUR2_CommParam_ADEC_UNI_set_DMAReader_PCM_Level,
        AUR2_CommParam_ADEC_UNI_set_HDMI_RdPtr,
        ...
        //LGSE6
        AUR2_LGSEFN_MODE_REGISTER = 0x5300,
        AUR2_LGSEFNMAIN_INIT,
        AUR2_LGSEFNMAIN_VARIABLES,
        AUR2_LGSEFN000_INIT,
        AUR2_LGSEFN000_VARIABLES,
        AUR2_LGSEFN001_INIT,
        AUR2_LGSEFN001_VARIABLES,
        AUR2_LGSEFN004_MODE1_VARIABLES,
        AUR2_LGSEFN004_MODE2_VARIABLES,
        AUR2_LGSEFN008_INIT,
        AUR2_LGSEFN008_VARIABLES,
        AUR2_LGSEFN009_INIT,
        AUR2_LGSEFN009_VARIABLES,
        AUR2_LGSEFN010_INIT,
        AUR2_LGSEFN010_VARIABLES,
        AUR2_LGSEFN010_OUT,
        AUR2_LGSEFN011_INIT,
        AUR2_LGSEFN011_VARIABLES,
        AUR2_LGSEFN014_INIT,
        AUR2_LGSEFN014_VARIABLES,
        AUR2_LGSEFN014_OUT, //0x5314
        AUR2_LGSEFN017_VARIABLES,
        AUR2_LGSEFN019_INIT,
        AUR2_LGSEFN019_VARIABLES,
        AUR2_LGSEFN020_VARIABLES,
        AUR2_LGSEFN022_INIT,
        AUR2_LGSEFN022_VARIABLES,
        AUR2_LGSEFN028_VARIABLES,
        AUR2_LGSEFN029_VARIABLES,
...
typedef enum
{
    ...
    R2_SHM_INFO_AVSYNC_MMTsSyncFlag,
    ...
    R2_SHM_INFO_HDMIbuf_LEVEL,
    R2_SHM_INFO_HDMIbuf_WR_PTR,
    R2_SHM_INFO_HDMIbuf_HBR,
    ...
    R2_SHM_INFO_DTS_PCM_FRAME_SIZE,
    R2_SHM_INFO_DTS_ES_TYPE,
    R2_SHM_INFO_SPDIF_INFO_FLAG,
    ...
    R2_SHM_INFO_OMX_NO_MIXING,
    R2_SHM_INFO_OMX_ES_BYPASS,
    R2_SHM_INFO_SECURITY_INFO,
} R2_SHM_INFO_TYPE;
...
typedef enum
{
    ...
    R2_SHM_PARAM_DTS_HD_HDMI_BYPASS,
    R2_SHM_PARAM_DTS_SEAMLESS_MODE,
