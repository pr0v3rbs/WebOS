...
static void _HAL_NJPD_SetMIUProtectMask(MS_BOOL bEnable)
{
    ...
    {
        __HAL_NJPD_WriteBit(NJPD_MIU0_RQ3_MASK+1, bEnable, NJPD0_MIU0_CLIENT_NJPD);
        __HAL_NJPD_WriteBit(NJPD_MIU1_RQ3_MASK+1, bEnable, NJPD0_MIU1_CLIENT_NJPD);

        NJPD_DEBUG_HAL_MSG("%s MIU0 : 0x%04x\n", __FUNCTION__, __HAL_NJPD_Read2Byte(NJPD_MIU0_RQ3_MASK));
        NJPD_DEBUG_HAL_MSG("%s MIU1 : 0x%04x\n", __FUNCTION__, __HAL_NJPD_Read2Byte(NJPD_MIU1_RQ3_MASK));
    }
    else
    {
        __HAL_NJPD_WriteBit(NJPD_MIU0_RQ3_MASK+1, bEnable, NJPD1_MIU0_CLIENT_NJPD);
        __HAL_NJPD_WriteBit(NJPD_MIU1_RQ3_MASK+1, bEnable, NJPD1_MIU1_CLIENT_NJPD);
...
void HAL_NJPD_SetMIU(MS_U8 u8Idx)
{
    ...
    else
    {
        ...
        __HAL_NJPD_WriteBit(NJPD1_MIU1_MIU_SEL2, 1, NJPD1_MIU1_CLIENT_NJPD);
    ...
    {
        NJPD_DEBUG_HAL_MSG("NJPD1, ");
        __HAL_NJPD_WriteBit(NJPD1_MIU1_MIU_SEL2, 0, NJPD1_MIU1_CLIENT_NJPD);
        if(u8Idx)
        {
            NJPD_DEBUG_HAL_MSG("MIU 1\n");
            __HAL_NJPD_WriteBit(NJPD1_MIU0_MIU_SEL2, 1, NJPD1_MIU0_CLIENT_NJPD);
        }
        else
        {
            NJPD_DEBUG_HAL_MSG("MIU 0\n");
            __HAL_NJPD_WriteBit(NJPD1_MIU0_MIU_SEL2, 0, NJPD1_MIU0_CLIENT_NJPD);
        }
    }
#endif
}
...
void HAL_NJPD_JPDSelect(MS_BOOL bNJPD)
{
    if(bNJPD)
    {
        __HAL_NJPD_WriteBit(NJPD_MIU_GROUP3_I64, 0, NJPD_MIU0_CLIENT_NJPD_CS2);
        __HAL_NJPD_WriteBit(NJPD_MIU_GROUP3_I64, 0, NJPD_MIU0_CLIENT_NJPD_CS3);
    ...
    {
        __HAL_NJPD_WriteBit(NJPD_MIU_GROUP3_I64, 1, NJPD_MIU0_CLIENT_NJPD_CS2);
        __HAL_NJPD_WriteBit(NJPD_MIU_GROUP3_I64, 1, NJPD_MIU0_CLIENT_NJPD_CS3);
...
void HAL_NJPD_PowerOn()
{
    ...
    u16reg_val = u16reg_val & 0xF2FF;
    u16reg_val |= 0x0000;  // set NJPD disable [8] : 0, [11:10] : 00 144MHz
...
void HAL_NJPD_PowerOff(void)
{
    ...
    u16reg_val = HAL_NJPD_GetClock();
    u16reg_val = u16reg_val & 0xF2FF;
    u16reg_val |= 0x0100;  // set NJPD disable [8] : 1, [11:10] : 00 144MHz
    NJPD_DEBUG_HAL_MSG("%s : SetClock : 0x%04x\n", __FUNCTION__ , u16reg_val);
    HAL_NJPD_SetClock(u16reg_val);
    NJPD_DEBUG_HAL_MSG("%s : GetClock : 0x%04x\n", __FUNCTION__ , HAL_NJPD_GetClock());
}
...
void HAL_NJPD_InitRegBase(void)
{
    ...
    {
        NJPD_DEBUG_HAL_MSG("RIUreg base = 0x%lx, length = %lu\n", u32NJPDRiuBaseAdd, u32NonPMBankSize);
    }
}
...
void HAL_NJPD_Debug(void)
{
    if(eNJPDNum == E_NJPD_NJPD1)
    {
        ...
        NJPD_DEBUG_HAL_MSG("=======================================================\n");
        NJPD_DEBUG_HAL_MSG("Addr  | 00/08 01/09 02/0A 03/0B 04/0C 05/0D 06/0E 07/0F\n");
        NJPD_DEBUG_HAL_MSG("=======================================================\n");
