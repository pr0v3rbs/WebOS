...
#define NJPD_CLKGEN0_BASE                0x00B00
...
// CLKGEN0
// For Agate, we use bank 0x0B,offset 0x35 bit(8:11) to set reg_ckg_njpd
#define NJPD_CLOCK                                  (NJPD_CLKGEN0_BASE+NJPD_OFFSET(0x35))     // Agate
...
#define NJPD_MIU0_RQ3_MASK              (NJPD_MIU0_BASE+NJPD_OFFSET(0x53))
#define NJPD_MIU1_RQ3_MASK              (NJPD_MIU1_BASE+NJPD_OFFSET(0x53))
#define NJPD0_MIU0_CLIENT_NJPD          NJPD_BIT(4) //bit4 of the second byte (bit c)
#define NJPD0_MIU1_CLIENT_NJPD          NJPD_BIT(4) //bit4 of the second byte (bit c)
#define NJPD1_MIU0_CLIENT_NJPD          NJPD_BIT(2) //bit2 of the second byte (bit a)
#define NJPD1_MIU1_CLIENT_NJPD          NJPD_BIT(2) //bit2 of the second byte (bit a)
#define NJPD0_MIU0_MIU_SEL2             (NJPD_MIU0_BASE+NJPD_OFFSET(0x7b)+1)
#define NJPD0_MIU1_MIU_SEL2             (NJPD_MIU1_BASE+NJPD_OFFSET(0x7b)+1)
#define NJPD1_MIU0_MIU_SEL2             (NJPD_MIU0_BASE+NJPD_OFFSET(0x7b)+1)
#define NJPD1_MIU1_MIU_SEL2             (NJPD_MIU1_BASE+NJPD_OFFSET(0x7b)+1)
...
#define NJPD_MIU_GROUP3_I64             (NJPD_CHIPTOP_BASE + NJPD_OFFSET(0x23)+1)
#define NJPD_MIU0_CLIENT_NJPD_CS2       NJPD_BIT(4) // bit 4 of the second byte (bit c)
#define NJPD_MIU0_CLIENT_NJPD_CS3       NJPD_BIT(2) // bit 2 of the second byte (bit a)
