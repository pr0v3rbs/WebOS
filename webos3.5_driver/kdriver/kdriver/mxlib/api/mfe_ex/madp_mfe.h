...
typedef struct _MFE_INPUT_BUF_INFO {
	...
	#define E_SYS_MMAP_MFE 0
       #define MIU_OFFSET 0x0000000000
		...
		#define MS_VA2PA(a) pmem_mm_va2pa((MFE_U32)(a))
		#define MS_PA2KSEG1(a) pmem_mm_pa2va((MFE_U32)(a))
		#define MAdp_MPool_VA2PA(a) pmem_mm_va2pa((MFE_U32)(a))
		#define MAdp_MPool_PA2KSEG1(a) pmem_mm_pa2va((MFE_U32)(a))
    #else
		#ifndef BOOLEAN
			#define BOOLEAN bool
		#endif
