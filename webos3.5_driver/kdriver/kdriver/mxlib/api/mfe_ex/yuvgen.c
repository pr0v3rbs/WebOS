...
void YuvGen_422(unsigned char seed, int width, int height, volatile unsigned char *buff);
...
static void PutTileY(unsigned char *pY, unsigned char *pDst, int nStride, int nMaxX, int nMaxY)
{
    unsigned char *s = pY;
...
static void PutTileUV(unsigned char *pU, unsigned char *pV, unsigned char *pDst, int nStride, int nMaxX, int nMaxY)
{
    unsigned char *s1 = pU;
    unsigned char *s2 = pV;
    unsigned char *t = pDst;
...
{
    int nHvdWidth, nHvdHeight, nSize;
    int x, y, nTileWidth, nTileHeight;
    unsigned char *pSrcPtr1, *pSrcPtr2, *pDstPtr;
