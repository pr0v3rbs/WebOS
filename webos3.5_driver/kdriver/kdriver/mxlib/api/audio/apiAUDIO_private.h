...
typedef void                (*IOCTL_AUDIO_SETDSPBASEADDR)(MS_U8, MS_U32, MS_U32 );
typedef MS_U32              (*IOCTL_AUDIO_GETDSPMADBASEADDR)(MS_U8);
typedef void                (*IOCTL_AUDIO_WRITEDECMAILBOX)(MS_U8, MS_U16);
typedef void                (*IOCTL_AUDIO_TRIGGERSIFPLL)(void);
typedef MS_U8               (*IOCTL_AUDIO_MONITOR)(void);
...
typedef void                (*IOCTL_AUDIO_SETENCCOMMAND)(AU_DVB_ENCCMD enEncComamnd, void* pCB, MS_U8 u8Param);
typedef void                (*IOCTL_AUDIO_GETENCODEFRAMEINFO)(AU_DVB_ENC_FRAME_INFO *);
typedef MS_BOOL             (*IOCTL_AUDIO_GETENCODEDONEFLAG)(void);
typedef MS_BOOL             (*IOCTL_AUDIO_SETENCINFO)(AUDIO_ENC_INFO_TYPE infoType, MS_U32 param1, MS_U32 param2);
typedef MS_U32              (*IOCTL_AUDIO_GETENCINFO)(AUDIO_ENC_INFO_TYPE infoType);
typedef void                (*IOCTL_AUDIO_SETCAPTUREENABLE)(MS_BOOL bEnable, void* PCM_CB);
...
typedef void                (*IOCTL_AUDIO_SIF_SETTHRESHOLD)(THR_TBL_TYPE code *);
typedef void                (*IOCTL_AUDIO_SIF_SETPRESCALE)(MS_U8, int);
...
typedef MS_BOOL             (*IOCTL_AUDIO_DIGITALOUT_GETCHANNELSTATUS)(DIGITAL_OUTPUT_TYPE, Digital_Out_Channel_Status_t*);
...
typedef MS_BOOL             (*IOCTL_AUDIO_ADVSOUND_SETPARAM2)(ADVSND_PARAM, MS_U32, MS_U32*, MS_U16);
typedef MS_BOOL             (*IOCTL_AUDIO_ADVSOUND_GETPARAM2)(ADVSND_PARAM, MS_U32, MS_U32*, MS_U16);
...
typedef void                (*IOCTL_AUDIO_SETADVSNDSYS)(MS_U8);
...
//typedef void                (*IOCTL_AUDIO_SETBEE)(MS_U8, MS_U8);
...
typedef void                (*IOCTL_AUDIO_COPY_PARAMETER)(ADVSND_PARAM, MS_U32 *,MS_U32);
...
//=============================================================
// Set Info
typedef MS_BOOL             (*IOCTL_AUDIO_SETCOMMAUDIOINFO)(Audio_COMM_infoType, MS_U32, MS_U32);
typedef MS_BOOL             (*IOCTL_AUDIO_SETDECODEPARAM)(AUDIO_DEC_ID DecId, Audio_ParamType paramType, MS_U32* Param );
//typedef MS_BOOL             (*IOCTL_AUDIO_SETMPEGINFO)(Audio_MPEG_infoType, MS_U32, MS_U32);
//typedef MS_BOOL             (*IOCTL_AUDIO_SETAC3INFO)(Audio_AC3_infoType , MS_U32, MS_U32);
//typedef MS_BOOL             (*IOCTL_AUDIO_SETAC3PINFO)(Audio_AC3P_infoType , MS_U32, MS_U32);
//typedef MS_BOOL             (*IOCTL_AUDIO_SETAACINFO)(Audio_AAC_infoType, MS_U32, MS_U32 );
//typedef MS_BOOL             (*IOCTL_AUDIO_SETWMAINFO)(Audio_WMA_infoType, MS_U32, MS_U32 );
//typedef MS_BOOL             (*IOCTL_AUDIO_SETDTSCOMMONCTRL)(Audio_DTS_infoType , Audio_DTS_CtrlType);
// Get Info
typedef long long           (*IOCTL_AUDIO_GETCOMMAUDIOINFO)(Audio_COMM_infoType);
...
typedef MS_U8               (*IOCTL_AUDIO_CHECKINPUTREQUEST)(MS_U32*, MS_U32*);
...
typedef MS_U8               (*IOCTL_AUDIO_MM_CHECKINPUTREQUEST)(En_DVB_AudioDecoder, MS_U32*, MS_U32*);
typedef void                (*IOCTL_AUDIO_DMAREADER_INIT)(PCM_OUTPUT_FORMAT* pSettings);
typedef void                (*IOCTL_AUDIO_DMAREADER_ALLINPUT_INIT)(void);
typedef MS_BOOL             (*IOCTL_AUDIO_DMAREADER_WRITEPCM)(MS_U8, void* , MS_U32 );
typedef void                (*IOCTL_AUDIO_SWDMAREADER_INIT)(PCM_OUTPUT_FORMAT* );
typedef MS_BOOL             (*IOCTL_AUDIO_SWDMAREADER_WRITEPCM)(MS_U8, void*, MS_U32);
...
typedef MS_BOOL             (*IOCTL_AUDIO_UNI_CHECKDECODEDONE)(MS_U32*, MS_U32*);
...
typedef MS_BOOL             (*IOCTL_AUDIO_SETAUDIOPARAM2)(AUDIO_DEC_ID, Audio_ParamType, MS_U32);
typedef MS_BOOL             (*IOCTL_AUDIO_GETAUDIOINFO2)(AUDIO_DEC_ID, Audio_InfoType, void*);
typedef MS_U32              (*IOCTL_AUDIO_GETDDRINFO)(AUDIO_DEC_ID, EN_AUDIO_DDRINFO);

// LG add function
//typedef void                (*IOCTL_AUDIO_SETBALANCE_L)(MS_U8);
//typedef void                (*IOCTL_AUDIO_SETBALANCE_R)(MS_U8);
typedef MS_U16              (*IOCTL_AUDIO_READREG)(MS_U32);
typedef void                (*IOCTL_AUDIO_WRITEREG)(MS_U32 , MS_U16);
//typedef void                (*IOCTL_AUDIO_SETCUTBOOST)(MS_U8);
//typedef void                (*IOCTL_AUDIO_ESSTOPTHRESHOLD)(MS_U32);
//typedef void                (*IOCTL_AUDIO_SETSPDIFHWMUTE)(MS_U8);
//typedef void                (*IOCTL_AUDIO_SETARCHWMUTE)(MS_U8);
typedef void                (*IOCTL_AUDIO_ARC_HWEN)(MS_BOOL);
typedef void                (*IOCTL_AUDIO_ARC_HWEN_BY_PORT)(AUDIO_HDMI_INDEX_T, MS_BOOL);
typedef void                (*IOCTL_AUDIO_LOADAUDIOCLIP)(MS_U32, void* ,MS_U32);
typedef void                (*IOCTL_AUDIO_PLAYAUDIOCLIP)(MS_U32);
typedef MS_U32              (*IOCTL_AUDIO_GETCLIP_POSITION)(void);
typedef void                (*IOCTL_AUDIO_SEEKAUDIOCLIP)(MS_U32);
typedef void                (*IOCTL_AUDIO_STOPAUDIOCLIP)(void);
typedef MS_U32              (*IOCTL_AUDIO_CLIPPLAYDONE)(void);
typedef void                (*IOCTL_AUDIO_CLIPPLAYDONE_RESET)(void);
typedef void                (*IOCTL_AUDIO_CLIP_PROCESSOR)(void);
typedef void                (*IOCTL_AUDIO_SIF_GETCURANALOEMODE)(MS_U8*);
typedef void                (*IOCTL_AUDIO_SIF_SETUSERANALOGMODE)(MS_U16);
typedef MS_BOOL             (*IOCTL_AUDIO_SIF_SETMODESETUP)(MS_U8);
typedef void                (*IOCTL_AUDIO_SIF_SETHDEVMODE)(MS_U8);
typedef MS_BOOL             (*IOCTL_AUDIO_SIF_SETBANDSETUP)(MS_U8);
typedef MS_BOOL             (*IOCTL_AUDIO_SIF_GETBANDDETECT)(MS_U8, MS_U32*);
typedef MS_BOOL             (*IOCTL_AUDIO_SIF_GETBANDDETECTAMP)(MS_U8, MS_U32*);
typedef MS_BOOL             (*IOCTL_AUDIO_SIF_CHECKAVAILABLESYSTEM)(MS_U8, MS_U8*);
typedef MS_BOOL             (*IOCTL_AUDIO_SIF_CHECKA2DK)(MS_U8, MS_U8*);
typedef MS_BOOL             (*IOCTL_AUDIO_SIF_GETSOUNDSTANDARD)(MS_U8*);
typedef void                (*IOCTL_AUDIO_SIF_REDOSETSTANDARD)(void);
//typedef void                (*IOCTL_AUDIO_SIF_ADC_RESET)(void);
typedef MS_BOOL             (*IOCTL_AUDIO_GET_BTSCA2STEREOLEVEL)(MS_U16*);
typedef MS_BOOL             (*IOCTL_AUDIO_SET_BTSCA2_THRESHOLDLEVEL)(MS_U16, MS_U16*);
typedef void                (*IOCTL_AUDIO_CHECKNICAMDIGITAL)(MS_U8*);
typedef void                (*IOCTL_AUDIO_SETTHRESHOLDTYPE)(THR_TBL_TYPE_C code *, MS_U8 ,  MS_U8);
typedef MS_U32              (*IOCTL_AUDIO_DECODE_FRAME_CNT)(MS_BOOL bDspType);
typedef MS_S32              (*IOCTL_AUDIO_PMCMIXER_INIT)(void);
typedef MS_S32              (*IOCTL_AUDIO_PMCMIXER_DEINIT)(void);
typedef MS_S32              (*IOCTL_AUDIO_PMCMIXER_OPEN)(void);
typedef MS_S32              (*IOCTL_AUDIO_PMCMIXER_CLOSE)(MS_S32);
typedef MS_S32              (*IOCTL_AUDIO_PMCMIXER_FLUSH)(MS_S32);
typedef MS_S32              (*IOCTL_AUDIO_PMCMIXER_START)(MS_S32);
typedef MS_S32              (*IOCTL_AUDIO_PMCMIXER_STOP)(MS_S32);
typedef MS_S32              (*IOCTL_AUDIO_PMCMIXER_SET)(MS_S32, MS_U32, void *);
typedef MS_S32              (*IOCTL_AUDIO_PMCMIXER_GET)(MS_S32, MS_U32, void *);
typedef MS_BOOL             (*IOCTL_AUDIO_PMCMIXER_WRITE)(MS_S32, void *, MS_U32);
typedef MS_S32              (*IOCTL_AUDIO_PMCMIXER_FUNC)(MS_U32);
typedef MS_U16              (*IOCTL_AUDIO_HDMI_RX_GETHDMIINCHANNELSTATUS)(void);

typedef MS_S32              (*IOCTL_AUDIO_PCM_OPEN)(void *);
typedef MS_S32              (*IOCTL_AUDIO_PCM_CLOSE)(MS_S32);
typedef MS_S32              (*IOCTL_AUDIO_PCM_START)(MS_S32);
typedef MS_S32              (*IOCTL_AUDIO_PCM_STOP)(MS_S32);
typedef MS_S32              (*IOCTL_AUDIO_PCM_SET)(MS_S32, MS_U32, const void *);
typedef MS_S32              (*IOCTL_AUDIO_PCM_GET)(MS_S32, MS_U32, void *);
typedef MS_U32              (*IOCTL_AUDIO_PCM_READ)(MS_S32, void *, MS_U32);
typedef MS_U32              (*IOCTL_AUDIO_PCM_WRITE)(MS_S32, const void *, MS_U32);
typedef MS_S32              (*IOCTL_AUDIO_PCM_FLUSH)(MS_S32);


//typedef void                (*IOCTL_AUDIO_GETLIBVER)(void);
//typedef long long           (*IOCTL_AUDIO_GETDSP_PTS)(void);
...
typedef struct _AUDIO_INSTANT_PRIVATE
{
    ...
    IOCTL_AUDIO_SETENCINFO                          fpAUDIOSetEncInfo;
    IOCTL_AUDIO_GETENCINFO                          fpAUDIOGetEncInfo;
    IOCTL_AUDIO_SETCAPTUREENABLE                    fpAUDIOSetCaptureEnable;
    ...
    IOCTL_AUDIO_ADVSOUND_SETPARAM2                  fpAUDIOADVSOUNDSetParam2;
    IOCTL_AUDIO_ADVSOUND_GETPARAM2                  fpAUDIOADVSOUNDGetParam2;
    ...
    //IOCTL_AUDIO_SETBEE                              fpAUDIOSetBEE;
    ...
    IOCTL_AUDIO_SWDMAREADER_INIT                    fpAUDIOSwDmaReaderInit;
    IOCTL_AUDIO_SWDMAREADER_WRITEPCM                fpAUDIOSwDmaReaderWritePCM;
    ...
    // LG add function
    //IOCTL_AUDIO_SETBALANCE_L                        fpAUDIOSetBalanceL;
    //IOCTL_AUDIO_SETBALANCE_R                        fpAUDIOSetBalanceR;
    IOCTL_AUDIO_READREG                             fpAUDIOReadReg;
    IOCTL_AUDIO_WRITEREG                            fpAUDIOWriteReg;
    //IOCTL_AUDIO_SETCUTBOOST                         fpAUDIOSetCutBoost;
    //IOCTL_AUDIO_ESSTOPTHRESHOLD                     fpAUDIOESStopThreshold;
    //IOCTL_AUDIO_SETSPDIFHWMUTE                      fpAUDIOSetSPDIFHwMute;
    //IOCTL_AUDIO_SETARCHWMUTE                        fpAUDIOSetARCHwMute;
    IOCTL_AUDIO_ARC_HWEN                            fpAUDIOARCHwEn;
    IOCTL_AUDIO_ARC_HWEN_BY_PORT                    fpAUDIOARCHwEnByPort;
    IOCTL_AUDIO_LOADAUDIOCLIP                       fpAUDIOLoadAudioClip;
    IOCTL_AUDIO_PLAYAUDIOCLIP                       fpAUDIOPlayAudioClip;
    IOCTL_AUDIO_GETCLIP_POSITION                    fpAUDIOGetClipPosition;
    IOCTL_AUDIO_SEEKAUDIOCLIP                       fpAUDIOSeekAudioClip;
    IOCTL_AUDIO_STOPAUDIOCLIP                       fpAUDIOStopAudioClip;
    IOCTL_AUDIO_CLIPPLAYDONE                        fpAUDIOClipPlayDone;
    IOCTL_AUDIO_CLIPPLAYDONE_RESET                  fpAUDIOPlayDoneReset;
    IOCTL_AUDIO_CLIP_PROCESSOR                      fpAUDIOClipProcessor;
    IOCTL_AUDIO_SIF_GETCURANALOEMODE                fpAUDIOSIFGetCurAnalogMode;
    IOCTL_AUDIO_SIF_SETUSERANALOGMODE               fpAUDIOSIFSetUserAnalogMode;
    IOCTL_AUDIO_SIF_SETMODESETUP                    fpAUDIOSIFSetModeSetup;
    IOCTL_AUDIO_SIF_SETHDEVMODE                     fpAUDIOSIFSetHDEVMode;
    IOCTL_AUDIO_SIF_SETBANDSETUP                    fpAUDIOSIFSetBandSetup;
    IOCTL_AUDIO_SIF_GETBANDDETECT                   fpAUDIOSIFGetBandDetect;
    IOCTL_AUDIO_SIF_GETBANDDETECTAMP                fpAUDIOSIFGetBandDetectAmp;
    IOCTL_AUDIO_SIF_CHECKAVAILABLESYSTEM            fpAUDIOSIFCheckAvailableSystem;
    IOCTL_AUDIO_SIF_CHECKA2DK                       fpAUDIOSIFCheckA2KD;
    IOCTL_AUDIO_SIF_GETSOUNDSTANDARD                fpAUDIOSIFGetSoundStandard;
    IOCTL_AUDIO_SIF_REDOSETSTANDARD                 fpAUDIOSIFRedoSetStandard;
    //IOCTL_AUDIO_SIF_ADC_RESET                       fpAUDIOSIFADCRest;
    IOCTL_AUDIO_GET_BTSCA2STEREOLEVEL               fpAUDIOGetBtscA2StereoLevel;
    IOCTL_AUDIO_SET_BTSCA2_THRESHOLDLEVEL           fpAUDIOSetBtscA2ThresholdLevel;
    IOCTL_AUDIO_CHECKNICAMDIGITAL                   fpAUDIOCheckNicamDigital;
    IOCTL_AUDIO_SETTHRESHOLDTYPE                    fpAUDIOSetThresholdType;
    IOCTL_AUDIO_DECODE_FRAME_CNT                    fpAUDIODecodeFrameCnt;
    IOCTL_AUDIO_PMCMIXER_INIT                       fpAUDIOPcmMixerInit;
    IOCTL_AUDIO_PMCMIXER_DEINIT                     fpAUDIOPcmMixerDeInit;
    IOCTL_AUDIO_PMCMIXER_OPEN                       fpAUDIOPcmMixerOpen;
    IOCTL_AUDIO_PMCMIXER_CLOSE                      fpAUDIOPcmMixerClose;
    IOCTL_AUDIO_PMCMIXER_FLUSH                      fpAUDIOPcmMixerFlush;
    IOCTL_AUDIO_PMCMIXER_START                      fpAUDIOPcmMixerStart;
    IOCTL_AUDIO_PMCMIXER_STOP                       fpAUDIOPcmMixerStop;
    IOCTL_AUDIO_PMCMIXER_SET                        fpAUDIOPcmMixerSet;
    IOCTL_AUDIO_PMCMIXER_GET                        fpAUDIOPcmMixerGet;
    IOCTL_AUDIO_PMCMIXER_WRITE                      fpAUDIOPcmMixerWrite;
    IOCTL_AUDIO_PMCMIXER_FUNC                       fpAUDIOPcmMixerFunc;
    IOCTL_AUDIO_HDMI_RX_GETHDMIINCHANNELSTATUS      fpAUDIOHDMIRXGetHDMIInChannelStatus;

    IOCTL_AUDIO_PCM_OPEN                            fpAUDIOPcmOpen;
    IOCTL_AUDIO_PCM_CLOSE                           fpAUDIOPcmClose;
    IOCTL_AUDIO_PCM_START                           fpAUDIOPcmStart;
    IOCTL_AUDIO_PCM_STOP                            fpAUDIOPcmStop;
    IOCTL_AUDIO_PCM_SET                             fpAUDIOPcmSet;
    IOCTL_AUDIO_PCM_GET                             fpAUDIOPcmGet;
    IOCTL_AUDIO_PCM_READ                            fpAUDIOPcmRead;
    IOCTL_AUDIO_PCM_WRITE                           fpAUDIOPcmWrite;
    IOCTL_AUDIO_PCM_FLUSH                           fpAUDIOPcmFlush;

    //IOCTL_AUDIO_GETLIBVER                           fpAUDIOGetLibVer;
    //IOCTL_AUDIO_GETDSP_PTS                          fpAUDIOGetDSPPTS;
...
// LG add function
//void                _MApi_AUDIO_SetBalance_L( MS_U8 u8Balance_L );
//void                _MApi_AUDIO_SetBalance_R( MS_U8 u8Balance_R );
MS_U16              _MApi_AUDIO_ReadReg(MS_U32 u32RegAddr);
void                _MApi_AUDIO_WriteReg(MS_U32 u32RegAddr, MS_U16 u16Val);
//void                _MApi_AUDIO_Set_Cut_Boost(MS_U8 scale);
//void                _MApi_AUDIO_ES_Stop_Threshold(MS_U32 threshold);
//void                _MApi_AUDIO_SetSPDIFHWMute(MS_U8 mute);
//void                _MApi_AUDIO_Set_ARC_HWMute(MS_U8 mute);
...
//void                _MApi_AUDIO_SIF_ADC_Reset(void);
...
//void                _MAPI_AUDIO_Get_LIB_Ver(void);
//long long           _MApi_AUDIO_GET_DSP_PTS(void);
