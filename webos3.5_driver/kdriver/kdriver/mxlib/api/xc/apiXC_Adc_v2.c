...
void ADC_Initialize(XC_INSTANCE_PRIVATE* psXCInstPri, const void* const pAttribute)
{
    ...
    psXCInstPri->fpXC_ADC_GetOffsetSetting =     MApi_XC_ADC_GetOffsetSetting_U2;
    psXCInstPri->fpXC_ADC_GetGainSetting =     MApi_XC_ADC_GetGainSetting_U2;
    psXCInstPri->fpXC_ADC_SetOffsetSetting =     MApi_XC_ADC_SetOffsetSetting_U2;
    psXCInstPri->fpXC_ADC_SetGainSetting =     MApi_XC_ADC_SetGainSetting_U2;
...
MS_U32 _ADCIoctl(void* pInstance, MS_U32 u32Cmd, void* pArgs)
{
    ...
    switch(u32Cmd)
    {
        ...
        case E_XC_ADC_CMD_GETOFFSETSETTING:
            {

                pstXC_ADC_GETOFFSETSETTING  pXCArgs = (pstXC_ADC_GETOFFSETSETTING) pArgs;
                psXCInstPri->fpXC_ADC_GetOffsetSetting(pInstance, pXCArgs->pstADCSetting);

                u32Return = UTOPIA_STATUS_SUCCESS;
                break;
            }

        case E_XC_ADC_CMD_GETGAINSETTING:
            {
                pstXC_ADC_GETGAINSETTING  pXCArgs = (pstXC_ADC_GETGAINSETTING) pArgs;
                psXCInstPri->fpXC_ADC_GetGainSetting(pInstance, pXCArgs->pstADCSetting);

                u32Return = UTOPIA_STATUS_SUCCESS;
                break;
            }

        case E_XC_ADC_CMD_SETOFFSETSETTING:
            {

                pstXC_ADC_SETOFFSETSETTING  pXCArgs = (pstXC_ADC_SETOFFSETSETTING) pArgs;
                psXCInstPri->fpXC_ADC_SetOffsetSetting(pInstance, pXCArgs->pstADCSetting);

                u32Return = UTOPIA_STATUS_SUCCESS;
                break;
            }

        case E_XC_ADC_CMD_SETGAINSETTING:
            {
                pstXC_ADC_SETGAINSETTING  pXCArgs = (pstXC_ADC_SETGAINSETTING) pArgs;
                psXCInstPri->fpXC_ADC_SetGainSetting(pInstance, pXCArgs->pstADCSetting);
