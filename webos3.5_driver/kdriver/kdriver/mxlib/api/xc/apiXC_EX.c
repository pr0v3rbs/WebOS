...
HDMI_EX_PACKET_VALUE MDrv_HDMI_EX_Packet_Received(MS_BOOL bEnable)
{
    ...
    {
        printf("[%s,%5d] ID %ld, No instance existed, please get an instance by calling MApi_XC_Init() first\n",__FUNCTION__,__LINE__,0L);
        return *((HDMI_EX_PACKET_VALUE*)(&(XCArgs.stReturnValue)));
    }
...
HDCP_EX_STATUS_INFO* MDrv_HDCP_EX_GetStatus(XC_DEVICE_ID *pDeviceId)
{
    ...
    memset(&XCArgs.stReturnValue, 0, sizeof(MS_HDCP_STATUS_INFO_t));

    if(UtopiaIoctl(_XC_SELECT_INSTANCE(pDeviceId->u32Id), E_XC_HDCP_IF_CMD_GETSTATUS, (void*)&XCArgs) != 0)
    {
        printf("Obtain XC engine fail\n");
        return (HDCP_EX_STATUS_INFO*)XCArgs.stReturnValue;
    }
    else
    {
        return (HDCP_EX_STATUS_INFO*)XCArgs.stReturnValue;
...
MS_U32  MApi_XC_EX_Get_DNRBaseOffset(XC_DEVICE_ID *pDeviceId, XC_EX_SCALER_WIN eWindow)
{
    if (_XC_SELECT_INSTANCE(pDeviceId->u32Id) == NULL)
    {
        printf("[%s,%5d] ID %ld, No instance existed, please get an instance by calling MApi_XC_Init() first\n",__FUNCTION__,__LINE__,pDeviceId->u32Id);
...
MS_BOOL MApi_XC_EX_Set_3D_HW2DTo3D_Buffer(XC_DEVICE_ID *pDeviceId, MS_PHYADDR u32HW2DTO3D_DD_Buf, MS_PHYADDR u32HW2DTO3D_DR_Buf)
{
    if (_XC_SELECT_INSTANCE(pDeviceId->u32Id) == NULL)
    {
        printf("[%s,%5d] ID %ld, No instance existed, please get an instance by calling MApi_XC_Init() first\n",__FUNCTION__,__LINE__,pDeviceId->u32Id);
...
void    MApi_XC_EX_SetFrameBufferAddress(XC_DEVICE_ID *pDeviceId, MS_PHYADDR u32FBAddress, MS_PHYADDR u32FBSize, XC_EX_SCALER_WIN eWindow)
{
    if (_XC_SELECT_INSTANCE(pDeviceId->u32Id) == NULL)
    {
        printf("[%s,%5d] ID %ld, No instance existed, please get an instance by calling MApi_XC_Init() first\n",__FUNCTION__,__LINE__,pDeviceId->u32Id);
...
void    MApi_XC_EX_MLoad_Init(XC_DEVICE_ID *pDeviceId, MS_PHYADDR PhyAddr, MS_U32 u32BufByteLen)
{
    if (_XC_SELECT_INSTANCE(pDeviceId->u32Id) == NULL)
    {
        printf("[%s,%5d] ID %ld, No instance existed, please get an instance by calling MApi_XC_Init() first\n",__FUNCTION__,__LINE__,pDeviceId->u32Id);
...
void    MApi_XC_EX_MLG_Init(XC_DEVICE_ID *pDeviceId, MS_PHYADDR PhyAddr, MS_U32 u32BufByteLen)
{
    if (_XC_SELECT_INSTANCE(pDeviceId->u32Id) == NULL)
    {
        printf("[%s,%5d] ID %ld, No instance existed, please get an instance by calling MApi_XC_Init() first\n",__FUNCTION__,__LINE__,pDeviceId->u32Id);
...
void    MApi_XC_EX_SetMCDIBufferAddress(XC_DEVICE_ID *pDeviceId, MS_PHYADDR u32FBAddress, MS_PHYADDR u32FBSize, XC_EX_MCDI_TYPE eType)
{
    if (_XC_SELECT_INSTANCE(pDeviceId->u32Id) == NULL)
    {
        printf("[%s,%5d] ID %ld, No instance existed, please get an instance by calling MApi_XC_Init() first\n",__FUNCTION__,__LINE__,pDeviceId->u32Id);
...
MS_BOOL MApi_XC_EX_LD_SetMemoryAddress(XC_DEVICE_ID *pDeviceId, MS_U8 u8MIU ,MS_U32 u32LDFBase0,MS_U32 u32LDFBase1,MS_U32 u32LDBBase0,MS_U32 u32LDBBase1,MS_U32 u32EDGE2DBase,MS_U32 u32LEDoffset)
{
    ...
    stXC_SET_LD_MEMORYADDRESS XCArgs = {0};
    XCArgs.u8MIU = u8MIU;
...
MS_BOOL MApi_XC_EX_Set_UsermodeLDFlags(XC_DEVICE_ID *pDeviceId, MS_BOOL buserLDFlags)
{
    ...
    stXC_SET_LD_USERMODEFLAGS XCArgs = {0};
...
{
    return (XC_EX_RETURN_VALUE)MApi_XC_DIP_SetDIPWinProperty((ST_XC_DIP_WINPROPERTY*)pstDIPWinProperty, (SCALER_DIP_WIN)eWindow);
}
...
{
    return (XC_EX_RETURN_VALUE)MApi_XC_DIP_SetDIPRProperty((ST_XC_DIPR_PROPERTY *)pstDIPRProperty, (SCALER_DIP_WIN)eWindow);
}
