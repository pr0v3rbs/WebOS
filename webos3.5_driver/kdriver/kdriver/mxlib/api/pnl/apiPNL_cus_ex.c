...
/*                      Function                                              */
/******************************************************************************/
MS_BOOL MApi_PNL_TCONMAP_DumpPSTable_EX(MS_U8 *pTCONTable, MS_U8 u8TconType, MS_U8 u8TconPnlIndex, MS_BOOL bEnable)
{
#if (API_CTRL_PS)
	if (MDrv_PNL_TCONMAP_Power_Sequence(pTCONTable, u8TconType, u8TconPnlIndex ,bEnable) == 0xFF)
		return FALSE;
	else
#endif
    return TRUE;
