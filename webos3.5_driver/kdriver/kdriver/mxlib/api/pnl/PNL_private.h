...
typedef MS_BOOL                             (*IOCTL_PNL_INIT)                                   (void*, PanelType*, MS_BOOL);
typedef MS_BOOL                             (*IOCTL_PNL_INIT_EX)                                (void*, PanelType*, MS_BOOL, MSIF_Version);
typedef void                                (*IOCTL_PNL_SETOUTPUT)                              (void*, APIPNL_OUTPUT_MODE);
typedef MS_BOOL                             (*IOCTL_PNL_CHANGEPANELTYPE)                        (void*, PanelType*, MS_BOOL);
...
typedef MS_BOOL                             (*IOCTL_PNL_CONTROL_PREEMPHASIS_LEVEL)              (void*, MS_BOOL,MS_U16);
typedef MS_BOOL                             (*IOCTL_PNL_CONTROL_VREG_LEVEL)                     (void*, MS_BOOL,MS_U16);
typedef MS_BOOL                             (*IOCTL_PNL_CONTROL_OUT_PE_CURRENT)                      (void*, MS_U16);
typedef MS_BOOL                             (*IOCTL_PNL_CONTROL_OUT_PE_CURRENT_PARTIAL)            (void*, MS_U8*);
...
typedef void                                (*IOCTL_PNL_SetOSDCOutputType)                            (void*,MS_U16,MS_U8);
typedef void                                (*IOCTL_PNL_Video_Protect)                            (void*, MS_BOOL);
typedef void                                (*IOCTL_PNL_Packer_Check)                            (void*, MS_U16);
...
typedef APIPNL_Result                       (*IOCTL_PNL_OSDC_INIT_STATUS)                        (void*, E_PNL_VIDEO_OSD_CONFIG);
typedef APIPNL_Result                       (*IOCTL_PNL_VIDEOOSD_CONFIG)                        (void*, E_PNL_VIDEO_OSD_CONFIG);
typedef APIPNL_Result                       (*IOCTL_PNL_DIVISIONMODE_CONFIG)                    (void*, E_PNL_DIVISIONMODE_CONFIG);
typedef void                                (*IOCTL_PNL_SET_GSTREAMER_PROCESS)                  (void*, MS_BOOL);
typedef MS_BOOL                             (*IOCTL_PNL_GET_GSTREAMER_PROCESS)                  (void*);
typedef void                                (*IOCTL_PNL_SET_CAPTURE_PROCESS)                  (void*, MS_BOOL);
typedef MS_BOOL                             (*IOCTL_PNL_GET_CAPTURE_PROCESS)                  (void*);
typedef void                                (*IOCTL_PNL_SET_MOD_PATTERN)                         (void*,MS_BOOL);
typedef void                                (*IOCTL_PNL_SET_STR_ENABLE)                         (void*, MS_BOOL);
typedef void                                (*IOCTL_PNL_SET_PANELINCH)                         (void*, MS_U16, MS_U16);
typedef void                                (*IOCTL_PNL_SET_FLAGCUS)                         (void*, MS_BOOL);
...
typedef struct
{
    ...
    IOCTL_PNL_CONTROL_PREEMPHASIS_LEVEL         fpPNL_Control_Preemphasis_Level;
    IOCTL_PNL_CONTROL_VREG_LEVEL                fpPNL_Control_VREG_Level;
    IOCTL_PNL_CONTROL_OUT_PE_CURRENT            fpPNL_Control_Out_PE_Current;
    IOCTL_PNL_CONTROL_OUT_PE_CURRENT_PARTIAL    fpPNL_Control_Out_PE_Current_Partial;
    ...
    IOCTL_PNL_SetOSDCOutputType                 fpPNL_SetOSDCOutputType;
    IOCTL_PNL_Video_Protect                     fpPNL_Video_Protect;
    IOCTL_PNL_Packer_Check                      fpPNL_Packer_Check;
    ...
    IOCTL_PNL_OSDC_INIT_STATUS                   fpPNL_OSDC_Init_Status;
    IOCTL_PNL_VIDEOOSD_CONFIG                   fpPNL_VideoOSDConfig;
    IOCTL_PNL_DIVISIONMODE_CONFIG               fpPNL_DivisionModeConfig;
    IOCTL_PNL_SET_GSTREAMER_PROCESS             fpPNL_Set_GstreamerProcess;
    IOCTL_PNL_GET_GSTREAMER_PROCESS             fpPNL_Get_GstreamerProcess;
    IOCTL_PNL_SET_CAPTURE_PROCESS               fpPNL_Set_CaptureProcess;
    IOCTL_PNL_GET_CAPTURE_PROCESS               fpPNL_Get_CaptureProcess;
	IOCTL_PNL_SET_MOD_PATTERN                   fpPNL_SET_MOD_PATTERN;    
    IOCTL_PNL_SET_STR_ENABLE                    fpPNL_Set_STREnable;
    IOCTL_PNL_SET_PANELINCH                     fpPNL_Set_PanelInch;
    IOCTL_PNL_SET_FLAGCUS                       fpPNL_Set_FlagCus;
    // Device ID
    MS_U32 u32DeviceID;
...
typedef struct
{
    ...
    MS_U8                        *_pu8GammaTab[3];
    MS_BOOL                      _bSkipTimingChange;
    MS_BOOL                      _bGstreamerProcess; // Skip some init for multi-process
    MS_BOOL                      _bCaptureProcess; // Skip some init for multi-process
    // Library info
    ...
    MS_BOOL _bEPIPanel;    
    MS_BOOL _bSTREnable;
    MS_U16 _u16SwingLevel;
    MS_U16 _u16PECurrent;
    MS_BOOL _bPNL_InitByCus;
} ST_APIPNL;
...
typedef struct
{
    ...
    MS_U16  _u16PnlDefault_PECurrent;
...
MS_BOOL MApi_PNL_Init_U2(void *pInstance, PanelType *pSelPanelType/* <in > */, MS_BOOL bEPUType);
MS_BOOL MApi_PNL_Init_Ex_U2(void *pInstance, PanelType *pSelPanelType/* <in > */, MS_BOOL bEPUType, MSIF_Version LIBVER);
void MApi_PNL_SetOutput_U2(void *pInstance, APIPNL_OUTPUT_MODE eOutputMode);
MS_BOOL MApi_PNL_ChangePanelType_U2(void *pInstance, PanelType *pSelPanelType, MS_BOOL bEPUType);
