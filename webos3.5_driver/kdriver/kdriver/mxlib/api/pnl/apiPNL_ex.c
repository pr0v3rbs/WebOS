...
static void _MApi_XC_DumpPanelData(const PNL_DeviceId *pPNL_DeviceId)
{
    ...
    {
        if(UtopiaOpen(MODULE_PNL, _PNL_SELECT_INSTANCE_P(pPNL_DeviceId->u32Id), 0, NULL) != UTOPIA_STATUS_SUCCESS)
        {
            printf("UtopiaOpen PNL failed\n");
            return;
        }
        PNL_INSTANCE_PRIVATE *pPNLInstancePrivate = NULL;
        UtopiaInstanceGetPrivate(_PNL_SELECT_INSTANCE(pPNL_DeviceId->u32Id), (void**)&pPNLInstancePrivate);
        pPNLInstancePrivate->u32DeviceID = pPNL_DeviceId->u32Id;
    }
...
*
*/
MS_BOOL MApi_PNL_EX_Init(const PNL_DeviceId *pPNL_DeviceId, PNL_EX_PanelType *pSelPanelType/* <in > */, MS_BOOL bEPIType)
{
    if(_PNL_SELECT_INSTANCE(pPNL_DeviceId->u32Id) == NULL)
    {
        if(UtopiaOpen(MODULE_PNL, _PNL_SELECT_INSTANCE_P(pPNL_DeviceId->u32Id), 0, NULL) != UTOPIA_STATUS_SUCCESS)
...
void MApi_PNL_EX_SetLPLLTypeExt(const PNL_DeviceId *pPNL_DeviceId, PNL_EX_LINK_EXT_TYPE eLPLL_TypeExt)
{
	...
	if(eLPLL_TypeExt<E_PNL_EX_LINK_EPI34_8P || eLPLL_TypeExt>E_PNL_EX_LINK_MINILVDS_1CH_6P_6BIT)
	{
	    printf("eLPLL_TypeExt fail\n");
		return;
	}
	else
	{
...
void MApi_PNL_EX_Init_MISC(const PNL_DeviceId *pPNL_DeviceId, PNL_EX_MISC ePNL_MISC)
{
	...
	switch(ePNL_MISC)
	{
        case E_PNL_EX_MISC_MFC_ENABLE:
		    PNLArgs.ePNL_MISC = E_APIPNL_MISC_MFC_ENABLE;
		    break;
		case E_PNL_EX_MISC_SKIP_CALIBRATION:
		    PNLArgs.ePNL_MISC = E_APIPNL_MISC_SKIP_CALIBRATION;
		    break;
		case E_PNL_EX_MISC_MFC_MCP:
		    PNLArgs.ePNL_MISC = E_APIPNL_MISC_MFC_MCP;
		    break;
		case E_PNL_EX_MISC_MFC_ABChannel:
		    PNLArgs.ePNL_MISC = E_APIPNL_MISC_MFC_ABChannel;
		    break;
		case E_PNL_EX_MISC_MFC_ACChannel:
		    PNLArgs.ePNL_MISC = E_APIPNL_MISC_MFC_ACChannel;
		    break;
		case E_PNL_EX_MISC_MFC_ENABLE_60HZ:
		    PNLArgs.ePNL_MISC = E_APIPNL_MISC_MFC_ENABLE_60HZ;
		    break;
		case E_PNL_EX_MISC_MFC_ENABLE_240HZ:
		    PNLArgs.ePNL_MISC = E_APIPNL_MISC_MFC_ENABLE_240HZ;
		    break;
		default:
			printf("eLPLL_TypeExt fail!!! \n");
			break;
