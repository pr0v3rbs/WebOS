...
static E_XC_ACE_INFOTYPE _ACE_Map_EX_InfoType(E_XC_ACE_EX_INFOTYPE eExInfoType)
{
    switch(eExInfoType)
    {
        case E_XC_ACE_EX_INFO_TYPE_VERSION:
        {
            return E_XC_ACE_INFO_TYPE_VERSION;
        }
        break;
        case E_XC_ACE_EX_INFO_TYPE_CONTRAST:
        {
            return E_XC_ACE_INFO_TYPE_CONTRAST;
        }
        break;
        case E_XC_ACE_EX_INFO_TYPE_R_GAIN:
        {
            return E_XC_ACE_INFO_TYPE_R_GAIN;
        }
        break;
        case E_XC_ACE_EX_INFO_TYPE_G_GAIN:
        {
            return E_XC_ACE_INFO_TYPE_G_GAIN;
        }
        break;
        case E_XC_ACE_EX_INFO_TYPE_B_GAIN:
        {
            return E_XC_ACE_INFO_TYPE_B_GAIN;
        }
        break;
        case E_XC_ACE_EX_INFO_TYPE_SATURATION:
        {
            return E_XC_ACE_INFO_TYPE_SATURATION;
        }
        break;
        case E_XC_ACE_EX_INFO_TYPE_HUE:
        {
            return E_XC_ACE_INFO_TYPE_HUE;
        }
        break;
        case E_XC_ACE_EX_INFO_TYPE_COLOR_CORRECTION_XY_R:
        {
            return E_XC_ACE_INFO_TYPE_COLOR_CORRECTION_XY_R;
        }
        break;
        case E_XC_ACE_EX_INFO_TYPE_COLOR_CORRECTION_XY_G:
        {
            return E_XC_ACE_INFO_TYPE_COLOR_CORRECTION_XY_G;
        }
        break;
        case E_XC_ACE_EX_INFO_TYPE_COLOR_CORRECTION_XY_B:
        {
            return E_XC_ACE_INFO_TYPE_COLOR_CORRECTION_XY_B;
        }
        break;
        case E_XC_ACE_EX_INFO_TYPE_COLOR_CORRECTION_OFFSET_R:
        {
            return E_XC_ACE_INFO_TYPE_COLOR_CORRECTION_OFFSET_R;
        }
        break;
        case E_XC_ACE_EX_INFO_TYPE_COLOR_CORRECTION_OFFSET_G:
        {
            return E_XC_ACE_INFO_TYPE_COLOR_CORRECTION_OFFSET_G;
        }
        break;
        case E_XC_ACE_EX_INFO_TYPE_COLOR_CORRECTION_OFFSET_B:
    {
            return E_XC_ACE_INFO_TYPE_COLOR_CORRECTION_OFFSET_B;
    }
        break;
        case E_XC_ACE_EX_INFO_TYPE_BRIGHTNESS_R:
        case E_XC_ACE_EX_INFO_TYPE_BRIGHTNESS_G:
        case E_XC_ACE_EX_INFO_TYPE_BRIGHTNESS_B:
        case E_XC_ACE_EX_INFO_TYPE_DUMMY:
        default:
            break;
    }
    return E_XC_ACE_INFO_TYPE_DUMMY;
}
...
static void _ACE_Map_EX_ApiStaus(XC_ACE_ApiStatus *pApiStatus, XC_ACE_EX_ApiStatus *pEXApiStatus)
{
    ...
    pEXApiStatus->ACEinit.S16ColorCorrectionMatrix = pApiStatus->ACEinit.S16ColorCorrectionMatrix;
    pEXApiStatus->ACEinit.S16RGB = pApiStatus->ACEinit.S16RGB;
...
MS_BOOL MApi_XC_ACE_EX_Init(XC_ACE_DeviceId *pDeviceId, XC_ACE_EX_InitData *pstXC_ACE_InitData, MS_U32 u32InitDataLen)
{
    ...
    {
        printf("Device %ld has initialized\n",pDeviceId->u32Id);
        return E_XC_ACE_FAIL;
    }
    ...
    {
        MS_U32 deviceID = 1;
        if(UtopiaOpen(MODULE_XC, &pu32ACE_XCInst_1, 0, &deviceID) != UTOPIA_STATUS_SUCCESS)
        {
            printf("UtopiaOpen pu32ACE_XCInst failed\n");
            return E_XC_ACE_FAIL;
        }
...
void MApi_XC_ACE_EX_PicSetColorTemp( XC_ACE_DeviceId *pDeviceId, MS_BOOL eWindow, MS_BOOL bUseYUVSpace, XC_ACE_EX_color_temp* pstColorTemp)
{
    ...
    {
        printf("[%s][%d] pstColorTemp=NULL, please check your input parameter!\n", __FUNCTION__, __LINE__);
    }
    else
    {
