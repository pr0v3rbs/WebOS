...
MS_U32 ACEOpen(void** ppInstance, MS_U32 u32ModuleVersion, void* pAttribute)
{
    ...
    psACEInstPri->fpACE_SETBT2020_COLORMETRY = MApi_XC_ACE_SetBT2020_Colormetry_U2;
    ...
    psACEInstPri->fpACE_PicSetHSC = MApi_XC_ACE_PicSetHSC_U2;
...
MS_U32 ACEIoctl(void* pInstance, MS_U32 u32Cmd, void* pArgs)
{
    ...
    switch(u32Cmd)
    {
        ...
        case E_ACE_CMD_SETBT2020_Colormetry:
            {
                pstACE_SetBT2020_Colormetry pACEArgs = (pstACE_SetBT2020_Colormetry)pArgs;
                pACEArgs->bReturn = psACEInstPri->fpACE_SETBT2020_COLORMETRY(pInstance, pACEArgs->eValue);
        ...
        case E_ACE_CMD_PICSETHSC:
            {
                pstACE_PicSetHSC pACEArgs = (pstACE_PicSetHSC)pArgs;
                psACEInstPri->fpACE_PicSetHSC(pInstance, pACEArgs->eWindow, pACEArgs->bUseYUVSpace, pACEArgs->u8Hue, pACEArgs->u8Saturation, pACEArgs->u8Contrast);
