...
typedef MS_BOOL                             (*IOCTL_ACE_SETBT2020_COLORMETRY)                 (void *pInstance, XC_ACE_BT2020_TYPE eValue);
...
typedef void                                (*IOCTL_ACE_PICSETHSC)                              (void *pInstance, MS_BOOL eWindow, MS_BOOL bUseYUVSpace, MS_U8 u8Hue, MS_U8 u8Saturation, MS_U8 u8Contrast);
...
typedef struct
{
    ...
    IOCTL_ACE_SETBT2020_COLORMETRY                  fpACE_SETBT2020_COLORMETRY;
    ...
    IOCTL_ACE_PICSETHSC                             fpACE_PicSetHSC;
...
MS_U32 ACEOpen(void** ppInstance, MS_U32 u32ModuleVersion, void* pAttribute);
