...
#define SUB_WINDOW      1
#define MODULE_ACE          MODULE_ACE
#define MODULE_ACE_KERNEL   MODULE_ACE | KERNEL_MODE
/******************************************************************************/
/*                      Debug information                                      */
/******************************************************************************/
...
static MS_BOOL _MApi_XC_ACE_Init_WithoutCreateMutex(void *pInstance, XC_ACE_InitData *pstXC_ACE_InitData)
{
...
MS_BOOL MApi_XC_ACE_Init_U2(void *pInstance, XC_ACE_InitData *pstXC_ACE_InitData, MS_U32 u32InitDataLen)
{
    ...
    bRet = _MApi_XC_ACE_Init_WithoutCreateMutex(pInstance, pstXC_ACE_InitData);
...
MS_BOOL MApi_XC_ACE_Init(XC_ACE_InitData *pstXC_ACE_InitData, MS_U32 u32InitDataLen)
{
    ...
    {
        if(UtopiaOpen(MODULE_XC, &pu32ACE_XCInst, 0, NULL) != UTOPIA_STATUS_SUCCESS)
        {
    ...
    if (pu32ACE_Kernel_Inst == NULL)
    {
        if(UtopiaOpen(MODULE_ACE_KERNEL, &pu32ACE_Kernel_Inst, 0, NULL) != UTOPIA_STATUS_SUCCESS)
        {
            printf("UtopiaOpen ACE failed\n");
            return E_XC_ACE_FAIL;
        }
    ...
    if(UtopiaIoctl(pu32ACE_Kernel_Inst, E_ACE_CMD_INIT, (void*)&ACEArgs) != UTOPIA_STATUS_SUCCESS)
    {
...
MS_BOOL MApi_XC_ACE_SetBT2020_Colormetry_U2(void *pInstance, XC_ACE_BT2020_TYPE eValue)
{
    MS_BOOL bRet = FALSE;
    XC_ACE_ENTRY();
    bRet = MDrv_ACE_SetBT2020_Colormetry(pInstance, eValue);
    XC_ACE_RETURN();
    return bRet;

}
MS_BOOL MApi_XC_ACE_SetBT2020_Colormetry( XC_ACE_BT2020_TYPE eValue)
{
    if (pu32ACEInst == NULL)
    {
        printf("ACE not initialized!\n");
    ...
    stACE_SetBT2020_Colormetry ACEArgs;
    ACEArgs.eValue = eValue;
    ACEArgs.bReturn = FALSE;
    if(UtopiaIoctl(pu32ACEInst, E_ACE_CMD_SETBT2020_Colormetry, (void*)&ACEArgs) != UTOPIA_STATUS_SUCCESS)
    {
        printf("Obtain ACE engine fail\n");
        return FALSE;
    }
...
void MApi_XC_ACE_PicSetHSC_U2(void *pInstance, MS_BOOL eWindow, MS_BOOL bUseYUVSpace, MS_U8 u8Hue, MS_U8 u8Saturation, MS_U8 u8Contrast)
{
    _ACE_SEMAPHORE_ENTRY(pInstance);
    XC_ACE_ENTRY();
    MDrv_ACE_PicSetHSC(pInstance,eWindow,bUseYUVSpace,u8Hue,u8Saturation,u8Contrast);
    XC_ACE_RETURN();
    _ACE_SEMAPHORE_RETURN(pInstance);
}

void MApi_XC_ACE_PicSetHSC( MS_BOOL eWindow, MS_BOOL bUseYUVSpace, MS_U8 u8Hue, MS_U8 u8Saturation, MS_U8 u8Contrast)
{
    if (pu32ACEInst == NULL)
    {
        printf("ACE not initialized!\n");
    ...
    stACE_PicSetHSC ACEArgs;
    ACEArgs.eWindow = eWindow;
    ACEArgs.bUseYUVSpace = bUseYUVSpace;
    ACEArgs.u8Contrast = u8Contrast;
    ACEArgs.u8Hue = u8Hue;
    ACEArgs.u8Saturation = u8Saturation;
    if(UtopiaIoctl(pu32ACEInst, E_ACE_CMD_PICSETHSC, (void*)&ACEArgs) != UTOPIA_STATUS_SUCCESS)
    {
        printf("Obtain ACE engine fail\n");
    }
    return;
...
E_XC_ACE_RESULT MApi_XC_ACE_SkipWaitVsync( MS_BOOL eWindow, MS_BOOL bIsSkipWaitVsyn)
{
    ...
    ACEArgs.eResult = E_XC_ACE_FAIL;
    if(UtopiaIoctl(pu32ACE_Kernel_Inst, E_ACE_CMD_SKIPWAITVSYNC, (void*)&ACEArgs) != UTOPIA_STATUS_SUCCESS)
    {
        printf("Obtain ACE engine fail\n");
        return E_XC_ACE_FAIL;
    }
...
void MApi_XC_ACE_PicSetColorTemp(MS_BOOL eWindow, MS_BOOL bUseYUVSpace, XC_ACE_color_temp* pstColorTemp)
{
    ...
    if(UtopiaIoctl(pu32ACE_Kernel_Inst, E_ACE_CMD_PICSETCOLORTEMP, (void*)&ACEArgs) != UTOPIA_STATUS_SUCCESS)
    {
        printf("Obtain ACE engine fail\n");
    }
    return;
...
MS_BOOL MApi_XC_ACE_MWEStatus_U2(void *pInstance)
{
    _ACE_SEMAPHORE_ENTRY(pInstance);
    _ACE_GET_VARIABLE();
    MS_BOOL bMWEStatusRet = bMWEStatus;
    _ACE_SEMAPHORE_RETURN(pInstance);
...
void MApi_XC_ACE_MWEFuncSel_U2(void *pInstance, MS_BOOL eWindow, E_XC_ACE_MWE_FUNC  mwe_func)
{
    ...
    case E_XC_ACE_MWE_MODE_H_SPLIT:
        ...
        XC_ACE_DBG_MSG("[MWE]_in_buffer;_enMirrorMode=%u,Ds-x[%lu],Ds-y[%lu],Ds-w[%lu],Ds-h[%lu].\n",_enMirrorMode,
        ...
        XC_ACE_DBG_MSG("[MWE]_out2;_enMirrorMode=%u,Ds-x[%lu],Ds-y[%lu],Ds-w[%lu],Ds-h[%lu].\n",_enMirrorMode,gMWERect.Xpos,gMWERect.Ypos,
...
MS_U16 MApi_XC_ACE_DNR_Get_PrecisionShift(void)
{
    ...
    ACEArgs.u16Return = 0;
    if(UtopiaIoctl(pu32ACE_Kernel_Inst, E_ACE_CMD_DNR_GET_PRECISIONSHIFT, (void*)&ACEArgs) != UTOPIA_STATUS_SUCCESS)
    {
        printf("Obtain ACE engine fail\n");
        return 0;
    }
    ...
    MS_U8 *pu8NRTBL)
{
    ...
    if(UtopiaIoctl(pu32ACE_Kernel_Inst, E_ACE_CMD_DNR_BLENDING_NRTBL, (void*)&ACEArgs) != UTOPIA_STATUS_SUCCESS)
    {
        printf("Obtain ACE engine fail\n");
    }
    return;
...
MS_U8 MApi_XC_ACE_DNR_Blending(MS_U8 u8NewItem, MS_U16 u16PreItem, MS_U8 u8Weight)
{
    ...
    ACEArgs.u8Weight = u8Weight;
    ACEArgs.u8Return = 0;
    if(UtopiaIoctl(pu32ACE_Kernel_Inst, E_ACE_CMD_DNR_BLENDING, (void*)&ACEArgs) != UTOPIA_STATUS_SUCCESS)
    {
        printf("Obtain ACE engine fail\n");
        return 0;
    }
    ...
    MS_U8 u8Step)
{
    ...
    ACEArgs.u16Return = 0;
    if(UtopiaIoctl(pu32ACE_Kernel_Inst, E_ACE_CMD_DNR_BLENDING_MISC, (void*)&ACEArgs) != UTOPIA_STATUS_SUCCESS)
    {
        printf("Obtain ACE engine fail\n");
        return 0;
    }
...
MS_U8 MApi_XC_ACE_DNR_GetMotion(void)
{
    ...
    ACEArgs.u8Return = 0;
    if(UtopiaIoctl(pu32ACE_Kernel_Inst, E_ACE_CMD_DNR_GETMOTION, (void*)&ACEArgs) != UTOPIA_STATUS_SUCCESS)
    {
        printf("Obtain ACE engine fail\n");
        return 0;
    }
    ...
    MS_U8 u8DeFilick_Step)
{
    ...
    ACEArgs.u8Return = 0;
    if(UtopiaIoctl(pu32ACE_Kernel_Inst, E_ACE_CMD_DNR_GETMOTION_WEIGHT, (void*)&ACEArgs) != UTOPIA_STATUS_SUCCESS)
    {
        printf("Obtain ACE engine fail\n");
        return 0;
    }
    ...
    MS_U8 u8DeFlick_Step)
{
    ...
    ACEArgs.u8Return = 0;
    if(UtopiaIoctl(pu32ACE_Kernel_Inst, E_ACE_CMD_DNR_GETLUMA_WEIGHT, (void*)&ACEArgs) != UTOPIA_STATUS_SUCCESS)
    {
        printf("Obtain ACE engine fail\n");
        return 0;
    }
    ...
    MS_U8 u8DeFlick_Step)
{
    ...
    ACEArgs.u8DeFlick_Step = u8DeFlick_Step;
    ACEArgs.u8Return = 0;
    if(UtopiaIoctl(pu32ACE_Kernel_Inst, E_ACE_CMD_DNR_GETNOISE_WEIGHT, (void*)&ACEArgs) != UTOPIA_STATUS_SUCCESS)
    {
        printf("Obtain ACE engine fail\n");
        return 0;
    }
...
void MApi_XC_ACE_DNR_Init_Motion(void)
{
    ...
    if(UtopiaIoctl(pu32ACE_Kernel_Inst, E_ACE_CMD_DNR_INIT_MOTION, (void*)NULL) != UTOPIA_STATUS_SUCCESS)
    {
        printf("Obtain ACE engine fail\n");
    }
    return;
...
void MApi_XC_ACE_DNR_Init_Luma(void)
{
    ...
    if(UtopiaIoctl(pu32ACE_Kernel_Inst, E_ACE_CMD_DNR_INIT_LUMA, (void*)NULL) != UTOPIA_STATUS_SUCCESS)
    {
        printf("Obtain ACE engine fail\n");
    }
    return;
...
void MApi_XC_ACE_DNR_Init_Noise(void)
{
    ...
    if(UtopiaIoctl(pu32ACE_Kernel_Inst, E_ACE_CMD_DNR_INIT_NOISE, (void*)NULL) != UTOPIA_STATUS_SUCCESS)
    {
        printf("Obtain ACE engine fail\n");
    }
    return;
...
MS_U8 MApi_XC_ACE_DNR_GetParam(MS_BOOL eWindow, XC_ACE_DNR_Param eParam)
{
    ...
    ACEArgs.u8Return = 0;
    if(UtopiaIoctl(pu32ACE_Kernel_Inst, E_ACE_CMD_DNR_GETPARAM, (void*)&ACEArgs) != UTOPIA_STATUS_SUCCESS)
    {
        printf("Obtain ACE engine fail\n");
        return 0;
    }
...
void MApi_XC_ACE_DNR_SetParam(MS_BOOL eWindow, XC_ACE_DNR_Param eParam, MS_U16 u16val)
{
    ...
    if(UtopiaIoctl(pu32ACE_Kernel_Inst, E_ACE_CMD_DNR_SETPARAM, (void*)&ACEArgs) != UTOPIA_STATUS_SUCCESS)
    {
        printf("Obtain ACE engine fail\n");
    }
    return;
...
MS_U32 MApi_XC_ACE_SetPowerState_U2(void* pInstance, EN_POWER_MODE enPowerState)
{
    ...
    else if (enPowerState == E_POWER_RESUME)
    {
        if (_enPrevPowerState == E_POWER_SUSPEND)
        {
            _ACE_SEMAPHORE_ENTRY(pInstance);
            _ACE_GET_VARIABLE();
            MS_BOOL bRet = _MApi_XC_ACE_Init_WithoutCreateMutex(pInstance, &g_XC_ACE_InitData);
            _ACE_SEMAPHORE_RETURN(pInstance);
            if(bRet == TRUE)
            {
                u32Ret = UTOPIA_STATUS_SUCCESS;
...
MS_BOOL MApi_XC2_ACE_Init(XC_ACE_InitData *pstXC_ACE_InitData, MS_U32 u32InitDataLen)
{
    MS_U32 u32deviceID = 1;
    if (pu32ACEInst_1 == NULL)
    {
        if(UtopiaOpen(MODULE_ACE, &pu32ACEInst_1, 0, &u32deviceID) != UTOPIA_STATUS_SUCCESS)
        {
            printf("UtopiaOpen ACE2 failed\n");
            return E_XC_ACE_FAIL;
        }
        if(UtopiaOpen(MODULE_XC, &pu32ACE_XCInst_1, 0, &u32deviceID) != UTOPIA_STATUS_SUCCESS)
        {
            printf("UtopiaOpen pu32ACE_XC2Inst failed\n");
            return E_XC_ACE_FAIL;
        }
    }
    stACE_Init ACEArgs;
    ...
    ACEArgs.u32InitDataLen = u32InitDataLen;
    ACEArgs.bReturn = FALSE;
    if(UtopiaIoctl(pu32ACEInst_1, E_ACE_CMD_INIT, (void*)&ACEArgs) != UTOPIA_STATUS_SUCCESS)
    {
        printf("Obtain ACE engine fail\n");
        return FALSE;
    }
...
void MApi_XC2_ACE_SelectYUVtoRGBMatrix(MS_BOOL eWindow, MS_U8 ucMatrix, MS_S16* psUserYUVtoRGBMatrix)
{
    if (pu32ACEInst_1 == NULL)
    {
        printf("ACE not initialized!\n");
    ...
    ACEArgs.ucMatrix = ucMatrix;
    ACEArgs.psUserYUVtoRGBMatrix = psUserYUVtoRGBMatrix;
    if(UtopiaIoctl(pu32ACEInst_1, E_ACE_CMD_SELECTYUVTORGBMATRIX, (void*)&ACEArgs) != UTOPIA_STATUS_SUCCESS)
    {
        printf("Obtain ACE engine fail\n");
    }
    return;
...
void MApi_XC2_ACE_SetPCYUV2RGB(MS_BOOL eWindow, MS_BOOL bEnable)
{
    if (pu32ACEInst_1 == NULL)
    {
        printf("ACE not initialized!\n");
    ...
    ACEArgs.eWindow = eWindow;
    ACEArgs.bEnable = bEnable;
    if(UtopiaIoctl(pu32ACEInst_1, E_ACE_CMD_SETPCYUV2RGB, (void*)&ACEArgs) != UTOPIA_STATUS_SUCCESS)
    {
        printf("Obtain ACE engine fail\n");
    }
    return;
...
void MApi_XC2_ACE_PicSetHue(MS_BOOL eWindow, MS_BOOL bUseYUVSpace, MS_U8 u8Hue)
{
    if (pu32ACEInst_1 == NULL)
    {
        printf("ACE not initialized!\n");
    ...
    ACEArgs.bUseYUVSpace = bUseYUVSpace;
    ACEArgs.u8Hue = u8Hue;
    if(UtopiaIoctl(pu32ACEInst_1, E_ACE_CMD_PICSETHUE, (void*)&ACEArgs) != UTOPIA_STATUS_SUCCESS)
    {
        printf("Obtain ACE engine fail\n");
    }
    return;
