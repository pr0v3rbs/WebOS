...
void JPEG_EXRegisterToUtopia(FUtopiaOpen ModuleType)
{
    ...
    // 1. deal with module
    void* pModuleJPEG_EX_V2 = NULL;
    UtopiaModuleCreate(MODULE_JPEG_EX, 0, &pModuleJPEG_EX_V2);
    UtopiaModuleRegister(pModuleJPEG_EX_V2);
    ...
    UtopiaModuleSetupFunctionPtr(pModuleJPEG_EX_V2,
    ...
    UtopiaModuleAddResourceStart(pModuleJPEG_EX_V2, JPEG_POOL_ID_JPD);
    UtopiaResourceCreate("JPD", sizeof(JPEG_RESOURCE_PRIVATE), &psResource);
    UtopiaResourceRegister(pModuleJPEG_EX_V2, psResource, JPEG_POOL_ID_JPD);
    UtopiaModuleAddResourceEnd(pModuleJPEG_EX_V2, JPEG_POOL_ID_JPD);
    UTOPIA_20_DBG("%s(): end\n", __FUNCTION__);
...
MS_U32 JPEGOpen(void** ppInstance, MS_U32 u32ModuleVersion, void* pAttribute)
{
    ...
    UTOPIA_20_DBG("%s(): start\n", __FUNCTION__);
    void* pModuleJPEG_EX_V2 = NULL;
    UtopiaModuleGetPtr(MODULE_JPEG_EX,&pModuleJPEG_EX_V2);
    // Check there is available decoder to be use
    if(UtopiaResourceObtain(pModuleJPEG_EX_V2, JPEG_POOL_ID_JPD, &pResource) != UTOPIA_STATUS_SUCCESS)
    {
...
#if 0
    for(i=0;i<SUPPORT_JPD_NUM_MAX;i++)
    {
