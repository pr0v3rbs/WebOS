...
typedef VDEC_EX_Result      (*IOCTL_VDEC_EX_KillProcess)          (VDEC_StreamId*);
...
typedef struct
{
    ...
    IOCTL_VDEC_EX_KillProcess            fpVDEC_EX_KillProcess;
...
typedef struct
{
    ...
    MS_U32              u32Arg[MAX_NUM_OF_STORE_USER_SET_CMD_U32ARG];
    //void*               pStructArg;
...
VDEC_EX_Result MApi_VDEC_EX_V2_KillProcess(VDEC_StreamId*);
