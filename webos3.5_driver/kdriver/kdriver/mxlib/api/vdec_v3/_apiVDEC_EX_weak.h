...
__vdec_if void MDrv_MVD_SetFrameBuffAddr(MS_U32 u32Id, MS_U32 u32addr) __vdec_weak;
...
__vdec_if MS_BOOL MDrv_MVD_DecodeIFrame(MS_U32 u32Id, MS_PHYADDR u32FrameBufAddr, MS_PHYADDR u32StreamBufAddr, MS_PHYADDR u32StreamBufEndAddr ) __vdec_weak;
...
__vdec_if MS_U32 MDrv_MVD_GetDropPicCounter(MS_U32 u32Id) __vdec_weak;
...
__vdec_if E_MVD_Result MDrv_MVD_DbgSetData(MS_U32 u32Id, MS_U32 u32Addr, MS_U32 u32Data) __vdec_weak;
__vdec_if E_MVD_Result MDrv_MVD_DbgGetData(MS_U32 u32Id, MS_U32 u32Addr, MS_U32* u32Data) __vdec_weak;
...
__vdec_if MS_BOOL MDrv_MVD_GenPattern(MS_U32 u32Id, MVD_PatternType ePattern, MS_PHYADDR u32PAddr, MS_U32* pu32Size) __vdec_weak;
...
__vdec_if MS_U8 MDrv_MVD_GetStereoType(MS_U32 u32Id) __vdec_weak;
...
__vdec_if MS_U64 MDrv_MVD_GetU64PTS(MS_U32 u32Id,MVD_PtsType eType) __vdec_weak;
...
__vdec_if E_MVD_Result MDrv_MVD_SetDynScalingParam(MS_U32 u32Id, MS_PHYADDR u32StAddr, MS_U32 u32Size) __vdec_weak;
...
__vdec_if E_MVD_Result MDrv_MVD_REE_GetVsyncExtShm(MS_U32* u32SHMAddr, MS_U32* u32VsyncExtShmOffset) __vdec_weak;
...
#ifdef VDEC3
__vdec_if HVD_EX_Result MDrv_HVD_EX_Init(MS_U32 u32Id, HVD_EX_MemCfg *mem, HVD_EX_InitSettings *InitParam, MS_BOOL bIsNSteram) __vdec_weak;
#else
...
__vdec_if HVD_EX_Result MDrv_HVD_EX_DecodeIFrame(MS_U32 u32Id, MS_PHYADDR u32SrcSt, MS_U32 u32SrcSize) __vdec_weak;
...
__vdec_if MS_U64 MDrv_HVD_EX_GetU64PTS_PreParse(MS_U32 u32Id) __vdec_weak;
...
__vdec_if MS_U32 MDrv_HVD_EX_GetMem_Dbg(MS_U32 u32Id, MS_U32 u32Addr) __vdec_weak;
__vdec_if void MDrv_HVD_EX_DbgDumpStatus(MS_U32 u32Id, HVD_EX_DumpStatus eFlag) __vdec_weak;
__vdec_if void MDrv_HVD_EX_SetMem_Dbg(MS_U32 u32Id, MS_U32 u32Addr, MS_U32 u32Arg) __vdec_weak;
...
__vdec_if HVD_EX_Result MDrv_HVD_EX_PreSetMFCodecMode(MS_U32 u32Id, HVD_EX_MFCodec_mode eMFCodecMode) __vdec_weak;
#endif
