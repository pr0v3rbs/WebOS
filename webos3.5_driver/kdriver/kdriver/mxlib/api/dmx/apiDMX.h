...
#define DMX_FILTER_TYPE_SECTION_VER             0x0000000D                  ///< DMX section filter type with version and CRC check
#define DMX_FILTER_FLT_MASK                     0xF2FF0F00
...
#define DMX_FILTER_SOURCEID_MASK                0x00000F00
#define DMX_FILTER_SOURCEID_0                   0x00000000
#define DMX_FILTER_SOURCEID_1                   0x00000100
#define DMX_FILTER_SOURCEID_2                   0x00000200
#define DMX_FILTER_SOURCEID_3                   0x00000300
#define DMX_FILTER_SOURCEID_4                   0x00000400
#define DMX_FILTER_SOURCEID_5                   0x00000500
#define DMX_FILTER_SOURCEID_6                   0x00000600
#define DMX_FILTER_SOURCEID_7                   0x00000700
#define DMX_FILTER_SOURCEID_8                   0x00000800
#define DMX_FILTER_SOURCEID_9                   0x00000900
#define DMX_FILTER_SOURCEID_10                  0x00000a00
#define DMX_FILTER_SOURCEID_11                  0x00000b00
#define DMX_FILTER_SOURCEID_12                  0x00000c00
#define DMX_FILTER_SOURCEID_13                  0x00000d00
#define DMX_FILTER_SOURCEID_14                  0x00000e00
#define DMX_FILTER_SOURCEID_15                  0x00000f00
...
#define DMX_MAX_SIGFLAG_NUM             10
#define DMX_MAX_PVRSIGFLAG_NUM          6
typedef struct
{
    MS_U32                 u32Eng;
...
typedef enum
{
    ...
    DMX_CAP_FW_BUF_ADDR             = 41,        ////Add for STR
    DMX_CAP_PIDFLT_MAP              = 42,        ////Add for STR
    DMX_CAP_SECFLT_MAP              = 43,        ////Add for STR
...
typedef enum
{
    ...
    DMX_HW_TYPE_TV_TYPE2_CA2     = 0x00001006,       ///< The HW architecture is TV series with general PVR filters, with general dscmb filters, and merge stream
    DMX_HW_TYPE_STB_SERIES       = 0x00002000,       ///< The HW architecture is BOX series without PVR cunfction
    DMX_HW_TYPE_STB_TYPE1        = 0x00002001,       ///< The HW architecture is BOX series 1
    DMX_HW_TYPE_STB_TYPE2        = 0x00002002,       ///< The HW architecture is BOX series 2
    DMX_HW_TYPE_STB_TYPE3        = 0x00002003,       ///< The HW architecture is BOX series 3
    DMX_HW_TYPE_STB_TYPE3_CASPS  = 0x80002003,       ///< The HW architecture is BOX series 3 with PVR CA SPS enable mode
} DMX_HW_TYPE;
...
typedef enum
{
    ...
    E_DMX_FQ_SKIP_PCR1_RUSH_DATA            = 0x00001000,
    E_DMX_FQ_SKIP_PVR3_RUSH_DATA            = E_DMX_FQ_SKIP_PCR1_RUSH_DATA,
    E_DMX_FQ_SKIP_CFG1_MASK                 = 0x80000000,
    E_DMX_FQ_SKIP_APES_C_RUSH_DATA          = 0x80000008,
    E_DMX_FQ_SKIP_APES_D_RUSH_DATA          = 0x80000010,
    E_DMX_FQ_SKIP_V3DPES_RUSH_DATA          = 0x80000020,
    E_DMX_FQ_SKIP_PVR2_RUSH_DATA            = 0x80000200,
}DMX_FQ_SkipPath;
