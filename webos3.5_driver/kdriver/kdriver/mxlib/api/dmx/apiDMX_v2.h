...
typedef struct _DMX_CAP_EX_PARAM
{
    MS_U32                  u32Res;
    int                     InputStrLen;
    int                     OutputSize;
...
typedef struct _DMX_TSO_CFG_PARAM
{
    MS_U32                  u32Res;
    MS_U32                  u32TsoEng;
    ...
    MS_U32                  u32CmdData0;
}DMX_TSO_CFG_PARAM, *PDMX_TSO_CFG_PARAM;
...
typedef struct _DMX_OutputPad_Cfg
{
    MS_U32              u32Res;    
...
typedef struct _DMX_FLOW_DSCMBENG_PARAM
{
    MS_U32              u32Res;  
    MS_U32              u32DscmbEng;
    DMX_TSIF            eTsif;
...
typedef struct _DMX_DROP_SCMB_PKT_PARAM
{
    MS_U32              u32Res;
    DMX_FILTER_TYPE     eType;
    MS_BOOL             bEnable;
