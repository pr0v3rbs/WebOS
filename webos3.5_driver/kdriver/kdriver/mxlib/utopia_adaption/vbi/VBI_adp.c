...
UADP_SPT_1NXT_DEF(VBI_GET_COMPLETE_VPS_DATA);
...
//set table
    ...
    UADP_SPT_0NXT(VBI_REGISTER_CB);
    UADP_SPT_0NXT(VBI_INITIALIZER_TTX_SLICER);
    ...
    UADP_SPT_0NXT(VBI_CC_INIT_SLICER);
    ...
    UADP_SPT_0NXT(DMX_TTX_SET_FILTERID);

    UADP_SPT_1NXT(VBI_GETSTATUS_PARAM, pDrvStatus, VBI_DrvStatus);
    UADP_SPT_2NXT(VBI_GET_VPS_DATA, lowerWord, MS_U8, higherWord, MS_U8);
    UADP_SPT_1NXT(VBI_TTX_GET_PACKETS, length, MS_U32);
    UADP_SPT_1NXT(VBI_TTX_GET_PACKET, packetAddress, MS_PHYADDR);
    UADP_SPT_1NXT(VBI_CC_SETDATARATE, ptable, VBI_CC_TABLE);
    UADP_SPT_1NXT(VBI_GET_COMPLETE_VPS_DATA, length, MS_U32);
...
MS_U32 VBI_adp_Ioctl(void* pInstanceTmp, MS_U32 u32Cmd, void* const pArgs)
{
    ...
    switch(u32Cmd)
    {
        ...
        case MDrv_CMD_VBI_GetCompleteVPS_Data:
			u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_VBI_GET_COMPLETE_VPS_DATA,spt_VBI_GET_COMPLETE_VPS_DATA,buffer_arg,sizeof(buffer_arg));
		    break;
