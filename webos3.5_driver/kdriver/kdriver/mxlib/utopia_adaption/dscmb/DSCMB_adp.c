...
//set table
    DSCMB_QUERYCAP*         pDSCMB_psQuery              =NULL;
    DSCMB_HDCP2_SETRIV*     pDSCMB_pstSetRiv            =NULL;
    DSCMB_MULTI2_SETSYSKEY* pDSCMB_psSetSysKey          =NULL;
    DSCMB_DSCMBSTATUS* pDSCMB_psStatus = NULL;
    DSCMB_ENGKEY*           pDSCMB_psEngSetKey          =NULL;
    DSCMB_ENGIV*            pDSCMB_psEngSetIv           =NULL;

    DSCMB_KL_ATOMICEXEC*    pDSCMB_psKlAtomicExec       =NULL;
    DSCMB_KL_ETSI*          pDSCMB_psKlETSI             =NULL;
    DSCMB_KLCfg_All*        pDSCMB_psSetSysKey_KCLfg_All=NULL;
    DSCMB_FLTIVSET*         pDSCMB_pstFltIVSet          =NULL;
    DSCMB_FLTKEYSET*        pDSCMB_pstFltKeySet         =NULL;
    ...
    UADPBypassSetSPT(&spt_DSCMB_pstFltKeySet[1],UADP_SPT_POINTER_TO_NEXT, ((unsigned int)(&(pDSCMB_pstFltKeySet->pu8Key)) - (unsigned int)pDSCMB_pstFltKeySet), (unsigned int)spt_DSCMB_pstFltKeySet_Key);
    ...
    UADPBypassSetSPT(&spt_DSCMB_pstFltIVSet[1],UADP_SPT_POINTER_TO_NEXT, ((unsigned int)(&(pDSCMB_pstFltIVSet->pu8IV)) - (unsigned int)pDSCMB_pstFltIVSet), (unsigned int)spt_DSCMB_pstFltIVSet_Iv);
    ...
    UADPBypassSetSPT(&spt_DSCMB_pstSetRiv[1],UADP_SPT_POINTER_TO_NEXT, ((unsigned int)(&(pDSCMB_pstSetRiv->pu8Riv)) - (unsigned int)pDSCMB_pstSetRiv), (unsigned int)spt_DSCMB_pstSetRiv_Iv);
    ...
    UADPBypassSetSPT(&spt_DSCMB_psSetSysKey[1],UADP_SPT_POINTER_TO_NEXT, ((unsigned int)(&(pDSCMB_psSetSysKey->pu8SysKey)) - (unsigned int)pDSCMB_psSetSysKey), (unsigned int)spt_DSCMB_psSetSysKey_Key);
    ...
    UADPBypassSetSPT(&spt_DSCMB_pDscmbStatus[1],UADP_SPT_POINTER_TO_NEXT,((unsigned int)(&(pDSCMB_psStatus->pScmbLevel)) - (unsigned int)pDSCMB_psStatus), (unsigned int)spt_DSCMB_pDscmbStatus_Status);
    ...
    UADPBypassSetSPT(&spt_DSCMB_psQuery[1],UADP_SPT_POINTER_TO_NEXT, ((unsigned int)(&(pDSCMB_psQuery->pInput)) - (unsigned int)pDSCMB_psQuery), (unsigned int)spt_DSCMB_psQuery_InOut);
    UADPBypassSetSPT(&spt_DSCMB_psQuery[2],UADP_SPT_POINTER_TO_NEXT, ((unsigned int)(&(pDSCMB_psQuery->pOutput)) - (unsigned int)pDSCMB_psQuery), (unsigned int)spt_DSCMB_psQuery_InOut);
    ...
    UADPBypassSetSPT(&spt_DSCMB_pDscmbEngSetKey[1],UADP_SPT_POINTER_TO_NEXT, ((unsigned int)(&(pDSCMB_psEngSetKey->pu8Key)) - (unsigned int)pDSCMB_psEngSetKey), (unsigned int)spt_DSCMB_psEngSetKey_Key);
    ...
    UADPBypassSetSPT(&spt_DSCMB_pDscmbEngSetIv[1],UADP_SPT_POINTER_TO_NEXT, ((unsigned int)(&(pDSCMB_psEngSetIv->pu8IV)) - (unsigned int)pDSCMB_psEngSetIv), (unsigned int)spt_DSCMB_psEngSetIV_Iv);
    ...
    UADPBypassSetSPT(&spt_DSCMB_pDscmbKLaddrAtomicExec[1],UADP_SPT_POINTER_TO_NEXT, ((unsigned int)(&(pDSCMB_psKlAtomicExec->KLCfg)) - (unsigned int)pDSCMB_psKlAtomicExec), (unsigned int)spt_DSCMB_psKLAtomicExec_KLCFG);
    UADPBypassSetSPT(&spt_DSCMB_pDscmbKLaddrAtomicExec[2],UADP_SPT_POINTER_TO_NEXT, ((unsigned int)(&(pDSCMB_psKlAtomicExec->ACPU_Out)) - (unsigned int)pDSCMB_psKlAtomicExec), (unsigned int)spt_DSCMB_psKLAtomicExec_ACPUOut);
    UADPBypassSetSPT(&spt_DSCMB_pDscmbKLaddrAtomicExec[3],UADP_SPT_POINTER_TO_NEXT, ((unsigned int)(&(pDSCMB_psKlAtomicExec->u32Status)) - (unsigned int)pDSCMB_psKlAtomicExec), (unsigned int)spt_DSCMB_psKL_Status);
    ...
    UADPBypassSetSPT(&spt_DSCMB_pDscmbKLaddrETSI[1],UADP_SPT_POINTER_TO_NEXT, ((unsigned int)(&(pDSCMB_psKlETSI->KLCfg)) - (unsigned int)pDSCMB_psKlETSI), (unsigned int)spt_DSCMB_psKLAtomicExec_KLCFG);
    UADPBypassSetSPT(&spt_DSCMB_pDscmbKLaddrETSI[2],UADP_SPT_POINTER_TO_NEXT, ((unsigned int)(&(pDSCMB_psKlETSI->ACPU_Out)) - (unsigned int)pDSCMB_psKlETSI), (unsigned int)spt_DSCMB_psKLAtomicExec_ACPUOut);
    UADPBypassSetSPT(&spt_DSCMB_pDscmbKLaddrETSI[3],UADP_SPT_POINTER_TO_NEXT, ((unsigned int)(&(pDSCMB_psKlETSI->pu8Nonce)) - (unsigned int)pDSCMB_psKlETSI), (unsigned int)spt_DSCMB_psKLETSI_Nonce);
    UADPBypassSetSPT(&spt_DSCMB_pDscmbKLaddrETSI[4],UADP_SPT_POINTER_TO_NEXT, ((unsigned int)(&(pDSCMB_psKlETSI->pu8Response)) - (unsigned int)pDSCMB_psKlETSI), (unsigned int)spt_DSCMB_psKLETSI_Response);
    UADPBypassSetSPT(&spt_DSCMB_pDscmbKLaddrETSI[5],UADP_SPT_POINTER_TO_NEXT, ((unsigned int)(&(pDSCMB_psKlETSI->u32Status)) - (unsigned int)pDSCMB_psKlETSI), (unsigned int)spt_DSCMB_psKL_Status);
...
//BOTTOM
    ...
    UADPBypassSetSPT(&spt_DSCMB_psKLAtomicExec_KLCFG[1],UADP_SPT_POINTER_TO_NEXT, ((unsigned int)(&(pDSCMB_psSetSysKey_KCLfg_All->u8KeyACPU)) - (unsigned int)pDSCMB_psSetSysKey_KCLfg_All), (unsigned int)spt_DSCMB_psKLAtomicExec_KLCFG_KeyACPU);
    UADPBypassSetSPT(&spt_DSCMB_psKLAtomicExec_KLCFG[2],UADP_SPT_POINTER_TO_NEXT, ((unsigned int)(&(pDSCMB_psSetSysKey_KCLfg_All->pu8KeyKLIn)) - (unsigned int)pDSCMB_psSetSysKey_KCLfg_All), (unsigned int)spt_DSCMB_psKLAtomicExec_KLCFG_KeyKLIn);
