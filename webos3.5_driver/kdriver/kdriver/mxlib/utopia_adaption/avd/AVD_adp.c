...
UADP_STRUCT_POINTER_TABLE spt_AVD_SETHSYNCSENSITIVITYFORDEBUG[10];
...
//========  
    UADP_SPT_BGN(&u8Value[0],sizeof(MS_U8));
    UADP_SPT_FIN(&u8Value[1]);  
    UADP_SPT_BGN(&u16Value[0],sizeof(MS_U16));
    UADP_SPT_FIN(&u16Value[1]); 
    UADP_SPT_BGN(&u32Value[0],sizeof(MS_U32));
    UADP_SPT_FIN(&u32Value[1]); 
    UADP_SPT_BGN(&bEnable[0],sizeof(MS_BOOL));
   ...
   // UADP_SPT_FIN(&spt_AVD_BACKPORCHWINPOS[1]);
    ...
    UADP_SPT_BGN(&spt_AVD_GETCAPTUREWINDOW[0], sizeof(AVD_GETCAPTUREWINDOW));
    UADP_SPT_NXT(&spt_AVD_GETCAPTUREWINDOW[1],AVD_GETCAPTUREWINDOW,stCapWin, spt_AVD_stCapWin);
    UADP_SPT_FIN(&spt_AVD_GETCAPTUREWINDOW[2]);
    ...
    UADP_SPT_BGN(&spt_AVD_SETHSYNCSENSITIVITYFORDEBUG[0],sizeof(AVD_SETHSYNCSENSITIVITYFORDEBUG));
    UADP_SPT_FIN(&spt_AVD_SETHSYNCSENSITIVITYFORDEBUG[1]);    
    ...
    switch(u32Cmd)
    {
        ...
        */
        ...
        case MDrv_CMD_AVD_SetFlag:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,u32Value,NULL,buffer_arg,sizeof(buffer_arg));
        break;
        ...
        */
        case MDrv_CMD_AVD_Set_Htt_UserMD :
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,u16Value,NULL,buffer_arg,sizeof(buffer_arg));
        break;
        ...
        */
        ...
        case MDrv_CMD_AVD_SetAutoFineGainToFixed:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,NULL,u8Value,buffer_arg,sizeof(buffer_arg));
        break;
        */
        ...
        */
        ...
        case MDrv_CMD_AVD_SetHsyncSensitivityForDebug:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_AVD_SETHSYNCSENSITIVITYFORDEBUG,NULL,buffer_arg,sizeof(buffer_arg));
        default:
        break;
