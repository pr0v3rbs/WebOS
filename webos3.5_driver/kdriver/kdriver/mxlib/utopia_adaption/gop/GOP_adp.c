...
UADP_SPT_NAMEnNXT_DEF(GOP_SETLAYER_LayerInfo,0);
UADP_SPT_NAMEnNXT_DEF(GOP_SETLAYER,1);
//MAPI_CMD_GOP_SET_MIRROR:
UADP_SPT_NAMEnNXT_DEF(GOP_MIRROR,0);
//MAPI_CMD_GOP_GET_MIRROR:
UADP_SPT_NAMEnNXT_DEF(GOP_GETMIRROR_A0,0);
UADP_SPT_NAMEnNXT_DEF(GOP_GETMIRROR,1);
...
UADP_SPT_NAMEnNXT_DEF(GOP_GWIN_DISPLAY_DisplayInfo,0);
...
UADP_SPT_NAMEnNXT_DEF(GOP_GWIN_GFLIP_SWITCH_MULTI_GWIN_MultiFlipInfo,0);
...
UADP_SPT_NAMEnNXT_DEF(GOP_CB_A0, 0);
UADP_SPT_NAMEnNXT_DEF(GOP_CB,1);
...
{
    //MAPI_CMD_GOP_INIT
    UADP_SPT_NAME0NXT(GOP_INIT_pInfo,GOP_InitInfo);
    ...
    UADP_SPT_NAME0NXT(GOP_CONFIG_GET_MAXFBNUM_A0,MS_U32);
    ...
    //MAPI_CMD_GOP_SET_LAYER:
    UADP_SPT_NAME0NXT(GOP_SETLAYER_LayerInfo,GOP_SETLayer);
    UADP_SPT_NAME1NXT(GOP_SETLAYER,GOP_SETLAYER_PARAM,pLayerInfo,GOP_SETLAYER_LayerInfo);
    //MAPI_CMD_GOP_SET_MIRROR:
    UADP_SPT_NAME0NXT(GOP_MIRROR,GOP_SETMIRROR_PARAM);
    //MAPI_CMD_GOP_GET_MIRROR:
    UADP_SPT_NAME0NXT(GOP_GETMIRROR_A0,EN_GOP_MIRROR_TYPE);
    UADP_SPT_NAME1NXT(GOP_GETMIRROR,GOP_GETMIRROR_PARAM,pdir,GOP_GETMIRROR_A0);
    //MAPI_CMD_GOP_GET_STATUS:
    ...
    UADP_SPT_NAME0NXT(GOP_GWIN_PROPERTY_SWITCH_2_GWIN_u32,DRV_GOP_CBFmtInfo);
    ...
    //MAPI_CMD_GOP_GWIN_SET_WININFO:
    //MAPI_CMD_GOP_GWIN_GET_WININFO:
    UADP_SPT_NAME0NXT(GOP_GWIN_SETWININFO_info,GOP_BUFFER_INFO);
    UADP_SPT_NAME1NXT(GOP_GWIN_SETWININFO,GOP_GWIN_SETWININFO_PARAM,pinfo,GOP_GWIN_SETWININFO_info);
    //MAPI_CMD_GOP_GWIN_SETDISPLAY:
    UADP_SPT_NAME0NXT(GOP_GWIN_DISPLAY_DisplayInfo,GOP_GWINDISPLAY_INFO);
    ...
    UADP_SPT_NAME1NXT(GOP_GWIN_GFLIP_SWITCH_GWIN_FlipInfo,GOP_GWIN_FLIP_WIN_INFO, pQueueCnt, GOP_GWIN_GFLIP_SWITCH_GWIN_FlipInfo_pQueueCnt);
    ...
    //MAPI_CMD_GOP_GFLIP_SWITCHMULTIGWIN:
    //UADP_SPT_NAME1NXT(GOP_GWIN_GFLIP_SWITCH_MULTI_GWIN_MultiFlipInfo,GOP_GWIN_FLIP_MULTI_WIN_INFO, );
    ...
    //MAPI_CMD_GOP_FB_CREATE:
    UADP_SPT_NAME0NXT(GOP_CREATE_BUFFER_BufInfo,GOP_BUFFER_INFO);
    ...
    //MAPI_CMD_GOP_FB_GETINFO:
    //MAPI_CMD_GOP_FB_SETINFO:
    UADP_SPT_NAME0NXT(GOP_FB_INFO_BufInfo,GOP_BUFFER_INFO);
    ...
    //MAPI_CMD_GOP_DWIN_CAPTURE:
    UADP_SPT_NAME0NXT(GOP_DWIN_CAPTURE_Dwin,GOP_CAPTURE_INFO);
    ...
    UADP_SPT_NAME0NXT(GOP_DWIN_PROPERTY_PINPON_Pinpon,GOP_PINPON_INFO);
    ...
    UADP_SPT_NAME1NXT(GOP_VE_PROPERTY_OUTPUT_TIMING,GOP_VE_PROPERTY_PARAM,pVEProp,GOP_VE_PROPERTY_OUTPUT_TIMING);
    //MAPI_CMD_GOP_UPDATE:
    ...
    //MAPI_CMD_GOP_REGISTER_CB:
    UADP_SPT_NAME0NXT(GOP_CB_A0, MS_U32);
    UADP_SPT_NAME1NXT(GOP_CB,GOP_REGISTER_CB_PARAM,pCB,GOP_CB_A0);
    //MAPI_CMD_GOP_TESTPATTERN:
    UADP_SPT_NAME0NXT(GOP_TESTPATTERN, GOP_TEST_PATTERN_PARAM);
    //MAPI_CMD_GOP_SELECTION:
    UADP_SPT_NAME0NXT(GOP_SELECTION_SELGOP_A0, DRV_GOP_CBFmtInfo);
    ...
    UADP_SPT_NAME0NXT(GOP_SELECTION_SELFB_A0, DRV_GOP_CBFmtInfo);
...
MS_U32 GOP_adp_Ioctl(void* pInstanceTmp, MS_U32 u32Cmd, void* const pArgs)
{
    ...
    //a large array may exhaust the kernel stack; change from 2048 to 1
    char buffer_arg[1];
    ...
    switch(u32Cmd)
    {
        ...
        case MAPI_CMD_GOP_GET_MIRROR:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_GOP_GETMIRROR, spt_GOP_GETMIRROR,buffer_arg,sizeof(buffer_arg));
            break;
        ...
        case MAPI_CMD_GOP_GFLIP_SWITCHGWIN:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_GOP_GWIN_GFLIP_SWITCH_GWIN, NULL,buffer_arg,sizeof(buffer_arg));
            break;
        case MAPI_CMD_GOP_GFLIP_SWITCHMULTIGWIN:
            ...
            for(i=0; i<Usr_A0->u8InfoCnt; i++)
            {
                ...
                Str_A0B0[i].pQueueCnt =&Str_A0B0CO;
        ...
        case MAPI_CMD_GOP_REGISTER_CB:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_GOP_CB,NULL,buffer_arg,sizeof(buffer_arg));
            break;
        ...
        case MAPI_CMD_GOP_SELECTION:
            {
                ...
                {
                    case EN_GOP_SEL_GOP:
                        u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_GOP_SELECTION_SELGOP, spt_GOP_SELECTION_SELGOP,buffer_arg,sizeof(buffer_arg));
                        break;
                    case EN_GOP_SEL_GWIN:
                        u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_GOP_SELECTION_SELGWIN, spt_GOP_SELECTION_SELGWIN,buffer_arg,sizeof(buffer_arg));
                        break;
                    case EN_GOP_SEL_FB:
