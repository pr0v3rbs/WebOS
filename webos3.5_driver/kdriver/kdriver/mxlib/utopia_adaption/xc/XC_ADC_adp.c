...
//set table
    ...
    UADPBypassSetSPT(&spt_XC_ADC_GETSOGLEVELRANGE[1],UADP_SPT_POINTER_TO_NEXT,
        ((unsigned int)(&(pXC_ADC_GETSOGLEVELRANGE->u32min)) - (unsigned int)pXC_ADC_GETSOGLEVELRANGE), (unsigned int)spt_XC_ADC_TYPE_U32);
    UADPBypassSetSPT(&spt_XC_ADC_GETSOGLEVELRANGE[2],UADP_SPT_POINTER_TO_NEXT,
        ((unsigned int)(&(pXC_ADC_GETSOGLEVELRANGE->u32max)) - (unsigned int)pXC_ADC_GETSOGLEVELRANGE), (unsigned int)spt_XC_ADC_TYPE_U32);
    UADPBypassSetSPT(&spt_XC_ADC_GETSOGLEVELRANGE[3],UADP_SPT_POINTER_TO_NEXT,
        ((unsigned int)(&(pXC_ADC_GETSOGLEVELRANGE->u32Recommend_value)) - (unsigned int)pXC_ADC_GETSOGLEVELRANGE), (unsigned int)spt_XC_ADC_TYPE_U32);
    ...
    UADPBypassSetSPT(&spt_XC_ADC_GETDEFAULTGAINOFFSET[1],UADP_SPT_POINTER_TO_NEXT,
        ((unsigned int)(&(pXC_ADC_GETDEFAULTGAINOFFSET->pstADCSetting)) - (unsigned int)pXC_ADC_GETDEFAULTGAINOFFSET), (unsigned int)spt_XC_AdcGainOffsetSetting);
    ...
    UADPBypassSetSPT(&spt_XC_ADC_ADJUSTGAINOFFSET[1],UADP_SPT_POINTER_TO_NEXT,
        ((unsigned int)(&(pXC_ADC_ADJUSTGAINOFFSET->pstADCSetting)) - (unsigned int)pXC_ADC_ADJUSTGAINOFFSET), (unsigned int)spt_XC_AdcGainOffsetSetting);
