...
//set table
    ...
    UADPBypassSetSPT(&spt_XC_AUTO_GEOMETRY[1],UADP_SPT_POINTER_TO_NEXT,
        ((unsigned int)(&(pXC_AUTO_GEOMETRY->ActiveInfo)) - (unsigned int)pXC_AUTO_GEOMETRY), (unsigned int)spt_XC_Auto_Signal_Info);
    UADPBypassSetSPT(&spt_XC_AUTO_GEOMETRY[2],UADP_SPT_POINTER_TO_NEXT,
        ((unsigned int)(&(pXC_AUTO_GEOMETRY->StandardInfo)) - (unsigned int)pXC_AUTO_GEOMETRY), (unsigned int)spt_XC_Auto_Signal_Info);
    ...
    UADPBypassSetSPT(&spt_XC_AUTO_GEOMETRY_EX[1],UADP_SPT_POINTER_TO_NEXT,
        ((unsigned int)(&(pXC_AUTO_GEOMETRY_EX->ActiveInfo)) - (unsigned int)pXC_AUTO_GEOMETRY_EX), (unsigned int)spt_XC_Auto_Signal_Info_Ex);
    UADPBypassSetSPT(&spt_XC_AUTO_GEOMETRY_EX[2],UADP_SPT_POINTER_TO_NEXT,
        ((unsigned int)(&(pXC_AUTO_GEOMETRY_EX->StandardInfo)) - (unsigned int)pXC_AUTO_GEOMETRY_EX), (unsigned int)spt_XC_Auto_Signal_Info_Ex);
    ...
    UADPBypassSetSPT(&spt_XC_AUTO_GAINOFFSET[1],UADP_SPT_POINTER_TO_NEXT,
        ((unsigned int)(&(pXC_AUTO_GAINOFFSET->pstADCSetting)) - (unsigned int)pXC_AUTO_GAINOFFSET), (unsigned int)spt_XC_AUTOGainOffsetSetting);
	...
	UADPBypassSetSPT(&spt_XC_AUTO_GETHWFIXEDGAINOFFSET[1],UADP_SPT_POINTER_TO_NEXT,
        ((unsigned int)(&(pXC_AUTO_GETHWFIXEDGAINOFFSET->pstADCSetting)) - (unsigned int)pXC_AUTO_GETHWFIXEDGAINOFFSET), (unsigned int)spt_XC_AUTOGainOffsetSetting);
    ...
    UADPBypassSetSPT(&spt_XC_AUTO_DETECTWIDTH[1],UADP_SPT_POINTER_TO_NEXT,
        ((unsigned int)(&(pXC_AUTO_DETECTWIDTH->pSignalInfo)) - (unsigned int)pXC_AUTO_DETECTWIDTH), (unsigned int)spt_XC_Auto_Signal_Info_Ex);
    ...
    UADPBypassSetSPT(&spt_XC_AUTO_GETCALIBRATIONMODE[1],UADP_SPT_POINTER_TO_NEXT,
        ((unsigned int)(&(pXC_AUTO_GETCALIBRATIONMODE->eMode)) - (unsigned int)pXC_AUTO_GETCALIBRATIONMODE), (unsigned int)spt_XC_Auto_CalibrationMode);
