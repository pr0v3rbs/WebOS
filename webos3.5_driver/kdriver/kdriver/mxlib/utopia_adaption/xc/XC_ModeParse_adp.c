...
//set table
    ...
    //Function parameter's pointer
    UADPBypassSetSPT(&spt_XC_MODEPARSE_MODETABLE_TYPE[0],UADP_SPT_SELF_SIZE,0, sizeof(MS_PCADC_MODETABLE_TYPE));
    ...
    UADPBypassSetSPT(&spt_XC_MODEPARSE_MODETABLE_TYPE_EX[0],UADP_SPT_SELF_SIZE,0, sizeof(MS_PCADC_MODETABLE_TYPE_EX));
    ...
    UADPBypassSetSPT(&spt_XC_MODEPARSE_MATCHMODE[1],UADP_SPT_POINTER_TO_NEXT,
        ((unsigned int)(&(pXC_MODEPARSE_MATCHMODE->ModeDB)) - (unsigned int)pXC_MODEPARSE_MATCHMODE), (unsigned int)spt_XC_MODEPARSE_MODETABLE_TYPE);
    UADPBypassSetSPT(&spt_XC_MODEPARSE_MATCHMODE[2],UADP_SPT_POINTER_TO_NEXT,
        ((unsigned int)(&(pXC_MODEPARSE_MATCHMODE->psInputInfo)) - (unsigned int)pXC_MODEPARSE_MATCHMODE), (unsigned int)spt_XC_MODEPARSE_INPUT_INFO);
    ...
    UADPBypassSetSPT(&spt_XC_MODEPARSE_MATCHMODEEX[1],UADP_SPT_POINTER_TO_NEXT,
        ((unsigned int)(&(pXC_MODEPARSE_MATCHMODEEX->ModeDB)) - (unsigned int)pXC_MODEPARSE_MATCHMODEEX), (unsigned int)spt_XC_MODEPARSE_MODETABLE_TYPE_EX);
    UADPBypassSetSPT(&spt_XC_MODEPARSE_MATCHMODEEX[2],UADP_SPT_POINTER_TO_NEXT,
        ((unsigned int)(&(pXC_MODEPARSE_MATCHMODEEX->psInputInfo)) - (unsigned int)pXC_MODEPARSE_MATCHMODEEX), (unsigned int)spt_XC_MODEPARSE_INPUT_INFO);
...
MS_U32 XC_MODEPARSE_adp_Ioctl(void* pInstanceTmp, MS_U32 u32Cmd, void* const pArgs)
{
    ...
    switch(u32Cmd)
    {
        ...
        {
            u32Ret = UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_XC_MODEPARSE_MATCHMODE, spt_XC_MODEPARSE_MATCHMODE,buffer_arg,sizeof(buffer_arg));
            break;
        }
