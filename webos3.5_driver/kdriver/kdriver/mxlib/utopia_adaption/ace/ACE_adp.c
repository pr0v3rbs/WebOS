...
//Function parameter
UADP_STRUCT_POINTER_TABLE spt_ACE_INIT[10];
...
UADP_STRUCT_POINTER_TABLE spt_XC_ACE_InitData[10];
UADP_STRUCT_POINTER_TABLE spt_ColorCorrectionTable[10];
UADP_STRUCT_POINTER_TABLE spt_MS_U8_NRTable[10];
UADP_STRUCT_POINTER_TABLE spt_MS_U16_NRTable[10];
...
UADP_STRUCT_POINTER_TABLE spt_ACE_SETBT2020_Colormetry[10];
...
UADP_STRUCT_POINTER_TABLE spt_ACE_COLORCORRECTIONTABLE[10];
...
//set table
    ...
    XC_ACE_InitData* pXC_ACE_InitData = (XC_ACE_InitData*)temp;
    ...
    UADP_SPT_BGN(&spt_MS_U8_NRTable[0],sizeof(MS_U8) * 8);
    UADP_SPT_FIN(&spt_MS_U8_NRTable[1]);

    UADP_SPT_BGN(&spt_MS_U16_NRTable[0],sizeof(MS_U16) * 8);
    UADP_SPT_FIN(&spt_MS_U16_NRTable[1]);

    UADPBypassSetSPT(&spt_XC_ACE_InitData[0],UADP_SPT_SELF_SIZE,0, sizeof(XC_ACE_InitData));
    UADPBypassSetSPT(&spt_XC_ACE_InitData[1],UADP_SPT_POINTER_TO_NEXT,
                     ((unsigned int)(&(pXC_ACE_InitData->S16ColorCorrectionMatrix)) - (unsigned int)pXC_ACE_InitData), (unsigned int)spt_ColorCorrectionTable);
    UADPBypassSetSPT(&spt_XC_ACE_InitData[2],UADP_SPT_POINTER_TO_NEXT,
                     ((unsigned int)(&(pXC_ACE_InitData->S16RGB)) - (unsigned int)pXC_ACE_InitData), (unsigned int)spt_ACE_YUVtoRGBMatrix);
    UADPBypassSetSPT(&spt_XC_ACE_InitData[3],UADP_SPT_END , 0, 0);

    UADPBypassSetSPT(&spt_ACE_INIT[0],UADP_SPT_SELF_SIZE,0, sizeof(stACE_Init));
    UADPBypassSetSPT(&spt_ACE_INIT[1],UADP_SPT_POINTER_TO_NEXT, ((unsigned int)(&(pACE_INIT->pstXC_ACE_InitData)) - (unsigned int)pACE_INIT), (unsigned int)&spt_XC_ACE_InitData);
    UADPBypassSetSPT(&spt_ACE_INIT[2],UADP_SPT_END , 0, 0);
    ...
    UADPBypassSetSPT(&spt_ACE_SELECTYUVTORGBMATRIX[0],UADP_SPT_SELF_SIZE,0, sizeof(stACE_SelectYUVtoRGBMatrix));
    UADPBypassSetSPT(&spt_ACE_SELECTYUVTORGBMATRIX[1],UADP_SPT_END , 0, 0);
    ...
    UADPBypassSetSPT(&spt_ACE_SETBT2020_Colormetry[0],UADP_SPT_SELF_SIZE,0, sizeof(stACE_SetBT2020_Colormetry));
    UADPBypassSetSPT(&spt_ACE_SETBT2020_Colormetry[1],UADP_SPT_END , 0, 0);
    ...
    UADPBypassSetSPT(&spt_ACE_GETACEINFOEX[1],UADP_SPT_POINTER_TO_NEXT, ((unsigned int)(&(pACE_GETACEINFOEX->pInfoEx)) - (unsigned int)pACE_GETACEINFOEX), (unsigned int)&spt_DrvACE_InfoEx);
    ...
    UADPBypassSetSPT(&spt_ACE_PICSETCOLORTEMP[1],UADP_SPT_POINTER_TO_NEXT, ((unsigned int)(&(pACE_PICSETCOLORTEMP->pstColorTemp)) - (unsigned int)pACE_PICSETCOLORTEMP), (unsigned int)&spt_DrvACE_Color_Temp);
    ...
    UADPBypassSetSPT(&spt_ACE_PICSETCOLORTEMPEX[1],UADP_SPT_POINTER_TO_NEXT, ((unsigned int)(&(pACE_PICSETCOLORTEMPEX->pstColorTemp)) - (unsigned int)pACE_PICSETCOLORTEMPEX), (unsigned int)&spt_DrvACE_Color_TempEx);
    ...
    UADPBypassSetSPT(&spt_ACE_PICSETPOSTCOLORTEMP_V02[1],UADP_SPT_POINTER_TO_NEXT, ((unsigned int)(&(pACE_PICSETPOSTCOLORTEMP_V02->pstColorTemp)) - (unsigned int)pACE_PICSETPOSTCOLORTEMP_V02), (unsigned int)&spt_DrvACE_Color_TempEx2);
    ...
    UADPBypassSetSPT(&spt_ACE_MWESETREGTABLE[1],UADP_SPT_POINTER_TO_NEXT, ((unsigned int)(&(pACE_MWESETREGTABLE->pMWETable)) - (unsigned int)pACE_MWESETREGTABLE), (unsigned int)&spt_DrvACE_TAB_Info);
    ...
    UADPBypassSetSPT(&spt_ACE_DNR_BLENDING_NRTBL[1],UADP_SPT_POINTER_TO_NEXT, ((unsigned int)(&(pACE_DNR_BLENDING_NRTBL->pu8NewNR)) - (unsigned int)pACE_DNR_BLENDING_NRTBL), (unsigned int)&spt_MS_U8_NRTable);
    UADPBypassSetSPT(&spt_ACE_DNR_BLENDING_NRTBL[2],UADP_SPT_POINTER_TO_NEXT, ((unsigned int)(&(pACE_DNR_BLENDING_NRTBL->pu16PreY0)) - (unsigned int)pACE_DNR_BLENDING_NRTBL), (unsigned int)&spt_MS_U16_NRTable);
    UADPBypassSetSPT(&spt_ACE_DNR_BLENDING_NRTBL[3],UADP_SPT_POINTER_TO_NEXT, ((unsigned int)(&(pACE_DNR_BLENDING_NRTBL->pu16PreY1)) - (unsigned int)pACE_DNR_BLENDING_NRTBL), (unsigned int)&spt_MS_U16_NRTable);
    UADPBypassSetSPT(&spt_ACE_DNR_BLENDING_NRTBL[4],UADP_SPT_POINTER_TO_NEXT, ((unsigned int)(&(pACE_DNR_BLENDING_NRTBL->pu8NRTBL)) - (unsigned int)pACE_DNR_BLENDING_NRTBL), (unsigned int)&spt_MS_U8_NRTable);
    UADPBypassSetSPT(&spt_ACE_DNR_BLENDING_NRTBL[5],UADP_SPT_END , 0, 0);
    ...
    UADPBypassSetSPT(&spt_ACE_GETINFO[1],UADP_SPT_POINTER_TO_NEXT, ((unsigned int)(&(pACE_GETINFO->pstApiInfo)) - (unsigned int)pACE_GETINFO), (unsigned int)&spt_DrvACE_ApiInfo);
    ...
    UADPBypassSetSPT(&spt_ACE_GETSTATUS[1],UADP_SPT_POINTER_TO_NEXT, ((unsigned int)(&(pACE_GETSTATUS->pDrvStatus)) - (unsigned int)pACE_GETSTATUS), (unsigned int)&spt_DrvACE_ApiStatus);
    ...
    UADPBypassSetSPT(&spt_ACE_COLORCORRECTIONTABLE[0],UADP_SPT_SELF_SIZE,0, sizeof(stACE_SetColorCorrectionTable));
    UADPBypassSetSPT(&spt_ACE_COLORCORRECTIONTABLE[1],UADP_SPT_END , 0, 0);
    ...
    UADPBypassSetSPT(&spt_ACE_PICSETPOSTCOLORTEMP[1],UADP_SPT_POINTER_TO_NEXT, ((unsigned int)(&(pACE_PICSETPOSTCOLORTEMP->pstColorTemp)) - (unsigned int)pACE_PICSETPOSTCOLORTEMP), (unsigned int)&spt_DrvACE_Color_Temp);
    ...
    UADPBypassSetSPT(&spt_ACE_PICSETPOSTCOLORTEMPEX[1],UADP_SPT_POINTER_TO_NEXT, ((unsigned int)(&(pACE_PICSETPOSTCOLORTEMPEX->pstColorTemp)) - (unsigned int)pACE_PICSETPOSTCOLORTEMPEX), (unsigned int)&spt_DrvACE_Color_TempEx);
    ...
    UADPBypassSetSPT(&spt_ACE_PICSETPOSTCOLORTEMP2[1],UADP_SPT_POINTER_TO_NEXT, ((unsigned int)(&(pACE_PICSETPOSTCOLORTEMP2->pstColorTemp)) - (unsigned int)pACE_PICSETPOSTCOLORTEMP2), (unsigned int)&spt_DrvACE_Color_Temp);
    ...
    UADPBypassSetSPT(&spt_ACE_PICSETPOSTCOLORTEMP2EX[1],UADP_SPT_POINTER_TO_NEXT, ((unsigned int)(&(pACE_PICSETPOSTCOLORTEMP2EX->pstColorTemp)) - (unsigned int)pACE_PICSETPOSTCOLORTEMP2EX), (unsigned int)&spt_DrvACE_Color_TempEx);
...
MS_U32 ACE_adp_Ioctl(void* pInstanceTmp, MS_U32 u32Cmd, void* const pArgs)
{
    ...
    switch(u32Cmd)
    {
        ...
        case E_ACE_CMD_SETIHC:
            ...
            break;
        case E_ACE_CMD_SETBT2020_Colormetry:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_SETBT2020_Colormetry, spt_ACE_SETBT2020_Colormetry, buffer_arg,sizeof(buffer_arg));
            break;
