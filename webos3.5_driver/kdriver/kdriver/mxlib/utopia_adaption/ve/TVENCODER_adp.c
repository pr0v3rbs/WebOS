...
//
    ...
    //    ((unsigned int)(&(pVE_DrvInfo->stCaps))-(unsigned int)pVE_DrvInfo), &spt_VE_VE_Caps);
...
//---
    ...
    UADPBypassSetSPT(&spt_TVE_GetInfo[1],UADP_SPT_POINTER_TO_NEXT,
                      ((unsigned int)(&(pGetInfo->pVE_DrvInfo))-(unsigned int)pGetInfo), (unsigned int)&spt_VE_DrvInfo);
    ...
    UADPBypassSetSPT(&spt_TVE_GetStatus[1],UADP_SPT_POINTER_TO_NEXT,
        ((unsigned int)(&(pGetStatus->pStaus))-(unsigned int)pGetStatus), (unsigned int)&spt_VE_DrvStatus);
    ...
    UADPBypassSetSPT(&spt_TVE_SwitchInputSRC[1],UADP_SPT_POINTER_TO_NEXT,
        ((unsigned int)(&(pVE_SwitchSrc_info->pSwithcSrc_info))-(unsigned int)pVE_SwitchSrc_info), (unsigned int)&spt_VE_SwithcSrc_info);
    ...
    UADPBypassSetSPT(&spt_TVE_SetInputSRC[1],UADP_SPT_POINTER_TO_NEXT,
        ((unsigned int)(&(pVE_SetInputSrc->pInputSrcInfo))-(unsigned int)pVE_SetInputSrc), (unsigned int)&spt_VE_InputSrcInfo);
    ...
    UADPBypassSetSPT(&spt_TVE_SwitchOutputDest[1],UADP_SPT_POINTER_TO_NEXT,
        ((unsigned int)(&(pSwitchOutputDest->pSwitchInfo))-(unsigned int)pSwitchOutputDest), (unsigned int)&spt_VE_Switch_Dest_Info);
    ...
    UADPBypassSetSPT(&spt_TVE_SetOutputCtrl[1],UADP_SPT_POINTER_TO_NEXT,
        ((unsigned int)(&(pSetOutputCtrl->pOutputCtrl)) - (unsigned int)pSetOutputCtrl), (unsigned int)&spt_VE_Output_Ctrl);
	...
	UADPBypassSetSPT(&spt_TVE_Init[0],UADP_SPT_SELF_SIZE,0, sizeof(TVE_INIT));
    UADPBypassSetSPT(&spt_TVE_Init[1],UADP_SPT_END , 0, 0);
    ...
    UADPBypassSetSPT(&spt_TVE_SetMode[1],UADP_SPT_POINTER_TO_NEXT,
        ((unsigned int)(&(pSetMode->pVESetMode)) - (unsigned int)pSetMode), (unsigned int)&spt_VE_DrvSetMode);
    ...
    //    ((unsigned int)(&(pSetDisplayWin->stDispWin)) - (unsigned int)pSetDisplayWin), (unsigned int)&spt_VE_SetDisplayWin);
    ...
    UADPBypassSetSPT(&spt_TVE_GetDstInfo[1],UADP_SPT_POINTER_TO_NEXT,
        ((unsigned int)(&(pGetDstInfo->pDstInfo)) - (unsigned int)pGetDstInfo), (unsigned int)&spt_VE_DST_DispInfo);
    ...
    UADPBypassSetSPT(&spt_TVE_Set_Customer_Scaling[1],UADP_SPT_POINTER_TO_NEXT,
        ((unsigned int)(&(pSetCusScaling->pstVECusScalingInfo)) - (unsigned int)pSetCusScaling), (unsigned int)&spt_VE_CusScalingInfo);
    ...
    UADPBypassSetSPT(&spt_TVE_InitVECapture[1],UADP_SPT_POINTER_TO_NEXT,
        ((unsigned int)(&(pInitCapture->pVECapture)) - (unsigned int)pInitCapture), (unsigned int)&spt_VE_Output_CAPTURE);
    ...
    UADPBypassSetSPT(&spt_TVE_EnaVECapture[1],UADP_SPT_POINTER_TO_NEXT,
        ((unsigned int)(&(pEnableCapture->pstVECapState)) - (unsigned int)pEnableCapture), (unsigned int)&spt_VE_VECAPTURESTATE);
    ...
    UADPBypassSetSPT(&spt_TVE_Adjust_FrameStart[1],UADP_SPT_POINTER_TO_NEXT,
        ((unsigned int)(&(pAdjustFrameStart->stSrcWin)) - (unsigned int)pAdjustFrameStart), (unsigned int)&spt_VE_WINDOW_TYPE);
