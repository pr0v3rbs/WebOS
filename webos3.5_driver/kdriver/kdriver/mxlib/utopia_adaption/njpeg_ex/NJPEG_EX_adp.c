...
UADP_SPT_NAMEnNXT_DEF(NJPEG_InitParam,0);
UADP_SPT_NAMEnNXT_DEF(NJPEG_INIT_PARAM,1);


UADP_SPT_NAMEnNXT_DEF(NJPEG_GETAPP0INFO_PARAM,3);
...
UADP_SPT_NAMEnNXT_DEF(NJPEG_MSIF_Version,0);
UADP_SPT_NAMEnNXT_DEF(NJPEG_Info,3);
UADP_SPT_NAMEnNXT_DEF(NJPEG_GETINFO_PARAM,1);
...
UADP_SPT_NAMEnNXT_DEF(NJPEG_PMSIF_Version,1);
UADP_SPT_NAMEnNXT_DEF(NJPEG_GETLIBVER_PARAM,1);
...
UADP_SPT_NAMEnNXT_DEF(NJPEG_EXIF_Orientation,0);
UADP_SPT_NAMEnNXT_DEF(NJPEG_GETEXIFORIENTATION_PARAM,1);

UADP_SPT_NAMEnNXT_DEF(NJPEG_GETEXIFSTRING_PARAM,1);

UADP_SPT_NAMEnNXT_DEF(NJPEG_GETEXIFU16_PARAM,1);

UADP_SPT_NAMEnNXT_DEF(NJPEG_GETEXIFU32_PARAM,1);

UADP_SPT_NAMEnNXT_DEF(NJPEG_RATIONAL,0);
UADP_SPT_NAMEnNXT_DEF(NJPEG_GETEXIFRATIONAL_PARAM,1);

UADP_SPT_NAMEnNXT_DEF(NJPEG_GETFREEMEMORY_PARAM,0);
...
UADP_SPT_NAMEnNXT_DEF(NJPEG_MPO_INDEX_INFO,0);
UADP_SPT_NAMEnNXT_DEF(NJPEG_PJPEG_MPO_INDEX_INFO,1);
UADP_SPT_NAMEnNXT_DEF(NJPEG_GETMPOINDEX_PARAM,1);
...
UADP_SPT_NAMEnNXT_DEF(NJPEG_MPO_INDEX_INFO,0);
UADP_SPT_NAMEnNXT_DEF(NJPEG_PJPEG_MPO_ATTRIBUTE_INFO,1);
UADP_SPT_NAMEnNXT_DEF(NJPEG_GETMPOATTR_PARAM,1);
...
UADP_SPT_NAMEnNXT_DEF(NJPEG_CB_CTRL_PARAM,0);

UADP_SPT_NAMEnNXT_DEF(NJPEG_ENABLE_ISR,0);
...
MS_U32 NJPEG_EX_adp_Init(FUtopiaIOctl* pIoctl)
{
    ...
    UADP_SPT_NAME0NXT(NJPEG_InitParam,JPEG_InitParam);
    UADP_SPT_NAME1NXT(NJPEG_INIT_PARAM,JPEG_INIT_PARAM,pInitParam,NJPEG_InitParam);

    UADP_SPT_NAME3NXT(NJPEG_GETAPP0INFO_PARAM,JPEG_GETAPP0INFO_PARAM,unit,NJPEG_U8,x,NJPEG_U16,y,NJPEG_U16);
    ...
    UADP_SPT_NAME0NXT(NJPEG_MSIF_Version,MSIF_Version);
    UADP_SPT_NAME3NXT(NJPEG_Info,JPEG_Info,pu8DrvVer,NJPEG_MSIF_Version,pu8HalVer,NJPEG_U8,pu8FwVer,NJPEG_U8);
    UADP_SPT_NAME1NXT(NJPEG_GETINFO_PARAM,JPEG_GETINFO_PARAM,pJPEG_Info,NJPEG_Info);
    
    UADP_SPT_NAME0NXT(NJPEG_Status,JPEG_Status);
    UADP_SPT_NAME1NXT(NJPEG_GETSTATUS_PARAM,JPEG_GETSTATUS_PARAM,pJPEG_Status,NJPEG_Status);

    UADP_SPT_NAME1NXT(NJPEG_PMSIF_Version,PMSIF_Version,pMSIF_Version,NJPEG_MSIF_Version);
    UADP_SPT_NAME1NXT(NJPEG_GETLIBVER_PARAM,JPEG_GETLIBVER_PARAM,ppVersion,NJPEG_PMSIF_Version);

    UADP_SPT_NAME0NXT(NJPEG_BuffLoadType,JPEG_BuffLoadType);
    UADP_SPT_NAME1NXT(NJPEG_GETBUFFLOADTYPE_PARAM,JPEG_GETBUFFLOADTYPE_PARAM,pBuffLoadType,NJPEG_BuffLoadType);

    UADP_SPT_NAME0NXT(NJPEG_WAITDONE_PARAM,JPEG_WAITDONE_PARAM);
    
    UADP_SPT_NAME0NXT(NJPEG_EXIF_DateTime,JPEG_EXIF_DateTime);
    UADP_SPT_NAME1NXT(NJPEG_GETEXIFDATETIME_PARAM,JPEG_GETEXIFDATETIME_PARAM,DateTime,NJPEG_EXIF_DateTime);
    
    UADP_SPT_NAME0NXT(NJPEG_EXIF_Orientation,JPEG_EXIF_Orientation);
    UADP_SPT_NAME1NXT(NJPEG_GETEXIFORIENTATION_PARAM,JPEG_GETEXIFORIENTATION_PARAM,eOrientation,NJPEG_EXIF_Orientation);

    UADP_SPT_NAME1NXT(NJPEG_GETEXIFSTRING_PARAM,JPEG_GETEXIFSTRING_PARAM,pu8String,NJPEG_U8);

    UADP_SPT_NAME1NXT(NJPEG_GETEXIFU16_PARAM,JPEG_GETEXIFU16_PARAM,pu16Value,NJPEG_U16);

    UADP_SPT_NAME1NXT(NJPEG_GETEXIFU32_PARAM,JPEG_GETEXIFU32_PARAM,pu32Value,NJPEG_U32);
    
    UADP_SPT_NAME0NXT(NJPEG_RATIONAL,JPEG_RATIONAL);
    UADP_SPT_NAME1NXT(NJPEG_GETEXIFRATIONAL_PARAM,JPEG_GETEXIFRATIONAL_PARAM,pRational,NJPEG_RATIONAL);
    
    UADP_SPT_NAME0NXT(NJPEG_GETFREEMEMORY_PARAM,JPEG_GETFREEMEMORY_PARAM);

    UADP_SPT_NAME0NXT(NJPEG_SUPPORTCMYK_PARAM,JPEG_SUPPORTCMYK_PARAM);
    
    UADP_SPT_NAME0NXT(NJPEG_MPO_INDEX_INFO,JPEG_MPO_INDEX_INFO);
    UADP_SPT_NAME1NXT(NJPEG_PJPEG_MPO_INDEX_INFO,PJPEG_MPO_INDEX_INFO,pMPOIndex,NJPEG_MPO_INDEX_INFO);
    UADP_SPT_NAME1NXT(NJPEG_GETMPOINDEX_PARAM,JPEG_GETMPOINDEX_PARAM,ppMPOIndex,NJPEG_PJPEG_MPO_INDEX_INFO);

    UADP_SPT_NAME0NXT(NJPEG_MPO_INDEX_INFO,JPEG_MPO_INDEX_INFO);
    UADP_SPT_NAME1NXT(NJPEG_PJPEG_MPO_ATTRIBUTE_INFO,PJPEG_MPO_ATTRIBUTE_INFO,pMPOIndex,NJPEG_MPO_INDEX_INFO);
    UADP_SPT_NAME1NXT(NJPEG_GETMPOATTR_PARAM,JPEG_GETMPOATTR_PARAM,ppMPOAttr,NJPEG_PJPEG_MPO_ATTRIBUTE_INFO);
    ...
    UADP_SPT_NAME1NXT(NJPEG_GET_CTRL_PARAM,JPEG_GET_CTRL_PARAM,param,NJPEG_U32);
    
    UADP_SPT_NAME0NXT(NJPEG_EXIF_MANUFACTURER,JPEG_INFO_12BYTE);
    UADP_SPT_NAME1NXT(NJPEG_GET_EXIF_MANUFACTURER,JPEG_GET_CTRL_PARAM,param,NJPEG_EXIF_MANUFACTURER);

    UADP_SPT_NAME0NXT(NJPEG_EXIF_SHUTTER_SPEED_VALUE,JPEG_INFO_12BYTE);
    UADP_SPT_NAME1NXT(NJPEG_GET_EXIF_SHUTTER_SPEED_VALUE,JPEG_GET_CTRL_PARAM,param,NJPEG_EXIF_SHUTTER_SPEED_VALUE);

    UADP_SPT_NAME0NXT(NJPEG_CB_CTRL_PARAM,JPEG_CB_EVENT_PARAM);

    UADP_SPT_NAME0NXT(NJPEG_ENABLE_ISR,JPEG_ENABLEISR_PARAM);
