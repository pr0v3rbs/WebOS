...
INTERFACE MS_U16 MDrv_HDMI_GetHtt(void);
INTERFACE MS_U16 MDrv_HDMI_GetVde(void);
INTERFACE MS_U16 MDrv_HDMI_GetVtt(void);
...
INTERFACE void MDrv_HDMI_SetHPD_HL(MS_BOOL bTrue);
...
INTERFACE MS_BOOL MDrv_HDMI_GetDEStableStatus(E_MUX_INPUTPORT enInputPortType);
INTERFACE void MDrv_HDMI_DDCChannelEnable(E_MUX_INPUTPORT enInputPortType, MS_BOOL bEnable);
INTERFACE void MDrv_HDMI_StablePolling(void);
