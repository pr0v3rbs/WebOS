...
typedef enum
{
    ...
    E_PNL_CMD_CONTROL_OUT_PE_CURRENT,
    E_PNL_CMD_CONTROL_OUT_PE_CURRENT_PARTIAL,
    ...
    E_PNL_CMD_SETOSDCOUTPUTTYPE,
    E_PNL_CMD_VIDEO_PROTECT,
    E_PNL_CMD_SETPACKER_CHECK,
    ...
    E_PNL_CMD_PNL_OSDC_INIT_STATUS,
    E_PNL_CMD_VIDEOOSD_CONFIG,
    E_PNL_CMD_DIVISIONMODE_CONFIG,
    E_PNL_CMD_SET_GSTREAMER_PROCESS,
    E_PNL_CMD_GET_GSTREAMER_PROCESS,
    E_PNL_CMD_SET_CAPTURE_PROCESS,
    E_PNL_CMD_GET_CAPTURE_PROCESS,
    E_PNL_CMD_SET_MOD_PATTERN,
    E_PNL_CMD_CONTROL_PREEMPHASIS_LEVEL,
    E_PNL_CMD_CONTROL_VREG_LEVEL,
    E_PNL_CMD_SET_STRENABLE,
    E_PNL_CMD_SET_PANELINCH,
    E_PNL_CMD_SET_FLAGCUS,
    E_PNL_CMD_NUM,
...
typedef struct _stPNL_Control_Preemphasis_Level
{
    MS_U16 u16Preemphasis_Level;
    MS_BOOL bEnable;
    MS_BOOL bReturn;

} stPNL_Control_Preemphasis_Level, *pstPNL_Control_Preemphasis_Level;
typedef struct _stPNL_Control_Vreg_Level
{
    MS_U16 u16Vreg_Level;
    MS_BOOL bEnable;
    MS_BOOL bReturn;

}stPNL_Control_Vreg_Level, *pstPNL_Control_Vreg_Level;
...
typedef struct _stPNL_Control_Out_PE_Current
{
    MS_U16 u16Current_Level;
    MS_BOOL bReturn;
} stPNL_Control_Out_PE_Current, *pstPNL_Control_Out_PE_Current;

typedef struct _stPNL_Control_Out_PE_Current_Partial
{
    MS_U8 *u8Current_Level_array;
    MS_BOOL bReturn;
} stPNL_Control_Out_PE_Current_Partial, *pstPNL_Control_Out_PE_Current_Partial;
...
typedef struct _stPNL_SetVB1VideoProtect
{
    MS_BOOL enable;
} stPNL_SetVB1VideoProtect, *pstPNL_SetVB1VideoProtect;



typedef struct _stPNL_SetOSDCOutputType
{
	MS_U16 eLPLL_Type;
	MS_U8 eOC_OutputFormat;
} stPNL_SetOSDCOutputType, *pstPNL_SetOSDCOutputType;
...
typedef struct _stPNL_VideoOSDConfig
{
    E_PNL_VIDEO_OSD_CONFIG econfig;
    APIPNL_Result eReturn;
} stPNL_VideoOSDConfig, *pstPNL_VideoOSDConfig;

typedef struct _stPNL_DivisionModeConfig
{
    E_PNL_DIVISIONMODE_CONFIG econfig;
    APIPNL_Result eReturn;
} stPNL_DivisionModeConfig, *pstPNL_DivisionModeConfig;

typedef struct _stPNL_Set_GstreamerProcess
{
    MS_BOOL bReturn;
} stPNL_Set_GstreamerProcess, *pstPNL_Set_GstreamerProcess;

typedef struct _stPNL_Get_GstreamerProcess
{
    MS_BOOL bReturn;
} stPNL_Get_GstreamerProcess, *pstPNL_Get_GstreamerProcess;

typedef struct _stPNL_Set_CaptureProcess
{
    MS_BOOL bReturn;
} stPNL_Set_CaptureProcess, *pstPNL_Set_CaptureProcess;

typedef struct _stPNL_Get_CaptureProcess
{
    MS_BOOL bReturn;
} stPNL_Get_CaptureProcess, *pstPNL_Get_CaptureProcess;

typedef struct _stPNL_SetModPattern
{
    MS_BOOL  bEnable;
} stPNL_SetModPattern, *pstPNL_SetModPattern;

typedef struct _stPNL_Set_STREnable
{
    MS_BOOL bEnable;
} stPNL_Set_STREnable, *pstPNL_Set_STREnable;

typedef struct _stPNL_Set_PanelInch
{
    MS_U16 u16SwingLevel;
    MS_U16 u16PECurrent;
} stPNL_Set_PanelInch, *pstPNL_Set_PanelInch;

typedef struct _stPNL_Set_FlagCus
{
    MS_BOOL bPNL_InitByCus;
} stPNL_Set_FlagCus, *pstPNL_Set_FlagCus;
