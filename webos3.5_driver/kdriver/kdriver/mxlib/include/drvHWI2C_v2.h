...
typedef enum {
    ...
    MDrv_CMD_HWI2C_WriteBytes_CUST,
    MDrv_CMD_HWI2C_ReadByte,
    MDrv_CMD_HWI2C_ReadBytes,
    MDrv_CMD_HWI2C_ReadBytes_CUST,
...
typedef struct _HWI2C_PRIVATE_PARAM_Init
{
   HWI2C_UnitCfg *psCfg;
} HWI2C_PRIVATE_PARAM_Init, *PHWI2C_PRIVATE_PARAM_Init;

typedef struct _HWI2C_PRIVATE_PARAM_GetPortIndex
{
   HWI2C_PORT ePort;
   MS_U8* pu8Port;
...
typedef struct _HWI2C_PRIVATE_PARAM_WriteBytes
{
   MS_U16 u16SlaveCfg;
   MS_U32 uAddrCnt;
   MS_U8 *pRegAddr;
...
typedef struct _HWI2C_PRIVATE_PARAM_WriteBytes_CUST
{
   MS_U16 u16SlaveCfg;
   MS_U32 uAddrCnt;
   MS_U8 *pRegAddr;
   ...
   HWI2C_CLKSEL eClk;
   MS_BOOL *bReturn;
} HWI2C_PRIVATE_PARAM_WriteBytes_CUST;

typedef struct _HWI2C_PRIVATE_PARAM_ReadByte
{
   MS_U16 u16SlaveCfg;
   MS_U8 u8RegAddr;
   MS_U8 *pData;
...
typedef struct _HWI2C_PRIVATE_PARAM_ReadBytes
{
   MS_U16 u16SlaveCfg;
   MS_U32 uAddrCnt;
   MS_U8 *pRegAddr;
...
typedef struct _HWI2C_PRIVATE_PARAM_ReadBytes_CUST
{
   MS_U16 u16SlaveCfg;
   MS_U32 uAddrCnt;
   MS_U8 *pRegAddr;
   ...
   HWI2C_CLKSEL eClk;
   MS_BOOL *bReturn;
} HWI2C_PRIVATE_PARAM_ReadBytes_CUST;
...
typedef struct _HWI2C_PRIVATE_PARAM_WriteBytesP1
{
   MS_U16 u16SlaveCfg;
   MS_U32 uAddrCnt;
   MS_U8 *pRegAddr;
...
typedef struct _HWI2C_PRIVATE_PARAM_ReadByteP1
{
   MS_U16 u16SlaveCfg;
   MS_U8 u8RegAddr;
   MS_U8 *pData;
...
typedef struct _HWI2C_PRIVATE_PARAM_ReadBytesP1
{
   MS_U16 u16SlaveCfg;
   MS_U32 uAddrCnt;
   MS_U8 *pRegAddr;
...
typedef struct _HWI2C_PRIVATE_PARAM_GetStatus
{
...
typedef union _HWI2C_PRIVATE_PARAM
{
    ...
    HWI2C_PRIVATE_PARAM_WriteBytes_CUST privateWriteBytes_CUST;
	HWI2C_PRIVATE_PARAM_ReadByte privateReadByte;
	HWI2C_PRIVATE_PARAM_ReadBytes privateReadBytes;
    HWI2C_PRIVATE_PARAM_ReadBytes_CUST privateReadBytes_CUST;
...
typedef struct _HWI2C_STR
{
	MS_U32 u32PowerState;
	HWI2C_UnitCfg   UnitCfg;
