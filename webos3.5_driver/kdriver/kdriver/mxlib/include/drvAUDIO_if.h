...
//  PCM Mixer Define
//================================================================
#define AUDIO_PCMMIXER_VERSION    2
#define AUDIO_PCMMIXER_MAXGROUP    1
#define AUDIO_PCMMIXER_GROUP_NONE    0x00000000
#define AUDIO_PCMMIXER_GROUP_1    0x00000001
#define AUDIO_PCMMIXER_GROUP_2    0x00000002
#define AUDIO_PCMMIXER_GROUP_3    0x00000004
#define AUDIO_PCMMIXER_GROUP_4    0x00000008
#define AUDIO_PCMMIXER_GROUP_5    0x00000010
#define AUDIO_PCMMIXER_GROUP_6    0x00000020
#define AUDIO_PCMMIXER_GROUP_7    0x00000040
#define AUDIO_PCMMIXER_GROUP_8    0x00000080
#define AUDIO_PCMMIXER_GROUP_ALL    0xFFFFFFFF
...
typedef struct
{
    AUDIO_EASE_TYPE eFadeType;     /* PCM Fade type */
    MS_U32 u32FadeDuration; /* PCM Fade Duration in ms */
    MS_U32 u32FadeTargetGain; /* PCM Fade Target gain,  the range is 0~100, and 100 means no any attenuation*/
}AUDIO_EASE_PARAM_t;
...
typedef struct
{
    ...
    MS_U8 u8Name[AUDIO_COMMON_PCM_IO_NAME_LENGTH]; /* The PCM name requested (only 32 bytes, if change this length, must change u8Name of AUDIO_PCM_INFO_t as well!) */
    ...
    MS_U8 u16Synth_H; /* High byte of synthesizer setting  */
    MS_U8 u16Synth_L; /* Low byte of synthesizer setting  */
    MS_BOOL bFastPlay;/* TRUE if in fast play mode  */
    AUDIO_EASE_PARAM_t tEaseParam;
...
//================================================================
// [LM14]
typedef struct LGE_AENC_MSG_TYPE
{
    MS_U32      channel;    // Encoder index
    MS_U64      pts;    // PTS
    MS_U32      *pData;     // pointer to Audio Data
    MS_U32      dataLen;	    // Audio Data Length
    MS_U32      *pRStart;   // start pointer of buffer
    MS_U32      *pREnd;     // end pointer of buffer
}LGE_AENC_MSG_TYPE_T;
...
typedef enum
{
    ...
    AUDIO_ENC_FORMAT,
    AUDIO_ENC_DATA_LEN,
    AUDIO_ENC_BUFFER_START_ADDR,
    AUDIO_ENC_BUFFER_END_ADDR,
} AUDIO_ENC_INFO_TYPE;
...
typedef enum
{
    E_AUDIO_KERNEL_DEBUG_MSG_OFF    = 0,
    E_AUDIO_KERNEL_DEBUG_MSG_LEVEL1_NORMAL = 1,
    E_AUDIO_KERNEL_DEBUG_MSG_LEVEL2_THREAD = 2,
}AUDIO_KERNEL_DEBUG_MSG;
...
typedef enum
{
    ...
    AUDIO_PATH_HW_DMA_1                 = 0x52,
    AUDIO_PATH_HW_DMA_2                 = 0x53,
    AUDIO_PATH_R2_DMA_1                 = 0x54,
    AUDIO_PATH_R2_DMA_2                 = 0x55,
...
typedef enum
{
    AUDIO_OMX_ARENDER_PATH_ID_NULL = -1,
    AUDIO_OMX_ARENDER_PATH_ID_CH5  = 0,
    AUDIO_OMX_ARENDER_PATH_ID_CH6  = 1,
}AUDIO_OMX_ARENDER_PATH_ID;
...
typedef enum
{
    ...
    A2_PILOT_ON_AMP,
    A2_PILOT_OFF_AMP,
    A2_PILOT_ON_PHASE,	//LG
    A2_PILOT_OFF_PHASE,	//LG
...
typedef enum
{
    ...
    MSAPI_AUD_DVB_DTSXLL,               // 0x16
    MSAPI_AUD_DVB_DTSHDADO,             // 0x17:
    MSAPI_AUD_DVB_MAX,
    ...
    MSAPI_AUD_DVB2_DolbyTrueHDBypass,    ///< 0x15: Dolby TruHD bypass
    MSAPI_AUD_DVB2_DTSHDADO,             //0x16:
    MSAPI_AUD_DVB2_MAX,
...
// need to be same as adec_type in halAUR2.h
typedef enum
{
    R2_AdecType_dummy,
    R2_AdecType_ac3,
    ...
    R2_AdecType_ra8,
    R2_AdecType_gaac,
    R2_AdecType_dolby_truhd_bypass,
    R2_AdecType_dolby_dtshd_ado,
    R2_AdecType_dra,

    R2_AdecType_reserved = 0x1F,
} R2_AdecType;
...
typedef enum
{
    ...
    Audio_DEC_DTSXLL                    = 0x00400000,
    Audio_DEC_Dolby_TrueHD_Bypass_R2    = 0x00800000,
    Audio_DEC_DTS_HD_ADO_R2             = 0x01000000,
...
typedef enum
{
  /*********  New Interface ********/
    ...
    Audio_Comm_infoType_SetSoundBarPowerOnOff,
    Audio_Comm_infoType_SetSoundBarMuteOnOff,
    Audio_Comm_infoType_SetSoundBarIDData,
    Audio_Comm_infoType_SetSoundBarAutoVolume,
    Audio_Comm_infoType_SetSoundBarWooferLevel,
    Audio_Comm_infoType_GetSoundBarPowerOnOff,
    Audio_Comm_infoType_GetSoundBarMuteOnOff,
    Audio_Comm_infoType_GetSoundBarIDData,
    Audio_Comm_infoType_GetSoundBarVolume,
    Audio_Comm_infoType_GetSoundBarAutoVolume,
    Audio_Comm_infoType_GetSoundBarWooferLevel,
    Audio_Comm_infoType_GetSoundBarCheckSum,
    Audio_Comm_infoType_DMAReader_RemainingBufferLevel,
    Audio_Comm_infoType_SwDMAReader_RemainingBufferLevel,
    Audio_Comm_infoType_SwDMAReader_Stop,
    Audio_Comm_infoType_MP3_ENCODE_MUX,
    Audio_Comm_infoType_Is_Decoder_In_R2,  /*For IC with R2 Decoder*/
    Audio_Comm_infoType_DMAReader_Pause,
    Audio_Comm_infoType_ADEC1_DPFG_Flag,
    Audio_Comm_infoType_ADEC2_DPFG_Flag,
    Audio_Comm_infoType_SPDIF_SetChannelStatus,
    Audio_Comm_infoType_HDMI_DolbyMonitor,
    ...
    Audio_Comm_infoType_SWDMAReader_Pause,
    Audio_Comm_infoType_PreNotMM_Flag,//morris temp
    Audio_Comm_infoType_Set_DFS_PowerSave,   /*DFS setting for saving power*/
    Audio_comm_infoType_Get_audio_crash_status,
    Audio_Comm_infoType_Vorbis_header_size,
    Audio_Comm_infoType_Multi_Channel = 0x200,
    ...
    Audio_comm_infoType_NonPCM_Mixed_System_Sound,
    /*******************************************************/
...
typedef enum
{
    ...
    AUDIO_PCM_CMD_EASING, /* SET/GET */
    AUDIO_PCM_CMD_BUFFERSIZE, /* GET only */
    AUDIO_PCM_CMD_FASTPLAY, /* GET only */
} AUDIO_PCM_COMMAND;
...
typedef enum
{
    ...
    Sound_SET_Type_AbsoluteTreble,      //adding
    Sound_SET_Type_SetEq,
    Sound_SET_Type_SetEq_7band,
    Sound_SET_Type_SetAvc,
    Sound_SET_Type_SetAvcThreshold,     //Merge from SND
    Sound_SET_Type_SetAvcMode,          //Merge from SND
    Sound_SET_Type_SetAvcAT,            //Merge from SND
    Sound_SET_Type_SetAvcRT,            //Merge from SND
    Sound_SET_Type_SetAudioDelay,
    Sound_SET_Type_SetSurround,
    Sound_SET_Type_SetSurroundXA,       //Merge from SND
    Sound_SET_Type_SetSurroundXB,       //Merge from SND
    Sound_SET_Type_SetSurroundXK,       //Merge from SND
    Sound_SET_Type_SetSurroundLPFGain,  //Merge from SND
...
typedef enum
{
    ...
    //LGSE [LM15]
    LGSEFN_MODE_REGISTER,
    LGSEFNMAIN_INIT,
    LGSEFNMAIN_VARIABLES,
    LGSEFN000_INIT,
    LGSEFN000_VARIABLES,
    LGSEFN001_INIT,
    LGSEFN001_VARIABLES,
    LGSEFN004_MODE1_VARIABLES,
    LGSEFN004_MODE2_VARIABLES,
    LGSEFN008_INIT,
    LGSEFN008_VARIABLES,
    LGSEFN009_INIT,
    LGSEFN009_VARIABLES,
...
typedef struct
{
    Audio_DTS_infoType      infoType;
    Audio_DTS_CtrlType      ctrl_type;
}Audio_DTS_Param;
...
typedef enum
{
    ...
    Audio_ParamType_STR_Resume,               // for KTV
    ...
    Audio_ParamType_Hdmi_RDptr,
    Audio_ParamType_Multi_Pcm_RDptr,
    Audio_ParamType_omx_pcm3_pcmLevel,
    Audio_ParamType_setMPEGDecParam,
    Audio_ParamType_setAC3DecParam,
    Audio_ParamType_setAC3PDecParam,
    Audio_ParamType_setAACDecParam,
    Audio_ParamType_setDTSDecParam,
    Audio_ParamType_MM2_initAesInfo,
    Audio_ParamType_MM2_checkAesInfo,
    Audio_ParamType_trueHD_bypass_enable,

//-----------------------------------------------------------------
//  LM15U Added Start (Need same as R2_SHM_PARAM_TYPE in halAUR2.h)
//-----------------------------------------------------------------
    Audio_R2_SHM_PARAM_ES_WR_PTR,
    Audio_R2_SHM_PARAM_MPG_AVOFFSET,
    Audio_R2_SHM_PARAM_AC3_AVOFFSET,
    Audio_R2_SHM_PARAM_AAC_AVOFFSET,

    Audio_R2_SHM_PARAM_DOLBY_DRC_MODE,
    Audio_R2_SHM_PARAM_DOLBY_RF_MODE,
    Audio_R2_SHM_PARAM_DOLBY_DMX_MODE,
    Audio_R2_SHM_PARAM_DOLBY_HIGH_CUT,
    Audio_R2_SHM_PARAM_DOLBY_LOW_BOOST,
    Audio_R2_SHM_PARAM_DOLBY_GAIN,
    Audio_R2_SHM_PARAM_DOLBY_MULTI_FRAME_HEADER,
    Audio_R2_SHM_PARAM_DOLBY_AAC_BYPASS,
    Audio_R2_SHM_PARAM_DOLBY_TB11_ENABLE,

    Audio_R2_SHM_PARAM_PARSER_SPEC,
    Audio_R2_SHM_PARAM_PARSER_PES_BYPASS,
    Audio_R2_SHM_PARAM_PARSER_PUSI_DISABLE,
    Audio_R2_SHM_PARAM_REPORT_MM_TS_PTS_WITH_MSB,
    Audio_R2_SHM_PARAM_MM_TS_SYNC_STC,
    Audio_R2_SHM_PARAM_MM_FF2X,
    Audio_R2_SHM_PARAM_MM_TRICK,
    Audio_R2_SHM_PARAM_DECODE_MUTE,
    Audio_R2_SHM_PARAM_SOUND_MODE,
    Audio_R2_SHM_PARAM_EXT_SMPRATE_CTRL,

    Audio_R2_SHM_PARAM_MM_FILE_REQ_SIZE,
    Audio_R2_SHM_PARAM_MM_INPUT_PTS,

    Audio_R2_SHM_PARAM_UNI_PCM_SET_OUTPUT_CNT,
    Audio_R2_SHM_PARAM_UNI_SETUP_DECODE_FRMCNT,
    Audio_R2_SHM_PARAM_ES2_WR_PTR,

    Audio_R2_SHM_PARAM_OMX_SPDIF_CTRL,
    Audio_R2_SHM_PARAM_OMX_SPDIF_PCM_LEVEL,

    Audio_R2_SHM_PARAM_MAIN_VOLUME,
    Audio_R2_SHM_PARAM_MAIN_VOLUME_MUTE,
    Audio_R2_SHM_PARAM_AD_VOLUME,
    Audio_R2_SHM_PARAM_AD_VOLUME_MUTE,

    Audio_R2_SHM_PARAM_MPEG_SOUNDMODE,
    Audio_R2_SHM_PARAM_MPEG_GAIN,

    Audio_R2_SHM_PARAM_COOK_NUMCODECS,
    Audio_R2_SHM_PARAM_COOK_SAMPLES,
    Audio_R2_SHM_PARAM_COOK_SAMPLERATES,
    Audio_R2_SHM_PARAM_COOK_CHANNELS,
    Audio_R2_SHM_PARAM_COOK_REGIONS,
    Audio_R2_SHM_PARAM_COOK_CPLSTART,
    Audio_R2_SHM_PARAM_COOK_CPLQBITS,
    Audio_R2_SHM_PARAM_COOK_FRAMESIZE,

    Audio_R2_SHM_PARAM_DTS_DMX_LFE_ENABLE,
    Audio_R2_SHM_PARAM_DTS_DMX_MODE,
    Audio_R2_SHM_PARAM_DTS_SEAMLESS_MODE,

    Audio_R2_SHM_PARAM_ASF_VERSION,
    Audio_R2_SHM_PARAM_ASF_CHANNELS,
    Audio_R2_SHM_PARAM_ASF_SAMPLERATE,
    Audio_R2_SHM_PARAM_ASF_BYTERATE,
    Audio_R2_SHM_PARAM_ASF_BLOCKALIGN,
    Audio_R2_SHM_PARAM_ASF_ENCOPT,
    Audio_R2_SHM_PARAM_ASF_PARSINGBYAPP,
    Audio_R2_SHM_PARAM_ASF_BITS_PER_SAMPLE,
    Audio_R2_SHM_PARAM_ASF_CHANNELMASK,
    Audio_R2_SHM_PARAM_ASF_DRC_PARAM_EXIST,
    Audio_R2_SHM_PARAM_ASF_DRC_RMS_AMP_REF,
    Audio_R2_SHM_PARAM_ASF_DRC_RMS_AMP_TARGET,
    Audio_R2_SHM_PARAM_ASF_DRC_PEAK_AMP_REF,
    Audio_R2_SHM_PARAM_ASF_DRC_PEAK_AMP_TARGET,
    Audio_R2_SHM_PARAM_ASF_MAX_PACKET_SIZE,

    Audio_R2_SHM_PARAM_XPCM_TYPE,
    Audio_R2_SHM_PARAM_XPCM_CHANNELS,
    Audio_R2_SHM_PARAM_XPCM_SAMPLERATES,
    Audio_R2_SHM_PARAM_XPCM_BITS_PER_SAMPLE,
    Audio_R2_SHM_PARAM_XPCM_BLOCK_SIZE,
    Audio_R2_SHM_PARAM_XPCM_SAMPLE_PER_BLOCK,

    Audio_R2_SHM_PARAM_HASH_KEY,

    Audio_R2_SHM_PARAM_SPDIF_TYPE,

    Audio_R2_SHM_PARAM_RFSIGNAL_TYPE,
    Audio_R2_SHM_PARAM_DPGA_FLAG,
//-----------------------------------------------------------------
//  LM15U Added End (Need same as R2_SHM_PARAM_TYPE in halAUR2.h)
//-----------------------------------------------------------------

//-----------------------------------------------------------------
//  LM15U Customization  Added Start
//-----------------------------------------------------------------
    Audio_SE_Set_I2S_OutNumber,
    Audio_SE_Set_HP_Delay,
    Audio_SE_Set_AENC_Input_Mux,
    Audio_SE_Set_AENC_Mute,
    Audio_SE_Set_ADEC0_Input_delay,
    Audio_SE_Set_ADEC1_Input_delay,
    Audio_R2_Set_NonPcm_Sel,
    Audio_SE_Set_PCM_Capture_Volume,
    Audio_SE_Set_PCM_Capture2_Volume,
    Audio_R2_Set_DEC_Parser,//[LM14A]
    Audio_R2_SHM_PARAM_AD_Volume,
    Audio_ParamType_KillProcess,
    Audio_ParamType_ATV_Exist,
    Audio_ParamType_Close_SWDmaReader,
    Audio_ParamType_Abs_ReadReg_Target,
    Audio_ParamType_Abs_WriteReg_Target,
    Audio_ParamType_Abs_WriteReg_Value,
    Audio_ParamType_bEnableKernelMsg,
    ...
    Audio_ParamType_SE_Set_SW_DMA_FS,
    Audio_ParamType_PreNotMM_Flag,//morris temp
    Audio_ParamType_TrickPlay,
    Audio_ParamType_TV_Service_CH5_Mute_Status, //[LM14A]
    Audio_ParamType_TV_Service_CH6_Mute_Status, //[LM14A]
    ...
    Audio_Set_DMA_Buffer_Limiter,
    Audio_Set_HP_GAIN_BOOST_flag,
    Audio_ParamType_STR_Resume_LGSE_Fail,
    Audio_ParamType_omx_spdif_flush_en,
    Audio_ParamType_omx_spdif_flush,
    Audio_ParamType_omx_spdif_mute,
    Audio_ParamType_omx_OutputDelayOffset_bEnable,
    Audio_ParamType_omx_bIsVP9_60P,
    Audio_ParamType_TV_Service_bForeground,
    Audio_ParamType_CommonCmd,
    Audio_ParamType_Optical_Output_AC3P_Enable,
    Audio_ParamType_Optical_Output_DTS_Enable,
    Audio_ParamType_LGSE_NO_PROCESSING,
    Audio_ParamType_MultiCH_Delay,
    Audio_ParamType_MetaData_Select,
    Audio_ParamType_DMXLR_Mixed_Channel,
    Audio_ParamType_System_Sound_Mixed_Channel,
    Audio_ParamType_HDMI_RX_Unstable_Mute,
    Audio_ParamType_HDMI_RX_Unstable_Threshold,
    Audio_ParamType_HDMI_RX_Unstable_Mute_Duration_CH5,
    Audio_ParamType_HDMI_RX_Unstable_Mute_Duration_CH6,
    Audio_ParamType_HDMI_Event_Mute_Enable,
//-----------------------------------------------------------------
...
typedef enum
{
    ...
    Audio_infoType_Multi_Pcm_WRptr,
    Audio_infoType_Decoder_Type,

//-----------------------------------------------------------------
//  LM15U Added Start (Need same as R2_SHM_INFO_TYPE in halAUR2.h)
//-----------------------------------------------------------------
    Audio_R2_SHM_INFO_CAPABILITY,
    Audio_R2_SHM_INFO_DEC_STAUS,
    Audio_R2_SHM_INFO_DEC_ERROR_ID,
    Audio_R2_SHM_INFO_SMP_RATE,
    Audio_R2_SHM_INFO_BIT_RATE,
    Audio_R2_SHM_INFO_SYNTH_RATE,
    Audio_R2_SHM_INFO_DEC_CHANNEL_MODE,
    Audio_R2_SHM_INFO_DRA_CHANNEL_MAPPING,

    Audio_R2_SHM_INFO_ES_LEVEL,
    Audio_R2_SHM_INFO_PCM_LEVEL,
    Audio_R2_SHM_INFO_ES_RD_PTR,                  //a
    Audio_R2_SHM_INFO_PCM_WR_PTR,
    Audio_R2_SHM_INFO_MM_FILE_REQ_SIZE,           //c

    Audio_R2_SHM_INFO_ACCUM_ES_BYTECNT,
    Audio_R2_SHM_INFO_WAIT_1STPTS_CNT,
    Audio_R2_SHM_INFO_WAIT_STC_CNT,
    Audio_R2_SHM_INFO_SMP_FLUSH_CNT,

    Audio_R2_SHM_INFO_AVSYNC_STATE,
    Audio_R2_SHM_INFO_AVSYNC_FREERUN_TYPE,
    Audio_R2_SHM_INFO_AVSYNC_OFFSET,
    Audio_R2_SHM_INFO_AVSYNC_MMTsSyncFlag,

    Audio_R2_SHM_INFO_PTS_TAG_WR_IDX,
    Audio_R2_SHM_INFO_PTS_TAG_RD_IDX,

    Audio_R2_SHM_INFO_PLAY_STATE,
    Audio_R2_SHM_INFO_DEC_TYPE,
    Audio_R2_SHM_INFO_PLAYSMPFLAG,
    Audio_R2_SHM_INFO_DEC_CALLING_CNT,
    Audio_R2_SHM_INFO_RECEIVE_STOP_CNT,

    Audio_R2_SHM_INFO_OK_FRMCNT,
    Audio_R2_SHM_INFO_ERR_FRMCNT,
    Audio_R2_SHM_INFO_SKIP_FRMCNT,
    Audio_R2_SHM_INFO_REPT_FRMCNT,
    Audio_R2_SHM_INFO_SYNC_MISS_CNT,
    Audio_R2_SHM_INFO_PCM_EMPTY_CNT,

    Audio_R2_SHM_INFO_STC,
    Audio_R2_SHM_INFO_PTS,
    Audio_R2_SHM_INFO_CURR_PTS,
    Audio_R2_SHM_INFO_TD,
    Audio_R2_SHM_INFO_PTS_LATENCY,

    Audio_R2_SHM_INFO_UNI_DECODE_DONE_CNT,
    Audio_R2_SHM_INFO_UNI_DECODE_DONE_PCM_ADDR,
    Audio_R2_SHM_INFO_UNI_DECODE_DONE_PCM_SIZE,

    Audio_R2_SHM_INFO_PCM_ADDR,
    Audio_R2_SHM_INFO_PCM_SIZE,

    Audio_R2_SHM_INFO_spdifbuf_LEVEL,
    Audio_R2_SHM_INFO_spdifbuf_WR_PTR,

    Audio_R2_SHM_INFO_DOLBY_DEC_TYPE,
    Audio_R2_SHM_INFO_DOLBY_FRAME_SIZE,
    Audio_R2_SHM_INFO_DOLBY_BS_MODE,
    Audio_R2_SHM_INFO_DOLBY_AAC_TYPE,

    Audio_R2_SHM_INFO_DTS_CD_MODE,
    Audio_R2_SHM_INFO_DTS_PCM_FRAME_SIZE,
    Audio_R2_SHM_INFO_DTS_ES_TYPE,
    Audio_R2_SHM_INFO_SPDIF_INFO_FLAG,

    Audio_R2_SHM_INFO_MPEG_LAYER,
    Audio_R2_SHM_INFO_MPEG_STEREOMODE,
    Audio_R2_SHM_INFO_MPEG_HEADER,
//-----------------------------------------------------------------
...
//-----------------------------------------------------------------
    Audio_SE_SPEAKER_MUTE_STATUS,
    Audio_SE_HPOUT_MUTE_STATUS,
    Audio_SE_SPDIFOUT_MUTE_STATUS,
    Audio_SE_SCARTOUT_MUTE_STATUS,
    Audio_SE_Decoder_Delay,
    Audio_SE_SpeakerOut_Delay,
    Audio_SE_HpOut_Delay,
    Audio_SE_SPDIFOut_Delay,
    Audio_R2_Dec_Type,
    Audio_infoType_SWDmaReader_Level,
    Audio_infoType_Open_SWDmaReader,
    Audio_infoType_Abs_ReadReg,
    Audio_infoType_ReadDM_Value,
    Audio_infoType_ReadPM_Value,
    Audio_infoType_SWDMAReader_Pause,
    Audio_infoType_PreNotMM_Flag,//morris temp
    Audio_R2_SHM_INFO_TP_ES_FreeSize,
    Audio_infoType_STR_Resume_LGSE_Fail,
    Audio_infoType_omx_OutputDelayOffset_bEnable,
    Audio_infoType_omx_bIsVP9_60P,
    Audio_infoType_TV_Service_bForeground,
//-----------------------------------------------------------------
...
//  DMR Added Start
//-----------------------------------------------------------------
    Audio_infoType_HDMI_NPCM_Lock_Status,
    Audio_infoType_MetaData_Select,
    Audio_infoType_DMXLR_Mixed_Channel,
    Audio_infoType_System_Sound_Mixed_Channel,
//-----------------------------------------------------------------
//  DMR Added End
//-----------------------------------------------------------------
...
typedef struct
{
    ...
    AUDIO_FORCE_ADEC_ID eAudio_Force_ID; // LM15U
} AudioDecStatus_t;
...
typedef struct
{
    ...
    MS_U8   u8SoundBarVolume1;
    MS_U8   u8SoundBarVolume2;
    MS_U8   u8SoundBarVolumeMuteOnOff;
    MS_U8   u8SoundBarWooferLevel;
    MS_U8   u8SoundBarAutoVolume;
    MS_U8   u8SoundBarCheckSum;
...
{
    SAMPLE_RATE eFs;
    MS_BOOL bLittleEndian;
    MS_U8 u8Channels;
    MS_U8 u8ByteWidth;
    MS_BOOL bMainChannel;
    MS_U8 u8PathIdx;
    MS_S8 OMX_ArenderPathID;
}PCM_OUTPUT_FORMAT;
...
typedef struct
{
    MS_U32   LGSEFN009_pParams;
    MS_U16   LGSEFN009_noParam;
    MS_U32   LGSEMode_pParams;
    MS_U16   LGSEMode_noParam;
}LGSEVolumeReset;
...
//================================================================
//  PCM Mixer Structure & Enum
//================================================================
typedef enum {
    AUDIO_PCMMIXER_CMD_ALL, /* GET only */
    AUDIO_PCMMIXER_CMD_GROUP, /* SET/GET */
    AUDIO_PCMMIXER_CMD_BUFFER, /* GET only */
    AUDIO_PCMMIXER_CMD_BUFFERSIZE, /* SET/GET */
    AUDIO_PCMMIXER_CMD_READPTR, /* GET only */
    AUDIO_PCMMIXER_CMD_WRITEPTR, /* GET only */
    AUDIO_PCMMIXER_CMD_CHANNEL, /* SET/GET */
    AUDIO_PCMMIXER_CMD_SAMPLERATE, /* SET/GET */
    AUDIO_PCMMIXER_CMD_BITWIDTH, /* SET/GET */
    AUDIO_PCMMIXER_CMD_ENDIEN, /* SET/GET */
    AUDIO_PCMMIXER_CMD_TIMESTAMP, /* SET/GET */
    AUDIO_PCMMIXER_CMD_WEIGHTING, /* SET/GET */
    AUDIO_PCMMIXER_CMD_VOLUME, /* SET/GET */
    AUDIO_PCMMIXER_CMD_BUFFERLEVEL, /* GET */
    AUDIO_PCMMIXER_CMD_MUTE, /* SET/GET */

    /*
     * Note!!!
     *
     * 1. The command in this structure can only be added (must from the bottom), never removed!!!
     *
     */
} AUDIO_PCMMIXER_COMMAND;

typedef struct {
    MS_U8 u8StructVersion;
     ...
     * Note!!!
     *
     * 1. No matter what kind of modification in this structure, "AUDIO_PCMMIXER_VERSION" must be updated as well!!!
     *
     * 2. The element in this structure can only be added (must from the bottom), never removed!!!
     *
     */
} Audio_PcmMixer_Element_Info_t;

/**
 * AUDIO HDMI Port Index.
 * AUDIO_HDMI_SWITCH is defined for HDMI Switch Model and 1 Port Only in SoC.
 *
 */
typedef  enum
{
	AUDIO_HDMI0	        = 0,	/* HDMI2.0 Port 0. */
	AUDIO_HDMI1	        = 1,	/* HDMI2.0 Port 1. */
	AUDIO_HDMI2 		= 2,	/* HDMI1.4 Port 0 with ARC. */
	AUDIO_HDMI3 		= 3,	/* HDMI1.4 Port 1 with MHL. */
	AUDIO_HDMI_SWITCH 	= 4,	/* HDMI1.4 Port with HDMI Switch Model. */
	AUDIO_HDMI_MAX		= AUDIO_HDMI_SWITCH,
} AUDIO_HDMI_INDEX_T;


typedef enum
{
    E_SELECT_DECODER      = 0x0,
    E_ELECT_MULTI_CHANNEL = 0x1,
    E_ELECT_DOWN_MIX      = 0x2,
}AUDIO_META_DATA_SELECT;
