...
{
    APIXC_AdcGainOffsetSetting* pstADCSetting;
} stXC_ADC_GETOFFSETSETTING, *pstXC_ADC_GETOFFSETSETTING;

typedef struct
{
    APIXC_AdcGainOffsetSetting* pstADCSetting;
} stXC_ADC_GETGAINSETTING, *pstXC_ADC_GETGAINSETTING;

typedef struct
{
    APIXC_AdcGainOffsetSetting* pstADCSetting;
} stXC_ADC_SETOFFSETSETTING, *pstXC_ADC_SETOFFSETSETTING;

typedef struct
{
    APIXC_AdcGainOffsetSetting* pstADCSetting;
} stXC_ADC_SETGAINSETTING, *pstXC_ADC_SETGAINSETTING;
