...
typedef enum {
    ...
    MApi_CMD_MFE_SetVUI,
    MApi_CMD_MFE_GETCONF_POWERSUSPEND,
    MApi_CMD_MFE_SETCONF_CLEARPOWERSUSPEND
} E_MFE_V2_IOCTL_CMD;
...
typedef struct _MFE_GETPOWER_SUSPEND
{
    PVR_Info* mfe_Info;
    MS_U32 u32MFEPWRSuspend;
    MS_BOOL retVal;
}MFE_GETCOFG_POWERSUSPEND, *PMFE_GETCOFG_POWERSUSPEND;
