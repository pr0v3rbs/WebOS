...
#define MSIF_AVD_LIBVER                        {'0','3'}      //LIB version
#define MSIF_AVD_BUILDNUM                 {'1','0' }    //Build Number
#define MSIF_AVD_CHANGELIST             {'0','0','6','8','3','0','8','2'} //P4 ChangeList Number
...
#define VD_MODE_DETECT_MASK_PAL_SWITCH (VD_SYNC_LOCKED|VD_HSYNC_LOCKED|VD_VSYNC_50HZ|VD_FSC_TYPE|VD_PAL_SWITCH|VD_RESET_ON)
#define VD_MODE_DETECT_MASK_NORMAL (VD_SYNC_LOCKED|VD_HSYNC_LOCKED|VD_VSYNC_50HZ|VD_FSC_TYPE|VD_RESET_ON)
#define VD_MODE_DETECT_MASK             ((((u16CurSyncStatus & VD_VSYNC_50HZ)==0)&& ((u16CurSyncStatus & VD_FSC_TYPE) == VD_FSC_4433)) ? VD_MODE_DETECT_MASK_PAL_SWITCH : VD_MODE_DETECT_MASK_NORMAL)
...
#define VD_AGC_COARSE_GAIN_SAMSUNG          13 // 0xD  1x  A1 & A5 series has different gain mapping 
...
//#define AVD_PATCH_ENABLE_ATSC BIT_(25)    // used to get TV system, DVB/ATSC
//#define AVD_PATCH_SAMSUNG_DSP BIT_(26)   // 1:Samsung dsp code, 0:Demo board dsp code
#define AVD_PATCH_DSPCODE_LG_ATSC BIT_(25)  //2013.12.24 for lm14 bringup
#define AVD_PATCH_DSPCODE_LG BIT_(26)  ////2013.12.24 for lm14 bringup
...
extern void MDrv_AVD_SetAnaDemod(MS_BOOL bEnable);
extern void MDrv_AVD_SetHsyncSensitivityForDebug(MS_U8 u8AFEC99 ,MS_U8 u8AFEC9C);
#ifdef __cplusplus
}
#endif
