...
typedef enum
{
    ...
    E_INT_IRQ_UART5                     = E_INT_FIQ_0x110_START + 15,   //Munich
    ...
    E_INT_FIQ_SPI2FCIE                  = E_INT_IRQ_0x120_START + 15,   //Munich
    E_INT_IRQ_0x120_END                 = 0x12F,
    
	E_INT_IRQ_0x130_START               = 0x130,
	E_INT_IRQ_AUDMA_V2_INT              = E_INT_IRQ_0x120_START + 1,    //Muji
    E_INT_IRQ_EMMC_OSP_INT              = E_INT_IRQ_0x120_START + 2,    //Muji
    E_INT_IRQ_MHL_ECBUS_INT             = E_INT_IRQ_0x120_START + 3,    //Muji
    E_INT_IRQ_SDIO_OSP_INT              = E_INT_IRQ_0x120_START + 4,    //Muji
	E_INT_IRQ_0x130_END                 = 0x13F,

    E_INT_IRQ_0x140_START               = 0x140,
    E_INT_IRQ_EXT_GPIO_MERGE            = E_INT_IRQ_0x140_START + 1,    //Mustang
    E_INT_IRQ_DIMOND_L3_BRIDGE_INT      = E_INT_IRQ_0x140_START + 2,    //Mustang
    E_INT_IRQ_PAS_PTS_INTRL_COMBINE     = E_INT_IRQ_0x140_START + 3,    //Mustang
    E_INT_IRQ_AESDMA_S_INT              = E_INT_IRQ_0x140_START + 4,    //Mustang
