...
typedef enum
{
    ...
    E_XC_CMD_SET_WINDOW,
    E_XC_CMD_SET_DYNAMICSCALING_WINDOW,
    E_XC_CMD_SET_GAMEMODE,
    E_XC_CMD_FORCEINTERLACEINPMODE,
    E_XC_CMD_GET_FBSIZE,
    ...
    E_XC_CMD_SET_3D_KR3DMODE,
    E_XC_CMD_GET_3D_KR3DMODE,
    E_XC_CMD_SET_MUX_INIT,
    E_XC_CMD_SET_MUX_SOURCE_MONITOR,
    E_XC_CMD_SET_RECORD_FLAG,
    E_XC_CMD_GET_RECORD_FLAG,
    E_XC_CMD_SET_MUX_CREATE_PATH,
    E_XC_CMD_SET_MUX_DELETE_PATH,
    E_XC_CMD_SET_INTERLACE_STATUS,
    ...
    E_XC_CMD_SET_FREERUN_TIMING_WITHOUTSEMAPHORE,
    ...
    E_XC_CMD_ENABLE_DUALWINDOWFORAPVR,
    E_XC_CMD_GET_DUALWINDOWFORAPVR,
    ...
    E_XC_SET_OP1_TESTPATTERN_RGB,
    E_XC_SET_OP2_TESTPATTERN_RGB,
    E_XC_SET_OP2_TESTPATTERN,
    E_XC_SET_IP1_TESTPATTERN_RGB,
    ...
    E_XC_SET_3D_TP_INNERPATTERN,
    E_XC_SET_OP_TESTPATTERN,
    E_XC_SET_VOP_TESTPATTERN,
    E_XC_CMD_SET_FRC_IPM_TESTPATTERN,
    E_XC_CMD_SET_FRC_OPM_TESTPATTERN,
    E_XC_CMD_SET_FRC_OP_TESTPATTERN,
    E_XC_CMD_SET_SEAMLESS_PLAY,
    E_XC_CMD_GET_SEAMLESS_PLAY,
	E_XC_CMD_SET_MOD_PATTERN,
	E_XC_CMD_SET_CODED_WIN,
	E_XC_CMD_SET_FRC_BYPASS_FLAG,
	E_XC_CMD_SET_SMARTZOOM,
    E_XC_CMD_GET_SMARTZOOM,
	E_XC_CMD_SET_STREAM_PAUSE,
	E_XC_CMD_GET_STREAM_PAUSE,
	E_XC_CMD_OP_CHK_STUS,
	E_XC_CMD_SET_OUTPUT_MODE,
	E_XC_CMD_Set_IPMUX_TestPattern,
	E_XC_CMD_GET_OUTPUT_MODE,
    E_XC_SET_OSD_DETECT,
    E_XC_GET_OSD_DETECT,
    E_XC_IS2K2KTOFRCMODE,
    E_XC_OFFLINE_ADC_SETMODE,
    E_XC_PRE_ADC_SETMODE,
    E_XC_CMD_SET_DYNAMIC_SCALING_FLAG,
	E_XC_CMD_GET_FORCE_NOAUTO_FIT,
	E_XC_CMD_SET_FORCE_NOAUTO_FIT,
	E_XC_CMD_CLOSE,
	E_XC_CMD_OPEN,

      //APIXC CUS DS
       E_XC_CMD_DSLOAD_GETSTATUS,
    //    E_XC_SET2PMODE,
#if 1
...
//** OBSELETE FUNCTION**//
    ...
    E_XC_CMD_GET_GSTREAMER_PROCESS,
    E_XC_CMD_SET_GSTREAMER_PROCESS,
    E_XC_CMD_GET_CAPTURE_PROCESS,
    E_XC_CMD_SET_CAPTURE_PROCESS,
    E_XC_CMD_GET_SVP_STATUS,
    E_XC_CMD_SET_SVP_STATUS,
    E_XC_CMD_GET_VTBlock_STATUS,
    E_XC_CMD_SET_VTBlock_STATUS,
    E_XC_CMD_GET_OPWrite_OFF,
    E_XC_CMD_SET_OPWrite_OFF,
    E_XC_CMD_CMA_INIT,
    E_XC_CMD_GET_CMA_ADDR,
    E_XC_CMD_RELEASE_CMA,
	E_XC_CMD_GET_DISP_DE_WINDOW,
	E_XC_CMD_SET_DYNAMIC_SCALING_ONOFF,
        E_XC_CMD_MAX,
//** OBSELETE FUNCTION**//
    ...
    //APIXC_ADC_CUS_EX
    E_XC_ADC_CMD_GETOFFSETSETTING,
    E_XC_ADC_CMD_GETGAINSETTING,
    E_XC_ADC_CMD_SETOFFSETSETTING,
    E_XC_ADC_CMD_SETGAINSETTING,
    E_XC_ADC_CMD_MAX,
    ...
    E_XC_HDMI_IF_CMD_GET_HDE,
    E_XC_HDMI_IF_CMD_GET_VDE,
    E_XC_HDMI_IF_CMD_GET_HTT,
    E_XC_HDMI_IF_CMD_GET_VTT,
    E_XC_HDMI_IF_CMD_GET_SOURCE_VERSION,
    E_XC_HDMI_IF_CMD_SET_5V_DETECT_GPIO_SELECT,
    E_XC_HDMI_IF_CMD_GET_DE_STABLE_STATUS,
    E_XC_HDMI_IF_CMD_DDC_CHANNEL_ENABLE,
    /*************************** HDCP22 ***************************/
...
{
    MS_U16 u16DbgSwitch;
    E_XC_MESSAGE_TYPE eMessageType;
    MS_BOOL bReturnValue;
...
{
    MS_BOOL bReturnValue;
} stXC_CMD_SET_IOMAPBASE_I, *pstXC_CMD_SET_IOMAPBASE_I;
...
{
    MS_BOOL bReturnValue;
} stXC_OPEN, *pstXC_OPEN, stXC_CLOSE, *pstXC_CLOSE;
...
typedef struct
{
    SCALER_WIN eWindow;
    MS_BOOL bReturnValue;
} stXC_GET_FBSIZE, *pstXC_GET_FBSIZE;

typedef struct
{
  SCALER_WIN eWindow;
  MS_BOOL bNeedSetWindow;
} stXC_SET_GAMEMODE, *pstXC_SET_GAMEMODE;

typedef struct
{
  MS_BOOL bEnable;
  SCALER_WIN eWindow;
  E_APIXC_ReturnValue bReturnValue;
} stXC_FORCEINTERLACEINPMODE, *pstXC_FORCEINTERLACEINPMODE;
...
{
    MS_BOOL bIsKR3D;
} stXC_SET_3D_KR3DMODE, *pstXC_SET_3D_KR3DMODE;
...
} stXC_SET_RECORD_FLAG, *pstXC_SET_RECORD_FLAG;

typedef struct
{  
    MS_BOOL bReturnValue;
} stXC_GET_RECORD_FLAG, *pstXC_GET_RECORD_FLAG;
...
typedef struct
{
    ...
    SCALER_WIN eWindow;
} stXC_SET_INTERLACE_STATUS, *pstXC_SET_INTERLACE_STATUS;
...
{
    MS_BOOL bEnable;
} stXC_ENABLE_DAULWINDOWFORAPVR, *pstXC_ENABLE_DAULWINDOWFORAPVR;

typedef struct
{
    MS_BOOL bEnable;
} stXC_GET_DAULWINDOWFORAPVR, *pstXC_GET_DAULWINDOWFORAPVR;
...
typedef struct
{
    ...
    MS_BOOL bEnable;
    MS_BOOL bReturnValue;
} stXC_SET_LD_SPI_CMD, *pstXC_SET_LD_SPI_CMD;
...
typedef struct
{
    MS_U16 u16Value;
    SCALER_WIN eWindow;
} stXC_SET_RFBFC, *pstXC_SET_RFBFC;

typedef struct
{
    MS_U16 u16Value;
    SCALER_WIN eWindow;
} stXC_SET_RFBFC_FRC, *pstXC_SET_RFBFC_FRC;

typedef struct
{
    MS_U16 u16Value;
    SCALER_WIN eWindow;
} stXC_SET_RWPD, *pstXC_SET_RWPD;

typedef struct
{
    MS_U16 u16Value;
    SCALER_WIN eWindow;
} stXC_SET_RWPD_FRC, *pstXC_SET_RWPD_FRC;

typedef struct
{
    MS_U16 u16ReturnValue;
    SCALER_WIN eWindow;
} stXC_GET_RFBFC, *pstXC_GET_RFBFC;

typedef struct
{
    MS_U16 u16ReturnValue;
    SCALER_WIN eWindow;
} stXC_GET_RFBFC_FRC, *pstXC_GET_RFBFC_FRC;

typedef struct
{
    MS_U16 u16ReturnValue;
    SCALER_WIN eWindow;
} stXC_GET_RWPD, *pstXC_GET_RWPD;

typedef struct
{
    MS_U16 u16ReturnValue;
    SCALER_WIN eWindow;
} stXC_GET_RWPD_FRC, *pstXC_GET_RWPD_FRC;
...
typedef struct
{
    DSLOAD_TYPE bReturnValue;
} stXC_DSLOAd_GETSTAUS, *pstXC_DSLOAd_GETSTAUS;
...
} stXC_SET_OP2_TESTPATTERN_RGB, *pstXC_SET_OP2_TESTPATTERN_RGB;
...
typedef struct
{
    ...
    MS_U16 u16GVal;
    MS_U16 u16BVal;
} stXC_SET_OP1_TESTPATTERN_RGB, *pstXC_SET_OP1_TESTPATTERN_RGB;
...
typedef struct
{
    ...
    MS_U16 u16CSC;
    MS_BOOL bCCIR;
} stXC_SET_IP1_TESTPATTERN_RGB, *pstXC_SET_IP1_TESTPATTERN_RGB;
...
{
    MS_BOOL bEnable;
    MS_3D_InnerInfo st3dinner;
    E_APIXC_ReturnValue eReturnValue;
} stXC_Set_3D_TP_InnerPattern, *pstXC_Set_3D_TP_InnerPattern;

typedef struct
{
    MS_BOOL bReturnValue;
} stXC_SET_GSTREAMER_PROCESS, *pstXC_SET_GSTREAMER_PROCESS;

typedef struct
{
    MS_BOOL bReturnValue;
} stXC_GET_GSTREAMER_PROCESS, *pstXC_GET_GSTREAMER_PROCESS;

typedef struct
{
    MS_BOOL bReturnValue;
} stXC_SET_CAPTURE_PROCESS, *pstXC_SET_CAPTURE_PROCESS;

typedef struct
{
    MS_BOOL bReturnValue;
} stXC_GET_CAPTURE_PROCESS, *pstXC_GET_CAPTURE_PROCESS;

typedef struct
{
    MS_BOOL bReturnValue;
} stXC_SET_SVP_STATUS, *pstXC_SET_SVP_STATUS;

typedef struct
{
    MS_BOOL bReturnValue;
} stXC_GET_SVP_STATUS, *pstXC_GET_SVP_STATUS;

typedef struct
{
    MS_BOOL bReturnValue;
} stXC_SET_OPWRITE_OFF, *pstXC_SET_OPWRITE_OFF;

typedef struct
{
    MS_BOOL bReturnValue;
} stXC_GET_OPWRITE_OFF, *pstXC_GET_OPWRITE_OFF;

typedef struct
{
    MS_BOOL bReturnValue;
} stXC_CMA_INIT, *pstXC_CMA_INIT;
...
typedef struct
{
    ...
    SCALER_WIN eWindow;
    MS_U64 u64ReturnValue;
} stXC_GET_CMA_ADDR, *pstXC_GET_CMA_ADDR;
...
typedef struct
{
    ...
    SCALER_WIN eWindow;
    MS_BOOL bReturnValue;
} stXC_RELEASE_CMA, *pstXC_RELEASE_CMA;

typedef struct
{
    MS_BOOL bReturnValue;
} stXC_SET_VTBlock_STATUS, *pstXC_SET_VTBlock_STATUS;

typedef struct
{
    MS_BOOL bReturnValue;
} stXC_GET_VTBlock_STATUS, *pstXC_GET_VTBlock_STATUS;

typedef struct
{
    MS_BOOL bEnable;
    MS_U8 u8TestMode;
} stXC_SET_OP_TESTPATTERN, *pstXC_SET_OP_TESTPATTERN;

typedef struct
{
    MS_BOOL bEnable;
} stXC_SET_VOP_TESTPATTERN, *pstXC_SET_VOP_TESTPATTERN;

typedef struct
{
    MS_BOOL bEnable;
    MS_U8 u8Pattern_type;
} stXC_SET_FRC_IPM_TESTPATTERN, *pstXC_SET_FRC_IPM_TESTPATTERN;

typedef struct
{
    MS_BOOL bEnable;
    MS_U8 u8Pattern_type;
} stXC_SET_FRC_OPM_TESTPATTERN, *pstXC_SET_FRC_OPM_TESTPATTERN;
...
typedef struct
{
    ...
    MS_U8 u8Pattern_type;
	MS_U8 u8Color;
} stXC_SET_FRC_OP_TESTPATTERN, *pstXC_SET_FRC_OP_TESTPATTERN;

typedef struct
{
    MS_BOOL bReturnValue;
} stXC_SET_SEAMLESS_PLAY, *pstXC_SET_SEAMLESS_PLAY;
...
{
    MS_BOOL bReturnValue;
} stXC_GET_SEAMLESS_PLAY, *pstXC_GET_SEAMLESS_PLAY;

typedef struct
{
    MS_U8 bEnable;
} stXC_SET_MOD_PATTERN, *pstXC_SET_MOD_PATTERN;

typedef struct
{
    MS_WINDOW_TYPE stCodedwin;
	SCALER_WIN eWindow;
} stXC_SET_CODED_WIN, *pstXC_SET_CODED_WIN;

typedef struct
{
    MS_BOOL bIsBypass;
} stXC_SET_FRC_BYPASS_FLAG, *pstXC_SET_FRC_BYPASS_FLAG;

typedef struct
{
    MS_BOOL bIsSmartZoomOpen;
} stXC_SET_SMARTZOOM, *pstXC_SET_SMARTZOOM;

typedef struct
{
    MS_BOOL bReturnValue;
} stXC_GET_SMARTZOOM, *pstXC_GET_SMARTZOOM;

typedef struct
{
    MS_BOOL bIsPause;
} stXC_SET_STREAM_PAUSE, *pstXC_SET_STREAM_PAUSE;

typedef struct
{
    MS_BOOL bIsPause;
} stXC_GET_STREAM_PAUSE, *pstXC_GET_STREAM_PAUSE;

typedef struct
{
    EN_XC_SOC_OUTPUT_MODE enXCOutputMode;
} stXC_SET_OUTPUT_MODE, *pstXC_SET_OUTPUT_MODE, stXC_GET_OUTPUT_MODE, *pstXC_GET_OUTPUT_MODE;
...
typedef struct
{
    ...
    MS_U16 u16G_Y;
    MS_U16 u16B_Cb;
} stXC_Set_IPMUX_TestPattern, *pstXC_Set_IPMUX_TestPattern;

typedef struct
{
    MS_BOOL bEnable;
    SCALER_WIN eWindow;
} stXC_SET_FRORCE_NOAUTO_FIT, *pstXC_SET_FRORCE_NOAUTO_FIT;

typedef struct
{
    SCALER_WIN eWindow;
} stXC_GET_FRORCE_NOAUTO_FIT, *pstXC_GET_FRORCE_NOAUTO_FIT;
...
typedef struct
{
	...
	MS_BOOL bIPS_On;
	MS_BOOL bIPM_On;
} stXC_SET_DYNAMIC_SCALING_ONOFF, *pstXC_SET_DYNAMIC_SCALING_ONOFF;
...
typedef struct
{
    ...
    MS_BOOL bHDuplicate ;
    INPUT_SOURCE_TYPE_t enSourceType ;
    SCALER_WIN eWindow ;
} stXC_Offline_ADC_Setmode, *pstXC_Offline_ADC_Setmode;
#ifdef _XC_C_
#define INTERFACE
#else
