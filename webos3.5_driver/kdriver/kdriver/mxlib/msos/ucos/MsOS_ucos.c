...
extern void DCACHE_vFlushAddr(U32 wAddr);
extern void DCACHE_vInvalidateAddr(U32 wAddr);
MS_BOOL MsOS_Dcache_Flush( MS_U32 u32Start, MS_U32 u32Size )
{
    ...
    for ( ; u32Addr < u32End; u32Addr += DCACHE_LINE_SIZE)
    {
        DCACHE_vFlushAddr(u32Addr);
    }
...
MS_BOOL MsOS_Dcache_Invalidate( MS_U32 u32Start, MS_U32 u32Size )
{
    ...
    for ( ; u32Addr < u32End; u32Addr += DCACHE_LINE_SIZE)
    {
        DCACHE_vInvalidateAddr(u32Addr);
    }
    //flush EC's write FIFO
    MAsm_CPU_Sync();
    MsOS_RestoreAllInterrupts(u32OldIntr);
...
MS_U32 MsOS_VA2PA(MS_U32 addr)
{
        ...
        #if (defined(CHIP_T12) || defined(CHIP_A2) || defined(CHIP_T8) || defined(CHIP_J2) || defined(CHIP_A5) || defined(CHIP_A5P) || defined(CHIP_A3) || defined(CHIP_K2) || defined(CHIP_EIFFEL) || defined(CHIP_NIKE) || defined(CHIP_MADISON) || defined(CHIP_CLIPPERS) || defined(CHIP_MIAMI) || defined(CHIP_NADAL))
