...
inline MS_U32 MsOS_MPool_VA2PA(MS_U32 addr)
{
        ...
        #if (defined(CHIP_T12) || defined(CHIP_A2) || defined(CHIP_T8) || defined(CHIP_J2) || defined(CHIP_A5) || defined(CHIP_A5P) || defined(CHIP_A3) || defined(CHIP_K2) || defined(CHIP_Edison) || defined(CHIP_EIFFEL))
