...
S32 mdrv_gpd_init(gpd_addr_info* addr_info)
{
...
S32 mdrv_gpd_decode(gpd_pic_info *pic_info, U32 Ocolor, U32 mode, gpd_roi_info *roi)
{
    unsigned char sig[5] = {0};
...
void mdrv_gpd_scaling_init(U32 enable, U32 mode)
{
