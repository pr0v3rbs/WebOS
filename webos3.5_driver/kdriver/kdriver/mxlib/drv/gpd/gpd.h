...
#define ENABLE_GPD_MESSAGE    FALSE
...
#define console_printf(format, args...)   printk(format, ##args)
#else
#define console_printf(format, args...)   printf(format, ##args)
#endif
#else
#ifndef LOGD
#define console_printf(format, args...)          ALOGI(format, ##args);
#else
#define console_printf(format, args...)          LOGI(format, ##args);
#endif
#endif
