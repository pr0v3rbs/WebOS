...
typedef struct PngInfoStruct
{
    unsigned int png_width,png_height;
    unsigned char bps,color_type;
    unsigned char interlace,compression,filter;
    unsigned char color_depth;
    unsigned char *palette;
    unsigned char *trans;
    unsigned char trns_en;
    unsigned short palette_num;
...
typedef PngInfo *PngInfop;

PngInfop PngProcess(void *,unsigned long,unsigned long, void * );
