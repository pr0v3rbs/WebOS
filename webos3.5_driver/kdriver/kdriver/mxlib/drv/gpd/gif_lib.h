...
typedef struct GifImageDesc {
    unsigned int Left, Top, Width, Height,	/* Current image dimensions. */
...
typedef struct GifFileType {
    unsigned int SWidth, SHeight;		/* Screen dimensions. */
    ...
    unsigned int UserData;           /* hook to attach user data (TVT) */
    VoidPtr Private;	  		/* Don't mess with this! */
    unsigned int  GifState;     /*record the decode state*/
    int isMGIF;                 /*record the current GIF picture is animate or static*/
} GifFileType;
...
GifFileType *MstDGifOpenFileHandle(int GifFileHandle,InputFunc read_fun, GifByteType* bitstream);
...
int MstDGifGetRecordType(GifFileType *GifFile, GifRecordType *GifType);
int MstDGifGetImageDesc(GifFileType *GifFile);
int MstDGifGetLine(GifFileType *GifFile, GifPixelType *GifLine, int GifLineLen);
int MstDGifGetPixel(GifFileType *GifFile, GifPixelType GifPixel);
int MstDGifGetComment(GifFileType *GifFile, char *GifComment);
int MstDGifGetExtension(GifFileType *GifFile, int *GifExtCode,
						GifByteType **GifExtension);
int MstDGifGetExtensionNext(GifFileType *GifFile, GifByteType **GifExtension);
int MstDGifGetCode(GifFileType *GifFile, int *GifCodeSize,
						GifByteType **GifCodeBlock);
int MstDGifGetCodeNext(GifFileType *GifFile, GifByteType **GifCodeBlock);
int MstDGifGetLZCodes(GifFileType *GifFile, int *GifCode);
