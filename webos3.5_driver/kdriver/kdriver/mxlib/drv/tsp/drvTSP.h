...
#define MSIF_TSP_CHANGELIST         {'0','0','6','1','7','4','7','0'}                               // P4 ChangeList Number
...
//TSP IF Source Enum
#define TSP_SRC_FROM_TSIF0_LIVE             0x00000001
#define TSP_SRC_FROM_TSIF0_FILE             0x00000002
#define TSP_SRC_FROM_TSIF1                  0x00000003
#define TSP_SRC_FROM_TSIF2                  0x00000004
...
#define E_DRVTSP_FLT_MASK               0xF0800000
#define E_DRVTSP_FLT_SOURCE_TYPE_MASK   0xC0800000
...
#define E_DRVTSP_FLT_SOURCE_TYPE_TS2    0x00800000
...
typedef enum //_DrvTSP_RecMode
{
    ...
    E_DRVTSP_REC_MODE_ENG0_FI_FLTTYPE = 0x00000008,                                                 //File-in record pid

    E_DRVTSP_REC_MODE_ENG0_FI_BYPASS  = 0x00000010,                                                 //File-in record all
...
typedef enum //_DrvTSP_CtrlMode
{
    ...
    /// Enable bounding option for PVR descrambled stream, from TS1, output to TS2
    E_DRVTSP_CTRL_MODE_PVR_TS2_CA,
    /// Input From Stream Source 0, but not pass through CA
    E_DRVTSP_CTRL_MODE_TS0_NOCA,
    /// Input From Stream Source 1, CA output to Live0
    E_DRVTSP_CTRL_MODE_TS1_OUT_LIVE0,
...
//Ca control path
#define DrvTSP_DscmbCtrl                MS_U32
#define E_DRVTSP_CA_INPUT_LIVE0         0x00000001
#define E_DRVTSP_CA_INPUT_FILE0         0x00000002
#define E_DRVTSP_CA_INPUT_TSIF1         0x00000004
#define E_DRVTSP_CA_INPUT_TSIF2         0x00000800
#define E_DRVTSP_CA_OUTPUT_LIVE0        0x00000010
#define E_DRVTSP_CA_OUTPUT_FILE0        0x00000020
#define E_DRVTSP_CA_OUTPUT_REC0         0x00000040
#define E_DRVTSP_CA_OUTPUT_TSIF2        0x00000400
...
typedef enum //_DrvTSP_PacketMode
{
    ...
    E_DRVTSP_PKTMODE_200              = 0x00000005,       // packet size with 200 (Open cable Single stream)

    E_DRVTSP_PKTMODE_MERG188          = 0x00000006,       // packet size with 188 (Merge stream)
    E_DRVTSP_PKTMODE_MERG192          = 0x00000007,       // packet size with 192 (Merge stream)
    E_DRVTSP_PKTMODE_MERG200          = 0x00000008,       //packet size with 200 (Open cable Merge stream)
