...
#ifndef __TSP_NOS_H__
#define __TSP_NOS_H__


#define _MDrv_TSP_GetEvent(events, flag, opt, timeout)  TSP_OS_EventGet(_s32EventId, (flag), &(events), (opt), (timeout))
...
typedef void (*TSP_OS_Isr)(MHAL_SavedRegisters *regs, MS_U32 vector);

#define TSP_OS_MUTEX_TIMEOUT        MSOS_WAIT_FOREVER

#define TSP_OS_Print(_f, _a...)     printf(_f, ##_a)
#define TSP_ISR_Print(_f, _a...)    printf(_f, ##_a)
