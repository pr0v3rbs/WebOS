...
MS_U32 CPUIoctl(void* pInstance, MS_U32 u32Cmd, void* pArgs)
{
    ...
    {
        printf("UtopiaInstanceGetModule fail\n");
    ...
    {
        printf("UtopiaInstanceGetPrivate fail\n");
        return UTOPIA_STATUS_FAIL;
    }
    ...
    switch(u32Cmd)
    {
        case MDrv_CMD_CPU_InitFront:
            printf("CPUIoctl - MDrv_CMD_CPU_InitFront\n");
        ...
        case MDrv_CMD_CPU_InitEnd:
            printf("CPUIoctl - MDrv_CMD_CPU_InitEnd\n");
            if(UtopiaResourceObtain(pModule, CPU_POOL_ID_CPU0, &pResource) != 0)
            {
                printf("UtopiaResourceObtainToInstant fail\n");
                return UTOPIA_STATUS_ERR_RESOURCE;
        ...
        case MDrv_CMD_CPU_Disable:
            printf("CPUIoctl - MDrv_CMD_CPU_Disable\n");
            if(UtopiaResourceObtain(pModule, CPU_POOL_ID_CPU0, &pResource) != 0)
            {
                printf("UtopiaResourceObtainToInstant fail\n");
	            return UTOPIA_STATUS_ERR_RESOURCE;
        ...
        case MDrv_CMD_CPU_Enable:
            printf("CPUIoctl - MDrv_CMD_CPU_Enable\n");
            if(UtopiaResourceObtain(pModule, CPU_POOL_ID_CPU0, &pResource) != 0)
            {
                printf("UtopiaResourceObtainToInstant fail\n");
                return UTOPIA_STATUS_ERR_RESOURCE;
        ...
        case MDrv_CMD_CPU_SetHost:
            printf("CPUIoctl - MDrv_CMD_CPU_SetHost\n");
            if(UtopiaResourceObtain(pModule, CPU_POOL_ID_CPU0, &pResource) != 0)
            {
                printf("UtopiaResourceObtainToInstant fail\n");
                return UTOPIA_STATUS_ERR_RESOURCE;
        ...
        case MDrv_CMD_CPU_GetInfo:
            printf("CPUIoctl - MDrv_CMD_CPU_GetInfo\n");
        ...
        case MDrv_CMD_CPU_GetLibVer:
            printf("CPUIoctl - MDrv_CMD_CPU_GetLibVer\n");
        ...
        case MDrv_CMD_CPU_GetStatus:
            printf("CPUIoctl - MDrv_CMD_CPU_GetStatus\n");
            // this function won't occupy h/w, so don't need to call UtopiaResourceObtainToInstant
        ...
        case MDrv_CMD_CPU_SetDbgLevel:
            printf("CPUIoctl - MDrv_CMD_CPU_SetDbgLevel\n");
            // this function won't occupy h/w, so don't need to call UtopiaResourceObtainToInstant
        ...
        case MDrv_CMD_CPU_GetBase:
            printf("CPUIoctl - MDrv_CMD_CPU_GetBase\n");
            if(UtopiaResourceObtain(pModule, CPU_POOL_ID_CPU0, &pResource) != 0)
            {
                printf("UtopiaResourceObtainToInstant fail\n");
                return UTOPIA_STATUS_ERR_RESOURCE;
        ...
        case MDrv_CMD_CPU_QueryClock:
            printf("CPUIoctl - MDrv_CMD_CPU_QueryClock\n");
            if(UtopiaResourceObtain(pModule, CPU_POOL_ID_CPU0, &pResource) != 0)
            {
                printf("UtopiaResourceObtainToInstant fail\n");
                return UTOPIA_STATUS_ERR_RESOURCE;
