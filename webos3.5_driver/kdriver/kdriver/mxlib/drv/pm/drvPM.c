...
//-------------------------------------------------------------------------------------------------
// Internal Definition
#define PM_LOCK_SUPPORT             0   // 1: Enable 0: Disable
...
//-------------------------------------------------------------------------------------------------
#if PM_LOCK_SUPPORT //-----------------------------------------------------------------------------
#define RES_HK51ID    0x01
#define RES_AeonID    0x02
#define RES_MipsID    0x03
#define PMSEMID                 0x04
...
static MS_BOOL gIsSetIoBase = FALSE;
...
#if (PM_UTOPIA20)
MS_BOOL _MDrv_PM_CheckUtopia20Open(void** pInstance, MS_U32 u32ModuleVersion, void* pAttribute);
#endif
...
//-------------------------------------------------------------------------------------------------
void MDrv_PM_RTCSetMatchTime_U2K(MS_U32 u32PmSysTime)
{
...
void MDrv_PM_RTCSetMatchTime(MS_U32 u32PmSysTime)
{
    _MDrv_PM_DummyMiuFifo();
#if (PM_UTOPIA20)
    PM_PRIVATE_PARAM_RTCSystemTime PmParam_RTCSetMatchTime;
    if (FALSE == _MDrv_PM_CheckUtopia20Open(&pInstantPm, 0, pAttributePm))
        return ;
	PmParam_RTCSetMatchTime.u32PmSysTime = u32PmSysTime;
    UtopiaIoctl(pInstantPm,MDrv_CMD_PM_RtcSetMatchTime,(MS_U32*) &PmParam_RTCSetMatchTime);
#else
    MDrv_PM_RTCSetMatchTime_U2K(u32PmSysTime);
#endif	
}
...
//-------------------------------------------------------------------------------------------------
void MDrv_PM_RTCSetSystemTime_U2K(MS_U32 u32PmSysTime)
{
    _MDrv_PM_DummyMiuFifo();
    _PM_ENTRY(_gu16PMResID);
...
{
#if (PM_UTOPIA20)
    PM_PRIVATE_PARAM_RTCSystemTime PmParam_RTCSetSystemTime;
    if (FALSE == _MDrv_PM_CheckUtopia20Open(&pInstantPm, 0, pAttributePm))
        return ;	
    UtopiaIoctl(pInstantPm,MDrv_CMD_PM_RtcSetSystemTime,(MS_U32*) &PmParam_RTCSetSystemTime);
#else
    MDrv_PM_RTCSetSystemTime_U2K(u32PmSysTime);
#endif	   
}
...
//-------------------------------------------------------------------------------------------------
MS_U32 MDrv_PM_RTCGetSystemTime_U2K(void)
{
    _MDrv_PM_DummyMiuFifo();
    MS_U32 pu32PmSysTime;
    _PM_ENTRY(_gu16PMResID);
...
MS_U32 MDrv_PM_RTCGetSystemTime(void)
{
 ...
 #if (PM_UTOPIA20)
    PM_PRIVATE_PARAM_RTCSystemTime PmParam_RTCGetSystemTime = {0};
    if (FALSE == _MDrv_PM_CheckUtopia20Open(&pInstantPm, 0, pAttributePm))
        return 0;	
    UtopiaIoctl(pInstantPm,MDrv_CMD_PM_RtcGetSystemTime,(MS_U32*) &PmParam_RTCGetSystemTime);
	return PmParam_RTCGetSystemTime.u32PmSysTime;
#else
    return MDrv_PM_RTCGetSystemTime_U2K();
#endif	
...
PM_Result MDrv_PM_Init(PM_WakeCfg *pPmWakeCfg)
{
    ...
    u32SrcAddr = (MS_U32)pPmWakeCfg;
    PM_WakeCfg *PmWakeCfg = (PM_WakeCfg*)_PA2VA((MS_U32)pPmWakeCfg);   
...
PM_Result MDrv_PM_PowerDown(PM_PowerDownCfg *pPmPowerDownCfg)
{
    ...
    u32SrcAddr = (MS_U32)pPmPowerDownCfg;
...
PM_Result MDrv_PM_GPIOInit(MS_U16 u16GPIOIndex)
{
    ...
    // send to PM51
    {
        ...
        MB_Command.u8Parameters[1] =  (MS_U8)(u16GPIOIndex&0x00FF);
...
void MDrv_PM_SetIOMapBase(void)
{
    ...
    HAL_PM_SetIOMapBase(u32BaseAddr);
}
...
//-------------------------------------------------------------------------------------------------
PM_Result _MDrv_PM_RtcInit(PM_RtcParam *pPmRtcParam)
{
    PM_Result PmResult = E_PM_FAIL;
    ...
    //MBX_Msg MB_Command;
    //MS_U32 u32SrcAddr;
    PM_RtcParam *pPmRtcVA = (PM_RtcParam*)_PA2VA((MS_U32)pPmRtcParam);
...
/// @note   Please call MDrv_PM_GetInfo() first to init _sPmDrvInfo
//-------------------------------------------------------------------------------------------------
PM_Result _MDrv_PM_RtcSetCounter(PM_RtcParam *pPmRtcParam)
{
    PM_Result PmResult = E_PM_FAIL;
...
/// @note   Please call MDrv_PM_GetInfo() first to init _sPmDrvInfo
//-------------------------------------------------------------------------------------------------
PM_Result _MDrv_PM_RtcGetCounter(PM_RtcParam *pPmRtcParam)
{
    PM_Result PmResult = E_PM_FAIL;
...
/// @note   Please call MDrv_PM_GetInfo() first to init _sPmDrvInfo
//-------------------------------------------------------------------------------------------------
PM_Result _MDrv_PM_RtcSetMatchCounter(PM_RtcParam *pPmRtcParam)
{
    PM_Result PmResult = E_PM_FAIL;
...
/// @note   Please call MDrv_PM_GetInfo() first to init _sPmDrvInfo
//-------------------------------------------------------------------------------------------------
PM_Result _MDrv_PM_RtcGetMatchCounter(PM_RtcParam *pPmRtcParam)
{
    PM_Result PmResult = E_PM_FAIL;
...
////////////////////////////////////////////////////////////////////////////////
void _MDrv_PM_SetSPIOffsetForMCU(MS_U32 BANK)
{
...
/// @param pStatus      \b Out: non
////////////////////////////////////////////////////////////////////////////////
void _MDrv_PM_SetSRAMOffsetForMCU(void)
{
    MS_U32 u32BaseAddr, u32BaseSize;
    if(!MDrv_MMIO_GetBASE(&u32BaseAddr, &u32BaseSize, MS_MODULE_PM))
    {
...
/// @param pStatus      \b Out: non
////////////////////////////////////////////////////////////////////////////////
void _MDrv_PM_SetDRAMOffsetForMCU(MS_U32 u32Offset)
{
    ...
    HAL_PM_SetDRAMOffsetForMCU(u32Offset);
...
////////////////////////////////////////////////////////////////////////////////
PM_WakeupSource _MDrv_PM_GetWakeupSource(void)
{
...
////////////////////////////////////////////////////////////////////////////////
MS_U8 _MDrv_PM_GetWakeupKey(void)
{
...
PM_Result MDrv_PM_GetExtraSramData(PM_ExtraSramData *pPmExtraSramData)
{
    ...
    MS_U32 MBX_Resendcnt = 0;
    PM_ExtraSramData *pPmExtraSramDataVA = (PM_ExtraSramData*)_PA2VA((MS_U32)pPmExtraSramData);
    ...
    u32SrcAddr = (MS_U32)pPmExtraSramData;
...
/// @return @ref PM_Result
////////////////////////////////////////////////////////////////////////////////
PM_Result _MDrv_PM_Disable51(void)
{
#if defined(__mips__) || defined(__arm__)


    MS_U32 u32BaseAddr = 0, u32BaseSize = 0;
...
PM_Result MDrv_PM_PWM_Init(MS_U8 u8PWM)
{
    ...
    // send to PM51
    {
        ...
        MB_Command.u8Parameters[0] =  (MS_U8)(u32SrcAddr&0x000000FF);
...
PM_Result MDrv_PM_PWM_IRRecord_Receive_Require(MS_U32 u32BufferAddr,MS_U16 u16BufferSize)
{
    ...
    PM_DBG_FUNC();
    memset((void*)&MB_Command, 0, sizeof(MBX_Msg));
    u32SrcAddr = (MS_U32)u32BufferAddr;
    ...
    // send to PM51
    {
        ...
        MB_Command.u8Parameters[5] =  (MS_U8)(u16BufferSize&0x00FF);
...
void MDrv_PM_RunTimePM_Disable_PassWord(void)
{
    ...
    HAL_PM_SetIOMapBase(u32BaseAddr);
    PM_DBG_STR(printf("[RT_PM] Start Write PM Run Time PassWord!\n"));
    PM_DBG_STR(printf("[Send] 0x0EAA = %x\n",HAL_PM_Read2Byte(0x0EAA)));
    HAL_PM_SetScratchPad(4,0xBABE);
    PM_DBG_STR(printf("[End] 0x0EAA = %x\n",HAL_PM_Read2Byte(0x0EAA)));
    PM_DBG_STR(printf("Wait for PM51 Ideal ...........\n"));
    do
    {
    ...
    while(u16Val != 0xAAAA);
    PM_DBG_STR(printf("[RT_PM] End  Write PM Run Time PassWord!\n"));
}
...
{
    PM_DBG_STR(printf("[PM] MDrv_PM_STR_CheckFactoryPowerOnMode\n"));
    HAL_PM_SetScratchPad(4,0xBBBB);
    PM_DBG_STR(printf("[PM] STR memory factory need AC ON\n"));
}
...
/// @return  none
//-------------------------------------------------------------------------------------------------
PM_Result _MDrv_PM_Check_Version(MS_BOOL bCheck)
{
    MS_U8 u8Val = 0;
    MS_BOOL bRet;
    if(bCheck)
...
MS_U16 _MDrv_PM_GetSRAMSize(void)
{   
    return HAL_PM_GetSRAMSize();

}

MS_U8 _MDrv_PM_GetIRPowerOnKey(void)
{
    return HAL_PM_GetIRPowerOnKey();
}

//2016.08.18 hank added start
void MDrv_PM_SPI(MS_BOOL bEN)
{
    MS_U32 u32BaseAddr = 0, u32BaseSize = 0;
...
//2016.08.18 hank added end

//2016.08.22 kelvin added start
void MDrv_PM_WholeChipReset(void)
{
    MS_U32 u32BaseAddr = 0, u32BaseSize = 0;
    ...
    HAL_PM_WholeChipReset();
}
//2016.08.22 kelvin added end

#if (PM_UTOPIA20)
// below are utopia10 interface and will call to utopia20 core
MS_BOOL _MDrv_PM_CheckUtopia20Open(void** pInstance, MS_U32 u32ModuleVersion, void* pAttribute)
{
    if (FALSE == bU20PMOpened)
    {
        if(UtopiaOpen(MODULE_PM | KERNEL_MODE, pInstance, u32ModuleVersion, pAttribute) != UTOPIA_STATUS_SUCCESS)
        {
            printf("Open PM fail\n");
    		return FALSE;
        }
...
#if (PM_UTOPIA20)
    MS_U32 u32Ret;
    PM_PRIVATE_PARAM_RtcInit PmParam_RtcInit;
    if (FALSE == _MDrv_PM_CheckUtopia20Open(&pInstantPm, 0, pAttributePm))
        return 0;	
    u32Ret = UtopiaIoctl(pInstantPm,MDrv_CMD_PM_RtcInit,(MS_U32*) &PmParam_RtcInit);
    return (PM_Result)u32Ret;    
#else
     return _MDrv_PM_RtcInit(pPmParam_RtcInit);
#endif			
}
...
#if (PM_UTOPIA20)
    MS_U32 u32Ret;
    PM_PRIVATE_PARAM_RtcSetCounter PmParam_RtcSetCounter;
    if (FALSE == _MDrv_PM_CheckUtopia20Open(&pInstantPm, 0, pAttributePm))
        return 0;	
    u32Ret = UtopiaIoctl(pInstantPm,MDrv_CMD_PM_RtcSetCounter,(MS_U32*) &PmParam_RtcSetCounter);
    return (PM_Result)u32Ret;    
#else
     return _MDrv_PM_RtcSetCounter(pPmParam_RtcSetCounter);
#endif		
}
...
#if (PM_UTOPIA20)
    MS_U32 u32Ret;
    PM_PRIVATE_PARAM_RtcGetCounter PmParam_RtcGetCounter;
    if (FALSE == _MDrv_PM_CheckUtopia20Open(&pInstantPm, 0, pAttributePm))
        return 0;	
    u32Ret = UtopiaIoctl(pInstantPm,MDrv_CMD_PM_RtcGetCounter,(MS_U32*) &PmParam_RtcGetCounter);
    return (PM_Result)u32Ret;    
#else
     return _MDrv_PM_RtcGetCounter(pPmParam_RtcGetCounter);
#endif		
}
...
#if (PM_UTOPIA20)
    MS_U32 u32Ret;
    PPM_PRIVATE_PARAM_RtcSetMatchCounter pPmParam_RtcSetMatchCounter = NULL;
    if (FALSE == _MDrv_PM_CheckUtopia20Open(&pInstantPm, 0, pAttributePm))
        return 0;	
    u32Ret = UtopiaIoctl(pInstantPm,MDrv_CMD_PM_RtcSetMatchCounter,(MS_U32*)pPmParam_RtcSetMatchCounter);
    free(pPmParam_RtcSetMatchCounter);
    return (PM_Result)u32Ret;    
#else
     return _MDrv_PM_RtcSetMatchCounter(pPmParam_RtcSetMatchCounter);
#endif		
}
...
#if (PM_UTOPIA20)
    MS_U32 u32Ret;
    PPM_PRIVATE_PARAM_RtcGetMatchCounter pPmParam_RtcGetMatchCounter = NULL;
    if (FALSE == _MDrv_PM_CheckUtopia20Open(&pInstantPm, 0, pAttributePm))
        return 0;	
    u32Ret = UtopiaIoctl(pInstantPm,MDrv_CMD_PM_RtcGetMatchCounter,(MS_U32*)pPmParam_RtcGetMatchCounter);
    free(pPmParam_RtcGetMatchCounter);
    return (MS_BOOL)u32Ret;    
#else
     return _MDrv_PM_RtcGetMatchCounter(pPmParam_RtcGetMatchCounter);
#endif		
}
...
{
#if (PM_UTOPIA20)
    PM_PRIVATE_PARAM_SetSPIOffsetForMCU PmParam_SetSPIOffsetForMCU;
    if (FALSE == _MDrv_PM_CheckUtopia20Open(&pInstantPm, 0, pAttributePm))
        return ;	
    UtopiaIoctl(pInstantPm,MDrv_CMD_PM_SetSPIOffsetForMCU,(MS_U32*) &PmParam_SetSPIOffsetForMCU);
#else
    _MDrv_PM_SetSPIOffsetForMCU(BANK);
#endif		
}
...
void MDrv_PM_SetSRAMOffsetForMCU(void)
{
    ...
    if (FALSE == _MDrv_PM_CheckUtopia20Open(&pInstantPm, 0, pAttributePm))
        return ;	
    UtopiaIoctl(pInstantPm,MDrv_CMD_PM_SetSRAMOffsetForMCU,(MS_U32*)NULL);
#else
    _MDrv_PM_SetSRAMOffsetForMCU();
#endif	
}
...
{
#if (PM_UTOPIA20)
    PM_PRIVATE_PARAM_SetDRAMOffsetForMCU PmParam_SetDRAMOffsetForMCU;
    if (FALSE == _MDrv_PM_CheckUtopia20Open(&pInstantPm, 0, pAttributePm))
        return ;	
    UtopiaIoctl(pInstantPm,MDrv_CMD_PM_SetDRAMOffsetForMCU,(MS_U32*) &PmParam_SetDRAMOffsetForMCU);
#else
    _MDrv_PM_SetDRAMOffsetForMCU(u32Offset);
#endif		
}
...
PM_WakeupSource MDrv_PM_GetWakeupSource(void)
{
    ...
    if (FALSE == _MDrv_PM_CheckUtopia20Open(&pInstantPm, 0, pAttributePm))
        return 0;	
    u32Ret=UtopiaIoctl(pInstantPm,MDrv_CMD_PM_GetWakeupSource,(MS_U32*)NULL);
    return (PM_WakeupSource)u32Ret;
#else
    return _MDrv_PM_GetWakeupSource();
#endif			
}
...
MS_U8 MDrv_PM_GetWakeupKey(void)
{
    ...
    if (FALSE == _MDrv_PM_CheckUtopia20Open(&pInstantPm, 0, pAttributePm))
        return 0;	
    u32Ret=UtopiaIoctl(pInstantPm,MDrv_CMD_PM_GetWakeupKey,(MS_U32*)NULL);
    return (MS_U8)u32Ret;
#else
    return _MDrv_PM_GetWakeupKey();
#endif		
} 
...
PM_Result MDrv_PM_Disable51(void)
{
    ...
    if (FALSE == _MDrv_PM_CheckUtopia20Open(&pInstantPm, 0, pAttributePm))
        return 0;	
    u32Ret=UtopiaIoctl(pInstantPm,MDrv_CMD_PM_Disable51,(MS_U32*)NULL);
    return (PM_Result)u32Ret;
#else
    return _MDrv_PM_Disable51();
#endif		
} 
...
#if (PM_UTOPIA20)
    MS_U32 u32Ret;
    PPM_PRIVATE_PARAM_Check_Version pPmParam_Check_Version = NULL;
    if (FALSE == _MDrv_PM_CheckUtopia20Open(&pInstantPm, 0, pAttributePm))
        return 0;	
    u32Ret = UtopiaIoctl(pInstantPm,MDrv_CMD_PM_Check_Version,(MS_U32*)pPmParam_Check_Version);
    free(pPmParam_Check_Version);
    return (PM_Result)u32Ret;    
#else
     return _MDrv_PM_Check_Version(bCheck);
#endif		
}    
...
MS_U16 MDrv_PM_GetSRAMSize(void)
{
    ...
    if (FALSE == _MDrv_PM_CheckUtopia20Open(&pInstantPm, 0, pAttributePm))
        return 0;	
    u32Ret=UtopiaIoctl(pInstantPm,MDrv_CMD_PM_GetSRAMSize,(MS_U32*)NULL);
    return (MS_U16)u32Ret;
#else
    return _MDrv_PM_GetSRAMSize();
#endif		
}     
...
MS_U8 MDrv_PM_GetIRPowerOnKey(void)
{
    ...
    if (FALSE == _MDrv_PM_CheckUtopia20Open(&pInstantPm, 0, pAttributePm))
        return 0;	
    u32Ret=UtopiaIoctl(pInstantPm,MDrv_CMD_PM_GetIRPowerOnKey,(MS_U32*)NULL);
    return (MS_U8)u32Ret;
#else
    return _MDrv_PM_GetIRPowerOnKey();
#endif		
}     
       

void MDrv_PM_ResetWakeUpFlag(void)
{
    PM51_WAKEUP_FLAG = 0;
}

void _MDrv_PM_LoadWakeUp51(void)
{
    
    if(PM51_WAKEUP_FLAG == 1)
        return;

    PM51_WAKEUP_FLAG = 1;

    printf("[_MDrv_PM_LoadWakeUp51]!!!!!  \n");

    MDrv_BDMA_LoadPM2SRAM(); //load PM51 to SRAM

    _MDrv_PM_SetSRAMOffsetForMCU(); //wakeup 51 from SRAM

}

void MDrv_PM_LoadWakeUp51_Internal(void)
{
    _MDrv_PM_LoadWakeUp51();
}


void MDrv_PM_DisablePM51_Internal(void)
{
    _MDrv_PM_Disable51();
}  

void MDrv_PM_LoadWakeUp51(void)
{
#if (PM_UTOPIA20)
    MS_U32 u32Ret;
    ...
    u32Ret=UtopiaIoctl(pInstantPm,MDrv_CMD_PM_LoadWakeUp51,(MS_U32*)NULL);
