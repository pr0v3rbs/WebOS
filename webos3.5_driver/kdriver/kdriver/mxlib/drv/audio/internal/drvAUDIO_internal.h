...
typedef struct
{
    ...
    // [LM14]
    MS_BOOL bMP3EncodeDebug;
    DOLBY_DRC_MODE g_drcMode_adec1;
    DOLBY_DRC_MODE g_drcMode_adec2;

    MS_U8 g_u8PcmMixerInitFlag;
    MS_U32 g_u32PcmMixerMaxElement;
    MS_U32 g_u32PcmMixerMaxGroup;
    MS_U32 g_u32PcmMixerElementInfoBase;
    MS_U32 g_u32PcmMixerElementBufferBase;
    MS_U32 g_u32PcmMixerElementBufferSize;
    MS_U32 g_u32PcmMixer1MixedBufferBase;
    MS_U32 g_u32PcmMixer2MixedBufferBase;
    MS_U32 g_u32PcmMixerMixedBufferSize;

    // [LM15]
    MS_BOOL g_bR2Adec1AD;
    MS_BOOL g_bR2Adec2AD;
    MS_U8   g_R2_NonPcm_Sel;
    MS_U8   g_Pre_R2_NonPcm_Sel;
    MS_BOOL g_bATVExist;
    MS_BOOL g_bPreNotMM_Flag;//morris temp
    MS_BOOL g_bTrickPlay;

    MS_BOOL g_bNonPCMMixedSystemSound;

    MS_BOOL g_bAdec1TVMute;
    MS_BOOL g_bAdec2TVMute;
    MS_BOOL g_bAdec1GSTMute;
    MS_BOOL g_bAdec2GSTMute;
} AUDIO_SHARED_VARS2;
