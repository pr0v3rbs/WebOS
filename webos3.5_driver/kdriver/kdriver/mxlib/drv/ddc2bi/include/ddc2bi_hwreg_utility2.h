...
//  Macro and Define
//-------------------------------------------------------------------------------------------------
extern MS_U32 DDC2BI_RIU_BASE;      // This should be inited before XC library starting.
...
#define RIU_READ_BYTE(addr)         ( READ_BYTE( DDC2BI_RIU_BASE + (addr) ) )
#define RIU_READ_2BYTE(addr)        ( READ_WORD( DDC2BI_RIU_BASE + (addr) ) )
#define RIU_WRITE_BYTE(addr, val)   { WRITE_BYTE( DDC2BI_RIU_BASE + (addr), val) }
#define RIU_WRITE_2BYTE(addr, val)  { WRITE_WORD( DDC2BI_RIU_BASE + (addr), val) }
