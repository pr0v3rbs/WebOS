...
#define E_DRVTSP_FLT_TYPE_AUDIO3        0x0000000A
#define E_DRVTSP_FLT_TYPE_AUDIO4        0x0000000B
...
#define E_DRVTSP_FLT_MASK                       	0xF2FC0F00
#define E_DRVTSP_FLT_SOURCE_TYPE_MASK           0xC0FC0000
...
#define E_DRVTSP_FLT_SOURCE_TYPE_FILE1          0x00100000                   // file1 fource from TS1
#define E_DRVTSP_FLT_SOURCE_TYPE_FILE2          0x00080000                   // file2 fource from TS2
#define E_DRVTSP_FLT_SOURCE_TYPE_LIVEB			E_DRVTSP_FLT_SOURCE_TYPE_FILE

// Source ID define.  For merge stream
#define E_DRVTSP_FLT_SOURCEID_SHIFT                	8
#define E_DRVTSP_FLT_SOURCEID_MASK                	0x00000F00

#define E_DRVTSP_FLT_TYPE_DUPSEC                0x02000000                   // Only for section filter duplicate patch
...
typedef enum //_DrvTSP_FltState
{
    ...
    E_DRVTSP_FLT_STATE_CBRUN          = 0x40000000,                                                 // Callback processing
    E_DRVTSP_FLT_STATE_FREEING        = 0x80000000,                                                 // Free filter is  running
...
#define E_DRVTSP_OUTPAD_MODE_MASK       0x30000000UL
...
typedef enum
{
    ...
    /// TSP Engine 0 Video3D PES Only
    E_DRVTSP_FILEIN_MODE_ENG0_A3PES  = 0x00000040,                                                 //TSP_TSDMA_CTRL_A3PES0
    /// TSP Engine 0 Video3D PES Only
    E_DRVTSP_FILEIN_MODE_ENG0_A4PES  = 0x00000080,                                                 //TSP_TSDMA_CTRL_A4PES0
