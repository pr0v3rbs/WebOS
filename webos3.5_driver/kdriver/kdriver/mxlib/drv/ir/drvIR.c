...
const IR_DrvInfo* MDrv_IR_GetInfo(void)
{
    ...
    //(1) set address to get final result
    #ifdef MSOS_TYPE_LINUX
    u32SrcAddr = (MS_U32)pIRDrvInfo;
    #else
    u32SrcAddr = (MS_U32)&gIRDrvInfo;
    #endif
...
MS_U32 IROpen(void** ppInstance, MS_U32 u32ModuleVersion, void* pAttribute)
{
    ...
    {
        //printf("\033[35mFunction = %s, Line = %d, ERROR, DRV_VERSION is not IR_VERSION\033[m\n", __PRETTY_FUNCTION__, __LINE__);
        //return FALSE;
    }
