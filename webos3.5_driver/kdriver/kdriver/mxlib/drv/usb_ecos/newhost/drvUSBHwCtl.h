...
extern void ms_UTMI_ORXBYTE_EX(MS_U8 offset,MS_U8 val, MS_U32 base);
extern void ms_UTMI_ANDXBYTE_EX(MS_U8 offset,MS_U8 val, MS_U32 base);
extern void ms_UTMI_SETXBYTE_EX(MS_U8 offset,MS_U8 val, MS_U32 base);
extern MS_U8 ms_UTMI_READXBYTE_EX(MS_U8 offset, MS_U32 base);
extern void ms_ehci_interrupt_enable (struct usb_hcd *hcd);
extern void ms_ehci_interrupt_disable (struct usb_hcd *hcd);
extern void ms_ResetMstarUsb(struct usb_hcd *hcd);
extern BOOL ms_RoothubPortConnected(struct usb_hcd *hcd);
extern BOOL ms_isHcdRunning(struct usb_hcd *hcd);
