...
#define E_DRVTSP_FLT_TYPE_PVR1          E_TSP_FLT_FIFO_PVR2
#define E_DRVTSP_FLT_TYPE_VIDEO3D       E_TSP_FLT_FIFO_VIDEO3D
#define E_DRVTSP_FLT_TYPE_REC           E_TSP_FLT_FIFO_REC                      // this is for MApi_DMX_Open flt type
...
#define E_DRVTSP_FLT_SOURCE_TYPE_LIVE   E_TSP_FLT_SRC_TSIF0
#define E_DRVTSP_FLT_SOURCE_TYPE_FILE   E_TSP_FLT_SRC_FILE
...
typedef enum
{
    E_DRVTSP_IF_PLAYBACK            =   0x0,
    E_DRVTSP_IF_PVR0                =   0x1,
    E_DRVTSP_IF_PVR1                =   0x2,
    E_DRVTSP_IF_PVR2                =   0x3,
    E_DRVTSP_IF_PVR3                =   0x4,
    E_DRVTSP_IF_PVR4                =   0x5,
    E_DRVTSP_IF_PVR5                =   0x6,
...
#define E_DRVTSP_CAP_FILTER_NUM     E_TSP_CAP_PIDFLT_NUM
...
#define MDrv_TSP_SetSTC                         MDrv_TSP_FILE_CmdSTC
...
#define MDrv_TSP_BurstLen(p...)                 MDRV_TSP_FAIL_NOT_SUPPORTED()
