...
typedef MS_BOOL                         (*IOCTL_MVOP_SETBASEADD)                                 (void*, MS_U32, MS_U32, MS_BOOL, MS_BOOL);
...
typedef void                         (*IOCTL_MVOP_GETBASEADD)                                 (void*, MS_U32*, MS_U32*);
...
typedef MS_BOOL                         (*IOCTL_MVOP_SUBSETBASEADD)                                 (void*, MS_U32, MS_U32, MS_BOOL, MS_BOOL);
...
typedef void                         (*IOCTL_MVOP_SUBGETBASEADD)                             (void*, MS_U32*, MS_U32*);
...
typedef struct
{
    ...
    //IOCTL_MVOP_SETPOWERSTATE                        fpMVOP_SetPowerState;
