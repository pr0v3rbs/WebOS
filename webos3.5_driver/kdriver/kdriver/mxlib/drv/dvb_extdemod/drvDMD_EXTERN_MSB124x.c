...
#endif
static MS_BOOL bDMD_MSB124X_Power_init_en = FALSE;
static MS_U8 u8DMD_MSB124X_PowerOnInitialization_Flow = 0;
static MS_U8 u8DMD_MSB124X_Sdram_Code = 0x0;
static MS_U8 u8DMD_MSB124X_Sram_Code  = 0x0;
static sDMD_MSB124X_InitData _sDMD_MSB124X_InitData;
static eDMD_MSB124X_DbgLv eDMD_MSB124X_DbgLevel=E_DMD_MSB124X_DBGLV_NONE;
static eDMD_MSB124X_DemodulatorType  eDMD_MSB124X_CurrentDemodulatorType=E_DMD_MSB124X_DEMOD_DVBT;
...
MS_BOOL MDrv_DMD_MSB124X_Init(sDMD_MSB124X_InitData *pDMD_MSB124X_InitData, MS_U32 u32InitDataLen)
{
    ...
    if (_s32DMD_Mutex != -1)
    {
        DMD_DBG(printf("MDrv_DMD_MSB124X_Init more than once\n"));
        return FALSE;
    }
    ...
    _s32DMD_Mutex = MsOS_CreateMutex(E_MSOS_FIFO, pDMD_MSB124X_MutexString, MSOS_PROCESS_SHARED);
    if (_s32DMD_Mutex == -1)
    {
    ...
    DMD_LOCK();
    if ( sizeof(_sDMD_MSB124X_InitData) == u32InitDataLen)
    {
        memcpy(&_sDMD_MSB124X_InitData, pDMD_MSB124X_InitData, u32InitDataLen);
    }
    else
    {
    ...
    if (_sDMD_MSB124X_InitData.pDVBC_DSP_REG!= NULL)
    {
        printf("MDrv_DMD_MSB124X_Init Init DVBC DSP Table By Device Driver ... \n");
        
        memcpy (&MSB124X_DVBC_DSPREG_TABLE[0],_sDMD_MSB124X_InitData.pDVBC_DSP_REG ,sizeof(MSB124X_DVBC_DSPREG_TABLE));
    }
    else
    {
        printf("MDrv_DMD_MSB124X_Init Init DVBC DSP Table By Device Driver ... \n");
    ...
    if (_sDMD_MSB124X_InitData.pDVBT_DSP_REG!= NULL)
    {
        printf("MDrv_DMD_MSB124X_Init Init DVBT DSP Table By Device Driver ... \n");
        
        memcpy (&MSB124X_DVBT_DSPREG_TABLE[0],_sDMD_MSB124X_InitData.pDVBT_DSP_REG ,sizeof(MSB124X_DVBT_DSPREG_TABLE));
    }
    else
    {
        printf("MDrv_DMD_MSB124X_Init Init DVBT DSP Table By Device Driver ... \n");
    ...
    if (_sDMD_MSB124X_InitData.pDVBT2_DSP_REG!= NULL)
    {
        printf("MDrv_DMD_MSB124X_Init Init DVBT2 DSP Table By Device Driver ... \n");
        
        memcpy (&MSB124X_DVBT2_DSPREG_TABLE[0],_sDMD_MSB124X_InitData.pDVBT2_DSP_REG ,sizeof(MSB124X_DVBT2_DSPREG_TABLE));
    }
    else
    {
        printf("MDrv_DMD_MSB124X_Init Init DVBT2 DSP Table By Device Driver ... \n");
...
static MS_BOOL _MDrv_DMD_MSB124X_GetReg(MS_U16 u16Addr, MS_U8 *pu8Data)
{
    ...
    u8MsbData[0] = 0x35;
    (*_sDMD_MSB124X_InitData.fpMSB124X_I2C_Access)(E_DMD_MSB124X_DEMOD_I2C_DYNAMIC_SLAVE_ID_1, E_DMD_MSB124X_DEMOD_I2C_WRITE_BYTES, 0, NULL, 1, u8MsbData);
    
    u8MsbData[0] = 0x10;
    (*_sDMD_MSB124X_InitData.fpMSB124X_I2C_Access)(E_DMD_MSB124X_DEMOD_I2C_DYNAMIC_SLAVE_ID_1, E_DMD_MSB124X_DEMOD_I2C_WRITE_BYTES, 0, NULL, 5, u8MsbData);
    (*_sDMD_MSB124X_InitData.fpMSB124X_I2C_Access)(E_DMD_MSB124X_DEMOD_I2C_DYNAMIC_SLAVE_ID_1, E_DMD_MSB124X_DEMOD_I2C_READ_BYTES, 0, NULL, 1, pu8Data);
    
    u8MsbData[0] = 0x34;
    bRet=(*_sDMD_MSB124X_InitData.fpMSB124X_I2C_Access)(E_DMD_MSB124X_DEMOD_I2C_DYNAMIC_SLAVE_ID_1, E_DMD_MSB124X_DEMOD_I2C_WRITE_BYTES, 0, NULL, 1, u8MsbData);
...
static MS_BOOL _MDrv_DMD_MSB124X_SetReg(MS_U16 u16Addr, MS_U8 u8Data)
{
    ...
    u8MsbData[0] = 0x10;
    (*_sDMD_MSB124X_InitData.fpMSB124X_I2C_Access)(E_DMD_MSB124X_DEMOD_I2C_DYNAMIC_SLAVE_ID_1, E_DMD_MSB124X_DEMOD_I2C_WRITE_BYTES, 0, NULL, 6, u8MsbData);
...
static MS_BOOL _MDrv_DMD_MSB124X_SetRegs(MS_U16 u16Addr, MS_U8* u8pData, MS_U16 data_size)
{
    ...
    bRet &= (*_sDMD_MSB124X_InitData.fpMSB124X_I2C_Access)(E_DMD_MSB124X_DEMOD_I2C_DYNAMIC_SLAVE_ID_1, E_DMD_MSB124X_DEMOD_I2C_WRITE_BYTES, 0, NULL, 1, u8MsbDataValue);

    u8MsbDataValue[0] = 0x10;
    bRet &= (*_sDMD_MSB124X_InitData.fpMSB124X_I2C_Access)(E_DMD_MSB124X_DEMOD_I2C_DYNAMIC_SLAVE_ID_1, E_DMD_MSB124X_DEMOD_I2C_WRITE_BYTES, 0, NULL, 5 + data_size, u8MsbDataValue);
...
static MS_BOOL _MSB124X_I2C_CH_Reset(MS_U8 ch_num)
{
    ...
    u8data[0] = 0x71;
    bRet &= (*_sDMD_MSB124X_InitData.fpMSB124X_I2C_Access)(E_DMD_MSB124X_DEMOD_I2C_DYNAMIC_SLAVE_ID_1, E_DMD_MSB124X_DEMOD_I2C_WRITE_BYTES, 0, NULL, 1, u8data);
...
// $display("--------Initial DRAM start here!!!");
    ...
    // [4]	    reg_ts_err_pol	1: inverse 0:normal
     bRet &= _MDrv_DMD_MSB124X_SetReg2Bytes(0x0900+(0x2e)*2, 0x0001);
...
static MS_BOOL _LoadDspCodeToSDRAM_Boot(void)
{
    ...
    if(!(u8DMD_MSB124X_Sdram_Code&MSB124X_BOOT))
    {
        if(sizeof(MSB124X_LIB) > MSB124X_BOOT_START_ADDR)
        {
            ...
            if(bRet == true)
            {
                u8DMD_MSB124X_Sdram_Code |= MSB124X_BOOT;
            }
        }
        else
        {
...
static MS_BOOL _LoadDspCodeToSDRAM_dvbt2(void)
{
    ...
    if( !(u8DMD_MSB124X_Sdram_Code&MSB124X_DVBT2) )
    {
        if(sizeof(MSB124X_LIB) > MSB124X_DVBT2_P1_START_ADDR)
        {
            ...
            if(bRet == true)
            {
                u8DMD_MSB124X_Sdram_Code |= MSB124X_DVBT2;
            }
        }
        else
        {
...
static MS_BOOL _LoadDspCodeToSDRAM_dvbt(void)
{
    ...
    if(!(u8DMD_MSB124X_Sdram_Code&MSB124X_DVBT))
    {
        // dvbt code
        if(sizeof(MSB124X_LIB) > MSB124X_DVBT_START_ADDR)
        {
         ...
         if(bRet == true)
         {
             u8DMD_MSB124X_Sdram_Code |= MSB124X_DVBT;
         }
        }
        else
        {
...
static MS_BOOL _LoadDspCodeToSDRAM_dvbc(void)
{
    ...
    if(!(u8DMD_MSB124X_Sdram_Code&MSB124X_DVBC))
    {
        // dvbc code
        if(sizeof(MSB124X_LIB) > MSB124X_DVBC_START_ADDR)
        {
            ...
            if(bRet == true)
            {
               u8DMD_MSB124X_Sdram_Code |= MSB124X_DVBC;
            }
        }
        else
        {
...
static MS_BOOL _LoadSdram2Sram(MS_U8 CodeNum)
{
    ...
    if(CodeNum == u8DMD_MSB124X_Sram_Code)
    {
        #ifdef MS_DEBUG
...
static MS_BOOL  _DTV_DVBC_DSPReg_Init(void)
{
    ...
    {
        if( _MDrv_DMD_MSB124X_SetDSPReg(idx + 0x20, MSB124X_DVBC_DSPREG_TABLE[idx])!=TRUE)
        {
...
static MS_U8  _DTV_DVBT_DSPReg_CRC(void)
{
    ...
    {
        crc ^= MSB124X_DVBT_DSPREG_TABLE[idx];
    }
...
static MS_BOOL  _DTV_DVBT_DSPReg_Init(void)
{
    ...
    if( _MDrv_DMD_MSB124X_SetDSPReg((MS_U8)T_CONFIG_BW, MSB124X_DVBT_DSPREG_TABLE[0]) != TRUE)
    {
      printf("dvbt dsp reg init NG\n"); return FALSE;
    }
    if( _MDrv_DMD_MSB124X_SetDSPReg((MS_U8)T_CONFIG_FC_L, MSB124X_DVBT_DSPREG_TABLE[1]) != TRUE)
    {
      printf("dvbt dsp reg init NG\n"); return FALSE;
    }
    if( _MDrv_DMD_MSB124X_SetDSPReg((MS_U8)T_CONFIG_FC_H, MSB124X_DVBT_DSPREG_TABLE[2]) != TRUE)
    {
      printf("dvbt dsp reg init NG\n"); return FALSE;
    }
    if( _MDrv_DMD_MSB124X_SetDSPReg((MS_U8)T_CONFIG_TS_SERIAL, MSB124X_DVBT_DSPREG_TABLE[3]) != TRUE)
    {
      printf("dvbt dsp reg init NG\n"); return FALSE;
    }
    if( _MDrv_DMD_MSB124X_SetDSPReg((MS_U8)T_CONFIG_TS_CLK_RATE, MSB124X_DVBT_DSPREG_TABLE[4]) != TRUE)
    {
      printf("dvbt dsp reg init NG\n"); return FALSE;
    }
    if( _MDrv_DMD_MSB124X_SetDSPReg((MS_U8)T_CONFIG_TS_OUT_INV, MSB124X_DVBT_DSPREG_TABLE[5]) != TRUE)
    {
      printf("dvbt dsp reg init NG\n"); return FALSE;
    }
    if( _MDrv_DMD_MSB124X_SetDSPReg((MS_U8)T_CONFIG_TS_DATA_SWAP, MSB124X_DVBT_DSPREG_TABLE[6]) != TRUE)
    {
      printf("dvbt dsp reg init NG\n"); return FALSE;
    }
    if( _MDrv_DMD_MSB124X_SetDSPReg((MS_U8)T_CONFIG_IQ_SWAP, MSB124X_DVBT_DSPREG_TABLE[7]) != TRUE)
    {
      printf("dvbt dsp reg init NG\n"); return FALSE;
    }
    if( _MDrv_DMD_MSB124X_SetDSPReg((MS_U8)T_CONFIG_IF_INV_PWM_OUT_EN, MSB124X_DVBT_DSPREG_TABLE[8]) != TRUE)
    {
      printf("dvbt dsp reg init NG\n"); return FALSE;
    }
...
static MS_BOOL _DTV_DVBT2_DSPReg_Init(void)
{
    ...
    if( _MDrv_DMD_MSB124X_SetDSPReg((MS_U8)E_T2_BW, MSB124X_DVBT2_DSPREG_TABLE[0]) != TRUE)
    {
      printf("T2 dsp reg init NG\n"); return FALSE;
    }
    if( _MDrv_DMD_MSB124X_SetDSPReg((MS_U8)E_T2_FC_L, MSB124X_DVBT2_DSPREG_TABLE[1]) != TRUE)
    {
      printf("T2 dsp reg init NG\n"); return FALSE;
    }
    if( _MDrv_DMD_MSB124X_SetDSPReg((MS_U8)E_T2_FC_H, MSB124X_DVBT2_DSPREG_TABLE[2]) != TRUE)
    {
      printf("T2 dsp reg init NG\n"); return FALSE;
    }
    if( _MDrv_DMD_MSB124X_SetDSPReg((MS_U8)E_T2_TS_SERIAL, MSB124X_DVBT2_DSPREG_TABLE[3]) != TRUE)
    {
      printf("T2 dsp reg init NG\n"); return FALSE;
    }
    if( _MDrv_DMD_MSB124X_SetDSPReg((MS_U8)E_T2_TS_CLK_RATE, MSB124X_DVBT2_DSPREG_TABLE[4]) != TRUE)
    {
      printf("T2 dsp reg init NG\n"); return FALSE;
    }
    if( _MDrv_DMD_MSB124X_SetDSPReg((MS_U8)E_T2_TS_OUT_INV, MSB124X_DVBT2_DSPREG_TABLE[5]) != TRUE)
    {
      printf("T2 dsp reg init NG\n"); return FALSE;
    }
    if( _MDrv_DMD_MSB124X_SetDSPReg((MS_U8)E_T2_TS_DATA_SWAP, MSB124X_DVBT2_DSPREG_TABLE[6]) != TRUE)
    {
      printf("T2 dsp reg init NG\n"); return FALSE;
    }
    if( _MDrv_DMD_MSB124X_SetDSPReg((MS_U8)E_T2_TS_ERR_POL, MSB124X_DVBT2_DSPREG_TABLE[7]) != TRUE)
    {
      printf("T2 dsp reg init NG\n"); return FALSE;
    }
...
static MS_BOOL _LoadDSPCode(void)
{
    ...
    switch(eDMD_MSB124X_CurrentDemodulatorType)
    {
    ...
    if(_sDMD_MSB124X_InitData.u8WO_SPI_Flash == 1)
    {
...
static MS_BOOL _msb124x_flash_mode_en(void)
{
    ...
    do{
        ...
        // 8'hb2(SRID)->8,h53(PWD1)->8,h45(PWD2)->8,h52(PWD3)->8,h44(PWD4)->8,h42(PWD5)
        data[0] = 0x53;
        bRet &= (*_sDMD_MSB124X_InitData.fpMSB124X_I2C_Access)(E_DMD_MSB124X_DEMOD_I2C_DYNAMIC_SLAVE_ID_1, E_DMD_MSB124X_DEMOD_I2C_WRITE_BYTES, 0, NULL, 5, data);

        // 8'hb2(SRID)->8,h71(CMD)  //TV.n_iic_
        data[0] = 0x71;
        bRet &= (*_sDMD_MSB124X_InitData.fpMSB124X_I2C_Access)(E_DMD_MSB124X_DEMOD_I2C_DYNAMIC_SLAVE_ID_1, E_DMD_MSB124X_DEMOD_I2C_WRITE_BYTES, 0, NULL, 1, data);
    ...
    */
        ...
        u8MsbData[0] = 0x10;
        bRet &= (*_sDMD_MSB124X_InitData.fpMSB124X_I2C_Access)(E_DMD_MSB124X_DEMOD_I2C_DYNAMIC_SLAVE_ID_1, E_DMD_MSB124X_DEMOD_I2C_WRITE_BYTES, 0, NULL, 5, u8MsbData);
        bRet &= (*_sDMD_MSB124X_InitData.fpMSB124X_I2C_Access)(E_DMD_MSB124X_DEMOD_I2C_DYNAMIC_SLAVE_ID_1, E_DMD_MSB124X_DEMOD_I2C_READ_BYTES, 0, NULL, 1, &u8Data);
        ...
        u8MsbData[0] = 0x10;
        bRet &= (*_sDMD_MSB124X_InitData.fpMSB124X_I2C_Access)(E_DMD_MSB124X_DEMOD_I2C_DYNAMIC_SLAVE_ID_1, E_DMD_MSB124X_DEMOD_I2C_WRITE_BYTES, 0, NULL, 6, u8MsbData);
...
static MS_BOOL _msbMSB124X_flash_WRSR(MS_U8 reg)
{
    ...
    (*_sDMD_MSB124X_InitData.fpMSB124X_I2C_Access)(E_DMD_MSB124X_DEMOD_I2C_DYNAMIC_SLAVE_ID_2, E_DMD_MSB124X_DEMOD_I2C_WRITE_BYTES, 0, NULL, 5, bWriteData);

    // WREN
    bAddr[0] = 0x10;
    bWriteData[0] = 0x06;
    (*_sDMD_MSB124X_InitData.fpMSB124X_I2C_Access)(E_DMD_MSB124X_DEMOD_I2C_DYNAMIC_SLAVE_ID_2, E_DMD_MSB124X_DEMOD_I2C_WRITE_BYTES, 1, bAddr, 1, bWriteData);

    bWriteData[0] = 0x12;
    (*_sDMD_MSB124X_InitData.fpMSB124X_I2C_Access)(E_DMD_MSB124X_DEMOD_I2C_DYNAMIC_SLAVE_ID_2, E_DMD_MSB124X_DEMOD_I2C_WRITE_BYTES, 0, NULL, 1, bWriteData);

    // WRSR
    bAddr[0] = 0x10;
    bWriteData[0] = 0x01;
    bWriteData[1] = reg;
    (*_sDMD_MSB124X_InitData.fpMSB124X_I2C_Access)(E_DMD_MSB124X_DEMOD_I2C_DYNAMIC_SLAVE_ID_2, E_DMD_MSB124X_DEMOD_I2C_WRITE_BYTES, 1, bAddr, 2, bWriteData);
...
static MS_BOOL _msbMSB124X_flash_SRSR(MS_U8 *p_reg)
{
    ...
    bAddr[0] = 0x11;
    (*_sDMD_MSB124X_InitData.fpMSB124X_I2C_Access)(E_DMD_MSB124X_DEMOD_I2C_DYNAMIC_SLAVE_ID_2, E_DMD_MSB124X_DEMOD_I2C_READ_BYTES, 1, bAddr, 1, p_reg);
...
static MS_BOOL _IspCheckVer(MS_U8* pLibData, MS_BOOL* pMatch)
{
    ...
    *pMatch = true;
    ...
    MS_U8 bWriteData[5] = {0x4D, 0x53, 0x54, 0x41, 0x52};
    (*_sDMD_MSB124X_InitData.fpMSB124X_I2C_Access)(E_DMD_MSB124X_DEMOD_I2C_DYNAMIC_SLAVE_ID_1, E_DMD_MSB124X_DEMOD_I2C_WRITE_BYTES, 0, NULL, 5, bWriteData);
    ...
    bError &= (*_sDMD_MSB124X_InitData.fpMSB124X_I2C_Access)(E_DMD_MSB124X_DEMOD_I2C_DYNAMIC_SLAVE_ID_2, E_DMD_MSB124X_DEMOD_I2C_WRITE_BYTES, 1, bAddr, 4, bWriteData);

    bAddr[0] = 0x11;
    bError &= (*_sDMD_MSB124X_InitData.fpMSB124X_I2C_Access)(E_DMD_MSB124X_DEMOD_I2C_DYNAMIC_SLAVE_ID_2, E_DMD_MSB124X_DEMOD_I2C_READ_BYTES, 1, bAddr, VERSION_CODE_SIZE, bReadData);

    bWriteData[0] = 0x12;
    bError &= (*_sDMD_MSB124X_InitData.fpMSB124X_I2C_Access)(E_DMD_MSB124X_DEMOD_I2C_DYNAMIC_SLAVE_ID_2, E_DMD_MSB124X_DEMOD_I2C_WRITE_BYTES, 0, NULL, 1,  bWriteData);
...
/// crc H byte
    ...
    u8MsbData[0] = 0x10;
    (*_sDMD_MSB124X_InitData.fpMSB124X_I2C_Access)(E_DMD_MSB124X_DEMOD_I2C_DYNAMIC_SLAVE_ID_1, E_DMD_MSB124X_DEMOD_I2C_WRITE_BYTES, 0, NULL, 5, u8MsbData);
    (*_sDMD_MSB124X_InitData.fpMSB124X_I2C_Access)(E_DMD_MSB124X_DEMOD_I2C_DYNAMIC_SLAVE_ID_1, E_DMD_MSB124X_DEMOD_I2C_READ_BYTES, 0, NULL, 1, &reg);
...
static MS_BOOL _IspProcFlash(MS_U8* pLibArry, MS_U32 dwLibSize)
{
    ...
    for(dwLoop=dwStartAddr; (dwLoop < dwEndAddr); dwLoop+=PAGE_WRITE_SIZE)
    {
        ...
        while(dwTimeOut--)
        {
            ...
            bAddr[0] = 0x11;
            (*_sDMD_MSB124X_InitData.fpMSB124X_I2C_Access)(E_DMD_MSB124X_DEMOD_I2C_DYNAMIC_SLAVE_ID_2, E_DMD_MSB124X_DEMOD_I2C_READ_BYTES, 1, bAddr, 1, &bReadData);
        ...
        if(!bError)
        {
            ...
            bAddr[0] = 0x10;
            bWriteData[0] = 0x06;
            bError &= (*_sDMD_MSB124X_InitData.fpMSB124X_I2C_Access)(E_DMD_MSB124X_DEMOD_I2C_DYNAMIC_SLAVE_ID_2, E_DMD_MSB124X_DEMOD_I2C_WRITE_BYTES, 1, bAddr, 1, bWriteData);
            ...
            bError &= (*_sDMD_MSB124X_InitData.fpMSB124X_I2C_Access)(E_DMD_MSB124X_DEMOD_I2C_DYNAMIC_SLAVE_ID_2, E_DMD_MSB124X_DEMOD_I2C_WRITE_BYTES, 5, bAddr, PAGE_WRITE_SIZE, (pLibArry+dwLoop));
...
void MDrv_DMD_MSB124X_SetCurrentDemodulatorType(eDMD_MSB124X_DemodulatorType eCurrentDemodulatorType)
{
    ...
    #endif
    eDMD_MSB124X_CurrentDemodulatorType = eCurrentDemodulatorType;
}
...
MS_BOOL MDrv_DMD_MSB124X_Power_On_Initialization(void)
{
    ...
    if (_sDMD_MSB124X_InitData.bPreloadDSPCodeFromMainCHIPI2C)
    {
        DMD_UNLOCK();    
        return TRUE;
    }
    ...
    if (bDMD_MSB124X_Power_init_en == TRUE)
    {
        DMD_UNLOCK();    
        return  TRUE;
    }
    ...
    {
        bDMD_MSB124X_Power_init_en = (u8DMD_MSB124X_PowerOnInitialization_Flow == 2) ? (TRUE) : (FALSE);
    }
    ...
    else
    {
        ...
        #endif  
        if(u8DMD_MSB124X_PowerOnInitialization_Flow ==0)
        {
        ...
        {
            if(u8DMD_MSB124X_PowerOnInitialization_Flow<2)
            {
                u8DMD_MSB124X_PowerOnInitialization_Flow++;
            }
            ...
            do
            {
                ...
                if(status == FALSE)
                {
                    if (_sDMD_MSB124X_InitData.fpGPIOReset != NULL)
                    {
                        #ifdef MS_DEBUG
                        printf(">>>MSB124X: Reset Demodulator\n");
                        #endif
                        (*_sDMD_MSB124X_InitData.fpGPIOReset)(FALSE); // gptr->SetOff();
                        MsOS_DelayTaskUs(resetDemodTime*1000);          
                        (*_sDMD_MSB124X_InitData.fpGPIOReset)(TRUE); // gptr->SetOn();
...

                {
                    ...
                    if (_sDMD_MSB124X_InitData.bFlashWPEnable)
                    {
                        if (bMatch == FALSE)
                        {
