...
typedef enum
{
    E_HVD_EX_DISP_PATH_DEFAULT = 0,
    E_HVD_EX_DISP_PATH_DYNMC_DISCONNECT,
    E_HVD_EX_DISP_PATH_DYNMC_HANDLING,
    E_HVD_EX_DISP_PATH_DYNMC_CONNECTTED
}HVD_EX_DISP_PATH_CONNECT_STATUS;

typedef enum
{
    E_HVD_EX_DISPLAY_PATH_MVOP_MAIN = 0,
    E_HVD_EX_DISPLAY_PATH_MVOP_SUB,
    E_HVD_EX_DISPLAY_PATH_NONE
}HVD_EX_DISPLAY_PATH;
...
typedef enum
{
    ...
    E_HVD_EX_RET_CMA_ERROR,         ///< CMA initialization error
} HVD_EX_Result;
...
typedef enum
{
    ...
    E_HVD_EX_GFRMINFO_LAST_DISPLAY_EX,
    E_HVD_EX_GFRMINFO_DECODE_SIMPLE,
...
#ifdef VDEC3
    E_HVD_EX_GDATA_TYPE_VBBU_ADDR,
#endif
    E_HVD_EX_GDATA_TYPE_IS_DIVX_PLUS_STREAM,
    E_HVD_EX_GDATA_TYPE_VIDEO_FULL_RANGE_FLAG,
} HVD_EX_GDataType;
...
typedef enum
{
    ...
    E_HVD_EX_ERRCODE_DIVX_PLUS_UNSUPPORTED,
} HVD_EX_ErrorCode;
...
//HVD set MFcodec Mode
typedef enum
{
    E_HVD_EX_MFCODEC_DEFAULT = 0,
    E_HVD_EX_MFCODEC_FORCE_ENABLE,
    E_HVD_EX_MFCODEC_FORCE_DISABLE,
}HVD_EX_MFCodec_mode;
...
#ifdef VDEC3
    MS_PHYADDR  u32TotalBitstreamBufAddr;
    MS_U32  u32TotalBitstreamBufSize;
#endif
} HVD_EX_MemCfg;
...
void MDrv_HVD_EX_MJPEG_InitSharemem(MS_U32 u32Id, MS_U32 u32CodeBufVAddr,MS_BOOL bPreConnEnable, MS_BOOL bConnect, HVD_EX_DISPLAY_PATH   eMvopPath);
