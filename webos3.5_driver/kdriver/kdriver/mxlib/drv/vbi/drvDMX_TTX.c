...
void MDrv_DMX_TTX_RingBuffer_Reset(void)
{
    ...
    {
        printf("Ioctl MDrv_DMX_TTX_RingBuffer_Reset fail\n");  
        return;
    }
#else
    _MDrv_DMX_TTX_RingBuffer_Reset();
...
{    
    ...
    {
        printf("Ioctl MDrv_DMX_TTX_Init fail\n");  
        return FALSE;
    }
    return TRUE;
#else
...
void MDrv_DMX_TTX_SetFilterID(MS_U8 fid)
{
    ...
    {
        printf("Ioctl MDrv_DMX_TTX_SetFilterID fail\n");  
        return;
    }
#else
...
void MDrv_DMX_TTX_SetCB(DMX_CB_FN fn)
{
    ...
    {
        printf("Ioctl MDrv_DMX_TTX_SetCB fail\n");  
        return;
    }
#else
...
MS_BOOL MDrv_DMX_TTX_PacketBufferIsEmpty(void)
{
    ...
    {
        printf("Ioctl MDrv_DMX_TTX_PacketBufferIsEmpty fail\n");  
        return FALSE;
    }
...
MS_BOOL MDrv_DMX_TTX_GetPackets(MS_PHY dataAddr, MS_U32 *length)
{
    ...
    {
        //printf("Ioctl MDrv_DMX_TTX_GetPackets fail\n");  
        return FALSE;
    }
    return TRUE;
#else
...
MS_BOOL MDrv_DMX_TTX_GetPacket(MS_PHY *packetAddress)
{
    ...
    {
        //printf("Ioctl MDrv_DMX_TTX_GetPacket fail\n");  
        return FALSE;
    }
    return TRUE;
#else
...
MS_BOOL MDrv_DMX_TTX_PacketBufferIsOverflow( void )
{
    ...
    {
        printf("Ioctl MDrv_DMX_TTX_PacketBufferIsOverflow fail\n");  
        return FALSE;
    }
    return CheckTureFalse.bCheck;
#else
...
MS_U16 MDrv_DMX_TTX_PacketBufferGetNoOfOverflows( void )
{
    ...
    {
        //printf("Ioctl MDrv_DMX_TTX_PacketBufferGetNoOfOverflows fail\n");  
        return FALSE;
    }
    return GetData.data;
#else
