...
OTGH_PT_BLK_Struct  OTGH_PT_BLK_Port2 __attribute__ ((aligned (16)));
OTGH_PT_BLK_Struct  *pOTGH_PT_BLK_Port2 = (OTGH_PT_BLK_Struct*) &OTGH_PT_BLK_Port2;

void OTGH_PT_Bulk_Init_Port2(void);


extern void Init_Mass_Storage_Structure_Port2(void);
...
void OTGH_PT_Bulk_Init_Port2(void)
{
  ...
  { //<5.1>.stop Asynchronous Schedule
    ...
    while(mwHost20_USBSTS_AsynchronousStatus_Rd()>0);
     ...
     pHost20_qHD_List_Control1_Port2->bNextQHDPointer=(VirtoPhyAddr((U32)pHost20_qHD_List_Bulk0_Port2)>>5);
     pHost20_qHD_List_Bulk0_Port2->bNextQHDPointer=(VirtoPhyAddr((U32)pHost20_qHD_List_Bulk1_Port2)>>5);
     pHost20_qHD_List_Bulk1_Port2->bNextQHDPointer=(VirtoPhyAddr((U32)pHost20_qHD_List_Control0_Port2)>>5);
  ...
  wMaxPacketSize=psAttachDevice_Port2->saCD[0].sInterface[0].sED[0].bED_wMaxPacketSizeHighByte;
  wMaxPacketSize=(wMaxPacketSize<<8)+(psAttachDevice_Port2->saCD[0].sInterface[0].sED[0].bED_wMaxPacketSizeLowByte);
  pHost20_qHD_List_Bulk0_Port2->bMaxPacketSize=wMaxPacketSize;
  pHost20_qHD_List_Bulk1_Port2->bMaxPacketSize=wMaxPacketSize; //Suppose In/Out have the same Max packet Size
