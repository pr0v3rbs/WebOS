...
/*--------------------------------------------------------------------
                               PROCEDURES
--------------------------------------------------------------------*/
U8 drvUSBHost_PTP_SendOpCode_Port3(ASSIGNVAR xdata *pAssignVar,DYMNVAR xdata *pDymnVar);
void drvUSBHost_PTP_BulkInData_Port3  (ASSIGNVAR xdata *pAssignVar,DYMNVAR xdata *pDymnVar);
void drvUSBHost_PTP_Read1stBulkIn_Port3(ASSIGNVAR xdata *pAssignVar,DYMNVAR xdata *pDymnVar);
void drvUSBHost_PTP_ReadRemBulkIn_Port3(ASSIGNVAR xdata *pAssignVar,DYMNVAR xdata *pDymnVar );
U8 drvUSBHost_PTP_BulkInResponse_Port3(void);
U8 drvUSBHost_PTP_Initial_Port3(void);
//DYMNVAR *drvUSBHost_PTP_GetCurObjectInfo(void);
DYMNVAR *drvUSBHost_PTP_GetObjectInfo_Port3(U32 u32HandleNo );
...
void drvUSBHost_PTP_GetBulkIn_Port3(DYMNVAR xdata *pDymnVar);
//U32 drvUSBHost_PTP_GetFreeSpace(void);
U32 drvUSBHost_PTP_GetObjectHandleNo_Port3(U32 u32HandleIdx);
void drvUSBHost_PTP_SaveObjectHandleNo_Port3(U32 u32HandleIdx,U32 u32HandleNo);
U32 drvUSBHost_PTP_GetObjectHandles_Port3(U16 u16ObjFormat, U32 u32AssociObjHandle);
