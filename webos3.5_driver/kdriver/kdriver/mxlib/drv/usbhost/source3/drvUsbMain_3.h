...
//========================================================================================================
	...
	#define mbFUSBH200_HALFSPEEDEnable_Set()		  (mwHost20Bit_Set_Port3(0x40,BIT2))
	#define mbFUSBH200_Interrupt_OutPut_High_Set()	  (mwHost20Bit_Set_Port3(0x40,BIT3))
       #define mbFUSBH200_Interrupt_OutPut_Low_Set()     (mwHost20Bit_Clr_Port3(0x40,BIT3))
	#define mbFUSBH200_VBUS_OFF_Set()		          (mwHost20Bit_Set_Port3(0x40,BIT4))
	#define mbFUSBH200_VBUS_ON_Set()   		          (mwHost20Bit_Clr_Port3(0x40,BIT4))
	#define mbFUSBH200_VBUS_VLD_Rd()   		          (mwHost20Port_Port3(0x40)&BIT8)
...
extern U32  gUTMI3_BASE;
extern U32  gUSBC3_BASE;
