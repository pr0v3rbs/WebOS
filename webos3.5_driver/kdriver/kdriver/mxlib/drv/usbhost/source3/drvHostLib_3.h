...
extern void USB_Write_REG32_Port3(UINT8 addr,UINT32 val);
extern U32 USB_BUFFER_START_ADR_4K_ALIGN_Var_Port3;
...
//	#define mwHost20Bit_Clr(bByte,wBitNum)           (mwHost20Port(bByte)&=~wBitNum)
        #define mwHost20Port_word(bOffset)                      *((UINT16 volatile  *) ( gUHC3_BASE | bOffset))
	...
	#define mwHost20_NumPorts_Rd()		              ((mwHost20Port_Port3(0x04)&0x0000000F)

	//<4>.0x008(HCCPARAMS - Capability Parameters)
	#define mbHost20_ProgrammableFrameListFlag_Rd()		(mwHost20Bit_Rd_Port3(0x08,BIT1)) 	//Bit 1
	...
	#define mbHost20_USBCMD_ParkMode_CNT_Rd()       	      ((mwHost20Port_Port3(0x10)>>8)&0x00000003)
	#define mbHost20_USBCMD_ParkMode_CNT_Set(bValue)     	  (mwHost20Port_Port3(0x011)=(mwHost20Port_Port3(0x011)&0xFC)|(( (UINT8) bValue )<<8)  )	//Bit 8~9

	#define mbHost20_USBCMD_InterruptOnAsync_Rd()       	  (mwHost20Bit_Rd_Port3(0x10,BIT6)) 	//Bit 6
	#define mbHost20_USBCMD_InterruptOnAsync_Set()     	      (mwHost20Bit_Set_Port3(0x10,BIT6))    //Bit 6
	#define mbHost20_USBCMD_InterruptOnAsync_Clr()	          (mwHost20Bit_Clr_Port3(0x10,BIT6))	//Bit 6

	#define mbHost20_USBCMD_AsynchronousEnable_Rd()     	  (mwHost20Bit_Rd_Port3(0x10,BIT5))     //Bit 5
	#define mbHost20_USBCMD_AsynchronousEnable_Set()     	  (mwHost20Bit_Set_Port3(0x10,BIT5))    //Bit 5
	#define mbHost20_USBCMD_AsynchronousEnable_Clr()	      (mwHost20Bit_Clr_Port3(0x10,BIT5))	//Bit 5

	#define mbHost20_USBCMD_PeriodicEnable_Rd()     	      (mwHost20Bit_Rd_Port3(0x10,BIT4) )    //Bit 4
	#define mbHost20_USBCMD_PeriodicEnable_Set()     	      (mwHost20Bit_Set_Port3(0x10,BIT4))    //Bit 4
	#define mbHost20_USBCMD_PeriodicEnable_Clr()	          (mwHost20Bit_Clr_Port3(0x10,BIT4))	//Bit 4

	#define mbHost20_USBCMD_FrameListSize_Rd()	              ((mwHost20Port_Port3(0x10)>>2)&0x00000003)	   //Bit 2~3
	#define mbHost20_USBCMD_FrameListSize_Set(bValue)     	  (mwHost20Port_wr_Port3(0x10, (mwHost20Port_Port3(0x10)&0xF3)|(((UINT8)(bValue))<<2)) )	//Bit 2~3
	...
	#define mbHost20_USBCMD_HCReset_Rd()	                  (mwHost20Bit_Rd_Port3(0x10,BIT1))	   //Bit 1
	#define mbHost20_USBCMD_HCReset_Set()	                  (mwHost20Bit_Set_Port3(0x10,BIT1))   //Bit 1

	#define mbHost20_USBCMD_RunStop_Rd()	                  (mwHost20Bit_Rd_Port3(0x10,BIT0) )  //Bit 0
	#define mbHost20_USBCMD_RunStop_Set()	                  (mwHost20Bit_Set_Port3(0x10,BIT0))  //Bit 0
	#define mbHost20_USBCMD_RunStop_Clr()	                  (mwHost20Bit_Clr_Port3(0x10,BIT0))  //Bit 0
	...
	#define mwHost20_USBSTS_Rd()		                      (mwHost20Port_Port3(0x14))
	#define mwHost20_USBSTS_Set(wValue)		                  mwHost20Port_wr_Port3(0x14,wValue)

	#define mwHost20_USBSTS_AsynchronousStatus_Rd()		      (mwHost20Bit_Rd_Port3(0x15,BIT7)) 	//14->Bit 15

	#define mwHost20_USBSTS_PeriodicStatus_Rd()		          (mwHost20Bit_Rd_Port3(0x15,BIT6)) 	//Bit 14
...
//	#define mwHost20_USBSTS_HCHalted_Rd()		              (mwHost20Bit_Rd(0x14,BIT12)) 	//Bit 12
	...
	#define mwHost20_USBSTS_IntOnAsyncAdvance_Rd()		      (mwHost20Bit_Rd_Port3(0x14,BIT5)) 	//Bit 5
	#define mwHost20_USBSTS_IntOnAsyncAdvance_Set()		      (mwHost20Bit_Set_Port3(0x14,BIT5)) 	//Bit 5

	#define mwHost20_USBSTS_SystemError_Rd()		          (mwHost20Bit_Rd_Port3(0x14,BIT4) )	//Bit 4
	#define mwHost20_USBSTS_SystemError_Set()		          (mwHost20Bit_Set_Port3(0x14,BIT4)) 	//Bit 4

	#define mwHost20_USBSTS_FrameRollover_Rd()		          (mwHost20Bit_Rd_Port3(0x14,BIT3)) 	//Bit 3
	#define mwHost20_USBSTS_FrameRollover_Set()		          (mwHost20Bit_Set_Port3(0x14,BIT3)) 	//Bit 3

	#define mwHost20_USBSTS_PortChangeDetect_Rd()		      (mwHost20Bit_Rd_Port3(0x14,BIT2)) 	//Bit 2
	#define mwHost20_USBSTS_PortChangeDetect_Set()		      (mwHost20Bit_Set_Port3(0x14,BIT2)) 	//Bit 2

	#define mwHost20_USBSTS_USBError_Rd()		              (mwHost20Bit_Rd_Port3(0x14,BIT1)) 	//Bit 1
	#define mwHost20_USBSTS_USBError_Set()		              (mwHost20Bit_Set_Port3(0x14,BIT1)) 	//Bit 1

	#define mwHost20_USBSTS_CompletionOfTransaction_Rd()	  (mwHost20Bit_Rd_Port3(0x14,BIT0)) 	//Bit 0
	#define mwHost20_USBSTS_CompletionOfTransaction_Set()	  (mwHost20Bit_Set_Port3(0x14,BIT0)) 	//Bit 0

	//<6>.0x018(USBINTR - USB Interrupt Enable Register)
	#define mwHost20_USBINTR_Rd()		                      (mwHost20Port_Port3(0x18))
	#define mwHost20_USBINTR_Set(bValue)		              mwHost20Port_wr_Port3(0x18,bValue)

	#define mwHost20_USBINTR_IntOnAsyncAdvance_Rd()		      (mwHost20Bit_Rd_Port3(0x18,BIT5) )	//Bit 5
	#define mwHost20_USBINTR_IntOnAsyncAdvance_Set()		  (mwHost20Bit_Set_Port3(0x18,BIT5)) 	//Bit 5
    #define mwHost20_USBINTR_IntOnAsyncAdvance_Clr()		  (mwHost20Bit_Clr_Port3(0x18,BIT5)) 	//Bit 5

	#define mwHost20_USBINTR_SystemError_Rd()		          (mwHost20Bit_Rd_Port3(0x18,BIT4)) 	//Bit 4
	#define mwHost20_USBINTR_SystemError_Set()		          (mwHost20Bit_Set_Port3(0x18,BIT4)) 	//Bit 4
	#define mwHost20_USBINTR_SystemError_Clr()		          (mwHost20Bit_Clr_Port3(0x18,BIT4)) 	//Bit 4

	#define mwHost20_USBINTR_FrameRollover_Rd()		          (mwHost20Bit_Rd_Port3(0x18,BIT3) )	//Bit 3
	#define mwHost20_USBINTR_FrameRollover_Set()		      (mwHost20Bit_Set_Port3(0x18,BIT3)) 	//Bit 3
	#define mwHost20_USBINTR_FrameRollover_Clr()		      (mwHost20Bit_Clr_Port3(0x18,BIT3)) 	//Bit 3

	#define mwHost20_USBINTR_PortChangeDetect_Rd()		      (mwHost20Bit_Rd_Port3(0x18,BIT2) )	//Bit 2
	#define mwHost20_USBINTR_PortChangeDetect_Set()		      (mwHost20Bit_Set_Port3(0x18,BIT2)) 	//Bit 2
	#define mwHost20_USBINTR_PortChangeDetect_Clr()		      (mwHost20Bit_Clr_Port3(0x18,BIT2)) 	//Bit 2

	#define mwHost20_USBINTR_USBError_Rd()		              (mwHost20Bit_Rd_Port3(0x18,BIT1) )	//Bit 1
	#define mwHost20_USBINTR_USBError_Set()		              (mwHost20Bit_Set_Port3(0x18,BIT1)) 	//Bit 1
	#define mwHost20_USBINTR_USBError_Clr()		              (mwHost20Bit_Clr_Port3(0x18,BIT1)) 	//Bit 1

	#define mwHost20_USBINTR_CompletionOfTransaction_Rd()	  (mwHost20Bit_Rd_Port3(0x18,BIT0) )	//Bit 0
	#define mwHost20_USBINTR_CompletionOfTransaction_Set()	  (mwHost20Bit_Set_Port3(0x18,BIT0)) 	//Bit 0
	#define mwHost20_USBINTR_CompletionOfTransaction_Clr()	  (mwHost20Bit_Clr_Port3(0x18,BIT0)) 	//Bit 0
	...
	#define mwHost20_FrameIndex_Rd()		                  (mwHost20Port_Port3(0x1C)&0x00001FFF) 	//Only Read Bit0~Bit12(Skip Bit 13)
	...
	#define mwHost20_PeriodicBaseAddr_Set(wValue)		      USB_Write_REG32_Port3(0x24,wValue)
	...
	#define mwHost20_CurrentAsynchronousAddr_Set(wValue)	  USB_Write_REG32_Port3(0x28,wValue)

	//<10>.0x030(PORTSC - Port Status and Control Register(Address = 030h))
	#define mwHost20_PORTSC_Rd()		                      mwHost20Port_Port3(0x30)

//	#define mwHost20_PORTSC_LineStatus_Rd()		              ((mwHost20Port(0x30)>>10)&0x00000003)

	#define mwHost20_PORTSC_PortReset_Rd()		              mwHost20Bit_Rd_Port3(0x31,BIT0)
	#define mwHost20_PORTSC_PortReset_Set()		              mwHost20Bit_Set_Port3(0x31,BIT0)
	#define mwHost20_PORTSC_PortReset_Clr()		              mwHost20Bit_Clr_Port3(0x31,BIT0)

	#define mwHost20_PORTSC_ForceSuspend_Rd()		          mwHost20Bit_Rd_Port3(0x30,BIT7)
	#define mwHost20_PORTSC_ForceSuspend_Set()		          mwHost20Bit_Set_Port3(0x30,BIT7)

	#define mwHost20_PORTSC_ForceResume_Rd()		          mwHost20Bit_Rd_Port3(0x30,BIT6)
	#define mwHost20_PORTSC_ForceResume_Set()		          mwHost20Bit_Set_Port3(0x30,BIT6)
	#define mwHost20_PORTSC_ForceResume_Clr()		          mwHost20Bit_Clr_Port3(0x30,BIT6)

	#define mwHost20_PORTSC_EnableDisableChange_Rd()		  mwHost20Bit_Rd_Port3(0x30,BIT3)
	#define mwHost20_PORTSC_EnableDisableChange_Set()		  mwHost20Bit_Set_Port3(0x30,BIT3)

	#define mwHost20_PORTSC_EnableDisable_Rd()		          mwHost20Bit_Rd_Port3(0x30,BIT2)
	#define mwHost20_PORTSC_EnableDisable_Set()		          mwHost20Bit_Set_Port3(0x30,BIT2)
	#define mwHost20_PORTSC_EnableDisable_Clr()		          mwHost20Bit_Clr_Port3(0x30,BIT2)
	#define mwHost20_PORTSC_EnableDisable_Write_0()		          (mwHost20Port_Port3(0x30)=0x00)


	#define mwHost20_PORTSC_ConnectChange_Rd()		          mwHost20Bit_Rd_Port3(0x30,BIT1)
	#define mwHost20_PORTSC_ConnectChange_Set()		          mwHost20Bit_Set_Port3(0x30,BIT1)

	#define mwHost20_PORTSC_ConnectStatus_Rd()		          mwHost20Bit_Rd_Port3(0x30,BIT0)



	//<10>.0x034(Misc. Register(Address = 034h))
	#define mwHost20_Misc_EOF1Time_Set(bValue)		           mwHost20Port_wr_Port3(0x34, ((mwHost20Port_Port3(0x34)&0xF3)|(((U8)(bValue))<<2)) )	//Bit 2~3

	//<10>.0x034(Misc. Register(Address = 40h))
	#define mwHost20_Control_LineStatus_Rd()		       (mwHost20Port_Port3(0x40)& BIT11)
	#define mwHost20_Control_LineStatus_Set()	           (mwHost20Bit_Set_Port3(0x40,BIT11))
	#define mwHost20_Control_LineStatus_Clr()	           (mwHost20Bit_Clr_Port3(0x40,BIT11))

	#define mwOTG20_Control_HOST_SPD_TYP_Rd()		          ((mwHost20Port_Port3(0x41)>>1)&0x03)

	#define mwHost20_Control_ForceFullSpeed_Rd()		       (mwHost20Port_Port3(0x40)& BIT7)
	#define mwHost20_Control_ForceFullSpeed_Set()	           (mwHost20Bit_Set_Port3(0x40,BIT7))
	#define mwHost20_Control_ForceFullSpeed_Clr()	           (mwHost20Bit_Clr_Port3(0x40,BIT7))

	#define mwHost20_Control_ForceHighSpeed_Rd()		       (mwHost20Port_Port3(0x40)& BIT6)
	#define mwHost20_Control_ForceHighSpeed_Set()	           (mwHost20Bit_Set_Port3(0x40,BIT6))
	#define mwHost20_Control_ForceHighSpeed_Clr()	           (mwHost20Bit_Clr_Port3(0x40,BIT6))

	#define mwOTG20_Control_Phy_Reset_Set()		               (mwHost20Bit_Set_Port3(0x40,BIT5))
	#define mwOTG20_Control_Phy_Reset_Clr()		               (mwHost20Bit_Clr_Port3(0x40,BIT5))

       #define mwOTG20_Control_Half_Speed()                                 (mwHost20Bit_Set_Port3(0x40,BIT2))
...
#define flib_Host20_Allocate_QHD_Macro(x,y,z,w,u,v)                 \
   {  x->bType=y;                                       \
       ...
       x->bMaxPacketSize=v;          }
#if 0
#define flib_Host20_Allocate_QHD_Port3(x,y,z,w,u,v)                           \
{                                                                                                     \
    flib_Host20_Allocate_QHD_Macro(x,y,z,w,u,v) ;                  \
    flib_Host20_Allocate_QHD1_Port3(x);  }
#endif
...
//========================================================================================================
  ...
  extern BOOLEAN flib_OTGH_Init_Port3(UINT8 wForDevice_B);
  extern U8 flib_Host20_Close_Port3(void);
 extern BOOLEAN USB_Hub_Handle_Port3(U8 port)	;
extern U8 Usb_Hub_Port_Num_Port3(void);

  //extern UINT8 flib_Host20_ISR(void);
  extern UINT8 flib_Host20_PortBusReset_Port3(void);
  extern void flib_Host20_Suspend_Port3(void);
  extern UINT8 flib_Host20_Issue_Control_Port3 (UINT8 bEdNum,UINT8* pbCmd,UINT16 hwDataSize,UINT8* pbData);
  extern UINT8  flib_Host20_Issue_Bulk_Port3(UINT8 bArrayListNum,UINT16 hwSize,UINT32,UINT8 bDirection);
  extern UINT8 flib_Host20_Enumerate_Port3 (UINT8 bNormalEnumerate,UINT8 bAddress);
extern UINT8 _flib_Host20_Enumerate_Port3 (UINT8 bNormalEnumerate,UINT8 bAddress);
  extern UINT8 flib_Host20_Issue_Control_CBI_Port3 (UINT8* pbCmd,UINT16 hwDataSize,UINT8* pbData);

  extern void flib_DumpDeviceDescriptor_Port3 (OTGH_Descriptor_Device_Struct *sDevice);
  extern void flib_PrintDeviceInfo_Port3 (void);
  extern   void flib_PrintDeviceInfo_ByInput_Port3 (Host20_Attach_Device_Structure *psAttachDevice);
  extern void flib_Host20_TimerISR_Port3(void);
//  extern void flib_Host20_TimerEnable(UINT32 wTime_ms);
  extern void flib_Host20_InitStructure_Port3(void);
  extern qTD_Structure *flib_Host20_GetStructure_Port3(UINT8 Type);
  extern void flib_Host20_ReleaseStructure_Port3(U8 Type,U32 pwAddress);
  extern void flib_Host20_QHD_Control_Init_Port3(void);
  extern UINT8 flib_Host20_Send_qTD_Port3(qTD_Structure *spHeadqTD ,qHD_Structure *spTempqHD,U16 wTimeOutSec);
extern void flib_Host20_Allocate_QHD_Port3(qHD_Structure  *psQHTemp,UINT8 bNextType,UINT8 bAddress,UINT8 bHead,UINT8 bEndPt, UINT32 wMaxPacketSize);

  extern UINT8 flib_Host20_Issue_Control_Turbo_Port3 (UINT8 bEdNum,UINT8* pbCmd,UINT32 wDataSize,UINT32 *pwPageAddress,UINT32 wCurrentOffset);
  extern void flib_Host20_Control_Command_Request_Port3(Host20_Control_Command_Structure *pbCMD,UINT8 bmRequestType_Temp,UINT8 bRequest_Temp,UINT16 wValue_Temp,UINT16 wIndex_Temp,UINT16 wLength_Temp);
  extern void flib_DumpString_Port3 (UINT8 *pbTemp,UINT8 bSize);
  extern void  flib_Host20_Interrupt_Init_Port3(UINT8 bAddr);
  extern U8  flib_Host20_Issue_Interrupt_Port3(U32 buf,U32 hwSize);

  extern void flib_Host20_Asynchronous_Enable_Port3(void);
  extern void flib_Host20_Asynchronous_Disable_Port3(void);

  extern   UINT8 flib_OTGH_Checking_RemoteWakeUp_Port3(void);
  extern  UINT8 flib_OTGH_RemoteWakeEnable_Port3(void);
   extern void flib_Host20_StopRun_Setting_Port3(UINT8 bOption);
// extern void flib_Host20_Asynchronous_Setting(UINT8 bOption);
extern void flib_Host20_Periodic_Setting_Port3(UINT8 bOption);
//   extern void flib_Host20_TimerEnable_UnLock(UINT32 wTime_Tick);
//   extern void flib_Host20_TimerDisable_UnLock(void);

   extern void flib_Host20_RemoteWakeUp_Processing_Port3(void);

  //  extern void SetPointer_Port3(UINT16 addr, UINT32 val);
...
//void SetPointer_Port3( qHD_Structure  xdata *qhd, UINT32 val);
qTD_Structure  *GetPointer_Port3(UINT8*  ptr);
void SetPointer_Port3( UINT8 *ptr, UINT32 val);
...
//========================================================================================================
 ...
 extern  code UINT8 OTGH_GETDESCRIPTOR_DEVICE_PORT3[];
 extern  code UINT8 OTGH_GETDESCRIPTOR_CONFIG_PORT3[];
 extern  code UINT8 OTGH_SETADDRESS_PORT3[];
 extern  code  UINT8 OTGH_SETCONFIGURATION_PORT3[];
...
extern  qHD_Structure *pHost20_qHD_List_Control0_Port3;
extern  qHD_Structure *pHost20_qHD_List_Bulk0_Port3;
extern  qHD_Structure *pHost20_qHD_List_Control1_Port3;
extern  qHD_Structure *pHost20_qHD_List_Bulk1_Port3;

   extern UINT8             Host20_qTD_Manage_Port3[Host20_qTD_MAX];  //1=>Free 2=>used
//   extern UINT8             Host20_iTD_Manage[Host20_iTD_MAX];  //1=>Free 2=>used
   ...
   extern  Host20_Attach_Device_Structure xdata *psAttachDevice_Port3;
   extern volatile UINT32 wOTG_Timer_Counter;
