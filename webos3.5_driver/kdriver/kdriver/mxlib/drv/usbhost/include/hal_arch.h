...
#define CYG_HAL_OPENRISC_REG    unsigned int
#define CYG_WORD                unsigned int
#define CYG_WORD32              unsigned int
...
#ifdef __AEONR2__
    CYG_HAL_OPENRISC_REG    machi2;         // Highest 32-bits of new 32x32=64 multiplier
#endif
...
externC void cyg_hal_deliver_exception( CYG_WORD __code, CYG_ADDRWORD __data );
...
#define HAL_BREAKINST           (0x8000)    // l.trap 1 instruction
