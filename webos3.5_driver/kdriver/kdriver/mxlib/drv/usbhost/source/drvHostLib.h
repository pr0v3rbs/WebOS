...
///	#define mwHost20Port(bOffset)	                  *((U16 volatile  *) ( gUHC_BASE | bOffset))
...
///	#define mwHost20Bit_Clr(bByte,wBitNum)           (mwHost20Port(bByte)&=~wBitNum)
        #define mwHost20Port_word(bOffset)                      *((UINT16 volatile  *) ( gUHC_BASE | bOffset))
	...
	//#define mbHost20_USBCMD_FrameListSize_Set(bValue)     	  ((mwHost20Port(0x10)=((mwHost20Port(0x10)&0xF3)|(((UINT8)(bValue))<<2)))	//Bit 2~3
	#define mbHost20_USBCMD_FrameListSize_Set(bValue)     	  (mwHost20Port_wr(0x10, (mwHost20Port(0x10)&0xF3)|(((UINT8)(bValue))<<2)) )	//Bit 2~3
...
//	#define mwHost20_USBSTS_HCHalted_Rd()		              (mwHost20Bit_Rd(0x14,BIT12)) 	//Bit 12
	...
	#define mwHost20_FrameIndex_Rd()		                  (mwHost20Port(0x1C)&0x1FFF) 	//Only Read Bit0~Bit12(Skip Bit 13)
...
//	#define mwHost20_PORTSC_LineStatus_Rd()		              ((mwHost20Port(0x30)>>10)&0x00000003)
	...
	#define mwHost20_Misc_EOF1Time_Set(bValue)		           mwHost20Port_wr(0x34, ((mwHost20Port(0x34)&0xF3)|(((U8)(bValue))<<2)) )	//Bit 2~3
...
//========================================================================================================
  ...
  extern U8 flib_Host20_Close(void);
...
extern U8 Usb_Hub_Port_Num(void);
  ...
  extern UINT8 _flib_Host20_Enumerate (UINT8 bNormalEnumerate,UINT8 bAddress);
  extern UINT8 flib_Host20_Issue_Control_CBI (UINT8* pbCmd,UINT16 hwDataSize,UINT8* pbData);
...
extern void flib_Host20_ReleaseStructure(U8 Type,U32 pwAddress);
...
extern void flib_Host20_Allocate_QHD(qHD_Structure  *psQHTemp,UINT8 bNextType,UINT8 bAddress,UINT8 bHead,UINT8 bEndPt, UINT32 wMaxPacketSize);
  ...
  extern U8  flib_Host20_Issue_Interrupt(U32 buf,U32 hwSize);
...
#endif
extern  qHD_Structure *pHost20_qHD_List_Control0;
extern  qHD_Structure *pHost20_qHD_List_Bulk0;
extern  qHD_Structure *pHost20_qHD_List_Control1;
extern  qHD_Structure *pHost20_qHD_List_Bulk1;
