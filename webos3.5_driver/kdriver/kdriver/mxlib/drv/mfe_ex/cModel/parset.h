...
void GenerateSequenceParameterSet(MFE_CONFIG* pConfig, seq_parameter_set_rbsp_t *sps, int SPS_id);
void GeneratePictureParameterSet (MFE_CONFIG* pConfig, pic_parameter_set_rbsp_t *pps, seq_parameter_set_rbsp_t *sps, int PPS_id);
