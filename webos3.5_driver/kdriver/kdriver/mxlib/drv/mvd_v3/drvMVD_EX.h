...
typedef struct
{
    ...
    MS_U32           u32FBUsedSize;     ///driver internal attribute: used size
} MVD_FWCfg;
...
typedef enum
{
    ...
    E_MVD_EVENT_PTS_DISCONTINUE= BIT(14),     ///<
...
typedef struct
{
    ...
    MS_U32 u32VSize;
    MS_U32 u32Strip;
    MS_U32 u32YStartAddr;
    MS_U32 u32UVStartAddr;
}MVD_CrcIn;
