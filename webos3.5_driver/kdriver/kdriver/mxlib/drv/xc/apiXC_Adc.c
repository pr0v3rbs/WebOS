...
void MApi_XC_ADC_SetCVBSOut(MS_BOOL bEnable, E_DEST_TYPE enOutputType , INPUT_SOURCE_TYPE_t enInputPortType, MS_BOOL isDigitalSource)
{
    ...
    if(UtopiaIoctl(pu32XC_Kernel_Inst, E_XC_ADC_CMD_SETCVBSOUT, (void*)&XCArgs) != 0)
    {
...
MS_BOOL MApi_XC_ADC_IsCVBSOutEnabled(E_DEST_TYPE enOutputType)
{
    ...
    if(UtopiaIoctl(pu32XC_Kernel_Inst, E_XC_ADC_CMD_ISCVBSOUTENABLED, (void*)&XCArgs) != 0)
    {
        printf("Obtain XC engine fail\n");
        return FALSE;
    }
...
void MApi_XC_ADC_SetPcClock( MS_U16 u16Value )
{
    ...
    if(UtopiaIoctl(pu32XC_Kernel_Inst, E_XC_ADC_CMD_SETPCCLOCK, (void*)&XCArgs) != 0)
    {
        printf("Obtain XC engine fail\n");
        return;
    }
...
void MApi_XC_ADC_SetPhase(MS_U8 u8Value)
{
    ...
    if(UtopiaIoctl(pu32XC_Kernel_Inst, E_XC_ADC_CMD_SETPHASE, (void*)&XCArgs) != 0)
    {
        printf("Obtain XC engine fail\n");
        return;
    }
...
void MApi_XC_ADC_SetPhaseEx( MS_U16 u16Value )
{
    ...
    if(UtopiaIoctl(pu32XC_Kernel_Inst, E_XC_ADC_CMD_SETPHASEEX, (void*)&XCArgs) != 0)
    {
        printf("Obtain XC engine fail\n");
        return;
    }
...
MS_U16 MApi_XC_ADC_GetPhaseRange( void )
{
    ...
    if(UtopiaIoctl(pu32XC_Kernel_Inst, E_XC_ADC_CMD_GETPHASERANGE, (void*)&XCArgs) != 0)
    {
        printf("Obtain XC engine fail\n");
        return 0;
    }
...
MS_U8 MApi_XC_ADC_GetPhase( void )
{
    ...
    if(UtopiaIoctl(pu32XC_Kernel_Inst, E_XC_ADC_CMD_GETPHASE, (void*)&XCArgs) != 0)
    {
        printf("Obtain XC engine fail\n");
        return 0;
    }
...
MS_U16 MApi_XC_ADC_GetPhaseEx( void )
{
    ...
    if(UtopiaIoctl(pu32XC_Kernel_Inst, E_XC_ADC_CMD_GETPHASEEX, (void*)&XCArgs) != 0)
    {
        printf("Obtain XC engine fail\n");
        return 0;
    }
...
MS_BOOL MApi_XC_ADC_IsScartRGB(void)
{
    ...
    if(UtopiaIoctl(pu32XC_Kernel_Inst, E_XC_ADC_CMD_ISSCARTRGB, (void*)&XCArgs) != 0)
    {
        printf("Obtain XC engine fail\n");
        return FALSE;
    }
...
MS_U16 MApi_XC_ADC_GetPcClock(void)
{
    ...
    if(UtopiaIoctl(pu32XC_Kernel_Inst, E_XC_ADC_CMD_GETPCCLOCK, (void*)&XCArgs) != 0)
    {
        printf("Obtain XC engine fail\n");
        return 0;
    }
...
void MApi_XC_ADC_GetSoGLevelRange(MS_U32 *u32min, MS_U32 *u32max, MS_U32 *u32Recommend_value)
{
    ...
    if(UtopiaIoctl(pu32XC_Kernel_Inst, E_XC_ADC_CMD_GETSOGLEVELRANGE, (void*)&XCArgs) != 0)
    {
        printf("Obtain XC engine fail\n");
        return;
    }
...
void MApi_XC_ADC_SetSoGLevel(MS_U32 u32Value)
{
    ...
    if(UtopiaIoctl(pu32XC_Kernel_Inst, E_XC_ADC_CMD_SETSOGLEVEL, (void*)&XCArgs) != 0)
    {
        printf("Obtain XC engine fail\n");
        return;
    }
...
void MApi_XC_ADC_PowerOff(void)
{
    ...
    if(UtopiaIoctl(pu32XC_Kernel_Inst, E_XC_ADC_CMD_POWEROFF, NULL) != 0)
    {
        printf("Obtain XC engine fail\n");
        return;
    }
...
void MApi_XC_ADC_GetDefaultGainOffset(INPUT_SOURCE_TYPE_t enSource , APIXC_AdcGainOffsetSetting* pstADCSetting)
{
    ...
    if(UtopiaIoctl(pu32XC_Kernel_Inst, E_XC_ADC_CMD_GETDEFAULTGAINOFFSET, (void*)&XCArgs) != 0)
    {
        printf("Obtain XC engine fail\n");
        return;
    }
...
MS_U16 MApi_XC_ADC_GetMaximalOffsetValue(void)
{
    ...
    if(UtopiaIoctl(pu32XC_Kernel_Inst, E_XC_ADC_CMD_GETMAXIMALOFFSETVALUE, (void*)&XCArgs) != 0)
    {
        printf("Obtain XC engine fail\n");
        return 0;
    }
...
MS_U16 MApi_XC_ADC_GetMaximalGainValue(void)
{
    ...
    if(UtopiaIoctl(pu32XC_Kernel_Inst, E_XC_ADC_CMD_GETMAXIMALGAINVALUE, (void*)&XCArgs) != 0)
    {
        printf("Obtain XC engine fail\n");
        return 0;
    }
...
MS_U16 MApi_XC_ADC_GetCenterGain(void)
{
    ...
    if(UtopiaIoctl(pu32XC_Kernel_Inst, E_XC_ADC_CMD_GETCENTERGAIN, (void*)&XCArgs) != 0)
    {
        printf("Obtain XC engine fail\n");
        return 0;
    }
...
MS_U16 MApi_XC_ADC_GetCenterOffset(void)
{
    ...
    if(UtopiaIoctl(pu32XC_Kernel_Inst, E_XC_ADC_CMD_GETCENTEROFFSET, (void*)&XCArgs) != 0)
    {
        printf("Obtain XC engine fail\n");
        return 0;
    }
...
void MApi_XC_ADC_SetGain(MS_U8 u8Color, MS_U16 u16Value)
{
    ...
    if(UtopiaIoctl(pu32XC_Kernel_Inst, E_XC_ADC_CMD_SETGAIN, (void*)&XCArgs) != 0)
    {
        printf("Obtain XC engine fail\n");
        return;
    }
...
void MApi_XC_ADC_SetOffset(MS_U8 u8Color, MS_U16 u16Value)
{
    ...
    if(UtopiaIoctl(pu32XC_Kernel_Inst, E_XC_ADC_CMD_SETOFFSET, (void*)&XCArgs) != 0)
    {
        printf("Obtain XC engine fail\n");
        return;
    }
...
void MApi_XC_ADC_AdjustGainOffset(APIXC_AdcGainOffsetSetting* pstADCSetting)
{
    ...
    if(UtopiaIoctl(pu32XC_Kernel_Inst, E_XC_ADC_CMD_ADJUSTGAINOFFSET, (void*)&XCArgs) != 0)
    {
        printf("Obtain XC engine fail\n");
        return;
    }
...
void MApi_XC_ADC_Source_Calibrate(INPUT_SOURCE_TYPE_t enInputSourceType)
{
    ...
    if(UtopiaIoctl(pu32XC_Kernel_Inst, E_XC_ADC_CMD_SOURCE_CALIBRATE, (void*)&XCArgs) != 0)
    {
        printf("Obtain XC engine fail\n");
        return;
    }
...
void MApi_XC_ADC_SetSoGCal(void)
{
    ...
    if(UtopiaIoctl(pu32XC_Kernel_Inst, E_XC_ADC_CMD_SETSOGCAL, NULL) != 0)
    {
        printf("Obtain XC engine fail\n");
        return;
    }
...
void MApi_XC_ADC_SetRGB_PIPE_Delay(MS_U8 u8Value)
{
    ...
    if(UtopiaIoctl(pu32XC_Kernel_Inst, E_XC_ADC_CMD_SETRGB_PIPE_DELAY, (void*)&XCArgs) != 0)
    {
        printf("Obtain XC engine fail\n");
        return;
    }
...
void MApi_XC_ADC_ScartRGB_SOG_ClampDelay(MS_U16 u16Clpdly, MS_U16 u16Caldur)
{
    ...
    if(UtopiaIoctl(pu32XC_Kernel_Inst, E_XC_ADC_CMD_SCARTRGB_SOG_CLAMPDELAY, (void*)&XCArgs) != 0)
    {
        printf("Obtain XC engine fail\n");
        return;
    }
...
void MApi_XC_ADC_Set_YPbPrLooseLPF(MS_BOOL bEnable)
{
    ...
    if(UtopiaIoctl(pu32XC_Kernel_Inst, E_XC_ADC_CMD_SET_YPBPRLOOSELPF, (void*)&XCArgs) != 0)
    {
        printf("Obtain XC engine fail\n");
        return;
    }
...
void MApi_XC_ADC_Set_SOGBW(MS_U16 u16Value)
{
    ...
    if(UtopiaIoctl(pu32XC_Kernel_Inst, E_XC_ADC_CMD_SET_SOGBW, (void*)&XCArgs) != 0)
    {
        printf("Obtain XC engine fail\n");
        return;
    }
...
void MApi_XC_ADC_SetClampDuration(MS_U16 u16Value)
{
    ...
    if(UtopiaIoctl(pu32XC_Kernel_Inst, E_XC_ADC_CMD_SETCLAMPDURATION, (void*)&XCArgs) != 0)
    {
        printf("Obtain XC engine fail\n");
        return;
    }
...
MS_BOOL MApi_XC_ADC_EnableHWCalibration(MS_BOOL bEnable)
{
    ...
    stXC_ADC_ENABLEHWCALIBRATION XCArgs ={0};
    XCArgs.bEnable = bEnable;

    if(UtopiaIoctl(pu32XC_Kernel_Inst, E_XC_ADC_CMD_ENABLEHWCALIBRATION, (void*)&XCArgs) != 0)
    {
        printf("Obtain XC engine fail\n");
        return FALSE;
    }
...
MS_BOOL MApi_XC_ADC_SetIdacCurrentMode(ADC_DacCurrentMode_t eMode)
{
    ...
    if(UtopiaIoctl(pu32XC_Kernel_Inst, E_XC_ADC_CMD_SET_IDACCURRENTMODE, (void*)&XCArgs) != 0)
    {
        printf("Obtain XC engine fail\n");
        return FALSE;
    }
...
ADC_DacCurrentMode_t MApi_XC_ADC_GetIdacCurrentMode(void)
{
    ...
    if(UtopiaIoctl(pu32XC_Kernel_Inst, E_XC_ADC_CMD_GET_IDACCURRENTMODE, (void*)&XCArgs) != 0)
    {
        printf("Obtain XC engine fail\n");
        return FALSE;
    }
