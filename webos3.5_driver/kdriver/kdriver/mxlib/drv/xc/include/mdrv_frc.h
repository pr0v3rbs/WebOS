...
void MDrv_FRC_AutoDownLoad_init(MS_PHYADDR PhyAddr, MS_U32 u32BufByteLen); //NO_USE
void MDrv_FRC_ADLG_Trigger(FRC_CLIENT_TABLE client,MS_PHYADDR startAddr, MS_U16 u16CmdCnt); //NO_USE
...
void MDrv_FRC_IPM_TestPattern(MS_BOOL bEnable,MS_U8 u8TestMode);
void MDrv_FRC_OPM_TestPattern(MS_BOOL bEnable,MS_U8 u8TestMode);
void MDrv_FRC_OP_TestPattern(MS_BOOL bEnable,MS_U8 u8TestMode, MS_U8 u8Color);
#endif
