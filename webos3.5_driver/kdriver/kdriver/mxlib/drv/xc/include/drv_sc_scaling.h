...
INTERFACE void MDrv_SWDS_Fire(void *pInstance, P_SC_SWDB_INFO pDBreg, SCALER_WIN eWindow);
...
INTERFACE void MDrv_SC_Enable_FEOP1(void *pInstance, MS_BOOL bEnable, SCALER_WIN eWindow);
INTERFACE MS_BOOL MDrv_SC_set_2p_mode(void *pInstance, MS_BOOL bEnable,SCALER_WIN eWindow);
INTERFACE MS_BOOL MDrv_SC_GetSmartzoom(void *pInstance);
