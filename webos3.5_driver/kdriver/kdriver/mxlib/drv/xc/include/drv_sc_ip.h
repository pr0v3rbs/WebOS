...
#define MD_DEHSTART_TORLANCE        10
#define MD_DEVSTART_TORLANCE	    10

#define ACCURATE_VFREQ_TOLERANCE 20 //Tolerance for using new accurate vfreq method: 1hz
#define HIGH_ACCURATE_VFREQ_TOLERANCE 2000 //Tolerance for using new accurate vfreq method: 1hz
...
INTERFACE MS_U16 Hal_SC_ip_get_horizontalTotal(void *pInstance, SCALER_WIN eWindow);
#define MDrv_SC_ip_get_horizontalTotal  Hal_SC_ip_get_horizontalTotal
...
#define MDrv_XC_Set_FD_Mask_ByWin HAL_SC_ip_Set_FD_Mask_ByWin
...
INTERFACE void MApi_XC_InitRegInTimingChange_Post(void *pInstance, MS_U8 u8CurrentSyncStatus );
...
INTERFACE MS_U32 MDrv_SC_ip_get_verticalperiod_isr(void* pInstance, SCALER_WIN eWindow);
