...
INTERFACE void MDrv_XC_Set_SeamlessPlay(MS_BOOL bEnable);
INTERFACE MS_BOOL MDrv_XC_Set_DynamicScaling(void *pInstance, MS_U32 u32DSMemAddr, MS_U32 u32DSMemSize, MS_U32 u32MemBaseAddr, MS_U8 u8MIU_Select, MS_U8 u8IdxDepth, MS_BOOL bOP_On, MS_BOOL bIPS_On, MS_BOOL bIPM_On, SCALER_WIN eWindow);
INTERFACE E_APIXC_ReturnValue MDrv_XC_Set_DS_ForceI_DeInterlaceMode(void *pInstance, MS_BOOL bPmode,  MS_BOOL bIsTopField, MS_U16 u16FrameRate, SCALER_WIN eWindow);
INTERFACE void MDrv_XC_Set_DynamicScaling_OPIP_OnOff(void *pInstance, MS_BOOL bOP_On, MS_BOOL bIPS_On, MS_BOOL bIPM_On, SCALER_WIN eWindow);
