...
#define LD_MAX_BW       (32)
#define LD_MAX_BH       (32)
#define LD_MAX_BLOCK    (LD_MAX_BW*LD_MAX_BH)
...
typedef struct
{
    ...
    MS_U32 u32LDFReadBuf0Base;
    MS_U32 u32LDFReadBuf1Base;

    //LDB memory frame buffer
    MS_U32 u32LDBWriteBuf0Base;
    MS_U32 u32LDBWriteBuf1Base;

    //SPI memory frame buffer
    MS_U32 u32SPIDataBuf0Base;
    MS_U32 u32SPIDataBuf1Base;

    //edge2 coeff base
    MS_U32 u32Edge2DCoeffBase;
} ST_LD_DRAM_ADDR;
...
#endif
#else
INTERFACE MS_U8 MDrv_LD_MIUReadByte(void* pInstance, MS_U32 u32Addr, MS_U32 u32Offset);
INTERFACE MS_U16 MDrv_LD_MIURead2Bytes(void* pInstance, MS_U32 u32Addr, MS_U32 u32Offset);
INTERFACE void MDrv_LD_MIUWriteByte(void* pInstance, MS_U32 u32Addr, MS_U32 u32Offset, MS_U8 u8Value);
INTERFACE void MDrv_LD_MIUWrite2Bytes(void* pInstance, MS_U32 u32Addr, MS_U32 u32Offset, MS_U16 u16Value);
#endif
...
/// @return  none
//-------------------------------------------------------------------------------------------------
INTERFACE void MDrv_LD_CommonInit(void);
//-------------------------------------------------------------------------------------------------
...
/// @return  none
//-------------------------------------------------------------------------------------------------
INTERFACE MS_BOOL MDrv_LD_SetLocalDimmingData(MS_U8* pu8LocalDimmingData, MS_U16 u16DataLen);
//-------------------------------------------------------------------------------------------------
/// LocalDimming test function(Set LocalDimming Data  to spi test )(not used, set Local dimming data to spi handle in pm code)
/// @param  void                \b IN: none
/// @return  none
//-------------------------------------------------------------------------------------------------
INTERFACE void MDrv_LD_Test1(void);
//-------------------------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------------------------
INTERFACE ST_DRV_LD_INFO MDrv_LD_GetLDInfo(void);
//-------------------------------------------------------------------------------------------------
/// set OSD enable
/// @param  u8OSDEnable      \b 1:enable ;0;disable
/// @return  none
//-------------------------------------------------------------------------------------------------
INTERFACE void MDrv_LD_SetOSDEnable(MS_U8 u8OSDEnable);
//-------------------------------------------------------------------------------------------------
/// get panel type
/// @param  void      \b IN: none
/// @return  panel type
//-------------------------------------------------------------------------------------------------
INTERFACE EN_LD_PANEL_TYPE Mdrv_LD_GetPanelType(void);
//-------------------------------------------------------------------------------------------------
/// load panel compensation table
/// @param  pu8CompTable      \b IN: panel compensation table
/// @return  none
//-------------------------------------------------------------------------------------------------
INTERFACE void MDrv_LD_Load_Compensation_Table(MS_U8* pu8CompTable,MS_U16 u16CompTableLength);
//-------------------------------------------------------------------------------------------------
/// load  edge2d table
...
/// @return  none
//-------------------------------------------------------------------------------------------------
INTERFACE void MDrv_LD_Load_Hscaling_Table(MS_U8* pu8CoefTable);
//-------------------------------------------------------------------------------------------------
/// load  Vscaling table
/// @param  pu8CoefTable      \b IN: Vscaling table
/// @return  none
//-------------------------------------------------------------------------------------------------
INTERFACE void MDrv_LD_Load_Vscaling_Table(MS_U8* pu8CoefTable);
//-------------------------------------------------------------------------------------------------
/// set DMA access x
...
/// @return  none
//-------------------------------------------------------------------------------------------------
INTERFACE void MDrvl_LD_Set_DmaXOffset(MS_U8 u8DmaIdx, MS_U8 u8XStart, MS_U8 u8XEnd);
//-------------------------------------------------------------------------------------------------
/// set DMA access y
...
/// @return  none
//-------------------------------------------------------------------------------------------------
INTERFACE void MDrv_LD_Set_DmaYOffset(MS_U8 u8DmaIdx, MS_U8 u8YStart);
#endif
//-------------------------------------------------------------------------------------------------
...
/// @return  none
//-------------------------------------------------------------------------------------------------
INTERFACE void MDrv_LD_Set_LDF_FrameBufBaseAddr(MS_U8 u8BufIdx,MS_U32 u32LDFBase);
//-------------------------------------------------------------------------------------------------
/// get LDF frame buffer
/// @param  u8BufIdx        \b IN: LDF buffer frame index
/// @return   LDF buffer frame memeory base address
//-------------------------------------------------------------------------------------------------
INTERFACE MS_U32 MDrv_LD_Get_LDF_FrameBufBaseAddr(MS_U8 u8BufIdx);
//-------------------------------------------------------------------------------------------------
...
/// @return  none
//-------------------------------------------------------------------------------------------------
INTERFACE void MDrv_LD_Set_LDB_FrameBufBaseAddr(MS_U8 u8BufIdx,MS_U32 u32LDBBase);
//-------------------------------------------------------------------------------------------------
/// get LDB frame buffer
/// @param  u8BufIdx        \b IN: LDB buffer frame index
/// @return   LDB buffer frame memeory base address
//-------------------------------------------------------------------------------------------------
INTERFACE MS_U32 MDrv_LD_Get_LDB_FrameBufBaseAddr(MS_U8 u8BufIdx);
//-------------------------------------------------------------------------------------------------
/// Set Led  control data offset
/// @param  u32LEDoffset      \b IN: Led  control data offset
/// @return  none
//-------------------------------------------------------------------------------------------------
INTERFACE void MDrv_LD_Set_LEDData_BaseOffset(MS_U32 u32LEDoffset);
//-------------------------------------------------------------------------------------------------
/// Get spi data memeory base address
/// @param  u8BufIdx        \b IN: LDB buffer frame index
/// @return   spi data memeory base address
//-------------------------------------------------------------------------------------------------
INTERFACE MS_U32 MDrv_LD_Get_SPIData_BaseAddr(MS_U8 u8BufIdx);
//-------------------------------------------------------------------------------------------------
/// set EDGE2D frame buffer
/// @param  u32EDGE2DBase      \b IN: EDGE2D memeory base address
/// @return  none
//-------------------------------------------------------------------------------------------------
INTERFACE void MDrv_LD_Set_EDGE2D_BaseAddr(MS_U32 u32EDGE2DBase);
//-------------------------------------------------------------------------------------------------
/// set EDGE2D frame buffer
/// @param  none
/// @return  EDGE2D memeory base address
//-------------------------------------------------------------------------------------------------
INTERFACE MS_U32 MDrv_LD_Get_EDGE2D_BaseAddr(void);
//-------------------------------------------------------------------------------------------------
/// set local dimming enable
/// @param  bEn         \b IN: 1 :enable ;0 :disable
/// @return  none
//-------------------------------------------------------------------------------------------------
INTERFACE void MDrv_LD_Set_LocalDimmingEn(MS_BOOL bEn);
//-------------------------------------------------------------------------------------------------
/// get local dimming enable
/// @param  none
/// @return  1 :enable ;0 :disable
//-------------------------------------------------------------------------------------------------
INTERFACE MS_BOOL MDrv_LD_Get_LocalDimmingEn(void);
//-------------------------------------------------------------------------------------------------
/// LD set panel type
/// @param  eLdPanelType                \b IN: panel type
/// @return E_APIXC_RET_OK or E_APIXC_RET_FAIL
//-------------------------------------------------------------------------------------------------
INTERFACE MS_BOOL MDrv_XC_LD_SetPanelType(EN_LD_PANEL_TYPE eLDPanelType );
