...
typedef struct _TYPE_LD_PANEL_TYPE_t
{
    MS_U8 u8PWMHigh;
    MS_U8 u8PWMWidth;
    MS_U8 u8LDWidth;
...
//#define REG_DEBUG_LD_DUMP_SEL        SC_R2BYTEMSK(REG_SC_BK2E_7A_L,0xF000) >>12
...
//-------------------------------------------------------------------------------------------------
INTERFACE void MDrv_LD_EnableLD(MS_BOOL bLDEnable);
//-------------------------------------------------------------------------------------------------
/// set LD gamma control
/// @param  u8GammaControl        \b IN: gamma control index
/// @return  void                \b IN: none
//-------------------------------------------------------------------------------------------------
INTERFACE void MDrv_LD_SetGammaControl(MS_U8 u8GammaControl);
//-------------------------------------------------------------------------------------------------
/// set LD ISR
