...
INTERFACE MS_U16 _MDrv_HDMI_GetHDE(void);
INTERFACE MS_U16 _MDrv_HDMI_GetHTT(void);
INTERFACE MS_U16 _MDrv_HDMI_GetVDE(void);
INTERFACE MS_U16 _MDrv_HDMI_GetVTT(void);
...
INTERFACE void MDrv_HDMI_init_internal(void *pInstance);
