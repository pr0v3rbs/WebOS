...
#ifndef VE_ANALOG_REG_H
#define VE_ANALOG_REG_H
...
/* Component */
#define L_BK_COMPONENT(x)      BK_REG_L(REG_BASE_COMPONENT, x)
#define H_BK_COMPONENT(x)      BK_REG_H(REG_BASE_COMPONENT, x)

/* VE */
#define L_BK_VE_ENC_EX(x)      BK_REG_L(REG_BASE_VE_ENCODER_EX, x)
#define H_BK_VE_ENC_EX(x)      BK_REG_H(REG_BASE_VE_ENCODER_EX, x)
...
#define L_BK_VE_DISC(x)      BK_REG_L(REG_BASE_VE_DISC, x)
#define H_BK_VE_DISC(x)      BK_REG_H(REG_BASE_VE_DISC, x)
...
/* Chip Top */
#define L_BK_CHIP(x)        BK_REG_L(REG_BASE_CHIP, x)
#define H_BK_CHIP(x)        BK_REG_H(REG_BASE_CHIP, x)

/* CLKGEN0 */
#define L_BK_CLKGEN0(x)     BK_REG_L(REG_CLKGEN0_BASE, x)
#define H_BK_CLKGEN0(x)     BK_REG_H(REG_CLKGEN0_BASE, x)

/* PM_SLP */
#define L_BK_PMSLP(x)       BK_REG_L(REG_BASE_PM_SLP, x)
#define H_BK_PMSLP(x)       BK_REG_H(REG_BASE_PM_SLP, x)

/* OTP */
#define L_BK_PMOTP(x)      BK_REG_L(REG_BASE_PM_OTP, x)
#define H_BK_PMOTP(x)      BK_REG_H(REG_BASE_PM_OTP, x)

#define REG_SC_BK20_03_L        (REG_SC_BASE + 0x2000 + 0x06)
#define REG_SC_BK57_2F_L        (REG_SC_BASE + 0x5700 + 0x5E)
#define REG_SC_BK57_7E_L        (REG_SC_BASE + 0x5700 + 0xFC)
#define REG_SC_BK57_7F_L        (REG_SC_BASE + 0x5700 + 0xFE)
...
typedef enum
{
    ...
    VE_IPMUX_CAPTURE    = 7,            ///< Scaler OP2 output
    VE_IPMUX_MVOP2      = 8,            ///< DC1
    VE_IPMUX_SC_SUBIP   = 9,            ///< SUB IP
    VE_IPMUX_DI         = 10,           ///< after DI
} VE_IPMUX_TYPE;
...
// CEC porting
#ifdef SATURN_IV_ENHANCE
#define L_BK_CEC(x)     BK_REG_L(CEC_REG_BASE, x)
#define H_BK_CEC(x)     BK_REG_H(CEC_REG_BASE, x)
#endif
...
#define REG_CKG_FCLK            0x1E35
    #define CKG_FCLK_GATED          (1 << 5)  //BIT(5)
    #define CKG_FCLK_INVERT         (1 << 1)  //BIT(1)
    #define CKG_FCLK_MASK           0x3C  //(BIT(5) | BIT(4) | BIT(3) | BIT(2))
...
#define REG_CKG_IDCLK2          0x1E3F
    #define CKG_IDCLK2_GATED        (1 << 0)
    #define CKG_IDCLK2_INVERT       (1 << 1)
    #define CKG_IDCLK2_MASK         0x3C //BMASK(5:2) //   (BIT5 | BIT4 | BIT3 | BIT2)
...
#define REG_CKG_ODCLK           0x1E37
    #define CKG_ODCLK_GATED         (1 << 0)
    #define CKG_ODCLK_INVERT        (1 << 1)
    #define CKG_ODCLK_MASK          0x3C  //(BIT5 | BIT4 | BIT3 | BIT2)
