...
typedef struct _TVENCODER_INSTANT_PRIVATE
{
    MS_BOOL bInited_Drv;
...
typedef struct _TVE_GETINfO
{
    const VE_DrvInfo *pVE_DrvInfo;
    E_TVENCODER_RET eRet;
}TVE_GETINFO, *PTVE_GETINFO;

typedef struct _TVE_GETSTATUS
{
    VE_DrvStatus *pStaus;
    E_TVENCODER_RET eRet;
...
typedef struct _TVE_INIT
{
    MS_PHYADDR u32MIUAddress;
    E_TVENCODER_RET eRet;
}TVE_INIT, *PTVE_INIT;
...
typedef struct _TVE_GETDSTINFO
{
...
typedef struct _TVE_ADJFRAMESTART
{
...
typedef struct _TVE_SETCUSTABLE
{
    MS_VE_VIDEOSYS VideoSystem;
    MS_U8* pTbl;
    E_TVENCODER_RET eRet;
...
typedef struct _TVE_GETVIDEOALPHA
{
    MS_U8* pu8Val;
    E_TVENCODER_RET eRet;
...
typedef struct _TVE_DCSSETACTIVATIONKEY
{
