...
MS_BOOL MDrv_SYS_DMD_VD_MBX_Init(void)
{
    if (_s32_DMD_VD_MBX_Mutex == -1)
    {
        ...
        #ifdef MS_DEBUG
        printf("MDrv_SYS_DMD_VD_MBX_Init %lx\n",_s32_DMD_VD_MBX_Mutex);
        #endif
    }
    else
    {
        printf("MDrv_SYS_DMD_VD_MBX_Init more than twice\n");
        return FALSE;
    }
    ...
    {
        #ifdef MS_DEBUG
        printf("MDrv_SYS_DMD_VD_MBX_Init Fail\n");
        #endif
        return FALSE;
    }
}
...
void MDrv_SYS_DMD_VD_MBX_SetType(DMD_VD_MBX_Type eType)
{
    ...
    switch (eType)
    {
        ...
        default:
            #ifdef MS_DEBUG
            printf("MDrv_SYS_DMD_VD_MBX_SetType Fail\n");
            #endif
            break;
    }
    DMD_VD_MBX_UNLOCK();
...
MS_BOOL MDrv_SYS_DMD_VD_MBX_ReadReg(MS_U32 u32Reg, MS_U8 *u8Value)
{
    ...
    switch (HAL_SYS_DMD_VD_MBX_GetType())
    {
        ...
        default:
            #ifdef MS_DEBUG
            printf("MDrv_SYS_DMD_VD_MBX_ReadReg>> Incorrect firmware code!!\n");
            #endif
            *u8Value = 0;
            bResult = FALSE;
            break;
    ...
    #ifdef MS_DEBUG
    printf("MDrv_SYS_DMD_VD_MBX_ReadReg %lx %x\n",u32Reg,*u8Value);
    #endif
    DMD_VD_MBX_UNLOCK();
    return bResult;
}
...
MS_BOOL MDrv_SYS_DMD_VD_MBX_ReadDSPReg(MS_U32 u32Reg, MS_U8 *u8Value)
{
    ...
    {
        #ifdef MS_DEBUG
        printf("MDrv_SYS_DMD_VD_MBX_ReadDSPReg>> Incorrect firmware code!!\n");
        #endif
        bResult = FALSE;
    }
    #ifdef MS_DEBUG
    printf("MDrv_SYS_DMD_VD_MBX_ReadDSPReg %lx %x\n",u32Reg,*u8Value);
    #endif
    DMD_VD_MBX_UNLOCK();
    return bResult;
}
...
MS_BOOL MDrv_SYS_DMD_VD_MBX_DBG_ReadReg(MS_U32 u32Reg, MS_U8 *u8Value)
{
    ...
    {
        #ifdef MS_DEBUG
        printf("MDrv_SYS_DMD_VD_MBX_DBG_ReadReg>> Incorrect firmware code!!\n");
        #endif
        bResult = FALSE;
    }
    #ifdef MS_DEBUG
    printf("MDrv_SYS_DMD_VD_MBX_DBG_ReadReg %lx %x\n",u32Reg,*u8Value);
    #endif
    DMD_VD_MBX_UNLOCK();
    return bResult;
}
...
MS_BOOL MDrv_SYS_DMD_VD_MBX_WriteReg(MS_U32 u32Reg, MS_U8 u8Value)
{
    ...
    u32Reg &= 0xFFFF;
    #ifdef MS_DEBUG
    printf("MDrv_SYS_DMD_VD_MBX_WriteReg %lx %x\n",u32Reg,u8Value);
    #endif
    switch (HAL_SYS_DMD_VD_MBX_GetType())
    {
        case BIN_FOR_ATV:
        ...
        default:
            #ifdef MS_DEBUG
            printf("MDrv_SYS_DMD_VD_MBX_WriteReg>> Incorrect firmware code!!\n");
            #endif
            DMD_VD_MBX_UNLOCK();
            bResult = FALSE;
            break;
...
MS_BOOL MDrv_SYS_DMD_VD_MBX_WriteDSPReg(MS_U32 u32Reg, MS_U8 u8Value)
{
    ...
    u32Reg &= 0xFFFF;
    #ifdef MS_DEBUG
    printf("MDrv_SYS_DMD_VD_MBX_WriteDSPReg %lx %x\n",u32Reg,u8Value);
    #endif
    if (HAL_SYS_DMD_VD_MBX_GetType()& (BIN_FOR_DVBT|BIN_FOR_DVBC|BIN_FOR_DVBT2|BIN_FOR_DVBS))
    {
    ...
    {
        #ifdef MS_DEBUG
        printf("MDrv_SYS_DMD_VD_MBX_WriteDSPReg>> Incorrect firmware code!!\n");
        #endif
        bResult = FALSE;
    }
    DMD_VD_MBX_UNLOCK();
...
MS_BOOL MDrv_SYS_DMD_VD_MBX_DBG_WriteReg(MS_U32 u32Reg, MS_U8 u8Value)
{
    ...
    u32Reg &= 0xFFFF;
    #ifdef MS_DEBUG
    printf("MDrv_SYS_DMD_VD_MBX_DBG_WriteReg %lx %x\n",u32Reg,u8Value);
    #endif
    if (HAL_SYS_DMD_VD_MBX_GetType()& (BIN_FOR_DVBT|BIN_FOR_DVBC|BIN_FOR_DVBT2|BIN_FOR_DVBS))
    {
    ...
    {
        #ifdef MS_DEBUG
        printf("MDrv_SYS_DMD_VD_MBX_DBG_WriteReg>> Incorrect firmware code!!\n");
        #endif
        bResult = FALSE;
    }
    DMD_VD_MBX_UNLOCK();
