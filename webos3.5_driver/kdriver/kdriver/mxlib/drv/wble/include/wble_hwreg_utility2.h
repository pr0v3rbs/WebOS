...
//  Macro and Define
//-------------------------------------------------------------------------------------------------
extern MS_U32 WBLE_RIU_BASE;      // This should be inited before XC library starting.
...
#define RIU_READ_BYTE(addr)         ( READ_BYTE( WBLE_RIU_BASE + (addr) ) )
#define RIU_READ_2BYTE(addr)        ( READ_WORD( WBLE_RIU_BASE + (addr) ) )
#define RIU_WRITE_BYTE(addr, val)   { WRITE_BYTE( WBLE_RIU_BASE + (addr), val) }
#define RIU_WRITE_2BYTE(addr, val)  { WRITE_WORD( WBLE_RIU_BASE + (addr), val) }
