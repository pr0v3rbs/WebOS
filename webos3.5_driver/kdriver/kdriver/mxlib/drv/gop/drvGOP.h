...
//  Customize Define
//-------------------------------------------------------------------------------------------------
#define CUS_SETTING     1
#define INSTANT_PRIVATE 1
#if CUS_SETTING
#define GOP_UTOPIA2K              1
#define WINFB_INSHARED            1
#define POOL_INSHARED             1
#define CURSOR_SUPPORT            1
#define MUTEX_LOCK_ENABLE         0
#define ENABLE_GOP0_RBLK_MIRROR   FALSE
#ifndef DRV_MAX_GWIN_FB_SUPPORT
#define DRV_MAX_GWIN_FB_SUPPORT   0xFFFF
#endif
#define GFLIP_ENABLE              FALSE
#define BOOTLOGO_PATCH            TRUE
#define GOP_PIXEL_ALIGN           FALSE//TRUE
...
#define GOP_UTOPIA2K              1
#define WINFB_INSHARED            1
#define POOL_INSHARED             0
#define CURSOR_SUPPORT            0
#define MUTEX_LOCK_ENABLE         0
#define ENABLE_GOP0_RBLK_MIRROR   TRUE
#ifndef DRV_MAX_GWIN_FB_SUPPORT
#define DRV_MAX_GWIN_FB_SUPPORT   32
#endif
...
#ifdef  MSOS_TYPE_NOS
#define GOP_LOCK_SUPPORT                0
#define GOP_XC_LOCK_SUPPORT             0
#define GOP_XC_SEMPHORE_PROTECT         0
#else
#define GOP_LOCK_SUPPORT                MUTEX_LOCK_ENABLE
#define GOP_XC_LOCK_SUPPORT             MUTEX_LOCK_ENABLE
#define GOP_XC_SEMPHORE_PROTECT         1
#endif
#define GOP_XC_LOCK_DEBUG               0

#if GOP_UTOPIA2K
    #define GOPDRIVER_BASE KERNEL_MODE
#else
    #define GOPDRIVER_BASE 0
#endif
...
#define INVAILD_GOP_NUM                 0xFF
#define INVALID_GWIN_ID                 0xFF
#define GWIN_OSD_DEFAULT                (MS_U8)g_pGOPCtxLocal->pGopChipProperty->TotalGwinNum
#define INVALID_POOL_NEXT_FBID          0xFFFF
#define FB_FMT_AS_DEFAULT               0xFFFF
#define INVALID_CLIENT_PID              0x00 //Invalid PID
...
#define GOP_STRETCH_TABLE_NUM           50
#define GOP_VSTRETCH_TABLE_NUM          32
#define GOP_REG_MAX                     128


#define SHARED_GWIN_MAX_COUNT           32
#define SHARED_GOP_MAX_COUNT            8
#define MAX_GOP_SW_SCROLLNUM            16
...
#define GOP_MIU_CLIENT_OC9              0x9
#define INVALID_BPP                     0xFFFF

#define SCALING_MULITPLIER              0x1000

#define GOP_FMT_RGB555_BLINK       0x0
#define GOP_FMT_RGB565             0x1
#define GOP_FMT_ARGB4444           0x2
#define GOP_FMT_FaBaFgBg2266       0x3
#define GOP_FMT_I8                 0x4
#define GOP_FMT_ARGB8888           0x5
#define GOP_FMT_ARGB1555           0x6
#define GOP_FMT_ABGR8888           0x7
#define GOP_FMT_ARGB1555_DST       0x8
#define GOP_FMT_YUV422             0x9
#define GOP_FMT_RGBA5551           10
#define GOP_FMT_RGBA4444           11
#define GOP_FMT_RGBA8888           12
#define GOP_FMT_BGR565             17
#define GOP_FMT_ABGR4444           18
#define GOP_FMT_ABGR1555           22
#define GOP_FMT_BGRA5551           26
#define GOP_FMT_BGRA4444           27
#define GOP_FMT_BGRA8888           28
#define GOP_FMT_GENERIC            0xFFFF

#define PAGE_SIZE                  4096
#define PER_BYTE_BITS              8
#define TLB_PER_ENTRY_SIZE         4
#define PER_MIU_TLB_ENTRY_COUNT    (GOP_WordUnit/TLB_PER_ENTRY_SIZE)
#define ADDRESSING_8BYTE_UNIT      8

///GOP_PALETTE_ENTRY_NUM
#define GOP_PALETTE_ENTRY_NUM_MAX   256
...
typedef struct
{
    ...
    MS_U32 u32DRAMRBlkStart;        //!< unit: Byte
...
typedef struct
{
    ...
    MS_U32 u32TFDRAMAddr;       //!< unit: Byte
    MS_U32 u32BFDRAMAddr;       //!< unit: Byte
...
typedef struct
{
    ...
    MS_U16 u16w;           ///< width
    MS_U16 u16h;           ///< height
    MS_U32 u32fbaddr0;     ///< Top field DRAM address
    MS_U32 u32fbaddr1;     ///< Bottom field DRAM address
...
typedef struct
{
    MS_U32 u32GOP_OC_DRAM_RBLK;         ///Bytes
    MS_U32 u32GOP_OC_ADDRPROTECT_STR;   ///Bytes
    MS_U32 u32GOP_OC_ADDRPROTECT_END;   ///Bytes
...
{
   GOP_FBPOOL_ID poolId;
   MS_U32 u32GWinFB_Pool_BaseAddr;
...
typedef struct
{
        ...
        MS_U32  u32TLBAddress[SHARED_GOP_MAX_COUNT];
...
void MDrv_GOP_SetGEDstFBInfo(MS_GOP_CTX_LOCAL*pGOPCtx, MS_U16 pitch,MS_U32 address, MS_U16 fbFmt);
...
MS_BOOL Mdrv_GOP_GetMuxPriority(MS_GOP_CTX_LOCAL*pGOPCtx, PST_DRV_GOP_MUX_CAP_EX pstMuxPri);
...
GOP_Result MDrv_GOP_SetTLBAddr(MS_GOP_CTX_LOCAL*pGOPCtx,MS_U8 GOP, MS_U32 tlbaddr,MS_BOOL bHMirror,MS_BOOL bVMirror,DRV_GOP_GWIN_INFO* pinfo);
