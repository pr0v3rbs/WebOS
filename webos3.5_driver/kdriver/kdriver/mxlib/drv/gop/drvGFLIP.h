...
INTERFACE MS_BOOL MDrv_GFLIP_SetFlipInfo(MS_GOP_CTX_LOCAL *pGOPCtx, MS_U32 u32GopIdx, MS_U32 u32GwinIdx, MS_U32 u32MainAddress, MS_U32 u32SubAddress, MS_U32 u32TagId, MS_U32 * u32QEntry);
