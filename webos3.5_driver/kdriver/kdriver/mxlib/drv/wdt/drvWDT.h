...
//LG@LG : added customization function.
...
//--------------------------------------------------------------------------------------------------
// Utopia2.0 will call this function to register WDT module
//--------------------------------------------------------------------------------------------------
...
void _MDrv_TIMER_Delay(E_PIU_Timer eTimer, MS_U32 u32Second);
void _MDrv_TIMER_DelayMs(E_PIU_Timer eTimer, MS_U32 u32MS);
