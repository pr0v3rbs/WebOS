...
MS_U32 FLASHIoctl(void* pInstance, MS_U32 u32Cmd, void* pArgs)
{
    ...
    switch(u32Cmd)
    {
        case MDrv_CMD_SERFLASH_GetInfo:
            printf("FLASHIoctl - MDrv_CMD_SERFLASH_GetInfo\n");
            // this function won't occupy h/w, so don't need to call UtopiaResourceObtainToInstant
            u32Ret = (MS_U32)psSERFLASHInstPri->fpSERFLASHGetInfo();
            return 0;
        case MDrv_CMD_SERFLASH_GetLibVer:
            printf("FLASHIoctl - MDrv_CMD_SERFLASH_GetLibVer\n");
        ...
        case MDrv_CMD_SERFLASH_GetStatus:
            printf("FLASHIoctl - MDrv_CMD_SERFLASH_GetStatus\n");
        ...
        case MDrv_CMD_SERFLASH_SetDbgLevel:
            printf("FLASHIoctl - MDrv_CMD_SERFLASH_SetDbgLevel\n");
        ...
        case MDrv_CMD_SERFLASH_SetWPInfo:
            printf("FLASHIoctl - MDrv_CMD_SERFLASH_SetWPInfo\n");
        ...
        case MDrv_CMD_SERFLASH_SetMcuCSCallBack:
            printf("FLASHIoctl - MDrv_CMD_SERFLASH_SetMcuCSCallBack\n");
        ...
        case MDrv_CMD_SERFLASH_SetFlashWPCallBack:
            printf("FLASHIoctl - MDrv_CMD_SERFLASH_SetFlashWPCallBack\n");
        ...
        case MDrv_CMD_SERFLASH_DetectType:
            printf("FLASHIoctl - MDrv_CMD_SERFLASH_DetectType\n");
        ...
        case MDrv_CMD_SERFLASH_DetectSize:
            printf("FLASHIoctl - MDrv_CMD_SERFLASH_DetectSize\n");
        ...
        case MDrv_CMD_SERFLASH_Set2XRead:
            printf("FLASHIoctl - MDrv_CMD_SERFLASH_Set2XRead\n");
        ...
        case MDrv_CMD_SERFLASH_SetCKG:
            printf("FLASHIoctl - MDrv_CMD_SERFLASH_SetCKG\n");
        ...
        case MDrv_CMD_SERFLASH_ClkDiv:
            printf("FLASHIoctl - MDrv_CMD_SERFLASH_ClkDiv\n");
        ...
        case MDrv_CMD_SERFLASH_SetMode:
            printf("FLASHIoctl - MDrv_CMD_SERFLASH_SetMode\n");
        ...
        case MDrv_CMD_SERFLASH_ReadUID:
            printf("FLASHIoctl - MDrv_CMD_SERFLASH_ReadUID\n");
            if(UtopiaResourceObtain(pModule, FLASH_POOL_ID_SERFLASH, &pResource) != 0)
            {
                printf("UtopiaResourceObtainToInstant fail\n");
	            return 0xFFFFFFFF;
        ...
        case MDrv_CMD_SERFLASH_ChipSelect:
            printf("FLASHIoctl - MDrv_CMD_SERFLASH_ChipSelect\n");
        ...
        case MDrv_CMD_SERFLASH_Init:
            printf("FLASHIoctl - MDrv_CMD_SERFLASH_Init\n");
            if(UtopiaResourceObtain(pModule, FLASH_POOL_ID_SERFLASH, &pResource) != 0)
            {
                printf("UtopiaResourceObtainToInstant fail\n");
	            return 0xFFFFFFFF;
        ...
        case MDrv_CMD_SERFLASH_ReadID:
            printf("FLASHIoctl - MDrv_CMD_SERFLASH_ReadID\n");
        ...
        case MDrv_CMD_SERFLASH_Read:
            printf("FLASHIoctl - MDrv_CMD_SERFLASH_Read\n");
        ...
        case MDrv_CMD_SERFLASH_EraseChip:
            printf("FLASHIoctl - MDrv_CMD_SERFLASH_EraseChip\n");
            if(UtopiaResourceObtain(pModule, FLASH_POOL_ID_SERFLASH, &pResource) != 0)
            {
                printf("UtopiaResourceObtainToInstant fail\n");
	            return 0xFFFFFFFF;
        ...
        case MDrv_CMD_SERFLASH_AddressToBlock:
            printf("FLASHIoctl - MDrv_CMD_SERFLASH_AddressToBlock\n");
        ...
        case MDrv_CMD_SERFLASH_BlockToAddress:
            printf("FLASHIoctl - MDrv_CMD_SERFLASH_BlockToAddress\n");
        ...
        case MDrv_CMD_SERFLASH_AddressErase:
            printf("FLASHIoctl - MDrv_CMD_SERFLASH_AddressErase\n");
        ...
        case MDrv_CMD_SERFLASH_BlockErase:
            printf("FLASHIoctl - MDrv_CMD_SERFLASH_BlockErase\n");
        ...
        case MDrv_CMD_SERFLASH_SectorErase:
            printf("FLASHIoctl - MDrv_CMD_SERFLASH_SectorErase\n");
        ...
        case MDrv_CMD_SERFLASH_CheckWriteDone:
            printf("FLASHIoctl - MDrv_CMD_SERFLASH_CheckWriteDone\n");
            if(UtopiaResourceObtain(pModule, FLASH_POOL_ID_SERFLASH, &pResource) != 0)
            {
                printf("UtopiaResourceObtainToInstant fail\n");
	            return 0xFFFFFFFF;
        ...
        case MDrv_CMD_SERFLASH_Write:
            printf("FLASHIoctl - MDrv_CMD_SERFLASH_Write\n");
        ...
        case MDrv_CMD_SERFLASH_DMA:
            printf("FLASHIoctl - MDrv_CMD_SERFLASH_DMA\n");
        ...
        case MDrv_CMD_SERFLASH_WriteProtect:
            printf("FLASHIoctl - MDrv_CMD_SERFLASH_WriteProtect\n");
        ...
        case MDrv_CMD_SERFLASH_WriteProtect_Enable_All_Range:
            printf("FLASHIoctl - MDrv_CMD_SERFLASH_WriteProtect_Enable_All_Range\n");
            if(UtopiaResourceObtain(pModule, FLASH_POOL_ID_SERFLASH, &pResource) != 0)
            {
                printf("UtopiaResourceObtainToInstant fail\n");
	            return 0xFFFFFFFF;
        ...
        case MDrv_CMD_SERFLASH_WriteProtect_Disable_All_Range:
            printf("FLASHIoctl - MDrv_CMD_SERFLASH_WriteProtect_Disable_All_Range\n");
            if(UtopiaResourceObtain(pModule, FLASH_POOL_ID_SERFLASH, &pResource) != 0)
            {
                printf("UtopiaResourceObtainToInstant fail\n");
	            return 0xFFFFFFFF;
        ...
        case MDrv_CMD_SERFLASH_WriteProtect_Disable_Range_Set:
            printf("FLASHIoctl - MDrv_CMD_SERFLASH_WriteProtect_Disable_Range_Set\n");
        ...
        case MDrv_CMD_SERFLASH_ReadStatusRegister:
            printf("FLASHIoctl - MDrv_CMD_SERFLASH_ReadStatusRegister\n");
        ...
        case MDrv_CMD_SERFLASH_ReadStatusRegister2:
            printf("FLASHIoctl - MDrv_CMD_SERFLASH_ReadStatusRegister2\n");
        ...
        case MDrv_CMD_SERFLASH_WriteStatusRegister:
            printf("FLASHIoctl - MDrv_CMD_SERFLASH_WriteStatusRegister\n");
        ...
        case MDrv_CMD_SERFLASH_CopyHnd:
            printf("FLASHIoctl - MDrv_CMD_SERFLASH_CopyHnd\n");
        ...
        case MDrv_CMD_SERFLASH_SetGPIO:
            printf("FLASHIoctl - MDrv_CMD_SERFLASH_SetGPIO\n");
