...
MS_BOOL _MDrv_SERFLASH_AddressToBlock(MS_U32 u32FlashAddr, MS_U32 *pu32BlockIndex)
{
    ...
    DEBUG_SER_FLASH(E_SERFLASH_DBGLV_DEBUG, printf("%s(0x%08X, %p)", __FUNCTION__, (int)u32FlashAddr, pu32BlockIndex));
...
MS_BOOL _MDrv_SERFLASH_BlockToAddress(MS_U32 u32BlockIndex, MS_U32 *pu32FlashAddr)
{
    ...
    DEBUG_SER_FLASH(E_SERFLASH_DBGLV_DEBUG, printf("%s(0x%08X, %p)", __FUNCTION__, (int)u32BlockIndex, pu32FlashAddr));
...
MS_U64 _MDrv_SERFLASH_ReadUID(void)
{
    ...
    if(u64Ret == 0)
    {
        printf("warning: Don't surport Read UID \n");
    }
    return u64Ret;
}
...
MS_BOOL _MDrv_SERFLASH_Read(MS_U32 u32FlashAddr, MS_U32 u32FlashSize, MS_U8 *user_buffer)
{
    ...
    if( user_buffer == NULL )
    {
    	DEBUG_SER_FLASH(E_SERFLASH_DBGLV_DEBUG, printf("USER BUFFER is NULL\n"));
		return 0;
	}
...
MS_BOOL _MDrv_SERFLASH_WriteProtect_Disable_Range_Set(MS_U32 u32DisableLowerBound, MS_U32 u32DisableSize)
{
    ...
    {
        DEBUG_SER_FLASH(E_SERFLASH_DBGLV_INFO, printf(" = FALSE, u32DisableLowerBound(0x%08X), u32DisableUpperBound(0x%08X), u32FlashIndexMax(0x%08X)\n", (int)u32DisableLowerBound, (int)u32DisableUpperBound, (int)u32FlashIndexMax));
...
{
    DEBUG_SER_FLASH(E_SERFLASH_DBGLV_DEBUG, printf("%s(%p, %d)\n", __FUNCTION__, pu8FlashID, (int)u32IDSize));
...
MS_BOOL MDrv_SERFLASH_SetDbgLevel(MS_U8 u8DbgLevel)
{
#if (SERFLASH_UTOPIA20)
    {
        ...
        {
            printf("Ioctl MDrv_SERFLASH_SetDbgLevel fail\n");
            return FALSE;
        }
        return TRUE;
    }
...
MS_BOOL MDrv_SERFLASH_SetWPInfo(MS_BOOL bWPInfo)
{
#if (SERFLASH_UTOPIA20)
    {
        ...
        {
            printf("Ioctl MDrv_SERFLASH_SetWPInfo fail\n");
            return FALSE;
        }
        return TRUE;
    }
...
void MDrv_SERFLASH_SetMcuCSCallBack(ms_Mcu_ChipSelect_CB ChipSel_cb)
{
#if (SERFLASH_UTOPIA20)
    {
        ...
        {
            printf("Ioctl MDrv_SERFLASH_SetMcuCSCallBack fail\n");
            return;
        }
        return;
    }
...
void MDrv_SERFLASH_SetFlashWPCallBack(ms_Flash_SetHWWP_CB FlashWP_cb)
{
#if (SERFLASH_UTOPIA20)
    {
        ...
        {
            printf("Ioctl MDrv_SERFLASH_SetFlashWPCallBack fail\n");
            return;
        }
        return;
    }
...
MS_BOOL MDrv_SERFLASH_DetectType(void)
{
    ...
    {
        printf("Ioctl MDrv_SERFLASH_DetectType fail\n");
        return FALSE;
    }
    return TRUE;
#else
...
MS_BOOL MDrv_SERFLASH_DetectSize(MS_U32 *u32FlashSize)
{
...
#if (SERFLASH_UTOPIA20)
    {
        ...
        {
            printf("Ioctl MDrv_SERFLASH_DetectSize fail\n");
            return FALSE;
        }
        return TRUE;
    }
...
MS_BOOL MDrv_SERFLASH_Set2XRead(MS_BOOL b2XMode)
{
#if (SERFLASH_UTOPIA20)
    {
        ...
        {
            printf("Ioctl MDrv_SERFLASH_Set2XRead fail\n");
            return FALSE;
        }
        return TRUE;
    }
...
MS_BOOL MDrv_SERFLASH_SetCKG(SPI_DrvCKG eCKGspi)
{
#if (SERFLASH_UTOPIA20)
    {
        ...
        {
            printf("Ioctl MDrv_SERFLASH_SetCKG fail\n");
            return FALSE;
        }
        return TRUE;
    }
...
void MDrv_SERFLASH_ClkDiv(SPI_DrvClkDiv eClkDivspi)
{
...
#if (SERFLASH_UTOPIA20)
    {
        ...
        {
            printf("Ioctl MDrv_SERFLASH_ClkDiv fail\n");
            return;
        }
        return;
    }
...
MS_BOOL MDrv_SERFLASH_SetMode(MS_BOOL bXiuRiu)
{
#if (SERFLASH_UTOPIA20)
    {
        ...
        {
            printf("Ioctl MDrv_SERFLASH_SetMode fail\n");
            return FALSE;
        }
        return TRUE;
    }
...
MS_BOOL MDrv_SERFLASH_ChipSelect(MS_U8 u8FlashIndex)
{
#if (SERFLASH_UTOPIA20)
    {
        ...
        {
            printf("Ioctl MDrv_SERFLASH_ChipSelect fail\n");
            return FALSE;
        }
        return TRUE;
    }
...
void MDrv_SERFLASH_Init(void)
{
    ...
    {
        DEBUG_SER_FLASH(E_SERFLASH_DBGLV_ERR, printf("IOMap failure to get DRV_MMIO_NONPM_BANK\n"));
    }
...
MS_BOOL MDrv_SERFLASH_AddressToBlock(MS_U32 u32FlashAddr, MS_U32 *pu32BlockIndex)
{
...
#if (SERFLASH_UTOPIA20)
    {
        ...
        {
            printf("Ioctl MDrv_SERFLASH_AddressToBlock fail\n");
            return FALSE;
        }
        return TRUE;
    }
...
MS_BOOL MDrv_SERFLASH_BlockToAddress(MS_U32 u32BlockIndex, MS_U32 *pu32FlashAddr)
{
...
#if (SERFLASH_UTOPIA20)
    {
        ...
        {
            printf("Ioctl MDrv_SERFLASH_BlockToAddress fail\n");
            return FALSE;
        }
        return TRUE;
    }
...
MS_BOOL MDrv_SERFLASH_AddressErase(MS_U32 u32StartAddr, MS_U32 u32EraseSize, MS_BOOL bWait)
{
#if (SERFLASH_UTOPIA20)
    {
        ...
        {
            printf("Ioctl MDrv_SERFLASH_AddressErase fail\n");
            return FALSE;
        }
        return TRUE;
    }
...
MS_BOOL MDrv_SERFLASH_BlockErase(MS_U32 u32StartBlock, MS_U32 u32EndBlock, MS_BOOL bWait)
{
...
#if (SERFLASH_UTOPIA20)
    {
        ...
        {
            printf("Ioctl MDrv_SERFLASH_BlockErase fail\n");
            return FALSE;
        }
        return TRUE;
    }
...
MS_BOOL MDrv_SERFLASH_SectorErase(MS_U32 u32StartAddr, MS_U32 u32EndAddr)
{
#if (SERFLASH_UTOPIA20)
    {
        ...
        {
            printf("Ioctl MDrv_SERFLASH_SectorErase fail\n");
            return FALSE;
        }
        return TRUE;
    }
...
MS_BOOL MDrv_SERFLASH_CheckWriteDone(void)
{
    ...
    {
        printf("Ioctl MDrv_SERFLASH_CheckWriteDone fail\n");
        return FALSE;
    }
    return TRUE;
#else
...
MS_BOOL MDrv_SERFLASH_Write(MS_U32 u32FlashAddr, MS_U32 u32FlashSize, MS_U8 *user_buffer)
{
...
#if (SERFLASH_UTOPIA20)
    {
        ...
        {
            printf("Ioctl MDrv_SERFLASH_Write fail\n");
            return FALSE;
        }
        return TRUE;
    }
...
MS_BOOL MDrv_SERFLASH_WriteProtect(MS_BOOL bEnable)
{
...
#if (SERFLASH_UTOPIA20)
    {
        ...
        {
            printf("Ioctl MDrv_SERFLASH_WriteProtect fail\n");
            return FALSE;
        }
        return TRUE;
    }
...
MS_BOOL MDrv_SERFLASH_WriteProtect_Enable_All_Range(void)
{
    ...
    {
        printf("Ioctl MDrv_SERFLASH_WriteProtect_Enable_All_Range fail\n");
        return FALSE;
    }
        return TRUE;
#else
...
MS_BOOL MDrv_SERFLASH_WriteProtect_Disable_All_Range(void)
{
    ...
    {
        printf("Ioctl MDrv_SERFLASH_WriteProtect_Disable_All_Range fail\n");
        return FALSE;
    }
    return TRUE;
#else
...
MS_BOOL MDrv_SERFLASH_WriteProtect_Disable_Range_Set(MS_U32 u32DisableLowerBound, MS_U32 u32DisableSize)
{
#if (SERFLASH_UTOPIA20)
    {
        ...
        {
            printf("Ioctl MDrv_SERFLASH_WriteProtect_Disable_Range_Set fail\n");
            return FALSE;
        }
        return TRUE;
    }
...
MS_BOOL MDrv_SERFLASH_WriteProtect_Area(MS_BOOL bEnableAllArea, MS_U8 u8BlockProtectBits)
{
#if (SERFLASH_UTOPIA20)
		{
			...
			{
				printf("Ioctl MDrv_SERFLASH_WriteProtect_Area fail\n");
				return FALSE;
			}
			return TRUE;
		}
...
#if (SERFLASH_UTOPIA20)
    {
        ...
        if (NULL == pInstantSerFlash)
            return FALSE;
					...
					{
						printf("Ioctl MDrv_SERFLASH_DMA fail\n");
						return FALSE;
					}
					return TRUE;
				}
...
MS_BOOL MDrv_SERFLASH_ReadStatusRegister(MS_U8 *pu8StatusReg)
{
#if (SERFLASH_UTOPIA20)
    {
        ...
        {
            printf("Ioctl MDrv_SERFLASH_ReadStatusRegister fail\n");
	        return FALSE;
        }
		return TRUE;
    }
...
MS_BOOL MDrv_SERFLASH_ReadStatusRegister2(MS_U8 *pu8StatusReg)
{
#if (SERFLASH_UTOPIA20)
    {
		...
		{
            printf("Ioctl MDrv_SERFLASH_ReadStatusRegister2 fail\n");
            return FALSE;
        }
        return TRUE;
    }
...
MS_BOOL MDrv_SERFLASH_WriteStatusRegister(MS_U16 u16StatusReg)
{
#if (SERFLASH_UTOPIA20)
    {
        ...
        {
            printf("Ioctl MDrv_SERFLASH_WriteStatusRegister fail\n");
            return FALSE;
        }
        return TRUE;
    }
                                          ...
                                          MS_U8 u8OpCfg)
{
#if (SERFLASH_UTOPIA20)
    {
        ...
        {
            printf("Ioctl MDrv_SERFLASH_CopyHnd fail\n");
            return FALSE;
        }
        return TRUE;
    }
...
{
    //DEBUG_SER_FLASH(E_SERFLASH_DBGLV_DEBUG, printf("%s(%p)\n", __FUNCTION__, pu8StatusReg));
...
{
    //DEBUG_SER_FLASH(E_SERFLASH_DBGLV_DEBUG, printf("%s(0x%08x, %p)\n", __FUNCTION__, (unsigned int)u32FlashAddr, pu16BlockIndex));
...
{
    //DEBUG_SER_FLASH(E_SERFLASH_DBGLV_DEBUG, printf("%s(0x%04x, %p)\n", __FUNCTION__, u16BlockIndex, pu32FlashAddr));
...
{
    //DEBUG_SER_FLASH(E_SERFLASH_DBGLV_DEBUG, printf("%s(0x%04x, 0x%04x, %d)\n", __FUNCTION__, u16StartBlock, u16EndBlock, (int)bWait));
