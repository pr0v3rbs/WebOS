...
#if 0
#define PREFIX(MODULE) MS_U32 MODULE##RegisterToUtopia(void);
INCLUDED_MODULE
#undef PREFIX
#endif
...
MS_U32 UtopiaInit()
{
    printf("\033[35m[NOS] UtopiaInit\033[m\n\n");
    MsOS_SHM_Init();
...
#ifdef CONFIG_PUMABOOT
    printf("\033[35m[PumaBoot] Driver Register to Utopia\033[m\n");
...
MS_U32 UtopiaClose(void* pInstantTmp)
{
    ...
    printf("\n[UTOPIA INFO] close moduleNames[%lu]: %s\n\n", pInstant->psModule->u32ModuleID, moduleNames[pInstant->psModule->u32ModuleID]);
