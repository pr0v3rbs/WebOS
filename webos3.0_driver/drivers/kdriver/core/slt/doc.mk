...
DOC_PROJECT_NAME=lg1150/sample
DOC_PROJECT_VERSION=v1.0
DOC_INPUT_DIR=../include
DOC_OUTPUT_DIR=../../doc
...
build_doc: clean_doc
	DOC_INPUT_DIR=${DOC_INPUT_DIR} DOC_OUTPUT_DIR=${DOC_OUTPUT_DIR} DOC_PROJECT_NAME=${DOC_PROJECT_NAME} DOC_PROJECT_VERSION=${DOC_PROJECT_VERSION} doxygen ${DOC_CONFIG}
