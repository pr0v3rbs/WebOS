...
/*-----------------------------------------------------------------------------
	0x0014 addr_sw_de_sav ''
-----------------------------------------------------------------------------*/
/*	no field */

/*-----------------------------------------------------------------------------
	0x0018 addr_sw_cpu_gpu ''
-----------------------------------------------------------------------------*/
/*	no field */

/*-----------------------------------------------------------------------------
	0x001c addr_sw_cpu_shadow ''
-----------------------------------------------------------------------------*/
/*	no field */

typedef struct {
	SW_RST                          	sw_rst                          ;	// 0x0000 : ''
	UINT32                          	clk_enable                      ;	// 0x0004 : ''
	...
	UINT32                          	addr_sw_de_sav                  ;	// 0x0014 : ''
	UINT32                          	addr_sw_cpu_gpu                 ;	// 0x0018 : ''
	UINT32                          	addr_sw_cpu_shadow              ;	// 0x001c : ''
} ICOD_REG_T;
/* 8 regs, 8 types */

/* 8 regs, 8 types in Total*/
...
/* from 'ICOD.csv' 20110414 08:55:38   대한민국 표준시 by getregs v2.7 */
