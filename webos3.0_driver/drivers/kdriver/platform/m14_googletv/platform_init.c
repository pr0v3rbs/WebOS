...
/* memory tune history
 *
 * raxis.lim (2013/01/03)
 * - GFX surface decreased from 180MB to 32MB
 *   so, DDR0 base address is moved
 *		from 0x5d00_0000 to 0x6640_0000 for M14Ax.
 *		from 0x6700_0000 to 0x7040_0000 for M14Bx.
 *
 * raxis.lim (2013/01/03)
 * - GFX surface decreased more to 16MB.
 *   so, DDR0 base address is moved ( memory align by 16MB )
 *		from 0x5d00_0000 to 0x6600_0000 for M14Ax.
 *		from 0x6700_0000 to 0x7000_0000 for M14Bx.
 */
...
void        BASE_PLT_Init   ( void )
{
	...
	switch( lx_chip_rev()&0xfff0 )	/* convert M14Ax to M14A0, M14Bx to M14B0 */
	{
		...
		default:
			mem_layout_tbl[0].base = 0x70000000; 	// 0x7000_0000 - 0x7FFF_FFFF
			mem_layout_tbl[0].size = 256<<20; 		// 256MB
