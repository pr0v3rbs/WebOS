 ...
 *
 ----------------------------------------------------------------------------------------*/
#define CONFIG_LX_CHIP_EMUL			LX_CHIP_REV(H15,A0)	/* 0x17A0 = H15A0 */
...
#define CONFIG_LX_GRAPHIC_RES       LX_MAKE_RES(3840,2160)  /* 0x0: auto detect. call lx_chip_graphic_res() to get resolution */
