...
int g_M14Ax_enable_vps_slicer = 0;

/*----------------------------------------------------------------------------------------
	global Variables
----------------------------------------------------------------------------------------*/
int gTTXCountOfLine318_M14A0;
int gTTXCountOfOtherLine_M14A0;
...
int TTX_HWInitialize_M14Ax(void)
{
	...
	TTX_PRINT("VBI TTX Initialize for M14Ax entered!\n");

	gTTXCountOfLine318_M14A0 = 0;
	...
	CVD_M14Ax_Wr01(vbi_ctrl_001, reg_vbi_little_endian, 0);
	...
	TTX_PRINT("VBI TTX Initialize for M14Ax is succefully done!\n");
	return ret;
}

int TTX_HWUninitialize_M14Ax(void)
{
	int ret = 0;
...
//			CVD_M14Ax_WrFL(vbi_016);
		...
		case eTTX625B:
			...
			CVD_M14Ax_RdFL(iris_040);
			CVD_M14Ax_RdFL(vbi_004);
			CVD_M14Ax_RdFL(vbi_013);
			CVD_M14Ax_RdFL(vbi_012);

			/* Added for M14Ax on improving performance & bugs... */
			/* 2012.10.22 won.hur */
			CVD_M14Ax_RdFL(vbi_021);
			...
			CVD_M14Ax_Wr(vbi_007, 0x66666666);
			CVD_M14Ax_Wr(vbi_008, 0x66666666);
			// 110917 by dws : Enable 16, 329 line TTX Slicing
			CVD_M14Ax_Wr(vbi_009, 0x66666666);
			//CVD_M14Ax_Wr(vbi_009, 0x66663366);
			CVD_M14Ax_Wr(vbi_010, 0x66666666);
			// 110917 by dws : Disable 336 line WSS Slicing
			CVD_M14Ax_Wr(vbi_011, 0x660C0000);
			//CVD_M14Ax_Wr(vbi_011, 0x66cc0000);
			// vbi_data_hlvl & start_code
			CVD_M14Ax_Wr(vbi_006, 0x2736);
			// reg_vps_start & reg_teletext_start & reg_wss625_start & vbi_020
			CVD_M14Ax_Wr(vbi_020, 0x54845a5a);
			CVD_M14Ax_Wr(vbi_014, 0x35A00F91);

			//CVD_M14Ax_Wr(vbi_015, 0x2066159a);
			// 110712 : WSS malfunction on green/red pattern
			//CVD_M14Ax_Wr01(vbi_015, reg_wss625_dto, 0x205A);		//13.48MHz
			CVD_M14Ax_Wr01(vbi_015, reg_wss625_dto, 0x2066);		//13.5MHz
			CVD_M14Ax_Wr01(vbi_015, reg_vps_dto, 0x159a);

			CVD_M14Ax_Wr01(vbi_016, reg_wss625_frame_start, 0x2);
			CVD_M14Ax_Wr01(iris_040, reg_vsync_vbi_max, 0x25);

			// 110712 : WSS malfunction on green/red pattern
			CVD_M14Ax_Wr01(vbi_013, reg_vbi_wss_slicer_mode, 0x1);

			CVD_M14Ax_Wr01(vbi_004, reg_vbi_muxout, 0);
			CVD_M14Ax_Wr01(vbi_004, reg_vbi_hsyncout, 0);
			CVD_M14Ax_Wr01(vbi_004, reg_vbi_en, VBI_ON);
			...
			CVD_M14Ax_WrFL(iris_040);
			CVD_M14Ax_WrFL(vbi_004);
			CVD_M14Ax_WrFL(vbi_013);

#if 0		//2012.05.04 there is no such reigister on H13 compared to l9b2
			// 110905 for L9B0 54MHz TTX
			CVD_M14Ax_RdFL(vbi_022);
			CVD_M14Ax_Wr01(vbi_022, reg_ttx_out_sel, 0x0);	//select 54Mhz or 27Mhz TTX
			CVD_M14Ax_Wr01(vbi_022, reg_ttx_vbi_en, 0x1);
			CVD_M14Ax_Wr01(vbi_022, reg_ttx_adap_slvl_en, 0x1);
			CVD_M14Ax_Wr01(vbi_022, reg_ttx_vbi_data_hlvl, 0x36);
			CVD_M14Ax_WrFL(vbi_022);

			CVD_M14Ax_RdFL(vbi_023);
			CVD_M14Ax_Wr01(vbi_023, reg_ttx_tt_slicer_mode, 0x0);
			CVD_M14Ax_Wr01(vbi_023, reg_ttx_teletext_runin_accum_amp, 0x40);
			CVD_M14Ax_Wr01(vbi_023, reg_ttx_vbi_tele_lpfil_acq_gain, 0x8);
			CVD_M14Ax_Wr01(vbi_023, reg_ttx_vbi_tele_lpfil_track_gai, 0x4);
			CVD_M14Ax_Wr01(vbi_023, reg_ttx_vbi_tele_lpfil_fine_gain, 0x2);
			CVD_M14Ax_Wr01(vbi_023, reg_ttx_teletext_start, 0x5a);
			CVD_M14Ax_WrFL(vbi_023);

			CVD_M14Ax_RdFL(vbi_024);
			CVD_M14Ax_Wr01(vbi_024, reg_ttx_vbi_fixgate_en, 0x0);
			CVD_M14Ax_Wr01(vbi_024, reg_ttx_teletext_dto, 0x1f22);
			CVD_M14Ax_Wr01(vbi_024, reg_ttx_teletext_frame_start, 0x2);
			CVD_M14Ax_Wr01(vbi_024, reg_ttx_start_code, 0x27);
			CVD_M14Ax_WrFL(vbi_024);
#endif

			/* Added for M14Ax on improving performance & bugs... */
			/* 2012.10.22 won.hur */
			CVD_M14Ax_Wr(vbi_021, 0x00011044);
			CVD_M14Ax_Wr(vbi_023, 0x5F0A0110);
			...
			CVD_M14Ax_Wr(vbi_037, 0x00000000);
			CVD_M14Ax_Wr(vbi_038, 0x00000111);

			CVD_M14Ax_WrFL(vbi_021);
			CVD_M14Ax_WrFL(vbi_023);
			CVD_M14Ax_WrFL(vbi_024);
			...
			CVD_M14Ax_Wr(vbi_012, 0x00006600);
			CVD_M14Ax_WrFL(vbi_012);
...
int TTX_SetInterrupt_M14Ax(int on_off)
{
	...
	if(on_off)
	{
		...
		CVD_M14Ax_Wr(cvd_intr1_enable1, (intr_vp1_en |= M14A0_VBI_INTERRUPT_MASK));
...
int TTX_ParsingVBIData_M14Ax(sHeaderData *data )
{
	...
	switch(buffer_number)
	{
		case 0:
			...
			CVD_M14Ax_Rd01(vbi_ctrl_002, reg_vbi0_start_addr, data->start);
			CVD_M14Ax_Rd01(vbi_ctrl_003, reg_vbi0_end_addr, data->end);
			CVD_M14Ax_Rd01(vbi_ctrl_002, reg_vbi0_data_cnt, data->count);
			break;
		case 1:
			CVD_M14Ax_RdFL(vbi_ctrl_004);
			CVD_M14Ax_RdFL(vbi_ctrl_005);

			CVD_M14Ax_Rd01(vbi_ctrl_004, reg_vbi1_start_addr, data->start);
			CVD_M14Ax_Rd01(vbi_ctrl_005, reg_vbi1_end_addr, data->end);
			CVD_M14Ax_Rd01(vbi_ctrl_004, reg_vbi1_data_cnt, data->count);
			break;
		case 2:
			CVD_M14Ax_RdFL(vbi_ctrl_006);
			CVD_M14Ax_RdFL(vbi_ctrl_007);

			CVD_M14Ax_Rd01(vbi_ctrl_006, reg_vbi2_start_addr, data->start);
			CVD_M14Ax_Rd01(vbi_ctrl_007, reg_vbi2_end_addr, data->end);
			CVD_M14Ax_Rd01(vbi_ctrl_006, reg_vbi2_data_cnt, data->count);
			break;
		case 3:
			CVD_M14Ax_RdFL(vbi_ctrl_008);
			CVD_M14Ax_RdFL(vbi_ctrl_009);

			CVD_M14Ax_Rd01(vbi_ctrl_008, reg_vbi3_start_addr, data->start);
			CVD_M14Ax_Rd01(vbi_ctrl_009, reg_vbi3_end_addr, data->end);
			CVD_M14Ax_Rd01(vbi_ctrl_008, reg_vbi3_data_cnt, data->count);
		break;
	}
	...
	else
	{
		...
		for(i=0;i<MAX_PACKET_NUM;i++)
		{
			...
			if( ( *(ucPacket + iHeaderPos + 0) == 0x00) && ( *(ucPacket + iHeaderPos + 1) == 0xff) && (*(ucPacket+iHeaderPos+2) == 0xff))
			{
				...
				if( ( *(ucPacket + iHeaderPos + 6) == 0x01) && ( *(ucPacket + iHeaderPos + 5) == 0x3e)) gTTXCountOfLine318_M14A0++;
				else gTTXCountOfOtherLine_M14A0++;
...
int TTX_Enable_VPS_Slicer_M14Ax(BOOLEAN Enable)
{
	...
	if(Enable){
		CVD_M14Ax_Wr01(vbi_009, reg_vbil16, 0x63);	// Enable VPS Slicing on Line #16
		g_M14Ax_enable_vps_slicer = 1;
	}
	else{
 		VBI_TTX_ClearVPSMemory();
		CVD_M14Ax_Wr01(vbi_009, reg_vbil16, 0x66);	// Enable TTX Slicing on Line #16
		g_M14Ax_enable_vps_slicer = 0;
	}
	CVD_M14Ax_WrFL(vbi_009);
...
int TTX_SetVBILPF_M14Ax(int onoff)
{
	...
	CVD_M14Ax_RdFL(vbi_005);

	if(onoff)
	{
		CVD_M14Ax_Wr(vbi_005, 0x00000001);
	}
	else
	{
		CVD_M14Ax_Wr(vbi_005, 0x00000000);
	}

	CVD_M14Ax_WrFL(vbi_005);
...
int TTX_CheckOnLine318_M14Ax(int mode)
{
	...
	if(mode)
	{
		...
		gTTXCountOfLine318_M14A0 = 0;
		gTTXCountOfOtherLine_M14A0 = 0;
		ret = 1;
	}
	else
	{
		//TTX_PRINT("Count of line 318 vs Other is [%d]/[%d]\n", gTTXCountOfLine318, gTTXCountOfOtherLine);
		if(gTTXCountOfLine318_M14A0 > 10)
		{
			if(gTTXCountOfOtherLine_M14A0 > 10) ret = 4;   // Case when data is also in line 318.
...
int TTX_SetTypeLine318_M14Ax(int onoff)
{
	...
	if(onoff)
	{
		...
		CVD_M14Ax_Wr(vbi_012, 0x00000060);
	}
	else
	{
		//TTX_PRINT("Detection for line 318 is off.\n");
		CVD_M14Ax_Wr(vbi_012, 0x00000000);
	}
...
int TTX_Set_TT_Slicer_Mode_M14Ax(unsigned int mode)
{
	...
	if(mode < 4)
	{
		CVD_M14Ax_Wr01(vbi_013, reg_vbi_tt_slicer_mode, mode);
		CVD_M14Ax_WrFL(vbi_013);
		ret = 0;
	}
	else
...
int TTX_CheckVline625_M14Ax(void)
{
	...
	if(g_M14Ax_enable_vps_slicer == 1) {
			CVD_M14Ax_RdFL(vbi_007);
			CVD_M14Ax_RdFL(vbi_008);
			CVD_M14Ax_RdFL(vbi_009);
			CVD_M14Ax_RdFL(vbi_010);
			...
			CVD_M14Ax_Wr01(vbi_009, reg_vbil16, 0x63);
			CVD_M14Ax_Wr01(vbi_015, reg_wss625_dto, 0x2066);		//13.5MHz
	...
	if(isVline625 == 0)
	{
		if(isVline625 != gPrevVline625)
		{
			...
			CVD_M14Ax_Wr(vbi_007, 0x00000000);
			CVD_M14Ax_Wr(vbi_008, 0x00000000);
			CVD_M14Ax_Wr(vbi_009, 0x00000000);
			CVD_M14Ax_Wr(vbi_010, 0x1100DD11);	// Becareful of RTL bug
			CVD_M14Ax_Wr(vbi_011, 0x00000000);
			CVD_M14Ax_Wr01(vbi_015, reg_wss625_dto, 0x1E2B);		//13.5MHz
...
int TTX_RunResume_M14Ax(void)
{
	...
	TTX_SetInputFormat_M14Ax(CURRENT_TTX);
