...
#define SLT_FDD_OFFSET	0x400  
#define SLT_DPE_OFFSET	0xC00

#ifdef SLT_FDD
#define M14B0_SLT_BASE		(M14_B0_SLT_BASE + SLT_FDD_OFFSET)
#define M14B0_IRQ_SLT		(M14_B0_IRQ_SLT)
#else // SLT_DPE
#define M14B0_SLT_BASE		(M14_B0_SLT_BASE + SLT_DPE_OFFSET)
#define M14B0_IRQ_SLT		(M14_B0_IRQ_SLT+1)
#endif
...
static int slt_open( void )
{
	...
	SLT_REG = (volatile M14_SLT_REG_T*)ioremap(M14B0_SLT_BASE, sizeof(M14_SLT_REG_T));
	ret = request_irq(M14B0_IRQ_SLT, (irq_handler_t)slt_isr, IRQF_DISABLED, "SLT", NULL);
