...
#ifndef  _IPC_DEF_M14_H_
#define  _IPC_DEF_M14_H_

/*----------------------------------------------------------------------------------------
 *   Control Constants
 *---------------------------------------------------------------------------------------*/
#define BE_IPC_FROM_CPU_M14A0_BASE       (DPPB_TOP_REG_M14A0_BASE + DPPB_TOP_IPC_M14A0_OFFSET)
#define BE_IPC_FROM_MCU_M14A0_BASE       (BE_IPC_FROM_CPU_M14A0_BASE + IPC_FROM_CPU_SIZE)
...
typedef struct
{
 ...
 // M14B0 IPC command & parameter
typedef enum {
	BE_TOP_B0_INIT					= 0x00000000,
	...
	BE_TOP_B0_SET_VIDEO_TYPE,
	BE_TOP_B0_SET_PANEL_INFO,
	BE_TOP_B0_SET_DEBUG_DISPLAY,		
	BE_TOP_B0_SET_VID_OPERATION,
	BE_TOP_B0_GET_SYSTEM_INFO,

	BE_H3D_B0_SET_MODE				= 0x10000000,
	BE_H3D_B0_T3C_DEPTH_LEVEL,
	BE_H3D_B0_A3C_DEPTH_LEVEL,	
	BE_H3D_B0_A3C_AUTOCONVERGENCE,
	
	BE_FRC_B0_SET_MEMC_MODE		= 0x20000000,
	BE_FRC_B0_SET_LOW_DELAY,
	BE_FRC_B0_SET_YUV444,
	BE_FRC_B0_ENABLE_DEBUG_BOX,
	BE_FRC_B0_SET_FREEZE,
	
	BE_LED_B0_LOAD_LUT				= 0x50000000,
	BE_LED_B0_SET_MODE,
	BE_LED_B0_CONTROL,
	BE_HDR_B0_LOAD_LUT,
	BE_HDR_B0_SET_MODE,
...
typedef struct
{
	UINT32	uMainVideoType;
	UINT32	rsvd[2];
} BE_IPC_B0_VIDEO_TYPE_T;

typedef struct
{
	UINT32	uPanelRate;          // 0 : 60Hz, 1 : 120Hz, 2 : SetTop Mode
	UINT32	uPanelRvrsEnable;    // 0 : Normal, 1 : Reverse
	UINT32	rsvd[2];
} BE_IPC_B0_PANEL_INFO_T;

typedef struct
{
	UINT32  	uH3DDebugdisplay;
	UINT32  	uFRCDebugDisplay;
...
typedef struct
{
	UINT32  	uVideoOperation;
	UINT32  	rsvd[3];
} BE_IPC_B0_VID_OPERATION_T;
...
typedef struct
{
	UINT32  	uA3CDepth;
	UINT32  	rsvd[3];
} BE_IPC_B0_H3D_A3C_DEPTH_T;

typedef struct
{
	UINT32  	bTDAutoConvOn;
	UINT32  	rsvd[3];
} BE_IPC_B0_H3D_AUTOCONVERGENCE_T;
...
typedef struct
{
	...
	UINT32  	uFRCBlur;
	UINT32  	rsvd;
} BE_IPC_B0_FRC_MEMC_MODE_T;

typedef struct
{
	UINT32  	bFRCLowDelay;
	UINT32  	rsvd[3];
} BE_IPC_B0_FRC_LOW_DELAY_T;

typedef struct
{
	UINT32  	bFRCProcYUV444;      // 0 : 422, 1 : 444
	UINT32  	rsvd[3];
} BE_IPC_B0_FRC_COLOR_YUV444_T;

typedef struct
{
	UINT32  	uDeboxMode;      // 0 : OFF,  1 :FRC, 2: 3D,  3: DE
	UINT32  	rsvd[3];
} BE_IPC_B0_FRC_ENABLE_DEBUG_BOX_T;

  typedef struct
{
	UINT32  	bFRCFreeze;
	UINT32  	rsvd[3];
} BE_IPC_B0_FRC_FREEZE_T;
...
typedef struct
{
	UINT32 	bLEDControl;
	UINT32 	rsvd[3];
}  BE_IPC_B0_LED_CONTROL_T;

typedef struct
{
	UINT32 	bHDRLutLoad;
	UINT32 	rsvd[3];
} BE_IPC_B0_HDR_LOAD_LUT_T;

typedef struct
{
    	UINT32 	uHDRMode;
    	UINT32 	rsvd[3];
}  BE_IPC_B0_HDR_MODE_T;

typedef struct
{
    	UINT32 	uHDRControl;
    	UINT32 	rsvd[3];
}  BE_IPC_B0_HDR_CONTROL_T;
...
typedef struct
{
    	UINT32 	uWCGMode;	// 0:BT709, 1:SMPTE, 2:EBU, 3:Color Extension
    	UINT32 	rsvd[3];
