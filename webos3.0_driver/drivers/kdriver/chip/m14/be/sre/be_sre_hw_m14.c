...
/*----------------------------------------------------------------------------------------
	Static Variables
----------------------------------------------------------------------------------------*/
static BE_SRE_HW_M14_INFO_T	_beSREHwM14Info =
{
	.u8SrControl 		= 0xFF,
...
int BE_SRE_HW_M14_Initialize(void)
{
	int ret = RET_OK;
...
int BE_SRE_HW_M14_Set_Command(LX_BE_SRE_CMN_T *pstParams)
{
	int ret = RET_OK;
	...
	do {
		...
		else
		{
			...
			IPC_SET_DEFAULT_PARAM(BE_IPC_SRE_GLOBAL_SCALE_T, stGScaleParams);
			IPC_SET_DEFAULT_PARAM(BE_IPC_SRE_INPUT_MODE_T, stInputModeParams);
			IPC_SET_DEFAULT_PARAM(BE_IPC_SRE_UPDATE_ALL_T, stUpdateParams);
			IPC_SET_DEFAULT_PARAM(BE_IPC_SRE_CONTROL_T, stCtrlParams);
			...
			/* Step 2-1.  */
			if (_beSREHwM14Info.u8SrControl != (UINT8)stCtrlParams.u4Control)
			{
				...
				if(ret) BREAK_WRONG(ret);
				_beSREHwM14Info.u8SrControl = (UINT8)stCtrlParams.u4Control;
				updateCount++;
			}

			/* Step 2-2.  */
			if ((_beSREHwM14Info.u8SrAGlobalScale != (UINT8)stGScaleParams.u8SRAGlobalScale)
				|| (_beSREHwM14Info.u8SrBGlobalScale != (UINT8)stGScaleParams.u8SRBGlobalScale))
			{
				/* return unexpected value */
				...
				if(ret) BREAK_WRONG(ret);
				_beSREHwM14Info.u8SrAGlobalScale = (UINT8)stGScaleParams.u8SRAGlobalScale;
				_beSREHwM14Info.u8SrBGlobalScale = (UINT8)stGScaleParams.u8SRBGlobalScale;
				updateCount++;
			}

			/* Step 2-3.  */
			if ((_beSREHwM14Info.u8InputResolution != (UINT8)stInputModeParams.u4InputResolution)
				|| (_beSREHwM14Info.u8Input3DMode != (UINT8)stInputModeParams.u4Input3DMode))
			{
				/* return unexpected value */
				...
				if(ret) BREAK_WRONG(ret);
				_beSREHwM14Info.u8InputResolution = (UINT8)stInputModeParams.u4InputResolution;
				_beSREHwM14Info.u8Input3DMode    = (UINT8)stInputModeParams.u4Input3DMode;
				updateCount++;
			}
...
int BE_SRE_HW_M14_Set_Params(LX_BE_SRE_PRAM_T *pstParams)
{
	int ret = RET_OK;
	...
	do {
		...
		else
		{
			int updateCount = 0;
			IPC_SET_GET_PARAM(BE_IPC_H3D_MODE_T, stIpcH3dModeParams);
			IPC_SET_DEFAULT_PARAM(BE_IPC_SRE_DB_GRADE_T, stDbGradeParams);
			IPC_SET_DEFAULT_PARAM(BE_IPC_SRE_LOCAL_SCALE_T, stLScaleParams);
			IPC_SET_DEFAULT_PARAM(BE_IPC_SRE_PREPROCESSING_T, stPreProcParams);
			IPC_SET_DEFAULT_PARAM(BE_IPC_SRE_INPUT_MODE_T, stInputModeParams);
			IPC_SET_DEFAULT_PARAM(BE_IPC_SRE_UPDATE_ALL_T, stUpdateParams);
			...
			/* Step 2-1.  */
			if ( _beSREHwM14Info.u8DbGrade != (UINT8)stDbGradeParams.u8DBGrade )
			{
				/* return unexpected value */
				...
				if(ret) BREAK_WRONG(ret);
				_beSREHwM14Info.u8DbGrade = (UINT8)stDbGradeParams.u8DBGrade;
				updateCount++;
			}

			/* Step 2-2.  */
			if ( (_beSREHwM14Info.u8ModeLocalScale != stLScaleParams.u4ModeLocalScale)
				|| (_beSREHwM14Info.u8SrALocalScale != stLScaleParams.u4SRALocalScale)
				|| (_beSREHwM14Info.u8SrBLocalScale != stLScaleParams.u4SRBLocalScale) )
			{
				/* return unexpected value */
				...
				if(ret) BREAK_WRONG(ret);
				_beSREHwM14Info.u8ModeLocalScale = stLScaleParams.u4ModeLocalScale;
				_beSREHwM14Info.u8SrALocalScale    = stLScaleParams.u4SRALocalScale;
				_beSREHwM14Info.u8SrBLocalScale    = stLScaleParams.u4SRBLocalScale;
				updateCount++;
			}
			...
			/* Step 2-3.  */
			if ( (_beSREHwM14Info.u8PP_XFilter != stPreProcParams.u8XFilter)
				|| (_beSREHwM14Info.u8PP_YFilter != stPreProcParams.u8YFilter)
				|| (_beSREHwM14Info.u8PP_GlobalScale != stPreProcParams.u8GlobalScale)
				|| (_beSREHwM14Info.u8PP_LocalScale  != stPreProcParams.u8LocalScale) )
			{
				/* return unexpected value */
				...
				if(ret) BREAK_WRONG(ret);
				_beSREHwM14Info.u8PP_XFilter 		= stPreProcParams.u8XFilter;
				_beSREHwM14Info.u8PP_YFilter    	= stPreProcParams.u8YFilter;
				_beSREHwM14Info.u8PP_GlobalScale   = stPreProcParams.u8GlobalScale;
				_beSREHwM14Info.u8PP_LocalScale    = stPreProcParams.u8LocalScale;
				updateCount++;
...
int BE_SRE_HW_M14_Get_Version(LX_BE_SRE_VERSION_T *pstParams)
{
	int ret = RET_OK;
...
int BE_SRE_HW_M14_Set_Input_Format(LX_BE_SRE_INPUT_MODE_T *pstParams)
{
	int ret = RET_OK;
	...
	do {
		...
		{
			IPC_SET_DEFAULT_PARAM(BE_IPC_SRE_INPUT_MODE_T, stHwParams);
