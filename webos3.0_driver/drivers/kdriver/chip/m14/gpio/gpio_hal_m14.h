...
#ifndef	_GPIO_DRV_HAL_M14_A0_H_
#define	_GPIO_DRV_HAL_M14_A0_H_
...
extern UINT32 		gpio_intr_num_m14[GPIO_IRQ_NUM_NR];

extern void _GPIO_ISR_GPIO_M14( unsigned int ui32IRQNum, unsigned int IntData );
#endif
