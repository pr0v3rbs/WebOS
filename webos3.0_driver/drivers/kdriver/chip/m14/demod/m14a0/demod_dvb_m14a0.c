 ...
 ************************************************************************************/
 ...
 UINT16 _gM14A0GBB_FullDVBPkerrCount = 9;
UINT16 _gM14A0GBB_FullDVBPkerrThreshold = 170;

UINT8 gM14A0GBB_PowerOnInitDVB = 1;
unsigned int 			gM14A0GBB_PowerOnInitStartTimeDVB = 0;


/***********************************************************************************
	Static Variable & Function Prototypes Declarations
 ************************************************************************************/
static	UINT16			_gM14A0GBB_DVB_UnlockCount_full_packeterr	= 0;


/***********************************************************************************
************************************************************************************/
/**
 * DEMOD_M14A0_DVBC_AutoSymbolRateDet
...
*/
int DEMOD_M14A0_DVBC_AutoSymbolRateDet(LX_DEMOD_SYMRDET_MODE_T symrateMode, UINT16 SymbolRate )
{
	...
	switch(symrateMode)
	{
		...
		case LX_DEMOD_SYMR_FIXED_MODE :
		{
			...
			srdfbsymrate_16 = 0;
			DEMOD_PRINT("[DEMOD M14A0] symbol_temp = 0x%llx \n",symbol_temp);
			DEMOD_PRINT("[DEMOD M14A0] srdfbsymrate0_15_8 = 0x%x \n",srdfbsymrate_15_8);
			DEMOD_PRINT("[DEMOD M14A0] srdfbsymrate0_7_0 = 0x%x \n",srdfbsymrate_7_0);
...
************************************************************************************/
/**
 * DEMOD_M14A0_DVBC_IsSymbolRateAuto
 * Enable/Diable automatic symbol rate detection on DVB-C mode.
 *
 * @param  *bAuto - BOOLEAN.
 * @return if Succeeded - RET_OK else-RET_ERROR
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14A0_DVBC_IsSymbolRateAuto(BOOLEAN *bAuto)
{
	...
	{
		*bAuto = FALSE;
		DEMOD_PRINT("[DEMOD M14A0] Auto Symbolrate detection is disabled  !!!\n");
	}
	else
	{
		*bAuto = TRUE;
		DEMOD_PRINT("[DEMOD M14A0] Auto Symbolrate detection is enabled  !!!\n");
	}
...
************************************************************************************/
/**
 * DEMOD_M14A0_DVBC_IsQammodeAutoDet
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14A0_DVBC_IsQammodeAutoDet (BOOLEAN *bAutoQam)
{
	...
	{
		*bAutoQam = TRUE;
		DEMOD_PRINT("[DEMOD M14A0] Auto QAM mode detection is enabled  !!!\n");
	}
	else
	{
		*bAutoQam = FALSE;
		DEMOD_PRINT("[DEMOD M14A0] Auto QAM mode detection is disabled  !!!\n");
	}
...
************************************************************************************/
/**
 * DEMOD_M14A0_DVBC_Set_DefaultRegisterValue
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14A0_DVBC_Set_DefaultRegisterValue(void)
{
...
/*****************************************************************************************/
	...
	_gM14A0GBB_DVB_UnlockCount_full_packeterr = 0;
...
************************************************************************************/
/**
 * DEMOD_M14A0_DVBC_Set_Config_auto
 * Control automatic setting of DVBC config.
 *
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14A0_DVBC_Set_Config_auto (BOOLEAN bAutoDetect)
{
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14A0_DVBC_Set_QamMode (LX_DEMOD_RF_MODE_T constel)
{
...
************************************************************************************/
/**
 * DEMOD_M14A0_DVBC_Set_NeverLockWaitTime
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14A0_DVBC_Set_NeverLockWaitTime(UINT32 waitMs)
{
...
************************************************************************************/
/**
 * DEMOD_M14A0_DVBC_Get_SymbolRateDetect
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14A0_DVBC_Get_SymbolRateDetect(UINT16 *pSymbolRate)
{
		...
		*pSymbolRate = (UINT16)(symbolRateKHz);
		...
		DEMOD_PRINT("[DEMOD M14A0] Symbol rate is %d [KHz]!!!\n",symbolRateKHz);
...
************************************************************************************/
/**
 * DEMOD_M14A0_DVBC_Get_SymbolRateStatus
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14A0_DVBC_Get_SymbolRateStatus(LX_DEMOD_SYMBOLRATE_STATE_T *pSymbolRateDet)
{
	...
	if(1 == srdlock)
	{
		...
		DEMOD_PRINT("[DEMOD M14A0] Success (%s:%d) Symbol rate is detected !!!\n", __F__, __L__);
		if (RET_OK != DEMOD_M14A0_DVBC_Get_SymbolRateDetect(&symbolRate))
		{
			DEMOD_PRINT("[DEMOD M14A0] FAIL (%s:%d) Symbol rate couldn't be read !!!\n", __F__, __L__);
			return RET_ERROR;
		}
	...
	{
		DEMOD_PRINT("[DEMOD M14A0] FAIL (%s:%d) Symbol rate couldn't be detected !!!\n", __F__, __L__);
...
************************************************************************************/
/**
 * DEMOD_M14A0_DVBC_Get_QamModeDetectStatus
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14A0_DVBC_Get_QamModeDetectStatus(LX_DEMOD_QAMMODE_STATE_T *pQamModeDet)
{
	...
	if(qmden == 1)
	{
		...
		switch(qmdstatus_1_0)
		{
			...
			case 0x02 :
			{
				...
				if (RET_OK != DEMOD_M14A0_Get_QAMMode(&qamMode ))
				{
					DEMOD_PRINT("[DEMOD M14A0] FAIL (%s:%d) DEMOD_M14A0_DVB_Get_QAMMode() !!!\n", __F__, __L__);
					return RET_ERROR;
				}
...
************************************************************************************/
/**
 * DEMOD_M14A0_DVBC_Obtaining_Signal_Lock.
...
int DEMOD_M14A0_DVBC_Obtaining_Signal_Lock(DEMOD_CTX_T *pDemodInfo)
{
		...
		case LX_DEMOD_RETUNE_RF:			/***************************************************/
			{
				...
				if(RET_OK != DEMOD_M14A0_DVBC_Set_DefaultRegisterValue())
				{
					DEMOD_PRINT("[DEMOD M14A0] FAIL (%s:%d) DEMOD_M14A0_DVBC_Set_DefaultRegisterValue() !!!\n", __F__, __L__);
					DEMOD_RETURN_FAIL(__F__);
				}

				if(RET_OK != DEMOD_M14A0_DVBC_Set_NeverLockWaitTime(LX_DEMOD_DVBC_NEVERLOCK_WAIT_TIME))
				{
					DEMOD_PRINT("[DEMOD M14A0] FAIL (%s:%d) DEMOD_M14A0_DVBC_Set_NeverLockWaitTime() !!!\n", __F__, __L__);
					DEMOD_RETURN_FAIL(__F__);
				}
				if(LX_DEMOD_TUNE_NORMAL != pDemodInfo->setCfgParam.dvbc.tuneMode)
				{
					if(RET_OK != DEMOD_M14A0_DVBC_Set_Config_auto(TRUE))
					{
						DEMOD_PRINT("[DEMOD M14A0] FAIL (%s:%d) DEMOD_M14A0_DVBC_Set_Config_auto() !!!\n", __F__, __L__);
						DEMOD_RETURN_FAIL(__F__);
					}

					if(RET_OK != DEMOD_M14A0_DVBC_AutoSymbolRateDet(LX_DEMOD_SYMR_FULL_SCAN_MODE, LX_DEMOD_SYMBOL_RATE_6900_KHZ))
					{
						DEMOD_PRINT("[DEMOD M14A0] FAIL (%s:%d) DEMOD_M14A0_DVBC_AutoSymbolRateDet() !!!\n", __F__, __L__);
						DEMOD_RETURN_FAIL(__F__);
					}
...
#else
					if(RET_OK != DEMOD_M14A0_DVBC_Set_Config_auto(FALSE))
					{
						DEMOD_PRINT("[DEMOD M14A0] FAIL (%s:%d) DEMOD_M14A0_DVBT_Set_Config_auto() !!!\n", __F__, __L__);
						DEMOD_RETURN_FAIL(__F__);
					}

					if(RET_OK != DEMOD_M14A0_DVBC_AutoSymbolRateDet(LX_DEMOD_SYMR_FIXED_MODE, pDemodInfo->setCfgParam.dvbc.symbolRate))
					{
						DEMOD_PRINT("[DEMOD M14A0] FAIL (%s:%d) DEMOD_M14A0_DVBC_AutoSymbolRateDet() !!!\n", __F__, __L__);
						DEMOD_RETURN_FAIL(__F__);
					}

					if(RET_OK != DEMOD_M14A0_DVBC_Set_QamMode(pDemodInfo->setCfgParam.dvbc.qamMode))
					{
						DEMOD_PRINT("[DEMOD M14A0] FAIL (%s:%d) DEMOD_M14A0_DVBC_Set_QamMode() !!!\n", __F__, __L__);
						DEMOD_RETURN_FAIL(__F__);
					}
		...
		case LX_DEMOD_TUNE_START:			/***************************************************/
			{
				...
				if(LX_DEMOD_TUNE_NORMAL != pDemodInfo->setCfgParam.dvbc.tuneMode)
				{
					...
					DEMOD_PRINT( "^R^[DEMOD M14A0] LX_DEMOD_SYNC_CHECKING : Going to LX_DEMOD_TUNE_SCAN..... ^0^\n");
		...
		case LX_DEMOD_TUNE_SCAN:			/***************************************************/
			{
				...
				{
					DEMOD_PRINT("[DEMOD M14A0] FAIL (%s:%d) DEMOD_NeverlockScan() !!!\n", __F__, __L__);
					DEMOD_RETURN_FAIL(__F__);
				}
				...
				if(LX_DEMOD_LOCKED == lockState)
				{
					...
					if (LX_DEMOD_TUNE_NORMAL == pDemodInfo->setCfgParam.dvbc.tuneMode)
					{
						...
						else
						{
							...
							{
								DEMOD_PRINT("[DEMOD M14A0] FAIL (%s:%d) DEMOD_VSB_PreMonitor() !!!\n", __F__, __L__);
								DEMOD_RETURN_FAIL(__F__);
							}
							else
							{
								if(packetError < LX_DEMOD_PACKET_ERROR_THD)
								{
									...
									DEMOD_PRINT_ALWAYS( "[DEMOD M14A0] LX_DEMOD_SIGNAL_STABLE : MSG_DVBC_FRONT_END_LOCKED..... ^^^0^^^\n");
...
int DEMOD_M14A0_DVBC_Monitoring_Signal_Lock(DEMOD_CTX_T *pDemodInfo)
{
	...
	if(LX_DEMOD_LOCKED == lockState)
	{
		...
		if(pDemodInfo->signalStatus.packetError >= _gM14A0GBB_FullDVBPkerrThreshold)
		{
			_gM14A0GBB_DVB_UnlockCount_full_packeterr++;
			DEMOD_PRINT( "^r^[DEMOD M14A0](%s) _gM14A0GBB_DVB_UnlockCount_full_packeterr = %d !!!\n", __F__,_gM14A0GBB_DVB_UnlockCount_full_packeterr);

			if(_gM14A0GBB_DVB_UnlockCount_full_packeterr == _gM14A0GBB_FullDVBPkerrCount)
			{
				...
				DEMOD_PRINT("[DEMOD M14A0](%s) DEMOD_M14A0_DVBT_Set_Config_auto(TRUE) !!!\n", __F__);
		...
		if(pDemodInfo->lockCount == 2)
		{
			...
			pDemodInfo->bNotifiedUnlock = FALSE;
				...
				DEMOD_PRINT_ALWAYS( "[DEMOD M14A0] MONITORING FUNC : MSG_DVBC_FRONT_END_LOCKED..... ^0^\n");
	...
	else
	{
		...
		if((LX_DEMOD_UNLOCKED != pDemodInfo->lockStatus)  && (TRUE != pDemodInfo->bNotifiedUnlock))
		{
			...
			if(pDemodInfo->unLockCount == 4)
			{
				...
				DEMOD_PRINT_ALWAYS( "[DEMOD M14A0] MONITORING FUNC : MSG_DVBC_FRONT_END_NOT_LOCKED..... -_-\n");
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14A0_DVBC_Get_DvbInfo(void)

{
	...
	//IF AGC
	if (RET_OK != DEMOD_M14A0_Get_IFAGC(&ifAGCGain))
	{
	...
	DEMOD_PRINT("[DEMOD M14A0] IF AGC Gain = 0x%x !!!\n",ifAGCGain);

 	//NeverLock status
	if (RET_OK != DEMOD_M14A0_Get_NeverLockStatus(LX_DEMOD_DVBC, &neverLockStatus))
	{

		DEMOD_PRINT("[DEMOD M14A0] FAIL (%s:%d) DEMOD_M14A0_DVBC_Get_NeverLockStatus() !!!\n", __F__, __L__);
	...
	switch(neverLockStatus)
	{
		...
		case LX_DEMOD_IDLE :
			DEMOD_PRINT("[DEMOD M14A0] Initialization process  !!!\n");
			break;

		case LX_DEMOD_DETECTION_PROCESSING :
			DEMOD_PRINT("[DEMOD M14A0] Signal Checking process !!!\n");
			break;

		case LX_DEMOD_DETECTED :
			DEMOD_PRINT("[DEMOD M14A0] normal State (available channel)  !!!\n");
			break;

		case LX_DEMOD_DETECTION_FAIL :
			DEMOD_PRINT("[DEMOD M14A0] neverlock state (empty channel) !!!\n");

			break;

		default :

			DEMOD_PRINT("[DEMOD M14A0] INVALID neverLockStatus !!!\n");
	...
	if (RET_OK != DEMOD_M14A0_Get_Lock(LX_DEMOD_CARR_LOCK,&carrLockState) )
	{
		DEMOD_PRINT("[LX_DEMOD_DTV] FAIL (%s:%d) DEMOD_M14A0_Get_Lock() !!!\n", __F__, __L__);
		return RET_ERROR;
	...
	if(carrLockState == LX_DEMOD_LOCKED)
	{
		...
		DEMOD_PRINT("[DEMOD M14A0] DVB CARRIER is LOCKED  !!!\n");

	}
	else
	{
		DEMOD_PRINT("[DEMOD M14A0] DVB CARRIER is NOT LOCKED  !!!\n");

	}

	// Sampling frequency LOCK status and offset monitoring
	if (RET_OK != DEMOD_M14A0_Get_Lock( LX_DEMOD_TR_LOCK, &samplingLock))
	{
	...
	{
		DEMOD_PRINT("[DEMOD M14A0] Sampling frequency is Locked   !!!\n");
	}
	else
	{
		DEMOD_PRINT("[DEMOD M14A0] Sampling frequency is NOT Locked !!!\n");
	}


	//Symbol rate detection

	if (RET_OK != DEMOD_M14A0_DVBC_IsSymbolRateAuto(&isAutoSymbol))
	{

		DEMOD_PRINT("[DEMOD M14A0] FAIL (%s:%d) DEMOD_M14A0_DVBC_Get_SymbolRateStatus() !!!\n", __F__, __L__);
	...
	{
		if (RET_OK != DEMOD_M14A0_DVBC_Get_SymbolRateStatus(&symbolRateDet))
...

		{
...

			{
				...
				DEMOD_PRINT("[DEMOD M14A0] Symbol rate status is idle status!!!\n");
...

			{
				...
				DEMOD_PRINT("[DEMOD M14A0] Symbol rate  is detected !!!\n");

				DEMOD_PRINT("[DEMOD M14A0] Symbol rate = %d [KHz] !!!\n",symbolRateDet.symbolRate);
...

			{
				...
				DEMOD_PRINT("[DEMOD M14A0] Symbol rate detection is processing !!!\n");
...

			{
				...
				DEMOD_PRINT("[DEMOD M14A0] Symbol rate detection is failed !!!\n");
			...
			default :
			{
				DEMOD_PRINT("[DEMOD M14A0] INVALID Symbol rate detection status  !!!\n");
	...
	if (RET_OK != DEMOD_M14A0_DVBC_IsQammodeAutoDet(&isAutoQammode))
	{

		DEMOD_PRINT("[DEMOD M14A0] FAIL (%s:%d) DEMOD_M14A0_DVBC_IsQammodeAutoDet() !!!\n", __F__, __L__);
	...
	if(TRUE == isAutoQammode)
	{
		...
		if (RET_OK != DEMOD_M14A0_DVBC_Get_QamModeDetectStatus(&qamModeDet))
		{
			DEMOD_PRINT("[DEMOD M14A0] FAIL (%s:%d) DEMOD_M14A0_DVBC_Get_QamModeDetectStatus() !!!\n", __F__, __L__);
		...
		switch(qamModeDet.status)
		{
			case LX_DEMOD_IDLE :
			{
				DEMOD_PRINT("[DEMOD M14A0] QAM mode detect is idle status!!!\n");
			...
			case LX_DEMOD_DETECTED :
			{
				...
				DEMOD_PRINT("[DEMOD M14A0] QAM mode is detected!!!\n");

				DEMOD_PRINT("[DEMOD M14A0] QAM mode is %s !!!\n",(qamModeDet.qamMode == LX_DEMOD_16QAM) ? "16QAM" :
			...
			case LX_DEMOD_DETECTION_PROCESSING :
			{
				...
				DEMOD_PRINT("[DEMOD M14A0] QAM mode detection is processing !!!\n");
			...
			case LX_DEMOD_DETECTION_FAIL :
			{
				...
				DEMOD_PRINT("[DEMOD M14A0] QAM mode detection is failed !!!\n");
			...
			case LX_DEMOD_DETECTION_MANUAL :
			{
				...
				DEMOD_PRINT("[DEMOD M14A0] Manual QAM mode detection mode !!!\n");
			...
			default :
			{
				DEMOD_PRINT("[DEMOD M14A0] INVALID QAM mode detection  !!!\n");
	...
	{
		DEMOD_PRINT("[DEMOD M14A0] Spectrum Inversion !!!\n");
	}
	else
	{
		DEMOD_PRINT("[DEMOD M14A0] Spectrum Normal !!!\n");
	}

	//Frame lock status
	if (RET_OK != DEMOD_M14A0_Get_Lock(LX_DEMOD_FEC_LOCK, &fecLockState) )
	{
		DEMOD_PRINT("[LX_DEMOD_DTV] FAIL (%s:%d) DEMOD_M14A0_Get_Lock() !!!\n", __F__, __L__);
		return RET_ERROR;
	...
	{
		DEMOD_PRINT("[DEMOD M14A0] DVB FEC IS NOT LOCKED !!!\n");
	}
	else
	{
		DEMOD_PRINT("[DEMOD M14A0] DVB FEC LOCK OK !!!\n");
	}
	...
	DEMOD_PRINT("[DEMOD M14A0] mse = %d, constPwr = %d, !!!\n",sigMse.mse, sigMse.constPwr);
 	...
 	//BER after Viterbi
	if (RET_OK != DEMOD_M14A0_Get_VABER(&vBer))
	{
		DEMOD_PRINT("[DEMOD M14A0] FAIL (%s:%d) DEMOD_M14A0_DVBC_Get_SNR() !!!\n", __F__, __L__);
	...
	DEMOD_PRINT("[DEMOD M14A0] vBER = %d  !!!\n",vBer);

	//TP Error count
	errorMode = LX_DEMOD_I2C_READ_BASED;
	if (RET_OK !=  DEMOD_M14A0_Get_Packet_Error(&errorCount))
	{
		DEMOD_PRINT("[DEMOD M14A0] FAIL (%s:%d) DEMOD_M14A0_DVBC_Get_TPError() !!!\n", __F__, __L__);
		return RET_ERROR;
	}
	...
	printk("[DEMOD M14A0] IF AGC Gain = 0x%x !!!\n",ifAGCGain);
	printk("[DEMOD M14A0] DVB CARRIER is %s  !!!\n",(carrLockState == LX_DEMOD_LOCKED) ? "locked" : "NOT locked" );
	printk("[DEMOD M14A0] Carrier offset Frequency = %d [KHz] !!!\n",carrierLock.carrOffset);
	printk("[DEMOD M14A0] Sampling frequency is %s   !!!\n",(samplingLock == LX_DEMOD_LOCKED) ? "locked" : "NOT locked");
	printk("[DEMOD M14A0] QAM mode is %s   !!!\n",(qamModeDet.status == LX_DEMOD_DETECTED) ? "detected" : "NOT detected");
...
/**
 * DEMOD_M14A0_DVBT_Set_DefaultRegisterValue
 * Set defualt register value on DVB-T.
 * This function is applied only to A0 version, not to A1 version.
 *
 * @param none
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14A0_DVBT_Set_DefaultRegisterValue(LX_DEMOD_BWMODE_T band)
{
	UINT8 adcsel1v;
	UINT8 adcclkpllsel;
	UINT8 adcmsbinv;
   ...
   // TXPCCTH_DI[7:0] : TPS/TMCC confidence counter value set
	...
	if(gM14A0GBB_PowerOnInitDVB == 1)
	{
		gM14A0GBB_PowerOnInitDVB = 2;
		...
		gM14A0GBB_PowerOnInitStartTimeDVB = jiffies_to_msecs(jiffies);
	}
	else if(gM14A0GBB_PowerOnInitDVB == 0)
	{
		crgearshen = 0x1;
		Common_RdFL(common_ctrl68);  //regAddr = 0x0044, COMMON_CTRL[68]
		Common_Wr01(common_ctrl68, crgearshen, crgearshen);
...
************************************************************************************/
/**
 * DEMOD_M14A0_DVBT_Set_Config_auto
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14A0_DVBT_Set_Config_auto (BOOLEAN bAutoDetect)
...
************************************************************************************/
/**
 * DEMOD_M14A0_DVBT_Set_PartialConfig
 * Set hierachical signal path and bandwidth.
 * This function is used when LX_DEMOD_M14A0_DVBT_Set_Config_auto is enabled.
 *
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14A0_DVBT_Set_PartialConfig (LX_DEMOD_DVBT_CONFIG_T *pDvbtConfigParam)
{
	...
	{
		hierhpsel_d = 0x1;
		DEMOD_PRINT("[DEMOD M14A0] High Priority signal is selected  !!!\n");
	}
	else
	{
		hierhpsel_d = 0x0;
		DEMOD_PRINT("[DEMOD M14A0] Low Priority signal is selected  !!!\n");
	}
...
************************************************************************************/
/**
 * DEMOD_M14A0_DVBT_Set_FullConfig
 * Set all config parameters on DVB-T.
 * This function is used when LX_DEMOD_M14A0_DVBT_Set_Config_auto is disabled.
 *
 * @param *pDvbtConfigParam 	[IN] LX_DEMOD_DVBT_CONFIG_T - DVB-T config. structure
 * @return if Succeeded - RET_OK else-RET_ERROR
 * @see
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14A0_DVBT_Set_FullConfig (LX_DEMOD_DVBT_CONFIG_T *pDvbtConfigParam)
{
	...
	switch(pDvbtConfigParam->hierachMode)
	{
		case LX_DEMOD_DVB_TPS_HIERACHY_NONE :
			{
				...
				DEMOD_PRINT("[DEMOD M14A0] Set Hierachical Mode = %s !!!\n","NONE");
			}
			break;
		...
		default :
			{
				tpshiermode_d_2_0 = 0x0;
				DEMOD_PRINT("[DEMOD M14A0] FAIL,(%s:%d) UNKNOWN Hierachical Mode  !!!\n", __F__, __L__);
			}
			return RET_ERROR;
	}
	...
	if(pDvbtConfigParam->bSetHp)  //code rate of high priority signal manual set
	{
		switch(pDvbtConfigParam->hpCodeRate)
		{
			case LX_DEMOD_CODE_1_2 :
				{
					...
					DEMOD_PRINT("[DEMOD M14A0] Set HP code rate = %s !!!\n","1_2");
				}
				break;
			...
			default :
				{
					tpshpcoderate_d_2_0 = 0x0;
					DEMOD_PRINT("[DEMOD M14A0] FAIL,(%s:%d) UNKNOWN HP code rate !!!\n", __F__, __L__);
				}
				return RET_ERROR;
		}
	...
	else  //code rate of low priority signal manual set
	{
		switch(pDvbtConfigParam->lpCodeRate)
		{
			case LX_DEMOD_CODE_1_2 :
				{
					...
					DEMOD_PRINT("[DEMOD M14A0] Set LP code rate = %s !!!\n","1_2");
				}
				break;
			...
			default :
				{
					tpslpcoderate_d_2_0 = 0x0;
					DEMOD_PRINT("[DEMOD M14A0] FAIL,(%s:%d) UNKNOWN LP code rate !!!\n", __F__, __L__);
				}
				return RET_ERROR;
		}
...
************************************************************************************/
/**
 * DEMOD_M14A0_DVBT_Set_NeverLockWaitTime
 * Set neverlock waiting period.
 *
 * @param waitMs 	[IN] UINT32 - unit: ms
 * @return if Succeeded - RET_OK else-RET_ERROR
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14A0_DVBT_Set_NeverLockWaitTime(UINT32 waitMs)
{
	UINT8 scsyslockchktime_7_0;
...
************************************************************************************/
/**
 * DEMOD_M14A0_DVBT_Set_TafcWaitSymbol
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14A0_DVBT_Set_TafcWaitSymbol(BOOLEAN bDelayed)
{
	UINT8 crtafcwaittime_di_7_0;
...
************************************************************************************/
/**
 * DEMOD_M14A0_DVBT_Set_CTFNR_Control
 * Set TAFC wait symbol number.
 *
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14A0_DVBT_Set_CTFNR_Control(LX_DEMOD_CTFNR_CTRL_T ctfnrCtrl)
{
	UINT8 ctfnrlen_2_0;
...
************************************************************************************/
/**
 * DEMOD_M14A0_DVBT_Set_CirPwrControl
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14A0_DVBT_Set_CirPwrControl(LX_DEMOD_CIR_POWER_CTRL_T cirPwrCtrl)
{
	UINT8 cirnrctrl_d_2_0;
	UINT8 cirpwrctrl_d_3_0;
...
************************************************************************************/
/**
 * DEMOD_M14A0_DVBT_Set_CrGearshEn
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14A0_DVBT_Set_CrGearshEn(BOOLEAN bEnable)
{
	UINT8 crgearshen;
...
************************************************************************************/
/**
 * DEMOD_M14A0_DVBT_Set_CirNormalize
 * Set Cir Power level and NR level
 *
 * @param none 	[IN] void
 * @return if Succeeded - RET_OK else-RET_ERROR
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14A0_DVBT_Set_CirNormalize(void)
{
	...
	if(RET_OK != DEMOD_M14A0_DVBT_Get_DelaySpreadStatus(&delaySpread))
	{
		DEMOD_PRINT("[DEMOD M14A0] FAIL (%s:%d) DEMOD_M14A0_DVBT_Get_DelaySpreadStatus() !!!\n", __F__, __L__);
		DEMOD_RETURN_FAIL(__F__);
	}

	if(delaySpread <= 430)
	{
		if (RET_OK != DEMOD_M14A0_DVBT_Set_CTFNR_Control(LX_DEMOD_CTFNR_1_16))
		{
			DEMOD_PRINT("[DEMOD H14] FAIL (%s:%d) DEMOD_M14A0_DVBT_Set_CTFNR_Control !!!\n", __F__, __L__);
			return RET_ERROR;
		}
	...
	DEMOD_PRINT("[DEMOD M14A0 DTV](%s) validCirCount = %d \n",__F__,validCirCount);
	DEMOD_PRINT("[DEMOD M14A0 DTV](%s) maxCir = %d, minCir = %d \n",__F__, maxCir, minCir);
	...
	if(validCirCount != 2 )
	{
		...
		DEMOD_PRINT("[DEMOD M14A0 DTV](%s) delay spread = %d \n",__F__,delaySpread);

		if(/*(delaySpread <= 600) ||*/ (delaySpread > 2048))
		{
			if (RET_OK != DEMOD_M14A0_DVBT_Set_CirPwrControl(LX_DEMOD_CIR_POWER_MID))
			{
				DEMOD_PRINT("[DEMOD H14] FAIL (%s:%d) DEMOD_M14A0_DVBT_Set_CirPwrControl !!!\n", __F__, __L__);
				return RET_ERROR;
			}
		...
		{
			if(RET_OK != DEMOD_M14A0_DVBT_Get_PreGhostDetection(&IsPreGhostExist))
			{
				DEMOD_PRINT("[DEMOD M14A0] FAIL (%s:%d) DEMOD_M14A0_DVBT_Get_DelaySpreadStatus() !!!\n", __F__, __L__);
				DEMOD_RETURN_FAIL(__F__);
			}
	...
	{
		if (RET_OK != DEMOD_M14A0_DVBT_Get_CirPwrControl(&cirPwrCtrl))
		{
			DEMOD_PRINT("[DEMOD H14] FAIL (%s:%d) DEMOD_M14A0_DVBT_Set_CirPwrControl !!!\n", __F__, __L__);
			return RET_ERROR;
		}
		...
		if(cirPwrCtrl == LX_DEMOD_CIR_POWER_HIGH)
		{
		    ...
		    {
				if (RET_OK != DEMOD_M14A0_DVBT_Set_CirPwrControl(LX_DEMOD_CIR_POWER_LOW))
				{
					DEMOD_PRINT("[DEMOD H14] FAIL (%s:%d) DEMOD_M14A0_DVBT_Set_CirPwrControl !!!\n", __F__, __L__);
					return RET_ERROR;
				}
...
************************************************************************************/
/**
 * DEMOD_M14A0_DVBT_Get_CirPwrControl
 * Set Cir Power level and NR level
 *
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14A0_DVBT_Get_CirPwrControl(LX_DEMOD_CIR_POWER_CTRL_T *pCirPwrCtrl)
{
	UINT8 cirnrctrl_d_2_0;
...
************************************************************************************/
/**
 * DEMOD_M14A0_DVBT_Get_PreGhostDetection
 * Set Cir Power level and NR level
 *
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14A0_DVBT_Get_PreGhostDetection(BOOLEAN *pIsExist)
{
	...
	DEMOD_PRINT("[DEMOD M14A0 DTV](%s) stocurstatus_1_0 = %d, pIsExist = %s \n",__F__, stocurstatus_1_0, (*pIsExist == TRUE) ? "TRUE" : "FALSE");
...
************************************************************************************/
/**
 * DEMOD_M14A0_DVBT_Get_DelaySpreadStatus
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14A0_DVBT_Get_DelaySpreadStatus(UINT16 *pDelaySpread)
{
...
************************************************************************************/
/**
 * DEMOD_M14A0_DVBT_Get_Hierach_HPSel
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14A0_DVBT_Get_Hierach_HPSel( BOOLEAN *pBSetHp )
{
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14A0_DVBT_Get_FFTMode( LX_DEMOD_LOCK_STATE_T *pTxModeLock, LX_DEMOD_FFTMODE_T *pFftMode )
{
...
************************************************************************************/
/**
 * DEMOD_M14A0_DVBT_Get_GuradIntervalMode
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14A0_DVBT_Get_GuradIntervalMode( LX_DEMOD_GIMODE_T *pGIMode )
{
...
************************************************************************************/
/**
 * DEMOD_M14A0_DVBT_Get_HierachyMode
 * Get the information of hierachical mode on DVB-T.
 *
 * @param *pHierachMode[OUT] DEMOD_M14A0_DVB_TPS_HIERACHY_T - alpha = none, 1, 2 and 4.
 * @return if Succeeded - RET_OK else-RET_ERROR
 * @see
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14A0_DVBT_Get_HierachyMode( LX_DEMOD_DVB_TPS_HIERACHY_T *pHierachMode )
{
...
************************************************************************************/
/**
 * DEMOD_M14A0_DVBT_Get_LpCoderRate
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14A0_DVBT_Get_LpCoderRate( LX_DEMOD_CODERATE_T *pLpCodeRate )
{
...
************************************************************************************/
/**
 * DEMOD_M14A0_DVBT_Get_HpCoderRate
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14A0_DVBT_Get_HpCoderRate( LX_DEMOD_CODERATE_T *pHpCodeRate )
{
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14A0_DVBT_Get_CellId(UINT8 *pCellIDLength, UINT16 *cell_id)
{
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14A0_DVBT_Get_TpsInfo( LX_DEMOD_DVBT_CONFIG_T *pTpsParams)
{
	BOOLEAN bSetHp = TRUE;
	...
	if(NULL == pTpsParams)
	{
		DEMOD_PRINT("[DEMOD M14A0] ERROR, DEMOD_M14A0_DVBT_CONFIG_T TpsParams is NULL !!!\n");
		return RET_ERROR;
	}

	// Get bSetHp

	if (RET_OK != DEMOD_M14A0_DVBT_Get_Hierach_HPSel( &bSetHp ))
	{
		DEMOD_PRINT("[DEMOD M14A0] FAIL (%s:%d) DEMOD_M14A0_DVBT_Get_Hierach_HPSel() !!!\n", __F__, __L__);
		return RET_ERROR;
	}

	pTpsParams->bSetHp = bSetHp;
	DEMOD_PRINT("[DEMOD M14A0] Set HP selection = %s !!!\n",(bSetHp == TRUE) ? " HP Mode" : " LP Mode");
	...
	// Get FFT mode
	if (RET_OK != DEMOD_M14A0_DVBT_Get_FFTMode( &txModeLock, &FFTMode ))
	{
		DEMOD_PRINT("[DEMOD M14A0] FAIL (%s:%d) DEMOD_M14A0_DVBT_Get_FFTMode() !!!\n", __F__, __L__);
		return RET_ERROR;
	}
	...
	if (RET_OK != DEMOD_M14A0_DVBT_Get_GuradIntervalMode( &gIMode ))
	{
	...
	if (RET_OK != DEMOD_M14A0_DVBT_Get_HierachyMode( &hierachMode ))
	{
		DEMOD_PRINT("[DEMOD M14A0] FAIL (%s:%d) DEMOD_M14A0_DVBT_Get_HierachyMode() !!!\n", __F__, __L__);
		return RET_ERROR;
	}

	pTpsParams->hierachMode = hierachMode;
	DEMOD_PRINT("[DEMOD M14A0] Hierachical Mode = %s  !!!\n",
	...
	// Get LP coder rate
	if (RET_OK != DEMOD_M14A0_DVBT_Get_LpCoderRate( &lpCodeRate ))
	{
		DEMOD_PRINT("[DEMOD M14A0] FAIL (%s:%d) DEMOD_M14A0_DVBT_Get_LpCoderRate() !!!\n", __F__, __L__);
		return RET_ERROR;
	}

	pTpsParams->lpCodeRate = lpCodeRate;
	DEMOD_PRINT("[DEMOD M14A0] LP code rate = %s  !!!\n",
	...
	if (RET_OK != DEMOD_M14A0_DVBT_Get_HpCoderRate( &hpCodeRate ))
	{
		DEMOD_PRINT("[DEMOD M14A0] FAIL (%s:%d) DEMOD_M14A0_DVBT_Get_HpCoderRate() !!!\n", __F__, __L__);
		return RET_ERROR;
	}

	pTpsParams->hpCodeRate = hpCodeRate;
	DEMOD_PRINT("[DEMOD M14A0] HP code rate = %s  !!!\n",
	...
	DEMOD_PRINT("[DEMOD M14A0] modulation  = %s  !!!\n",
...
************************************************************************************/
/**
 * DEMOD_M14A0_DVBT_Get_TotalInfo
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14A0_DVBT_Get_TotalInfo( void)
{
	...
	if (RET_OK != DEMOD_M14A0_Get_NeverLockStatus(LX_DEMOD_DVBT, &neverLockStatus))
	{
		DEMOD_PRINT("[DEMOD M14A0] FAIL (%s:%d) DEMOD_M14A0_DVB_Get_NeverLockStatus() !!!\n", __F__, __L__);
	...
	if (RET_OK != DEMOD_M14A0_DVBT_Get_FFTMode( &txModeLock, &fftMode ))
	{
		DEMOD_PRINT("[DEMOD M14A0] FAIL (%s:%d) DEMOD_M14A0_DVBT_Get_SpectrumInvStatus() !!!\n", __F__, __L__);
		delaySpread = 0xffff;
	}
	//TP Error count
	errorMode = LX_DEMOD_I2C_READ_BASED;
	if (RET_OK !=  DEMOD_M14A0_Get_Packet_Error(&errorCount))
	{
		DEMOD_PRINT("[DEMOD M14A0] FAIL (%s:%d) DEMOD_M14A0_DVBT_Get_TPError() !!!\n", __F__, __L__);
		return RET_ERROR;
	}
	DEMOD_PRINT("[DEMOD M14A0] TP Error Count= %d !!!\n",errorCount);
	...
	if (RET_OK != DEMOD_M14A0_DVBT_Get_TpsInfo( &tppsParams))
	{
		DEMOD_PRINT("[DEMOD M14A0] FAIL (%s:%d) DEMOD_M14A0_DVBT_Get_TpsInfo() !!!\n", __F__, __L__);
		return RET_ERROR;
	}
	...
	printk("[DEMOD M14A0] AGC LOCK is %s !!!\n",(agcLockStatus == LX_DEMOD_LOCKED) ? " Locked" : " NOT Locked");
	printk("[DEMOD M14A0] IF AGC value = %d !!!\n",ifagcValue);
	printk("[DEMOD M14A0] Neverlock is %s !!!\n",(neverLockStatus == LX_DEMOD_LOCKED) ? " Locked" : " NOT Locked");
	printk("[DEMOD M14A0] Spectrum mode = %s !!!\n",(spectrumInv == LX_DEMOD_NORMAL) ? " Normal" :
																	(spectrumInv == LX_DEMOD_INVERSION) ? "Inversion" : 	" Unknown");
	printk("[DEMOD M14A0] Delay Spread = %d !!!\n",delaySpread);
	printk("[DEMOD M14A0] FFT mode LOCK = %s !!!\n",(txModeLock == LX_DEMOD_LOCKED) ? " Locked" : " NOT Locked");


	// Get bSetHp
	printk("[DEMOD M14A0] Set HP selection = %s !!!\n",(tppsParams->bSetHp == TRUE) ? " HP Mode" : " LP Mode");

	// Get channelBW
	printk("[DEMOD M14A0] Bandwidth = %s  !!!\n",
	...
	// Get Guard Interval mode
	printk("[DEMOD M14A0] Guard Intterval = %s  !!!\n",
	...
	printk("[DEMOD M14A0] Hierachical Mode = %s  !!!\n",
	...
	// Get LP coder rate
	printk("[DEMOD M14A0] LP code rate = %s  !!!\n",
	...
	// Get HP coder rate
	printk("[DEMOD M14A0] HP code rate = %s  !!!\n",
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14A0_DVBT_Get_IFO_LOCK( BOOLEAN *pIfoLock)
{
	UINT8	syslock;
...
************************************************************************************/
/**
 * DEMOD_M14A0_DVBT_Get_CochanDetIndicator
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14A0_DVBT_Get_CochanDetIndicator( BOOLEAN *pDetStatus)
{
...
************************************************************************************/
/**
 * DEMOD_M14A0_DVBT_EqualizereReset.
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14A0_DVBT_EqualizereReset(void)
{
...
************************************************************************************/
/**
 * DEMOD_M14A0_DVBT_Obtaining_Signal_Lock.
 * Set channel change parameters
 *
 * @param *pDemodInfo [IN] DEMOD_CTX_T
 * @return if Succeeded - RET_OK else-RET_ERROR
...
int DEMOD_M14A0_DVBT_Obtaining_Signal_Lock(DEMOD_CTX_T *pDemodInfo)
{
		...
		case LX_DEMOD_RETUNE_RF:			/***************************************************/
			{
				...
				if(RET_OK != DEMOD_M14A0_DVBT_Set_DefaultRegisterValue(pDemodInfo->setCfgParam.dvbt.channelBW))
				{
					DEMOD_PRINT("[DEMOD M14A0] FAIL (%s:%d) DEMOD_M14A0_DVBT_Set_DefaultRegisterValue() !!!\n", __F__, __L__);
					DEMOD_RETURN_FAIL(__F__);
				}

				DEMOD_PRINT("[DEMOD M14A0] [DEMOD M14A0] MONITORING FUNC : change to CIR power level(0x86) !!!\n");
				if(RET_OK != DEMOD_M14A0_DVBT_Set_NeverLockWaitTime(LX_DEMOD_DVBT_NEVERLOCK_WAIT_TIME))
				{
					DEMOD_PRINT("[DEMOD M14A0] FAIL (%s:%d) DEMOD_M14A0_DVBT_Set_NeverLockWaitTime() !!!\n", __F__, __L__);
					DEMOD_RETURN_FAIL(__F__);
				}

				if(LX_DEMOD_TUNE_NORMAL != pDemodInfo->setCfgParam.dvbt.tuneMode)
				{
					if(RET_OK != DEMOD_M14A0_DVBT_Set_Config_auto(TRUE))
					{
						DEMOD_PRINT("[DEMOD M14A0] FAIL (%s:%d) DEMOD_DVBT_Set_Config_auto() !!!\n", __F__, __L__);
						DEMOD_RETURN_FAIL(__F__);
					}

					if(RET_OK != DEMOD_M14A0_DVBT_Set_PartialConfig(&(pDemodInfo->setCfgParam.dvbt)))
					{
						DEMOD_PRINT("[DEMOD M14A0] FAIL (%s:%d) DEMOD_DVBT_Set_PartialConfig() !!!\n", __F__, __L__);
						DEMOD_RETURN_FAIL(__F__);
					}
				}
				else
				{
					...
					if(RET_OK != DEMOD_M14A0_DVBT_Set_PartialConfig(&(pDemodInfo->setCfgParam.dvbt)))
					{
						DEMOD_PRINT("[DEMOD M14A0] FAIL (%s:%d) DEMOD_M14A0_DVBT_Set_PartialConfig() !!!\n", __F__, __L__);
						DEMOD_RETURN_FAIL(__F__);
					}

#else
					if(RET_OK != DEMOD_M14A0_DVBT_Set_Config_auto(FALSE))
					{
						DEMOD_PRINT("[DEMOD M14A0] FAIL (%s:%d) DEMOD_M14A0_DVBT_Set_Config_auto() !!!\n", __F__, __L__);
						DEMOD_RETURN_FAIL(__F__);
					}

					if(RET_OK != DEMOD_M14A0_DVBT_Set_FullConfig(&(pDemodInfo->setCfgParam.dvbt)))
					{
						DEMOD_PRINT("[DEMOD M14A0] FAIL (%s:%d) DEMOD_M14A0_DVBT_Set_FullConfig() !!!\n", __F__, __L__);
						DEMOD_RETURN_FAIL(__F__);
					}
		...
		case LX_DEMOD_SYNC_CHECKING : 		/********************************************/
			{
				...
				if(LX_DEMOD_LOCKED == lockState)
				{
					DEMOD_M14A0_DVBT_Set_TafcWaitSymbol(TRUE);
						...
						else
						{
							...
							if(packetError < LX_DEMOD_PACKET_ERROR_THD)
							{
								...
								if((LX_DEMOD_BW_6MHZ == pDemodInfo->setCfgParam.dvbt.channelBW) /* && (LX_DEMOD_TUNE_NORMAL == pDemodInfo->setCfgParam.dvbt.tuneMode)*/)
								{
									...
									if (RET_OK != DEMOD_M14A0_Get_QAMMode( &qamMode ))
									{
										DEMOD_PRINT("[DEMOD M14A0] FAIL (%s:%d) DEMOD_M14A0_Get_QAMMode() !!!\n", __F__, __L__);
										DEMOD_RETURN_FAIL(__F__);
									}
									...
									{	// To resolve pre-echo stream TW 8K, 1/4
										...
										if (RET_OK != DEMOD_M14A0_DVBT_Set_CirNormalize())
										{
											DEMOD_PRINT("[DEMOD M14A0] FAIL (%s:%d) DEMOD_M14A0_DVBT_Set_CirNormalize() !!!\n", __F__, __L__);
											DEMOD_RETURN_FAIL(__F__);
										}
										DEMOD_PRINT("[DEMOD M14A0] (%s) DEMOD_M14A0_DVBT_Set_CirNormalize() !!!\n", __F__ );
								...
								DEMOD_PRINT_ALWAYS( "[DEMOD M14A0] LX_DEMOD_SIGNAL_STABLE : MSG_DVBT_FRONT_END_LOCKED..... ^^^0^^^\n");
								DEMOD_PRINT_ALWAYS( "[DEMOD M14A0] LX_DEMOD_SIGNAL_STABLE : Elapsed Time = %d [ms] ..... ^^^0^^^\n", elapsedTime);
								DEMOD_PRINT( "^R^[DEMOD M14A0] LX_DEMOD_SIGNAL_STABLE : Frequency offset = %d [KHz] ..... ^^^0^^^\n", freqOffset);
							...
							{
								DEMOD_PRINT( "^R^[DEMOD M14A0] LX_DEMOD_SIGNAL_STABLE : Packet error = %d .....  --_--\n", packetError);
								elapsedTime = jiffies_to_msecs(jiffies) - sigStablestartTime;
...
************************************************************************************/
/**
 * DEMOD_M14A0_DVBT_Monitoring_Signal_Lock.
 * Set channel change parameters
 *
 * @param *pDemodInfo [IN] DEMOD_CTX_T
 * @return if Succeeded - RET_OK else-RET_ERROR
...
int DEMOD_M14A0_DVBT_Monitoring_Signal_Lock(DEMOD_CTX_T *pDemodInfo)
{
	...
	if(LX_DEMOD_LOCKED == lockState)
	{
		...
		if (RET_OK != DEMOD_Get_signal_status(pDemodInfo))
		{
			DEMOD_PRINT( "[DEMOD M14A0] FAIL (%s:%d) DEMOD_Get_signal_status() !!!\n", __F__, __L__);
			DEMOD_RETURN_FAIL(__F__);
		}
		...
		if(pDemodInfo->signalStatus.packetError >= _gM14A0GBB_FullDVBPkerrThreshold)
		{
			...
			if(_gM14A0GBB_DVB_UnlockCount_full_packeterr == _gM14A0GBB_FullDVBPkerrCount)
			{
				...
				pDemodInfo->bNotifiedLock	= FALSE;
				pDemodInfo->signalStatus.bSignalValid = FALSE;
				DEMOD_PRINT_ALWAYS( "[DEMOD M14A0] MONITORING FUNC : MSG_DVBT_FRONT_END_NOT_LOCKED..... -_-;;\n");
		...
		else
		{
			...
			if(gM14A0GBB_PowerOnInitDVB == 2)
			{
				powerOnElapsedTime = jiffies_to_msecs(jiffies) - gM14A0GBB_PowerOnInitStartTimeDVB;
				...
				if(powerOnElapsedTime >= 60000)
				{
					...
					if (RET_OK != DEMOD_M14A0_DVBT_Set_CrGearshEn(TRUE ))
					{
						DEMOD_PRINT("[DEMOD M14A0] FAIL (%s:%d) DEMOD_M14A0_DVBT_Set_CrGearshEn() !!!\n", __F__, __L__);
						DEMOD_RETURN_FAIL(__F__);
					}
				}
			}
			...
			{
				pDemodInfo->lockCount++;
				DEMOD_PRINT( "^r^[DEMOD M14A0](%s) pDemodInfo->lockCount = %d !!!\n", __F__,pDemodInfo->lockCount);
			...
			if(pDemodInfo->lockCount == 2)
			{
				...
				DEMOD_PRINT_ALWAYS( "[DEMOD M14A0] MONITORING FUNC : MSG_DVBT_FRONT_END_LOCKED..... ^0^\n");
	...
	else
	{
		...
		{
			pDemodInfo->unLockCount++;
			DEMOD_PRINT( "^r^[DEMOD M14A0](%s) pDemodInfo->unLockCount = %d !!!\n", __F__,pDemodInfo->unLockCount);
