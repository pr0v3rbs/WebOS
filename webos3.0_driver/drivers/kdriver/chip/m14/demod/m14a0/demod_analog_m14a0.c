...
**
**  Functions
**  Implemented:   char*	DEMOD_M14A0_ANALOG_WhatAudioSystem
**                  int DEMOD_M14A0_ANALOG_Demod_Open
**                  int DEMOD_M14A0_ANALOG_Demod_Open
**                  int DEMOD_M14A0_ANALOG_Set_IF_Frq
**                  int DEMOD_M14A0_ANALOG_Set_AftRange
**                  int DEMOD_M14A0_ANALOG_ChangeAudioSystem
**                  int DEMOD_M14A0_ANALOG_SetAudioSystem
**                  int DEMOD_M14A0_ANALOG_SetAudioSystem
**                  int DEMOD_M14A0_ANALOG_SetLowIFinput
**                  LX_ADEMOD_VideoStandard DEMOD_M14A0_ANALOG_GetVideoStandard
**                  int DEMOD_M14A0_ANALOG_SetSIFMode
**                  int DEMOD_M14A0_ANALOG_SetAGCTOP
**                  int DEMOD_M14A0_ANALOG_SmartTune
**                  int DEMOD_M14A0_ANALOG_CheckVideoCarrier
**                  int DEMOD_M14A0_ANALOG_CheckVideoSync
**                  int DEMOD_M14A0_ANALOG_ControlOutput
**                  int DEMOD_M14A0_ANALOG_Get_FreqOffset
**                  int DEMOD_M14A0_ANALOG_ChangeFilter4SIF
**                  int DEMOD_M14A0_ANALOG_CarrierlockScan
**                  int DEMOD_M14A0_ANALOG_SoftReset
**                  int DEMOD_M14A0_ANALOG_Set_CvbsDecCtrl
**                  int DEMOD_M14A0_ANALOG_Set_CvbsRateConversion
**                  int DEMOD_M14A0_ANALOG_Set_HighCvbsRateOffset
**                  int DEMOD_M14A0_ANALOG_Set_SifCtrl
**                  int DEMOD_M14A0_ANALOG_Set_SifPathCtrl
**                  int DEMOD_M14A0_ANALOG_Set_SpectrumInv
**                  int DEMOD_M14A0_ANALOG_Obtaining_Signal_Lock
**                  int DEMOD_M14A0_ANALOG_Monitoring_Signal_Lock
**
**                  int DEMOD_M14A0_ANALOG_Dbg_Get_RegDump
**                  int DEMOD_M14A0_ANALOG_Dbg_Set_RegisterValue
**                  int DEMOD_M14A0_ANALOG_Dbg_SmartTune
**                  int DEMOD_M14A0_ANALOG_Dbg_Get_RegisterValue
**                  int DEMOD_M14A0_ANALOG_Dbg_TestFunctions
**                  int DEMOD_M14A0_ANALOG_OptimizingTunerInBrazil
**                  int DEMOD_M14A0_ANALOG_OptimizingTunerInBrazil
**
**  References:    
**
...
static	UINT32	_gCurrentSamplRate	= LX_ADEMOD_SAMPLING_RATE_240MHz;
static	BOOLEAN	_gbSIFFilterMode	= FALSE;
...
*/
char*	DEMOD_M14A0_ANALOG_WhatAudioSystem(LX_DEMOD_ANALOG_SIF_SOUNDSYSTEM_T audioSystem)
{
	UINT8	index = 0;
 ...
 * @author	Jeongpil Yun (jeongpil.yun@lge.com)
 */
int DEMOD_M14A0_ANALOG_Demod_Open(UINT32 chipDevID, UINT32 handleI2C,  Handle_t *phDevice)
{
...
/**
 * DEMOD_M14A0_ANALOG_Init.
 *
 * @param	phDevice	[in] UINT32
 * @return	OK/FAIL
 * @author	Jeongpil Yun (jeongpil.yun@lge.com)
 */
int DEMOD_M14A0_ANALOG_Init(Handle_t phDevice, LX_DEMOD_RF_MODE_T rfMode)
{
	...
	{
		DEMOD_PRINT( "^r^[M14  ATV] FAIL (%s:%d) DEMOD_M14A0_ANALOG_Init - Invaild rf mode !!!\n",  __F__, __L__);
		DEMOD_RETURN_FAIL(__F__);

	}
	if (retOK != DEMOD_M14A0_ANALOG_SetLowIFinput(phDevice, pllClkSource, ifFreq, 1))
	{
		DEMOD_PRINT( "^r^[M14  ATV] FAIL (%s:%d) DEMOD_M14A0_ANALOG_SetLowIFinput  !!!\n",  __F__, __L__);
		DEMOD_RETURN_FAIL(__F__);
	}
 ...
 * @author	Jeongpil Yun (jeongpil.yun@lge.com)
 */
int DEMOD_M14A0_ANALOG_Set_IF_Frq(Handle_t phDevice, UINT32 pllClkSource, UINT32 ifFrq)
{
	int ifFreq;
	...
	if (retOK != DEMOD_M14A0_ANALOG_Set_CvbsRateConversion(phDevice, pllClkSource))
	{
		DEMOD_PRINT( "^r^[M14  ATV] FAIL (%s:%d) DEMOD_M14A0_ANALOG_Set_CvbsRateConversion !!!\n",  __F__, __L__);
		DEMOD_RETURN_FAIL(__F__);
	}

	if (retOK != DEMOD_M14A0_ANALOG_Set_SifPathCtrl(phDevice, pllClkSource, LX_DEMOD_ANALOG_SIF_PATH_INTERNAL ))
	{
		DEMOD_PRINT( "^r^[M14  ATV] FAIL (%s:%d) DEMOD_M14A0_ANALOG_Set_SifPathCtrl !!!\n",  __F__, __L__);
		DEMOD_RETURN_FAIL(__F__);
	}
...
/**
 * DEMOD_M14A0_ANALOG_Set_AftRange.
 *
 * @param	phDevice	[in] UINT32
 * @return	OK/FAIL
 * @author	Jeongpil Yun (jeongpil.yun@lge.com)
 */
int DEMOD_M14A0_ANALOG_Set_AftRange(Handle_t phDevice, LX_DEMOD_ANALOG_ATFRANGE_PARAM_T aftRange)
{
	UINT32 rangeValue[3];
 ...
 * @author 	Jeongpil Yun (jeongpil.yun@lge.com)
 */
 int DEMOD_M14A0_ANALOG_ChangeAudioSystem(LX_DEMOD_SMARTTUNE_PARAM_T *pSmartTuneParam)
{
	...
	videoStd	= DEMOD_M14A0_ANALOG_GetVideoStandard(audioSystem);
	...
	DEMOD_M14A0_ANALOG_SmartTune(pSmartTuneParam, TRUE);

	ADEMOD_SetGroupDelay(phDevice, videoStd);

	DEMOD_PRINT( "[ABB M14] Set %s !!!\n",  DEMOD_M14A0_ANALOG_WhatAudioSystem(audioSystem));

	_gbSIFFilterMode = FALSE;
 ...
 * @author 	Jeongpil Yun (jeongpil.yun@lge.com)
 */
 int DEMOD_M14A0_ANALOG_SetAudioSystem(LX_DEMOD_SMARTTUNE_PARAM_T *pSmartTuneParam)
{
	...
	if (LX_DEMOD_NTSC == pSmartTuneParam->rfMode)
	{
		...
		{
			DEMOD_PRINT( "[ABB M14] Same %s : Only SmartTune() !!!\n",  DEMOD_M14A0_ANALOG_WhatAudioSystem(nextAudioSystem));
			DEMOD_M14A0_ANALOG_SmartTune( pSmartTuneParam, FALSE);
		}
		else
		{
			DEMOD_M14A0_ANALOG_ChangeAudioSystem( pSmartTuneParam);
		}

//		DEMOD_M14A0_ANALOG_SetSIFMode(phDevice);
		DEMOD_M14A0_ANALOG_SetAGCTOP(phDevice, pSmartTuneParam->frequency,LX_DEMOD_NTSC);
	...
	else if (LX_DEMOD_PAL == rfMode)
	{
		...
		else if ((_gbSIFFilterMode) || (LX_DEMOD_TUNE_MANUAL == tuneMode))
		{
			DEMOD_M14A0_ANALOG_ChangeAudioSystem( pSmartTuneParam);
		}
		else
...
//		DEMOD_M14A0_ANALOG_SetSIFMode(phDevice);
		DEMOD_M14A0_ANALOG_SetAGCTOP(phDevice, pSmartTuneParam->frequency,LX_DEMOD_PAL);
 ...
 * @author
*/
 int DEMOD_M14A0_ANALOG_CheckIFLevel(Handle_t phDevice,  UINT32 *pIFLevel)
{
    ...
    {
        DEMOD_PRINT( "[M14 ABB] FAIL (%s:%d) ADEMOD_Parameter_Get(LXDEMOD_M14A0_ANALOG_PARM_IF_LEVEL_STAT)\n",  __F__, __L__);
		*pIFLevel = 0;
		DEMOD_RETURN_FAIL(__F__);
    }
...
int DEMOD_M14A0_ANALOG_SetLowIFinput(Handle_t phDevice, UINT32 pllClkSource, int lif_freq, UINT8 isdefault)
{
 ...
 * @author 	Jeongpil Yun (jeongpil.yun@lge.com)
 */
LX_ADEMOD_VideoStandard DEMOD_M14A0_ANALOG_GetVideoStandard(LX_DEMOD_ANALOG_SIF_SOUNDSYSTEM_T audioSystem)
{
	switch(audioSystem)
	{
 ...
 * @author 	Jeongpil Yun (jeongpil.yun@lge.com)
 */
int DEMOD_M14A0_ANALOG_SetSIFMode(Handle_t phDevice)
{
 ...
 * @author 	Jeongpil Yun (jeongpil.yun@lge.com)
 */
int DEMOD_M14A0_ANALOG_SetAGCTOP(Handle_t phDevice, UINT32 frequency, LX_DEMOD_RF_MODE_T rfMode )
{
 ...
 * @author 	Jeongpil Yun (jeongpil.yun@lge.com)
 */
int DEMOD_M14A0_ANALOG_SmartTune(LX_DEMOD_SMARTTUNE_PARAM_T *pSmartTuneParam,  BOOLEAN bForce)
{
	...
	{
		DEMOD_PRINT( "[ABB M14] ERR (%s:%d) INVALID audio system(%s) !!!\n",  __F__, __L__, DEMOD_M14A0_ANALOG_WhatAudioSystem(audioSystem));
		DEMOD_RETURN_FAIL(__F__);
	}
	...
	smartTune.SmplRate	= pSmartTuneParam->sampleRate; //LX_ADEMOD_SAMPLING_RATE_240MHz; //_gCurrentSamplRate;
...
#endif
	{
		...
		_gCurrentSamplRate = smartTune.SmplRate;
	}
	return RET_OK;
}
 ...
 */
int DEMOD_M14A0_ANALOG_CheckVideoCarrier(Handle_t phDevice, LX_DEMOD_LOCK_STATE_T *pCarrierLockStatus)
{
 ...
 */
static int DEMOD_M14A0_ANALOG_CheckVideoSync(Handle_t phDevice, LX_DEMOD_LOCK_STATE_T *pLockState)
{
	UINT32 	stat;
 ...
 * @author 	Jeongpil Yun (jeongpil.yun@lge.com)
 */
int DEMOD_M14A0_ANALOG_ControlOutput(Handle_t phDevice,  BOOLEAN bOutputON)
{
	/* Check */
	return RET_OK;
}
 ...
 */
int DEMOD_M14A0_ANALOG_Get_FreqOffset(DEMOD_CTX_T *pDemodInfo, SINT32 *pFreqOffset)
{
	...
	*pFreqOffset = 0; // All related to AFT is controlled by Tuner 2158B  
	...
	{
		if (RET_OK != DEMOD_M14A0_ANALOG_CheckVideoCarrier(phDevice, &carrierLockStatus))
		{
			DEMOD_PRINT("[ABB M14] FAIL (%s:%d) DEMOD_M14A0_ANALOG_CheckVideoCarrier() !!!\n", __F__, __L__);
			DEMOD_RETURN_FAIL(__F__);
		}
 ...
 * @author 	Jeongpil Yun (jeongpil.yun@lge.com)
 */
int DEMOD_M14A0_ANALOG_ChangeFilter4SIF(Handle_t	phDevice,  LX_DEMOD_ANALOG_SIF_SOUNDSYSTEM_T audioSystem)
{
    ...
    DEMOD_PRINT( "[TU ATV](%s:%d) !!!\n",__F__,__L__);
    DEMOD_PRINT( "[TU ATV](%s:%d) audioSystem = %d!!!\n",__F__,__L__,audioSystem);
	...
	DEMOD_PRINT( "[M14 ABB] _ADEMOD_ChangeFilter4SIF(%s) : VIDEO BW(%d Hz), %d Hz ~ %d Hz !!!\n",
				DEMOD_M14A0_ANALOG_WhatAudioSystem(audioSystem), videoBW[0], dataFreq[0], dataFreq[1]);


	_gbSIFFilterMode	= TRUE;
...
/**
 * DEMOD_M14A0_ANALOG_CarrierlockScan
 ...
 * @author 	Jeongpil.yun(jeongpil.yun@lge.com)
*/
int DEMOD_M14A0_ANALOG_CarrierlockScan(DEMOD_CTX_T *pDemodInfo, LX_DEMOD_FLAG_T ResetOn, LX_DEMOD_FLAG_T *pScanProcessing, LX_DEMOD_LOCK_STATE_T *pScanLock)
{
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14A0_ANALOG_SoftReset(Handle_t	phDevice)
{
...
************************************************************************************/
/**
 * DEMOD_M14A0_ANALOG_Set_CvbsDecCtrl.
 * Select CVBS DEC sel.
 *
 * @param  NONE
 * @param	phDevice 	[in] 	Handle_t
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14A0_ANALOG_Set_CvbsDecCtrl(Handle_t phDevice, LX_DEMOD_ANALOG_CVBSDEC_SEL_T sel )
{
	
	if(LX_DEMOD_ANALOG_DTV == sel)
	{
		if(retOK !=ADEMOD_Register_Set(phDevice, 0x465, 1, 0x0))
		{
			DEMOD_PRINT("[ABB M14] FAIL (%s:%d) ADEMOD_Register_Set() !!!\n", __F__, __L__);
			DEMOD_RETURN_FAIL(__F__);
		}
	...
	{
		if(retOK !=ADEMOD_Register_Set(phDevice, 0x465, 1, 0x1))
		{
			DEMOD_PRINT("[ABB M14] FAIL (%s:%d) ADEMOD_Register_Set() !!!\n", __F__, __L__);
			DEMOD_RETURN_FAIL(__F__);
		}
...
************************************************************************************/
/**
 * DEMOD_M14A0_ANALOG_Set_CvbsRateConversion.
 * Reset Analog module by software.
 *
 * @param  NONE
 * @param	phDevice 	[in] 	Handle_t
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14A0_ANALOG_Set_CvbsRateConversion(Handle_t	phDevice, UINT32 pllClkSource)
{
//	UINT8 i;
//	UINT32 data;
//	UINT16 reg = 0xb10;
...
#if 1
	if(retOK != ADEMOD_Register_Set(phDevice, 0xb04, 1, 0x1))
	{
		DEMOD_PRINT("[ABB M14] FAIL (%s:%d) ADEMOD_Register_Set(0xb04, 0x1) !!!\n", __F__, __L__);
		DEMOD_RETURN_FAIL(__F__);
	}

	if(retOK != ADEMOD_Register_Set(phDevice, 0xb07, 1, 0x4))
	{
		DEMOD_PRINT("[ABB M14] FAIL (%s:%d) ADEMOD_Register_Set(0xb07, 0x4) !!!\n", __F__, __L__);
		DEMOD_RETURN_FAIL(__F__);
	}

	if(retOK != ADEMOD_Register_Set(phDevice, 0xb04, 1, 0x0))
	{
		DEMOD_PRINT("[ABB M14] FAIL (%s:%d) ADEMOD_Register_Set(0xb04, 0x0) !!!\n", __F__, __L__);
		DEMOD_RETURN_FAIL(__F__);
	}
#endif
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14A0_ANALOG_Set_HighCvbsRateOffset(Handle_t	phDevice, BOOLEAN bInitOffsetHigh)
{
	...
	if(TRUE == bInitOffsetHigh)
	{
		...
		if(retOK != ADEMOD_Register_Set(phDevice, 0xb07, 1, 0x4))
		{
			DEMOD_PRINT("[ABB M14] FAIL (%s:%d) ADEMOD_Register_Set(0xb07, 0x7) !!!\n", __F__, __L__);
			DEMOD_RETURN_FAIL(__F__);
		}
	...
	{
		if(retOK != ADEMOD_Register_Set(phDevice, 0xb01, 1, 0x1f))
		{
			DEMOD_PRINT("[ABB M14] FAIL (%s:%d) ADEMOD_Register_Set(0xb01, 0xa) !!!\n", __F__, __L__);
			DEMOD_RETURN_FAIL(__F__);
		}
		if(retOK != ADEMOD_Register_Set(phDevice, 0xb02, 1, 0x1f))
		{
			DEMOD_PRINT("[ABB M14] FAIL (%s:%d) ADEMOD_Register_Set(0xb02, 0xa) !!!\n", __F__, __L__);
			DEMOD_RETURN_FAIL(__F__);
		}
		...
		if(retOK != ADEMOD_Register_Set(phDevice, 0xb07, 1, 0x0))
		{
			DEMOD_PRINT("[ABB M14] FAIL (%s:%d) ADEMOD_Register_Set(0xb07, 0x3) !!!\n", __F__, __L__);
			DEMOD_RETURN_FAIL(__F__);
		}
		if(retOK != ADEMOD_Register_Set(phDevice, 0xb04, 1, 0x0))
		{
...
************************************************************************************/
/**
 * DEMOD_M14A0_ANALOG_Set_SifCtrl.
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14A0_ANALOG_Set_SifCtrl(Handle_t	phDevice, UINT32 pllClkSource)
{
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14A0_ANALOG_Set_SifPathCtrl(Handle_t phDevice, UINT32 pllClkSource, LX_DEMOD_ANALOG_SIFPATH_SEL_T sel )
{
		...
		case LX_DEMOD_ANALOG_SIF_PATH_DIRECT:
			{
				...
				if(retOK !=DEMOD_M14A0_ANALOG_Set_SifCtrl(phDevice, pllClkSource))
				{
					DEMOD_PRINT("[ABB M14] FAIL (%s:%d) ADEMOD_Register_Set() !!!\n", __F__, __L__);
					DEMOD_RETURN_FAIL(__F__);
				}
...
************************************************************************************/
/**
 * DEMOD_M14A0_ANALOG_Set_SpectrumInv.
 * Reset Analog module by software.
 *
 * @param  NONE
 * @param	phDevice 	[in] 	Handle_t
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14A0_ANALOG_Set_SpectrumInv(Handle_t phDevice, BOOLEAN bInv, BOOLEAN bforce)
{
...
************************************************************************************/
/**
 * DEMOD_M14A0_ANALOG_Obtaining_Signal_Lock.
...
int DEMOD_M14A0_ANALOG_Obtaining_Signal_Lock(DEMOD_CTX_T *pDemodInfo)
{
		...
		case LX_DEMOD_RETUNE_RF:			/***************************************************/
			{
				...
				DEMOD_M14A0_ANALOG_SoftReset(phDevice);
		...
		case LX_DEMOD_TUNE_START:			/***************************************************/
			{
				...
				if (retOK != DEMOD_M14A0_ANALOG_SetAudioSystem(&smartTuneParam))
				{
					DEMOD_PRINT("[ABB M14] FAIL (%s:%d) DEMOD_M14A0_ANALOG_SetAudioSystem() !!!\n", __F__, __L__);
					DEMOD_RETURN_FAIL(__F__);
				}

				if(LX_DEMOD_TUNE_NORMAL != (pDemodInfo->setCfgParam.analog.tuneMode & 0xf0))
				{
					if(RET_OK != DEMOD_M14A0_ANALOG_CarrierlockScan(pDemodInfo, LX_DEMOD_FLAG_ON, &scanProcessing, &scanLock))
					{
						DEMOD_PRINT("[ABB M14] FAIL (%s:%d) DEMOD_M14A0_ANALOG_CarrierlockScan() !!!\n", __F__, __L__);
						DEMOD_RETURN_FAIL(__F__);
					}
...
//					DEMOD_M14A0_ANALOG_Set_HighCvbsRateOffset(phDevice, TRUE);
					DEMOD_PRINT( "^R^[ABB M14] LX_DEMOD_TUNE_START	end..... ^0^\n");
		...
		case LX_DEMOD_TUNE_SCAN:			/***************************************************/
			{
				...
				if(RET_OK != DEMOD_M14A0_ANALOG_CarrierlockScan(pDemodInfo, LX_DEMOD_FLAG_OFF, &scanProcessing, &scanLock))
				{
					DEMOD_PRINT("[ABB M14] FAIL (%s:%d) DEMOD_M14A0_ANALOG_CarrierlockScan() !!!\n", __F__, __L__);
					DEMOD_RETURN_FAIL(__F__);
				}
				...
				if((LX_DEMOD_FLAG_FINISH == scanProcessing) && (LX_DEMOD_LOCKED == scanLock))
				{
					...
					DEMOD_PRINT_ALWAYS( "[ABB M14] (%s:%d) Signal is Found  !!!\n", __F__, __L__);
					DEMOD_PRINT( "[ABB M14] LX_DEMOD_TUNE_SCAN : Going to LX_DEMOD_SYNC_CHECKING..... ^0^\n");
		...
		case LX_DEMOD_SYNC_CHECKING : 		/********************************************/
			{
				...
				if(RET_OK != DEMOD_M14A0_ANALOG_CheckVideoSync(phDevice, &lockState))
				{
					DEMOD_PRINT("[ABB M14] FAIL (%s:%d) DEMOD_M14A0_ANALOG_CheckVideoSync() !!!\n", __F__, __L__);
					DEMOD_RETURN_FAIL(__F__);
				}
...
#if 0
					if(TRUE == pDemodInfo->setCfgParam.analog.cvdLock)
					{
						pDemodInfo->controlState	= LX_DEMOD_SIGNAL_STABLE;
						sigStablestartTime = jiffies_to_msecs(jiffies);
						DEMOD_PRINT( "^R^[ABB M14] LX_DEMOD_SYNC_CHECKING (CVD LOCK !!) : Going to LX_DEMOD_SIGNAL_STABLE..... ^0^\n");
	   	...
	   	case LX_DEMOD_SIGNAL_STABLE: 		/********************************************/
			{
				...
				if(LX_DEMOD_LOCKED == lockState)
				{
					...
					if(elapsedTime < LX_DEMOD_ANALOG_SIG_STABLE_WAIT_TIMEOUT)
					{
						break;
					}
					else
					{
						...
						if (RET_OK != DEMOD_M14A0_ANALOG_Get_FreqOffset(pDemodInfo, &freqOffset))
						{
							DEMOD_PRINT( "[ABB M14] FAIL (%s:%d) DEMOD_M14A0_ANALOG_Get_FreqOffset() !!!\n", __F__, __L__);
							DEMOD_RETURN_FAIL(__F__);
						}
...
#endif
//						DEMOD_M14A0_ANALOG_Set_HighCvbsRateOffset(phDevice, FALSE);
				...
				else
				{
					...
					if(TRUE == pDemodInfo->setCfgParam.analog.cvdLock)
					{
						...
						pDemodInfo->freqOffset = 0;
						pDemodInfo->controlState	= LX_DEMOD_SIGNAL_LOCKED;


						elapsedTime = jiffies_to_msecs(jiffies) - g_RetuneStartTime;

						DEMOD_PRINT_ALWAYS( "[ABB M14] LX_DEMOD_SIGNAL_STABLE : CVD_LOCKED..... ^-lo^\n");
						DEMOD_PRINT_ALWAYS( "[ABB M14] LX_DEMOD_SIGNAL_STABLE : Elapsed Time = %d [ms] ..... ^^^0^^^\n", elapsedTime);
...
************************************************************************************/
/**
 * DEMOD_M14A0_ANALOG_Monitoring_Signal_Lock.
 * Set channel change parameters
 *
 * @param *pDemodInfo [IN] DEMOD_CTX_T
 * @return if Succeeded - RET_OK else-RET_ERROR
...
int DEMOD_M14A0_ANALOG_Monitoring_Signal_Lock(DEMOD_CTX_T *pDemodInfo)
{
	...
	DEMOD_PRINT( "^R^[ABB M14] DEMOD_M14A0_ANALOG_Monitoring_Signal_Lock  start..... ^0^\n");
	phDevice = pDemodInfo->setCfgParam.analog.handleABB;
...
//	DEMOD_M14A0_ANALOG_Set_HighCvbsRateOffset(phDevice, FALSE);
...
#if 0
	else if(TRUE == pDemodInfo->setCfgParam.analog.cvdLock)
	{
		pDemodInfo->unLockCount = 0;
		pDemodInfo->unLockLongCount	= 0;
		...
		if(pDemodInfo->lockCount == 1)
		{
			...
			DEMOD_PRINT_ALWAYS( "[ABB M14] MONITORING FUNC : MSG_ANALOG_FRONT_END_LOCKED(CVD LOCK)..... ^0^\n");
	...
	DEMOD_PRINT( "^R^[ABB M14] DEMOD_M14A0_ANALOG_Monitoring_Signal_Lock  end..... ^0^\n");
...
************************************************************************************/
/**
 * DEMOD_M14A0_ANALOG_Get_RegDump.
 * Reset Analog module by software.
 *
 * @param  NONE
 * @param	phDevice	[in]	Handle_t
 ...
 * @author	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14A0_ANALOG_Dbg_Get_RegDump(Handle_t	phDevice)
{
...
************************************************************************************/
/**
 * DEMOD_M14A0_ANALOG_Dbg_Set_RegisterValue.
 * Reset Analog module by software.
 *
 * @param  NONE
 * @param	phDevice	[in]	Handle_t
 ...
 * @author	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14A0_ANALOG_Dbg_Set_RegisterValue(Handle_t phDevice,  UINT32 RegAddr, UINT32 RegSize, UINT32 RegData)
{

		DEMOD_DEBUG_PRINT("RegAddr = 0x%x, RegSize = 0x%x, RegData = 0x%x  \n",RegAddr, RegSize, RegData);
...
************************************************************************************/
/**
 * DEMOD_M14A0_ANALOG_Dbg_SmartTune.
 * Reset Analog module by software.
 *
 * @param  NONE
 * @param	*pSmartTuneParam	[in]	LX_DEMOD_SMARTTUNE_PARAM_T
 ...
 * @author	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14A0_ANALOG_Dbg_SmartTune(LX_DEMOD_SMARTTUNE_PARAM_T *pSmartTuneParam)
{
...
************************************************************************************/
/**
 * DEMOD_M14A0_ANALOG_Dbg_Get_RegisterValue.
 * Reset Analog module by software.
 *
 * @param  NONE
 * @param	phDevice	[in]	Handle_t
 ...
 * @author	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14A0_ANALOG_Dbg_Get_RegisterValue(Handle_t phDevice, UINT32 RegAddr, UINT32 RegSize, UINT32 *pRegData)
{
...
************************************************************************************/
/**
 * DEMOD_M14A0_ANALOG_Dbg_TestFunctions.
 * Reset Analog module by software.
 *
 * @param  NONE
 * @param	phDevice	[in]	Handle_t
 ...
 * @author	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14A0_ANALOG_Dbg_TestFunctions(Handle_t phDevice, UINT32 argc, UINT32 *val)
{
 ...
 */
void DEMOD_M14A0_ANALOG_OptimizingTunerInBrazil(Handle_t phDevice)
{
	int i;
 ...
 * @author 	sungbin.na(sungbin.na@lge.com)
 */
int DEMOD_M14A0_ANALOG_OptimizingTunerSetting(Handle_t phDevice)
{
