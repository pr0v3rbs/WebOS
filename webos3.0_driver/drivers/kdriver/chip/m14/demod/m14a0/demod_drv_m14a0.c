...
LX_DEMOD_COMMON_REG_T 	*gpRegM14A0COMMON_Ax; 
LX_DEMOD_SYNC_REG_T 	*gpRegM14A0SYNC_Ax;	
LX_DEMOD_EQ_V_REG_T 	*gpRegM14A0EQ_V_Ax; 	
LX_DEMOD_EQ_DI_REG_T 	*gpRegM14A0EQ_DI_Ax;	
LX_DEMOD_EQ_CQS_REG_T 	*gpRegM14A0CQS_Ax; 	
LX_DEMOD_FEC_REG_T	 	*gpRegM14A0FEC_Ax; 	
...
{
	gpRegM14A0COMMON_Ax 	=  (LX_DEMOD_COMMON_REG_T*)OS_KMalloc(sizeof(LX_DEMOD_COMMON_REG_T));
	gpRegM14A0SYNC_Ax		=  (LX_DEMOD_SYNC_REG_T*)OS_KMalloc(sizeof(LX_DEMOD_SYNC_REG_T));
	gpRegM14A0EQ_V_Ax 		=  (LX_DEMOD_EQ_V_REG_T*)OS_KMalloc(sizeof(LX_DEMOD_EQ_V_REG_T));
	gpRegM14A0EQ_DI_Ax		=  (LX_DEMOD_EQ_DI_REG_T*)OS_KMalloc(sizeof(LX_DEMOD_EQ_DI_REG_T));
	gpRegM14A0CQS_Ax 		=  (LX_DEMOD_EQ_CQS_REG_T*)OS_KMalloc(sizeof(LX_DEMOD_EQ_CQS_REG_T));
	gpRegM14A0FEC_Ax 		=  (LX_DEMOD_FEC_REG_T*)OS_KMalloc(sizeof(LX_DEMOD_FEC_REG_T));
