...
/*****************************************************************************
**
**  Name:demod_common_m14b0.c
**
**  Description:    ABB/GBB common block.
**
**  Functions
**  Implemented:   int	DEMOD_M14B0_ResetHW
**                  int DEMOD_M14B0_SetI2C
**                  int DEMOD_M14B0_SetInclk
**                  int DEMOD_M14B0_AdcInit
**                  int DEMOD_M14B0_RepeaterEnable
**                  int DEMOD_M14B0_SoftwareReset
**                  int DEMOD_M14B0_Serial_Control
**                  int DEMOD_M14B0_Power_Save
**                  int DEMOD_M14B0_StdOperModeContrl
**                  int DEMOD_M14B0_NeverlockScan
**                  int DEMOD_M14B0_TPOutEnable
**                  int DEMOD_M14B0_Set_IF_Frq
**                  int DEMOD_M14B0_Set_AGCPolarity
**                  int DEMOD_M14B0_Set_SpectrumCtrl
**                  int DEMOD_M14B0_Get_Id
**                  int DEMOD_M14B0_Get_SpectrumStatus
**                  int DEMOD_M14B0_Get_IFAGC
**                  int DEMOD_M14B0_Get_OperMode
**                  int DEMOD_M14B0_Get_NeverLockStatus
**                  int DEMOD_M14B0_Get_CarrierFreqOffset
**                  int DEMOD_M14B0_Get_TPIFStatus
**                  int DEMOD_M14B0_Get_VABER
**                  int DEMOD_M14B0_Get_Packet_Error
**                  int DEMOD_M14B0_Get_BandWidthMode
**                  int DEMOD_M14B0_Get_QAMMode
**                  int DEMOD_M14B0_Get_MseInfo
**                  int DEMOD_M14B0_Get_Lock
**                  int DEMOD_M14B0_VSB_Get_SysLockTime
**                  int DEMOD_M14B0_VSB_Get_FecLockTime
**			
**                  int DEMOD_M14B0_ANALOG_ResetHW
**                  int DEMOD_M14B0_ANALOG_SetI2C
**                  int DEMOD_M14B0_ANALOG_Set_AbbMode
**                  int DEMOD_M14B0_ANALOG_Set_WorkAround
**
**  References:    
**
**  Exports:       
...
**				 demod_analog_m14b0.h, demod_reg_m14b0.h
**
**  Revision History:
**
...
int DEMOD_M14B0_ResetHW(void)
{
	...
	if(ACE_REG_M14B0_RdFd(soft_reset_0,swrst_f24m_bb) == 1)
	{
		ACE_REG_M14B0_RdFL(soft_reset_0);
		ACE_REG_M14B0_Wr01(soft_reset_0,swrst_f24m_bb,0);
		ACE_REG_M14B0_WrFL(soft_reset_0);
		DEMOD_PRINT_ALWAYS("[KDRV_DEMOD] NEED TO BE RESET swrst_f24m_bb \n");	
		
	}
	else
	{
		DEMOD_PRINT_ALWAYS("[KDRV_DEMOD] ALREADY RESET swrst_f24m_bb \n");
	}


	DEMOD_PRINT("[KDRV_DEMOD] DEMOD_ResetHW start !! \n");

	ACE_REG_M14B0_RdFL(gbb_0);
	
	ACE_REG_M14B0_Wr01(gbb_0, reset, 1);

	ACE_REG_M14B0_WrFL(gbb_0);

	OS_MsecSleep(10);


	ACE_REG_M14B0_Wr01(gbb_0, reset, 0);
	...
	ACE_REG_M14B0_RdFL(dmd_abbpll_0); //ABB clock disable
	
	ACE_REG_M14B0_Wr01(dmd_abbpll_0, dmd_pdb_amdp, 0);

	ACE_REG_M14B0_WrFL(dmd_abbpll_0);



	gM14B0GBB_PowerOnInit = 1;
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14B0_SetI2C(void)
{
	DEMOD_PRINT("[KDRV_DEMOD] DEMOD_SetI2C Start !! \n");

	ACE_REG_M14B0_RdFL(gbb_0);

	ACE_REG_M14B0_Wr01(gbb_0, i2csel, 0);
...
int DEMOD_M14B0_SetInclk(LX_DEMOD_INCLK_SEL_T *inclk)
{

	DEMOD_PRINT("[KDRV_DEMOD] DEMOD_SetInclk Start !! \n");

	ACE_REG_M14B0_RdFL(gbb_afe_0);

	switch(*inclk)
	{
		case LX_DEMOD_ARM_SETTING:
		{
			ACE_REG_M14B0_Wr01(dmd_gbbpll_0, dmd_inck_sel_gbbp, 0);
		}
		break;
		...
		case LX_DEMOD_EXTERN_PIN:
		{
			...
			ACE_REG_M14B0_Wr01(dmd_gbbpll_0, dmd_inck_sel_gbbp, 1);
		}
		break;
	...
	ACE_REG_M14B0_WrFL(dmd_gbbpll_0);
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14B0_AdcInit(void)
{
	DEMOD_PRINT("[KDRV_DEMOD] DEMOD_M14B0_AdcInit Start !! \n");

	ACE_REG_M14B0_RdFL(dmd_adc_2);

	ACE_REG_M14B0_Wr02(dmd_adc_2, dmd_adc_pdbm, 1, dmd_adc_pdb, 1 );

	ACE_REG_M14B0_WrFL(dmd_adc_2);

   
	ACE_REG_M14B0_RdFL(dmd_gbbpll_3);	 

	ACE_REG_M14B0_Wr01(dmd_gbbpll_3, dmd_pllctrl_add_gbbp, 0x9);    

	ACE_REG_M14B0_WrFL(dmd_gbbpll_3);	 
	 

	ACE_REG_M14B0_RdFL(dmd_abbpll_4);	  

	ACE_REG_M14B0_Wr01(dmd_abbpll_4, dmd_pre_fd_amdp, 0x1);	  

	ACE_REG_M14B0_WrFL(dmd_abbpll_4);   
	 


	DEMOD_PRINT("[KDRV_DEMOD] DEMOD_M14B0_AdcInit end !! \n");
	return RET_OK;
}
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14B0_RepeaterEnable(BOOLEAN bEnable)
{
	UINT8 ni2crpten;
	...
	DEMOD_PRINT("^r^[DEMOD M14B0] success!!  DVB_RepeaterEnable =  %s ", (bEnable == TRUE)?"ON":"OFF");
	return RET_OK;
}
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14B0_SoftwareReset(void)
{
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14B0_Serial_Control(BOOLEAN bEnable)
{
	...
	DEMOD_PRINT("^r^[DEMOD M14B0 DTV] success!!  DEMOD_M14B0_VQI_Serial_Control =  %s ", (bEnable == TRUE)? "SERIAL":"PARALLEL");
...
int DEMOD_M14B0_Power_Save(BOOLEAN bEnable)
{

	UINT8 	gbbpdb;
	UINT8	softrstb;

	DEMOD_PRINT("[DEMOD M14B0 DTV] @ ######chungiii   %s =====\n",__F__);
	...
	DEMOD_PRINT("[DEMOD M14B0] success!!  DEMOD_M14B0_Power_Save =  %s  %d\n ", (bEnable == TRUE)? "ON":"OFF", gbbpdb);
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14B0_StdOperModeContrl( LX_DEMOD_OPER_MODE_T operMode, LX_DEMOD_BWMODE_T bandWd, LX_DEMOD_SYMRDET_MODE_T symbr)
{
	UINT8 	stdopmode_7_0;
	...
	UINT8 pllctrl_7_0;
	UINT8 sampling4xfen;
	UINT8 pllctrladdgbbp_4_0;

	UINT8 agcfixvalue_7_0;

	UINT32 	samplingFreq;

	UINT8 dmd_inck_sel_gbbp;
	UINT8 dmd_inck_divsel_gbbp;	
	UINT8 dmd_bypass_gbbp;

	DEMOD_PRINT(" == @ %s  ==(oper = 0x%x)\n",__F__,operMode);

	aippdbctrlen = 0;
	Common_RdFL(common_ctrl4);	 //regAddr = 0x0004
	Common_Wr01(common_ctrl4, aippdbctrlen, aippdbctrlen);
	Common_WrFL(common_ctrl4);
	//AIPPDBCTRLEN : Control of internal AIP power mode selection
	// 0 : control by I2C only
	// 1 : control by I2C and internally generated signal
	...
	pllctrladdgbbp_4_0 = 0x9;
	Common_RdFL(common_ctrl60);	 //regAddr = 0x003c
	Common_Wr01(common_ctrl60, pllctrladdgbbp_4_0, pllctrladdgbbp_4_0);
	Common_WrFL(common_ctrl60);
	//PLLCTRLADDGBBP[4:0] :Set of additional PLL control caused by ABB insertion.

	agcfixvalue_7_0 = 0;  //AGCFIXVALUE
	Common_RdFL(common_ctrl20);   //regAddr = 0x0014, COMMON_CTRL[20]
	Common_Wr01(common_ctrl20, agcfixvalue_7_0, agcfixvalue_7_0);
	Common_WrFL(common_ctrl20);
	//AGCFIXVALUE[7:0] :Set of fixed gain error value
	// This is valid when AGCRFFIXB(@0x13[7]) or AGCIFFIXB(@0x13[6]) has '0' value
	// gain error = AGCFIXVALUE & "00000000000"
	// This signal should be set to signed form(e.g. -128 ~ 127)


#if 0
// xtal clock 24MHz 
	dmd_inck_sel_gbbp = 0;
	dmd_inck_divsel_gbbp = 1;
	dmd_bypass_gbbp = 0;
#else
// pll clock 24MHz  
	dmd_inck_sel_gbbp = 0;
...
#endif
	ACE_REG_M14B0_RdFL(dmd_gbbpll_0);
	ACE_REG_M14B0_Wr03(dmd_gbbpll_0,dmd_inck_sel_gbbp,dmd_inck_sel_gbbp, dmd_inck_divsel_gbbp,dmd_inck_divsel_gbbp, dmd_bypass_gbbp,dmd_bypass_gbbp);
	ACE_REG_M14B0_WrFL(dmd_gbbpll_0);
	DEMOD_PRINT("[KDRV_DEMOD] dmd_inck_sel_gbbp = %d \n",dmd_inck_sel_gbbp);	
	DEMOD_PRINT("[KDRV_DEMOD] dmd_inck_divsel_gbbp = %d \n",dmd_inck_divsel_gbbp);	
	DEMOD_PRINT("[KDRV_DEMOD] dmd_bypass_gbbp = %d \n",dmd_bypass_gbbp);	
	...
	switch(operMode)
	{
		...
		default :
			DEMOD_PRINT("[DEMOD M14B0](%s,%d) Invaild Opermode parameter !!!\n",__F__, __L__);
			return RET_ERROR;
	}
	...
	switch(bandWd)
	{
		...
		default :
			DEMOD_PRINT("[DEMOD M14B0](%s,%d) Invalid Bandwidth parameter !!!\n",__F__, __L__);
			return RET_ERROR;
	}
	...
	switch(symbr)
	{
		...
		default :
			DEMOD_PRINT("[DEMOD M14B0](%s,%d) Invalid Symbol rate parameter !!!\n",__F__, __L__);
			return RET_ERROR;
	}
	...
	*/
	...
	DEMOD_PRINT("[DEMOD H14 GBB] Sampling frequency is %d [MHz] (%d)!!!\n",samplingFreq/65536, samplingFreq );
 ...
 * @author 	Jeongpil.yun(jeongpil.yun@lge.com)
*/
int DEMOD_M14B0_NeverlockScan(DEMOD_CTX_T *pDemodInfo, LX_DEMOD_FLAG_T ResetOn, LX_DEMOD_FLAG_T *pScanProcessing, LX_DEMOD_LOCK_STATE_T *pScanLock)
{
		...
		case LX_DEMOD_IDLE :
			...
			if(elapsedTime > _maxTimeOut)
			{
				*pScanProcessing	= LX_DEMOD_FLAG_FINISH;
				...
				DEMOD_PRINT( "[DEMOD H14 GBB] NEVERSCAN : LX_DEMOD_NEVERLOCK DETECTION is on initializing \n");
		...
		case LX_DEMOD_DETECTION_PROCESSING:
			{
				...
				if(elapsedTime > _maxTimeOut)
				{
					*pScanProcessing 	= LX_DEMOD_FLAG_FINISH;
					_demodScanLock		= LX_DEMOD_UNLOCKED;
					DEMOD_PRINT( "[DEMOD H14 GBB] NEVERSCAN : LX_DEMOD_NEVERLOCK DETECTION is on processing \n");
		...
		case LX_DEMOD_DETECTION_FAIL:
			{
				*pScanProcessing 	= LX_DEMOD_FLAG_FINISH;
				_demodScanLock		= LX_DEMOD_UNLOCKED;
				DEMOD_PRINT( "[DEMOD H14 GBB] NEVERSCAN :  LX_DEMOD_NEVERLOCK DETECTION FAIL  \n");
			}
			break;
		...
		case LX_DEMOD_DETECTED:
			{
				*pScanProcessing 	= LX_DEMOD_FLAG_FINISH;
				...
				DEMOD_PRINT( "[DEMOD H14 GBB] NEVERSCAN :  LX_DEMOD_NEVERLOCK DETECTED  !! \n");
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14B0_TPOutEnable(BOOLEAN bEnable)
{

	UINT8 	tpouten;

	DEMOD_PRINT(" @DEMOD_M14B0_TPOutCLKEnable\n");
	...
	DEMOD_TRACE(" DEMOD_M14B0_TPOutEnable(%s)\n",(bEnable == TRUE) ? "ENABLE":"DISABLE");
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14B0_Set_IF_Frq(UINT32 ifFrq)
{
	...
	DEMOD_PRINT(" @DEMOD_M14B0_Set_IF_Frq\n");
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14B0_Set_AGCPolarity(LX_DEMOD_AGC_POLAR_T agcPola)
{

	UINT8 	agcoutpol;

	DEMOD_PRINT(" @DEMOD_M14B0_DVBT_Set_AGCPolarity\n");
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14B0_Set_SpectrumCtrl(BOOLEAN bAutoEnable, BOOLEAN bSpecInvEnable)
{
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14B0_Get_Id(UINT16 *pId)
{
...
************************************************************************************/
/**
 * DEMOD_M14B0_Get_SpectrumInvStatus
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14B0_Get_SpectrumStatus(LX_DEMOD_LOCK_STATE_T *pSpectrumAuto, LX_DEMOD_LOCK_STATE_T *pSpectrumInv)
{
	...
	Common_Rd01(common_mon5,specinvstatus,specinvstatus); //SPECINVSTATUS : '1'-> inversion, '0'-> normal.
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14B0_Get_IFAGC(UINT16 *pIfAgc)
{
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14B0_Get_OperMode(LX_DEMOD_OPER_MODE_T *pOperMode)
{
...
************************************************************************************/
/**
 * DEMOD_M14B0_Get_NeverLockStatus
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14B0_Get_NeverLockStatus(LX_DEMOD_OPER_MODE_T scanMode, LX_DEMOD_LOCK_STATE_T *pNeverLockStatus)
{
	UINT8 neverlock_1_0;
	UINT8 srdstatus_1_0;
	UINT8 tpslockeq_d;
	...
	*pNeverLockStatus = LX_DEMOD_UNKOWN_STATE;
	...
	DEMOD_PRINT("[DEMOD H14 GBB](%s) neverlock_1_0 = %d !!!\n", __F__,neverlock_1_0);
	DEMOD_PRINT("[DEMOD H14 GBB](%s) srdstatus_1_0 = %d !!!\n", __F__,srdstatus_1_0);
	DEMOD_PRINT("[DEMOD H14 GBB](%s) tpslockeq_d = %d !!!\n", __F__,tpslockeq_d);

	if(scanMode == LX_DEMOD_QAM)
	{
		if((neverlock_1_0 == 3) || (srdstatus_1_0 == 3))
		{
			DEMOD_PRINT("[DEMOD H14 GBB](%s)neverlock_1_0[%d] srdstatus_1_0[%d]!!!\n", __F__,neverlock_1_0,srdstatus_1_0);
			neverlock_1_0 = 3;
		}
	}
	else if(scanMode == LX_DEMOD_ISDBT)
	{
		...
		{
			DEMOD_PRINT("[DEMOD H14 GBB](%s)neverlock_1_0[%d] tpslockeq_d[%d]!!!\n", __F__,neverlock_1_0,tpslockeq_d);
			neverlock_1_0 = 1;
		}
	...
	DEMOD_PRINT("[DEMOD H14 GBB](%s) SYSLOCK = %s !!!\n", __F__,(syslock == 1) ? "LOCK" :"NOT LOCK");
...
************************************************************************************/
/**
 * DEMOD_M14B0_Get_CarrierFreqOffset
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14B0_Get_CarrierFreqOffset(SINT32 *pFreqOff)
{
		...
		*pFreqOff = carrierOffset;
		...
		DEMOD_PRINT("[DEMOD H14 GBB] Carrier Offset freq = %d [KHz] !!!\n",*pFreqOff);
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14B0_Get_TPIFStatus(BOOLEAN *pbEnable)
{
	UINT8 	tpifen;

	DEMOD_PRINT("[DEMOD H14 GBB] == @ %s!!!\n",__F__);
	...
	DEMOD_PRINT("[DEMOD H14 GBB] TP IF function is %s!!\n",(*pbEnable == TRUE) ? "Active" : "Inactive");
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14B0_Get_VABER(UINT32 *pVber)
{
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14B0_Get_Packet_Error(UINT32 *pError)
{
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14B0_Get_BandWidthMode( LX_DEMOD_BWMODE_T *ChannelBW )
{
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14B0_Get_QAMMode( LX_DEMOD_RF_MODE_T *pQamMode )
{
	...
	*pQamMode = LX_DEMOD_UNKOWN_MODE;
	...
	switch(mode)
	{
		...
		default :
			DEMOD_PRINT("[DEMOD H14 GBB] FAIL,(%s:%d) UNKNOWN RF MODE !!!\n", __F__, __L__);
			return RET_ERROR;
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14B0_Get_MseInfo( LX_DEMOD_MSE_T *pSigMse)
{
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14B0_Get_Lock(LX_DEMOD_LOCK_STATUS_T whatLock, LX_DEMOD_LOCK_STATE_T *lockState)
{
...
//	DEMOD_PRINT("[DEMOD H13 DTV] @ %s =====\n",__F__);
	...
	if (RET_OK != DEMOD_M14B0_Get_OperMode(&operMode))
	{
		DEMOD_PRINT("[DEMOD H14 GBB] FAIL (%s:%d) DEMOD_M14B0_GetOperMode() !!!\n", __F__, __L__);
		...
		case LX_DEMOD_PSYNC_LOCK:
			{
				...
				{
//					DEMOD_M14B0_DVBT_Get_IFO_LOCK(&ifoLock);
...
int DEMOD_M14B0_VSB_Get_SysLockTime(UINT16 *pSyslocktime)
{
	UINT8	syslocktime_15_8;
	UINT8	syslocktime_7_0;
	UINT16	syslocktime;

	DEMOD_PRINT("[DEMOD M14B0 DTV] @ %s =====\n",__F__);

	Common_RdFL(common_mon8);  //regAddr = 0x0088[7:0]
	Common_Rd01(common_mon8,syslocktime_15_8,syslocktime_15_8); 
	syslocktime = (syslocktime_15_8 << 8 ) ;


	Common_RdFL(common_mon9);  //regAddr = 0x0089[7:0]
	Common_Rd01(common_mon9,syslocktime_7_0,syslocktime_7_0); 
	syslocktime += (syslocktime_7_0 << 0 ) ;

	*pSyslocktime = syslocktime;

	//printk("#####check syslock time [%d] \n", syslocktime);
...
int DEMOD_M14B0_VSB_Get_FecLockTime(UINT16 *pFeclocktime)
{
	UINT8	feclocktime_15_8;
	UINT8	feclocktime_7_0;
	UINT16	feclocktime;

	DEMOD_PRINT("[DEMOD M14B0 DTV] @ %s =====\n",__F__);

	Common_RdFL(common_mon12);  //regAddr = 0x008c[7:0]
	Common_Rd01(common_mon12,feclocktime_15_8,feclocktime_15_8); 
	feclocktime = (feclocktime_15_8 << 8 ) ;


	Common_RdFL(common_mon13);  //regAddr = 0x008d[7:0]
	Common_Rd01(common_mon13,feclocktime_7_0,feclocktime_7_0); 
	feclocktime += (feclocktime_7_0 << 0 ) ;

	*pFeclocktime = feclocktime;

	//printk("#####check feclocktime [%d] \n", feclocktime);
...
int DEMOD_M14B0_ANALOG_ResetHW(void)
{
	...
	if(ACE_REG_M14B0_RdFd(soft_reset_0,swrst_f24m) == 1)
	{
		...
		ACE_REG_M14B0_Wr01(soft_reset_0,swrst_f24m,0);
		ACE_REG_M14B0_WrFL(soft_reset_0);
		DEMOD_PRINT_ALWAYS("[KDRV_DEMOD] ###chungiii NEED TO BE RESET swrst_f24m \n");
		
	}
	else
	{
		DEMOD_PRINT_ALWAYS("[KDRV_DEMOD]###chungiii ALREADY RESET swrst_f24m \n");
	}
...
////
	ACE_REG_M14B0_RdFL(bbdemod_control_0);

	ACE_REG_M14B0_Wr01(bbdemod_control_0, bbdemod_control, 0);

	ACE_REG_M14B0_WrFL(bbdemod_control_0);
...
////
	...
	DEMOD_PRINT("[KDRV_DEMOD]###chungiii DEMOD_ResetHW start !! \n");
	...
	ACE_REG_M14B0_RdFL(abb_1);

	ACE_REG_M14B0_Wr01(abb_1, abb_reset, 1);

	ACE_REG_M14B0_WrFL(abb_1);

	OS_MsecSleep(10);


	ACE_REG_M14B0_Wr01(abb_1, abb_reset, 0);
	...
	DEMOD_PRINT("[KDRV_DEMOD] ###chungiii DEMOD_ANALOG_ResetHW end !! \n");
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_M14B0_ANALOG_SetI2C(void)
{
	DEMOD_PRINT("[KDRV_DEMOD] DEMOD_M14B0_ANALOG_SetI2C Start !! \n");

	ACE_REG_M14B0_RdFL(abb_0);

	ACE_REG_M14B0_Wr01(abb_0, abb_i2csel, 0);

	ACE_REG_M14B0_WrFL(abb_0);

	DEMOD_PRINT("[KDRV_DEMOD] DEMOD_M14B0_ANALOG_SetI2C end !! \n");
	return RET_OK;
}
...
************************************************************************************/
/**
 * DEMOD_M14B0_ANALOG_Set_AbbMode.
 * select inclk mode
 *
 * @param inclk  [IN] LX_DEMOD_INCLK_SEL_T
 * @return if Succeeded - RET_OK else-RET_ERROR
...
int DEMOD_M14B0_ANALOG_Set_AbbMode(BOOLEAN bIsAbbMode)
{

	DEMOD_PRINT("[KDRV_DEMOD] DEMOD_M14B0_ANALOG_Set_AbbMode Start !! \n");


	if(TRUE == bIsAbbMode)
	{
		ACE_REG_M14B0_RdFL(bbdemod_control_0);	 // slave/reg addr = 0x10/0x46
		
		ACE_REG_M14B0_Wr01(bbdemod_control_0, bbdemod_control, 0); //0 : ABB, 1: GBB
		
		ACE_REG_M14B0_WrFL(bbdemod_control_0);


#if 0
		ACE_REG_M14B0_RdFL(abb_2);  // slave/reg addr = 0x12/0x15  --> handed over to CVD part 
		
		ACE_REG_M14B0_Wr01(abb_2, abb_mux_sel, 0);
		
		ACE_REG_M14B0_WrFL(abb_2);


		ACE_REG_M14B0_RdFL(abb_3);   // slave/reg addr = 0x12/0x16   --> handed over to audio part
		
		ACE_REG_M14B0_Wr01(abb_3, abb_mux_sel_aad, 0);
	...
	else
	{
		...
		ACE_REG_M14B0_Wr01(bbdemod_control_0, bbdemod_control, 1); //0 : ABB, 1: GBB
		
		ACE_REG_M14B0_WrFL(bbdemod_control_0);


#if 0
		ACE_REG_M14B0_RdFL(abb_2);  // slave/reg addr = 0x12/0x15
		
		ACE_REG_M14B0_Wr01(abb_2, abb_mux_sel, 1);//0 : ABB, 1: GBB
		
		ACE_REG_M14B0_WrFL(abb_2);


		ACE_REG_M14B0_RdFL(abb_3);   // slave/reg addr = 0x12/0x16
		
		ACE_REG_M14B0_Wr01(abb_3, abb_mux_sel_aad, 1);//0 : ABB, 1: GBB
	...
	DEMOD_PRINT("[KDRV_DEMOD] DEMOD_M14B0_ANALOG_Set_AbbMode End !! \n");
