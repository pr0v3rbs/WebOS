...
//#ifndef _REG_HDMI_LINK_M14A0_h
//#define _REG_HDMI_LINK_M14A0_h
/*-----------------------------------------------------------------------------
		0x0 phy_link_00 ''
-----------------------------------------------------------------------------*/
typedef struct {
...
typedef struct {
	...
	UINT32 intr_auth_init_enable              : 1 ;  //    14     
	UINT32 intr_auth_done_enable              : 1 ;  //    15     
...
typedef struct {
	...
	UINT32 intr_auth_init                     : 1 ;  //    14     
	UINT32 intr_auth_done                     : 1 ;  //    15     
...
typedef struct {
	...
	UINT32 reg_cbus_disc_width_sel            : 1 ;  //    14     
	UINT32 reg_cbus_ctrl_inv                  : 1 ;  //    15     
...
typedef struct {
	...
	UINT32 reg_cbus_bi_src_bit_length         : 7 ;  // 14: 8     
	UINT32                                    : 1 ;  //    15     reserved
...
typedef struct {
	M14A0_PHY_LINK_00_T                  	phy_link_00;                  //0x0
	M14A0_PHY_LINK_01_T                  	phy_link_01;                  //0x4
	M14A0_PHY_LINK_02_T                  	phy_link_02;                  //0x8
	M14A0_PHY_LINK_03_T                  	phy_link_03;                  //0xc
	M14A0_PHY_LINK_04_T                  	phy_link_04;                  //0x10
	M14A0_PHY_LINK_05_T                  	phy_link_05;                  //0x14
	M14A0_PHY_LINK_06_T                  	phy_link_06;                  //0x18
	M14A0_PHY_LINK_07_T                  	phy_link_07;                  //0x1c
	M14A0_INTERRUPT_ENABLE_00_T          	interrupt_enable_00;          //0x20
	M14A0_INTERRUPT_ENABLE_01_T          	interrupt_enable_01;          //0x24
	M14A0_INTERRUPT_ENABLE_02_T          	interrupt_enable_02;          //0x28
	M14A0_INTERRUPT_ENABLE_03_T          	interrupt_enable_03;          //0x2c
	M14A0_INTERRUPT_ENABLE_04_T          	interrupt_enable_04;          //0x30
	M14A0_INTERRUPT_00_T                 	interrupt_00;                 //0x34
	M14A0_INTERRUPT_01_T                 	interrupt_01;                 //0x38
	M14A0_INTERRUPT_02_T                 	interrupt_02;                 //0x3c
	M14A0_INTERRUPT_03_T                 	interrupt_03;                 //0x40
	M14A0_INTERRUPT_04_T                 	interrupt_04;                 //0x44
	M14A0_SYSTEM_CONTROL_00_T            	system_control_00;            //0x48
	M14A0_SYSTEM_CONTROL_01_T            	system_control_01;            //0x4c
	M14A0_SYSTEM_CONTROL_02_T            	system_control_02;            //0x50
	M14A0_HDCP_00_T                      	hdcp_00;                      //0x54
	M14A0_HDCP_01_T                      	hdcp_01;                      //0x58
	M14A0_HDCP_02_T                      	hdcp_02;                      //0x5c
	M14A0_HDCP_03_T                      	hdcp_03;                      //0x60
	M14A0_HDCP_04_T                      	hdcp_04;                      //0x64
	M14A0_HDCP_05_T                      	hdcp_05;                      //0x68
	M14A0_HDCP_06_T                      	hdcp_06;                      //0x6c
	M14A0_HDCP_07_T                      	hdcp_07;                      //0x70
	M14A0_HDCP_08_T                      	hdcp_08;                      //0x74
	M14A0_HDCP_09_T                      	hdcp_09;                      //0x78
	M14A0_HDCP_10_T                      	hdcp_10;                      //0x7c
	M14A0_HDCP_11_T                      	hdcp_11;                      //0x80
	M14A0_HDCP_12_T                      	hdcp_12;                      //0x84
	M14A0_HDCP_13_T                      	hdcp_13;                      //0x88
	M14A0_HDCP_14_T                      	hdcp_14;                      //0x8c
	M14A0_HDCP_15_T                      	hdcp_15;                      //0x90
	M14A0_HDCP_16_T                      	hdcp_16;                      //0x94
	M14A0_HDCP_17_T                      	hdcp_17;                      //0x98
	M14A0_HDCP_18_T                      	hdcp_18;                      //0x9c
	M14A0_HDCP_19_T                      	hdcp_19;                      //0xa0
	M14A0_HDCP_20_T                      	hdcp_20;                      //0xa4
	M14A0_HDCP_21_T                      	hdcp_21;                      //0xa8
	M14A0_HDCP_22_T                      	hdcp_22;                      //0xac
	M14A0_HDCP_23_T                      	hdcp_23;                      //0xb0
	M14A0_PACKET_00_T                    	packet_00;                    //0xb4
	M14A0_PACKET_01_T                    	packet_01;                    //0xb8
	M14A0_PACKET_02_T                    	packet_02;                    //0xbc
	M14A0_PACKET_03_T                    	packet_03;                    //0xc0
	M14A0_PACKET_04_T                    	packet_04;                    //0xc4
	M14A0_PACKET_05_T                    	packet_05;                    //0xc8
	M14A0_PACKET_06_T                    	packet_06;                    //0xcc
	M14A0_PACKET_07_T                    	packet_07;                    //0xd0
	M14A0_PACKET_08_T                    	packet_08;                    //0xd4
	M14A0_PACKET_09_T                    	packet_09;                    //0xd8
	M14A0_PACKET_10_T                    	packet_10;                    //0xdc
	M14A0_PACKET_11_T                    	packet_11;                    //0xe0
	M14A0_PACKET_12_T                    	packet_12;                    //0xe4
	M14A0_PACKET_13_T                    	packet_13;                    //0xe8
	M14A0_PACKET_14_T                    	packet_14;                    //0xec
	M14A0_PACKET_15_T                    	packet_15;                    //0xf0
	M14A0_PACKET_16_T                    	packet_16;                    //0xf4
	M14A0_PACKET_17_T                    	packet_17;                    //0xf8
	M14A0_PACKET_18_T                    	packet_18;                    //0xfc
	M14A0_PACKET_19_T                    	packet_19;                    //0x100
	M14A0_PACKET_20_T                    	packet_20;                    //0x104
	M14A0_PACKET_21_T                    	packet_21;                    //0x108
	M14A0_PACKET_22_T                    	packet_22;                    //0x10c
	M14A0_PACKET_23_T                    	packet_23;                    //0x110
	M14A0_PACKET_24_T                    	packet_24;                    //0x114
	M14A0_PACKET_25_T                    	packet_25;                    //0x118
	M14A0_PACKET_26_T                    	packet_26;                    //0x11c
	M14A0_PACKET_27_T                    	packet_27;                    //0x120
	M14A0_PACKET_28_T                    	packet_28;                    //0x124
	M14A0_PACKET_29_T                    	packet_29;                    //0x128
	M14A0_PACKET_30_T                    	packet_30;                    //0x12c
	M14A0_PACKET_31_T                    	packet_31;                    //0x130
	M14A0_PACKET_32_T                    	packet_32;                    //0x134
	M14A0_PACKET_33_T                    	packet_33;                    //0x138
	M14A0_PACKET_34_T                    	packet_34;                    //0x13c
	M14A0_PACKET_35_T                    	packet_35;                    //0x140
	M14A0_PACKET_36_T                    	packet_36;                    //0x144
	M14A0_PACKET_37_T                    	packet_37;                    //0x148
	M14A0_PACKET_38_T                    	packet_38;                    //0x14c
	M14A0_PACKET_39_T                    	packet_39;                    //0x150
	M14A0_PACKET_40_T                    	packet_40;                    //0x154
	M14A0_PACKET_41_T                    	packet_41;                    //0x158
	M14A0_PACKET_42_T                    	packet_42;                    //0x15c
	M14A0_PACKET_43_T                    	packet_43;                    //0x160
	M14A0_PACKET_44_T                    	packet_44;                    //0x164
	M14A0_PACKET_45_T                    	packet_45;                    //0x168
	M14A0_PACKET_46_T                    	packet_46;                    //0x16c
	M14A0_PACKET_47_T                    	packet_47;                    //0x170
	M14A0_PACKET_48_T                    	packet_48;                    //0x174
	M14A0_PACKET_49_T                    	packet_49;                    //0x178
	M14A0_PACKET_50_T                    	packet_50;                    //0x17c
	M14A0_PACKET_51_T                    	packet_51;                    //0x180
	M14A0_PACKET_52_T                    	packet_52;                    //0x184
	M14A0_PACKET_53_T                    	packet_53;                    //0x188
	M14A0_PACKET_54_T                    	packet_54;                    //0x18c
	M14A0_PACKET_55_T                    	packet_55;                    //0x190
	M14A0_PACKET_56_T                    	packet_56;                    //0x194
	M14A0_PACKET_57_T                    	packet_57;                    //0x198
	M14A0_PACKET_58_T                    	packet_58;                    //0x19c
	M14A0_PACKET_59_T                    	packet_59;                    //0x1a0
	M14A0_PACKET_60_T                    	packet_60;                    //0x1a4
	M14A0_PACKET_61_T                    	packet_61;                    //0x1a8
	M14A0_PACKET_62_T                    	packet_62;                    //0x1ac
	M14A0_PACKET_63_T                    	packet_63;                    //0x1b0
	M14A0_PACKET_64_T                    	packet_64;                    //0x1b4
	M14A0_PACKET_65_T                    	packet_65;                    //0x1b8
	M14A0_PACKET_66_T                    	packet_66;                    //0x1bc
	M14A0_PACKET_67_T                    	packet_67;                    //0x1c0
	M14A0_PACKET_68_T                    	packet_68;                    //0x1c4
	M14A0_PACKET_69_T                    	packet_69;                    //0x1c8
	M14A0_PACKET_70_T                    	packet_70;                    //0x1cc
	M14A0_PACKET_71_T                    	packet_71;                    //0x1d0
	M14A0_PACKET_72_T                    	packet_72;                    //0x1d4
	M14A0_PACKET_73_T                    	packet_73;                    //0x1d8
	M14A0_PACKET_74_T                    	packet_74;                    //0x1dc
	M14A0_PACKET_75_T                    	packet_75;                    //0x1e0
	M14A0_PACKET_76_T                    	packet_76;                    //0x1e4
	M14A0_PACKET_77_T                    	packet_77;                    //0x1e8
	M14A0_PACKET_78_T                    	packet_78;                    //0x1ec
	M14A0_PACKET_79_T                    	packet_79;                    //0x1f0
	M14A0_PACKET_80_T                    	packet_80;                    //0x1f4
	M14A0_PACKET_81_T                    	packet_81;                    //0x1f8
	M14A0_PACKET_82_T                    	packet_82;                    //0x1fc
	M14A0_VIDEO_00_T                     	video_00;                     //0x200
	M14A0_VIDEO_01_T                     	video_01;                     //0x204
	M14A0_VIDEO_02_T                     	video_02;                     //0x208
	M14A0_VIDEO_03_T                     	video_03;                     //0x20c
	M14A0_VIDEO_04_T                     	video_04;                     //0x210
	M14A0_VIDEO_05_T                     	video_05;                     //0x214
	M14A0_VIDEO_06_T                     	video_06;                     //0x218
	M14A0_VIDEO_07_T                     	video_07;                     //0x21c
	M14A0_VIDEO_08_T                     	video_08;                     //0x220
	M14A0_VIDEO_09_T                     	video_09;                     //0x224
	M14A0_VIDEO_10_T                     	video_10;                     //0x228
	M14A0_AUDIO_00_T                     	audio_00;                     //0x22c
	M14A0_AUDIO_01_T                     	audio_01;                     //0x230
	M14A0_AUDIO_02_T                     	audio_02;                     //0x234
	M14A0_AUDIO_03_T                     	audio_03;                     //0x238
	M14A0_AUDIO_04_T                     	audio_04;                     //0x23c
	M14A0_AUDIO_05_T                     	audio_05;                     //0x240
	M14A0_AUDIO_06_T                     	audio_06;                     //0x244
	M14A0_AUDIO_07_T                     	audio_07;                     //0x248
	M14A0_AUDIO_08_T                     	audio_08;                     //0x24c
	M14A0_AUDIO_09_T                     	audio_09;                     //0x250
	M14A0_AUDIO_10_T                     	audio_10;                     //0x254
	M14A0_EDID_HEAC_00_T                 	edid_heac_00;                 //0x258
	M14A0_CBUS_00_T                      	cbus_00;                      //0x25c
	M14A0_CBUS_01_T                      	cbus_01;                      //0x260
	M14A0_CBUS_02_T                      	cbus_02;                      //0x264
	M14A0_CBUS_03_T                      	cbus_03;                      //0x268
	M14A0_CBUS_04_T                      	cbus_04;                      //0x26c
	M14A0_CBUS_05_T                      	cbus_05;                      //0x270
	M14A0_CBUS_06_T                      	cbus_06;                      //0x274
	M14A0_CBUS_07_T                      	cbus_07;                      //0x278
	M14A0_CBUS_08_T                      	cbus_08;                      //0x27c
	M14A0_CBUS_09_T                      	cbus_09;                      //0x280
	M14A0_CBUS_10_T                      	cbus_10;                      //0x284
	M14A0_CBUS_11_T                      	cbus_11;                      //0x288
	M14A0_CBUS_12_T                      	cbus_12;                      //0x28c
	M14A0_CBUS_13_T                      	cbus_13;                      //0x290
	M14A0_CBUS_14_T                      	cbus_14;                      //0x294
	M14A0_CBUS_15_T                      	cbus_15;                      //0x298
	M14A0_CBUS_16_T                      	cbus_16;                      //0x29c
	M14A0_CBUS_17_T                      	cbus_17;                      //0x2a0
	M14A0_CBUS_18_T                      	cbus_18;                      //0x2a4
	M14A0_CBUS_19_T                      	cbus_19;                      //0x2a8
	M14A0_CBUS_20_T                      	cbus_20;                      //0x2ac
	M14A0_CBUS_21_T                      	cbus_21;                      //0x2b0
	M14A0_CBUS_22_T                      	cbus_22;                      //0x2b4
	M14A0_CBUS_23_T                      	cbus_23;                      //0x2b8
	M14A0_CBUS_24_T                      	cbus_24;                      //0x2bc
	M14A0_CBUS_25_T                      	cbus_25;                      //0x2c0
	M14A0_CBUS_26_T                      	cbus_26;                      //0x2c4
	M14A0_CBUS_27_T                      	cbus_27;                      //0x2c8
	M14A0_CBUS_28_T                      	cbus_28;                      //0x2cc
	M14A0_CBUS_29_T                      	cbus_29;                      //0x2d0
	M14A0_CBUS_30_T                      	cbus_30;                      //0x2d4
	M14A0_CBUS_31_T                      	cbus_31;                      //0x2d8
	M14A0_CBUS_32_T                      	cbus_32;                      //0x2dc
	M14A0_EDID_00_T                      	edid_00;                      //0x2e0
	M14A0_EDID_01_T                      	edid_01;                      //0x2e4
	M14A0_EDID_02_T                      	edid_02;                      //0x2e8
	M14A0_EDID_03_T                      	edid_03;                      //0x2ec
	M14A0_EDID_04_T                      	edid_04;                      //0x2f0
	M14A0_EDID_05_T                      	edid_05;                      //0x2f4
	M14A0_EDID_06_T                      	edid_06;                      //0x2f8
	M14A0_EDID_07_T                      	edid_07;                      //0x2fc
	M14A0_EDID_08_T                      	edid_08;                      //0x300
	M14A0_EDID_09_T                      	edid_09;                      //0x304
	M14A0_EDID_10_T                      	edid_10;                      //0x308
	M14A0_EDID_11_T                      	edid_11;                      //0x30c
	M14A0_EDID_12_T                      	edid_12;                      //0x310
	M14A0_EDID_13_T                      	edid_13;                      //0x314
	M14A0_EDID_14_T                      	edid_14;                      //0x318
	M14A0_EDID_15_T                      	edid_15;                      //0x31c
	M14A0_EDID_16_T                      	edid_16;                      //0x320
	M14A0_EDID_17_T                      	edid_17;                      //0x324
	M14A0_EDID_18_T                      	edid_18;                      //0x328
	M14A0_EDID_19_T                      	edid_19;                      //0x32c
	M14A0_EDID_20_T                      	edid_20;                      //0x330
	M14A0_EDID_21_T                      	edid_21;                      //0x334
	M14A0_EDID_22_T                      	edid_22;                      //0x338
	M14A0_EDID_23_T                      	edid_23;                      //0x33c
	M14A0_EDID_24_T                      	edid_24;                      //0x340
	M14A0_EDID_25_T                      	edid_25;                      //0x344
	M14A0_EDID_26_T                      	edid_26;                      //0x348
	M14A0_EDID_27_T                      	edid_27;                      //0x34c
	M14A0_EDID_28_T                      	edid_28;                      //0x350
	M14A0_EDID_29_T                      	edid_29;                      //0x354
	M14A0_EDID_30_T                      	edid_30;                      //0x358
	M14A0_EDID_31_T                      	edid_31;                      //0x35c
	M14A0_EDID_32_T                      	edid_32;                      //0x360
	M14A0_EDID_33_T                      	edid_33;                      //0x364
	M14A0_EDID_34_T                      	edid_34;                      //0x368
	M14A0_EDID_35_T                      	edid_35;                      //0x36c
	M14A0_EDID_36_T                      	edid_36;                      //0x370
	M14A0_EDID_37_T                      	edid_37;                      //0x374
	M14A0_EDID_38_T                      	edid_38;                      //0x378
	M14A0_EDID_39_T                      	edid_39;                      //0x37c
	M14A0_EDID_40_T                      	edid_40;                      //0x380
	M14A0_EDID_41_T                      	edid_41;                      //0x384
	M14A0_EDID_42_T                      	edid_42;                      //0x388
	M14A0_EDID_43_T                      	edid_43;                      //0x38c
	M14A0_EDID_44_T                      	edid_44;                      //0x390
	M14A0_EDID_45_T                      	edid_45;                      //0x394
	M14A0_EDID_46_T                      	edid_46;                      //0x398
	M14A0_EDID_47_T                      	edid_47;                      //0x39c
	M14A0_EDID_48_T                      	edid_48;                      //0x3a0
	M14A0_EDID_49_T                      	edid_49;                      //0x3a4
	M14A0_EDID_50_T                      	edid_50;                      //0x3a8
	M14A0_EDID_51_T                      	edid_51;                      //0x3ac
	M14A0_EDID_52_T                      	edid_52;                      //0x3b0
	M14A0_EDID_53_T                      	edid_53;                      //0x3b4
	M14A0_EDID_54_T                      	edid_54;                      //0x3b8
	M14A0_EDID_55_T                      	edid_55;                      //0x3bc
	M14A0_EDID_56_T                      	edid_56;                      //0x3c0
	M14A0_EDID_57_T                      	edid_57;                      //0x3c4
	M14A0_EDID_58_T                      	edid_58;                      //0x3c8
	M14A0_EDID_59_T                      	edid_59;                      //0x3cc
	M14A0_EDID_60_T                      	edid_60;                      //0x3d0
	M14A0_EDID_61_T                      	edid_61;                      //0x3d4
	M14A0_EDID_62_T                      	edid_62;                      //0x3d8
	M14A0_EDID_63_T                      	edid_63;                      //0x3dc
	M14A0_EDID_64_T                      	edid_64;                      //0x3e0
	M14A0_EDID_65_T                      	edid_65;                      //0x3e4
	M14A0_EDID_66_T                      	edid_66;                      //0x3e8
	M14A0_EDID_67_T                      	edid_67;                      //0x3ec
	M14A0_EDID_68_T                      	edid_68;                      //0x3f0
	M14A0_EDID_69_T                      	edid_69;                      //0x3f4
	M14A0_EDID_70_T                      	edid_70;                      //0x3f8
	M14A0_EDID_71_T                      	edid_71;                      //0x3fc
	M14A0_EDID_72_T                      	edid_72;                      //0x400
	M14A0_EDID_73_T                      	edid_73;                      //0x404
	M14A0_EDID_74_T                      	edid_74;                      //0x408
	M14A0_EDID_75_T                      	edid_75;                      //0x40c
	M14A0_EDID_76_T                      	edid_76;                      //0x410
	M14A0_EDID_77_T                      	edid_77;                      //0x414
	M14A0_EDID_78_T                      	edid_78;                      //0x418
	M14A0_EDID_79_T                      	edid_79;                      //0x41c
	M14A0_EDID_80_T                      	edid_80;                      //0x420
	M14A0_EDID_81_T                      	edid_81;                      //0x424
	M14A0_EDID_82_T                      	edid_82;                      //0x428
	M14A0_EDID_83_T                      	edid_83;                      //0x42c
	M14A0_EDID_84_T                      	edid_84;                      //0x430
	M14A0_EDID_85_T                      	edid_85;                      //0x434
	M14A0_EDID_86_T                      	edid_86;                      //0x438
	M14A0_EDID_87_T                      	edid_87;                      //0x43c
	M14A0_EDID_88_T                      	edid_88;                      //0x440
	M14A0_EDID_89_T                      	edid_89;                      //0x444
	M14A0_EDID_90_T                      	edid_90;                      //0x448
	M14A0_EDID_91_T                      	edid_91;                      //0x44c
	M14A0_EDID_92_T                      	edid_92;                      //0x450
	M14A0_EDID_93_T                      	edid_93;                      //0x454
	M14A0_EDID_94_T                      	edid_94;                      //0x458
	M14A0_EDID_95_T                      	edid_95;                      //0x45c
	M14A0_EDID_96_T                      	edid_96;                      //0x460
	M14A0_EDID_97_T                      	edid_97;                      //0x464
	M14A0_EDID_98_T                      	edid_98;                      //0x468
	M14A0_EDID_99_T                      	edid_99;                      //0x46c
	M14A0_EDID_100_T                     	edid_100;                     //0x470
	M14A0_EDID_101_T                     	edid_101;                     //0x474
	M14A0_EDID_102_T                     	edid_102;                     //0x478
	M14A0_EDID_103_T                     	edid_103;                     //0x47c
	M14A0_EDID_104_T                     	edid_104;                     //0x480
	M14A0_EDID_105_T                     	edid_105;                     //0x484
	M14A0_EDID_106_T                     	edid_106;                     //0x488
	M14A0_EDID_107_T                     	edid_107;                     //0x48c
	M14A0_EDID_108_T                     	edid_108;                     //0x490
	M14A0_EDID_109_T                     	edid_109;                     //0x494
	M14A0_EDID_110_T                     	edid_110;                     //0x498
	M14A0_EDID_111_T                     	edid_111;                     //0x49c
	M14A0_EDID_112_T                     	edid_112;                     //0x4a0
	M14A0_EDID_113_T                     	edid_113;                     //0x4a4
	M14A0_EDID_114_T                     	edid_114;                     //0x4a8
	M14A0_EDID_115_T                     	edid_115;                     //0x4ac
	M14A0_EDID_116_T                     	edid_116;                     //0x4b0
	M14A0_EDID_117_T                     	edid_117;                     //0x4b4
	M14A0_EDID_118_T                     	edid_118;                     //0x4b8
	M14A0_EDID_119_T                     	edid_119;                     //0x4bc
	M14A0_EDID_120_T                     	edid_120;                     //0x4c0
	M14A0_EDID_121_T                     	edid_121;                     //0x4c4
	M14A0_EDID_122_T                     	edid_122;                     //0x4c8
	M14A0_EDID_123_T                     	edid_123;                     //0x4cc
	M14A0_EDID_124_T                     	edid_124;                     //0x4d0
	M14A0_EDID_125_T                     	edid_125;                     //0x4d4
	M14A0_EDID_126_T                     	edid_126;                     //0x4d8
	M14A0_EDID_127_T                     	edid_127;                     //0x4dc
	M14A0_EDID_128_T                     	edid_128;                     //0x4e0
	M14A0_EDID_129_T                     	edid_129;                     //0x4e4
	M14A0_EDID_130_T                     	edid_130;                     //0x4e8
	M14A0_EDID_131_T                     	edid_131;                     //0x4ec
	M14A0_EDID_132_T                     	edid_132;                     //0x4f0
	M14A0_EDID_133_T                     	edid_133;                     //0x4f4
	M14A0_EDID_134_T                     	edid_134;                     //0x4f8
	M14A0_EDID_135_T                     	edid_135;                     //0x4fc
	M14A0_EDID_136_T                     	edid_136;                     //0x500
	M14A0_EDID_137_T                     	edid_137;                     //0x504
	M14A0_EDID_138_T                     	edid_138;                     //0x508
	M14A0_EDID_139_T                     	edid_139;                     //0x50c
	M14A0_EDID_140_T                     	edid_140;                     //0x510
	M14A0_EDID_141_T                     	edid_141;                     //0x514
	M14A0_EDID_142_T                     	edid_142;                     //0x518
	M14A0_EDID_143_T                     	edid_143;                     //0x51c
	M14A0_EDID_144_T                     	edid_144;                     //0x520
	M14A0_EDID_145_T                     	edid_145;                     //0x524
	M14A0_EDID_146_T                     	edid_146;                     //0x528
	M14A0_EDID_147_T                     	edid_147;                     //0x52c
	M14A0_EDID_148_T                     	edid_148;                     //0x530
	M14A0_EDID_149_T                     	edid_149;                     //0x534
	M14A0_EDID_150_T                     	edid_150;                     //0x538
	M14A0_EDID_151_T                     	edid_151;                     //0x53c
	M14A0_EDID_152_T                     	edid_152;                     //0x540
	M14A0_EDID_153_T                     	edid_153;                     //0x544
	M14A0_EDID_154_T                     	edid_154;                     //0x548
	M14A0_EDID_155_T                     	edid_155;                     //0x54c
	M14A0_EDID_156_T                     	edid_156;                     //0x550
	M14A0_EDID_157_T                     	edid_157;                     //0x554
	M14A0_EDID_158_T                     	edid_158;                     //0x558
	M14A0_EDID_159_T                     	edid_159;                     //0x55c
	M14A0_EDID_160_T                     	edid_160;                     //0x560
	M14A0_EDID_161_T                     	edid_161;                     //0x564
	M14A0_EDID_162_T                     	edid_162;                     //0x568
	M14A0_EDID_163_T                     	edid_163;                     //0x56c
	M14A0_EDID_164_T                     	edid_164;                     //0x570
	M14A0_EDID_165_T                     	edid_165;                     //0x574
	M14A0_EDID_166_T                     	edid_166;                     //0x578
	M14A0_EDID_167_T                     	edid_167;                     //0x57c
	M14A0_EDID_168_T                     	edid_168;                     //0x580
	M14A0_EDID_169_T                     	edid_169;                     //0x584
	M14A0_EDID_170_T                     	edid_170;                     //0x588
	M14A0_EDID_171_T                     	edid_171;                     //0x58c
	M14A0_EDID_172_T                     	edid_172;                     //0x590
	M14A0_EDID_173_T                     	edid_173;                     //0x594
	M14A0_EDID_174_T                     	edid_174;                     //0x598
	M14A0_EDID_175_T                     	edid_175;                     //0x59c
	M14A0_EDID_176_T                     	edid_176;                     //0x5a0
	M14A0_EDID_177_T                     	edid_177;                     //0x5a4
	M14A0_EDID_178_T                     	edid_178;                     //0x5a8
	M14A0_EDID_179_T                     	edid_179;                     //0x5ac
	M14A0_EDID_180_T                     	edid_180;                     //0x5b0
	M14A0_EDID_181_T                     	edid_181;                     //0x5b4
	M14A0_EDID_182_T                     	edid_182;                     //0x5b8
	M14A0_EDID_183_T                     	edid_183;                     //0x5bc
	M14A0_EDID_184_T                     	edid_184;                     //0x5c0
	M14A0_EDID_185_T                     	edid_185;                     //0x5c4
	M14A0_EDID_186_T                     	edid_186;                     //0x5c8
	M14A0_EDID_187_T                     	edid_187;                     //0x5cc
	M14A0_EDID_188_T                     	edid_188;                     //0x5d0
	M14A0_EDID_189_T                     	edid_189;                     //0x5d4
	M14A0_EDID_190_T                     	edid_190;                     //0x5d8
	M14A0_EDID_191_T                     	edid_191;                     //0x5dc
	M14A0_EDID_192_T                     	edid_192;                     //0x5e0
	M14A0_EDID_193_T                     	edid_193;                     //0x5e4
	M14A0_EDID_194_T                     	edid_194;                     //0x5e8
	M14A0_EDID_195_T                     	edid_195;                     //0x5ec
	M14A0_EDID_196_T                     	edid_196;                     //0x5f0
	M14A0_EDID_197_T                     	edid_197;                     //0x5f4
	M14A0_EDID_198_T                     	edid_198;                     //0x5f8
	M14A0_EDID_199_T                     	edid_199;                     //0x5fc
	M14A0_EDID_200_T                     	edid_200;                     //0x600
	M14A0_EDID_201_T                     	edid_201;                     //0x604
	M14A0_EDID_202_T                     	edid_202;                     //0x608
	M14A0_EDID_203_T                     	edid_203;                     //0x60c
	M14A0_EDID_204_T                     	edid_204;                     //0x610
	M14A0_EDID_205_T                     	edid_205;                     //0x614
	M14A0_EDID_206_T                     	edid_206;                     //0x618
	M14A0_EDID_207_T                     	edid_207;                     //0x61c
	M14A0_EDID_208_T                     	edid_208;                     //0x620
	M14A0_EDID_209_T                     	edid_209;                     //0x624
	M14A0_EDID_210_T                     	edid_210;                     //0x628
	M14A0_EDID_211_T                     	edid_211;                     //0x62c
	M14A0_EDID_212_T                     	edid_212;                     //0x630
	M14A0_EDID_213_T                     	edid_213;                     //0x634
	M14A0_EDID_214_T                     	edid_214;                     //0x638
	M14A0_EDID_215_T                     	edid_215;                     //0x63c
	M14A0_EDID_216_T                     	edid_216;                     //0x640
	M14A0_EDID_217_T                     	edid_217;                     //0x644
	M14A0_EDID_218_T                     	edid_218;                     //0x648
	M14A0_EDID_219_T                     	edid_219;                     //0x64c
	M14A0_EDID_220_T                     	edid_220;                     //0x650
	M14A0_EDID_221_T                     	edid_221;                     //0x654
	M14A0_EDID_222_T                     	edid_222;                     //0x658
	M14A0_EDID_223_T                     	edid_223;                     //0x65c
	M14A0_EDID_224_T                     	edid_224;                     //0x660
	M14A0_EDID_225_T                     	edid_225;                     //0x664
	M14A0_EDID_226_T                     	edid_226;                     //0x668
	M14A0_EDID_227_T                     	edid_227;                     //0x66c
	M14A0_EDID_228_T                     	edid_228;                     //0x670
	M14A0_EDID_229_T                     	edid_229;                     //0x674
	M14A0_EDID_230_T                     	edid_230;                     //0x678
	M14A0_EDID_231_T                     	edid_231;                     //0x67c
	M14A0_EDID_232_T                     	edid_232;                     //0x680
	M14A0_EDID_233_T                     	edid_233;                     //0x684
	M14A0_EDID_234_T                     	edid_234;                     //0x688
	M14A0_EDID_235_T                     	edid_235;                     //0x68c
	M14A0_EDID_236_T                     	edid_236;                     //0x690
	M14A0_EDID_237_T                     	edid_237;                     //0x694
	M14A0_EDID_238_T                     	edid_238;                     //0x698
	M14A0_EDID_239_T                     	edid_239;                     //0x69c
	M14A0_EDID_240_T                     	edid_240;                     //0x6a0
	M14A0_EDID_241_T                     	edid_241;                     //0x6a4
	M14A0_EDID_242_T                     	edid_242;                     //0x6a8
	M14A0_EDID_243_T                     	edid_243;                     //0x6ac
	M14A0_EDID_244_T                     	edid_244;                     //0x6b0
	M14A0_EDID_245_T                     	edid_245;                     //0x6b4
	M14A0_EDID_246_T                     	edid_246;                     //0x6b8
	M14A0_EDID_247_T                     	edid_247;                     //0x6bc
	M14A0_EDID_248_T                     	edid_248;                     //0x6c0
	M14A0_EDID_249_T                     	edid_249;                     //0x6c4
	M14A0_EDID_250_T                     	edid_250;                     //0x6c8
	M14A0_EDID_251_T                     	edid_251;                     //0x6cc
	M14A0_EDID_252_T                     	edid_252;                     //0x6d0
	M14A0_EDID_253_T                     	edid_253;                     //0x6d4
	M14A0_EDID_254_T                     	edid_254;                     //0x6d8
	M14A0_EDID_255_T                     	edid_255;                     //0x6dc
	M14A0_HDCP_24_T                      	hdcp_24;                      //0x6e0
	M14A0_HDCP_25_T                      	hdcp_25;                      //0x6e4
	M14A0_HDCP_26_T                      	hdcp_26;                      //0x6e8
	M14A0_HDCP_27_T                      	hdcp_27;                      //0x6ec
	M14A0_HDCP_28_T                      	hdcp_28;                      //0x6f0
	M14A0_HDCP_29_T                      	hdcp_29;                      //0x6f4
	M14A0_HDCP_30_T                      	hdcp_30;                      //0x6f8
	M14A0_HDCP_31_T                      	hdcp_31;                      //0x6fc
	M14A0_HDCP_32_T                      	hdcp_32;                      //0x700
	M14A0_HDCP_33_T                      	hdcp_33;                      //0x704
	M14A0_HDCP_34_T                      	hdcp_34;                      //0x708
	M14A0_HDCP_35_T                      	hdcp_35;                      //0x70c
	M14A0_HDCP_36_T                      	hdcp_36;                      //0x710
	M14A0_HDCP_37_T                      	hdcp_37;                      //0x714
	M14A0_HDCP_38_T                      	hdcp_38;                      //0x718
	M14A0_HDCP_39_T                      	hdcp_39;                      //0x71c
	M14A0_HDCP_40_T                      	hdcp_40;                      //0x720
	M14A0_HDCP_41_T                      	hdcp_41;                      //0x724
	M14A0_HDCP_42_T                      	hdcp_42;                      //0x728
	M14A0_HDCP_43_T                      	hdcp_43;                      //0x72c
	M14A0_HDCP_44_T                      	hdcp_44;                      //0x730
	M14A0_HDCP_45_T                      	hdcp_45;                      //0x734
	M14A0_HDCP_46_T                      	hdcp_46;                      //0x738
	M14A0_HDCP_47_T                      	hdcp_47;                      //0x73c
	M14A0_HDCP_48_T                      	hdcp_48;                      //0x740
	M14A0_HDCP_49_T                      	hdcp_49;                      //0x744
	M14A0_HDCP_50_T                      	hdcp_50;                      //0x748
	M14A0_HDCP_51_T                      	hdcp_51;                      //0x74c
	M14A0_HDCP_52_T                      	hdcp_52;                      //0x750
	M14A0_HDCP_53_T                      	hdcp_53;                      //0x754
	M14A0_HDCP_54_T                      	hdcp_54;                      //0x758
	M14A0_HDCP_55_T                      	hdcp_55;                      //0x75c
	M14A0_HDCP_56_T                      	hdcp_56;                      //0x760
	M14A0_HDCP_57_T                      	hdcp_57;                      //0x764
	M14A0_HDCP_58_T                      	hdcp_58;                      //0x768
	M14A0_HDCP_59_T                      	hdcp_59;                      //0x76c
	M14A0_HDCP_60_T                      	hdcp_60;                      //0x770
	M14A0_HDCP_61_T                      	hdcp_61;                      //0x774
	M14A0_HDCP_62_T                      	hdcp_62;                      //0x778
	M14A0_HDCP_63_T                      	hdcp_63;                      //0x77c
	M14A0_HDCP_64_T                      	hdcp_64;                      //0x780
	M14A0_HDCP_65_T                      	hdcp_65;                      //0x784
	M14A0_HDCP_66_T                      	hdcp_66;                      //0x788
	M14A0_HDCP_67_T                      	hdcp_67;                      //0x78c
	M14A0_HDCP_68_T                      	hdcp_68;                      //0x790
	M14A0_HDCP_69_T                      	hdcp_69;                      //0x794
	M14A0_HDCP_70_T                      	hdcp_70;                      //0x798
	M14A0_HDCP_71_T                      	hdcp_71;                      //0x79c
	M14A0_HDCP_72_T                      	hdcp_72;                      //0x7a0
	M14A0_HDCP_73_T                      	hdcp_73;                      //0x7a4
	M14A0_HDCP_74_T                      	hdcp_74;                      //0x7a8
	M14A0_HDCP_75_T                      	hdcp_75;                      //0x7ac
	M14A0_HDCP_76_T                      	hdcp_76;                      //0x7b0
	M14A0_HDCP_77_T                      	hdcp_77;                      //0x7b4
	M14A0_HDCP_78_T                      	hdcp_78;                      //0x7b8
	M14A0_HDCP_79_T                      	hdcp_79;                      //0x7bc
	M14A0_HDCP_80_T                      	hdcp_80;                      //0x7c0
	M14A0_HDCP_81_T                      	hdcp_81;                      //0x7c4
	M14A0_HDCP_82_T                      	hdcp_82;                      //0x7c8
	M14A0_HDCP_83_T                      	hdcp_83;                      //0x7cc
	M14A0_HDCP_84_T                      	hdcp_84;                      //0x7d0
	M14A0_HDCP_85_T                      	hdcp_85;                      //0x7d4
	M14A0_HDCP_86_T                      	hdcp_86;                      //0x7d8
	M14A0_HDCP_87_T                      	hdcp_87;                      //0x7dc
	M14A0_HDCP_88_T                      	hdcp_88;                      //0x7e0
	M14A0_HDCP_89_T                      	hdcp_89;                      //0x7e4
	M14A0_HDCP_90_T                      	hdcp_90;                      //0x7e8
	M14A0_HDCP_91_T                      	hdcp_91;                      //0x7ec
	M14A0_HDCP_92_T                      	hdcp_92;                      //0x7f0
	M14A0_HDCP_93_T                      	hdcp_93;                      //0x7f4
	M14A0_HDCP_94_T                      	hdcp_94;                      //0x7f8
	M14A0_HDCP_95_T                      	hdcp_95;                      //0x7fc
}HDMI_LINK_REG_M14A0_T;
//#endif
