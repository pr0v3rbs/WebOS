 ...
 * @{
 */
#ifndef  HDMI_HW_M14B0_INC
#define  HDMI_HW_M14B0_INC
...
int HDMI_M14B0_PowerConsumption(UINT32 power);
int HDMI_M14B0_SetUDn3DControl(LX_HDMI_UD_3D_MODE_T *udn3d);


void HDMI_M14B0_SetPixelRepetition(void);
void HDMI_M14B0_SetAutoSyncPolarity(void);
