...
const PE_REG_PARAM_T shp_l_pc_default_m14c0[] =
{
	...
	{0x4434, 0x18202020},    // PE1_SP_CTRL_01
	...
	{0x4448, 0x00001001},    // PE1_SP_CTRL_06
	...
	{0x4470, 0x00000001},    // PE1_MP_CTRL_00
	                         // [    0]=0x1(1) : edge_enhance_enable
	                         // [13:12]=0x0(0) : Edge_operator_selection
	{0x4474, 0x18203030},    // PE1_MP_CTRL_01
	...
	{0x44A0, 0x0000FFFF},    // PE1_MP_CTRL_0C
	                         // [ 7: 0]=0xff(255) : lum2_y1
	                         // [15: 8]=0xff(255) : lum2_y2
	{0x44B0, 0x06400820},    // PE1_CORING_CTRL_00
	                         // [ 5: 0]=0x20 : ga_max
	                         // [15: 8]=0x8 : ga_th0
	                         // [23:16]=0x40 : ga_th1
	                         // [25:24]=0x2 : amap1_sel
	                         ...
	                         // [   28]=0x0 : edge_a_sel
	                         // [   29]=0x0 : debug_a_sel
	{0x44B4, 0x78380A01},    // PE1_CORING_CTRL_01
	                         // [ 2: 0]=0x1(1) : max_sel
	                         // [ 5: 4]=0x0(0) : avg_sel
	                         // [13: 8]=0xa(10) : a2tw_min
	                         // [23:16]=0x38(56) : a2tw_th0
	                         // [31:24]=0x78(120) : a2tw_th1
	{0x44B8, 0x08040C01},    // PE1_CORING_CTRL_02
	                         // [    0]=0x1(1) : nrv_en
	                         // [13: 8]=0xc(12) : nrv_th1
	                         // [21:16]=0x4(4) : nrv_th2
	...
	{0x44BC, 0x00040C01},    // PE1_CORING_CTRL_03
	                         ...
	                         // [13: 8]=0xc(12) : nrh_th1
	                         // [21:16]=0x4(4) : nrh_th2
	{0x44C0, 0x00220803},    // PE1_CORING_CTRL_04
	                         // [ 1: 0]=0x3(3) : dflt_sel
	                         // [15: 8]=0x8(8) : var_v_th
	...
	{0x44C4, 0x0118040D},    // PE1_CORING_CTRL_05
	                         // [ 5: 0]=0xd(13) : gt_max
	                         // [15: 8]=0x4(4) : gt_th0
	                         // [23:16]=0x18(24) : gt_th1
	                         // [   24]=0x1(1) : a2tw_en
	{0x44C8, 0x04011008},    // PE1_CORING_CTRL_06
	                         // [ 7: 0]=0x8(8) : gt_th0a
	                         // [15: 8]=0x10(16) : gt_th0b
	                         // [21:16]=0x1(1) : gt_gain0a
	                         // [29:24]=0x4(4) : gt_gain0b
	{0x44CC, 0x48403B28},    // PE1_CORING_CTRL_07
	                         // [ 7: 0]=0x28(40) : g_th0
	                         // [15: 8]=0x3b(59) : g_th1
	                         // [22:16]=0x40(64) : amap_gain
	                         // [30:24]=0x48(72) : tmap_gain
	...
	{0x44D4, 0x40200820},    // PE1_CORING_CTRL_09
