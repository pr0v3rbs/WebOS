...
const PE_REG_PARAM_T shp_l_sd_480_default_m14b0[] =
{
	...
	{0x43C4, 0x1E100001},    // PE1_DERH_CTRL_05
	...
	{0x43C8, 0xC50C0C00},    // PE1_DERH_CTRL_06
	                         // [13: 8]=0xc(12) : edge_filter_white_gain
	...
	{0x43CC, 0xE0000201},    // PE1_DERH_CTRL_07
	...
	{0x43DC, 0x18084428},    // PE1_DERH_CTRL_0B
	...
	{0x4434, 0x20284040},    // PE1_SP_CTRL_01
	                         // [ 6: 0]=0x40(64) : white_gain
	                         // [14: 8]=0x40(64) : black_gain
	...
	{0x4448, 0x00001000},    // PE1_SP_CTRL_06
	...
	{0x4470, 0x00000001},    // PE1_MP_CTRL_00
	                         // [    0]=0x1(1) : edge_enhance_enable
	                         // [13:12]=0x0(0) : Edge_operator_selection
	{0x4474, 0x18202828},    // PE1_MP_CTRL_01
	...
	{0x44C4, 0x01200418},    // PE1_CORING_CTRL_05
	                         // [ 5: 0]=0x18(24) : gt_max
	                         // [15: 8]=0x4(4) : gt_th0
	                         // [23:16]=0x20(32) : gt_th1
	                         // [   24]=0x1(1) : a2tw_en
	...
	{0x44D4, 0x28309820},    // PE1_CORING_CTRL_09
	...
	{0x4530, 0x00002071},    // PE1_CTI_CTRL_00
	                         // [    0]=0x0(0) : cti_en
