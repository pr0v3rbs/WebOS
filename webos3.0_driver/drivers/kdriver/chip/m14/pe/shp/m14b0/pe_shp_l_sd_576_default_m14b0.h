...
const PE_REG_PARAM_T shp_l_sd_576_default_m14b0[] =
{
	{0x43B0, 0x09030109},    // PE1_DERH_CTRL_00
	                         // [ 1: 0]=0x1(1) : vsum_mode
	                         // [ 3: 2]=0x2(2) : hsum_mode
	                         // [    4]=0x0(0) : vsum121_en
	...
	{0x43C8, 0xC5101000},    // PE1_DERH_CTRL_06
	                         // [13: 8]=0x10 : edge_filter_white_gain
	                         // [21:16]=0x10 : edge_filter_black_gain
	...
	{0x4414, 0x40302030},    // PE1_DP_CTRL_01
	                         // [ 6: 0]=0x30 : edge_gain_b
	                         // [14: 8]=0x20 : edge_gain_w
	                         // [22:16]=0x30 : texture_gain_b
	                         // [30:24]=0x40 : texture_gain_w
	...
	{0x4434, 0x02202820},    // PE1_SP_CTRL_01
	                         // [ 6: 0]=0x28 : white_gain
	                         // [14: 8]=0x28 : black_gain
	                         // [23:16]=0x20 : Horizontal_gain
	                         // [31:24]=0x18 : Vertical_gain
	...
	{0x4470, 0x00000001},    // PE1_MP_CTRL_00
	                         // [    0]=0x1(1) : edge_enhance_enable
	                         // [13:12]=0x0(0) : Edge_operator_selection
	{0x4474, 0x02202820},    // PE1_MP_CTRL_01
	                         // [ 6: 0]=0x28 : white_gain
	                         // [14: 8]=0x28 : black_gain
	                         // [23:16]=0x20 : horizontal_gain
	                         // [31:24]=0x18 : vertical_gain
	...
	{0x4488, 0x00001022},    // PE1_MP_CTRL_06
	...
	{0x44A0, 0x0000FFFF},    // PE1_MP_CTRL_0C
	                         // [ 7: 0]=0xff(255) : lum2_y1
	                         // [15: 8]=0xff(255) : lum2_y2
	{0x44B0, 0x05400828},    // PE1_CORING_CTRL_00
	                         // [ 5: 0]=0x28 : ga_max
	                         // [15: 8]=0x8 : ga_th0
	                         // [23:16]=0x40 : ga_th1
	                         // [25:24]=0x1 : amap1_sel
	...
	{0x44B4, 0x50100502},    // PE1_CORING_CTRL_01
	                         ...
	                         // [23:16]=0x10 : a2tw_th0
	                         // [31:24]=0x50 : a2tw_th1
	{0x44B8, 0x06040C01},    // PE1_CORING_CTRL_02
	                         // [    0]=0x1(1) : nrv_en
	                         // [13: 8]=0xc(12) : nrv_th1
	                         // [21:16]=0x4(4) : nrv_th2
	                         // [31:24]=0x6(6) : var_h_th
	{0x44BC, 0x00040C01},    // PE1_CORING_CTRL_03
	                         // [    0]=0x1(1) : nrh_en
	                         // [13: 8]=0xc(12) : nrh_th1
	                         // [21:16]=0x4(4) : nrh_th2
	{0x44C0, 0x00210603},    // PE1_CORING_CTRL_04
	                         // [ 1: 0]=0x3(3) : dflt_sel
	                         // [15: 8]=0x6(6) : var_v_th
	...
	{0x44C4, 0x01200414},    // PE1_CORING_CTRL_05
	                         // [ 5: 0]=0x14 : gt_max
	                         // [15: 8]=0x4(4) : gt_th0
	                         // [23:16]=0x20 : gt_th1
	                         // [   24]=0x1(1) : a2tw_en
	{0x44C8, 0x1008140C},    // PE1_CORING_CTRL_06
	                         // [ 7: 0]=0xC(12) : gt_th0a
	                         // [15: 8]=0x14(20) : gt_th0b
	                         // [21:16]=0x8(8) : gt_gain0a
	                         // [29:24]=0x10(16) : gt_gain0b
	{0x44CC, 0x40503B28},    // PE1_CORING_CTRL_07
	                         // [ 7: 0]=0x28(40) : g_th0
	                         // [15: 8]=0x3b(59) : g_th1
	...
	{0x44D4, 0x40301420},    // PE1_CORING_CTRL_09
	                         // [ 6: 0]=0x20 : edge_gain_b
	                         // [14: 8]=0x14 : edge_gain_w
	                         // [22:16]=0x30 : texture_gain_b
	                         // [30:24]=0x40 : texture_gain_w
