...
const PE_REG_PARAM_T shp_l_atv_default_m14b0[] =
{
	...
	{0x43C4, 0x1E100201},    // PE1_DERH_CTRL_05
	...
	{0x43C8, 0xC5202000},    // PE1_DERH_CTRL_06
                        	// [13: 8]=0x18(24) : edge_filter_white_gain
                        	// [21:16]=0x18(24) : edge_filter_black_gain
	...
	{0x43F0, 0x85202009},    // PE1_DERV_CTRL_0
                        	// [    0]=0x1(1) : der_v_en
                        	// [ 2: 1]=0x0(0) : der_gain_mapping
                        	// [    3]=0x1(1) : bif_en
                        	// [ 7: 4]=0x0(0) : output_mux
                        	// [15: 8]=0x8(8) : bif_manual_th
                        	// [21:16]=0x14(20) : th_gain
                        	// [   24]=0x1(1) : th_mode
	{0x43F4, 0x00000008},    // PE1_DERV_CTRL_1
                        	// [ 5: 0]=0x18(24) : csft_gain
                        	// [    8]=0x0(0) : csft_mode
	{0x43F8, 0x44280000},    // PE1_DERV_CTRL_2
                        	// [ 2: 0]=0x1(1) : mmd_sel
                        	// [ 6: 4]=0x0(0) : max_sel
                        	// [ 9: 8]=0x1(1) : avg_sel
	...
	{0x4414, 0x22193A3A},    // PE1_DP_CTRL_01
                        	// [ 6: 0]=0x3a(58) : edge_gain_b
                        	// [14: 8]=0x3a(58) : edge_gain_w
                        	// [22:16]=0x19(25) : texture_gain_b
                        	// [30:24]=0x22(34) : texture_gain_w
	...
	{0x4434, 0x0C203030},    // PE1_SP_CTRL_01
                        	// [ 6: 0]=0x20(32) : white_gain
                        	// [14: 8]=0x20(32) : black_gain
                        	// [23:16]=0x16(22) : Horizontal_gain
                        	// [31:24]=0x14(20) : Vertical_gain
	...
	{0x4470, 0x00000001},    // PE1_MP_CTRL_00
                        	// [    0]=0x1(1) : edge_enhance_enable
                        	// [13:12]=0x0(0) : Edge_operator_selection
	{0x4474, 0x0C203030},    // PE1_MP_CTRL_01
                        	// [ 6: 0]=0x24(36) : white_gain
                        	// [14: 8]=0x24(36) : black_gain
                        	// [23:16]=0x16(22) : horizontal_gain
                        	// [31:24]=0x14(20) : vertical_gain
	...
	{0x4488, 0x00001012},    // PE1_MP_CTRL_06
	...
	{0x44A0, 0x0000FFFF},    // PE1_MP_CTRL_0C
                        	// [ 7: 0]=0xff(255) : lum2_y1
                        	// [15: 8]=0xff(255) : lum2_y2
	{0x44B0, 0x05300830},    // PE1_CORING_CTRL_00
                        	// [ 5: 0]=0x30(48) : ga_max
                        	// [15: 8]=0x8(8) : ga_th0
                        	// [23:16]=0x30(48) : ga_th1
                        	// [25:24]=0x1(1) : amap1_sel
                        	// [27:26]=0x1(1) : amap2_sel
                        	// [   28]=0x0(0) : edge_a_sel
                        	// [   29]=0x0(0) : debug_a_sel
	{0x44B4, 0x50100300},    // PE1_CORING_CTRL_01
                        	// [ 2: 0]=0x0(0) : max_sel
                        	// [ 5: 4]=0x0(0) : avg_sel
                        	// [13: 8]=0x3(3) : a2tw_min
                        	// [23:16]=0x10(16) : a2tw_th0
                        	// [31:24]=0x50(80) : a2tw_th1
	{0x44B8, 0x03040C01},    // PE1_CORING_CTRL_02
                        	// [    0]=0x1(1) : nrv_en
                        	// [13: 8]=0xc(12) : nrv_th1
                        	// [21:16]=0x4(4) : nrv_th2
                        	// [31:24]=0x3(3) : var_h_th
	{0x44BC, 0x00040C01},    // PE1_CORING_CTRL_03
                        	// [    0]=0x1(1) : nrh_en
                        	// [13: 8]=0xc(12) : nrh_th1
                        	// [21:16]=0x4(4) : nrh_th2
	{0x44C0, 0x00210303},    // PE1_CORING_CTRL_04
                        	// [ 1: 0]=0x3(3) : dflt_sel
                        	// [15: 8]=0x3(3) : var_v_th
	...
	{0x44C4, 0x01300418},    // PE1_CORING_CTRL_05
                        	// [ 5: 0]=0x18(24) : gt_max
                        	// [15: 8]=0x4(4) : gt_th0
                        	// [23:16]=0x30(48) : gt_th1
                        	// [   24]=0x1(1) : a2tw_en
	{0x44C8, 0x0C012010},    // PE1_CORING_CTRL_06
                        	// [ 7: 0]=0x10(16) : gt_th0a
                        	// [15: 8]=0x20(32) : gt_th0b
                        	// [21:16]=0x1(1) : gt_gain0a
                        	// [29:24]=0xc(12) : gt_gain0b
	{0x44CC, 0x60403B28},    // PE1_CORING_CTRL_07
                        	// [ 7: 0]=0x28(40) : g_th0
                        	// [15: 8]=0x3b(59) : g_th1
	...
	{0x44D4, 0x22193A3A},    // PE1_CORING_CTRL_09
                        	// [ 6: 0]=0x3a(58) : edge_gain_b
                        	// [14: 8]=0x3a(58) : edge_gain_w
                        	// [22:16]=0x19(25) : texture_gain_b
                        	// [30:24]=0x22(34) : texture_gain_w
	...
	{0x4520, 0xB0500165},    // PE1_DJ_CTRL_00
                        	// [    0]=0x1(1) : edf_en
	...
	{0x4530, 0x00005050},    // PE1_CTI_CTRL_00
                        	// [    0]=0x0(0) : cti_en
                        	// [ 6: 4]=0x5(5) : filter_tap_size
                        	// [15: 8]=0x50(80) : cti_gain
	{0x4534, 0x00011005},    // PE1_CTI_CTRL_01
                        	// [ 7: 0]=0x5(5) : coring_th0
                        	// [15: 8]=0x10(16) : coring_th1
