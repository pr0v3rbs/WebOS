...
const PE_REG_PARAM_T shp_l_av_576_default_m14b0[] =
{
	...
	{0x4448, 0x00001011},    // PE1_SP_CTRL_06
	                         ...
	                         //[    4]=0x1(1) : lap_v_mode
	{0x444C, 0x00100C01},    // PE1_SP_CTRL_07
	                         //[    0]=0x1(1) : gb_en
	                         //[    4]=0x0(0) : gb_mode
	                         //[15: 8]=0xc(12) : gb_x1
	                         //[23:16]=0xc(12) : gb_y1
	...
	{0x448C, 0x00100C01},    // PE1_MP_CTRL_07
	                         //[    0]=0x1(1) : gb_en
	                         //[    4]=0x0(0) : gb_mode
	                         //[15: 8]=0xc(12) : gb_x1
	                         //[23:16]=0xc(12) : gb_y1
	{0x4490, 0x00D02018},    // PE1_MP_CTRL_08
	                         //[ 7: 0]=0x19(25) : gb_x2
	                         //[15: 8]=0x19(25) : gb_y2
	...
	{0x44B4, 0x50100502},    // PE1_CORING_CTRL_01
	                         //[ 2: 0]=0x0(0) : max_sel
	                         //[ 5: 4]=0x0(0) : avg_sel
	                         //[13: 8]=0x5(5) : a2tw_min
