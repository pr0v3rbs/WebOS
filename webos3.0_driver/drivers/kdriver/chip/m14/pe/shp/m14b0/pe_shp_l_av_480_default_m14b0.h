...
const PE_REG_PARAM_T shp_l_av_480_default_m14b0[] =
{
	{0x43B0, 0x08030109},    // PE1_DERH_CTRL_00
	                         //[ 1: 0]=0x1(1) : vsum_mode
	                         //[ 3: 2]=0x2(2) : hsum_mode
	                         //[    4]=0x0(0) : vsum121_en
	...
	{0x43CC, 0x10000000},    // PE1_DERH_CTRL_07
	...
	{0x43DC, 0x05034428},    // PE1_DERH_CTRL_0B
	...
	{0x43F0, 0x850C0801},    // PE1_DERV_CTRL_0
	                         //[    0]=0x1(1) : der_v_en
	                         ...
	                         //[   24]=0x1(1) : th_mode
	{0x43F4, 0x00000018},    // PE1_DERV_CTRL_1
	                         //[ 5: 0]=0x18(24) : csft_gain
	                         //[    8]=0x0(0) : csft_mode
	{0x43F8, 0x44280001},    // PE1_DERV_CTRL_2
	                         //[ 2: 0]=0x1(1) : mmd_sel
	                         //[ 6: 4]=0x0(0) : max_sel
	                         //[ 9: 8]=0x0(0) : avg_sel
	                         //[23:16]=0x28(40) : gain_th1
	                         //[31:24]=0x44(68) : gain_th2
	{0x43FC, 0x00002828},    // PE1_DERV_CTRL_3
	                         //[ 6: 0]=0x28(40) : gain_b
	                         //[14: 8]=0x28(40) : gain_w
	{0x4410, 0x00000000},    // PE1_DP_CTRL_00
	                         //[ 2: 0]=0x0(0) : debug_display
	{0x4414, 0x40302030},    // PE1_DP_CTRL_01
	                         //[ 6: 0]=0x28(40) : edge_gain_b
	                         //[14: 8]=0x20(32) : edge_gain_w
	                         //[22:16]=0x20(32) : texture_gain_b
	                         //[30:24]=0x30(48) : texture_gain_w
	...
	{0x4434, 0x10202020},    // PE1_SP_CTRL_01
	                         //[ 6: 0]=0x28(40) : white_gain
	                         //[14: 8]=0x28(40) : black_gain
	                         //[23:16]=0x20(32) : Horizontal_gain
	                         //[31:24]=0x18(24) : Vertical_gain
	...
	{0x4448, 0x00001011},    // PE1_SP_CTRL_06
	                         ...
	                         //[    4]=0x1(1) : lap_v_mode
	{0x444C, 0x000C0C01},    // PE1_SP_CTRL_07
	                         //[    0]=0x1(1) : gb_en
	                         //[    4]=0x0(0) : gb_mode
	                         //[15: 8]=0xc(12) : gb_x1
	                         //[23:16]=0xc(12) : gb_y1
	{0x4450, 0x00C81919},    // PE1_SP_CTRL_08
	                         //[ 7: 0]=0x19(25) : gb_x2
	                         //[15: 8]=0x19(25) : gb_y2
	...
	{0x4470, 0x00000001},    // PE1_MP_CTRL_00
	                         //[    0]=0x1(1) : edge_enhance_enable
	                         //[13:12]=0x0(0) : Edge_operator_selection
	{0x4474, 0x10203030},    // PE1_MP_CTRL_01
	                         //[ 6: 0]=0x28(40) : white_gain
	                         //[14: 8]=0x28(40) : black_gain
	                         //[23:16]=0x20(32) : horizontal_gain
	                         //[31:24]=0x18(24) : vertical_gain
	...
	{0x4488, 0x00001011},    // PE1_MP_CTRL_06
	                         //[ 2: 0]=0x1(1) : lap_h_mode
	                         //[ 6: 4]=0x1(1) : lap_v_mode
	{0x448C, 0x000C0C01},    // PE1_MP_CTRL_07
	                         //[    0]=0x1(1) : gb_en
	                         //[    4]=0x0(0) : gb_mode
	                         //[15: 8]=0xc(12) : gb_x1
	                         //[23:16]=0xc(12) : gb_y1
	{0x4490, 0x00B01919},    // PE1_MP_CTRL_08
	                         //[ 7: 0]=0x19(25) : gb_x2
	                         //[15: 8]=0x19(25) : gb_y2
	...
	{0x44A0, 0x0000FFFF},    // PE1_MP_CTRL_0C
	                         //[ 7: 0]=0xff(255) : lum2_y1
	                         //[15: 8]=0xff(255) : lum2_y2
	{0x44B0, 0x09400828},    // PE1_CORING_CTRL_00
	                         //[ 5: 0]=0x28(40) : ga_max
	                         //[15: 8]=0x8(8) : ga_th0
	                         //[23:16]=0x40(64) : ga_th1
	                         //[25:24]=0x1(1) : amap1_sel
	                         //[27:26]=0x2(2) : amap2_sel
	                         //[   28]=0x0(0) : edge_a_sel
	                         //[   29]=0x0(0) : debug_a_sel
	{0x44B4, 0x60200602},    // PE1_CORING_CTRL_01
	                         //[ 2: 0]=0x0(0) : max_sel
	                         //[ 5: 4]=0x0(0) : avg_sel
	                         //[13: 8]=0x5(5) : a2tw_min
	                         //[23:16]=0x10(16) : a2tw_th0
	                         //[31:24]=0x50(80) : a2tw_th1
	{0x44B8, 0x0C040C01},    // PE1_CORING_CTRL_02
	                         //[    0]=0x1(1) : nrv_en
	                         //[13: 8]=0xc(12) : nrv_th1
	                         //[21:16]=0x4(4) : nrv_th2
	                         //[31:24]=0xc(12) : var_h_th
	{0x44BC, 0x00040C01},    // PE1_CORING_CTRL_03
	                         //[    0]=0x1(1) : nrh_en
	                         //[13: 8]=0xc(12) : nrh_th1
	                         //[21:16]=0x4(4) : nrh_th2
	{0x44C0, 0x00220C03},    // PE1_CORING_CTRL_04
	                         //[ 1: 0]=0x3(3) : dflt_sel
	                         //[15: 8]=0xc(12) : var_v_th
	...
	{0x44C4, 0x01280816},    // PE1_CORING_CTRL_05
	                         //[ 5: 0]=0x16(22) : gt_max
	                         //[15: 8]=0x8(8) : gt_th0
	                         //[23:16]=0x28(40) : gt_th1
	                         //[   24]=0x1(1) : a2tw_en
	{0x44C8, 0x0A021810},    // PE1_CORING_CTRL_06
	                         //[ 7: 0]=0x10(16) : gt_th0a
	                         //[15: 8]=0x18(24) : gt_th0b
	                         //[21:16]=0x2(2) : gt_gain0a
	                         //[29:24]=0xa(10) : gt_gain0b
	{0x44CC, 0x50403B28},    // PE1_CORING_CTRL_07
	                         //[ 7: 0]=0x28(40) : g_th0
	                         //[15: 8]=0x3b(59) : g_th1
	...
	{0x44D4, 0x30301820},    // PE1_CORING_CTRL_09
	                         //[ 6: 0]=0x20(32) : edge_gain_b
	                         //[14: 8]=0x14(20) : edge_gain_w
	...
	{0x4520, 0xB0400165},    // PE1_DJ_CTRL_00
	                         //[    0]=0x1(1) : edf_en
