...
#ifndef	_PE_WIN_HW_M14_H_
#define	_PE_WIN_HW_M14_H_
...
typedef struct
{
	PE_WIN_HW_M14_CTRL_T win_inf;			///< window info
	PE_WIN_HW_M14_LRCR_CTRL_T lrcr_inf;		///< lrcr win info
	PE_WIN_HW_M14_TNR_CTRL_T tnr_inf;		///< tnr measure win info
}
PE_WIN_HW_M14_SETTINGS_T;
