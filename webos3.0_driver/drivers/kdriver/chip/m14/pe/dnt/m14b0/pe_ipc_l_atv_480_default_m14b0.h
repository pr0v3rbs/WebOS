...
// RomFile for PE0_M
//         Extracted from RegFile:D:\SoC_Tools\Chip\M14B0\RegFile\DE\M14B0_RegFile_DE_PE0.xls
//         Date : 2013-12-05[¿ÀÈÄ 7:23:16]
const PE_REG_PARAM_T ipc_l_atv_480_default_m14b0[] =
{
	{0x2200, 0xF250ACAA},     // IPC_CTRL_00
	...
	{0x2210, 0x500000f8},     // IPC_CTRL_04
                             // [ 7: 0]=0xfc(252) : ET_Offset__s7
                             // [15: 8]=0x0(0) : Motion_x_Tearing_Gain
                             // [23:16]=0x0(0) : Tearing_Gain
                             // [31:24]=0x40(64) : Motion_Gain
	{0x2214, 0x20E02040},     // IPC_CTRL_05
                             // [ 7: 0]=0x40(64) : cr_ipc_c_motion_alpha
                             // [15: 8]=0x80(128) : cr_t_grad_weight
                             // [23:16]=0xe0(224) : cr_v_grad_weight
                             // [31:24]=0x10(16) : cr_h_grad_weight
	{0x2218, 0x00A00877},     // IPC_CTRL_06
                             ...
                             // [23:16]=0xa0(160) : cr_normalize_center
                             // [31:24]=0x0(0) : cr_motion_coring
	{0x221C, 0x00E002DF},     // IPC_CTRL_07
                             // [    1]=0x1(1) : cr_v_en
                             // [    2]=0x1(1) : cr_45_en
                             // [    3]=0x1(1) : cr_15_en
                             // [31:24]=0x0(0) : TNR_motion_gain
	...
	{0x22A0, 0x000DF0FF}      // IPC_CTRL_42
                             // [ 3: 0]=0xf(15) : reg_yy_diff_gain
                             // [ 7: 4]=0xf(15) : reg_hv_add_gain
                             // [11: 8]=0x0(0) : reg_v_motion_gain
                             // [15:12]=0xf(15) : reg_h_motion_gain
                             // [19:16]=0xd(13) : reg_cc_diff_gain
};