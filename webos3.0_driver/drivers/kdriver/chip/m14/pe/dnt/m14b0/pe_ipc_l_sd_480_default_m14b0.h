...
const PE_REG_PARAM_T ipc_l_sd_480_default_m14b0[] =
{
	{0x2200, 0xF2D055AA},    // IPC_CTRL_00
	                         // [ 1: 0]=0x2(2) : cr_luma_mode
	                         // [ 5: 4]=0x2(2) : cr_chroma_mode
	                         // [    6]=0x0(0) : cr_integer_edi  
	                         // [    7]=0x1(1) : cr_chroma_edi
	                         // [11: 8]=0xc(12) : cr_st_2d_v_flt_range2
	                         // [15:12]=0xa(10) : cr_st_2d_v_flt_range
	                         // [17:16]=0x0(0) : cr_ori_3d_blur_y
	                         // [19:18]=0x0(0) : cr_ori_3d_blur_c
	                         // [   20]=0x1(1) : cr_tava_v_edge_adap
	                         // [   21]=0x0(0) : cr_tava_debug_mode
	                         // [   22]=0x1(1) : cr_tava_st_adap
	                         // [   23]=0x0(0) : cr_tava_en
	                         // [   24]=0x0(0) : cr_hmc_force_fmd        
	                         // [   25]=0x1(1) : cr_st_2d_v_flt_en
	                         // [   26]=0x0(0) : cr_clc_fmd_off
	                         // [   27]=0x1(1) : cr_chroma_tava_only
	...
	{0x2210, 0x500000F8},    // IPC_CTRL_04
	                         // [ 7: 0]=0x0(0) : ET_Offset__s7
	                         // [15: 8]=0x0(0) : Motion_x_Tearing_Gain
	                         // [23:16]=0x0(0) : Tearing_Gain
	                         // [31:24]=0x60(96) : Motion_Gain
	...
	{0x2218, 0x00700877},    // IPC_CTRL_06
	                         // [    0]=0x1(1) : cr_normalize_en
	                         // [    1]=0x1(1) : cr_flat_only
	                         // [    2]=0x1(1) : use_TNR_motion
	                         // [    4]=0x1(1) : cr_tearing_normalize_en
	                         // [15: 8]=0x8(8) : cr_normalize_base
	                         // [23:16]=0x70(112) : cr_normalize_center
	                         // [31:24]=0x0(0) : cr_motion_coring
	{0x221C, 0x0FE002DF},    // IPC_CTRL_07
	                         // [    1]=0x1(1) : cr_v_en
	                         // [    2]=0x1(1) : cr_45_en
	                         // [    3]=0x1(1) : cr_15_en
	                         // [31:24]=0xf(15) : TNR_motion_gain
	...
	{0x230C, 0xD020D020},    // IPC_CTRL_27
	                         // [ 7: 0]=0x20(32) : CHROMA_st_flt_ctrl_x0
	                         // [15: 8]=0xd0(208) : CHROMA_st_flt_ctrl_x1
	                         // [23:16]=0x20(32) : LUMA_st_flt_ctrl_x0
	                         // [31:24]=0xd0(208) : LUMA_st_flt_ctrl_x1
	...
	{0x2314, 0xF0704018},    // IPC_CTRL_29
	                         // [23:16]=0x70(112) : HMC_flt_ctrl_x0
	                         // [31:24]=0xf0(240) : HMC_st_flt_ctrl_x1
	{0x2318, 0x61808310},    // IPC_CTRL_30
	                         // [ 7: 0]=0x18(24) : reg_vmc_motion_th
	                         // [    8]=0x1(1) : reg_vmc_debug
	                         // [    9]=0x1(1) : reg_vmc_en
	                         // [   10]=0x0(0) : reg_vmc_still_check 
	                         // [13:11]=0x0(0) : reg_vmc_mul         
	                         // [15:14]=0x3(3) : reg_vmc_out_mul
	                         // [23:16]=0x80(128) : reg_vmc_protect_th
	...
	{0x2320, 0x20001890},    // IPC_CTRL_32
	                         // [31:24]=0x20(32) : tava_ErrT_x3
	                         // [23:16]=0x0(0) : tava_ErrT_y3
	                         // [15: 8]=0x18(24) : tava_ErrT_x2
	                         // [ 7: 0]=0x90(144) : tava_ErrT_y2
	{0x2324, 0x10B008FF},    // IPC_CTRL_33
	                         // [31:24]=0x10(16) : tava_ErrT_x1
	                         // [23:16]=0xb0(176) : tava_ErrT_y1
	                         // [15: 8]=0x8(8) : tava_ErrT_x0
	                         // [ 7: 0]=0xff(255) : tava_ErrT_y0
	{0x2280, 0x180010FF},    // IPC_CTRL_34
	                         // [31:24]=0x3e(62) : tava_v_diff_x1
	                         // [23:16]=0xff(255) : tava_v_diff_y1
	                         // [15: 8]=0x30(48) : tava_v_diff_x0
	                         // [ 7: 0]=0x0(0) : tava_v_diff_y0
	{0x2284, 0x00C10002},    // IPC_CTRL_35
