...
const PE_REG_PARAM_T ipc_l_dtv_hd_tp_default_m14b0[] =
{
	/* pe0m ipc, 0x2200~0x224C, 0x2280~0x22A0, 0x22F0~0x2324 */
	{0x2200, 0xF2D0AC88},    // IPC_CTRL_00
 	                         // [ 1: 0]=0x0(0) : cr_luma_mode
	                         // [ 5: 4]=0x0(0) : cr_chroma_mode
	                         // [    7]=0x1(1) : cr_chroma_edi
	                         // [    8]=0x0(0) : cr_integer_edi
	                         // [   23]=0x1(1) : cr_tava_en
	                         // [   24]=0x0(0) : cr_hmc_force_fmd
	                         // [   26]=0x0(0) : cr_clc_fmd_off
	                         // [   27]=0x0(0) : cr_chroma_tava_only
	...
	{0x2210, 0x500000F8},    // IPC_CTRL_04
	                         // [ 7: 0]=0xF8 : ET_Offset__s7
	                         // [15: 8]=0x0 : Motion_x_Tearing_Gain
	                         // [23:16]=0x0 : Tearing_Gain
	                         // [31:24]=0x40 : Motion_Gain
	...
	{0x2218, 0x00680A77},    // IPC_CTRL_06
	                         ...
	                         // [23:16]=0x68(104) : cr_normalize_center
	                         // [31:24]=0x0(0) : cr_motion_coring
	{0x221C, 0x0EE002DF},    // IPC_CTRL_07
	                         // [    1]=0x1(1) : cr_v_en
	                         // [    2]=0x1(1) : cr_45_en
	                         // [    3]=0x1(1) : cr_15_en
	...
	{0x2228, 0x25100404},    // IPC_CTRL_10
	                         // [ 7: 0]=0x4(4) : PCNC_fmd_a_th
	...
	{0x2230, 0xFF041003},    // IPC_CTRL_12
	                         // [ 7: 0]=0x3(3) : reg_still_pn_th
	                         // [15: 8]=0x10(16) : reg_fmd_ratio_th
	                         // [23:16]=0x4(4) : reg_fmd_max_th
	...
	{0x22FC, 0x80798029},    // IPC_CTRL_23
	                         // [    0]=0x1 : cr_hmc_enable
	                         // [ 7: 1]=0xd : cr_lock_th
	                         // [15: 8]=0x80 : cr_g_motion_th
	                         // [17:16]=0x1 : cr_hmc_expend
	                         // [   18]=0x0 : cr_hmc_half_en
	                         // [23:20]=0x7 : cr_robustness
	                         // [31:24]=0x80 : cr_center_weight
	{0x2300, 0x507A0130},    // IPC_CTRL_24
	                         // [    0]=0x0 : cr_noise_en
	                         // [15: 8]=0x1 : cr_noise_th
	                         // [18:16]=0x2 : cr_gds_resolution
	{0x2304, 0x14201010},    // IPC_CTRL_25
	...
	{0x230C, 0xD820D820},    // IPC_CTRL_27
	                         // [ 7: 0]=0x20() : CHROMA_st_flt_ctrl_x0
	                         // [15: 8]=0xD8(216) : CHROMA_st_flt_ctrl_x1
	                         // [23:16]=0x20() : LUMA_st_flt_ctrl_x0
	                         // [31:24]=0xD8(216) : LUMA_st_flt_ctrl_x1
	...
	{0x2314, 0xB0604018},    // IPC_CTRL_29
	                         // [    0]=0x0 : HMC_flt_ctrl_x0
	                         // [31:24]=0xB0 : HMC_st_flt_ctrl_x1
	{0x2318, 0xA118CE18},    // IPC_CTRL_30
	...
	{0x2320, 0x40003040},    // IPC_CTRL_32
	                         // [31:24]=0x40 : tava_ErrT_x3
	                         // [23:16]=0x0 : tava_ErrT_y3
	                         // [15: 8]=0x30 : tava_ErrT_x2
	                         // [ 7: 0]=0x40 : tava_ErrT_y2
	{0x2324, 0x208014C0},    // IPC_CTRL_33
	                         // [31:24]=0x20 : tava_ErrT_x1
	                         // [23:16]=0x80 : tava_ErrT_y1
	                         // [15: 8]=0x14 : tava_ErrT_x0
	                         // [ 7: 0]=0xC0 : tava_ErrT_y0
	{0x2280, 0x300020FF},    // IPC_CTRL_34
	                         // [31:24]=0x30(48) : tava_v_diff_x1
	                         // [23:16]=0x0(0) : tava_v_diff_y1
	                         // [15: 8]=0x20(32) : tava_v_diff_x0
	                         // [ 7: 0]=0xff(255) : tava_v_diff_y0
	{0x2284, 0x70810003},    // IPC_CTRL_35
	                         // [31:24]=0x70(112) : reg_div_position
	...
	{0x22A0, 0x000DF0FF}     // IPC_CTRL_42
	                         // [ 3: 0]=0xf : reg_yy_diff_gain
	                         // [ 7: 4]=0xf : reg_hv_add_gain
	                         // [11: 8]=0x0 : reg_v_motion_gain
	                         // [15:12]=0xf : reg_h_motion_gain
	                         // [19:16]=0xd : reg_cc_diff_gain
};