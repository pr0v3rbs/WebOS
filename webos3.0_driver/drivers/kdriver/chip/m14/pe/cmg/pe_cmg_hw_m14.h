...
#ifndef	_PE_CMG_HW_M14_H_
#define	_PE_CMG_HW_M14_H_
...
PE_CMG_HW_M14_SETTINGS_T;

/*----------------------------------------------------------------------------------------
	Extern Function Prototype Declaration
----------------------------------------------------------------------------------------*/
int PE_CMG_HW_M14_Init(PE_CFG_CTRL_T *pstParams);
