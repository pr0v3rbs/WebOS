...
typedef enum
{
	PE_TSK_M14_RUN_START = 0,	///< run start
	PE_TSK_M14_RUN_STOP_TASK,	///< run stop task
	PE_TSK_M14_RUN_STOP_HDLR,	///< run stop handler
	PE_TSK_M14_RUN_STOP_OVWR,	///< run stop overwrite
	PE_TSK_M14_RUN_STOP_ALGO,	///< run stop algorithm
	PE_TSK_M14_RUN_NUM			///< max num
}
PE_TSK_M14_OPR_RUN_MODE;
...
typedef enum
{
	PE_TSK_M14_DBG_OFF = 0,		///< off
	PE_TSK_M14_DBG_ON,			///< on
	PE_TSK_M14_DBG_TIME,		///< time check
	PE_TSK_M14_DBG_CNT,			///< count check
	PE_TSK_M14_DBG_BRK,			///< break check
	PE_TSK_M14_DBG_MAX			///< max num
}
PE_TSK_M14_OPR_DBG_MODE;
...
typedef enum
{
	PE_TSK_M14_TIME_TASK = 0,	///< task time
	PE_TSK_M14_TIME_HNDL,		///< handler time
	PE_TSK_M14_TIME_MAX			///< max num
}
PE_TSK_M14_TIME;
