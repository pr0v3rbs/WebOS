...
#ifndef _PE_MSC_REG_M14B0_H_
#define _PE_MSC_REG_M14B0_H_
/*-----------------------------------------------------------------------------
...
} PE_M14B0_MSC_Y_FIR_COEF_DATA0_T;
...
} PE_M14B0_MSC_Y_FIR_COEF_DATA1_T;
...
} PE_M14B0_MSC_Y_FIR_COEF_DATA2_T;
...
} PE_M14B0_MSC_Y_FIR_COEF_DATA3_T;
...
} PE_M14B0_MSC_Y_FIR_COEF_DATA4_T;
...
} PE_M14B0_MSC_Y_FIR_COEF_DATA5_T;
...
typedef struct {
	...
	UINT32                                    : 3 ;  // 11: 9     reserved
	UINT32 rnw                                : 1 ;  //    12     
} PE_M14B0_MSC_Y_FIR_COEF_CTRL_T;
...
} PE_M14B0_MSC_C_FIR_COEF_DATA0_T;
...
} PE_M14B0_MSC_C_FIR_COEF_DATA1_T;
...
} PE_M14B0_MSC_C_FIR_COEF_DATA2_T;
...
} PE_M14B0_MSC_C_FIR_COEF_DATA3_T;
...
typedef struct {
	...
	UINT32                                    : 3 ;  // 11: 9     reserved
	UINT32 rnw                                : 1 ;  //    12     
} PE_M14B0_MSC_C_FIR_COEF_CTRL_T;
...
} PE_M14B0_MSC_CHROMA_TEAR_CTRL_T;
...
} PE_M14B0_MANUAL_SAMPLING_Y_H_T;
...
typedef struct {
	...
	UINT32                                    : 4 ;  // 15:12     reserved
	UINT32 denominator                        : 12;  // 27:16     
} PE_M14B0_MANUAL_SAMPLING_Y_V_T;
...
typedef struct {
	...
	UINT32                                    : 4 ;  // 15:12     reserved
	UINT32 denominator                        : 12;  // 27:16     
} PE_M14B0_MANUAL_SAMPLING_C_H_T;
...
typedef struct {
	...
	UINT32                                    : 4 ;  // 15:12     reserved
	UINT32 denominator                        : 12;  // 27:16     
} PE_M14B0_MANUAL_SAMPLING_C_V_T;
...
} PE_M14B0_MSC_PIC_END_CTRL_T;

typedef struct {
	PE_M14B0_MSC_CTRL_T                	msc_ctrl;                     //0xc0023800L
	PE_M14B0_MSC_Y_INIT_POS_H_T        	msc_y_init_pos_h;             //0xc0023804L
	PE_M14B0_MSC_Y_INIT_POS_V_T        	msc_y_init_pos_v;             //0xc0023808L
	PE_M14B0_MSC_C_INIT_POS_H_T        	msc_c_init_pos_h;             //0xc002380cL
	PE_M14B0_MSC_C_INIT_POS_V_T        	msc_c_init_pos_v;             //0xc0023810L
	PE_M14B0_MSC_ADAPTIVE_TH_T         	msc_adaptive_th;              //0xc0023814L
	PE_M14B0_MSC_SCR_SIZE_T            	msc_scr_size;                 //0xc0023818L
	PE_M14B0_MSC_WIN_OUT_SIZE_T        	msc_win_out_size;             //0xc002381cL
	PE_M14B0_MSC_WIN_IN_OFFSET_T       	msc_win_in_offset;            //0xc0023820L
	PE_M14B0_MSC_WIN_IN_SIZE_T         	msc_win_in_size;              //0xc0023824L
	PE_M14B0_MSC_C_FORMAT_T            	msc_c_format;                 //0xc0023828L
	UINT32                             	reserved00;                   //0xc002382cL
	PE_M14B0_MSC_Y_FIR_COEF_DATA0_T    	msc_y_fir_coef_data0;         //0xc0023830L
	PE_M14B0_MSC_Y_FIR_COEF_DATA1_T    	msc_y_fir_coef_data1;         //0xc0023834L
	PE_M14B0_MSC_Y_FIR_COEF_DATA2_T    	msc_y_fir_coef_data2;         //0xc0023838L
	PE_M14B0_MSC_Y_FIR_COEF_DATA3_T    	msc_y_fir_coef_data3;         //0xc002383cL
	PE_M14B0_MSC_Y_FIR_COEF_DATA4_T    	msc_y_fir_coef_data4;         //0xc0023840L
	PE_M14B0_MSC_Y_FIR_COEF_DATA5_T    	msc_y_fir_coef_data5;         //0xc0023844L
	PE_M14B0_MSC_Y_FIR_COEF_CTRL_T     	msc_y_fir_coef_ctrl;          //0xc0023848L
	UINT32                             	reserved01;                   //0xc002384cL
	PE_M14B0_MSC_C_FIR_COEF_DATA0_T    	msc_c_fir_coef_data0;         //0xc0023850L
	PE_M14B0_MSC_C_FIR_COEF_DATA1_T    	msc_c_fir_coef_data1;         //0xc0023854L
	PE_M14B0_MSC_C_FIR_COEF_DATA2_T    	msc_c_fir_coef_data2;         //0xc0023858L
	PE_M14B0_MSC_C_FIR_COEF_DATA3_T    	msc_c_fir_coef_data3;         //0xc002385cL
	PE_M14B0_MSC_C_FIR_COEF_CTRL_T     	msc_c_fir_coef_ctrl;          //0xc0023860L
	UINT32                             	reserved02;                   //0xc0023864L
	PE_M14B0_MSC_STATUS_REV_T          	msc_status_rev;               //0xc0023868L
	PE_M14B0_MSC_MANUALOAD_T           	msc_manuaload;                //0xc002386cL
	UINT32                             	reserved03;                   //0xc0023870L
	PE_M14B0_MSC_CHROMA_TEAR_T         	msc_chroma_tear;              //0xc0023874L
	PE_M14B0_MSC_CHROMA_TEAR_CTRL_T    	msc_chroma_tear_ctrl;         //0xc0023878L
	UINT32                             	reserved04;                   //0xc002387cL
	PE_M14B0_MSC_MIN_MAX_CTRL_Y_T      	msc_min_max_ctrl_y;           //0xc0023880L
	PE_M14B0_MSC_MIN_MAX_CTRL_C_T      	msc_min_max_ctrl_c;           //0xc0023884L
	UINT32                             	reserved05[2];                //0xc0023888L~0xc002388cL
	PE_M14B0_MANUAL_SAMPLING_Y_H_T     	manual_sampling_y_h;          //0xc0023890L
	PE_M14B0_MANUAL_SAMPLING_Y_V_T     	manual_sampling_y_v;          //0xc0023894L
	PE_M14B0_MANUAL_SAMPLING_C_H_T     	manual_sampling_c_h;          //0xc0023898L
	PE_M14B0_MANUAL_SAMPLING_C_V_T     	manual_sampling_c_v;          //0xc002389cL
	PE_M14B0_CHROMA_V_CTI_T            	chroma_v_cti;                 //0xc00238a0L
	PE_M14B0_MSC_FRAME_CNT_T           	msc_frame_cnt;                //0xc00238a4L
	PE_M14B0_MSC_PIC_END_CTRL_T        	msc_pic_end_ctrl;             //0xc00238a8L
}PE_MSC_REG_M14B0_T;
