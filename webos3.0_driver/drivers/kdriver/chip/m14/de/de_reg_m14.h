 ...
 * @{
 */
#ifndef  DE_REG_M14_INC
#define  DE_REG_M14_INC
...
int DE_DMA_M14_WakeUpReg(BOOLEAN turnOn);
...
int DE_REG_M14_VSPMute(BOOLEAN turnOn);
...
int DE_REG_M14_GetIrqNum(UINT32 mcu_id,      \
                         UINT32 *ipc_irq_num,\
                         UINT32 *sync_irq_num);
