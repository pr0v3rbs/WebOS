...
#ifndef _REG_IPC_M14A0_h
#define _REG_IPC_M14A0_h
...
typedef struct {
	UINT32 pattern_addr                : 32;  //  0:31
} M14A0_PATTERN_DATA_T;

typedef struct {
	M14A0_SET_CTRL0_T           set_ctrl0;                   // 0x4e00
	M14A0_SET_CTRL1_T           set_ctrl1;                   // 0x4e04
	M14A0_EXT_INTR_EVENT_T      ext_intr_event;              // 0x4e08
	M14A0_EXT_INTR_ENABLE_T     ext_intr_enable;             // 0x4e0c
	M14A0_EXT_INTR_STATUS_T     ext_intr_status;             // 0x4e10
	M14A0_EXT_INTR_CLEAR_T      ext_intr_clear;              // 0x4e14
	M14A0_INT_INTR_EVENT_T      int_intr_event;              // 0x4e18
	M14A0_INT_INTR_ENABLE_T     int_intr_enable;             // 0x4e1c
	M14A0_INT_INTR_STATUS_T     int_intr_status;             // 0x4e20
	M14A0_INT_INTR_CLEAR_T      int_intr_clear;              // 0x4e24
	M14A0_SROM_BOOT_OFFSET_T    srom_boot_offset;            // 0x4e28
	M14A0_ATLAS_PORT_SEL_T      atlas_port_sel;              // 0x4e2c
	M14A0_PDEBUG_STATUS_T       pdebug_status;               // 0x4e30
	M14A0_PDEBUG_DATA_T         pdebug_data;                 // 0x4e34
	M14A0_PDEBUG_PC_T           pdebug_pc;                   // 0x4e38
	M14A0_AXI_USER_ID_T         axi_user_id;                 // 0x4e3c
	M14A0_SRAM0_ATLAS_OFFSET_T  sram0_atlas_offset;          // 0x4e40
	M14A0_SRAM1_ATLAS_OFFSET_T  sram1_atlas_offset;          // 0x4e44
	M14A0_SRAM2_ATLAS_OFFSET_T  sram2_atlas_offset;          // 0x4e48
	M14A0_SROM_BOOT_OFFSET2_T   srom_boot_offset2;           // 0x4e4c
	UINT32                      reserved0[3];                // 0x4e50~0x4e58
	M14A0_SPP_MCU_VERSION_T     spp_mcu_version;             // 0x4e5c
	UINT32                      reserved1[40];               // 0x4e60~0x4efc
	M14A0_TX_LOCKED_ID_T        tx_locked_id;                // 0x4f00
	M14A0_TX_SRC_ADDR_T         tx_src_addr;                 // 0x4f04
	M14A0_TX_DST_ADDR_T         tx_dst_addr;                 // 0x4f08
	M14A0_TX_NXT_ADDR_T         tx_nxt_addr;                 // 0x4f0c
	M14A0_TX_LENGTH_T           tx_length;                   // 0x4f10
	M14A0_EDMA_CTRL_T           edma_ctrl;                   // 0x4f14
	M14A0_PATTERN_ADDR_T        pattern_addr;                // 0x4f18
	M14A0_PATTERN_DATA_T        pattern_data;                // 0x4f1c
} DE_IPC_REG_M14A0_T;
...
} M14A0_MCU1_ARM_INTR_RAW_STATUS;
...
typedef struct {
	M14A0_MCU1_RUNSTALL                     	top_runstall                     ;	// 0x0000 : ''
	M14A0_MCU1_STAT_VECTOR_SEL              	top_stat_vector_sel              ;	// 0x0004 : ''
	M14A0_MCU1_PDEBUGENABLE                 	top_pdebugenable                 ;	// 0x0008 : ''
	M14A0_MCU1_PDEBUGDATA                   	top_pdebugdata                   ;	// 0x000c : ''
	M14A0_MCU1_PDEBUGPC                     	top_pdebugpc                     ;	// 0x0010 : ''
	M14A0_MCU1_PDEBUGSTATUS                 	top_pdebugstatus                 ;	// 0x0014 : ''
	M14A0_MCU1_TR_ADDR_OFFSET_0             	top_tr_addr_offset_0             ;	// 0x0018 : ''
	M14A0_MCU1_TR_ADDR_OFFSET_1             	top_tr_addr_offset_1             ;	// 0x001c : ''
	M14A0_MCU1_TR_ADDR_OFFSET_2             	top_tr_addr_offset_2             ;	// 0x0020 : ''
	M14A0_MCU1_TR_ADDR_OFFSET_3             	top_tr_addr_offset_3             ;	// 0x0024 : ''
	M14A0_MCU1_ARM_INTR_EN                  	top_arm_intr_en                  ;	// 0x0028 : ''
	M14A0_MCU1_ARM_INTR_STATUS              	top_arm_intr_status              ;	// 0x002c : ''
	M14A0_MCU1_ARM_INTR_RAW_STATUS          	top_arm_intr_raw_status          ;	// 0x0030 : ''
	M14A0_MCU1_ARM_INTR_CLR                 	top_arm_intr_clr                 ;	// 0x0034 : ''
	M14A0_MCU1_DE_INTR_EN                   	top_de_intr_en                   ;	// 0x0038 : ''
	M14A0_MCU1_DE_INTR_STATUS               	top_de_intr_status               ;	// 0x003c : ''
	M14A0_MCU1_DE_INTR_RAW_STATUS           	top_de_intr_raw_status           ;	// 0x0040 : ''
	M14A0_MCU1_DE_INTR_CLR                  	top_de_intr_clr                  ;	// 0x0044 : ''
	M14A0_MCU1_RC_INTR_EN                   	top_rc_intr_en                   ;	// 0x0048 : ''
	M14A0_MCU1_RC_INTR_STATUS               	top_rc_intr_status               ;	// 0x004c : ''
	M14A0_MCU1_RC_INTR_RAW_STATUS           	top_rc_intr_raw_status           ;	// 0x0050 : ''
	M14A0_MCU1_RC_INTR_CLR                  	top_rc_intr_clr                  ;	// 0x0054 : ''
	M14A0_MCU1_DMA_CRC_CLR                  	top_dma_crc_clr                  ;	// 0x0058 : ''
	M14A0_MCU1_DMA_CRC_HEC                  	top_dma_crc_hec                  ;	// 0x005c : ''
	M14A0_MCU1_DMA_CRC_AAL5                 	top_dma_crc_aal5                 ;	// 0x0060 : ''
