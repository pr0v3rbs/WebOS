...
#ifndef _REG_IPC_M14B0_H_
#define _REG_IPC_M14B0_H_
/*-----------------------------------------------------------------------------
...
} M14B0_INTR_MCU_FLAG_EN_T;

/*-----------------------------------------------------------------------------
		0xc0025068L intr_cpu_flag ''
-----------------------------------------------------------------------------*/
typedef struct {
	UINT32 dei_mcu_intr_cpu                   : 1 ;  //     0     
	UINT32 dem_mcu_intr_cpu                   : 1 ;  //     1     
	UINT32 deo_mcu_intr_cpu                   : 1 ;  //     2     
	UINT32 dpp_mcu_intr_cpu                   : 1 ;  //     3     
} M14B0_INTR_CPU_FLAG_T;
...
typedef struct {
	M14B0_SET_CTRL0_T              	        set_ctrl0;                    //0xc0025000L
	M14B0_SET_CTRL1_T              	        set_ctrl1;                    //0xc0025004L
	M14B0_EXT_INTR_EVENT_T             	ext_intr_event;               //0xc0025008L
	M14B0_EXT_INTR_ENABLE_T            	ext_intr_enable;              //0xc002500cL
	M14B0_EXT_INTR_STATUS_T            	ext_intr_status;              //0xc0025010L
	M14B0_EXT_INTR_CLEAR_T             	ext_intr_clear;               //0xc0025014L
	M14B0_INT_INTR_EVENT_T             	int_intr_event;               //0xc0025018L
	M14B0_INT_INTR_ENABLE_T            	int_intr_enable;              //0xc002501cL
	M14B0_INT_INTR_STATUS_T            	int_intr_status;              //0xc0025020L
	M14B0_INT_INTR_CLEAR_T             	int_intr_clear;               //0xc0025024L
	M14B0_SROM_BOOT_OFFSET1_T          	srom_boot_offset1;            //0xc0025028L
	M14B0_SROM_BOOT_OFFSET2_T          	srom_boot_offset2;            //0xc002502cL
	M14B0_ATLAS_PORT_SEL_T             	atlas_port_sel;               //0xc0025030L
	M14B0_PDEBUG_STATUS_T              	pdebug_status;                //0xc0025034L
	M14B0_PDEBUG_DATA_T                	pdebug_data;                  //0xc0025038L
	M14B0_PDEBUG_PC_T                  	pdebug_pc;                    //0xc002503cL
	M14B0_AXI_USER_ID_T                	axi_user_id;                  //0xc0025040L
	M14B0_SRAM0_ATLAS_OFFSET_T         	sram0_atlas_offset;           //0xc0025044L
	M14B0_SRAM1_ATLAS_OFFSET_T         	sram1_atlas_offset;           //0xc0025048L
	M14B0_SRAM2_ATLAS_OFFSET_T         	sram2_atlas_offset;           //0xc002504cL
	M14B0_SRAM3_ATLAS_OFFSET_T         	sram3_atlas_offset;           //0xc0025050L
	M14B0_INBOUND_START_T              	inbound_start;                //0xc0025054L
	M14B0_INBOUND_OFFSET_T             	inbound_offset;               //0xc0025058L
	M14B0_SPP_MCU_VERSION_T            	spp_mcu_version;              //0xc002505cL
	M14B0_INTR_MCU_FLAG_T              	intr_mcu_flag;                //0xc0025060L
	M14B0_INTR_MCU_FLAG_EN_T           	intr_mcu_flag_en;             //0xc0025064L
	M14B0_INTR_CPU_FLAG_T              	intr_cpu_flag;                //0xc0025068L
	UINT32                             	reserved00[37];               //0xc002506cL~0xc00250fcL
	M14B0_CPU_IPC0_T                   	cpu_ipc0;                     //0xc0025100L
	UINT32                             	reserved01[62];               //0xc0025104L~0xc00251f8L
	M14B0_CPU_IPC63_T                  	cpu_ipc63;                    //0xc00251fcL
} DE_IPC_REG_M14B0_T;
