...
#ifndef _REG_MIF_M14A0_h
#define _REG_MIF_M14A0_h
...
} M14A0_MIFA_RD_CMD_STRIDE_SET_T;
...
} M14A0_MIFA_WD_CMD_STRIDE_SET_T;
...
} M14A0_MIFA_SADDR_RD_MVI_Y_MVI_C_T;
...
} M14A0_MIFA_SADDR_RD_IPC0_Y_T;

/*-----------------------------------------------------------------------------
	0x086c mifa_saddr_rd_ipc_c ''
------------------------------------------------------------------------------*/
typedef struct {
	UINT32                             : 3;   //  0: 2 reserved
...
} M14A0_MIFA_SADDR_PARAM_UPDATE0_M_T;
...
} M14A0_MIFA_SADDR_PARAM_UPDATE0_M1_T;
...
typedef struct {
	...
	UINT32 req_rd_bank_split_8_ipc_c   : 1;   //    20
	UINT32 req_rd_bank_addr_8_ipc_c    : 3;   // 21:23
...
typedef struct {
	...
	UINT32 req_rd_bank_split_2_ipc_c   : 1;   //    20
	UINT32 req_rd_bank_addr_2_ipc_c    : 3;   // 21:23
...
} M14A0_MIFB_RD_CMD_STRIDE_SET_T;
...
} M14A0_MIFB_WD_CMD_STRIDE_SET_T;
...
} M14A0_MIFC_RD_CMD_STRIDE_SET_T;
...
} M14A0_MIFC_WD_CMD_STRIDE_SET_T;
...
typedef struct {
	...
	UINT32                             : 3;   // 16:18 reserved
	UINT32 req_rd_saddr_mvi_c          : 13;  // 19:31
} M14A0_MIFC_SADDR_RD_MVI_Y_MVI_C_T;
...
} M14A0_MIFC_SADDR_RD_PREW_Y_PREW_C_T;
...
typedef struct {
	...
	UINT32                             : 3;   // 16:18 reserved
	UINT32 req_rd_saddr_ipc_c          : 13;  // 19:31
} M14A0_MIFC_SADDR_RD_IPC0_Y_IPC_C_T;
...
} M14A0_MIFC_SADDR_RD_IPC1_Y_TNR0_Y_T;
...
} M14A0_MIFC_SADDR_RD_SS_Y_SS_C_T;
...
} M14A0_MIFC_SADDR_WD_SS_Y_SS_C_T;
...
} M14A0_MIFC_SADDR_WD_TNR_Y_TNR_C_T;
...
} M14A0_MIFC_SADDR_WD_PREW_Y_PREW_C_T;
...
} M14A0_MIFC_SADDR_RD_DL_Y_DL_C_T;
...
} M14A0_MIFC_SADDR_RD_DR_Y_DR_C_T;
...
} M14A0_MIFC_SADDR_WD_DL_Y_DL_C_T;
...
} M14A0_MIFC_SADDR_WD_DR_Y_DR_C_T;
...
typedef struct {
	...
	UINT32                             : 10;  //  1:10 reserved
	UINT32 register_update_address0_m  : 21;  // 11:31
} M14A0_MIFC_SADDR_PARAM_UPDATE0_M_T;
...
} M14A0_MIFD_RD_CMD_STRIDE_SET_T;
...
typedef struct {
	UINT32 man_cmd_wd_stride_v_sm_y    : 1;   //     0
	UINT32 man_cmd_wd_stride_v_sm_c    : 1;   //     1
} M14A0_MIFD_WD_CMD_STRIDE_SET_T;
...
} M14A0_MIFD_SADDR_RD_OV_Y_OV_C_T;
...
} M14A0_MIFD_SADDR_RD_CVE_Y_CVE_C_T;
...
typedef struct {
	...
	UINT32                             : 10;  //  1:10 reserved
	UINT32 register_update_address0_m  : 21;  // 11:31
} M14A0_MIFD_SADDR_PARAM_UPDATE0_M_T;
...
} M14A0_MIFF_RD_CMD_STRIDE_SET_T;
...
typedef struct {
	...
	UINT32                             : 10;  //  1:10 reserved
	UINT32 register_update_address0_m  : 21;  // 11:31
} M14A0_MIFF_SADDR_PARAM_UPDATE0_M_T;


typedef struct {
	M14A0_MIFA_RD_CTRL_T                    mifa_rd_ctrl;                            // 0x0800
	M14A0_MIFA_WD_CTRL_T                    mifa_wd_ctrl;                            // 0x0804
	M14A0_MIF_RD_SET_10B_T                  mif_rd_set_10b;                          // 0x0808
	M14A0_MIF_WD_SET_10B_T                  mif_wd_set_10b;                          // 0x080c
	M14A0_MIFA_RD_CMD_PRI0_T                mifa_rd_cmd_pri0;                        // 0x0810
	M14A0_MIFA_RD_CMD_PRI1_T                mifa_rd_cmd_pri1;                        // 0x0814
	M14A0_MIFA_WD_CMD_PRI0_T                mifa_wd_cmd_pri0;                        // 0x0818
	M14A0_MIFA_RD_REQ_PRI0_T                mifa_rd_req_pri0;                        // 0x081c
	M14A0_MIFA_RD_REQ_PRI1_T                mifa_rd_req_pri1;                        // 0x0820
	M14A0_MIFA_WD_REQ_PRI0_T                mifa_wd_req_pri0;                        // 0x0824
	M14A0_MIFA_RD_REQ_STV0_T                mifa_rd_req_stv0;                        // 0x0828
	M14A0_MIFA_RD_REQ_STV1_T                mifa_rd_req_stv1;                        // 0x082c
	M14A0_MIFA_WD_REQ_STV0_T                mifa_wd_req_stv0;                        // 0x0830
	M14A0_MIFA_RD_CMD_PEND0_T               mifa_rd_cmd_pend0;                       // 0x0834
	M14A0_MIFA_RD_CMD_PEND1_T               mifa_rd_cmd_pend1;                       // 0x0838
	M14A0_MIFA_WD_CMD_PEND0_T               mifa_wd_cmd_pend0;                       // 0x083c
	M14A0_MIFA_RD_CMD_STRIDE0_T             mifa_rd_cmd_stride0;                     // 0x0840
	M14A0_MIFA_RD_CMD_STRIDE1_T             mifa_rd_cmd_stride1;                     // 0x0844
	M14A0_MIFA_RD_CMD_STRIDE2_T             mifa_rd_cmd_stride2;                     // 0x0848
	M14A0_MIFA_RD_CMD_STRIDE_SET_T          mifa_rd_cmd_stride_set;                  // 0x084c
	M14A0_MIFA_WD_CMD_STRIDE0_T             mifa_wd_cmd_stride0;                     // 0x0850
	M14A0_MIFA_WD_CMD_STRIDE1_T             mifa_wd_cmd_stride1;                     // 0x0854
	M14A0_MIFA_WD_CMD_STRIDE_SET_T          mifa_wd_cmd_stride_set;                  // 0x0858
	M14A0_MIFA_SADDR_RD_MVI_Y_MVI_C_T       mifa_saddr_rd_mvi_y_mvi_c;               // 0x085c
	M14A0_MIFA_SADDR_RD_PREW_Y_T            mifa_saddr_rd_prew_y;                    // 0x0860
	M14A0_MIFA_SADDR_RD_PREW_C_T            mifa_saddr_rd_prew_c;                    // 0x0864
	M14A0_MIFA_SADDR_RD_IPC0_Y_T            mifa_saddr_rd_ipc0_y;                    // 0x0868
	M14A0_MIFA_SADDR_RD_IPC_C_T             mifa_saddr_rd_ipc0_c;                    // 0x086c
	M14A0_MIFA_SADDR_RD_IPC1_Y_T            mifa_saddr_rd_ipc1_y;                    // 0x0870
	M14A0_MIFA_SADDR_RD_TNR0_Y_T            mifa_saddr_rd_tnr0_y;                    // 0x0874
	M14A0_MIFA_SADDR_RD_TNR_C_T             mifa_saddr_rd_tnr_c;                     // 0x0878
	M14A0_MIFA_SADDR_RD_TNR1_Y_T            mifa_saddr_rd_tnr1_y;                    // 0x087c
	M14A0_MIFA_SADDR_RD_IPC_M_T             mifa_saddr_rd_ipc_m;                     // 0x0880
	M14A0_MIFA_SADDR_WD_TNR_Y_T             mifa_saddr_wd_tnr_y;                     // 0x0884
	M14A0_MIFA_SADDR_WD_TNR_C_T             mifa_saddr_wd_tnr_c;                     // 0x0888
	M14A0_MIFA_SADDR_WD_PREW_Y_T            mifa_saddr_wd_prew_y;                    // 0x088c
	M14A0_MIFA_SADDR_WD_PREW_C_T            mifa_saddr_wd_prew_c;                    // 0x0890
	M14A0_MIFA_SADDR_WD_TNR_M_T             mifa_saddr_wd_tnr_m;                     // 0x0894
	M14A0_MIFA_SADDR_RD_DL_Y_T              mifa_saddr_rd_dl_y;                      // 0x0898
	M14A0_MIFA_SADDR_RD_DL_C_T              mifa_saddr_rd_dl_c;                      // 0x089c
	M14A0_MIFA_SADDR_RD_DR_Y_T              mifa_saddr_rd_dr_y;                      // 0x08a0
	M14A0_MIFA_SADDR_RD_DR_C_T              mifa_saddr_rd_dr_c;                      // 0x08a4
	M14A0_MIFA_SADDR_WD_DL_Y_T              mifa_saddr_wd_dl_y;                      // 0x08a8
	M14A0_MIFA_SADDR_WD_DL_C_T              mifa_saddr_wd_dl_c;                      // 0x08ac
	M14A0_MIFA_SADDR_WD_DR_Y_T              mifa_saddr_wd_dr_y;                      // 0x08b0
	M14A0_MIFA_SADDR_WD_DR_C_T              mifa_saddr_wd_dr_c;                      // 0x08b4
	M14A0_MIFA_SADDR_RD_EXT0_T              mifa_saddr_rd_ext0;                      // 0x08b8
	M14A0_MIFA_SADDR_RD_EXT1_T              mifa_saddr_rd_ext1;                      // 0x08bc
	M14A0_MIFA_SADDR_RD_EXT2_T              mifa_saddr_rd_ext2;                      // 0x08c0
	M14A0_MIFA_SADDR_WD_EXT0_T              mifa_saddr_wd_ext0;                      // 0x08c4
	M14A0_MIFA_SADDR_WD_EXT1_T              mifa_saddr_wd_ext1;                      // 0x08c8
	M14A0_MIFA_RD_DR_DL_EXT_T               mifa_rd_dr_dl_ext;                       // 0x08cc
	M14A0_MIFA_WD_DR_DL_EXT_T               mifa_wd_dr_dl_ext;                       // 0x08d0
	M14A0_MIFA_STATUS_T                     mifa_status;                             // 0x08d4
	M14A0_MIFA_SADDR_PARAM_UPDATE0_M_T      mifa_saddr_param_update0_m;              // 0x08d8
	M14A0_MIFA_SADDR_PARAM_UPDATE0_M1_T     mifa_saddr_param_update0_m1;             // 0x08dc
	M14A0_MIFA_RD_BANK_8_ADDR0_T            mifa_rd_bank_8_addr0;                    // 0x08e0
	M14A0_MIFA_RD_BANK_8_ADDR1_T            mifa_rd_bank_8_addr1;                    // 0x08e4
	M14A0_MIFA_RD_BANK_2_ADDR0_T            mifa_rd_bank_2_addr0;                    // 0x08e8
	M14A0_MIFA_RD_BANK_2_ADDR1_T            mifa_rd_bank_2_addr1;                    // 0x08ec
	M14A0_MIFA_WD_BANK_8_ADDR0_T            mifa_wd_bank_8_addr0;                    // 0x08f0
	M14A0_MIFA_WD_BANK_8_ADDR1_T            mifa_wd_bank_8_addr1;                    // 0x08f4
	M14A0_MIFA_WD_BANK_2_ADDR0_T            mifa_wd_bank_2_addr0;                    // 0x08f8
	M14A0_MIFA_WD_BANK_2_ADDR1_T            mifa_wd_bank_2_addr1;                    // 0x08fc
	M14A0_MIFA_LSB_SWITCH_T                 mifa_lsb_switch;                         // 0x0900
	M14A0_MIFA_RD_REQ_PEND0_T               mifa_rd_req_pend0;                       // 0x0904
	M14A0_MIFA_RD_REQ_PEND1_T               mifa_rd_req_pend1;                       // 0x0908
	M14A0_MIFA_RD_REQ_PEND2_T               mifa_rd_req_pend2;                       // 0x090c
	M14A0_MIFA_WD_REQ_PEND0_T               mifa_wd_req_pend0;                       // 0x0910
	M14A0_MIFA_WD_REQ_PEND1_T               mifa_wd_req_pend1;                       // 0x0914
	M14A0_MIFA_RD_CMD_PRI0_S_T              mifa_rd_cmd_pri0_s;                      // 0x0918
	M14A0_MIFA_RD_CMD_PRI1_S_T              mifa_rd_cmd_pri1_s;                      // 0x091c
	M14A0_MIFA_WD_CMD_PRI0_S_T              mifa_wd_cmd_pri0_s;                      // 0x0920
	M14A0_MIFA_RESET_T                      mifa_reset;                              // 0x0924
} DE_MIA_REG_M14A0_T;

typedef struct {
	M14A0_MIFB_RD_CTRL_T                    mifb_rd_ctrl;                            // 0x1b00
	M14A0_MIFB_WD_CTRL_T                    mifb_wd_ctrl;                            // 0x1b04
	M14A0_MIFB_RD_SET_10B_T                 mifb_rd_set_10b;                         // 0x1b08
	M14A0_MIFB_WD_SET_10B_T                 mifb_wd_set_10b;                         // 0x1b0c
	M14A0_MIFB_RD_CMD_PRI0_T                mifb_rd_cmd_pri0;                        // 0x1b10
	M14A0_MIFB_WD_CMD_PRI0_T                mifb_wd_cmd_pri0;                        // 0x1b14
	M14A0_MIFB_RD_REQ_PRI0_T                mifb_rd_req_pri0;                        // 0x1b18
	M14A0_MIFB_WD_REQ_PRI0_T                mifb_wd_req_pri0;                        // 0x1b1c
	M14A0_MIFB_RD_REQ_STV0_T                mifb_rd_req_stv0;                        // 0x1b20
	M14A0_MIFB_WD_REQ_STV0_T                mifb_wd_req_stv0;                        // 0x1b24
	M14A0_MIFB_RD_CMD_PEND0_T               mifb_rd_cmd_pend0;                       // 0x1b28
	M14A0_MIFB_WD_CMD_PEND0_T               mifb_wd_cmd_pend0;                       // 0x1b2c
	M14A0_MIFB_RD_CMD_STRIDE0_T             mifb_rd_cmd_stride0;                     // 0x1b30
	M14A0_MIFB_RD_CMD_STRIDE_SET_T          mifb_rd_cmd_stride_set;                  // 0x1b34
	M14A0_MIFB_WD_CMD_STRIDE0_T             mifb_wd_cmd_stride0;                     // 0x1b38
	M14A0_MIFB_WD_CMD_STRIDE_SET_T          mifb_wd_cmd_stride_set;                  // 0x1b3c
	M14A0_MIFB_SADDR_RD_OV_Y_T              mifb_saddr_rd_ov_y;                      // 0x1b40
	M14A0_MIFB_SADDR_RD_OV_C_T              mifb_saddr_rd_ov_c;                      // 0x1b44
	M14A0_MIFB_SADDR_WD_SM_Y_T              mifb_saddr_wd_sm_y;                      // 0x1b48
	M14A0_MIFB_SADDR_WD_SM_C_T              mifb_saddr_wd_sm_c;                      // 0x1b4c
	M14A0_MIFB_SADDR_RD_EXT0_T              mifb_saddr_rd_ext0;                      // 0x1b50
	M14A0_MIFB_SADDR_WD_EXT0_T              mifb_saddr_wd_ext0;                      // 0x1b54
	M14A0_MIFB_STATUS_T                     mifb_status;                             // 0x1b58
	M14A0_MIFB_RD_BANK_8_ADDR0_T            mifb_rd_bank_8_addr0;                    // 0x1b5c
	M14A0_MIFB_RD_BANK_8_ADDR1_T            mifb_rd_bank_8_addr1;                    // 0x1b60
	M14A0_MIFB_RD_BANK_2_ADDR0_T            mifb_rd_bank_2_addr0;                    // 0x1b64
	M14A0_MIFB_RD_BANK_2_ADDR1_T            mifb_rd_bank_2_addr1;                    // 0x1b68
	M14A0_MIFB_WD_BANK_8_ADDR0_T            mifb_wd_bank_8_addr0;                    // 0x1b6c
	M14A0_MIFB_WD_BANK_8_ADDR1_T            mifb_wd_bank_8_addr1;                    // 0x1b70
	M14A0_MIFB_WD_BANK_2_ADDR0_T            mifb_wd_bank_2_addr0;                    // 0x1b74
	M14A0_MIFB_WD_BANK_2_ADDR1_T            mifb_wd_bank_2_addr1;                    // 0x1b78
	M14A0_MIFB_LSB_SWITCH_T                 mifb_lsb_switch;                         // 0x1b7c
	M14A0_MIFB_RD_REQ_PEND0_T               mifb_rd_req_pend0;                       // 0x1b80
	M14A0_MIFB_WD_REQ_PEND0_T               mifb_wd_req_pend0;                       // 0x1b84
	M14A0_MIFB_RD_CMD_PRI0_S_T              mifb_rd_cmd_pri0_s;                      // 0x1b88
	M14A0_MIFB_WD_CMD_PRI0_S_T              mifb_wd_cmd_pri0_s;                      // 0x1b8c
	M14A0_MIFB_RESET_T                      mifb_reset;                              // 0x1b90
} DE_MIB_REG_M14A0_T;

typedef struct {
	M14A0_MIFC_RD_CTRL_T                    mifc_rd_ctrl;                            // 0x2800
	M14A0_MIFC_WD_CTRL_T                    mifc_wd_ctrl;                            // 0x2804
	M14A0_MIFC_RD_CMD_PRI0_T                mifc_rd_cmd_pri0;                        // 0x2808
	M14A0_MIFC_RD_CMD_PRI1_T                mifc_rd_cmd_pri1;                        // 0x280c
	M14A0_MIFC_WD_CMD_PRI0_T                mifc_wd_cmd_pri0;                        // 0x2810
	M14A0_MIFC_RD_REQ_PRI0_T                mifc_rd_req_pri0;                        // 0x2814
	M14A0_MIFC_RD_REQ_PRI1_T                mifc_rd_req_pri1;                        // 0x2818
	M14A0_MIFC_WD_REQ_PRI0_T                mifc_wd_req_pri0;                        // 0x281c
	M14A0_MIFC_RD_REQ_STV0_T                mifc_rd_req_stv0;                        // 0x2820
	M14A0_MIFC_RD_REQ_STV1_T                mifc_rd_req_stv1;                        // 0x2824
	M14A0_MIFC_WD_REQ_STV0_T                mifc_wd_req_stv0;                        // 0x2828
	M14A0_MIFC_RD_CMD_PEND0_T               mifc_rd_cmd_pend0;                       // 0x282c
	M14A0_MIFC_RD_CMD_PEND1_T               mifc_rd_cmd_pend1;                       // 0x2830
	M14A0_MIFC_WD_CMD_PEND0_T               mifc_wd_cmd_pend0;                       // 0x2834
	M14A0_MIFC_RD_CMD_STRIDE0_T             mifc_rd_cmd_stride0;                     // 0x2838
	M14A0_MIFC_RD_CMD_STRIDE1_T             mifc_rd_cmd_stride1;                     // 0x283c
	M14A0_MIFC_RD_CMD_STRIDE_SET_T          mifc_rd_cmd_stride_set;                  // 0x2840
	M14A0_MIFC_WD_CMD_STRIDE0_T             mifc_wd_cmd_stride0;                     // 0x2844
	M14A0_MIFC_WD_CMD_STRIDE_SET_T          mifc_wd_cmd_stride_set;                  // 0x2848
	M14A0_MIFC_SADDR_RD_MVI_Y_MVI_C_T       mifc_saddr_rd_mvi_y_mvi_c;               // 0x284c
	M14A0_MIFC_SADDR_RD_PREW_Y_PREW_C_T     mifc_saddr_rd_prew_y_prew_c;             // 0x2850
	M14A0_MIFC_SADDR_RD_IPC0_Y_IPC_C_T      mifc_saddr_rd_ipc0_y_ipc_c;              // 0x2854
	M14A0_MIFC_SADDR_RD_IPC1_Y_TNR0_Y_T     mifc_saddr_rd_ipc1_y_tnr0_y;             // 0x2858
	M14A0_MIFC_SADDR_RD_SS_Y_SS_C_T         mifc_saddr_rd_ss_y_ss_c;                 // 0x285c
	M14A0_MIFC_SADDR_RD_TNR_C_T             mifc_saddr_rd_tnr_c;                     // 0x2860
	M14A0_MIFC_SADDR_WD_SS_Y_SS_C_T         mifc_saddr_wd_ss_y_ss_c;                 // 0x2864
	M14A0_MIFC_SADDR_WD_TNR_Y_TNR_C_T       mifc_saddr_wd_tnr_y_tnr_c;               // 0x2868
	M14A0_MIFC_SADDR_WD_PREW_Y_PREW_C_T     mifc_saddr_wd_prew_y_prew_c;             // 0x286c
	M14A0_MIFC_SADDR_RD_DL_Y_DL_C_T         mifc_saddr_rd_dl_y_dl_c;                 // 0x2870
	M14A0_MIFC_SADDR_RD_DR_Y_DR_C_T         mifc_saddr_rd_dr_y_dr_c;                 // 0x2874
	M14A0_MIFC_SADDR_WD_DL_Y_DL_C_T         mifc_saddr_wd_dl_y_dl_c;                 // 0x2878
	M14A0_MIFC_SADDR_WD_DR_Y_DR_C_T         mifc_saddr_wd_dr_y_dr_c;                 // 0x287c
	M14A0_MIFC_SADDR_RD_EXT0_T              mifc_saddr_rd_ext0;                      // 0x2880
	M14A0_MIFC_SADDR_RD_EXT1_T              mifc_saddr_rd_ext1;                      // 0x2884
	M14A0_MIFC_SADDR_WD_EXT0_T              mifc_saddr_wd_ext0;                      // 0x2888
	M14A0_MIFC_RD_DR_DL_EXT_T               mifc_rd_dr_dl_ext;                       // 0x288c
	M14A0_MIFC_WD_DR_DL_EXT_T               mifc_wd_dr_dl_ext;                       // 0x2890
	M14A0_MIFC_STATUS_T                     mifc_status;                             // 0x2894
	M14A0_MIFC_SADDR_PARAM_UPDATE0_M_T      mifc_saddr_param_update0_m;              // 0x2898
	M14A0_MIFC_RD_BANK_8_ADDR0_T            mifc_rd_bank_8_addr0;                    // 0x289c
	M14A0_MIFC_RD_BANK_8_ADDR1_T            mifc_rd_bank_8_addr1;                    // 0x28a0
	M14A0_MIFC_WD_BANK_8_ADDR0_T            mifc_wd_bank_8_addr0;                    // 0x28a4
	M14A0_MIFC_WD_BANK_8_ADDR1_T            mifc_wd_bank_8_addr1;                    // 0x28a8
	M14A0_MIFC_RD_REQ_PEND0_T               mifc_rd_req_pend0;                       // 0x28ac
	M14A0_MIFC_RD_REQ_PEND1_T               mifc_rd_req_pend1;                       // 0x28b0
	M14A0_MIFC_RD_REQ_PEND2_T               mifc_rd_req_pend2;                       // 0x28b4
	M14A0_MIFC_WD_REQ_PEND0_T               mifc_wd_req_pend0;                       // 0x28b8
	M14A0_MIFC_WD_REQ_PEND1_T               mifc_wd_req_pend1;                       // 0x28bc
	M14A0_MIFC_RD_CMD_PRI0_S_T              mifc_rd_cmd_pri0_s;                      // 0x28c0
	M14A0_MIFC_RD_CMD_PRI1_S_T              mifc_rd_cmd_pri1_s;                      // 0x28c4
	M14A0_MIFC_WD_CMD_PRI0_S_T              mifc_wd_cmd_pri0_s;                      // 0x28c8
	M14A0_MIFC_RESET_T                      mifc_reset;                              // 0x28cc
} DE_MIC_REG_M14A0_T;

typedef struct {
	M14A0_MIFD_RD_CTRL_T                    mifd_rd_ctrl;                            // 0x3900
	M14A0_MIFD_WD_CTRL_T                    mifd_wd_ctrl;                            // 0x3904
	M14A0_MIFD_RD_CMD_PRI0_T                mifd_rd_cmd_pri0;                        // 0x3908
	M14A0_MIFD_WD_CMD_PRI0_T                mifd_wd_cmd_pri0;                        // 0x390c
	M14A0_MIFD_RD_REQ_PRI0_T                mifd_rd_req_pri0;                        // 0x3910
	M14A0_MIFD_WD_REQ_PRI0_T                mifd_wd_req_pri0;                        // 0x3914
	M14A0_MIFD_RD_REQ_STV0_T                mifd_rd_req_stv0;                        // 0x3918
	M14A0_MIFD_WD_REQ_STV0_T                mifd_wd_req_stv0;                        // 0x391c
	M14A0_MIFD_RD_CMD_PEND0_T               mifd_rd_cmd_pend0;                       // 0x3920
	M14A0_MIFD_WD_CMD_PEND0_T               mifd_wd_cmd_pend0;                       // 0x3924
	M14A0_MIFD_RD_CMD_STRIDE0_T             mifd_rd_cmd_stride0;                     // 0x3928
	M14A0_MIFD_RD_CMD_STRIDE_SET_T          mifd_rd_cmd_stride_set;                  // 0x392c
	M14A0_MIFD_WD_CMD_STRIDE0_T             mifd_wd_cmd_stride0;                     // 0x3930
	M14A0_MIFD_WD_CMD_STRIDE_SET_T          mifd_wd_cmd_stride_set;                  // 0x3934
	M14A0_MIFD_SADDR_RD_OV_Y_OV_C_T         mifd_saddr_rd_ov_y_ov_c;                 // 0x3938
	M14A0_MIFD_SADDR_RD_CVE_Y_CVE_C_T       mifd_saddr_rd_cve_y_cve_c;               // 0x393c
	M14A0_MIFD_SADDR_WD_SM_YC_T             mifd_saddr_wd_sm_yc;                     // 0x3940
	M14A0_MIFD_SADDR_RD_EXT0_T              mifd_saddr_rd_ext0;                      // 0x3944
	M14A0_MIFD_SADDR_WD_EXT0_T              mifd_saddr_wd_ext0;                      // 0x3948
	M14A0_MIFD_STATUS_T                     mifd_status;                             // 0x394c
	M14A0_MIFD_SADDR_PARAM_UPDATE0_M_T      mifd_saddr_param_update0_m;              // 0x3950
	M14A0_MIFD_RD_BANK_8_ADDR0_T            mifd_rd_bank_8_addr0;                    // 0x3954
	M14A0_MIFD_RD_BANK_8_ADDR1_T            mifd_rd_bank_8_addr1;                    // 0x3958
	M14A0_MIFD_WD_BANK_8_ADDR0_T            mifd_wd_bank_8_addr0;                    // 0x395c
	M14A0_MIFD_WD_BANK_8_ADDR1_T            mifd_wd_bank_8_addr1;                    // 0x3960
	M14A0_MIFD_RD_REQ_PEND0_T               mifd_rd_req_pend0;                       // 0x3964
	M14A0_MIFD_WD_REQ_PEND0_T               mifd_wd_req_pend0;                       // 0x3968
	M14A0_MIFD_RD_CMD_PRI0_S_T              mifd_rd_cmd_pri0_s;                      // 0x396c
	M14A0_MIFD_WD_CMD_PRI0_S_T              mifd_wd_cmd_pri0_s;                      // 0x3970
	M14A0_MIFD_RESET_T                      mifd_reset;                              // 0x3974
} DE_MID_REG_M14A0_T;

typedef struct {
	M14A0_MIFO_RD_CTRL_T                    mifo_rd_ctrl;                            // 0x5900
	M14A0_MIFO_RD_CMD_PRI0_T                mifo_rd_cmd_pri0;                        // 0x5904
	M14A0_MIFO_RD_REQ_PRI0_T                mifo_rd_req_pri0;                        // 0x5908
	M14A0_MIFO_RD_REQ_STV0_T                mifo_rd_req_stv0;                        // 0x590c
	M14A0_MIFO_RD_CMD_PEND0_T               mifo_rd_cmd_pend0;                       // 0x5910
	M14A0_MIFO_SADDR_OSD_0_L_T              mifo_saddr_osd_0_l;                      // 0x5914
	M14A0_MIFO_SADDR_OSD_0_R_T              mifo_saddr_osd_0_r;                      // 0x5918
	M14A0_MIFO_SADDR_OSD_1_L_T              mifo_saddr_osd_1_l;                      // 0x591c
	M14A0_MIFO_SADDR_OSD_1_R_T              mifo_saddr_osd_1_r;                      // 0x5920
	M14A0_MIFO_SADDR_OSD_3_L_T              mifo_saddr_osd_3_l;                      // 0x5924
	M14A0_MIFO_SADDR_OSD_3_R_T              mifo_saddr_osd_3_r;                      // 0x5928
	M14A0_MIFO_STATUS_T                     mifo_status;                             // 0x592c
	M14A0_MIFO_RD_REQ_PEND0_T               mifo_rd_req_pend0;                       // 0x5930
	M14A0_MIFO_RD_CMD_PRI0_S_T              mifo_rd_cmd_pri0_s;                      // 0x5934
	M14A0_MIFO_RESET_T                      mifo_reset;                              // 0x5938
} DE_MIO_REG_M14A0_T;

typedef struct {
	M14A0_MIFF_RD_CTRL_T                 miff_rd_ctrl;                        // 0x5f00
	M14A0_MIFF_RD_CMD_PRI0_T             miff_rd_cmd_pri0;                    // 0x5f04
	M14A0_MIFF_RD_REQ_PRI0_T             miff_rd_req_pri0;                    // 0x5f08
	M14A0_MIFF_RD_REQ_STV0_T             miff_rd_req_stv0;                    // 0x5f0c
	M14A0_MIFF_RD_CMD_PEND0_T            miff_rd_cmd_pend0;                   // 0x5f10
	M14A0_MIFF_RD_CMD_STRIDE0_T          miff_rd_cmd_stride0;                 // 0x5f14
	M14A0_MIFF_RD_CMD_STRIDE_SET_T       miff_rd_cmd_stride_set;              // 0x5f18
	M14A0_MIFF_SADDR_RD_OSD_01_T         miff_saddr_rd_osd_01;                // 0x5f1c
	M14A0_MIFF_SADDR_RD_OSD_23_T         miff_saddr_rd_osd_23;                // 0x5f20
	M14A0_MIFF_SADDR_RD_CVE_YC_T         miff_saddr_rd_cve_yc;                // 0x5f24
	M14A0_MIFF_SADDR_RD_EXT0_T           miff_saddr_rd_ext0;                  // 0x5f28
	M14A0_MIFF_STATUS_T                  miff_status;                         // 0x5f2c
	M14A0_MIFF_RD_BANK_8_ADDR0_T         miff_rd_bank_8_addr0;                // 0x5f30
	M14A0_MIFF_RD_BANK_8_ADDR1_T         miff_rd_bank_8_addr1;                // 0x5f34
	M14A0_MIFF_RD_BANK_2_ADDR0_T         miff_rd_bank_2_addr0;                // 0x5f38
	M14A0_MIFF_RD_BANK_2_ADDR1_T         miff_rd_bank_2_addr1;                // 0x5f3c
	M14A0_MIFF_RD_REQ_PEND0_T            miff_rd_req_pend0;                   // 0x5f40
	M14A0_MIFF_RD_CMD_PRI0_S_T           miff_rd_cmd_pri0_s;                  // 0x5f44
	M14A0_MIFF_RESET_T                   miff_reset;                          // 0x5f48
	M14A0_MIFF_SADDR_PARAM_UPDATE0_M_T   miff_saddr_param_update0_m;          // 0x5f4c
} DE_MIF_REG_M14A0_T;
