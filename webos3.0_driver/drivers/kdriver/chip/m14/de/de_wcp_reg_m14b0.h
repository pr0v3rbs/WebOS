...
#ifndef _REG_WCP_M14B0_h
#define _REG_WCP_M14B0_h
...
typedef struct {
	...
	UINT32                             : 6;   // 10:15 reserved
	UINT32 buf_rdy_th_c                : 10;  // 16:25
} M14B0_OVR_OV_BUF_RDY_CTRL_T;

typedef struct {
	M14B0_OVL_OV_CTRL0_T            ovl_ov_ctrl0;                    // 0x1200
	M14B0_OVL_OV_CTRL1_T            ovl_ov_ctrl1;                    // 0x1204
	M14B0_OVL_OV_CTRL2_T            ovl_ov_ctrl2;                    // 0x1208
	M14B0_OVL_OV_CTRL3_T            ovl_ov_ctrl3;                    // 0x120c
	M14B0_OVL_OV_MOFFSET_T          ovl_ov_moffset;                  // 0x1210
	M14B0_OVL_OV_MSIZE_T            ovl_ov_msize;                    // 0x1214
	UINT32                          reserved0[2];                    // 0x1218~0x121c
	M14B0_OVL_OV_BORDER_WIDTH_T     ovl_ov_border_width;             // 0x1220
	M14B0_OVL_CFLT_COEF0_T          ovl_cflt_coef0;                  // 0x1224
	M14B0_OVL_CFLT_COEF1_T          ovl_cflt_coef1;                  // 0x1228
	UINT32                          reserved1[5];                    // 0x122c~0x123c
	M14B0_OVL_OV_INTR_CTRL_T        ovl_ov_intr_ctrl;                // 0x1240
	M14B0_OVL_OV_INTR_STATUS_T      ovl_ov_intr_status;              // 0x1244
	M14B0_OVL_OV_CTRL4_T            ovl_ov_ctrl4;                    // 0x1248
	UINT32                          reserved2[3];                    // 0x124c~0x1254
	M14B0_OVL_OV_YC_DELAY_T         ovl_ov_yc_delay;                 // 0x1258
	M14B0_OVL_OV_MIF_CTRL0_T        ovl_ov_mif_ctrl0;                // 0x125c
	UINT32                          reserved3[8];                    // 0x1260~0x127c
	M14B0_OVL_OV_MIF_STATUS_T       ovl_ov_mif_status;               // 0x1280
	M14B0_OVL_OV_LR_STATUS_T        ovl_ov_lr_status;                // 0x1284
	UINT32                          reserved4[2];                    // 0x1288~0x128c
	M14B0_OVL_OV_BUF_SIZE_CTRL_T    ovl_ov_buf_size_ctrl;            // 0x1290
	UINT32                          reserved5[3];                    // 0x1294~0x129c
	M14B0_OVL_OV_BUF_RDY_CTRL_T     ovl_ov_buf_rdy_ctrl;             // 0x12a0
	M14B0_OV_BA_SYNC_CTRL_0_T       ov_ba_sync_ctrl_0;               // 0x12a4
	M14B0_OV_BA_SYNC_CTRL_1_T       ov_ba_sync_ctrl_1;               // 0x12a8
	M14B0_OV_BA_SYNC_ST_T           ov_ba_sync_st;                   // 0x12ac
} DE_OVL_REG_M14B0_T;

typedef struct {
	M14B0_OVR_OV_CTRL0_T            ovr_ov_ctrl0;                    // 0x3200
	M14B0_OVR_OV_CTRL1_T            ovr_ov_ctrl1;                    // 0x3204
	M14B0_OVR_OV_CTRL2_T            ovr_ov_ctrl2;                    // 0x3208
	M14B0_OVR_OV_CTRL3_T            ovr_ov_ctrl3;                    // 0x320c
	M14B0_OVR_OV_MOFFSET_T          ovr_ov_moffset;                  // 0x3210
	M14B0_OVR_OV_MSIZE_T            ovr_ov_msize;                    // 0x3214
	UINT32                          reserved6[2];                    // 0x3218~0x321c
	M14B0_OVR_OV_BORDER_WIDTH_T     ovr_ov_border_width;             // 0x3220
	M14B0_OVR_CFLT_COEF0_T          ovr_cflt_coef0;                  // 0x3224
	M14B0_OVR_CFLT_COEF1_T          ovr_cflt_coef1;                  // 0x3228
	UINT32                          reserved7[5];                    // 0x322c~0x323c
	M14B0_OVR_OV_INTR_CTRL_T        ovr_ov_intr_ctrl;                // 0x3240
	M14B0_OVR_OV_INTR_STATUS_T      ovr_ov_intr_status;              // 0x3244
	M14B0_OVR_OV_CTRL4_T            ovr_ov_ctrl4;                    // 0x3248
	UINT32                          reserved8[3];                    // 0x324c~0x3254
	M14B0_OVR_OV_YC_DELAY_T         ovr_ov_yc_delay;                 // 0x3258
	M14B0_OVR_OV_MIF_CTRL0_T        ovr_ov_mif_ctrl0;                // 0x325c
	UINT32                          reserved9[8];                    // 0x3260~0x327c
	M14B0_OVR_OV_MIF_STATUS_T       ovr_ov_mif_status;               // 0x3280
	M14B0_OVR_OV_LR_STATUS_T        ovr_ov_lr_status;                // 0x3284
	UINT32                          reserved10[2];                   // 0x3288~0x328c
	M14B0_OVR_OV_BUF_SIZE_CTRL_T    ovr_ov_buf_size_ctrl;            // 0x3290
	UINT32                          reserved11[3];                   // 0x3294~0x329c
	M14B0_OVR_OV_BUF_RDY_CTRL_T     ovr_ov_buf_rdy_ctrl;             // 0x32a0
} DE_OVR_REG_M14B0_T;
