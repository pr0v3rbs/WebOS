...
do {																																\
	switch (lx_chip_rev()) {																										\
		...
		case LX_CHIP_REV(_chip, B0) :																								\
			REG_PHYS_VER_RdFL(g##_fn##_##_chip, b0, _r);																			\
			break;																													\
...
do {																																\
	switch (lx_chip_rev()) {																										\
		default :																													\
		case LX_CHIP_REV(_chip, B0) :																								\
			REG_PHYS_VER_WrFL(g##_fn##_##_chip, b0, _r);																			\
			break;																													\
		case LX_CHIP_REV(_chip, A1) :																								\
		case LX_CHIP_REV(_chip, A0) :																								\
...
do {																																\
	switch (lx_chip_rev()) {																										\
		default :																													\
		case LX_CHIP_REV(_chip, B0) :																								\
			REG_SHDW_VER_Wr32(g##_fn##_##_chip, b0, _r, _v);																		\
			break;																													\
		case LX_CHIP_REV(_chip, A1) :																								\
		case LX_CHIP_REV(_chip, A0) :																								\
...
do {																																\
	switch (lx_chip_rev()) {																										\
		default :																													\
		case LX_CHIP_REV(_chip, B0) :																								\
			REG_SHDW_VER_WfCM(g##_fn##_##_chip, b0, _r, _f, _c, _m);																\
			break;																													\
		case LX_CHIP_REV(_chip, A1) :																								\
		case LX_CHIP_REV(_chip, A0) :																								\
...
do {																																\
	switch (lx_chip_rev()) {																										\
		default :																													\
		case LX_CHIP_REV(_chip, B0) :																								\
			REG_SHDW_VER_WfCV(g##_fn##_##_chip, b0, _r, _f, _c, _v1, _v2);															\
			break;																													\
		case LX_CHIP_REV(_chip, A1) :																								\
		case LX_CHIP_REV(_chip, A0) :																								\
...
do {																																\
	switch (lx_chip_rev()) {																										\
		default :																													\
		case LX_CHIP_REV(_chip, B0) :																								\
			REG_SHDW_VER_Rd01(g##_fn##_##_chip, b0, _r, _f01, _v01);																\
			break;																													\
		case LX_CHIP_REV(_chip, A1) :																								\
		case LX_CHIP_REV(_chip, A0) :																								\
...
do {																																\
	switch (lx_chip_rev()) {																										\
		default :																													\
		case LX_CHIP_REV(_chip, B0) :																								\
			REG_SHDW_VER_Rd02(g##_fn##_##_chip, b0, _r, _f01, _v01, _f02, _v02);													\
			break;																													\
		case LX_CHIP_REV(_chip, A1) :																								\
		case LX_CHIP_REV(_chip, A0) :																								\
...
do {																																\
	switch (lx_chip_rev()) {																										\
		default :																													\
		case LX_CHIP_REV(_chip, B0) :																								\
			REG_SHDW_VER_Rd03(g##_fn##_##_chip, b0, _r, _f01, _v01, _f02, _v02, _f03, _v03);										\
			break;																													\
		case LX_CHIP_REV(_chip, A1) :																								\
		case LX_CHIP_REV(_chip, A0) :																								\
...
do {																																\
	switch (lx_chip_rev()) {																										\
		default :																													\
		case LX_CHIP_REV(_chip, B0) :																								\
			REG_SHDW_VER_Rd04(g##_fn##_##_chip, b0, _r, _f01, _v01, _f02, _v02, _f03, _v03, _f04, _v04);							\
			break;																													\
		case LX_CHIP_REV(_chip, A1) :																								\
		case LX_CHIP_REV(_chip, A0) :																								\
...
do {																																\
	switch (lx_chip_rev()) {																										\
		default :																													\
		case LX_CHIP_REV(_chip, B0) :																								\
			REG_SHDW_VER_Rd05(g##_fn##_##_chip, b0, _r, _f01, _v01, _f02, _v02, _f03, _v03, _f04, _v04,								\
					_f05, _v05);																									\
			break;																													\
		case LX_CHIP_REV(_chip, A1) :																								\
		case LX_CHIP_REV(_chip, A0) :																								\
...
do {																																\
	switch (lx_chip_rev()) {																										\
		default :																													\
		case LX_CHIP_REV(_chip, B0) :																								\
			REG_SHDW_VER_Rd06(g##_fn##_##_chip, b0, _r, _f01, _v01, _f02, _v02, _f03, _v03, _f04, _v04,								\
					_f05, _v05, _f06, _v06);																						\
			break;																													\
		case LX_CHIP_REV(_chip, A1) :																								\
		case LX_CHIP_REV(_chip, A0) :																								\
...
do {																																\
	switch (lx_chip_rev()) {																										\
		default :																													\
		case LX_CHIP_REV(_chip, B0) :																								\
			REG_SHDW_VER_Rd07(g##_fn##_##_chip, b0, _r, _f01, _v01, _f02, _v02, _f03, _v03, _f04, _v04,								\
					_f05, _v05, _f06, _v06, _f07, _v07);																			\
			break;																													\
		case LX_CHIP_REV(_chip, A1) :																								\
		case LX_CHIP_REV(_chip, A0) :																								\
...
do {																																\
	switch (lx_chip_rev()) {																										\
		default :																													\
		case LX_CHIP_REV(_chip, B0) :																								\
			REG_SHDW_VER_Rd08(g##_fn##_##_chip, b0, _r, _f01, _v01, _f02, _v02, _f03, _v03, _f04, _v04,								\
					_f05, _v05, _f06, _v06, _f07, _v07, _f08, _v08);																\
			break;																													\
		case LX_CHIP_REV(_chip, A1) :																								\
		case LX_CHIP_REV(_chip, A0) :																								\
...
do {																																\
	switch (lx_chip_rev()) {																										\
		default :																													\
		case LX_CHIP_REV(_chip, B0) :																								\
			REG_SHDW_VER_Rd09(g##_fn##_##_chip, b0, _r, _f01, _v01, _f02, _v02, _f03, _v03, _f04, _v04,								\
					_f05, _v05, _f06, _v06, _f07, _v07, _f08, _v08, _f09, _v09);													\
			break;																													\
		case LX_CHIP_REV(_chip, A1) :																								\
		case LX_CHIP_REV(_chip, A0) :																								\
...
do {																																\
	switch (lx_chip_rev()) {																										\
		default :																													\
		case LX_CHIP_REV(_chip, B0) :																								\
			REG_SHDW_VER_Rd10(g##_fn##_##_chip, b0, _r, _f01, _v01, _f02, _v02, _f03, _v03, _f04, _v04,								\
					_f05, _v05, _f06, _v06, _f07, _v07, _f08, _v08, _f09, _v09, _f10, _v10);										\
			break;																													\
		case LX_CHIP_REV(_chip, A1) :																								\
		case LX_CHIP_REV(_chip, A0) :																								\
...
do {																																\
	switch (lx_chip_rev()) {																										\
		default :																													\
		case LX_CHIP_REV(_chip, B0) :																								\
			REG_SHDW_VER_Rd11(g##_fn##_##_chip, b0, _r, _f01, _v01, _f02, _v02, _f03, _v03, _f04, _v04,								\
					_f05, _v05, _f06, _v06, _f07, _v07, _f08, _v08, _f09, _v09, _f10, _v10,											\
					_f11, _v11);																									\
			break;																													\
		case LX_CHIP_REV(_chip, A1) :																								\
...
do {																																\
	switch (lx_chip_rev()) {																										\
		default :																													\
		case LX_CHIP_REV(_chip, B0) :																								\
			REG_SHDW_VER_Rd12(g##_fn##_##_chip, b0, _r, _f01, _v01, _f02, _v02, _f03, _v03, _f04, _v04,								\
					_f05, _v05, _f06, _v06, _f07, _v07, _f08, _v08, _f09, _v09, _f10, _v10,											\
					_f11, _v11, _f12, _v12);																						\
			break;																													\
		case LX_CHIP_REV(_chip, A1) :																								\
...
do {																																\
	switch (lx_chip_rev()) {																										\
		default :																													\
		case LX_CHIP_REV(_chip, B0) :																								\
			REG_SHDW_VER_Rd13(g##_fn##_##_chip, b0, _r, _f01, _v01, _f02, _v02, _f03, _v03, _f04, _v04,								\
					_f05, _v05, _f06, _v06, _f07, _v07, _f08, _v08, _f09, _v09, _f10, _v10,											\
					_f11, _v11, _f12, _v12, _f13, _v13);																			\
			break;																													\
		case LX_CHIP_REV(_chip, A1) :																								\
...
do {																																\
	switch (lx_chip_rev()) {																										\
		default :																													\
		case LX_CHIP_REV(_chip, B0) :																								\
			REG_SHDW_VER_Rd14(g##_fn##_##_chip, b0, _r, _f01, _v01, _f02, _v02, _f03, _v03, _f04, _v04,								\
					_f05, _v05, _f06, _v06, _f07, _v07, _f08, _v08, _f09, _v09, _f10, _v10,											\
					_f11, _v11, _f12, _v12, _f13, _v13, _f14, _v14);																\
			break;																													\
		case LX_CHIP_REV(_chip, A1) :																								\
...
do {																																\
	switch (lx_chip_rev()) {																										\
		default :																													\
		case LX_CHIP_REV(_chip, B0) :																								\
			REG_SHDW_VER_Rd15(g##_fn##_##_chip, b0, _r, _f01, _v01, _f02, _v02, _f03, _v03, _f04, _v04,								\
					_f05, _v05, _f06, _v06, _f07, _v07, _f08, _v08, _f09, _v09, _f10, _v10,											\
					_f11, _v11, _f12, _v12, _f13, _v13, _f14, _v14, _f15, _v15);													\
			break;																													\
		case LX_CHIP_REV(_chip, A1) :																								\
...
do {																																\
	switch (lx_chip_rev()) {																										\
		default :																													\
		case LX_CHIP_REV(_chip, B0) :																								\
			REG_SHDW_VER_Rd16(g##_fn##_##_chip, b0, _r, _f01, _v01, _f02, _v02, _f03, _v03, _f04, _v04,								\
					_f05, _v05, _f06, _v06, _f07, _v07, _f08, _v08, _f09, _v09, _f10, _v10,											\
					_f11, _v11, _f12, _v12, _f13, _v13, _f14, _v14, _f15, _v15, _f16, _v16);										\
			break;																													\
		case LX_CHIP_REV(_chip, A1) :																								\
...
do {																																\
	switch (lx_chip_rev()) {																										\
		default :																													\
		case LX_CHIP_REV(_chip, B0) :																								\
			REG_SHDW_VER_Wr01(g##_fn##_##_chip, b0, _r, _f01, _v01);																\
			break;																													\
		case LX_CHIP_REV(_chip, A1) :																								\
		case LX_CHIP_REV(_chip, A0) :																								\
...
do {																																\
	switch (lx_chip_rev()) {																										\
		default :																													\
		case LX_CHIP_REV(_chip, B0) :																								\
			REG_SHDW_VER_Wr02(g##_fn##_##_chip, b0, _r, _f01, _v01, _f02, _v02);													\
			break;																													\
		case LX_CHIP_REV(_chip, A1) :																								\
		case LX_CHIP_REV(_chip, A0) :																								\
...
do {																																\
	switch (lx_chip_rev()) {																										\
		default :																													\
		case LX_CHIP_REV(_chip, B0) :																								\
			REG_SHDW_VER_Wr03(g##_fn##_##_chip, b0, _r, _f01, _v01, _f02, _v02, _f03, _v03);										\
			break;																													\
		case LX_CHIP_REV(_chip, A1) :																								\
		case LX_CHIP_REV(_chip, A0) :																								\
...
do {																																\
	switch (lx_chip_rev()) {																										\
		default :																													\
		case LX_CHIP_REV(_chip, B0) :																								\
			REG_SHDW_VER_Wr04(g##_fn##_##_chip, b0, _r, _f01, _v01, _f02, _v02, _f03, _v03, _f04, _v04);							\
			break;																													\
		case LX_CHIP_REV(_chip, A1) :																								\
		case LX_CHIP_REV(_chip, A0) :																								\
...
do {																																\
	switch (lx_chip_rev()) {																										\
		default :																													\
		case LX_CHIP_REV(_chip, B0) :																								\
			REG_SHDW_VER_Wr05(g##_fn##_##_chip, b0, _r, _f01, _v01, _f02, _v02, _f03, _v03, _f04, _v04,								\
					_f05, _v05);																									\
			break;																													\
		case LX_CHIP_REV(_chip, A1) :																								\
		case LX_CHIP_REV(_chip, A0) :																								\
...
do {																																\
	switch (lx_chip_rev()) {																										\
		default :																													\
		case LX_CHIP_REV(_chip, B0) :																								\
			REG_SHDW_VER_Wr06(g##_fn##_##_chip, b0, _r, _f01, _v01, _f02, _v02, _f03, _v03, _f04, _v04,								\
					_f05, _v05, _f06, _v06);																						\
			break;																													\
		case LX_CHIP_REV(_chip, A1) :																								\
		case LX_CHIP_REV(_chip, A0) :																								\
...
do {																																\
	switch (lx_chip_rev()) {																										\
		default :																													\
		case LX_CHIP_REV(_chip, B0) :																								\
			REG_SHDW_VER_Wr07(g##_fn##_##_chip, b0, _r, _f01, _v01, _f02, _v02, _f03, _v03, _f04, _v04,								\
					_f05, _v05, _f06, _v06, _f07, _v07);																			\
			break;																													\
		case LX_CHIP_REV(_chip, A1) :																								\
		case LX_CHIP_REV(_chip, A0) :																								\
...
do {																																\
	switch (lx_chip_rev()) {																										\
		default :																													\
		case LX_CHIP_REV(_chip, B0) :																								\
			REG_SHDW_VER_Wr08(g##_fn##_##_chip, b0, _r, _f01, _v01, _f02, _v02, _f03, _v03, _f04, _v04,								\
					_f05, _v05, _f06, _v06, _f07, _v07, _f08, _v08);																\
			break;																													\
		case LX_CHIP_REV(_chip, A1) :																								\
		case LX_CHIP_REV(_chip, A0) :																								\
...
do {																																\
	switch (lx_chip_rev()) {																										\
		default :																													\
		case LX_CHIP_REV(_chip, B0) :																								\
			REG_SHDW_VER_Wr09(g##_fn##_##_chip, b0, _r, _f01, _v01, _f02, _v02, _f03, _v03, _f04, _v04,								\
					_f05, _v05, _f06, _v06, _f07, _v07, _f08, _v08, _f09, _v09);													\
			break;																													\
		case LX_CHIP_REV(_chip, A1) :																								\
		case LX_CHIP_REV(_chip, A0) :																								\
...
do {																																\
	switch (lx_chip_rev()) {																										\
		default :																													\
		case LX_CHIP_REV(_chip, B0) :																								\
			REG_SHDW_VER_Wr10(g##_fn##_##_chip, b0, _r, _f01, _v01, _f02, _v02, _f03, _v03, _f04, _v04,								\
					_f05, _v05, _f06, _v06, _f07, _v07, _f08, _v08, _f09, _v09, _f10, _v10);										\
			break;																													\
		case LX_CHIP_REV(_chip, A1) :																								\
		case LX_CHIP_REV(_chip, A0) :																								\
...
do {																																\
	switch (lx_chip_rev()) {																										\
		default :																													\
		case LX_CHIP_REV(_chip, B0) :																								\
			REG_SHDW_VER_Wr11(g##_fn##_##_chip, b0, _r, _f01, _v01, _f02, _v02, _f03, _v03, _f04, _v04,								\
					_f05, _v05, _f06, _v06, _f07, _v07, _f08, _v08, _f09, _v09, _f10, _v10,											\
					_f11, _v11);																									\
			break;																													\
		case LX_CHIP_REV(_chip, A1) :																								\
...
do {																																\
	switch (lx_chip_rev()) {																										\
		default :																													\
		case LX_CHIP_REV(_chip, B0) :																								\
			REG_SHDW_VER_Wr12(g##_fn##_##_chip, b0, _r, _f01, _v01, _f02, _v02, _f03, _v03, _f04, _v04,								\
					_f05, _v05, _f06, _v06, _f07, _v07, _f08, _v08, _f09, _v09, _f10, _v10,											\
					_f11, _v11, _f12, _v12);																						\
			break;																													\
		case LX_CHIP_REV(_chip, A1) :																								\
...
do {																																\
	switch (lx_chip_rev()) {																										\
		default :																													\
		case LX_CHIP_REV(_chip, B0) :																								\
			REG_SHDW_VER_Wr13(g##_fn##_##_chip, b0, _r, _f01, _v01, _f02, _v02, _f03, _v03, _f04, _v04,								\
					_f05, _v05, _f06, _v06, _f07, _v07, _f08, _v08, _f09, _v09, _f10, _v10,											\
					_f11, _v11, _f12, _v12, _f13, _v13);																			\
			break;																													\
		case LX_CHIP_REV(_chip, A1) :																								\
...
do {																																\
	switch (lx_chip_rev()) {																										\
		default :																													\
		case LX_CHIP_REV(_chip, B0) :																								\
			REG_SHDW_VER_Wr14(g##_fn##_##_chip, b0, _r, _f01, _v01, _f02, _v02, _f03, _v03, _f04, _v04,								\
					_f05, _v05, _f06, _v06, _f07, _v07, _f08, _v08, _f09, _v09, _f10, _v10,											\
					_f11, _v11, _f12, _v12, _f13, _v13, _f14, _v14);																\
			break;																													\
		case LX_CHIP_REV(_chip, A1) :																								\
...
do {																																\
	switch (lx_chip_rev()) {																										\
		default :																													\
		case LX_CHIP_REV(_chip, B0) :																								\
			REG_SHDW_VER_Wr15(g##_fn##_##_chip, b0, _r, _f01, _v01, _f02, _v02, _f03, _v03, _f04, _v04,								\
					_f05, _v05, _f06, _v06, _f07, _v07, _f08, _v08, _f09, _v09, _f10, _v10,											\
					_f11, _v11, _f12, _v12, _f13, _v13, _f14, _v14, _f15, _v15);													\
			break;																													\
		case LX_CHIP_REV(_chip, A1) :																								\
...
do {																																\
	switch (lx_chip_rev()) {																										\
		default :																													\
		case LX_CHIP_REV(_chip, B0) :																								\
			REG_SHDW_VER_Wr16(g##_fn##_##_chip, b0, _r, _f01, _v01, _f02, _v02, _f03, _v03, _f04, _v04,								\
					_f05, _v05, _f06, _v06, _f07, _v07, _f08, _v08, _f09, _v09, _f10, _v10,											\
					_f11, _v11, _f12, _v12, _f13, _v13, _f14, _v14, _f15, _v15, _f16, _v16);										\
			break;																													\
		case LX_CHIP_REV(_chip, A1) :																								\
...
do {																																\
	switch (lx_chip_rev()) {																										\
		default :																													\
		case LX_CHIP_REV(_chip, B0) :																								\
			REG_PHYS_VER_FLRd(g##_fn##_##_chip, b0, _r, _v);																		\
			break;																													\
		case LX_CHIP_REV(_chip, A1) :																								\
		case LX_CHIP_REV(_chip, A0) :																								\
...
do {																																\
	switch (lx_chip_rev()) {																										\
		default :																													\
		case LX_CHIP_REV(_chip, B0) :																								\
			REG_PHYS_VER_FLWr(g##_fn##_##_chip, b0, _r, _v);																		\
			break;																													\
		case LX_CHIP_REV(_chip, A1) :																								\
		case LX_CHIP_REV(_chip, A0) :																								\
...
do {																																\
	switch (lx_chip_rev()) {																										\
		default :																													\
		case LX_CHIP_REV(_chip, B0) :																								\
			REG_PHYS_VER_FLRf(g##_fn##_##_chip, b0, _r, _f01, _v01);																\
			break;																													\
		case LX_CHIP_REV(_chip, A1) :																								\
		case LX_CHIP_REV(_chip, A0) :																								\
...
do {																																\
	switch (lx_chip_rev()) {																										\
		default :																													\
		case LX_CHIP_REV(_chip, B0) :																								\
			REG_PHYS_VER_FLWf(g##_fn##_##_chip, b0, _r, _f01, _v01);																\
			break;																													\
		case LX_CHIP_REV(_chip, A1) :																								\
		case LX_CHIP_REV(_chip, A0) :																								\
...
do {																																\
	switch (lx_chip_rev()) {																										\
		default :																													\
		case LX_CHIP_REV(_chip, B0) :																								\
			REG_PHYS_VER_FLCM(g##_fn##_##_chip, b0, _r, _f, _c, _m);																\
			break;																													\
		case LX_CHIP_REV(_chip, A1) :																								\
		case LX_CHIP_REV(_chip, A0) :																								\
...
do {																																\
	switch (lx_chip_rev()) {																										\
		default :																													\
		case LX_CHIP_REV(_chip, B0) :																								\
			REG_PHYS_VER_FLCV(g##_fn##_##_chip, b0, _r, _f, _c, _v1, _v2);															\
			break;																													\
		case LX_CHIP_REV(_chip, A1) :																								\
		case LX_CHIP_REV(_chip, A0) :																								\
