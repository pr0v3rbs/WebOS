...
#ifndef _REG_CTR_M14A0_h
#define _REG_CTR_M14A0_h
...
} M14A0_DEA_MSRC_SYNC_MUX_CTRL_T;
...
} M14A0_DEA_VDEC_VSYNC_SRC_SEL_T;
...
} M14A0_DEA_SMUX_HSC_Y_SET_VAL_0_T;
...
} M14A0_DEA_SMUX_HSC_Y_SET_VAL_1_T;
...
} M14A0_DEA_SMUX_HSC_Y_SET_VAL_2_T;
...
} M14A0_DEA_SMUX_HSC_C_SET_VAL_0_T;
...
} M14A0_DEA_SMUX_HSC_C_SET_VAL_1_T;
...
} M14A0_DEA_SMUX_HSC_C_SET_VAL_2_T;
...
} M14A0_DEA_PIC_START_DELAY_CTRL_T;
...
} M14A0_DEA_PIC_START_G0_TIMER_T;
...
} M14A0_DEA_PIC_START_G1_TIMER_T;
...
} M14A0_DEB_DISP_INTR_TIME_STP_T;
...
} M14A0_DEB_OV_PIC_START_DLY_EN_T;
...
} M14A0_DEB_PIC_INIT_G1_TIMER_C_T;
...
} M14A0_DEC_MSRC_SYNC_MUX_CTRL_T;
...
} M14A0_DEC_SSRC_SYNC_MUX_CTRL_T;
...
} M14A0_DEC_MSRC_INTR_TIME_STP_T;
...
} M14A0_DEC_SSRC_INTR_TIME_STP_T;
...
typedef struct {
	...
	UINT32                                 : 14;  //  2:15 reserved
	UINT32 vdec_vsync_ready_off            : 1;   //    16
} M14A0_DEC_VDEC_VSYNC_SRC_SEL_T;
...
typedef struct {
	...
	UINT32                                 : 6;   //  6:11 reserved
	UINT32 aal_coef_0_y                    : 10;  // 12:21
} M14A0_DEC_SMUX_HSC_Y_SET_VAL_0_T;
...
typedef struct {
	...
	UINT32                                 : 2;   // 10:11 reserved
	UINT32 aal_coef_2_y                    : 10;  // 12:21
} M14A0_DEC_SMUX_HSC_Y_SET_VAL_1_T;
...
typedef struct {
	...
	UINT32                                 : 2;   // 10:11 reserved
	UINT32 aal_coef_4_y                    : 10;  // 12:21
} M14A0_DEC_SMUX_HSC_Y_SET_VAL_2_T;
...
typedef struct {
	...
	UINT32                                 : 6;   //  6:11 reserved
	UINT32 aal_coef_0_c                    : 10;  // 12:21
} M14A0_DEC_SMUX_HSC_C_SET_VAL_0_T;
...
typedef struct {
	...
	UINT32                                 : 2;   // 10:11 reserved
	UINT32 aal_coef_2_c                    : 10;  // 12:21
} M14A0_DEC_SMUX_HSC_C_SET_VAL_1_T;
...
typedef struct {
	...
	UINT32                                 : 2;   // 10:11 reserved
	UINT32 aal_coef_4_c                    : 10;  // 12:21
} M14A0_DEC_SMUX_HSC_C_SET_VAL_2_T;
...
} M14A0_DEC_PIC_START_DELAY_CTRL_T;
...
typedef struct {
	UINT32 pic_start_g0_timer              : 28;  //  0:27
} M14A0_DEC_PIC_START_G0_TIMER_T;
...
typedef struct {
	UINT32 pic_start_g1_timer              : 28;  //  0:27
} M14A0_DEC_PIC_START_G1_TIMER_T;
...
} M14A0_DEC_PIC_START_G2_TIMER_T;
...
typedef struct {
	...
	UINT32 pic_end_g1_c_force_en           : 1;   //    16
	UINT32 pic_end_g1_c_force_value        : 1;   //    17
} M14A0_DED_OV_PIC_START_DLY_EN_T;
...
typedef struct {
	UINT32 pic_init_g1_timer_c             : 28;  //  0:27
} M14A0_DED_PIC_INIT_G1_TIMER_C_T;
...
} M14A0_DEE_HDMI_BRIDGE_CTRL10_T;
...
typedef struct {
	UINT32 reserved                                : 32;  //  0:31 
} M14A0_DEE_HDMI_BRIDGE_CTRL11_T;
...
} M14A0_DEE_HDMI_BRIDGE_CTRL12_T;
...
typedef struct {
	UINT32 reserved                                : 32;  // 16:28
} M14A0_DEE_HDMI_BRIDGE_CTRL13_T;

/*-----------------------------------------------------------------------------
	0x4090 dee_vbi_cgms_ctrl0 ''
------------------------------------------------------------------------------*/
typedef struct {
...
} M14A0_DEE_VBI_CGMS_CTRL0_T;

/*-----------------------------------------------------------------------------
	0x4094 dee_vbi_cgms_ctrl1 ''
------------------------------------------------------------------------------*/
typedef struct {
...
} M14A0_DEE_VBI_CGMS_CTRL1_T;

/*-----------------------------------------------------------------------------
	0x4098 dee_vbi_cgms_data0 ''
------------------------------------------------------------------------------*/
typedef struct {
	UINT32 cgms_even_data                          : 32;  //  0:31
} M14A0_DEE_VBI_CGMS_DATA0_T;

/*-----------------------------------------------------------------------------
	0x409c dee_vbi_cgms_data1 ''
------------------------------------------------------------------------------*/
typedef struct {
	UINT32 cgms_odd_data                           : 32;  //  0:31
} M14A0_DEE_VBI_CGMS_DATA1_T;

/*-----------------------------------------------------------------------------
	0x40a0 dee_vbi_wss_ctrl0 ''
------------------------------------------------------------------------------*/
typedef struct {
...
} M14A0_DEE_VBI_WSS_CTRL0_T;

/*-----------------------------------------------------------------------------
	0x40a4 dee_vbi_wss_ctrl1 ''
------------------------------------------------------------------------------*/
typedef struct {
...
} M14A0_DEE_VBI_WSS_CTRL1_T;

/*-----------------------------------------------------------------------------
	0x40a8 dee_vbi_wss_ctrl2 ''
------------------------------------------------------------------------------*/
typedef struct {
	UINT32 runin_data                              : 12;  //  0:11
	UINT32 wss_st_detect_offset                    : 4;   // 12:15
	UINT32 wss_st_data_bit_width                   : 7;   // 16:22
} M14A0_DEE_VBI_WSS_CTRL2_T;

/*-----------------------------------------------------------------------------
	0x40ac dee_vbi_wss_data0 ''
------------------------------------------------------------------------------*/
typedef struct {
	UINT32 wss_data                                : 32;  //  0:31
} M14A0_DEE_VBI_WSS_DATA0_T;

/*-----------------------------------------------------------------------------
	0x40b0 dee_vbi_wss_data1 ''
------------------------------------------------------------------------------*/
typedef struct {
	UINT32 wss_bi_phase_data                       : 16;  //  0:15
} M14A0_DEE_VBI_WSS_DATA1_T;
...
typedef struct {
	UINT32 pic_init_g2_timer               : 28;  //  0:27
} M14A0_DPPA_PIC_INIT_G2_TIMER_T;
...
typedef struct {
	...
	UINT32                                 : 3;   //  9:11 reserved
	UINT32 gmau_flush_wr_done              : 1;   //    12
} M14A0_DPPA_GMAU_FLUSH_T;

typedef struct {
	M14A0_DEA_CHA_INFO_T                dea_cha_info;                        // 0x0000
	M14A0_DEA_CHB_INFO_T                dea_chb_info;                        // 0x0004
	M14A0_DEA_PIC_INIT_T                dea_pic_init;                        // 0x0008
	M14A0_DEA_PIC_START_T               dea_pic_start;                       // 0x000c
	M14A0_DEA_SMUX_CTRL_T               dea_smux_ctrl;                       // 0x0010
	M14A0_DEA_SMUX_SIZE_T               dea_smux_size;                       // 0x0014
	M14A0_DEA_MVI_V_INFO_T              dea_mvi_v_info;                      // 0x0018
	M14A0_DEA_MVI_H_INFO_T              dea_mvi_h_info;                      // 0x001c
	M14A0_DEA_MVI_CTRL_T                dea_mvi_ctrl;                        // 0x0020
	M14A0_DEA_MSRC_SYNC_MUX_CTRL_T      dea_msrc_sync_mux_ctrl;              // 0x0024
	M14A0_DEA_MSRC_SYNC_DLY_T           dea_msrc_sync_dly;                   // 0x0028
	M14A0_DEA_MEM_SYNC_PERIOD_T         dea_mem_sync_period;                 // 0x002c
	M14A0_DEA_DCO_MFC_T                 dea_dco_mfc;                         // 0x0030
	M14A0_DEA_DCO_DFC_T                 dea_dco_dfc;                         // 0x0034
	M14A0_DEA_DCO_DFLC_T                dea_dco_dflc;                        // 0x0038
	M14A0_DEA_DCO_FCW_T                 dea_dco_fcw;                         // 0x003c
	M14A0_DEA_SMUX_RO_LCNT_T            dea_smux_ro_lcnt;                    // 0x0040
	M14A0_DEA_GMAU_CTRL_T               dea_gmau_ctrl;                       // 0x0044
	M14A0_DEA_PIC_END_EN_T              dea_pic_end_en;                      // 0x0048
	M14A0_DEA_PIC_INIT_G0_TIMER_T       dea_pic_init_g0_timer;               // 0x004c
	M14A0_DEA_PIC_INIT_G1_TIMER_T       dea_pic_init_g1_timer;               // 0x0050
	M14A0_DEA_PIC_END_INFO_T            dea_pic_end_info;                    // 0x0054
	M14A0_DEA_INTR_REG_T                dea_intr_reg;                        // 0x0058
	M14A0_DEA_INTR_MASK_T               dea_intr_mask;                       // 0x005c
	M14A0_DEA_INTR_MUX_T                dea_intr_mux;                        // 0x0060
	M14A0_DEA_SRC_INTR_TIME_STP_T       dea_src_intr_time_stp;               // 0x0064
	M14A0_DE_GPIO_MUX_T                 de_gpio_mux;                         // 0x0068
	M14A0_MSRC_RO_VBLK_CNT_T            msrc_ro_vblk_cnt;                    // 0x006c
	UINT32                              reserved0[3];                        // 0x0070~0x0078
	M14A0_DE_VERSION_T                  de_version;                          // 0x007c
	UINT32                              reserved1[5];                        // 0x0080~0x0090
	M14A0_DEA_VDEC_VSYNC_SRC_SEL_T      dea_vdec_vsync_src_sel;              // 0x0094
	UINT32                              reserved2[2];                        // 0x0098~0x009c
	M14A0_DEA_SMUX_SIZE_I_T             dea_smux_size_i;                     // 0x00a0
	M14A0_DEA_SMUX_HSC_Y_SET_VAL_0_T    dea_smux_hsc_y_set_val_0;            // 0x00a4
	M14A0_DEA_SMUX_HSC_Y_SET_VAL_1_T    dea_smux_hsc_y_set_val_1;            // 0x00a8
	M14A0_DEA_SMUX_HSC_Y_SET_VAL_2_T    dea_smux_hsc_y_set_val_2;            // 0x00ac
	M14A0_DEA_SMUX_HSC_C_SET_VAL_0_T    dea_smux_hsc_c_set_val_0;            // 0x00b0
	M14A0_DEA_SMUX_HSC_C_SET_VAL_1_T    dea_smux_hsc_c_set_val_1;            // 0x00b4
	M14A0_DEA_SMUX_HSC_C_SET_VAL_2_T    dea_smux_hsc_c_set_val_2;            // 0x00b8
	UINT32                              reserved3;                           // 0x00bc
	M14A0_DEA_MVI_CTRL_0_T              dea_mvi_ctrl_0;                      // 0x00c0
	M14A0_DEA_MVI_CTRL_1_T              dea_mvi_ctrl_1;                      // 0x00c4
	M14A0_DEA_MVI_CTRL_2_T              dea_mvi_ctrl_2;                      // 0x00c8
	M14A0_DEA_MVI_CTRL_3_T              dea_mvi_ctrl_3;                      // 0x00cc
	M14A0_DEA_MVI_CTRL_4_T              dea_mvi_ctrl_4;                      // 0x00d0
	M14A0_DEA_MVI_CTRL_5_T              dea_mvi_ctrl_5;                      // 0x00d4
	M14A0_DEA_MVI_CTRL_6_T              dea_mvi_ctrl_6;                      // 0x00d8
	UINT32                              reserved4;                           // 0x00dc
	M14A0_DEA_PIC_START_DELAY_CTRL_T    dea_pic_start_delay_ctrl;            // 0x00e0
	M14A0_DEA_PIC_START_G0_TIMER_T      dea_pic_start_g0_timer;              // 0x00e4
	M14A0_DEA_PIC_START_G1_TIMER_T      dea_pic_start_g1_timer;              // 0x00e8
	UINT32                              reserved5;                           // 0x00ec
	M14A0_DEA_RO_GAP_IRQ_INIT_T         dea_ro_gap_irq_init;                 // 0x00f0
	M14A0_DEA_PIC_END_FORCE_T           dea_pic_end_force;                   // 0x00f4
	M14A0_DEA_CTRL_GAP_IRQ_INIT_T       dea_ctrl_gap_irq_init;               // 0x00f8
	M14A0_DEA_GMAU_FLUSH_T              dea_gmau_flush;                      // 0x00fc
} DE_DEA_REG_M14A0_T;

typedef struct {
	M14A0_DEB_PIC_INIT_T                deb_pic_init;                        // 0x1000
	M14A0_DEB_PIC_START_T               deb_pic_start;                       // 0x1004
	M14A0_DEB_DISP_V_PORCH_T            deb_disp_v_porch;                    // 0x1008
	M14A0_DEB_DISP_VS_VA_T              deb_disp_vs_va;                      // 0x100c
	M14A0_DEB_DISP_H_PORCH_T            deb_disp_h_porch;                    // 0x1010
	M14A0_DEB_DISP_HS_HA_T              deb_disp_hs_ha;                      // 0x1014
	M14A0_DEB_DISP_SYNC_DLY_T           deb_disp_sync_dly;                   // 0x1018
	M14A0_DEB_DISP_PULSE_DLY_T          deb_disp_pulse_dly;                  // 0x101c
	M14A0_DEB_DISP_SYNC_PARAMS_T        deb_disp_sync_params;                // 0x1020
	UINT32                              reserved6;                           // 0x1024
	M14A0_DEBD_MSDF_CTRL_0_T            debd_msdf_ctrl_0;                    // 0x1028
	UINT32                              reserved7[16];                       // 0x102c~0x1068
	M14A0_DEB_GMAU_CTRL_T               deb_gmau_ctrl;                       // 0x106c
	M14A0_DEB_PIC_END_EN_T              deb_pic_end_en;                      // 0x1070
	M14A0_DEB_PIC_INIT_G0_TIMER_T       deb_pic_init_g0_timer;               // 0x1074
	M14A0_DEB_PIC_INIT_G1_TIMER_T       deb_pic_init_g1_timer;               // 0x1078
	M14A0_DEB_PIC_END_INFO_T            deb_pic_end_info;                    // 0x107c
	M14A0_DEB_INTR_REG_T                deb_intr_reg;                        // 0x1080
	M14A0_DEB_INTR_MASK_T               deb_intr_mask;                       // 0x1084
	M14A0_DEB_INTR_MUX_T                deb_intr_mux;                        // 0x1088
	M14A0_DEB_DISP_INTR_TIME_STP_T      deb_disp_intr_time_stp;              // 0x108c
	UINT32                              reserved8[16];                       // 0x1090~0x10cc
	M14A0_DEB_OV_PIC_START_DLY_EN_T     deb_ov_pic_start_dly_en;             // 0x10d0
	M14A0_DEB_PIC_INIT_G1_TIMER_C_T     deb_pic_init_g1_timer_c;             // 0x10d4
	UINT32                              reserved9[9];                        // 0x10d8~0x10f8
	M14A0_DEB_GMAU_FLUSH_T              deb_gmau_flush;                      // 0x10fc
} DE_DEB_REG_M14A0_T;

typedef struct {
	M14A0_DEC_PIC_INIT_T                dec_pic_init;                        // 0x2000
	M14A0_DEC_PIC_START_T               dec_pic_start;                       // 0x2004
	M14A0_DEC_SMUX_CTRL_T               dec_smux_ctrl;                       // 0x2008
	M14A0_DEC_SMUX_SIZE_T               dec_smux_size;                       // 0x200c
	M14A0_DEC_MVI_V_INFO_T              dec_mvi_v_info;                      // 0x2010
	M14A0_DEC_MVI_H_INFO_T              dec_mvi_h_info;                      // 0x2014
	M14A0_DEC_MVI_CTRL_T                dec_mvi_ctrl;                        // 0x2018
	M14A0_DEC_MSRC_SYNC_MUX_CTRL_T      dec_msrc_sync_mux_ctrl;              // 0x201c
	M14A0_DEC_MSRC_SYNC_DLY_T           dec_msrc_sync_dly;                   // 0x2020
	M14A0_DEC_MEM0_SYNC_PERIOD_T        dec_mem0_sync_period;                // 0x2024
	M14A0_DEC_MEM1_SYNC_PERIOD_T        dec_mem1_sync_period;                // 0x2028
	M14A0_DEC_SSMUX_CTRL_T              dec_ssmux_ctrl;                      // 0x202c
	M14A0_DEC_SSRC_SYNC_MUX_CTRL_T      dec_ssrc_sync_mux_ctrl;              // 0x2030
	M14A0_DEC_SSRC_SYNC_DLY_T           dec_ssrc_sync_dly;                   // 0x2034
	M14A0_DEC_MSRC_RO_VBLK_CNT_T        dec_msrc_ro_vblk_cnt;                // 0x2038
	M14A0_DEC_SSRC_RO_VBLK_CNT_T        dec_ssrc_ro_vblk_cnt;                // 0x203c
	UINT32                              reserved10[7];                       // 0x2040~0x2058
	M14A0_DEC_SMUX_RO_LCNT_T            dec_smux_ro_lcnt;                    // 0x205c
	M14A0_DEC_GMAU_CTRL_T               dec_gmau_ctrl;                       // 0x2060
	M14A0_DEC_PIC_END_EN_T              dec_pic_end_en;                      // 0x2064
	M14A0_DEC_PIC_INIT_G0_TIMER_T       dec_pic_init_g0_timer;               // 0x2068
	M14A0_DEC_PIC_INIT_G1_TIMER_T       dec_pic_init_g1_timer;               // 0x206c
	M14A0_DEC_PIC_INIT_G2_TIMER_T       dec_pic_init_g2_timer;               // 0x2070
	M14A0_DEC_PIC_END_INFO_T            dec_pic_end_info;                    // 0x2074
	M14A0_DEC_INTR_REG_T                dec_intr_reg;                        // 0x2078
	M14A0_DEC_INTR_MASK_T               dec_intr_mask;                       // 0x207c
	M14A0_DEC_INTR_MUX_T                dec_intr_mux;                        // 0x2080
	M14A0_DEC_MSRC_INTR_TIME_STP_T      dec_msrc_intr_time_stp;              // 0x2084
	M14A0_DEC_SSRC_INTR_TIME_STP_T      dec_ssrc_intr_time_stp;              // 0x2088
	M14A0_DEC_MVI_READY_CTRL_T          dec_mvi_ready_ctrl;                  // 0x208c
	M14A0_DEC_MVI_PATH_SEL_T            dec_mvi_path_sel;                    // 0x2090
	M14A0_DEC_VDEC_VSYNC_SRC_SEL_T      dec_vdec_vsync_src_sel;              // 0x2094
	UINT32                              reserved11[2];                       // 0x2098~0x209c
	M14A0_DEC_SMUX_SIZE_I_T             dec_smux_size_i;                     // 0x20a0
	M14A0_DEC_SMUX_HSC_Y_SET_VAL_0_T    dec_smux_hsc_y_set_val_0;            // 0x20a4
	M14A0_DEC_SMUX_HSC_Y_SET_VAL_1_T    dec_smux_hsc_y_set_val_1;            // 0x20a8
	M14A0_DEC_SMUX_HSC_Y_SET_VAL_2_T    dec_smux_hsc_y_set_val_2;            // 0x20ac
	M14A0_DEC_SMUX_HSC_C_SET_VAL_0_T    dec_smux_hsc_c_set_val_0;            // 0x20b0
	M14A0_DEC_SMUX_HSC_C_SET_VAL_1_T    dec_smux_hsc_c_set_val_1;            // 0x20b4
	M14A0_DEC_SMUX_HSC_C_SET_VAL_2_T    dec_smux_hsc_c_set_val_2;            // 0x20b8
	UINT32                              reserved12;                          // 0x20bc
	M14A0_DEC_MVI_CTRL_0_T              dec_mvi_ctrl_0;                      // 0x20c0
	M14A0_DEC_MVI_CTRL_1_T              dec_mvi_ctrl_1;                      // 0x20c4
	M14A0_DEC_MVI_CTRL_2_T              dec_mvi_ctrl_2;                      // 0x20c8
	M14A0_DEC_MVI_CTRL_3_T              dec_mvi_ctrl_3;                      // 0x20cc
	M14A0_DEC_MVI_CTRL_4_T              dec_mvi_ctrl_4;                      // 0x20d0
	M14A0_DEC_MVI_CTRL_5_T              dec_mvi_ctrl_5;                      // 0x20d4
	M14A0_DEC_MVI_CTRL_6_T              dec_mvi_ctrl_6;                      // 0x20d8
	UINT32                              reserved13;                          // 0x20dc
	M14A0_DEC_PIC_START_DELAY_CTRL_T    dec_pic_start_delay_ctrl;            // 0x20e0
	M14A0_DEC_PIC_START_G0_TIMER_T      dec_pic_start_g0_timer;              // 0x20e4
	M14A0_DEC_PIC_START_G1_TIMER_T      dec_pic_start_g1_timer;              // 0x20e8
	M14A0_DEC_PIC_START_G2_TIMER_T      dec_pic_start_g2_timer;              // 0x20ec
	M14A0_DEC_RO_GAP_IRQ_INIT_T         dec_ro_gap_irq_init;                 // 0x20f0
	M14A0_DEC_PIC_END_FORCE_T           dec_pic_end_force;                   // 0x20f4
	M14A0_DEC_CTRL_GAP_IRQ_INIT_T       dec_ctrl_gap_irq_init;               // 0x20f8
	M14A0_DEC_GMAU_FLUSH_T              dec_gmau_flush;                      // 0x20fc
} DE_DEC_REG_M14A0_T;

typedef struct {
	M14A0_DED_PIC_INIT_T                ded_pic_init;                        // 0x3000
	M14A0_DED_PIC_START_T               ded_pic_start;                       // 0x3004
	M14A0_DED_DE_VENC_IF_T              ded_de_venc_if;                      // 0x3008
	UINT32                              reserved14;                          // 0x300c
	M14A0_DED_CVE_PARAM0_T              ded_cve_param0;                      // 0x3010
	M14A0_DED_CVE_PARAM1_T              ded_cve_param1;                      // 0x3014
	M14A0_DED_CVE_PARAM2_T              ded_cve_param2;                      // 0x3018
	M14A0_DED_CVE_PARAM3_T              ded_cve_param3;                      // 0x301c
	M14A0_DED_CVE_PULSE_DLY_T           ded_cve_pulse_dly;                   // 0x3020
	M14A0_DED_GMAU_CTRL_T               ded_gmau_ctrl;                       // 0x3024
	M14A0_DED_PIC_END_EN_T              ded_pic_end_en;                      // 0x3028
	M14A0_DED_PIC_INIT_G0_TIMER_T       ded_pic_init_g0_timer;               // 0x302c
	M14A0_DED_PIC_INIT_G1_TIMER_T       ded_pic_init_g1_timer;               // 0x3030
	UINT32                              reserved15;                          // 0x3034
	M14A0_DED_PIC_INIT_G3_TIMER_T       ded_pic_init_g3_timer;               // 0x3038
	M14A0_DED_PIC_END_INFO_T            ded_pic_end_info;                    // 0x303c
	M14A0_DED_INTR_REG_T                ded_intr_reg;                        // 0x3040
	M14A0_DED_INTR_MASK_T               ded_intr_mask;                       // 0x3044
	M14A0_DED_INTR_MUX_T                ded_intr_mux;                        // 0x3048
	M14A0_DEF_CVE_INTR_TIME_STP_T       def_cve_intr_time_stp;               // 0x304c
	UINT32                              reserved16[32];                      // 0x3050~0x30cc
	M14A0_DED_OV_PIC_START_DLY_EN_T     ded_ov_pic_start_dly_en;             // 0x30d0
	M14A0_DED_PIC_INIT_G1_TIMER_C_T     ded_pic_init_g1_timer_c;             // 0x30d4
	UINT32                              reserved17[9];                       // 0x30d8~0x30f8
	M14A0_DED_GMAU_FLUSH_T              ded_gmau_flush;                      // 0x30fc
} DE_DED_REG_M14A0_T;

typedef struct {
	M14A0_DEC_DE_INTR_FLAG_MCU_T        dec_de_intr_flag_mcu;                // 0x4000
	M14A0_DEC_DE_INTR_FLAG_CPU_T        dec_de_intr_flag_cpu;                // 0x4004
	M14A0_DEE_CVI_MUX_SEL_T             dee_cvi_mux_sel;                     // 0x4008
	M14A0_DEE_PE0_HIF_OFFSET_T          dee_pe0_hif_offset;                  // 0x400c
	M14A0_DEE_SM_HIF_OFFSET_T           dee_sm_hif_offset;                   // 0x4010
	M14A0_DEE_PE1_HIF_OFFSET_T          dee_pe1_hif_offset;                  // 0x4014
	UINT32                              reserved18[6];                       // 0x4018~0x402c
	M14A0_DEE_MCU_ADDR_WINDOW_T         dee_mcu_addr_window;                 // 0x4030
	M14A0_DEE_INTR_REG_T                dee_intr_reg;                        // 0x4034
	M14A0_DEE_INTR_MASK_T               dee_intr_mask;                       // 0x4038
	UINT32                              reserved19[5];                       // 0x403c~0x404c
	M14A0_DEE_HDMI_BRIDGE_CTRL0_T       dee_hdmi_bridge_ctrl0;               // 0x4050
	M14A0_DEE_HDMI_BRIDGE_CTRL1_T       dee_hdmi_bridge_ctrl1;               // 0x4054
	M14A0_DEE_HDMI_BRIDGE_CTRL2_T       dee_hdmi_bridge_ctrl2;               // 0x4058
	M14A0_DEE_HDMI_BRIDGE_CTRL3_T       dee_hdmi_bridge_ctrl3;               // 0x405c
	M14A0_DEE_HDMI_BRIDGE_CTRL4_T       dee_hdmi_bridge_ctrl4;               // 0x4060
	M14A0_DEE_HDMI_BRIDGE_CTRL5_T       dee_hdmi_bridge_ctrl5;               // 0x4064
	M14A0_DEE_HDMI_BRIDGE_CTRL6_T       dee_hdmi_bridge_ctrl6;               // 0x4068
	M14A0_DEE_HDMI_BRIDGE_CTRL7_T       dee_hdmi_bridge_ctrl7;               // 0x406c
	M14A0_DEE_HDMI_BRIDGE_CTRL8_T       dee_hdmi_bridge_ctrl8;               // 0x4070
	M14A0_DEE_HDMI_BRIDGE_CTRL9_T       dee_hdmi_bridge_ctrl9;               // 0x4074
	M14A0_DEE_HDMI_BRIDGE_CTRL10_T      dee_hdmi_bridge_ctrl10;              // 0x4078
	M14A0_DEE_HDMI_BRIDGE_CTRL11_T      dee_hdmi_bridge_ctrl11;              // 0x407c
	M14A0_DEE_HDMI_BRIDGE_CTRL12_T      dee_hdmi_bridge_ctrl12;              // 0x4080
	M14A0_DEE_HDMI_BRIDGE_CTRL13_T      dee_hdmi_bridge_ctrl13;              // 0x4084
	UINT32                              reserved20[2];                       // 0x4088~0x408c
	M14A0_DEE_VBI_CGMS_CTRL0_T          dee_vbi_cgms_ctrl0;                  // 0x4090
	M14A0_DEE_VBI_CGMS_CTRL1_T          dee_vbi_cgms_ctrl1;                  // 0x4094
	M14A0_DEE_VBI_CGMS_DATA0_T          dee_vbi_cgms_data0;                  // 0x4098
	M14A0_DEE_VBI_CGMS_DATA1_T          dee_vbi_cgms_data1;                  // 0x409c
	M14A0_DEE_VBI_WSS_CTRL0_T           dee_vbi_wss_ctrl0;                   // 0x40a0
	M14A0_DEE_VBI_WSS_CTRL1_T           dee_vbi_wss_ctrl1;                   // 0x40a4
	M14A0_DEE_VBI_WSS_CTRL2_T           dee_vbi_wss_ctrl2;                   // 0x40a8
	M14A0_DEE_VBI_WSS_DATA0_T           dee_vbi_wss_data0;                   // 0x40ac
	M14A0_DEE_VBI_WSS_DATA1_T           dee_vbi_wss_data1;                   // 0x40b0
	UINT32                              reserved200[17];                     // 0x40b4~0x40f4
	M14A0_DEE_FPGA_CTRL_T               dee_fpga_ctrl;                       // 0x40f8
	M14A0_DEE_GMAU_FLUSH_T              dee_gmau_flush;                      // 0x40fc
} DE_DEE_REG_M14A0_T;

typedef struct {
	M14A0_DPPA_PIC_INIT_T               dppa_pic_init;                       // 0x5000
	M14A0_DPPA_PIC_START_T              dppa_pic_start;                      // 0x5004
	UINT32                              reserved25;                          // 0x5008
	M14A0_DPPA_DPATH_CTRL_T             dppa_dpath_ctrl;                     // 0x500c
	M14A0_DPPA_SYNC_CTRL_T              dppa_sync_ctrl;                      // 0x5010
	UINT32                              reserved26[4];                       // 0x5014~0x5020
	M14A0_DPPA_GMAU_CTRL_T              dppa_gmau_ctrl;                      // 0x5024
	M14A0_DPPA_PIC_END_EN_T             dppa_pic_end_en;                     // 0x5028
	UINT32                              reserved27[2];                       // 0x502c~0x5030
	M14A0_DPPA_PIC_INIT_G2_TIMER_T      dppa_pic_init_g2_timer;              // 0x5034
	UINT32                              reserved28;                          // 0x5038
	M14A0_DPPA_PIC_END_INFO_T           dppa_pic_end_info;                   // 0x503c
	M14A0_DPPA_INTR_REG_T               dppa_intr_reg;                       // 0x5040
	M14A0_DPPA_INTR_MASK_T              dppa_intr_mask;                      // 0x5044
	M14A0_DPPA_INTR_MUX_T               dppa_intr_mux;                       // 0x5048
	UINT32                              reserved29[5];                       // 0x504c~0x505c
	M14A0_DPPA_MOF_CTRL0_T              dppa_mof_ctrl0;                      // 0x5060
	M14A0_DPPA_MOF_CTRL1_T              dppa_mof_ctrl1;                      // 0x5064
	M14A0_DPPA_MOF_CTRL2_T              dppa_mof_ctrl2;                      // 0x5068
	M14A0_DPPA_MOF_CTRL3_T              dppa_mof_ctrl3;                      // 0x506c
	M14A0_DPPA_MOF_CTRL4_T              dppa_mof_ctrl4;                      // 0x5070
	M14A0_DPPA_MOF_CTRL5_T              dppa_mof_ctrl5;                      // 0x5074
	M14A0_DPPA_MOF_CTRL6_T              dppa_mof_ctrl6;                      // 0x5078
	M14A0_DPPA_MOF_CTRL7_T              dppa_mof_ctrl7;                      // 0x507c
	M14A0_DPPA_MOF_CTRL8_T              dppa_mof_ctrl8;                      // 0x5080
	UINT32                              reserved30[3];                       // 0x5084~0x508c
	M14A0_DISP_SYNC_DLY_CTRL0_T         disp_sync_dly_ctrl0;                 // 0x5090
	M14A0_DISP_SYNC_DLY_CTRL1_T         disp_sync_dly_ctrl1;                 // 0x5094
	M14A0_DISP_SYNC_DLY_CTRL2_T         disp_sync_dly_ctrl2;                 // 0x5098
	M14A0_DISP_SYNC_DLY_CTRL3_T         disp_sync_dly_ctrl3;                 // 0x509c
	M14A0_DISP_SYNC_DLY_CTRL4_T         disp_sync_dly_ctrl4;                 // 0x50a0
	M14A0_DISP_SYNC_DLY_CTRL5_T         disp_sync_dly_ctrl5;                 // 0x50a4
	M14A0_DISP_PREV_DLY_CTRL0_T         disp_prev_dly_ctrl0;                 // 0x50a8
	M14A0_DISP_PREV_DLY_CTRL1_T         disp_prev_dly_ctrl1;                 // 0x50ac
	M14A0_DISP_PREV_DLY_CTRL2_T         disp_prev_dly_ctrl2;                 // 0x50b0
	M14A0_DISP_PREV_DLY_CTRL3_T         disp_prev_dly_ctrl3;                 // 0x50b4
	M14A0_DISP_PREV_DLY_CTRL4_T         disp_prev_dly_ctrl4;                 // 0x50b8
	M14A0_DISP_PREV_DLY_CTRL5_T         disp_prev_dly_ctrl5;                 // 0x50bc
	UINT32                              reserved31[15];                      // 0x50c0~0x50f8
	M14A0_DPPA_GMAU_FLUSH_T             dppa_gmau_flush;                     // 0x50fc
} DE_DEF_REG_M14A0_T;
