...
#ifndef	_CVD_CONTROL_M14A0_H_
#define	_CVD_CONTROL_M14A0_H_
...
----------------------------------------------------------------------------------------*/
#define CVD_M14A0_NOISE_MAX	0x3FF
...
int CVD_M14Ax_Comb2d_Only_Test(int set_params, int enable, int on_time, int off_time, int md_on_time, int md_off_time);
