...
static const CVD_REG_PARAM_T cvd_av_ntsc_443_l_default_m14b[] = 
{
    {0x12B4, 0x00000200},	
    {0x12B8, 0x00020010},	
    {0x12EC, 0x00016FC1},
    ...
    {0x15CC, 0x45470000},
    {0x1414, 0x00000011},
    {0x16D4, 0x000F4040},  //H13B 0x00004F40 E2D_ST_dly : reg_cdct_ifcomp_ctrl_0[30]  -> 0x47D8,reg_cdct_ifcomp_ctrl_1[30]
    {0x16C0, 0x000F4040}, // 2D Comb IFC
    {0x1620, 0x000F4040}, // 3D Comb IFC
    {0x1624, 0x00000206}, // CTI
    {0x15C8, 0x00032008},
    {0x15B0, 0x00100000}, //0x0010000F},
    {0x169C, 0x00000000},
    {0x1570, 0x00004D61},
    {0x1588, 0x00000000},
    {0x1560, 0x00000003},
    ...
    {0x1250, 0x00002300},   // dly, reg_blue_mode[9:8]
    {0x155C, 0x00000000},
    {0x1548, 0x00080475}, //H13B :0x00080354
    {0x16D8, 0x03302211},
    {0x154C, 0x00202300},
    {0x1554, 0x30202800},
    {0x16DC, 0x00000000},
    ...
    {0x1614, 0x001357C0},
    {0x1618, 0x0000C7FF},
    {0x13DC, 0x0F0007FE}, //H13 0x0F779080},   // OADJ
    {0x13E0, 0x00000F11}, //H13 0x00000EFC},
    {0x13E4, 0x00600203},
    {0x13E8, 0x10001000},
    {0x13EC, 0x06002030}
};
