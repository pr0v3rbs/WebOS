...
#include "../afe/de_cvd_reg_h13ax.h"
...
/*----------------------------------------------------------------------------------------
	global Variables
----------------------------------------------------------------------------------------*/
int gTTXCountOfLine318_H13A0;
int gTTXCountOfOtherLine_H13A0;
...
int TTX_HWInitialize_H13Ax(void)
{
	...
	TTX_PRINT("VBI TTX Initialize for H13Ax entered!\n");

	gTTXCountOfLine318_H13A0 = 0;
	...
	CVD_H13Ax_RdFL(vbi_ctrl_001);
	CVD_H13Ax_Wr01(vbi_ctrl_001, reg_vbi_little_endian, 0);
	CVD_H13Ax_WrFL(vbi_ctrl_001);

	ret = RET_OK;

	TTX_PRINT("VBI TTX Initialize for H13A0 is succefully done!\n");
	return ret;
}

int TTX_HWUninitialize_H13Ax(void)
{
	int ret = 0;
...
int TTX_SetInputFormat_H13Ax(eVBIDataType type)
{
	...
	{
		case eDisable:
			CVD_H13Ax_RdFL(vbi_004);
			CVD_H13Ax_Wr01(vbi_004, reg_vbi_en, VBI_OFF);
			CVD_H13Ax_WrFL(vbi_004);
			break;

		case eClosedCaptionUS:
		case eClosedCaptionEURO:
			CVD_H13Ax_RdFL(vbi_004);
			CVD_H13Ax_RdFL(vbi_006);
			CVD_H13Ax_RdFL(vbi_007);
			CVD_H13Ax_RdFL(vbi_008);
			CVD_H13Ax_RdFL(vbi_009);
			CVD_H13Ax_RdFL(vbi_010);
			CVD_H13Ax_RdFL(vbi_011);
			CVD_H13Ax_RdFL(vbi_014);
			CVD_H13Ax_RdFL(vbi_015);
			CVD_H13Ax_RdFL(vbi_020);
			CVD_H13Ax_RdFL(iris_040);

			CVD_H13Ax_Wr(vbi_007, 0);
			CVD_H13Ax_Wr(vbi_008, 0);
			CVD_H13Ax_Wr(vbi_009, 0);
			CVD_H13Ax_Wr(vbi_010, 0x11);
			CVD_H13Ax_Wr(vbi_011, 0);
			CVD_H13Ax_Wr(vbi_006, 0xE736);
			CVD_H13Ax_Wr(vbi_020, 0x54548282);
			CVD_H13Ax_Wr(vbi_014, 0x35A012DB);
			CVD_H13Ax_Wr(vbi_015, 0x2066159A);
			CVD_H13Ax_Wr01(iris_040, reg_vsync_vbi_max, 0x25);
			CVD_H13Ax_Wr01(vbi_004, reg_vbi_en, VBI_ON);

			CVD_H13Ax_WrFL(vbi_004);
			CVD_H13Ax_WrFL(vbi_007);
			CVD_H13Ax_WrFL(vbi_008);
			CVD_H13Ax_WrFL(vbi_009);
			CVD_H13Ax_WrFL(vbi_010);
			CVD_H13Ax_WrFL(vbi_011);
			CVD_H13Ax_WrFL(vbi_006);
			CVD_H13Ax_WrFL(vbi_020);
			CVD_H13Ax_WrFL(vbi_014);
			CVD_H13Ax_WrFL(vbi_015);
//			CVD_H13Ax_WrFL(vbi_016);
			CVD_H13Ax_WrFL(iris_040);
		...
		case eVPS:
			...
			CVD_H13Ax_Wr(vbi_008, 0);
			CVD_H13Ax_Wr(vbi_009, 0);
			CVD_H13Ax_Wr(vbi_010, 0);
			CVD_H13Ax_Wr(vbi_011, 0);
			// vbi_data_hlvl & start_code
			CVD_H13Ax_Wr(vbi_006, 0x2736);
			CVD_H13Ax_Wr(vbi_020, 0x54545A82);
			CVD_H13Ax_Wr(vbi_014, 0x35A012DB);
			CVD_H13Ax_Wr(vbi_015, 0x2066159a);
			CVD_H13Ax_Wr01(iris_040, reg_vsync_vbi_max, 0x25);
			CVD_H13Ax_Wr01(vbi_004, reg_vbi_en, VBI_ON);
		...
		case eTTX625A:
			...
			CVD_H13Ax_Wr(vbi_007, 0x55555555);
			CVD_H13Ax_Wr(vbi_008, 0x55555555);
			CVD_H13Ax_Wr(vbi_009, 0x55555555);
			CVD_H13Ax_Wr(vbi_010, 0x55555555);
			CVD_H13Ax_Wr(vbi_011, 0);
			CVD_H13Ax_Wr(vbi_006, 0x2736);
			CVD_H13Ax_Wr(vbi_020, 0x54545A82);
			CVD_H13Ax_Wr01(vbi_014, reg_teletext_dto, 0x12DB);
			CVD_H13Ax_Wr01(iris_040, reg_vsync_vbi_max, 0x25);
			CVD_H13Ax_Wr01(vbi_004, reg_vbi_en, VBI_ON);
		...
		case eTTX625B:
			...
			CVD_H13Ax_RdFL(vbi_014);
			CVD_H13Ax_RdFL(vbi_015);
			CVD_H13Ax_RdFL(vbi_016);
			CVD_H13Ax_RdFL(iris_040);
			CVD_H13Ax_RdFL(vbi_004);
			CVD_H13Ax_RdFL(vbi_013);
			CVD_H13Ax_RdFL(vbi_012);


			CVD_H13Ax_Wr(vbi_007, 0x66666666);
			CVD_H13Ax_Wr(vbi_008, 0x66666666);
			// 110917 by dws : Enable 16, 329 line TTX Slicing
			CVD_H13Ax_Wr(vbi_009, 0x66666666);
			//CVD_H13Ax_Wr(vbi_009, 0x66663366);
			CVD_H13Ax_Wr(vbi_010, 0x66666666);
			// 110917 by dws : Disable 336 line WSS Slicing
			CVD_H13Ax_Wr(vbi_011, 0x660C0000);
			//CVD_H13Ax_Wr(vbi_011, 0x66cc0000);
			// vbi_data_hlvl & start_code
			CVD_H13Ax_Wr(vbi_006, 0x2736);
			// reg_vps_start & reg_teletext_start & reg_wss625_start & vbi_020
			CVD_H13Ax_Wr(vbi_020, 0x54825a5a);
			CVD_H13Ax_Wr(vbi_014, 0x35A00F91);

			//CVD_H13Ax_Wr(vbi_015, 0x2066159a);
			// 110712 : WSS malfunction on green/red pattern
			//CVD_H13Ax_Wr01(vbi_015, reg_wss625_dto, 0x205A);		//13.48MHz
			CVD_H13Ax_Wr01(vbi_015, reg_wss625_dto, 0x2066);		//13.5MHz
			CVD_H13Ax_Wr01(vbi_015, reg_vps_dto, 0x159a);

			CVD_H13Ax_Wr01(vbi_016, reg_wss625_frame_start, 0x2);
			CVD_H13Ax_Wr01(iris_040, reg_vsync_vbi_max, 0x25);

			// 110712 : WSS malfunction on green/red pattern
			CVD_H13Ax_Wr01(vbi_013, reg_vbi_wss_slicer_mode, 0x1);

			CVD_H13Ax_Wr01(vbi_004, reg_vbi_muxout, 0);
			CVD_H13Ax_Wr01(vbi_004, reg_vbi_hsyncout, 0);
			CVD_H13Ax_Wr01(vbi_004, reg_vbi_en, VBI_ON);

			CVD_H13Ax_Wr01(vbi_004, reg_vbi_st_err_ignored, 1);
			...
			CVD_H13Ax_WrFL(iris_040);
			CVD_H13Ax_WrFL(vbi_004);
			CVD_H13Ax_WrFL(vbi_013);

#if 0		//2012.05.04 there is no such reigister on H13 compared to l9b2
			// 110905 for L9B0 54MHz TTX
			CVD_H13Ax_RdFL(vbi_022);
			CVD_H13Ax_Wr01(vbi_022, reg_ttx_out_sel, 0x0);	//select 54Mhz or 27Mhz TTX
			CVD_H13Ax_Wr01(vbi_022, reg_ttx_vbi_en, 0x1);
			CVD_H13Ax_Wr01(vbi_022, reg_ttx_adap_slvl_en, 0x1);
			CVD_H13Ax_Wr01(vbi_022, reg_ttx_vbi_data_hlvl, 0x36);
			CVD_H13Ax_WrFL(vbi_022);

			CVD_H13Ax_RdFL(vbi_023);
			CVD_H13Ax_Wr01(vbi_023, reg_ttx_tt_slicer_mode, 0x0);
			CVD_H13Ax_Wr01(vbi_023, reg_ttx_teletext_runin_accum_amp, 0x40);
			CVD_H13Ax_Wr01(vbi_023, reg_ttx_vbi_tele_lpfil_acq_gain, 0x8);
			CVD_H13Ax_Wr01(vbi_023, reg_ttx_vbi_tele_lpfil_track_gai, 0x4);
			CVD_H13Ax_Wr01(vbi_023, reg_ttx_vbi_tele_lpfil_fine_gain, 0x2);
			CVD_H13Ax_Wr01(vbi_023, reg_ttx_teletext_start, 0x5a);
			CVD_H13Ax_WrFL(vbi_023);

			CVD_H13Ax_RdFL(vbi_024);
			CVD_H13Ax_Wr01(vbi_024, reg_ttx_vbi_fixgate_en, 0x0);
			CVD_H13Ax_Wr01(vbi_024, reg_ttx_teletext_dto, 0x1f22);
			CVD_H13Ax_Wr01(vbi_024, reg_ttx_teletext_frame_start, 0x2);
			CVD_H13Ax_Wr01(vbi_024, reg_ttx_start_code, 0x27);
			CVD_H13Ax_WrFL(vbi_024);
#endif

			// 110121 won.hur : for 318 line TTX data
			CVD_H13Ax_Wr(vbi_012, 0x00000060);
			CVD_H13Ax_WrFL(vbi_012);
		...
		case eTTX525B:
			...
			CVD_H13Ax_Wr01(vbi_004, reg_vbi_en, VBI_ON);
			CVD_H13Ax_Wr(vbi_007, 0x99999999);
			CVD_H13Ax_Wr(vbi_008, 0x99999999);
			CVD_H13Ax_Wr(vbi_009, 0x99999999);
			CVD_H13Ax_Wr(vbi_010, 0x99999999);
			CVD_H13Ax_Wr(vbi_011, 0);
			// vbi_data_hlvl & start_code
			CVD_H13Ax_Wr(vbi_006, 0x2736);
			// reg_vps_start & reg_teletext_start & reg_wss625_start & vbi_020
		...
		case eTTX525C:
			...
			CVD_H13Ax_Wr01(vbi_004, reg_vbi_en, VBI_ON);
			CVD_H13Ax_Wr(vbi_007, 0xAAAAAAAA);
			CVD_H13Ax_Wr(vbi_008, 0xAAAAAAAA);
			CVD_H13Ax_Wr(vbi_009, 0xAAAAAAAA);
			CVD_H13Ax_Wr(vbi_010, 0xAAAAAAAA);
			CVD_H13Ax_Wr(vbi_011, 0);
			// vbi_data_hlvl & start_code
			CVD_H13Ax_Wr(vbi_006, 0xE736);
			// reg_vps_start & reg_teletext_start & reg_wss625_start & vbi_020
			CVD_H13Ax_Wr(vbi_020, 0x54546482);
			CVD_H13Ax_Wr01(vbi_014, reg_teletext_dto, 0x12DB);
			CVD_H13Ax_Wr01(iris_040, reg_vsync_vbi_max, 0x23);
		...
		case eTTX525D:
			...
			CVD_H13Ax_Wr01(vbi_004, reg_vbi_en, VBI_ON);
			CVD_H13Ax_Wr(vbi_007, 0xBBBBBBBB);
			CVD_H13Ax_Wr(vbi_008, 0xBBBBBBBB);
			CVD_H13Ax_Wr(vbi_009, 0xBBBBBBBB);
			CVD_H13Ax_Wr(vbi_010, 0xBBBBBBBB);
			CVD_H13Ax_Wr(vbi_011, 0);
			// vbi_data_hlvl & start_code
			CVD_H13Ax_Wr(vbi_006, 0xA736);
			// reg_vps_start & reg_teletext_start & reg_wss625_start & vbi_020
			CVD_H13Ax_Wr(vbi_020, 0x54545A82);
			CVD_H13Ax_Wr01(vbi_014, reg_teletext_dto, 0x12DB);
			CVD_H13Ax_Wr01(iris_040, reg_vsync_vbi_max, 0x23);
		...
		case eWSS625:
			...
			CVD_H13Ax_Wr(vbi_009, 0);
			CVD_H13Ax_Wr(vbi_010, 0);
			CVD_H13Ax_Wr(vbi_011, 0x00CC0000);
			// vbi_data_hlvl & start_code
			CVD_H13Ax_Wr(vbi_006, 0xE736);
			// reg_vps_start & reg_teletext_start & reg_wss625_start & vbi_020
			CVD_H13Ax_Wr(vbi_020, 0x54828282);
			CVD_H13Ax_Wr01(vbi_015, reg_wss625_dto, 0x2066);
			CVD_H13Ax_Wr01(vbi_016, reg_wss625_frame_start, 0x2);
			CVD_H13Ax_Wr01(iris_040, reg_vsync_vbi_max, 0x23);
...
int TTX_SetInterruptClear_H13Ax(void)
{
	...
	intr_vp1_en = CVD_H13Ax_Rd(cvd_intr1_clear0);
	CVD_H13Ax_Wr(cvd_intr1_clear0, (intr_vp1_en |= (1<<15)));
...
int TTX_SetInterrupt_H13Ax(int on_off)
{
	...
	if(on_off)
	{
		CVD_H13Ax_RdFL(cvd_intr1_enable1);
		intr_vp1_en = CVD_H13Ax_Rd(cvd_intr1_enable1);
		CVD_H13Ax_Wr(cvd_intr1_enable1, (intr_vp1_en |= H13A0_VBI_INTERRUPT_MASK));
		CVD_H13Ax_WrFL(cvd_intr1_enable1);
	}
	else
	{
		CVD_H13Ax_RdFL(cvd_intr1_enable1);
...
int TTX_ParsingVBIData_H13Ax(sHeaderData *data )
{
	...
	CVD_H13Ax_RdFL(vbi_ctrl_002);
	CVD_H13Ax_Rd01(vbi_ctrl_002, reg_vbi_buffer_number, buffer_number);

	switch(buffer_number)
	{
		case 0:
			CVD_H13Ax_RdFL(vbi_ctrl_002);
			CVD_H13Ax_RdFL(vbi_ctrl_003);

			CVD_H13Ax_Rd01(vbi_ctrl_002, reg_vbi0_start_addr, data->start);
			CVD_H13Ax_Rd01(vbi_ctrl_003, reg_vbi0_end_addr, data->end);
			CVD_H13Ax_Rd01(vbi_ctrl_002, reg_vbi0_data_cnt, data->count);
			break;
		case 1:
			CVD_H13Ax_RdFL(vbi_ctrl_004);
			CVD_H13Ax_RdFL(vbi_ctrl_005);

			CVD_H13Ax_Rd01(vbi_ctrl_004, reg_vbi1_start_addr, data->start);
			CVD_H13Ax_Rd01(vbi_ctrl_005, reg_vbi1_end_addr, data->end);
			CVD_H13Ax_Rd01(vbi_ctrl_004, reg_vbi1_data_cnt, data->count);
			break;
		case 2:
			CVD_H13Ax_RdFL(vbi_ctrl_006);
			CVD_H13Ax_RdFL(vbi_ctrl_007);

			CVD_H13Ax_Rd01(vbi_ctrl_006, reg_vbi2_start_addr, data->start);
			CVD_H13Ax_Rd01(vbi_ctrl_007, reg_vbi2_end_addr, data->end);
			CVD_H13Ax_Rd01(vbi_ctrl_006, reg_vbi2_data_cnt, data->count);
			break;
		case 3:
			CVD_H13Ax_RdFL(vbi_ctrl_008);
			CVD_H13Ax_RdFL(vbi_ctrl_009);

			CVD_H13Ax_Rd01(vbi_ctrl_008, reg_vbi3_start_addr, data->start);
			CVD_H13Ax_Rd01(vbi_ctrl_009, reg_vbi3_end_addr, data->end);
			CVD_H13Ax_Rd01(vbi_ctrl_008, reg_vbi3_data_cnt, data->count);
		break;
	}
	...
	else
	{
		...
		for(i=0;i<MAX_PACKET_NUM;i++)
		{
			...
			if( ( *(ucPacket + iHeaderPos + 0) == 0x00) && ( *(ucPacket + iHeaderPos + 1) == 0xff) && (*(ucPacket+iHeaderPos+2) == 0xff))
			{
				...
				if( ( *(ucPacket + iHeaderPos + 6) == 0x01) && ( *(ucPacket + iHeaderPos + 5) == 0x3e)) gTTXCountOfLine318_H13A0++;
				else gTTXCountOfOtherLine_H13A0++;
...
int TTX_Enable_VPS_Slicer_H13Ax(BOOLEAN Enable)
{
	...
	if(Enable)
		CVD_H13Ax_Wr01(vbi_009, reg_vbil16, 0x63);	// Enable VPS Slicing on Line #16
	else
		CVD_H13Ax_Wr01(vbi_009, reg_vbil16, 0x66);	// Enable TTX Slicing on Line #16
...
int TTX_SetVBILPF_H13Ax(int onoff)
{
	...
	CVD_H13Ax_RdFL(vbi_005);

	if(onoff)
	{
		CVD_H13Ax_Wr(vbi_005, 0x00000001);
	}
	else
	{
		CVD_H13Ax_Wr(vbi_005, 0x00000000);
	}

	CVD_H13Ax_WrFL(vbi_005);
...
int TTX_CheckOnLine318_H13Ax(int mode)
{
	...
	if(mode)
	{
		...
		gTTXCountOfLine318_H13A0 = 0;
		gTTXCountOfOtherLine_H13A0 = 0;
		ret = 1;
	}
	else
	{
		//TTX_PRINT("Count of line 318 vs Other is [%d]/[%d]\n", gTTXCountOfLine318, gTTXCountOfOtherLine);
		if(gTTXCountOfLine318_H13A0 > 10)
		{
			if(gTTXCountOfOtherLine_H13A0 > 10) ret = 4;   // Case when data is also in line 318.
...
int TTX_SetTypeLine318_H13Ax(int onoff)
{
	...
	else
	{
		...
		CVD_H13Ax_Wr(vbi_012, 0x00000000);
	}
...
int TTX_Set_TT_Slicer_Mode_H13Ax(unsigned int mode)
{
	...
	if(mode < 4)
	{
		CVD_H13Ax_Wr01(vbi_013, reg_vbi_tt_slicer_mode, mode);
		CVD_H13Ax_WrFL(vbi_013);
		ret = 0;
	}
	else
...
int TTX_CheckVline625_H13Ax(void)
{
	...
	CVD_H13Ax_Rd01(iris_013, reg_vline_625, isVline625);
	...
	if(isVline625 == 0)
	{
		if(isVline625 != gPrevVline625)
		{
			...
			CVD_H13Ax_Wr(vbi_007, 0x00000000);
			CVD_H13Ax_Wr(vbi_008, 0x00000000);
			CVD_H13Ax_Wr(vbi_009, 0x00000000);
			CVD_H13Ax_Wr(vbi_010, 0x0000DD00);
			CVD_H13Ax_Wr(vbi_011, 0x00000000);
			CVD_H13Ax_Wr01(vbi_015, reg_wss625_dto, 0x1E2B);		//13.5MHz
...
int TTX_CheckAnalogCP_H13Ax(void)
{
	...
	CVD_H13Ax_Rd01(iris_001, reg_mv_vbi_detected, analog_cp_psync);
	CVD_H13Ax_Rd01(iris_001, reg_mv_colourstripes, analog_cp_cstripe);

	if(gEnableTTXDataPrint){
		printk("TTX_ANALOG_CP = CP_PSYNC[0x%x], CP_CSTRIPES[0x%x]\n", analog_cp_psync, analog_cp_cstripe);
	}
	...
	do{
		...
		if(gEnableTTXDataPrint) printk("TTX_ANALOG_CP = RETURN VALUE[0x%x]\n", ret);
	}while(0);
...
int TTX_RunResume_H13Ax(void)
{
	...
	TTX_SetInputFormat_H13Ax(CURRENT_TTX);
