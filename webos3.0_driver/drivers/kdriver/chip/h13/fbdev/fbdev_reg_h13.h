...
#ifndef _FBDEV_REG_H13_H_
#define _FBDEV_REG_H13_H_
...
} OSD_H13_COMMON_OSD_H13_VALID_TH;
...
} OSD_H13_COMMON_SEP_OSD_H13_CTRL;
...
typedef struct {
	UINT32
	osd_frc_hdr_0                   ;   	// 31: 0
} OSD_H13_COMMON_SEP_OSD_H13_HDR0;
...
typedef struct {
	UINT32
	osd_frc_hdr_1                   ;   	// 31: 0
} OSD_H13_COMMON_SEP_OSD_H13_HDR1;
...
typedef struct {
	UINT32
	osd_frc_hdr_2                   ;   	// 31: 0
} OSD_H13_COMMON_SEP_OSD_H13_HDR2;
...
typedef struct {
	UINT32
	osd_frc_hdr_3                   ;   	// 31: 0
} OSD_H13_COMMON_SEP_OSD_H13_HDR3;
...
typedef struct {
	UINT32
	osd_frc_hdr_4                   ;   	// 31: 0
} OSD_H13_COMMON_SEP_OSD_H13_HDR4;
...
typedef struct {
	UINT32
	osd_frc_hdr_5                   ;   	// 31: 0
} OSD_H13_COMMON_SEP_OSD_H13_HDR5;
...
typedef struct {
	UINT32
	osd_frc_hdr_6                   ;   	// 31: 0
} OSD_H13_COMMON_SEP_OSD_H13_HDR6;
...
} OSD_H13_COMMON_60HZ_OSD_H13_VALID_TH;
...
typedef struct {
	OSD_H13_STATUS_MON_CFG              	osd_status_mon_cfg              ;	// 0x0000 : ''
	OSD_H13_STATUS_MON_POS              	osd_status_mon_pos              ;	// 0x0004 : ''
	OSD_H13_STATUS_VERSION              	osd_status_version              ;	// 0x0008 : ''
	OSD_H13_STATUS_MIXER_LINE           	osd_status_mixer_line           ;	// 0x000c : ''
	OSD_H13_STATUS_MON_DATA0            	osd_status_mon_data0            ;	// 0x0010 : ''
	OSD_H13_STATUS_MON_DATA1            	osd_status_mon_data1            ;	// 0x0014 : ''
	OSD_H13_STATUS_MON_DATA2            	osd_status_mon_data2            ;	// 0x0018 : ''
	OSD_H13_STATUS_MON_DATA3            	osd_status_mon_data3            ;	// 0x001c : ''
	OSD_H13_STATUS_MON_DATA4            	osd_status_mon_data4            ;	// 0x0020 : ''
	OSD_H13_STATUS_MON_DATA5            	osd_status_mon_data5            ;	// 0x0024 : ''
	OSD_H13_STATUS_MON_DATA6            	osd_status_mon_data6            ;	// 0x0028 : ''
	OSD_H13_STATUS_MON_DATA7            	osd_status_mon_data7            ;	// 0x002c : ''
	OSD_H13_STATUS_MON_DATA8            	osd_status_mon_data8            ;	// 0x0030 : ''
	OSD_H13_STATUS_MON_DATA9            	osd_status_mon_data9            ;	// 0x0034 : ''
	OSD_H13_STATUS_MON_DATAA            	osd_status_mon_dataa            ;	// 0x0038 : ''
	OSD_H13_STATUS_MON_DATAB            	osd_status_mon_datab            ;	// 0x003c : ''
	OSD_H13_COMMON_DISP_SIZE            	osd_common_disp_size            ;	// 0x0040 : ''
	OSD_H13_COMMON_CTRL_IRQ             	osd_common_ctrl_irq             ;	// 0x0044 : ''
	OSD_H13_COMMON_CTRL_PIC_INIT        	osd_common_ctrl_pic_init        ;	// 0x0048 : ''
	OSD_H13_COMMON_CTRL_PIC_TIMER       	osd_common_ctrl_pic_timer       ;	// 0x004c : ''
	OSD_H13_COMMON_CTRL_3DFP_OUT        	osd_common_ctrl_3dfp_out        ;	// 0x0050 : ''
	OSD_H13_COMMON_CTRL_PQ_PATH         	osd_common_ctrl_pq_path         ;	// 0x0054 : ''
	OSD_H13_COMMON_PLTE_SEL             	osd_common_plte_sel             ;	// 0x0058 : ''
	OSD_H13_COMMON_OSD_H13_VALID_TH         	osd_common_osd_valid_th         ;	// 0x005c : ''
	OSD_H13_COMMON_CSC_CTRL             	osd_common_csc_ctrl             ;	// 0x0060 : ''
	OSD_H13_COMMON_CSC_COEF0            	osd_common_csc_coef0            ;	// 0x0064 : ''
	OSD_H13_COMMON_CSC_COEF1            	osd_common_csc_coef1            ;	// 0x0068 : ''
	UINT32                          	                 __rsvd_00[   1];	// 0x006c
	OSD_H13_COMMON_SEP_OSD_H13_CTRL         	osd_common_sep_osd_ctrl         ;	// 0x0070 : ''
	OSD_H13_COMMON_SEP_OSD_H13_HDR0         	osd_common_sep_osd_hdr0         ;	// 0x0074 : ''
	OSD_H13_COMMON_SEP_OSD_H13_HDR1         	osd_common_sep_osd_hdr1         ;	// 0x0078 : ''
	OSD_H13_COMMON_SEP_OSD_H13_HDR2         	osd_common_sep_osd_hdr2         ;	// 0x007c : ''
	OSD_H13_COMMON_SEP_OSD_H13_HDR3         	osd_common_sep_osd_hdr3         ;	// 0x0080 : ''
	OSD_H13_COMMON_SEP_OSD_H13_HDR4         	osd_common_sep_osd_hdr4         ;	// 0x0084 : ''
	OSD_H13_COMMON_SEP_OSD_H13_HDR5         	osd_common_sep_osd_hdr5         ;	// 0x0088 : ''
	OSD_H13_COMMON_SEP_OSD_H13_HDR6         	osd_common_sep_osd_hdr6         ;	// 0x008c : ''
	OSD_H13_COMMON_CTRL_TPG             	osd_common_ctrl_tpg             ;	// 0x0090 : ''
	OSD_H13_COMMON_60HZ_DISP_SIZE       	osd_common_60hz_disp_size       ;	// 0x0094 : ''
	OSD_H13_COMMON_60HZ_CTRL_PATH       	osd_common_60hz_ctrl_path       ;	// 0x0098 : ''
	OSD_H13_COMMON_60HZ_OSD_H13_VALID_TH    	osd_common_60hz_osd_valid_th    ;	// 0x009c : ''
	OSD_H13_MIXER_CTRL_ONOFF            	osd_mixer_ctrl_onoff            ;	// 0x00a0 : ''
	OSD_H13_MIXER_CTRL_OUTPUT           	osd_mixer_ctrl_output           ;	// 0x00a4 : ''
	OSD_H13_MIXER_CTRL_AWB              	osd_mixer_ctrl_awb              ;	// 0x00a8 : ''
	OSD_H13_MIXER_CTRL_SYNC             	osd_mixer_ctrl_sync             ;	// 0x00ac : ''
	OSD_H13_MIXER_CTRL_BLEND            	osd_mixer_ctrl_blend            ;	// 0x00b0 : ''
	OSD_H13_MIXER_60HZ_CTRL_AWB         	osd_mixer_60hz_ctrl_awb         ;	// 0x00b4 : ''
	OSD_H13_MIXER_60HZ_CTRL_BLEND       	osd_mixer_60hz_ctrl_blend       ;	// 0x00b8 : ''
	OSD_H13_MIXER_CTRL_HOLE             	osd_mixer_ctrl_hole             ;	// 0x00bc : ''
	OSD_H13_MIXER_CTRL_MUX0             	osd_mixer_ctrl_mux0             ;	// 0x00c0 : ''
	OSD_H13_MIXER_CTRL_MUX1             	osd_mixer_ctrl_mux1             ;	// 0x00c4 : ''
	OSD_H13_MIXER_CTRL_MUX2             	osd_mixer_ctrl_mux2             ;	// 0x00c8 : ''
	OSD_H13_MIXER_CTRL_MUX3             	osd_mixer_ctrl_mux3             ;	// 0x00cc : ''
	OSD_H13_MIXER_CTRL_MUX4             	osd_mixer_ctrl_mux4             ;	// 0x00d0 : ''
	OSD_H13_MIXER_CTRL_MUX5             	osd_mixer_ctrl_mux5             ;	// 0x00d4 : ''
	OSD_H13_MIXER_CTRL_MUX6             	osd_mixer_ctrl_mux6             ;	// 0x00d8 : ''
	OSD_H13_MIXER_CTRL_MUX7             	osd_mixer_ctrl_mux7             ;	// 0x00dc : ''
	OSD_H13_MIXER_CTRL_MUX8             	osd_mixer_ctrl_mux8             ;	// 0x00e0 : ''
	OSD_H13_MIXER_CTRL_MUX9             	osd_mixer_ctrl_mux9             ;	// 0x00e4 : ''
	OSD_H13_MIXER_CTRL_MUXA             	osd_mixer_ctrl_muxa             ;	// 0x00e8 : ''
	OSD_H13_MIXER_CTRL_MUXB             	osd_mixer_ctrl_muxb             ;	// 0x00ec : ''
	OSD_H13_MIXER_CTRL_MUXC             	osd_mixer_ctrl_muxc             ;	// 0x00f0 : ''
	OSD_H13_MIXER_CTRL_MUXD             	osd_mixer_ctrl_muxd             ;	// 0x00f4 : ''
	OSD_H13_MIXER_CTRL_MUXE             	osd_mixer_ctrl_muxe             ;	// 0x00f8 : ''
	OSD_H13_MIXER_CTRL_MUXF             	osd_mixer_ctrl_muxf             ;	// 0x00fc : ''
	OSD0_H13_CTRL_MAIN                  	osd0_ctrl_main                  ;	// 0x0100 : ''
	OSD0_H13_BASE_ADDR                  	osd0_ctrl_base_addr             ;	// 0x0104 : ''
	OSD0_H13_CTRL_SWAP                  	osd0_ctrl_swap                  ;	// 0x0108 : ''
	OSD0_H13_CTRL_PDEC                  	osd0_ctrl_pdec                  ;	// 0x010c : ''
	OSD0_H13_CTRL_SCALER                	osd0_ctrl_scaler                ;	// 0x0110 : ''
	OSD0_H13_CTRL_3D_DISPARITY          	osd0_ctrl_3d_disparity          ;	// 0x0114 : ''
	OSD0_H13_CTRL_3D_BLANK              	osd0_ctrl_3d_blank              ;	// 0x0118 : ''
	UINT32                          	                 __rsvd_01[   1];	// 0x011c
	OSD0_H13_CTRL_HDR0                  	osd0_ctrl_hdr0                  ;	// 0x0120 : ''
	OSD0_H13_CTRL_HDR1                  	osd0_ctrl_hdr1                  ;	// 0x0124 : ''
	OSD0_H13_CTRL_HDR2                  	osd0_ctrl_hdr2                  ;	// 0x0128 : ''
	OSD0_H13_CTRL_HDR3                  	osd0_ctrl_hdr3                  ;	// 0x012c : ''
	OSD0_H13_CTRL_HDR4                  	osd0_ctrl_hdr4                  ;	// 0x0130 : ''
	OSD0_H13_CTRL_HDR5                  	osd0_ctrl_hdr5                  ;	// 0x0134 : ''
	OSD0_H13_CTRL_HDR6                  	osd0_ctrl_hdr6                  ;	// 0x0138 : ''
	UINT32                          	                 __rsvd_02[   1];	// 0x013c
	OSD1_H13_CTRL_MAIN                  	osd1_ctrl_main                  ;	// 0x0140 : ''
	OSD1_H13_CTRL_BASE_ADDR             	osd1_ctrl_base_addr             ;	// 0x0144 : ''
	OSD1_H13_CTRL_SWAP                  	osd1_ctrl_swap                  ;	// 0x0148 : ''
	OSD1_H13_CTRL_PDEC                  	osd1_ctrl_pdec                  ;	// 0x014c : ''
	OSD1_H13_CTRL_SCALER                	osd1_ctrl_scaler                ;	// 0x0150 : ''
	OSD1_H13_CTRL_3D_DISPARITY          	osd1_ctrl_3d_disparity          ;	// 0x0154 : ''
	OSD1_H13_CTRL_3D_BLANK              	osd1_ctrl_3d_blank              ;	// 0x0158 : ''
	UINT32                          	                 __rsvd_03[   1];	// 0x015c
	OSD1_H13_CTRL_HDR0                  	osd1_ctrl_hdr0                  ;	// 0x0160 : ''
	OSD1_H13_CTRL_HDR1                  	osd1_ctrl_hdr1                  ;	// 0x0164 : ''
	OSD1_H13_CTRL_HDR2                  	osd1_ctrl_hdr2                  ;	// 0x0168 : ''
	OSD1_H13_CTRL_HDR3                  	osd1_ctrl_hdr3                  ;	// 0x016c : ''
	OSD1_H13_CTRL_HDR4                  	osd1_ctrl_hdr4                  ;	// 0x0170 : ''
	OSD1_H13_CTRL_HDR5                  	osd1_ctrl_hdr5                  ;	// 0x0174 : ''
	OSD1_H13_CTRL_HDR6                  	osd1_ctrl_hdr6                  ;	// 0x0178 : ''
	UINT32                          	                 __rsvd_04[   1];	// 0x017c
	OSD2_H13_CTRL_MAIN                  	osd2_ctrl_main                  ;	// 0x0180 : ''
	OSD2_H13_CTRL_BASE_ADDR             	osd2_ctrl_base_addr             ;	// 0x0184 : ''
	OSD2_H13_CTRL_SWAP                  	osd2_ctrl_swap                  ;	// 0x0188 : ''
	OSD2_H13_CTRL_PDEC                  	osd2_ctrl_pdec                  ;	// 0x018c : ''
	OSD2_H13_CTRL_SCALER                	osd2_ctrl_scaler                ;	// 0x0190 : ''
	OSD2_H13_CTRL_3D_DISPARITY          	osd2_ctrl_3d_disparity          ;	// 0x0194 : ''
	OSD2_H13_CTRL_3D_BLANK              	osd2_ctrl_3d_blank              ;	// 0x0198 : ''
	UINT32                          	                 __rsvd_05[   1];	// 0x019c
	OSD2_H13_CTRL_HDR0                  	osd2_ctrl_hdr0                  ;	// 0x01a0 : ''
	OSD2_H13_CTRL_HDR1                  	osd2_ctrl_hdr1                  ;	// 0x01a4 : ''
	OSD2_H13_CTRL_HDR2                  	osd2_ctrl_hdr2                  ;	// 0x01a8 : ''
	OSD2_H13_CTRL_HDR3                  	osd2_ctrl_hdr3                  ;	// 0x01ac : ''
	OSD2_H13_CTRL_HDR4                  	osd2_ctrl_hdr4                  ;	// 0x01b0 : ''
	OSD2_H13_CTRL_HDR5                  	osd2_ctrl_hdr5                  ;	// 0x01b4 : ''
	OSD2_H13_CTRL_HDR6                  	osd2_ctrl_hdr6                  ;	// 0x01b8 : ''
	UINT32                          	                 __rsvd_06[   1];	// 0x01bc
	OSD3_H13_CTRL_MAIN                  	osd3_ctrl_main                  ;	// 0x01c0 : ''
	OSD3_H13_CTRL_BASE_ADDR             	osd3_ctrl_base_addr             ;	// 0x01c4 : ''
	OSD3_H13_CTRL_SWAP                  	osd3_ctrl_swap                  ;	// 0x01c8 : ''
	OSD3_H13_CTRL_PDEC                  	osd3_ctrl_pdec                  ;	// 0x01cc : ''
	OSD3_H13_CTRL_SCALER                	osd3_ctrl_scaler                ;	// 0x01d0 : ''
	OSD3_H13_CTRL_3D_DISPARITY          	osd3_ctrl_3d_disparity          ;	// 0x01d4 : ''
	OSD3_H13_CTRL_3D_BLANK              	osd3_ctrl_3d_blank              ;	// 0x01d8 : ''
	UINT32                          	                 __rsvd_07[   1];	// 0x01dc
	OSD3_H13_CTRL_HDR0                  	osd3_ctrl_hdr0                  ;	// 0x01e0 : ''
	OSD3_H13_CTRL_HDR1                  	osd3_ctrl_hdr1                  ;	// 0x01e4 : ''
	OSD3_H13_CTRL_HDR2                  	osd3_ctrl_hdr2                  ;	// 0x01e8 : ''
	OSD3_H13_CTRL_HDR3                  	osd3_ctrl_hdr3                  ;	// 0x01ec : ''
	OSD3_H13_CTRL_HDR4                  	osd3_ctrl_hdr4                  ;	// 0x01f0 : ''
	OSD3_H13_CTRL_HDR5                  	osd3_ctrl_hdr5                  ;	// 0x01f4 : ''
	OSD3_H13_CTRL_HDR6                  	osd3_ctrl_hdr6                  ;	// 0x01f8 : ''
} OSD_H13_REG_T;
/* 119 regs, 119 types */
 ...
 * g_fbdev_h13_reg : real register of OSD.
 * g_fbdev_h13_reg_cached     : shadow register.
 *
 * @def OSD_H13_RdFL: Read  FLushing : Shadow <- Real.
 * @def OSD_H13_WrFL: Write FLushing : Shadow -> Real.
 * @def OSD_H13_Rd  : Read  whole register(UINT32) from Shadow register.
 * @def OSD_H13_Wr  : Write whole register(UINT32) from Shadow register.
 * @def OSD_H13_Rd01 ~ OSD_H13_Rdnn: Read  given '01~nn' fields from Shadow register.
 * @def OSD_H13_Wr01 ~ OSD_H13_Wrnn: Write given '01~nn' fields to   Shadow register.
 * */
#define OSD_H13_RdFL(_r)			((g_fbdev_h13_reg_cached->_r)=(g_fbdev_h13_reg->_r))
#define OSD_H13_WrFL(_r)			((g_fbdev_h13_reg->_r)=(g_fbdev_h13_reg_cached->_r))

#define OSD_H13_Rd(_r)			*((UINT32*)(&(g_fbdev_h13_reg_cached->_r)))
#define OSD_H13_Wr(_r,_v)			((OSD_H13_Rd(_r))=((UINT32)(_v)))

#define OSD_H13_Rd00(_r,_f)         (g_fbdev_h13_reg_cached->_r._f)


#define OSD_H13_Rd01(_r,_f01,_v01)													\
								do { 											\
									(_v01) = (g_fbdev_h13_reg_cached->_r._f01);				\
								} while(0)

#define OSD_H13_Rd02(_r,_f01,_v01,_f02,_v02)										\
								do { 											\
									(_v01) = (g_fbdev_h13_reg_cached->_r._f01);				\
									(_v02) = (g_fbdev_h13_reg_cached->_r._f02);				\
								} while(0)

#define OSD_H13_Rd03(_r,_f01,_v01,_f02,_v02,_f03,_v03)								\
								do { 											\
									(_v01) = (g_fbdev_h13_reg_cached->_r._f01);				\
									(_v02) = (g_fbdev_h13_reg_cached->_r._f02);				\
									(_v03) = (g_fbdev_h13_reg_cached->_r._f03);				\
								} while(0)

#define OSD_H13_Rd04(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04)					\
								do { 											\
									(_v01) = (g_fbdev_h13_reg_cached->_r._f01);				\
									(_v02) = (g_fbdev_h13_reg_cached->_r._f02);				\
									(_v03) = (g_fbdev_h13_reg_cached->_r._f03);				\
									(_v04) = (g_fbdev_h13_reg_cached->_r._f04);				\
								} while(0)

#define OSD_H13_Rd05(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05)													\
								do { 											\
									(_v01) = (g_fbdev_h13_reg_cached->_r._f01);				\
									(_v02) = (g_fbdev_h13_reg_cached->_r._f02);				\
									(_v03) = (g_fbdev_h13_reg_cached->_r._f03);				\
									(_v04) = (g_fbdev_h13_reg_cached->_r._f04);				\
									(_v05) = (g_fbdev_h13_reg_cached->_r._f05);				\
								} while(0)

#define OSD_H13_Rd06(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06)										\
								do { 											\
									(_v01) = (g_fbdev_h13_reg_cached->_r._f01);				\
									(_v02) = (g_fbdev_h13_reg_cached->_r._f02);				\
									...
									(_v04) = (g_fbdev_h13_reg_cached->_r._f04);				\
									(_v05) = (g_fbdev_h13_reg_cached->_r._f05);				\
									(_v06) = (g_fbdev_h13_reg_cached->_r._f06);				\
								} while(0)

#define OSD_H13_Rd07(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07)								\
								do { 											\
									...
									(_v05) = (g_fbdev_h13_reg_cached->_r._f05);				\
									(_v06) = (g_fbdev_h13_reg_cached->_r._f06);				\
									(_v07) = (g_fbdev_h13_reg_cached->_r._f07);				\
								} while(0)

#define OSD_H13_Rd08(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08)					\
								do { 											\
									...
									(_v06) = (g_fbdev_h13_reg_cached->_r._f06);				\
									(_v07) = (g_fbdev_h13_reg_cached->_r._f07);				\
									(_v08) = (g_fbdev_h13_reg_cached->_r._f08);				\
								} while(0)

#define OSD_H13_Rd09(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08,					\
					_f09,_v09)													\
								do { 											\
									(_v01) = (g_fbdev_h13_reg_cached->_r._f01);				\
									...
									(_v07) = (g_fbdev_h13_reg_cached->_r._f07);				\
									(_v08) = (g_fbdev_h13_reg_cached->_r._f08);				\
									(_v09) = (g_fbdev_h13_reg_cached->_r._f09);				\
								} while(0)

#define OSD_H13_Rd10(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08,					\
					_f09,_v09,_f10,_v10)										\
								do { 											\
									(_v01) = (g_fbdev_h13_reg_cached->_r._f01);				\
									...
									(_v08) = (g_fbdev_h13_reg_cached->_r._f08);				\
									(_v09) = (g_fbdev_h13_reg_cached->_r._f09);				\
									(_v10) = (g_fbdev_h13_reg_cached->_r._f10);				\
								} while(0)

#define OSD_H13_Rd11(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08,					\
					_f09,_v09,_f10,_v10,_f11,_v11)								\
								do { 											\
									...
									(_v09) = (g_fbdev_h13_reg_cached->_r._f09);				\
									(_v10) = (g_fbdev_h13_reg_cached->_r._f10);				\
									(_v11) = (g_fbdev_h13_reg_cached->_r._f11);				\
								} while(0)

#define OSD_H13_Rd12(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08,					\
					_f09,_v09,_f10,_v10,_f11,_v11,_f12,_v12)					\
								do { 											\
									...
									(_v10) = (g_fbdev_h13_reg_cached->_r._f10);				\
									(_v11) = (g_fbdev_h13_reg_cached->_r._f11);				\
									(_v12) = (g_fbdev_h13_reg_cached->_r._f12);				\
								} while(0)

#define OSD_H13_Rd13(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08,					\
					_f09,_v09,_f10,_v10,_f11,_v11,_f12,_v12,					\
					_f13,_v13)													\
								do { 											\
									...
									(_v11) = (g_fbdev_h13_reg_cached->_r._f11);				\
									(_v12) = (g_fbdev_h13_reg_cached->_r._f12);				\
									(_v13) = (g_fbdev_h13_reg_cached->_r._f13);				\
								} while(0)

#define OSD_H13_Rd14(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08,					\
					_f09,_v09,_f10,_v10,_f11,_v11,_f12,_v12,					\
					_f13,_v13,_f14,_v14)										\
								do { 											\
									...
									(_v12) = (g_fbdev_h13_reg_cached->_r._f12);				\
									(_v13) = (g_fbdev_h13_reg_cached->_r._f13);				\
									(_v14) = (g_fbdev_h13_reg_cached->_r._f14);				\
								} while(0)

#define OSD_H13_Rd15(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08,					\
					_f09,_v09,_f10,_v10,_f11,_v11,_f12,_v12,					\
					_f13,_v13,_f14,_v14,_f15,_v15)								\
								do { 											\
									...
									(_v13) = (g_fbdev_h13_reg_cached->_r._f13);				\
									(_v14) = (g_fbdev_h13_reg_cached->_r._f14);				\
									(_v15) = (g_fbdev_h13_reg_cached->_r._f15);				\
								} while(0)

#define OSD_H13_Rd16(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08,					\
					_f09,_v09,_f10,_v10,_f11,_v11,_f12,_v12,					\
					_f13,_v13,_f14,_v14,_f15,_v15,_f16,_v16)					\
								do { 											\
									...
									(_v14) = (g_fbdev_h13_reg_cached->_r._f14);				\
									(_v15) = (g_fbdev_h13_reg_cached->_r._f15);				\
									(_v16) = (g_fbdev_h13_reg_cached->_r._f16);				\
								} while(0)


#define OSD_H13_Wr01(_r,_f01,_v01)													\
								do { 											\
									(g_fbdev_h13_reg_cached->_r._f01) = (_v01);				\
								} while(0)

#define OSD_H13_Wr02(_r,_f01,_v01,_f02,_v02)										\
								do { 											\
									(g_fbdev_h13_reg_cached->_r._f01) = (_v01);				\
									(g_fbdev_h13_reg_cached->_r._f02) = (_v02);				\
								} while(0)

#define OSD_H13_Wr03(_r,_f01,_v01,_f02,_v02,_f03,_v03)								\
								do { 											\
									(g_fbdev_h13_reg_cached->_r._f01) = (_v01);				\
									(g_fbdev_h13_reg_cached->_r._f02) = (_v02);				\
									(g_fbdev_h13_reg_cached->_r._f03) = (_v03);				\
								} while(0)

#define OSD_H13_Wr04(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04)					\
								do { 											\
									(g_fbdev_h13_reg_cached->_r._f01) = (_v01);				\
									(g_fbdev_h13_reg_cached->_r._f02) = (_v02);				\
									(g_fbdev_h13_reg_cached->_r._f03) = (_v03);				\
									(g_fbdev_h13_reg_cached->_r._f04) = (_v04);				\
								} while(0)

#define OSD_H13_Wr05(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05)													\
								do { 											\
									(g_fbdev_h13_reg_cached->_r._f01) = (_v01);				\
									(g_fbdev_h13_reg_cached->_r._f02) = (_v02);				\
									(g_fbdev_h13_reg_cached->_r._f03) = (_v03);				\
									(g_fbdev_h13_reg_cached->_r._f04) = (_v04);				\
									(g_fbdev_h13_reg_cached->_r._f05) = (_v05);				\
								} while(0)

#define OSD_H13_Wr06(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06)										\
								do { 											\
									(g_fbdev_h13_reg_cached->_r._f01) = (_v01);				\
									(g_fbdev_h13_reg_cached->_r._f02) = (_v02);				\
									...
									(g_fbdev_h13_reg_cached->_r._f04) = (_v04);				\
									(g_fbdev_h13_reg_cached->_r._f05) = (_v05);				\
									(g_fbdev_h13_reg_cached->_r._f06) = (_v06);				\
								} while(0)

#define OSD_H13_Wr07(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07)								\
								do { 											\
									(g_fbdev_h13_reg_cached->_r._f01) = (_v01);				\
									(g_fbdev_h13_reg_cached->_r._f02) = (_v02);				\
									...
									(g_fbdev_h13_reg_cached->_r._f05) = (_v05);				\
									(g_fbdev_h13_reg_cached->_r._f06) = (_v06);				\
									(g_fbdev_h13_reg_cached->_r._f07) = (_v07);				\
								} while(0)

#define OSD_H13_Wr08(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08)					\
								do { 											\
									(g_fbdev_h13_reg_cached->_r._f01) = (_v01);				\
									(g_fbdev_h13_reg_cached->_r._f02) = (_v02);				\
									...
									(g_fbdev_h13_reg_cached->_r._f06) = (_v06);				\
									(g_fbdev_h13_reg_cached->_r._f07) = (_v07);				\
									(g_fbdev_h13_reg_cached->_r._f08) = (_v08);				\
								} while(0)

#define OSD_H13_Wr09(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08,					\
					_f09,_v09)													\
								do { 											\
									(g_fbdev_h13_reg_cached->_r._f01) = (_v01);				\
									...
									(g_fbdev_h13_reg_cached->_r._f07) = (_v07);				\
									(g_fbdev_h13_reg_cached->_r._f08) = (_v08);				\
									(g_fbdev_h13_reg_cached->_r._f09) = (_v09);				\
								} while(0)

#define OSD_H13_Wr10(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08,					\
					_f09,_v09,_f10,_v10)										\
								do { 											\
									(g_fbdev_h13_reg_cached->_r._f01) = (_v01);				\
									...
									(g_fbdev_h13_reg_cached->_r._f08) = (_v08);				\
									(g_fbdev_h13_reg_cached->_r._f09) = (_v09);				\
									(g_fbdev_h13_reg_cached->_r._f10) = (_v10);				\
								} while(0)

#define OSD_H13_Wr11(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08,					\
					_f09,_v09,_f10,_v10,_f11,_v11)								\
								do { 											\
									(g_fbdev_h13_reg_cached->_r._f01) = (_v01);				\
									...
									(g_fbdev_h13_reg_cached->_r._f09) = (_v09);				\
									(g_fbdev_h13_reg_cached->_r._f10) = (_v10);				\
									(g_fbdev_h13_reg_cached->_r._f11) = (_v11);				\
								} while(0)

#define OSD_H13_Wr12(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08,					\
					_f09,_v09,_f10,_v10,_f11,_v11,_f12,_v12)					\
								do { 											\
									(g_fbdev_h13_reg_cached->_r._f01) = (_v01);				\
									...
									(g_fbdev_h13_reg_cached->_r._f10) = (_v10);				\
									(g_fbdev_h13_reg_cached->_r._f11) = (_v11);				\
									(g_fbdev_h13_reg_cached->_r._f12) = (_v12);				\
								} while(0)

#define OSD_H13_Wr13(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08,					\
					_f09,_v09,_f10,_v10,_f11,_v11,_f12,_v12,					\
					_f13,_v13)													\
								do { 											\
									...
									(g_fbdev_h13_reg_cached->_r._f11) = (_v11);				\
									(g_fbdev_h13_reg_cached->_r._f12) = (_v12);				\
									(g_fbdev_h13_reg_cached->_r._f13) = (_v13);				\
								} while(0)

#define OSD_H13_Wr14(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08,					\
					_f09,_v09,_f10,_v10,_f11,_v11,_f12,_v12,					\
					_f13,_v13,_f14,_v14)										\
								do { 											\
									...
									(g_fbdev_h13_reg_cached->_r._f12) = (_v12);				\
									(g_fbdev_h13_reg_cached->_r._f13) = (_v13);				\
									(g_fbdev_h13_reg_cached->_r._f14) = (_v14);				\
								} while(0)

#define OSD_H13_Wr15(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08,					\
					_f09,_v09,_f10,_v10,_f11,_v11,_f12,_v12,					\
					_f13,_v13,_f14,_v14,_f15,_v15)								\
								do { 											\
									...
									(g_fbdev_h13_reg_cached->_r._f13) = (_v13);				\
									(g_fbdev_h13_reg_cached->_r._f14) = (_v14);				\
									(g_fbdev_h13_reg_cached->_r._f15) = (_v15);				\
								} while(0)

#define OSD_H13_Wr16(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08,					\
					_f09,_v09,_f10,_v10,_f11,_v11,_f12,_v12,					\
					_f13,_v13,_f14,_v14,_f15,_v15,_f16,_v16)					\
								do { 											\
									...
									(g_fbdev_h13_reg_cached->_r._f14) = (_v14);				\
									(g_fbdev_h13_reg_cached->_r._f15) = (_v15);				\
									(g_fbdev_h13_reg_cached->_r._f16) = (_v16);				\
								} while(0)
 ...
 * _rwname: name of rw    bit field : shall be 0 after OSD_H13_Wind(), 1 for OSD_H13_Rind()
 * _iname : name of index bit field
 * _ival  : index value
 * _fname : field name
 * _fval  : field variable that field value shall be stored.
 *
 * OSD_H13_Rind : General indexed register Read.(
 * OSD_H13_Wind : General indexed register Read.
 *
 * OSD_H13_Ridx : For 'index', 'rw', 'load' field name
 * OSD_H13_Widx : For 'index', 'rw', 'load' field name and NO_LOAD.
 */
#define OSD_H13_Rind(_r, _lname, _rwname, _iname, _ival, _fname, _fval)				\
							do {												\
								OSD_H13_Wr03(_r,_lname,0,_rwname,1,_iname,_ival);	\
								OSD_H13_WrFL(_r);									\
								OSD_H13_RdFL(_r);									\
								OSD_H13_Rd01(_r,_fname,_fval);						\
							} while (0)

#define OSD_H13_Wind(_r, _lname, _rwname, _iname, _ival, _fname, _fval)				\
				OSD_H13_Wr04(_r, _lname,0, _rwname,0, _iname,_ival, _fname,_fval)


#define OSD_H13_Ridx(_r, _ival, _fname, _fval)	OSD_H13_Rind(_r,load,rw,index,_ival,_fname,_fval)

#define OSD_H13_Widx(_r, _ival, _fname, _fval)	OSD_H13_Wind(_r,load,rw,index,_ival,_fname,_fval)
...
#endif	/* _FBDEV_REG_H13_H_ */

/* from 'H13_OSD_H13_RegFile.csv' 20120409 16:25:56   대한민국 표준시 by getregs v2.7 */
