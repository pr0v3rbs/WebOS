...
int BE_H3D_HW_H13_Get_Version(LX_BE_H3D_VERSION_T *pstParams)
{
	int ret = RET_OK;
...
int BE_H3D_HW_H13_Reset_Block(LX_BE_H3D_RESET_BLOCK_T *pstParams)
{
	int ret = RET_OK;
...
int BE_H3D_HW_H13_Bypass_All(LX_BE_H3D_BYPASS_ALL_T *pstParams)
{
	int ret = RET_OK;
...
int BE_H3D_HW_H13_Set_Mode(LX_BE_H3D_MODE_T *pstParams)
{
	int ret = RET_OK;
	unsigned int status;
...
int BE_H3D_HW_H13_Get_Mode(LX_BE_H3D_MODE_T *pstParams)
{
	int ret = RET_OK;
	IPC_SET_GET_PARAM(BE_IPC_H3D_MODE_T, stHwParams);
...
int BE_H3D_HW_H13_In_Format(LX_BE_H3D_IN_FORMAT_T *pstParams)
{
	int ret = RET_OK;
	...
	do{
		...
		/* return unexpected value */
		if(*(ULONG *)&pstParams == (ULONG)0xFFFFFFFF)
		{
			return ret;
		}	
...
int BE_H3D_HW_H13_T3C_Depth_Level(LX_BE_H3D_T3C_DEPTH_LEVEL_T *pstParams)
{
	int ret = RET_OK;
	unsigned int status;
...
int BE_H3D_HW_H13_A3C_Depth_Level(LX_BE_H3D_A3C_DEPTH_LEVEL_T *pstParams)
{
	int ret = RET_OK;
	unsigned int status;
...
int BE_H3D_HW_H13_A3C_AutoConvergence(LX_BE_H3D_A3C_AUTOCONVERGENCE_T *pstParams)
{
	int ret = RET_OK;
	unsigned int status;
...
int BE_H3D_HW_H13_Set_TridFmt( LX_BE_TRIDTV_FMT_CTRL_T *pstParams)
{
	int ret = RET_OK;
	unsigned int status;
	...
	do{
		...
		if((stHwParams1.bA3CMode == 1)  || (stHwParams1.bT3CMode == 1))
		{
			...
			stHwParams5.u16ConvergenceVal = (UINT32)(pstParams->convCtrl+10);
