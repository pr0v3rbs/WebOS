...
/*----------------------------------------------------------------------------------------
	Static Variables
----------------------------------------------------------------------------------------*/
static BE_SRE_HW_H13_INFO_T	_beSREHwH13Info =
{
	.u8SrControl 		= 0xFF,
...
int BE_SRE_HW_H13_Initialize(void)
{
	int ret = RET_OK;
...
int BE_SRE_HW_H13_Set_Command(LX_BE_SRE_CMN_T *pstParams)
{
	int ret = RET_OK;
	int updateCount = 0;
	...
	do {
		...
		/* Step 2-1.  */
		if (_beSREHwH13Info.u8SrControl != (UINT8)stCtrlParams.u4Control)
		{
			//BE_SRE_HW_H13_Control(&stCtrlParams);
			...
			if(ret) BREAK_WRONG(ret);
			_beSREHwH13Info.u8SrControl = (UINT8)stCtrlParams.u4Control;
			updateCount++;
		}

		/* Step 2-2.  */
		if ( (_beSREHwH13Info.u8SrAGlobalScale != (UINT8)stGScaleParams.u8SRAGlobalScale)
			|| (_beSREHwH13Info.u8SrBGlobalScale != (UINT8)stGScaleParams.u8SRBGlobalScale) )
		{
				/* return unexpected value */
			...
			if(ret) BREAK_WRONG(ret);
			_beSREHwH13Info.u8SrAGlobalScale = (UINT8)stGScaleParams.u8SRAGlobalScale;
			_beSREHwH13Info.u8SrBGlobalScale = (UINT8)stGScaleParams.u8SRBGlobalScale;
			updateCount++;
		}

		/* Step 2-3.  */
		if ( (_beSREHwH13Info.u8InputResolution != (UINT8)stInputModeParams.u4InputResolution)
			|| (_beSREHwH13Info.u8Input3DMode != (UINT8)stInputModeParams.u4Input3DMode) )
		{
			/* return unexpected value */
			...
			if(ret) BREAK_WRONG(ret);
			_beSREHwH13Info.u8InputResolution = (UINT8)stInputModeParams.u4InputResolution;
			_beSREHwH13Info.u8Input3DMode    = (UINT8)stInputModeParams.u4Input3DMode;
			updateCount++;
		}
...
int BE_SRE_HW_H13_Set_Params(LX_BE_SRE_PRAM_T *pstParams)
{
	int ret = RET_OK;
	int updateCount = 0;
	...
	do {
		...
		/* Step 2-1.  */
		if ( _beSREHwH13Info.u8DbGrade != (UINT8)stDbGradeParams.u8DBGrade )
		{
			/* return unexpected value */
			...
			if(ret) BREAK_WRONG(ret);
			_beSREHwH13Info.u8DbGrade = (UINT8)stDbGradeParams.u8DBGrade;
			updateCount++;
		}

		/* Step 2-2.  */
		if ( (_beSREHwH13Info.u8ModeLocalScale != stLScaleParams.u4ModeLocalScale)
			|| (_beSREHwH13Info.u8SrALocalScale != stLScaleParams.u4SRALocalScale)
			|| (_beSREHwH13Info.u8SrBLocalScale != stLScaleParams.u4SRBLocalScale) )
		{
			/* return unexpected value */
			...
			if(ret) BREAK_WRONG(ret);
			_beSREHwH13Info.u8ModeLocalScale = stLScaleParams.u4ModeLocalScale;
			_beSREHwH13Info.u8SrALocalScale    = stLScaleParams.u4SRALocalScale;
			_beSREHwH13Info.u8SrBLocalScale    = stLScaleParams.u4SRBLocalScale;
			updateCount++;
		}
		...
		/* Step 2-3.  */
		if ( (_beSREHwH13Info.u8PP_XFilter != stPreProcParams.u8XFilter)
			|| (_beSREHwH13Info.u8PP_YFilter != stPreProcParams.u8YFilter)
			|| (_beSREHwH13Info.u8PP_GlobalScale != stPreProcParams.u8GlobalScale)
			|| (_beSREHwH13Info.u8PP_LocalScale  != stPreProcParams.u8LocalScale) )
		{
			/* return unexpected value */
			...
			if(ret) BREAK_WRONG(ret);
			_beSREHwH13Info.u8PP_XFilter 		= stPreProcParams.u8XFilter;
			_beSREHwH13Info.u8PP_YFilter    	= stPreProcParams.u8YFilter;
			_beSREHwH13Info.u8PP_GlobalScale   = stPreProcParams.u8GlobalScale;
			_beSREHwH13Info.u8PP_LocalScale    = stPreProcParams.u8LocalScale;
			updateCount++;
...
int BE_SRE_HW_H13_Get_Version(LX_BE_SRE_VERSION_T *pstParams)
{
	int ret = RET_OK;
...
int BE_SRE_HW_H13_Set_Input_Format(LX_BE_SRE_INPUT_MODE_T *pstParams)
{
	int ret = RET_OK;
