...
#include "be_dbg.h"
#include "be_def.h"
#include "be_reg_hw_h13.h"
#include "be_reg_def_h13.h"
#include "be_reg_dppb_h13.h"
#include "be_reg_frc_h13.h"
...
/*----------------------------------------------------------------------------------------
	Static Variables
----------------------------------------------------------------------------------------*/
static BE_REG_HW_H13_INFO_T gstBeRegHwH13Info;

/*========================================================================================
	Implementation Group
========================================================================================*/
int BE_REG_HW_H13_Initialize(void)
{
	int ret = RET_OK;
...
int BE_REG_HW_H13_Read(BE_REG_RW_TYPE_T type, UINT32 addr, UINT32 *data)
{
	int ret = RET_OK;
	UINT32 value;
	UINT32 recvAddr;
...
int BE_REG_HW_H13_Write(BE_REG_RW_TYPE_T type, UINT32 addr, UINT32 data)
{
	int ret = RET_OK;
	UINT32 value;
	UINT32 recvAddr;
