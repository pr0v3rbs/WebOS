...
#ifndef	_CVD_HW_H13A0_H_
#define	_CVD_HW_H13A0_H_
...
void CVD_H13Ax_Set_Picture_Enhancement(BOOLEAN ycrdc_lcr_on, BOOLEAN cyrdc_lcr_on);
...
int CVD_H13Ax_Vport_Reg_Read(UINT32 arg);
int CVD_H13Ax_Vport_Reg_Write(UINT32 arg);
...
int CVD_H13Ax_Get_CHB_No_Signal_Flag(void);
int CVD_H13Ax_Get_CHB_HLock_Flag(void);
int CVD_H13Ax_Get_CHB_VLock_Flag(void);
int CVD_H13Ax_Get_CHB_Chromalock_Flag(void);
int CVD_H13Ax_Get_CHB_PAL_Flag(void);
int CVD_H13Ax_Get_CHB_Vline_625_Flag(void);
int CVD_H13Ax_Get_CHB_SECAM_Flag(void);
