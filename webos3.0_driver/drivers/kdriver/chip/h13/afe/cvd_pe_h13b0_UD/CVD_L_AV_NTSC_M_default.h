...
static const CVD_REG_PARAM_T cvd_av_ntsc_m_l_default_UD[] = 
{
    {0x42B4, 0x00000200},	
    {0x42B8, 0x00020010},	
    {0x42EC, 0x00016FC1},
    ...
    {0x4644, 0x00FF80FF},
    {0x46BC, 0xA0E0FFE0},
    {0x4740, 0x40112002}, //0x40110002}, //0x40110001},
    ...
    {0x4784, 0x2D000000},
    {0x4758, 0x70003510},
    {0x475C, 0x06044120}, //0x060440A0}, //0x360840A0},
    {0x4760, 0x30003F10}, //0x30003F0B},
    {0x45BC, 0x08002021},
    {0x46F8, 0x5001F181},
    {0x46FC, 0x00210200},
    {0x470C, 0x523D1901},
