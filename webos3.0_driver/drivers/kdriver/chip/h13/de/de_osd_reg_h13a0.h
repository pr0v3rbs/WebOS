...
#ifndef _REG_OSD_H13A0_h
#define _REG_OSD_H13A0_h
...
} H13A0_OSD_COMMON_CTRL_PIC_INIT_T;
...
} H13A0_OSD_COMMON_CTRL_PIC_TIMER_T;
...
} H13A0_OSD_COMMON_CTRL_PQ_PATH_T;
...
} H13A0_OSD_COMMON_OSD_VALID_TH_T;
...
} H13A0_OSD_COMMON_SEP_OSD_CTRL_T;
...
} H13A0_OSD_COMMON_SEP_OSD_HDR0_T;
...
} H13A0_OSD_COMMON_SEP_OSD_HDR1_T;
...
} H13A0_OSD_COMMON_SEP_OSD_HDR2_T;
...
} H13A0_OSD_COMMON_SEP_OSD_HDR3_T;
...
} H13A0_OSD_COMMON_SEP_OSD_HDR4_T;
...
} H13A0_OSD_COMMON_SEP_OSD_HDR5_T;
...
} H13A0_OSD_COMMON_SEP_OSD_HDR6_T;
...
} H13A0_OSD0_CTRL_3D_DISPARITY_T;
...
} H13A0_OSD1_CTRL_CTRL_3D_DISPARITY_T;
...
} H13A0_OSD1_CTRL_CTRL_3D_BLANK_T;
...
} H13A0_OSD2_CTRL_CTRL_3D_DISPARITY_T;
...
} H13A0_OSD2_CTRL_CTRL_3D_BLANK_T;
...
} H13A0_OSD3_CTRL_CTRL_3D_DISPARITY_T;
...
} H13A0_OSD3_CTRL_CTRL_3D_BLANK_T;
...
} H13A0_OSD3_CTRL_CTRL_HDR6_T;

typedef struct {
	H13A0_OSD_STATUS_MON_CFG_T              osd_status_mon_cfg;                      // 0x5100
	H13A0_OSD_STATUS_MON_POS_T              osd_status_mon_pos;                      // 0x5104
	H13A0_OSD_STATUS_VERSION_T              osd_status_version;                      // 0x5108
	H13A0_OSD_STATUS_MIXER_LINE_T           osd_status_mixer_line;                   // 0x510c
	H13A0_OSD_STATUS_MON_DATA0_T            osd_status_mon_data0;                    // 0x5110
	H13A0_OSD_STATUS_MON_DATA1_T            osd_status_mon_data1;                    // 0x5114
	H13A0_OSD_STATUS_MON_DATA2_T            osd_status_mon_data2;                    // 0x5118
	H13A0_OSD_STATUS_MON_DATA3_T            osd_status_mon_data3;                    // 0x511c
	H13A0_OSD_STATUS_MON_DATA4_T            osd_status_mon_data4;                    // 0x5120
	H13A0_OSD_STATUS_MON_DATA5_T            osd_status_mon_data5;                    // 0x5124
	H13A0_OSD_STATUS_MON_DATA6_T            osd_status_mon_data6;                    // 0x5128
	H13A0_OSD_STATUS_MON_DATA7_T            osd_status_mon_data7;                    // 0x512c
	H13A0_OSD_STATUS_MON_DATA8_T            osd_status_mon_data8;                    // 0x5130
	H13A0_OSD_STATUS_MON_DATA9_T            osd_status_mon_data9;                    // 0x5134
	H13A0_OSD_STATUS_MON_DATAA_T            osd_status_mon_dataa;                    // 0x5138
	H13A0_OSD_STATUS_MON_DATAB_T            osd_status_mon_datab;                    // 0x513c
	H13A0_OSD_COMMON_DISP_SIZE_T            osd_common_disp_size;                    // 0x5140
	H13A0_OSD_COMMON_CTRL_IRQ_T             osd_common_ctrl_irq;                     // 0x5144
	H13A0_OSD_COMMON_CTRL_PIC_INIT_T        osd_common_ctrl_pic_init;                // 0x5148
	H13A0_OSD_COMMON_CTRL_PIC_TIMER_T       osd_common_ctrl_pic_timer;               // 0x514c
	UINT32                                  reserved0;                               // 0x5150
	H13A0_OSD_COMMON_CTRL_PQ_PATH_T         osd_common_ctrl_pq_path;                 // 0x5154
	H13A0_OSD_COMMON_PLTE_SEL_T             osd_common_plte_sel;                     // 0x5158
	H13A0_OSD_COMMON_OSD_VALID_TH_T         osd_common_osd_valid_th;                 // 0x515c
	H13A0_OSD_COMMON_CSC_CTRL_T             osd_common_csc_ctrl;                     // 0x5160
	H13A0_OSD_COMMON_CSC_COEF0_T            osd_common_csc_coef0;                    // 0x5164
	H13A0_OSD_COMMON_CSC_COEF1_T            osd_common_csc_coef1;                    // 0x5168
	UINT32                                  reserved1;                               // 0x516c
	H13A0_OSD_COMMON_SEP_OSD_CTRL_T         osd_common_sep_osd_ctrl;                 // 0x5170
	H13A0_OSD_COMMON_SEP_OSD_HDR0_T         osd_common_sep_osd_hdr0;                 // 0x5174
	H13A0_OSD_COMMON_SEP_OSD_HDR1_T         osd_common_sep_osd_hdr1;                 // 0x5178
	H13A0_OSD_COMMON_SEP_OSD_HDR2_T         osd_common_sep_osd_hdr2;                 // 0x517c
	H13A0_OSD_COMMON_SEP_OSD_HDR3_T         osd_common_sep_osd_hdr3;                 // 0x5180
	H13A0_OSD_COMMON_SEP_OSD_HDR4_T         osd_common_sep_osd_hdr4;                 // 0x5184
	H13A0_OSD_COMMON_SEP_OSD_HDR5_T         osd_common_sep_osd_hdr5;                 // 0x5188
	H13A0_OSD_COMMON_SEP_OSD_HDR6_T         osd_common_sep_osd_hdr6;                 // 0x518c
	UINT32                                  reserved2[4];                            // 0x5190~0x519c
	H13A0_OSD_MIXER_CTRL_ONOFF_T            osd_mixer_ctrl_onoff;                    // 0x51a0
	H13A0_OSD_MIXER_CTRL_OUTPUT_T           osd_mixer_ctrl_output;                   // 0x51a4
	H13A0_OSD_MIXER_CTRL_AWB_T              osd_mixer_ctrl_awb;                      // 0x51a8
	H13A0_OSD_MIXER_CTRL_SYNC_T             osd_mixer_ctrl_sync;                     // 0x51ac
	H13A0_OSD_MIXER_CTRL_BLEND_T            osd_mixer_ctrl_blend;                    // 0x51b0
	UINT32                                  reserved3[3];                            // 0x51b4~0x51bc
	H13A0_OSD_MIXER_CTRL_MUX0_T             osd_mixer_ctrl_mux0;                     // 0x51c0
	H13A0_OSD_MIXER_CTRL_MUX1_T             osd_mixer_ctrl_mux1;                     // 0x51c4
	H13A0_OSD_MIXER_CTRL_MUX2_T             osd_mixer_ctrl_mux2;                     // 0x51c8
	H13A0_OSD_MIXER_CTRL_MUX3_T             osd_mixer_ctrl_mux3;                     // 0x51cc
	H13A0_OSD_MIXER_CTRL_MUX4_T             osd_mixer_ctrl_mux4;                     // 0x51d0
	H13A0_OSD_MIXER_CTRL_MUX5_T             osd_mixer_ctrl_mux5;                     // 0x51d4
	H13A0_OSD_MIXER_CTRL_MUX6_T             osd_mixer_ctrl_mux6;                     // 0x51d8
	H13A0_OSD_MIXER_CTRL_MUX7_T             osd_mixer_ctrl_mux7;                     // 0x51dc
	H13A0_OSD_MIXER_CTRL_MUX8_T             osd_mixer_ctrl_mux8;                     // 0x51e0
	H13A0_OSD_MIXER_CTRL_MUX9_T             osd_mixer_ctrl_mux9;                     // 0x51e4
	UINT32                                  reserved4[6];                            // 0x51e8~0x51fc
	H13A0_OSD0_CTRL_MAIN_T                  osd0_ctrl_main;                          // 0x5200
	H13A0_OSD0_BASE_ADDR_T                  osd0_base_addr;                          // 0x5204
	H13A0_OSD0_CTRL_SWAP_T                  osd0_ctrl_swap;                          // 0x5208
	H13A0_OSD0_CTRL_PDEC_T                  osd0_ctrl_pdec;                          // 0x520c
	H13A0_OSD0_CTRL_SCALER_T                osd0_ctrl_scaler;                        // 0x5210
	H13A0_OSD0_CTRL_3D_DISPARITY_T          osd0_ctrl_3d_disparity;                  // 0x5214
	H13A0_OSD0_CTRL_3D_BLANK_T              osd0_ctrl_3d_blank;                      // 0x5218
	UINT32                                  reserved5;                               // 0x521c
	H13A0_OSD0_CTRL_HDR0_T                  osd0_ctrl_hdr0;                          // 0x5220
	H13A0_OSD0_CTRL_HDR1_T                  osd0_ctrl_hdr1;                          // 0x5224
	H13A0_OSD0_CTRL_HDR2_T                  osd0_ctrl_hdr2;                          // 0x5228
	H13A0_OSD0_CTRL_HDR3_T                  osd0_ctrl_hdr3;                          // 0x522c
	H13A0_OSD0_CTRL_HDR4_T                  osd0_ctrl_hdr4;                          // 0x5230
	H13A0_OSD0_CTRL_HDR5_T                  osd0_ctrl_hdr5;                          // 0x5234
	H13A0_OSD0_CTRL_HDR6_T                  osd0_ctrl_hdr6;                          // 0x5238
	UINT32                                  reserved6;                               // 0x523c
	H13A0_OSD1_CTRL_CTRL_MAIN_T             osd1_ctrl_ctrl_main;                     // 0x5240
	H13A0_OSD1_CTRL_BASE_ADDR_T             osd1_ctrl_base_addr;                     // 0x5244
	H13A0_OSD1_CTRL_CTRL_SWAP_T             osd1_ctrl_ctrl_swap;                     // 0x5248
	H13A0_OSD1_CTRL_CTRL_PDEC_T             osd1_ctrl_ctrl_pdec;                     // 0x524c
	H13A0_OSD1_CTRL_CTRL_SCALER_T           osd1_ctrl_ctrl_scaler;                   // 0x5250
	H13A0_OSD1_CTRL_CTRL_3D_DISPARITY_T     osd1_ctrl_ctrl_3d_disparity;             // 0x5254
	H13A0_OSD1_CTRL_CTRL_3D_BLANK_T         osd1_ctrl_ctrl_3d_blank;                 // 0x5258
	UINT32                                  reserved7;                               // 0x525c
	H13A0_OSD1_CTRL_CTRL_HDR0_T             osd1_ctrl_ctrl_hdr0;                     // 0x5260
	H13A0_OSD1_CTRL_CTRL_HDR1_T             osd1_ctrl_ctrl_hdr1;                     // 0x5264
	H13A0_OSD1_CTRL_CTRL_HDR2_T             osd1_ctrl_ctrl_hdr2;                     // 0x5268
	H13A0_OSD1_CTRL_CTRL_HDR3_T             osd1_ctrl_ctrl_hdr3;                     // 0x526c
	H13A0_OSD1_CTRL_CTRL_HDR4_T             osd1_ctrl_ctrl_hdr4;                     // 0x5270
	H13A0_OSD1_CTRL_CTRL_HDR5_T             osd1_ctrl_ctrl_hdr5;                     // 0x5274
	H13A0_OSD1_CTRL_CTRL_HDR6_T             osd1_ctrl_ctrl_hdr6;                     // 0x5278
	UINT32                                  reserved8;                               // 0x527c
	H13A0_OSD2_CTRL_CTRL_MAIN_T             osd2_ctrl_ctrl_main;                     // 0x5280
	H13A0_OSD2_CTRL_BASE_ADDR_T             osd2_ctrl_base_addr;                     // 0x5284
	H13A0_OSD2_CTRL_CTRL_SWAP_T             osd2_ctrl_ctrl_swap;                     // 0x5288
	H13A0_OSD2_CTRL_CTRL_PDEC_T             osd2_ctrl_ctrl_pdec;                     // 0x528c
	H13A0_OSD2_CTRL_CTRL_SCALER_T           osd2_ctrl_ctrl_scaler;                   // 0x5290
	H13A0_OSD2_CTRL_CTRL_3D_DISPARITY_T     osd2_ctrl_ctrl_3d_disparity;             // 0x5294
	H13A0_OSD2_CTRL_CTRL_3D_BLANK_T         osd2_ctrl_ctrl_3d_blank;                 // 0x5298
	UINT32                                  reserved9;                               // 0x529c
	H13A0_OSD2_CTRL_CTRL_HDR0_T             osd2_ctrl_ctrl_hdr0;                     // 0x52a0
	H13A0_OSD2_CTRL_CTRL_HDR1_T             osd2_ctrl_ctrl_hdr1;                     // 0x52a4
	H13A0_OSD2_CTRL_CTRL_HDR2_T             osd2_ctrl_ctrl_hdr2;                     // 0x52a8
	H13A0_OSD2_CTRL_CTRL_HDR3_T             osd2_ctrl_ctrl_hdr3;                     // 0x52ac
	H13A0_OSD2_CTRL_CTRL_HDR4_T             osd2_ctrl_ctrl_hdr4;                     // 0x52b0
	H13A0_OSD2_CTRL_CTRL_HDR5_T             osd2_ctrl_ctrl_hdr5;                     // 0x52b4
	H13A0_OSD2_CTRL_CTRL_HDR6_T             osd2_ctrl_ctrl_hdr6;                     // 0x52b8
	UINT32                                  reserved10;                              // 0x52bc
	H13A0_OSD3_CTRL_CTRL_MAIN_T             osd3_ctrl_ctrl_main;                     // 0x52c0
	H13A0_OSD3_CTRL_BASE_ADDR_T             osd3_ctrl_base_addr;                     // 0x52c4
	H13A0_OSD3_CTRL_CTRL_SWAP_T             osd3_ctrl_ctrl_swap;                     // 0x52c8
	H13A0_OSD3_CTRL_CTRL_PDEC_T             osd3_ctrl_ctrl_pdec;                     // 0x52cc
	H13A0_OSD3_CTRL_CTRL_SCALER_T           osd3_ctrl_ctrl_scaler;                   // 0x52d0
	H13A0_OSD3_CTRL_CTRL_3D_DISPARITY_T     osd3_ctrl_ctrl_3d_disparity;             // 0x52d4
	H13A0_OSD3_CTRL_CTRL_3D_BLANK_T         osd3_ctrl_ctrl_3d_blank;                 // 0x52d8
	UINT32                                  reserved11;                              // 0x52dc
	H13A0_OSD3_CTRL_CTRL_HDR0_T             osd3_ctrl_ctrl_hdr0;                     // 0x52e0
	H13A0_OSD3_CTRL_CTRL_HDR1_T             osd3_ctrl_ctrl_hdr1;                     // 0x52e4
	H13A0_OSD3_CTRL_CTRL_HDR2_T             osd3_ctrl_ctrl_hdr2;                     // 0x52e8
	H13A0_OSD3_CTRL_CTRL_HDR3_T             osd3_ctrl_ctrl_hdr3;                     // 0x52ec
	H13A0_OSD3_CTRL_CTRL_HDR4_T             osd3_ctrl_ctrl_hdr4;                     // 0x52f0
	H13A0_OSD3_CTRL_CTRL_HDR5_T             osd3_ctrl_ctrl_hdr5;                     // 0x52f4
	H13A0_OSD3_CTRL_CTRL_HDR6_T             osd3_ctrl_ctrl_hdr6;                     // 0x52f8
} DE_OSD_REG_H13A0_T;
