...
typedef struct {
	...
	UINT32                              reserved14[7];                       // 0x4018~0x4030
	...
	H13B0_DEE_VBI_CGMS_CTRL0_T          dee_vbi_cgms_ctrl0;                  // 0x4090
	H13B0_DEE_VBI_CGMS_CTRL1_T          dee_vbi_cgms_ctrl1;                  // 0x4094
	H13B0_DEE_VBI_CGMS_DATA0_T          dee_vbi_cgms_data0;                  // 0x4098
	H13B0_DEE_VBI_CGMS_DATA1_T          dee_vbi_cgms_data1;                  // 0x409c
	H13B0_DEE_VBI_WSS_CTRL0_T           dee_vbi_wss_ctrl0;                   // 0x40a0
	H13B0_DEE_VBI_WSS_CTRL1_T           dee_vbi_wss_ctrl1;                   // 0x40a4
	H13B0_DEE_VBI_WSS_CTRL2_T           dee_vbi_wss_ctrl2;                   // 0x40a8
	H13B0_DEE_VBI_WSS_DATA0_T           dee_vbi_wss_data0;                   // 0x40ac
	H13B0_DEE_VBI_WSS_DATA1_T           dee_vbi_wss_data1;                   // 0x40b0
