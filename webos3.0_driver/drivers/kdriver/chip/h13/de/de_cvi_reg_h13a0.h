...
#ifndef _REG_CVI_H13A0_h
#define _REG_CVI_H13A0_h
...
typedef struct {
	...
	UINT32                                 : 4;   // 12:15 reserved
	UINT32 pseudo_vn                       : 12;  // 16:27
} H13A0_CVB_PSEUDO_SYNC_CTRL4_T;

typedef struct {
	H13A0_CVA_TOP_CTRL_T            cva_top_ctrl;                    // 0x0100
	H13A0_CVA_OFFSET_CTRL_T         cva_offset_ctrl;                 // 0x0104
	H13A0_CVA_SIZE_CTRL_T           cva_size_ctrl;                   // 0x0108
	H13A0_CVA_INT_SYNC_CTRL0_T      cva_int_sync_ctrl0;              // 0x010c
	H13A0_CVA_INT_SYNC_CTRL1_T      cva_int_sync_ctrl1;              // 0x0110
	H13A0_CVA_DIG_FILT_CTRL0_T      cva_dig_filt_ctrl0;              // 0x0114
	H13A0_CVA_DIG_FILT_CTRL1_T      cva_dig_filt_ctrl1;              // 0x0118
	H13A0_CVA_DIG_FILT_CTRL2_T      cva_dig_filt_ctrl2;              // 0x011c
	H13A0_CVA_DIG_FILT_CTRL3_T      cva_dig_filt_ctrl3;              // 0x0120
	H13A0_CVA_CSC_CTRL0_T           cva_csc_ctrl0;                   // 0x0124
	H13A0_CVA_CSC_CTRL1_T           cva_csc_ctrl1;                   // 0x0128
	H13A0_CVA_CSC_CTRL2_T           cva_csc_ctrl2;                   // 0x012c
	H13A0_CVA_CSC_CTRL3_T           cva_csc_ctrl3;                   // 0x0130
	H13A0_CVA_CSC_CTRL4_T           cva_csc_ctrl4;                   // 0x0134
	H13A0_CVA_CSC_CTRL5_T           cva_csc_ctrl5;                   // 0x0138
	H13A0_CVA_CSC_CTRL6_T           cva_csc_ctrl6;                   // 0x013c
	H13A0_CVA_CSC_CTRL7_T           cva_csc_ctrl7;                   // 0x0140
	H13A0_CVA_MISC_CTRL_T           cva_misc_ctrl;                   // 0x0144
	H13A0_CVA_OFFSET_READ_T         cva_offset_read;                 // 0x0148
	H13A0_CVA_PRE3D_CTRL0_T         cva_pre3d_ctrl0;                 // 0x014c
	H13A0_CVA_PRE3D_CTRL1_T         cva_pre3d_ctrl1;                 // 0x0150
	H13A0_CVA_PRE3D_CTRL2_T         cva_pre3d_ctrl2;                 // 0x0154
	H13A0_CVA_SIZE_STATUS1_T        cva_size_status1;                // 0x0158
	H13A0_CVA_SIZE_STATUS2_T        cva_size_status2;                // 0x015c
	H13A0_CVA_SIZE_STATUS3_T        cva_size_status3;                // 0x0160
	H13A0_CVA_SIZE_STATUS4_T        cva_size_status4;                // 0x0164
	H13A0_CVA_PIX_SUM_CTRL0_T       cva_pix_sum_ctrl0;               // 0x0168
	H13A0_CVA_PIX_SUM_CTRL1_T       cva_pix_sum_ctrl1;               // 0x016c
	H13A0_CVA_PIX_SUM_STATUS0_T     cva_pix_sum_status0;             // 0x0170
	H13A0_CVA_PIX_SUM_STATUS1_T     cva_pix_sum_status1;             // 0x0174
	H13A0_CVA_PIX_SUM_STATUS2_T     cva_pix_sum_status2;             // 0x0178
	H13A0_CVA_SYNC_FIL_CTRL_T       cva_sync_fil_ctrl;               // 0x017c
	H13A0_CVA_SYNC_FIL_STATUS_T     cva_sync_fil_status;             // 0x0180
	H13A0_CVA_CTI_CTRL_T            cva_cti_ctrl;                    // 0x0184
	UINT32                          reserved0[2];                    // 0x0188~0x018c
	H13A0_CVA_SYNC_REPEAT_CTRL_T    cva_sync_repeat_ctrl;            // 0x0190
	H13A0_CVA_SYNC_REPEAT_SIZE0_T   cva_sync_repeat_size0;           // 0x0194
	H13A0_CVA_SYNC_REPEAT_SIZE1_T   cva_sync_repeat_size1;           // 0x0198
	H13A0_CVA_SYNC_REPEAT_SIZE2_T   cva_sync_repeat_size2;           // 0x019c
	H13A0_CVA_SYNC_REPEAT_SIZE3_T   cva_sync_repeat_size3;           // 0x01a0
	H13A0_CVA_SYNC_REPEAT_SIZE4_T   cva_sync_repeat_size4;           // 0x01a4
	H13A0_CVA_SYNC_REPEAT_SIZE5_T   cva_sync_repeat_size5;           // 0x01a8
	H13A0_CVA_DIG_FILT_CTRL4_T      cva_dig_filt_ctrl4;              // 0x01ac
	H13A0_CVA_DIG_FILT_CTRL5_T      cva_dig_filt_ctrl5;              // 0x01b0
	H13A0_CVA_DIG_FILT_CTRL6_T      cva_dig_filt_ctrl6;              // 0x01b4
	UINT32                          reserved1[2];                    // 0x01b8~0x01bc
	H13A0_CVA_SIZE_DETECT_CTRL_T    cva_size_detect_ctrl;            // 0x01c0
	H13A0_CVA_SIZE_DETECT_READ_T    cva_size_detect_read;            // 0x01c4
	H13A0_CVA_SIZE_STATUS0_T        cva_size_status0;                // 0x01c8
	H13A0_CVA_SIZE_STATUS5_T        cva_size_status5;                // 0x01cc
	H13A0_CVA_SIZE_STATUS6_T        cva_size_status6;                // 0x01d0
	H13A0_CVA_SIZE_DETECT_CTRL1_T   cva_size_detect_ctrl1;           // 0x01d4
	H13A0_CVA_SIZE_DETECT_CTRL2_T   cva_size_detect_ctrl2;           // 0x01d8
	H13A0_CVA_PSEUDO_SYNC_CTRL0_T   cva_pseudo_sync_ctrl0;           // 0x01dc
	H13A0_CVA_PSEUDO_SYNC_CTRL1_T   cva_pseudo_sync_ctrl1;           // 0x01e0
	H13A0_CVA_PSEUDO_SYNC_CTRL2_T   cva_pseudo_sync_ctrl2;           // 0x01e4
	H13A0_CVA_PSEUDO_SYNC_CTRL3_T   cva_pseudo_sync_ctrl3;           // 0x01e8
	H13A0_CVA_PSEUDO_SYNC_CTRL4_T   cva_pseudo_sync_ctrl4;           // 0x01ec
} DE_CVA_REG_H13A0_T;

typedef struct {
	H13A0_CVB_TOP_CTRL_T            cvb_top_ctrl;                    // 0x0200
	H13A0_CVB_OFFSET_CTRL_T         cvb_offset_ctrl;                 // 0x0204
	H13A0_CVB_SIZE_CTRL_T           cvb_size_ctrl;                   // 0x0208
	H13A0_CVB_INT_SYNC_CTRL0_T      cvb_int_sync_ctrl0;              // 0x020c
	H13A0_CVB_INT_SYNC_CTRL1_T      cvb_int_sync_ctrl1;              // 0x0210
	H13A0_CVB_DIG_FILT_CTRL0_T      cvb_dig_filt_ctrl0;              // 0x0214
	H13A0_CVB_DIG_FILT_CTRL1_T      cvb_dig_filt_ctrl1;              // 0x0218
	H13A0_CVB_DIG_FILT_CTRL2_T      cvb_dig_filt_ctrl2;              // 0x021c
	H13A0_CVB_DIG_FILT_CTRL3_T      cvb_dig_filt_ctrl3;              // 0x0220
	H13A0_CVB_CSC_CTRL0_T           cvb_csc_ctrl0;                   // 0x0224
	H13A0_CVB_CSC_CTRL1_T           cvb_csc_ctrl1;                   // 0x0228
	H13A0_CVB_CSC_CTRL2_T           cvb_csc_ctrl2;                   // 0x022c
	H13A0_CVB_CSC_CTRL3_T           cvb_csc_ctrl3;                   // 0x0230
	H13A0_CVB_CSC_CTRL4_T           cvb_csc_ctrl4;                   // 0x0234
	H13A0_CVB_CSC_CTRL5_T           cvb_csc_ctrl5;                   // 0x0238
	H13A0_CVB_CSC_CTRL6_T           cvb_csc_ctrl6;                   // 0x023c
	H13A0_CVB_CSC_CTRL7_T           cvb_csc_ctrl7;                   // 0x0240
	H13A0_CVB_MISC_CTRL_T           cvb_misc_ctrl;                   // 0x0244
	H13A0_CVB_OFFSET_READ_T         cvb_offset_read;                 // 0x0248
	H13A0_CVB_PRE3D_CTRL0_T         cvb_pre3d_ctrl0;                 // 0x024c
	H13A0_CVB_PRE3D_CTRL1_T         cvb_pre3d_ctrl1;                 // 0x0250
	H13A0_CVB_PRE3D_CTRL2_T         cvb_pre3d_ctrl2;                 // 0x0254
	H13A0_CVB_SIZE_STATUS1_T        cvb_size_status1;                // 0x0258
	H13A0_CVB_SIZE_STATUS2_T        cvb_size_status2;                // 0x025c
	H13A0_CVB_SIZE_STATUS3_T        cvb_size_status3;                // 0x0260
	H13A0_CVB_SIZE_STATUS4_T        cvb_size_status4;                // 0x0264
	H13A0_CVB_PIX_SUM_CTRL0_T       cvb_pix_sum_ctrl0;               // 0x0268
	H13A0_CVB_PIX_SUM_CTRL1_T       cvb_pix_sum_ctrl1;               // 0x026c
	H13A0_CVB_PIX_SUM_STATUS0_T     cvb_pix_sum_status0;             // 0x0270
	H13A0_CVB_PIX_SUM_STATUS1_T     cvb_pix_sum_status1;             // 0x0274
	H13A0_CVB_PIX_SUM_STATUS2_T     cvb_pix_sum_status2;             // 0x0278
	H13A0_CVB_SYNC_FIL_CTRL_T       cvb_sync_fil_ctrl;               // 0x027c
	H13A0_CVB_SYNC_FIL_STATUS_T     cvb_sync_fil_status;             // 0x0280
	H13A0_CVB_CTI_CTRL_T            cvb_cti_ctrl;                    // 0x0284
	UINT32                          reserved2[2];                    // 0x0288~0x028c
	H13A0_CVB_SYNC_REPEAT_CTRL_T    cvb_sync_repeat_ctrl;            // 0x0290
	H13A0_CVB_SYNC_REPEAT_SIZE0_T   cvb_sync_repeat_size0;           // 0x0294
	H13A0_CVB_SYNC_REPEAT_SIZE1_T   cvb_sync_repeat_size1;           // 0x0298
	H13A0_CVB_SYNC_REPEAT_SIZE2_T   cvb_sync_repeat_size2;           // 0x029c
	H13A0_CVB_SYNC_REPEAT_SIZE3_T   cvb_sync_repeat_size3;           // 0x02a0
	H13A0_CVB_SYNC_REPEAT_SIZE4_T   cvb_sync_repeat_size4;           // 0x02a4
	H13A0_CVB_SYNC_REPEAT_SIZE5_T   cvb_sync_repeat_size5;           // 0x02a8
	H13A0_CVB_DIG_FILT_CTRL4_T      cvb_dig_filt_ctrl4;              // 0x02ac
	H13A0_CVB_DIG_FILT_CTRL5_T      cvb_dig_filt_ctrl5;              // 0x02b0
	H13A0_CVB_DIG_FILT_CTRL6_T      cvb_dig_filt_ctrl6;              // 0x02b4
	UINT32                          reserved3[2];                    // 0x02b8~0x02bc
	H13A0_CVB_SIZE_DETECT_CTRL_T    cvb_size_detect_ctrl;            // 0x02c0
	H13A0_CVB_SIZE_DETECT_READ_T    cvb_size_detect_read;            // 0x02c4
	H13A0_CVB_SIZE_STATUS0_T        cvb_size_status0;                // 0x02c8
	H13A0_CVB_SIZE_STATUS5_T        cvb_size_status5;                // 0x02cc
	H13A0_CVB_SIZE_STATUS6_T        cvb_size_status6;                // 0x02d0
	H13A0_CVB_SIZE_DETECT_CTRL1_T   cvb_size_detect_ctrl1;           // 0x02d4
	H13A0_CVB_SIZE_DETECT_CTRL2_T   cvb_size_detect_ctrl2;           // 0x02d8
	H13A0_CVB_PSEUDO_SYNC_CTRL0_T   cvb_pseudo_sync_ctrl0;           // 0x02dc
	H13A0_CVB_PSEUDO_SYNC_CTRL1_T   cvb_pseudo_sync_ctrl1;           // 0x02e0
	H13A0_CVB_PSEUDO_SYNC_CTRL2_T   cvb_pseudo_sync_ctrl2;           // 0x02e4
	H13A0_CVB_PSEUDO_SYNC_CTRL3_T   cvb_pseudo_sync_ctrl3;           // 0x02e8
	H13A0_CVB_PSEUDO_SYNC_CTRL4_T   cvb_pseudo_sync_ctrl4;           // 0x02ec
} DE_CVB_REG_H13A0_T;
