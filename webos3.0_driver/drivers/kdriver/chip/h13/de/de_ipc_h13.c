 ...
 */
int DE_IPC_H13_Init(UINT32 mcu_id,           \
   ...
   switch(mcu_id)
   {
	   case 0:
		   *pVideoBuffToMCU = (UINT32)ioremap(  \
				   DTVSOC_IPC_FROM_CPU_H13_BASE,\
				   DTVSOC_IPC_FROM_CPU_SIZE);
		   *pVideoBuffFrMCU = (UINT32)ioremap(  \
				   DTVSOC_IPC_FROM_MCU_H13_BASE,\
				   DTVSOC_IPC_FROM_MCU_SIZE);
		   break;
	   case 1:
		   *pVideoBuffToMCU = (UINT32)ioremap(    \
				   DTVSOC_IPC_1_FROM_CPU_H13_BASE,\
				   IPC_1_FROM_CPU_SIZE);
		   *pVideoBuffFrMCU = (UINT32)ioremap(    \
				   DTVSOC_IPC_1_FROM_MCU_H13_BASE,\
				   IPC_1_FROM_MCU_SIZE);
		   break;
	   default:
		   ret = RET_ERROR;
 ...
 * @return RET_OK(0) if success, none zero for otherwise
 */
int DE_IPC_H13_Free(UINT32 *pVideoBuffToMCU, UINT32 *pVideoBuffFrMCU)
{
#ifdef USE_QEMU_SYSTEM
