...
#ifndef _REG_D3P_H13A0_h
#define _REG_D3P_H13A0_h
...
typedef struct {
	H13A0_DEBD_PP_TOP_CTRL_00_T         debd_pp_top_ctrl_00;                 // 0x1300
	H13A0_DEBD_PP_TOP_CTRL_01_T         debd_pp_top_ctrl_01;                 // 0x1304
	H13A0_DEBD_PP_TOP_CTRL_02_T         debd_pp_top_ctrl_02;                 // 0x1308
	UINT32                              reserved0;                           // 0x130c
	H13A0_DEBD_PP_APL_CTRL_00_T         debd_pp_apl_ctrl_00;                 // 0x1310
	H13A0_DEBD_PP_APL_CTRL_01_T         debd_pp_apl_ctrl_01;                 // 0x1314
	H13A0_DEBD_PP_APL_CTRL_02_T         debd_pp_apl_ctrl_02;                 // 0x1318
	H13A0_DEBD_PP_APL_STAT_00_T         debd_pp_apl_stat_00;                 // 0x131c
	H13A0_DEBD_PP_L_LEVEL_CTRL_00_T     debd_pp_l_level_ctrl_00;             // 0x1320
	H13A0_DEBD_PP_R_LEVEL_CTRL_00_T     debd_pp_r_level_ctrl_00;             // 0x1324
	UINT32                              reserved1[2];                        // 0x1328~0x132c
	H13A0_DEBD_PP_L_VSPYC_CTRL_00_T     debd_pp_l_vspyc_ctrl_00;             // 0x1330
	H13A0_DEBD_PP_L_VSPYC_CTRL_01_T     debd_pp_l_vspyc_ctrl_01;             // 0x1334
	H13A0_DEBD_PP_R_VSPYC_CTRL_00_T     debd_pp_r_vspyc_ctrl_00;             // 0x1338
	H13A0_DEBD_PP_R_VSPYC_CTRL_01_T     debd_pp_r_vspyc_ctrl_01;             // 0x133c
	H13A0_DEBD_PP_L_CSC_CTRL_00_T       debd_pp_l_csc_ctrl_00;               // 0x1340
	H13A0_DEBD_PP_L_CSC_CTRL_01_T       debd_pp_l_csc_ctrl_01;               // 0x1344
	H13A0_DEBD_PP_L_CSC_CTRL_02_T       debd_pp_l_csc_ctrl_02;               // 0x1348
	H13A0_DEBD_PP_L_CSC_CTRL_03_T       debd_pp_l_csc_ctrl_03;               // 0x134c
	H13A0_DEBD_PP_L_CSC_CTRL_04_T       debd_pp_l_csc_ctrl_04;               // 0x1350
	H13A0_DEBD_PP_L_CSC_CTRL_05_T       debd_pp_l_csc_ctrl_05;               // 0x1354
	H13A0_DEBD_PP_L_CSC_CTRL_06_T       debd_pp_l_csc_ctrl_06;               // 0x1358
	H13A0_DEBD_PP_L_CSC_CTRL_07_T       debd_pp_l_csc_ctrl_07;               // 0x135c
	H13A0_DEBD_PP_R_CSC_CTRL_00_T       debd_pp_r_csc_ctrl_00;               // 0x1360
	H13A0_DEBD_PP_R_CSC_CTRL_01_T       debd_pp_r_csc_ctrl_01;               // 0x1364
	H13A0_DEBD_PP_R_CSC_CTRL_02_T       debd_pp_r_csc_ctrl_02;               // 0x1368
	H13A0_DEBD_PP_R_CSC_CTRL_03_T       debd_pp_r_csc_ctrl_03;               // 0x136c
	H13A0_DEBD_PP_R_CSC_CTRL_04_T       debd_pp_r_csc_ctrl_04;               // 0x1370
	H13A0_DEBD_PP_R_CSC_CTRL_05_T       debd_pp_r_csc_ctrl_05;               // 0x1374
	H13A0_DEBD_PP_R_CSC_CTRL_06_T       debd_pp_r_csc_ctrl_06;               // 0x1378
	H13A0_DEBD_PP_R_CSC_CTRL_07_T       debd_pp_r_csc_ctrl_07;               // 0x137c
	H13A0_DEBD_PP_LRCR_CTRL_00_T        debd_pp_lrcr_ctrl_00;                // 0x1380
	H13A0_DEBD_PP_LRCR_CTRL_01_T        debd_pp_lrcr_ctrl_01;                // 0x1384
	H13A0_DEBD_PP_LRCR_CTRL_02_T        debd_pp_lrcr_ctrl_02;                // 0x1388
	H13A0_DEBD_PP_LRCR_CTRL_03_T        debd_pp_lrcr_ctrl_03;                // 0x138c
	H13A0_DEBD_PP_LRCR_CTRL_04_T        debd_pp_lrcr_ctrl_04;                // 0x1390
	H13A0_DEBD_PP_LRCR_CTRL_05_T        debd_pp_lrcr_ctrl_05;                // 0x1394
	H13A0_DEBD_PP_LRCR_CTRL_06_T        debd_pp_lrcr_ctrl_06;                // 0x1398
	H13A0_DEBD_PP_LRCR_CTRL_07_T        debd_pp_lrcr_ctrl_07;                // 0x139c
	H13A0_DEBD_PP_LRCR_STAT_00_T        debd_pp_lrcr_stat_00;                // 0x13a0
	H13A0_DEBD_PP_LRCR_STAT_01_T        debd_pp_lrcr_stat_01;                // 0x13a4
	H13A0_DEBD_PP_LRCR_STAT_02_T        debd_pp_lrcr_stat_02;                // 0x13a8
	UINT32                              reserved2;                           // 0x13ac
	H13A0_DEBD_PP_L_G_HIST_IA_CTRL_T    debd_pp_l_g_hist_ia_ctrl;            // 0x13b0
	H13A0_DEBD_PP_L_G_HIST_IA_DATA_T    debd_pp_l_g_hist_ia_data;            // 0x13b4
	H13A0_DEBD_PP_L_B_HIST_IA_CTRL_T    debd_pp_l_b_hist_ia_ctrl;            // 0x13b8
	H13A0_DEBD_PP_L_B_HIST_IA_DATA_T    debd_pp_l_b_hist_ia_data;            // 0x13bc
	H13A0_DEBD_PP_L_R_HIST_IA_CTRL_T    debd_pp_l_r_hist_ia_ctrl;            // 0x13c0
	H13A0_DEBD_PP_L_R_HIST_IA_DATA_T    debd_pp_l_r_hist_ia_data;            // 0x13c4
	H13A0_DEBD_PP_R_G_HIST_IA_CTRL_T    debd_pp_r_g_hist_ia_ctrl;            // 0x13c8
	H13A0_DEBD_PP_R_G_HIST_IA_DATA_T    debd_pp_r_g_hist_ia_data;            // 0x13cc
	H13A0_DEBD_PP_R_B_HIST_IA_CTRL_T    debd_pp_r_b_hist_ia_ctrl;            // 0x13d0
	H13A0_DEBD_PP_R_B_HIST_IA_DATA_T    debd_pp_r_b_hist_ia_data;            // 0x13d4
	H13A0_DEBD_PP_R_R_HIST_IA_CTRL_T    debd_pp_r_r_hist_ia_ctrl;            // 0x13d8
	H13A0_DEBD_PP_R_R_HIST_IA_DATA_T    debd_pp_r_r_hist_ia_data;            // 0x13dc
} DE_P1L_REG_H13A0_T;
