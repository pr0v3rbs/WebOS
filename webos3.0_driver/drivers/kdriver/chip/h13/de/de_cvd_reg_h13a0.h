...
#ifndef _REG_CVD_H13A0_h
#define _REG_CVD_H13A0_h
...
typedef struct {
	...
	UINT32                             : 2;   //  2: 3 reserved
	UINT32 vbi_scmux_sw                : 5;   //  4: 8
	UINT32                             : 3;   //  9:11 reserved
	UINT32 vbi_data_sel                : 2;   // 12:13
	UINT32 vbi_peak_sel                : 1;   //    14
} H13A0_VBI_005_T;
...
} H13A0_IRIS_HIF_CTRL1_001_T;

typedef struct {
	H13A0_CVD_INTR1_ENABLE0_T       cvd_intr1_enable0;               // 0x4100
	H13A0_CVD_INTR1_INTR0_T         cvd_intr1_intr0;                 // 0x4104
	H13A0_CVD_INTR1_CLEAR0_T        cvd_intr1_clear0;                // 0x4108
	H13A0_CVD_INTR1_ENABLE1_T       cvd_intr1_enable1;               // 0x410c
	H13A0_CVD_INTR1_INTR1_T         cvd_intr1_intr1;                 // 0x4110
	H13A0_CVD_INTR1_CLEAR1_T        cvd_intr1_clear1;                // 0x4114
	H13A0_CVD_INTR2_ENABLE0_T       cvd_intr2_enable0;               // 0x4118
	H13A0_CVD_INTR2_INTR0_T         cvd_intr2_intr0;                 // 0x411c
	H13A0_CVD_INTR2_CLEAR0_T        cvd_intr2_clear0;                // 0x4120
	H13A0_CVD_INTR2_ENABLE1_T       cvd_intr2_enable1;               // 0x4124
	H13A0_CVD_INTR2_INTR1_T         cvd_intr2_intr1;                 // 0x4128
	H13A0_CVD_INTR2_CLEAR1_T        cvd_intr2_clear1;                // 0x412c
	H13A0_TOP_001_T                 top_001;                         // 0x4130
	UINT32                          reserved0[3];                    // 0x4134~0x413c
	H13A0_IRIS_MIF_GMUA_001_T       iris_mif_gmua_001;               // 0x4140
	H13A0_IRIS_MIF_GMUA_002_T       iris_mif_gmua_002;               // 0x4144
	H13A0_IRIS_MIF_GMUA_003_T       iris_mif_gmua_003;               // 0x4148
	H13A0_IRIS_MIF_GMUA_004_T       iris_mif_gmua_004;               // 0x414c
	H13A0_IRIS_MIF_GMUA_005_T       iris_mif_gmua_005;               // 0x4150
	H13A0_IRIS_MIF_GMUA_006_T       iris_mif_gmua_006;               // 0x4154
	H13A0_IRIS_MIF_GMUA_007_T       iris_mif_gmua_007;               // 0x4158
	UINT32                          reserved1;                       // 0x415c
	H13A0_IRIS_MIF_GMUA_008_T       iris_mif_gmua_008;               // 0x4160
	H13A0_IRIS_MIF_GMUA_009_T       iris_mif_gmua_009;               // 0x4164
	H13A0_FASTBLANK_001_T           fastblank_001;                   // 0x4168
	H13A0_FASTBLANK_002_T           fastblank_002;                   // 0x416c
	H13A0_FASTBLANK_003_T           fastblank_003;                   // 0x4170
	H13A0_FASTBLANK_004_T           fastblank_004;                   // 0x4174
	H13A0_FASTBLANK_005_T           fastblank_005;                   // 0x4178
	H13A0_FASTBLANK_006_T           fastblank_006;                   // 0x417c
	H13A0_FASTBLANK_007_T           fastblank_007;                   // 0x4180
	H13A0_FASTBLANK_008_T           fastblank_008;                   // 0x4184
	H13A0_FASTBLANK_009_T           fastblank_009;                   // 0x4188
	H13A0_FASTBLANK_010_T           fastblank_010;                   // 0x418c
	H13A0_IRIS_DE_CTRL_001_T        iris_de_ctrl_001;                // 0x4190
	H13A0_VBI_CTRL_001_T            vbi_ctrl_001;                    // 0x4194
	H13A0_VBI_CTRL_002_T            vbi_ctrl_002;                    // 0x4198
	H13A0_VBI_CTRL_003_T            vbi_ctrl_003;                    // 0x419c
	H13A0_VBI_CTRL_004_T            vbi_ctrl_004;                    // 0x41a0
	H13A0_VBI_CTRL_005_T            vbi_ctrl_005;                    // 0x41a4
	H13A0_VBI_CTRL_006_T            vbi_ctrl_006;                    // 0x41a8
	H13A0_VBI_CTRL_007_T            vbi_ctrl_007;                    // 0x41ac
	H13A0_VBI_CTRL_008_T            vbi_ctrl_008;                    // 0x41b0
	H13A0_VBI_CTRL_009_T            vbi_ctrl_009;                    // 0x41b4
	H13A0_VBI_CTRL_010_T            vbi_ctrl_010;                    // 0x41b8
	UINT32                          reserved2;                       // 0x41bc
	H13A0_FAST_BLANK_STATUS_001_T   fast_blank_status_001;           // 0x41c0
	H13A0_CVBSAFE_001_T             cvbsafe_001;                     // 0x41c4
	UINT32                          reserved3[14];                   // 0x41c8~0x41fc
	H13A0_IRIS_001_T                iris_001;                        // 0x4200
	H13A0_IRIS_002_T                iris_002;                        // 0x4204
	H13A0_IRIS_003_T                iris_003;                        // 0x4208
	H13A0_IRIS_004_T                iris_004;                        // 0x420c
	H13A0_IRIS_005_T                iris_005;                        // 0x4210
	H13A0_IRIS_006_T                iris_006;                        // 0x4214
	H13A0_IRIS_007_T                iris_007;                        // 0x4218
	H13A0_IRIS_008_T                iris_008;                        // 0x421c
	H13A0_IRIS_009_T                iris_009;                        // 0x4220
	H13A0_IRIS_010_T                iris_010;                        // 0x4224
	H13A0_IRIS_011_T                iris_011;                        // 0x4228
	UINT32                          reserved4;                       // 0x422c
	H13A0_IRIS_012_T                iris_012;                        // 0x4230
	H13A0_IRIS_013_T                iris_013;                        // 0x4234
	H13A0_IRIS_014_T                iris_014;                        // 0x4238
	H13A0_IRIS_015_T                iris_015;                        // 0x423c
	H13A0_IRIS_016_T                iris_016;                        // 0x4240
	H13A0_IRIS_017_T                iris_017;                        // 0x4244
	H13A0_IRIS_018_T                iris_018;                        // 0x4248
	H13A0_IRIS_019_T                iris_019;                        // 0x424c
	H13A0_IRIS_020_T                iris_020;                        // 0x4250
	H13A0_IRIS_021_T                iris_021;                        // 0x4254
	H13A0_IRIS_022_T                iris_022;                        // 0x4258
	H13A0_IRIS_023_T                iris_023;                        // 0x425c
	H13A0_IRIS_024_T                iris_024;                        // 0x4260
	H13A0_IRIS_025_T                iris_025;                        // 0x4264
	H13A0_IRIS_026_T                iris_026;                        // 0x4268
	H13A0_IRIS_027_T                iris_027;                        // 0x426c
	H13A0_IRIS_028_T                iris_028;                        // 0x4270
	H13A0_IRIS_029_T                iris_029;                        // 0x4274
	H13A0_IRIS_030_T                iris_030;                        // 0x4278
	H13A0_IRIS_031_T                iris_031;                        // 0x427c
	H13A0_IRIS_032_T                iris_032;                        // 0x4280
	H13A0_IRIS_033_T                iris_033;                        // 0x4284
	H13A0_IRIS_034_T                iris_034;                        // 0x4288
	H13A0_IRIS_035_T                iris_035;                        // 0x428c
	H13A0_IRIS_036_T                iris_036;                        // 0x4290
	H13A0_IRIS_037_T                iris_037;                        // 0x4294
	H13A0_IRIS_038_T                iris_038;                        // 0x4298
	H13A0_IRIS_039_T                iris_039;                        // 0x429c
	H13A0_IRIS_040_T                iris_040;                        // 0x42a0
	H13A0_IRIS_041_T                iris_041;                        // 0x42a4
	H13A0_IRIS_042_T                iris_042;                        // 0x42a8
	H13A0_IRIS_043_T                iris_043;                        // 0x42ac
	H13A0_IRIS_044_T                iris_044;                        // 0x42b0
	H13A0_IRIS_045_T                iris_045;                        // 0x42b4
	H13A0_IRIS_046_T                iris_046;                        // 0x42b8
	H13A0_IRIS_047_T                iris_047;                        // 0x42bc
	H13A0_IRIS_048_T                iris_048;                        // 0x42c0
	H13A0_IRIS_049_T                iris_049;                        // 0x42c4
	H13A0_IRIS_050_T                iris_050;                        // 0x42c8
	H13A0_IRIS_051_T                iris_051;                        // 0x42cc
	H13A0_IRIS_052_T                iris_052;                        // 0x42d0
	H13A0_IRIS_053_T                iris_053;                        // 0x42d4
	H13A0_IRIS_054_T                iris_054;                        // 0x42d8
	H13A0_IRIS_055_T                iris_055;                        // 0x42dc
	H13A0_IRIS_056_T                iris_056;                        // 0x42e0
	H13A0_IRIS_057_T                iris_057;                        // 0x42e4
	H13A0_IRIS_058_T                iris_058;                        // 0x42e8
	H13A0_IRIS_059_T                iris_059;                        // 0x42ec
	H13A0_IRIS_060_T                iris_060;                        // 0x42f0
	H13A0_IRIS_061_T                iris_061;                        // 0x42f4
	H13A0_IRIS_062_T                iris_062;                        // 0x42f8
	H13A0_IRIS_063_T                iris_063;                        // 0x42fc
	H13A0_IRIS_064_T                iris_064;                        // 0x4300
	H13A0_IRIS_065_T                iris_065;                        // 0x4304
	H13A0_IRIS_066_T                iris_066;                        // 0x4308
	H13A0_IRIS_067_T                iris_067;                        // 0x430c
	H13A0_IRIS_068_T                iris_068;                        // 0x4310
	H13A0_IRIS_069_T                iris_069;                        // 0x4314
	H13A0_IRIS_070_T                iris_070;                        // 0x4318
	H13A0_IRIS_071_T                iris_071;                        // 0x431c
	H13A0_IRIS_072_T                iris_072;                        // 0x4320
	H13A0_IRIS_073_T                iris_073;                        // 0x4324
	H13A0_IRIS_074_T                iris_074;                        // 0x4328
	H13A0_IRIS_075_T                iris_075;                        // 0x432c
	H13A0_IRIS_076_T                iris_076;                        // 0x4330
	H13A0_IRIS_077_T                iris_077;                        // 0x4334
	H13A0_IRIS_078_T                iris_078;                        // 0x4338
	H13A0_IRIS_079_T                iris_079;                        // 0x433c
	H13A0_IRIS_080_T                iris_080;                        // 0x4340
	H13A0_IRIS_081_T                iris_081;                        // 0x4344
	H13A0_IRIS_082_T                iris_082;                        // 0x4348
	H13A0_IRIS_083_T                iris_083;                        // 0x434c
	H13A0_IRIS_084_T                iris_084;                        // 0x4350
	H13A0_IRIS_085_T                iris_085;                        // 0x4354
	H13A0_IRIS_086_T                iris_086;                        // 0x4358
	H13A0_IRIS_087_T                iris_087;                        // 0x435c
	H13A0_IRIS_088_T                iris_088;                        // 0x4360
	H13A0_IRIS_089_T                iris_089;                        // 0x4364
	H13A0_IRIS_090_T                iris_090;                        // 0x4368
	H13A0_IRIS_091_T                iris_091;                        // 0x436c
	H13A0_IRIS_092_T                iris_092;                        // 0x4370
	H13A0_IRIS_093_T                iris_093;                        // 0x4374
	H13A0_IRIS_094_T                iris_094;                        // 0x4378
	H13A0_IRIS_095_T                iris_095;                        // 0x437c
	H13A0_IRIS_096_T                iris_096;                        // 0x4380
	H13A0_IRIS_097_T                iris_097;                        // 0x4384
	H13A0_IRIS_098_T                iris_098;                        // 0x4388
	H13A0_IRIS_099_T                iris_099;                        // 0x438c
	H13A0_IRIS_100_T                iris_100;                        // 0x4390
	H13A0_IRIS_101_T                iris_101;                        // 0x4394
	H13A0_IRIS_102_T                iris_102;                        // 0x4398
	H13A0_IRIS_103_T                iris_103;                        // 0x439c
	H13A0_IRIS_104_T                iris_104;                        // 0x43a0
	H13A0_IRIS_105_T                iris_105;                        // 0x43a4
	H13A0_IRIS_106_T                iris_106;                        // 0x43a8
	H13A0_IRIS_107_T                iris_107;                        // 0x43ac
	H13A0_IRIS_108_T                iris_108;                        // 0x43b0
	H13A0_IRIS_109_T                iris_109;                        // 0x43b4
	H13A0_IRIS_110_T                iris_110;                        // 0x43b8
	H13A0_IRIS_111_T                iris_111;                        // 0x43bc
	H13A0_IRIS_112_T                iris_112;                        // 0x43c0
	H13A0_IRIS_113_T                iris_113;                        // 0x43c4
	H13A0_IRIS_114_T                iris_114;                        // 0x43c8
	H13A0_IRIS_115_T                iris_115;                        // 0x43cc
	H13A0_IRIS_116_T                iris_116;                        // 0x43d0
	H13A0_IRIS_117_T                iris_117;                        // 0x43d4
	H13A0_IRIS_118_T                iris_118;                        // 0x43d8
	H13A0_IRIS_119_T                iris_119;                        // 0x43dc
	H13A0_IRIS_120_T                iris_120;                        // 0x43e0
	H13A0_IRIS_121_T                iris_121;                        // 0x43e4
	H13A0_IRIS_122_T                iris_122;                        // 0x43e8
	H13A0_IRIS_123_T                iris_123;                        // 0x43ec
	H13A0_IRIS_124_T                iris_124;                        // 0x43f0
	H13A0_IRIS_125_T                iris_125;                        // 0x43f4
	H13A0_IRIS_126_T                iris_126;                        // 0x43f8
	H13A0_IRIS_127_T                iris_127;                        // 0x43fc
	H13A0_IRIS_128_T                iris_128;                        // 0x4400
	H13A0_IRIS_129_T                iris_129;                        // 0x4404
	H13A0_IRIS_130_T                iris_130;                        // 0x4408
	H13A0_IRIS_131_T                iris_131;                        // 0x440c
	H13A0_IRIS_132_T                iris_132;                        // 0x4410
	H13A0_IRIS_133_T                iris_133;                        // 0x4414
	H13A0_IRIS_134_T                iris_134;                        // 0x4418
	H13A0_IRIS_135_T                iris_135;                        // 0x441c
	H13A0_IRIS_136_T                iris_136;                        // 0x4420
	H13A0_IRIS_137_T                iris_137;                        // 0x4424
	H13A0_IRIS_138_T                iris_138;                        // 0x4428
	H13A0_IRIS_139_T                iris_139;                        // 0x442c
	H13A0_IRIS_140_T                iris_140;                        // 0x4430
	H13A0_IRIS_141_T                iris_141;                        // 0x4434
	H13A0_IRIS_142_T                iris_142;                        // 0x4438
	H13A0_IRIS_143_T                iris_143;                        // 0x443c
	H13A0_IRIS_144_T                iris_144;                        // 0x4440
	H13A0_IRIS_145_T                iris_145;                        // 0x4444
	H13A0_IRIS_146_T                iris_146;                        // 0x4448
	H13A0_IRIS_147_T                iris_147;                        // 0x444c
	H13A0_IRIS_148_T                iris_148;                        // 0x4450
	H13A0_IRIS_149_T                iris_149;                        // 0x4454
	H13A0_IRIS_150_T                iris_150;                        // 0x4458
	H13A0_IRIS_151_T                iris_151;                        // 0x445c
	H13A0_IRIS_152_T                iris_152;                        // 0x4460
	H13A0_IRIS_153_T                iris_153;                        // 0x4464
	H13A0_IRIS_154_T                iris_154;                        // 0x4468
	H13A0_IRIS_155_T                iris_155;                        // 0x446c
	H13A0_IRIS_156_T                iris_156;                        // 0x4470
	H13A0_IRIS_157_T                iris_157;                        // 0x4474
	H13A0_IRIS_158_T                iris_158;                        // 0x4478
	H13A0_IRIS_159_T                iris_159;                        // 0x447c
	H13A0_IRIS_160_T                iris_160;                        // 0x4480
	H13A0_IRIS_161_T                iris_161;                        // 0x4484
	H13A0_IRIS_162_T                iris_162;                        // 0x4488
	H13A0_IRIS_163_T                iris_163;                        // 0x448c
	H13A0_IRIS_164_T                iris_164;                        // 0x4490
	H13A0_IRIS_165_T                iris_165;                        // 0x4494
	H13A0_IRIS_166_T                iris_166;                        // 0x4498
	H13A0_IRIS_167_T                iris_167;                        // 0x449c
	H13A0_IRIS_168_T                iris_168;                        // 0x44a0
	H13A0_IRIS_169_T                iris_169;                        // 0x44a4
	H13A0_IRIS_170_T                iris_170;                        // 0x44a8
	H13A0_IRIS_171_T                iris_171;                        // 0x44ac
	H13A0_IRIS_172_T                iris_172;                        // 0x44b0
	H13A0_IRIS_173_T                iris_173;                        // 0x44b4
	H13A0_IRIS_174_T                iris_174;                        // 0x44b8
	H13A0_IRIS_175_T                iris_175;                        // 0x44bc
	H13A0_IRIS_176_T                iris_176;                        // 0x44c0
	H13A0_IRIS_177_T                iris_177;                        // 0x44c4
	H13A0_IRIS_178_T                iris_178;                        // 0x44c8
	H13A0_IRIS_179_T                iris_179;                        // 0x44cc
	H13A0_IRIS_180_T                iris_180;                        // 0x44d0
	H13A0_IRIS_181_T                iris_181;                        // 0x44d4
	H13A0_IRIS_182_T                iris_182;                        // 0x44d8
	H13A0_IRIS_183_T                iris_183;                        // 0x44dc
	H13A0_IRIS_184_T                iris_184;                        // 0x44e0
	H13A0_IRIS_185_T                iris_185;                        // 0x44e4
	H13A0_IRIS_186_T                iris_186;                        // 0x44e8
	H13A0_IRIS_187_T                iris_187;                        // 0x44ec
	H13A0_IRIS_188_T                iris_188;                        // 0x44f0
	H13A0_IRIS_189_T                iris_189;                        // 0x44f4
	H13A0_IRIS_190_T                iris_190;                        // 0x44f8
	H13A0_IRIS_191_T                iris_191;                        // 0x44fc
	H13A0_IRIS_192_T                iris_192;                        // 0x4500
	H13A0_IRIS_193_T                iris_193;                        // 0x4504
	H13A0_IRIS_194_T                iris_194;                        // 0x4508
	H13A0_IRIS_195_T                iris_195;                        // 0x450c
	H13A0_IRIS_196_T                iris_196;                        // 0x4510
	H13A0_IRIS_197_T                iris_197;                        // 0x4514
	H13A0_IRIS_198_T                iris_198;                        // 0x4518
	H13A0_IRIS_199_T                iris_199;                        // 0x451c
	H13A0_IRIS_200_T                iris_200;                        // 0x4520
	H13A0_IRIS_201_T                iris_201;                        // 0x4524
	H13A0_IRIS_202_T                iris_202;                        // 0x4528
	H13A0_IRIS_203_T                iris_203;                        // 0x452c
	H13A0_IRIS_204_T                iris_204;                        // 0x4530
	H13A0_IRIS_205_T                iris_205;                        // 0x4534
	H13A0_IRIS_206_T                iris_206;                        // 0x4538
	H13A0_IRIS_207_T                iris_207;                        // 0x453c
	H13A0_IRIS_208_T                iris_208;                        // 0x4540
	H13A0_IRIS_209_T                iris_209;                        // 0x4544
	H13A0_IRIS_210_T                iris_210;                        // 0x4548
	H13A0_IRIS_211_T                iris_211;                        // 0x454c
	H13A0_IRIS_212_T                iris_212;                        // 0x4550
	H13A0_IRIS_213_T                iris_213;                        // 0x4554
	H13A0_IRIS_214_T                iris_214;                        // 0x4558
	H13A0_IRIS_215_T                iris_215;                        // 0x455c
	H13A0_IRIS_216_T                iris_216;                        // 0x4560
	H13A0_IRIS_217_T                iris_217;                        // 0x4564
	H13A0_IRIS_218_T                iris_218;                        // 0x4568
	H13A0_IRIS_219_T                iris_219;                        // 0x456c
	H13A0_IRIS_220_T                iris_220;                        // 0x4570
	H13A0_IRIS_221_T                iris_221;                        // 0x4574
	H13A0_IRIS_222_T                iris_222;                        // 0x4578
	H13A0_IRIS_223_T                iris_223;                        // 0x457c
	H13A0_IRIS_224_T                iris_224;                        // 0x4580
	H13A0_IRIS_225_T                iris_225;                        // 0x4584
	H13A0_IRIS_226_T                iris_226;                        // 0x4588
	H13A0_IRIS_227_T                iris_227;                        // 0x458c
	H13A0_IRIS_228_T                iris_228;                        // 0x4590
	H13A0_IRIS_229_T                iris_229;                        // 0x4594
	H13A0_IRIS_230_T                iris_230;                        // 0x4598
	H13A0_IRIS_231_T                iris_231;                        // 0x459c
	H13A0_IRIS_232_T                iris_232;                        // 0x45a0
	H13A0_IRIS_233_T                iris_233;                        // 0x45a4
	H13A0_IRIS_234_T                iris_234;                        // 0x45a8
	H13A0_IRIS_235_T                iris_235;                        // 0x45ac
	H13A0_IRIS_236_T                iris_236;                        // 0x45b0
	H13A0_IRIS_237_T                iris_237;                        // 0x45b4
	H13A0_IRIS_238_T                iris_238;                        // 0x45b8
	H13A0_IRIS_239_T                iris_239;                        // 0x45bc
	H13A0_IRIS_240_T                iris_240;                        // 0x45c0
	H13A0_IRIS_241_T                iris_241;                        // 0x45c4
	H13A0_IRIS_242_T                iris_242;                        // 0x45c8
	H13A0_IRIS_243_T                iris_243;                        // 0x45cc
	H13A0_IRIS_244_T                iris_244;                        // 0x45d0
	H13A0_IRIS_245_T                iris_245;                        // 0x45d4
	H13A0_IRIS_246_T                iris_246;                        // 0x45d8
	H13A0_IRIS_247_T                iris_247;                        // 0x45dc
	H13A0_IRIS_248_T                iris_248;                        // 0x45e0
	H13A0_IRIS_249_T                iris_249;                        // 0x45e4
	H13A0_IRIS_250_T                iris_250;                        // 0x45e8
	H13A0_IRIS_251_T                iris_251;                        // 0x45ec
	H13A0_IRIS_252_T                iris_252;                        // 0x45f0
	H13A0_IRIS_253_T                iris_253;                        // 0x45f4
	H13A0_IRIS_254_T                iris_254;                        // 0x45f8
	H13A0_IRIS_255_T                iris_255;                        // 0x45fc
	H13A0_IRIS_256_T                iris_256;                        // 0x4600
	H13A0_IRIS_257_T                iris_257;                        // 0x4604
	H13A0_IRIS_258_T                iris_258;                        // 0x4608
	H13A0_IRIS_259_T                iris_259;                        // 0x460c
	H13A0_IRIS_260_T                iris_260;                        // 0x4610
	H13A0_IRIS_261_T                iris_261;                        // 0x4614
	H13A0_IRIS_262_T                iris_262;                        // 0x4618
	H13A0_IRIS_263_T                iris_263;                        // 0x461c
	H13A0_IRIS_264_T                iris_264;                        // 0x4620
	H13A0_IRIS_265_T                iris_265;                        // 0x4624
	UINT32                          reserved5[2];                    // 0x4628~0x462c
	H13A0_IRIS_266_T                iris_266;                        // 0x4630
	H13A0_IRIS_267_T                iris_267;                        // 0x4634
	H13A0_IRIS_268_T                iris_268;                        // 0x4638
	H13A0_IRIS_269_T                iris_269;                        // 0x463c
	H13A0_IRIS_270_T                iris_270;                        // 0x4640
	H13A0_IRIS_271_T                iris_271;                        // 0x4644
	H13A0_IRIS_272_T                iris_272;                        // 0x4648
	H13A0_IRIS_273_T                iris_273;                        // 0x464c
	H13A0_IRIS_274_T                iris_274;                        // 0x4650
	H13A0_IRIS_275_T                iris_275;                        // 0x4654
	H13A0_IRIS_276_T                iris_276;                        // 0x4658
	H13A0_IRIS_277_T                iris_277;                        // 0x465c
	H13A0_IRIS_278_T                iris_278;                        // 0x4660
	H13A0_IRIS_279_T                iris_279;                        // 0x4664
	H13A0_IRIS_280_T                iris_280;                        // 0x4668
	H13A0_IRIS_281_T                iris_281;                        // 0x466c
	H13A0_IRIS_282_T                iris_282;                        // 0x4670
	H13A0_IRIS_283_T                iris_283;                        // 0x4674
	H13A0_IRIS_284_T                iris_284;                        // 0x4678
	H13A0_IRIS_285_T                iris_285;                        // 0x467c
	H13A0_IRIS_286_T                iris_286;                        // 0x4680
	H13A0_IRIS_287_T                iris_287;                        // 0x4684
	H13A0_IRIS_288_T                iris_288;                        // 0x4688
	H13A0_IRIS_289_T                iris_289;                        // 0x468c
	H13A0_IRIS_290_T                iris_290;                        // 0x4690
	H13A0_IRIS_291_T                iris_291;                        // 0x4694
	H13A0_IRIS_292_T                iris_292;                        // 0x4698
	H13A0_IRIS_293_T                iris_293;                        // 0x469c
	H13A0_IRIS_294_T                iris_294;                        // 0x46a0
	H13A0_IRIS_295_T                iris_295;                        // 0x46a4
	H13A0_IRIS_296_T                iris_296;                        // 0x46a8
	H13A0_IRIS_297_T                iris_297;                        // 0x46ac
	H13A0_IRIS_298_T                iris_298;                        // 0x46b0
	H13A0_IRIS_299_T                iris_299;                        // 0x46b4
	H13A0_IRIS_300_T                iris_300;                        // 0x46b8
	H13A0_IRIS_301_T                iris_301;                        // 0x46bc
	H13A0_IRIS_302_T                iris_302;                        // 0x46c0
	H13A0_IRIS_303_T                iris_303;                        // 0x46c4
	H13A0_IRIS_304_T                iris_304;                        // 0x46c8
	H13A0_IRIS_305_T                iris_305;                        // 0x46cc
	H13A0_IRIS_306_T                iris_306;                        // 0x46d0
	H13A0_IRIS_307_T                iris_307;                        // 0x46d4
	UINT32                          reserved6[74];                   // 0x46d8~0x47fc
	H13A0_VBI_001_T                 vbi_001;                         // 0x4800
	H13A0_VBI_002_T                 vbi_002;                         // 0x4804
	H13A0_VBI_003_T                 vbi_003;                         // 0x4808
	H13A0_VBI_004_T                 vbi_004;                         // 0x480c
	H13A0_VBI_005_T                 vbi_005;                         // 0x4810
	H13A0_VBI_006_T                 vbi_006;                         // 0x4814
	H13A0_VBI_007_T                 vbi_007;                         // 0x4818
	H13A0_VBI_008_T                 vbi_008;                         // 0x481c
	H13A0_VBI_009_T                 vbi_009;                         // 0x4820
	H13A0_VBI_010_T                 vbi_010;                         // 0x4824
	H13A0_VBI_011_T                 vbi_011;                         // 0x4828
	H13A0_VBI_012_T                 vbi_012;                         // 0x482c
	H13A0_VBI_013_T                 vbi_013;                         // 0x4830
	H13A0_VBI_014_T                 vbi_014;                         // 0x4834
	H13A0_VBI_015_T                 vbi_015;                         // 0x4838
	H13A0_VBI_016_T                 vbi_016;                         // 0x483c
	H13A0_VBI_017_T                 vbi_017;                         // 0x4840
	H13A0_VBI_018_T                 vbi_018;                         // 0x4844
	H13A0_VBI_019_T                 vbi_019;                         // 0x4848
	H13A0_VBI_020_T                 vbi_020;                         // 0x484c
	H13A0_VBI_021_T                 vbi_021;                         // 0x4850
	H13A0_VBI_022_T                 vbi_022;                         // 0x4854
	H13A0_VBI_023_T                 vbi_023;                         // 0x4858
	UINT32                          reserved7[19];                   // 0x485c~0x48a4
	H13A0_IRIS_MIF_GMUA_MON_001_T   iris_mif_gmua_mon_001;           // 0x48a8
	H13A0_IRIS_MIF_GMUA_MON_002_T   iris_mif_gmua_mon_002;           // 0x48ac
	H13A0_IRIS_MIF_GMUA_MON_003_T   iris_mif_gmua_mon_003;           // 0x48b0
	H13A0_IRIS_MIF_GMUA_MON_004_T   iris_mif_gmua_mon_004;           // 0x48b4
	H13A0_IRIS_MIF_GMUA_MON_005_T   iris_mif_gmua_mon_005;           // 0x48b8
	H13A0_IRIS_MIF_GMUA_MON_006_T   iris_mif_gmua_mon_006;           // 0x48bc
	H13A0_IRIS_MIF_GMUA_MON_007_T   iris_mif_gmua_mon_007;           // 0x48c0
	H13A0_IRIS_MIF_GMUA_MON_008_T   iris_mif_gmua_mon_008;           // 0x48c4
	H13A0_IRIS_MIF_GMUA_MON_009_T   iris_mif_gmua_mon_009;           // 0x48c8
	H13A0_IRIS_MIF_GMUA_MON_010_T   iris_mif_gmua_mon_010;           // 0x48cc
	H13A0_IRIS_MIF_GMUA_MON_011_T   iris_mif_gmua_mon_011;           // 0x48d0
	H13A0_IRIS_MIF_GMUA_MON_012_T   iris_mif_gmua_mon_012;           // 0x48d4
	H13A0_IRIS_MIF_GMUA_MON_013_T   iris_mif_gmua_mon_013;           // 0x48d8
	H13A0_IRIS_MIF_GMUA_MON_014_T   iris_mif_gmua_mon_014;           // 0x48dc
	H13A0_IRIS_MIF_GMUA_MON_015_T   iris_mif_gmua_mon_015;           // 0x48e0
	H13A0_IRIS_MIF_GMUA_MON_016_T   iris_mif_gmua_mon_016;           // 0x48e4
	H13A0_IRIS_MIF_GMUA_MON_017_T   iris_mif_gmua_mon_017;           // 0x48e8
	H13A0_IRIS_MIF_GMUA_MON_018_T   iris_mif_gmua_mon_018;           // 0x48ec
	H13A0_IRIS_MIF_GMUA_MON_019_T   iris_mif_gmua_mon_019;           // 0x48f0
	H13A0_IRIS_MIF_GMUA_MON_020_T   iris_mif_gmua_mon_020;           // 0x48f4
	H13A0_IRIS_MIF_GMUA_MON_021_T   iris_mif_gmua_mon_021;           // 0x48f8
	H13A0_IRIS_MIF_GMUA_MON_022_T   iris_mif_gmua_mon_022;           // 0x48fc
	H13A0_IRIS_HIF_CTRL0_001_T      iris_hif_ctrl0_001;              // 0x4900
	H13A0_IRIS_HIF_CTRL1_001_T      iris_hif_ctrl1_001;              // 0x4904
} DE_CVD_REG_H13A0_T;
