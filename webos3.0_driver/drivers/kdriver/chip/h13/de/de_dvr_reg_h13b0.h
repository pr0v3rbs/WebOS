...
#ifndef _REG_DVR_H13B0_h
#define _REG_DVR_H13B0_h
...
} H13B0_DVR_C_STRIDE_T;

typedef struct {
	H13B0_DVR_STATUS_T      dvr_status;              // 0x5ca0
	H13B0_DVR_DSIZE_T       dvr_dsize;               // 0x5ca4
	H13B0_DVR_DECSIZE_T     dvr_decsize;             // 0x5ca8
	H13B0_DVR_HOFFSET_T     dvr_hoffset;             // 0x5cac
	H13B0_DVR_VOFFSET_T     dvr_voffset;             // 0x5cb0
	H13B0_DVR_SEQINFO_T     dvr_seqinfo;             // 0x5cb4
	H13B0_DVR_PICINFO_T     dvr_picinfo;             // 0x5cb8
	H13B0_DVR_PTSINFO_T     dvr_ptsinfo;             // 0x5cbc
	H13B0_DVR_Y_ADDR_T      dvr_y_addr;              // 0x5cc0
	H13B0_DVR_Y_STRIDE_T    dvr_y_stride;            // 0x5cc4
	H13B0_DVR_C_ADDR_T      dvr_c_addr;              // 0x5cc8
	H13B0_DVR_C_STRIDE_T    dvr_c_stride;            // 0x5ccc
} DE_DVR_REG_H13B0_T;
