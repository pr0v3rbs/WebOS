...
#include "../../chip/h13/os/linux_irqs.h"
...
----------------------------------------------------------------------------------------*/
#ifdef INCLUDE_H13_CHIP_KDRV
UINT32 		gpio_intr_num_h13[GPIO_IRQ_NUM_NR] = {H13_IRQ_GPIO0_2,H13_IRQ_GPIO3_5,H13_IRQ_GPIO6_8,H13_IRQ_GPIO9_11,H13_IRQ_GPIO12_14,H13_IRQ_GPIO15_17};
...
========================================================================================*/
 ...
 void _GPIO_ISR_GPIO_H13( unsigned int ui32IRQNum, unsigned int IntData )
{
	UINT32	gpio_array_n;
	...
	if (ui32IRQNum >= H13_IRQ_GPIO0_2 && ui32IRQNum <=H13_IRQ_GPIO9_11)
		gpio_array_n = ui32IRQNum-H13_IRQ_GPIO0_2;
	else if(ui32IRQNum >= H13_IRQ_GPIO12_14 && ui32IRQNum <=H13_IRQ_GPIO15_17)
		gpio_array_n = ui32IRQNum-H13_IRQ_GPIO12_14;
	else
	{
	...
	switch( ui32IRQNum )
	{
		case H13_IRQ_GPIO0_2 :
			gpio_array_n = 0;
			break;
		case H13_IRQ_GPIO3_5 :
			gpio_array_n = 3;
			break;
		case H13_IRQ_GPIO6_8 :
			gpio_array_n = 6;
			break;
		case H13_IRQ_GPIO9_11 :
			gpio_array_n = 9;
			break;
		case H13_IRQ_GPIO12_14 :
			gpio_array_n = 12;
			break;
		case H13_IRQ_GPIO15_17 :
			gpio_array_n = 15;
			break;
			...
			if ( GPIONIE(gpio_array_n) & ( 1 << ucGpio ) )
			{
				...
				if (gpio_isr_info[realGpio].count_enable == 0)
				{
						...
						)
					{
						...
						GPIO_ERROR("_GPIO_ISR_GPIO_H13 h13b0 pin[%d] value[%d]\n",realGpio, value);
					}
					else
					{
						_GPIO_GetValue(realGpio, &value );
						GPIO_DEBUG("_GPIO_ISR_GPIO_H13 		pin[%d] value[%d]\n",realGpio, value);
					}
