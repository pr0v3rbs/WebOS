...
static int slt_open( void )
{
	...
	SLT_REG = (volatile H13_SLT_REG_T*)ioremap(H13_SLT_BASE, sizeof(H13_SLT_REG_T) );
	ret |= request_irq( H13_IRQ_SLT, (irq_handler_t)slt_isr, IRQF_DISABLED, "SLT", NULL );
