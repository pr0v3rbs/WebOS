...
LX_DEMOD_COMMON_REG_T 	*gpRegH13COMMON_Ax;
LX_DEMOD_SYNC_REG_T 	*gpRegH13SYNC_Ax;	
LX_DEMOD_EQ_V_REG_T 	*gpRegH13EQ_V_Ax; 	
LX_DEMOD_EQ_DI_REG_T 	*gpRegH13EQ_DI_Ax;	
LX_DEMOD_EQ_CQS_REG_T 	*gpRegH13CQS_Ax; 	
LX_DEMOD_FEC_REG_T	 	*gpRegH13FEC_Ax; 	
...
{
	gpRegH13COMMON_Ax 	=  (LX_DEMOD_COMMON_REG_T*)OS_KMalloc(sizeof(LX_DEMOD_COMMON_REG_T));
	gpRegH13SYNC_Ax		=  (LX_DEMOD_SYNC_REG_T*)OS_KMalloc(sizeof(LX_DEMOD_SYNC_REG_T));
	gpRegH13EQ_V_Ax 	=  (LX_DEMOD_EQ_V_REG_T*)OS_KMalloc(sizeof(LX_DEMOD_EQ_V_REG_T));
	gpRegH13EQ_DI_Ax	=  (LX_DEMOD_EQ_DI_REG_T*)OS_KMalloc(sizeof(LX_DEMOD_EQ_DI_REG_T));
	gpRegH13CQS_Ax 		=  (LX_DEMOD_EQ_CQS_REG_T*)OS_KMalloc(sizeof(LX_DEMOD_EQ_CQS_REG_T));
	gpRegH13FEC_Ax 		=  (LX_DEMOD_FEC_REG_T*)OS_KMalloc(sizeof(LX_DEMOD_FEC_REG_T));
