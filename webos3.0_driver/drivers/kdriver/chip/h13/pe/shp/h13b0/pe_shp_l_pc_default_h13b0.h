const PE_REG_PARAM_T shp_l_pc_default_h13b0[] =
{
	...
	{0x53D0, 0x00000000},  //PE1_DERH_CTRL_00
	                       // [ 1: 0]=0x1(1) : vsum_mode
	                       // [ 3: 2]=0x2(2) : hsum_mode
	                       // [    4]=0x0(0) : vsum121_en
	...
	{0x53E8, 0x85100400},  //PE1_DERH_CTRL_06
	...
	{0x53EC, 0x10000000},  //PE1_DERH_CTRL_07
	...
	{0x5400, 0x00000000},  //PE1_DERV_CTRL_0
	                       // [    0]=0x1(1) : der_v_en
	...
	{0x5404, 0x00000010},  //PE1_DERV_CTRL_1
	                       ...
	                       // [    8]=0x0(0) : csft_mode
	{0x5408, 0x40200007},  //PE1_DERV_CTRL_2
	                       // [ 2: 0]=0x7(7) : mmd_sel
	                       // [ 6: 4]=0x0(0) : max_sel
	                       // [ 9: 8]=0x0(0) : avg_sel
	                       // [23:16]=0x20(32) : gain_th1
	                       // [31:24]=0x40(64) : gain_th2
	{0x540C, 0x00001030},  //PE1_DERV_CTRL_3
	                       // [ 6: 0]=0x30(48) : gain_b
	                       // [14: 8]=0x10(16) : gain_w
	...
	{0x5420, 0x1B3C2EDF},  //PE1_CORING_STAT_00
	                       // [15: 0]=0x2edf(11999) : tm_h
	                       // [31:16]=0x1b3c(6972) : tm_v
	{0x5424, 0x00004727},  //PE1_CORING_STAT_01
	...
	{0x54F0, 0x00000000},  //PE1_MP_CTRL_00
	                       // [    0]=0x1(1) : edge_enhance_enable
	                       // [13:12]=0x0(0) : Edge_operator_selection
	...
	{0x5524, 0x0000FFFF},  //PE1_MP_CTRL_0C
	                       // [ 7: 0]=0xff(255) : lum2_y1
	                       // [15: 8]=0xff(255) : lum2_y2
	{0x5530, 0x00000000},  //PE1_CTI_CTRL_00
	                       // [    0]=0x1(1) : cti_en
	                       // [ 6: 4]=0x6(6) : filter_tap_size
	                       // [15: 8]=0x30(48) : cti_gain
	{0x5534, 0x00011810},  //PE1_CTI_CTRL_01
	...
	{0x5550, 0x00000000},  //PE1_BLUR_CTRL
	                       // [    0]=0x0(0) : enable
	                       // [    1]=0x1(1) : coring_en
	                       // [ 5: 4]=0x0(0) : direction
	                       // [15: 8]=0x0(0) : gain
	...
	{0x5564, 0x40100200},  //PE1_CORING_CTRL_01
	                       // [ 2: 0]=0x0(0) : max_sel
	                       // [ 5: 4]=0x0(0) : avg_sel
	                       // [13: 8]=0x2(2) : a2tw_min
	...
	{0x556C, 0x00040C01},  //PE1_CORING_CTRL_03
	                       ...
	                       // [13: 8]=0xc(12) : nrh_th1
	                       // [21:16]=0x4(4) : nrh_th2
	{0x5570, 0x00210703},  //PE1_CORING_CTRL_04
	                       // [ 1: 0]=0x3(3) : dflt_sel
	...
	{0x5574, 0x0110010D},  //PE1_CORING_CTRL_05
	                       // [ 5: 0]=0xd(13) : gt_max
	                       // [15: 8]=0x1(1) : gt_th0
	                       // [23:16]=0x10(16) : gt_th1
	                       // [   24]=0x1(1) : a2tw_en
	{0x5578, 0x08040802},  //PE1_CORING_CTRL_06
	                       // [ 7: 0]=0x2(2) : gt_th0a
	                       // [15: 8]=0x8(8) : gt_th0b
	...
	{0x5580, 0x00000000},  //PE1_CORING_CTRL_08
	...
	{0x5590, 0x00000000},  //PE1_DJ_CTRL_00
	                       // [    0]=0x1(1) : edf_en
	...
	{0x5594, 0x00001000},  //PE1_DJ_CTRL_01
	                       // [ 7: 0]=0x0(0) : level_th
	                       // [15: 8]=0x10(16) : protect_th
	                       // [23:16]=0x0(0) : n_avg_gain
	{0x5598, 0x0000100B},  //PE1_DJ_CTRL_02
	                       // [ 4: 0]=0xb(11) : edf_count_min
	                       // [12: 8]=0x10(16) : edf_count_max
	{0x559C, 0x100B100B},  //PE1_DJ_CTRL_03
