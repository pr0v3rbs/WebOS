const PE_REG_PARAM_T shp_l_3d_tb_ss_default_h13b0[] =
{
	...
	{0x5400, 0x0110100F}, // PE1_DERV_CTRL_0
                          // [    0]=0x1(1) : der_v_en
                          // [ 2: 1]=0x3(3) : der_gain_mapping
                          // [    3]=0x1(1) : bif_en
                          // [ 7: 4]=0x0(0) : output_mux
                          // [15: 8]=0x10(16) : bif_manual_th
                          // [21:16]=0x10(16) : th_gain
                          // [   24]=0x1(1) : th_mode
	...
	{0x5414, 0x20201020}, // PE1_DP_CTRL_01
	...
	{0x5474, 0x05035020}, // PE1_DERH_CTRL_0B
                          // [ 7: 0]=0x20(32) : e_gain_th1
                          // [15: 8]=0x50(80) : e_gain_th2
	...
	{0x5494, 0x08202020}, // PE1_SP_CTRL_01
	...
	{0x54AC, 0x00001000}, // PE1_SP_CTRL_06
                          ...
                          // [    4]=0x0(0) : lap_v_mode
	{0x54B0, 0x00141001}, // PE1_SP_CTRL_07
                          // [    0]=0x1(1) : gb_en
                          // [    4]=0x0(0) : gb_mode
                          // [15: 8]=0x10(16) : gb_x1
                          // [23:16]=0x14(20) : gb_y1
	{0x54B4, 0x00603020}, // PE1_SP_CTRL_08
                          // [ 7: 0]=0x20(32) : gb_x2
                          // [15: 8]=0x30(48) : gb_y2
                          // [23:16]=0x60(96) : gb_y3
	...
	{0x54F0, 0x00000001}, // PE1_MP_CTRL_00
                          // [    0]=0x1(1) : edge_enhance_enable
                          // [13:12]=0x0(0) : Edge_operator_selection
	{0x54F4, 0x04142020}, // PE1_MP_CTRL_01
                          // [ 6: 0]=0x20(32) : white_gain
                          // [14: 8]=0x20(32) : black_gain
                          // [23:16]=0x14(20) : horizontal_gain
                          // [31:24]=0x4(4) : vertical_gain
	...
	{0x5510, 0x00141001}, // PE1_MP_CTRL_07
                          // [    0]=0x1(1) : gb_en
                          // [    4]=0x0(0) : gb_mode
                          // [15: 8]=0x10(16) : gb_x1
                          // [23:16]=0x14(20) : gb_y1
	{0x5514, 0x00604020}, // PE1_MP_CTRL_08
                          // [ 7: 0]=0x20(32) : gb_x2
                          // [15: 8]=0x40(64) : gb_y2
                          // [23:16]=0x60(96) : gb_y3
	...
	{0x5560, 0x03630A28}, // PE1_CORING_CTRL_00
                          // [ 5: 0]=0x28(40) : ga_max
                          // [15: 8]=0xa(10) : ga_th0
                          // [23:16]=0x63(99) : ga_th1
                          // [25:24]=0x3(3) : amap1_sel
                          // [27:26]=0x0(0) : amap2_sel
                          // [   28]=0x0(0) : edge_a_sel
                          // [   29]=0x0(0) : debug_a_sel
	{0x5564, 0x60200621}, // PE1_CORING_CTRL_01
                          // [ 2: 0]=0x1(1) : max_sel
                          // [ 5: 4]=0x2(2) : avg_sel
                          // [13: 8]=0x6(6) : a2tw_min
	...
	{0x556C, 0x00040C01}, // PE1_CORING_CTRL_03
                          ...
                          // [13: 8]=0xc(12) : nrh_th1
                          // [21:16]=0x4(4) : nrh_th2
	{0x5570, 0x00220700}, // PE1_CORING_CTRL_04
                          // [ 1: 0]=0x0(0) : dflt_sel
	...
	{0x5574, 0x01400410}, // PE1_CORING_CTRL_05
                          // [ 5: 0]=0x10(16) : gt_max
                          // [15: 8]=0x4(4) : gt_th0
                          // [23:16]=0x40(64) : gt_th1
                          // [   24]=0x1(1) : a2tw_en
	{0x5578, 0x0C082010}, // PE1_CORING_CTRL_06
                          // [ 7: 0]=0x10(16) : gt_th0a
                          // [15: 8]=0x20(32) : gt_th0b
                          // [21:16]=0x8(8) : gt_gain0a
                          // [29:24]=0xc(12) : gt_gain0b
	{0x557C, 0x40403B2A}, // PE1_CORING_CTRL_07
                          // [ 7: 0]=0x2a(42) : g_th0
                          // [15: 8]=0x3b(59) : g_th1
	...
	{0x5584, 0x20201020}, // PE1_CORING_CTRL_09
                          // [ 6: 0]=0x20(32) : edge_gain_b
                          // [14: 8]=0x10(16) : edge_gain_w
                          // [22:16]=0x20(32) : texture_gain_b
                          // [30:24]=0x20(32) : texture_gain_w
