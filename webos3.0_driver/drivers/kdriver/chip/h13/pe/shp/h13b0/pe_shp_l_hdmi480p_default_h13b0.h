...
*/ 
const PE_REG_PARAM_T shp_l_hdmi480p_default_h13b0[] =
{
	...
	{0x05E4, 0x00280001},
	/* SHP */
	{0x53D0, 0x08030109}, // PE1_DERH_CTRL_00
                         //[ 1: 0]=0x1(1) : vsum_mode
                         //[ 3: 2]=0x2(2) : hsum_mode
                         //[    4]=0x0(0) : vsum121_en
	...
	{0x53E8, 0x850C0800}, // PE1_DERH_CTRL_06
	...
	{0x5400, 0x0006200B}, // PE1_DERV_CTRL_0
                         //[    0]=0x1(1) : der_v_en
                         ...
                         //[21:16]=0x6(6) : th_gain
                         //[   24]=0x0(0) : th_mode
	{0x5404, 0x00000008}, // PE1_DERV_CTRL_1
                         //[ 5: 0]=0x8(8) : csft_gain
                         //[    8]=0x0(0) : csft_mode
	{0x5408, 0x44280013}, // PE1_DERV_CTRL_2
                         //[ 2: 0]=0x3(3) : mmd_sel
                         //[ 6: 4]=0x1(1) : max_sel
                         //[ 9: 8]=0x0(0) : avg_sel
                         //[23:16]=0x28(40) : gain_th1
                         //[31:24]=0x44(68) : gain_th2
	{0x540C, 0x00001010}, // PE1_DERV_CTRL_3
                         //[ 6: 0]=0x10(16) : gain_b
                         //[14: 8]=0x10(16) : gain_w
	{0x5410, 0x00000000}, // PE1_DP_CTRL_00
                         //[ 2: 0]=0x0(0) : debug_display
	{0x5414, 0x20201818}, // PE1_DP_CTRL_01
                         //[ 6: 0]=0x10(16) : edge_gain_b
                         //[14: 8]=0x10(16) : edge_gain_w
                         //[22:16]=0x18(24) : texture_gain_b
                         //[30:24]=0x18(24) : texture_gain_w
	...
	{0x5474, 0x08034020}, // PE1_DERH_CTRL_0B
                         //[ 7: 0]=0x20(32) : e_gain_th1
                         //[15: 8]=0x40(64) : e_gain_th2
	...
	{0x54AC, 0x00001000}, // PE1_SP_CTRL_06
                         ...
                         //[    4]=0x0(0) : lap_v_mode
	{0x54B0, 0x000C0C01}, // PE1_SP_CTRL_07
                         //[    0]=0x1(1) : gb_en
                         //[    4]=0x0(0) : gb_mode
                         //[15: 8]=0xc(12) : gb_x1
                         //[23:16]=0xc(12) : gb_y1
	...
	{0x54F0, 0x00000001}, // PE1_MP_CTRL_00
                         //[    0]=0x1(1) : edge_enhance_enable
                         //[13:12]=0x0(0) : Edge_operator_selection
	{0x54F4, 0x10202020}, // PE1_MP_CTRL_01
                         //[ 6: 0]=0x20(32) : white_gain
                         //[14: 8]=0x20(32) : black_gain
                         //[23:16]=0x20(32) : horizontal_gain
                         //[31:24]=0x10(16) : vertical_gain
	{0x54F8, 0x20014020}, // PE1_MP_CTRL_02
                         //[ 7: 0]=0x20(32) : sobel_weight
                         //[15: 8]=0x40(64) : laplacian_weight
                         //[   16]=0x1(1) : sobel_manual_mode_en
                         //[31:24]=0x20(32) : sobel_manual_gain
	...
	{0x550C, 0x00001013}, // PE1_MP_CTRL_06
                         //[ 2: 0]=0x3(3) : lap_h_mode
	...
	{0x5524, 0x0000FFFF}, // PE1_MP_CTRL_0C
                         //[ 7: 0]=0xff(255) : lum2_y1
                         //[15: 8]=0xff(255) : lum2_y2
	{0x5530, 0x80201051}, // PE1_CTI_CTRL_00
                         //[    0]=0x1(1) : cti_en
	...
	{0x5540, 0x00000050}, // PE1_TI_CTRL_0
                         //[    0]=0x0(0) : enable
	...
	{0x5560, 0x00401020}, // PE1_CORING_CTRL_00
                         //[ 5: 0]=0x20(32) : ga_max
                         //[15: 8]=0x10(16) : ga_th0
                         //[23:16]=0x40(64) : ga_th1
                         //[25:24]=0x0(0) : amap1_sel
                         //[27:26]=0x0(0) : amap2_sel
                         //[   28]=0x0(0) : edge_a_sel
                         //[   29]=0x0(0) : debug_a_sel
	{0x5564, 0x50200A07}, // PE1_CORING_CTRL_01
                         //[ 2: 0]=0x7(7) : max_sel
                         //[ 5: 4]=0x0(0) : avg_sel
                         //[13: 8]=0xa(10) : a2tw_min
                         //[23:16]=0x20(32) : a2tw_th0
                         //[31:24]=0x50(80) : a2tw_th1
	...
	{0x556C, 0x00040C01}, // PE1_CORING_CTRL_03
                         ...
                         //[13: 8]=0xc(12) : nrh_th1
                         //[21:16]=0x4(4) : nrh_th2
	{0x5570, 0x01210503}, // PE1_CORING_CTRL_04
                         //[ 1: 0]=0x3(3) : dflt_sel
                         //[14: 4]=0x50(80) : var_th
                         ...
                         //[   21]=0x1(1) : tflt_en
                         //[25:24]=0x1(1) : exp_mode
	{0x5574, 0x01280420}, // PE1_CORING_CTRL_05
                         //[ 5: 0]=0x20(32) : gt_max
                         //[15: 8]=0x4(4) : gt_th0
                         //[23:16]=0x28(40) : gt_th1
                         //[   24]=0x1(1) : a2tw_en
	{0x5578, 0x18101008}, // PE1_CORING_CTRL_06
                         //[ 7: 0]=0x8(8) : gt_th0a
                         //[15: 8]=0x10(16) : gt_th0b
                         //[21:16]=0x10(16) : gt_gain0a
                         //[29:24]=0x18(24) : gt_gain0b
	...
	{0x5584, 0x30302020}, // PE1_CORING_CTRL_09
                         //[ 6: 0]=0x18(24) : edge_gain_b
                         //[14: 8]=0x18(24) : edge_gain_w
                         //[22:16]=0x28(40) : texture_gain_b
                         //[30:24]=0x28(40) : texture_gain_w
	{0x5590, 0xB0400165}, // PE1_DJ_CTRL_00
                         //[    0]=0x1(1) : edf_en
	...
	{0x5594, 0x00801000}, // PE1_DJ_CTRL_01
                         //[ 7: 0]=0x0(0) : level_th
