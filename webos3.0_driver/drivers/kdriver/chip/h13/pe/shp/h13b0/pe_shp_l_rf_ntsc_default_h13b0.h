const PE_REG_PARAM_T shp_l_rf_ntsc_default_h13b0[] =
{
	...
	{0x53D0, 0x0A030109},   // PE1_DERH_CTRL_00
                        // [ 1: 0]=0x1(1) : vsum_mode
                        // [ 3: 2]=0x2(2) : hsum_mode
                        // [    4]=0x0(0) : vsum121_en
	...
	{0x5414, 0x00000000},   // PE1_DP_CTRL_01
                        ...
                        // [22:16]=0x0(0) : texture_gain_b
                        // [30:24]=0x0(0) : texture_gain_w
	...
	{0x5474, 0x05030000},   // PE1_DERH_CTRL_0B
	...
	{0x5494, 0x04282020},   // PE1_SP_CTRL_01
	...
	{0x54F0, 0x00000001},   // PE1_MP_CTRL_00
                        // [    0]=0x1(1) : edge_enhance_enable
                        // [13:12]=0x0(0) : Edge_operator_selection
	{0x54F4, 0x04283030},   // PE1_MP_CTRL_01
	...
	{0x5510, 0x000C0C01},   // PE1_MP_CTRL_07
                        ...
                        // [15: 8]=0xc(12) : gb_x1
                        // [23:16]=0xc(12) : gb_y1
	{0x5514, 0x08100410},   // PE1_MP_CTRL_08
                        // [ 7: 0]=0x10(16) : gb_x2
                        // [15: 8]=0x4(4) : gb_y2
                        // [23:16]=0x10(16) : gb_y3
	...
	{0x5550, 0x18102002},   // PE1_BLUR_CTRL
                        // [    0]=0x0(0) : enable
                        // [    1]=0x1(1) : coring_en
                        // [ 5: 4]=0x0(0) : direction
                        // [15: 8]=0x20(32) : gain
	...
	{0x5564, 0x48180A26},   // PE1_CORING_CTRL_01
                        // [ 2: 0]=0x6(6) : max_sel
                        // [ 5: 4]=0x2(2) : avg_sel
	...
	{0x556C, 0x00040C01},   // PE1_CORING_CTRL_03
                        ...
                        // [13: 8]=0xc(12) : nrh_th1
                        // [21:16]=0x4(4) : nrh_th2
	{0x5570, 0x00210303},   // PE1_CORING_CTRL_04
                        // [ 1: 0]=0x3(3) : dflt_sel
                        // [14: 4]=0x30(48) : var_th
	...
	{0x5574, 0x01000010},   // PE1_CORING_CTRL_05
                        // [ 5: 0]=0x10(16) : gt_max
                        // [15: 8]=0x0(0) : gt_th0
                        // [23:16]=0x0(0) : gt_th1
                        // [   24]=0x1(1) : a2tw_en
	{0x5578, 0x08040000},   // PE1_CORING_CTRL_06
                        // [ 7: 0]=0x0(0) : gt_th0a
                        // [15: 8]=0x0(0) : gt_th0b
                        // [21:16]=0x4(4) : gt_gain0a
                        // [29:24]=0x8(8) : gt_gain0b
	{0x557C, 0x60403B2A},   // PE1_CORING_CTRL_07
                        // [ 7: 0]=0x2a(42) : g_th0
                        // [15: 8]=0x3b(59) : g_th1
	...
	{0x5584, 0x00000000},   // PE1_CORING_CTRL_09
                        ...
                        // [22:16]=0x0(0) : texture_gain_b
                        // [30:24]=0x0(0) : texture_gain_w
	{0x5590, 0xB0400465},   // PE1_DJ_CTRL_00
                        // [    0]=0x1(1) : edf_en
	...
	{0x5594, 0x00FF1800},   // PE1_DJ_CTRL_01
                        // [ 7: 0]=0x0(0) : level_th
                        // [15: 8]=0x18(24) : protect_th
                        // [23:16]=0xff(255) : n_avg_gain
