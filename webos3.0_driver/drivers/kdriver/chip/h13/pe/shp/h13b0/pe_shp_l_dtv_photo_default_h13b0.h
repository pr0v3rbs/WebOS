const PE_REG_PARAM_T shp_l_dtv_photo_default_h13b0[] =
{
	...
	{0x53D0, 0x00030109},  //PE1_DERH_CTRL_00
	                       // [ 1: 0]=0x1(1) : vsum_mode
	                       // [ 3: 2]=0x2(2) : hsum_mode
	                       // [    4]=0x0(0) : vsum121_en
	                       ...
	                       // [19:18]=0x0(0) : a_e_mux
	                       // [   20]=0x0(0) : t_mux
	                       // [27:24]=0x4(4) : a_gen_width
	{0x53D4, 0x00004000},  //PE1_DERH_CTRL_01
	                       // [ 7: 0]=0x0(0) : a_gen_of_Y
	                       // [15: 8]=0x40(64) : a_gen_of_C
	...
	{0x5400, 0x00060008},  //PE1_DERV_CTRL_0
	                       // [    0]=0x1(1) : der_v_en
	                       // [ 2: 1]=0x3(3) : der_gain_mapping
	                       // [    3]=0x1(1) : bif_en
	                       // [ 7: 4]=0x0(0) : output_mux
	                       // [15: 8]=0x14(20) : bif_manual_th
	                       // [21:16]=0x6(6) : th_gain
	                       // [   24]=0x0(0) : th_mode
	{0x5404, 0x00000000},  //PE1_DERV_CTRL_1
	                       // [ 5: 0]=0x10(16) : csft_gain
	                       // [    8]=0x0(0) : csft_mode
	{0x5408, 0x00000000},  //PE1_DERV_CTRL_2
	                       // [ 2: 0]=0x7(7) : mmd_sel
	                       // [ 6: 4]=0x0(0) : max_sel
	                       // [ 9: 8]=0x0(0) : avg_sel
	                       // [23:16]=0x20(32) : gain_th1
	                       // [31:24]=0x40(64) : gain_th2
	{0x540C, 0x00000000},  //PE1_DERV_CTRL_3
	                       // [ 6: 0]=0x30(48) : gain_b
	                       // [14: 8]=0x10(16) : gain_w
	{0x5410, 0x00000000},  //PE1_DP_CTRL_00
	                       // [ 2: 0]=0x0(0) : debug_display
	{0x5414, 0x00000000},  //PE1_DP_CTRL_01
	                       // [ 6: 0]=0x0(0) : edge_gain_b
	                       // [14: 8]=0x0(0) : edge_gain_w
	                       // [22:16]=0x5c(92) : texture_gain_b
	                       // [30:24]=0x76(118) : texture_gain_w
	{0x5420, 0xFF090000},  //PE1_CORING_STAT_00
	                       // [15: 0]=0x2edf(11999) : tm_h
	                       // [31:16]=0x1b3c(6972) : tm_v
	{0x5424, 0x00000000},  //PE1_CORING_STAT_01
	                       // [15: 0]=0x4727(18215) : tm_h
	...
	{0x5494, 0x00000000},  //PE1_SP_CTRL_01
	                       // [ 6: 0]=0x10(16) : white_gain
	                       // [14: 8]=0x10(16) : black_gain
	                       // [23:16]=0x20(32) : Horizontal_gain
	                       // [31:24]=0x20(32) : Vertical_gain
	{0x5498, 0x20010000},  //PE1_SP_CTRL_02
	...
	{0x54AC, 0x00001000},  //PE1_SP_CTRL_06
	                       // [ 1: 0]=0x1(1) : lap_h_mode
	                       // [    4]=0x1(1) : lap_v_mode
	{0x54B0, 0x000C0C00},  //PE1_SP_CTRL_07
	                       // [    0]=0x0(0) : gb_en
	                       // [    4]=0x0(0) : gb_mode
	                       // [15: 8]=0xc(12) : gb_x1
	                       // [23:16]=0xc(12) : gb_y1
	{0x54B4, 0x00C81919},  //PE1_SP_CTRL_08
	                       // [ 7: 0]=0x19(25) : gb_x2
	                       // [15: 8]=0x19(25) : gb_y2
	...
	{0x54F0, 0x00000001},  //PE1_MP_CTRL_00
	                       // [    0]=0x1(1) : edge_enhance_enable
	                       // [13:12]=0x0(0) : Edge_operator_selection
	{0x54F4, 0x00000000},  //PE1_MP_CTRL_01
	                       // [ 6: 0]=0x8(8) : white_gain
	                       // [14: 8]=0x8(8) : black_gain
	                       // [23:16]=0x20(32) : horizontal_gain
	                       // [31:24]=0x20(32) : vertical_gain
	{0x54F8, 0x20010000},  //PE1_MP_CTRL_02
	...
	{0x5500, 0x01401000},  //PE1_MP_CTRL_04
	                       ...
	                       // [   12]=0x1(1) : gx_weight_manual_mode
	                       // [23:16]=0x40(64) : gx_weight_manual_gain
	{0x550C, 0x00001000},  //PE1_MP_CTRL_06
	                       // [ 2: 0]=0x1(1) : lap_h_mode
	                       // [ 6: 4]=0x1(1) : lap_v_mode
	{0x5510, 0x000C0C01},  //PE1_MP_CTRL_07
	                       // [    0]=0x1(1) : gb_en
	                       // [    4]=0x0(0) : gb_mode
	                       // [15: 8]=0xc(12) : gb_x1
	                       // [23:16]=0xc(12) : gb_y1
	{0x5514, 0x00B01919},  //PE1_MP_CTRL_08
	                       // [ 7: 0]=0x19(25) : gb_x2
	                       // [15: 8]=0x19(25) : gb_y2
	...
	{0x5524, 0x0000FFFF},  //PE1_MP_CTRL_0C
	                       // [ 7: 0]=0xff(255) : lum2_y1
	                       // [15: 8]=0xff(255) : lum2_y2
	{0x5530, 0x80200030},  //PE1_CTI_CTRL_00
	                       // [    0]=0x1(1) : cti_en
	                       // [ 6: 4]=0x6(6) : filter_tap_size
	                       // [15: 8]=0x30(48) : cti_gain
	{0x5534, 0x00000000},  //PE1_CTI_CTRL_01
	                       // [15: 8]=0x18(24) : coring_th1
	                       // [18:16]=0x1(1) : coring_map_filter
	                       // [22:20]=0x0(0) : coring_tap_size
	                       // [25:24]=0x0(0) : debug mode
	{0x5538, 0x00000000},  //PE1_CTI_CTRL_02
	                       // [    0]=0x0(0) : ycm_en0
	                       // [    1]=0x1(1) : ycm_en1
	...
	{0x5540, 0x00000000},  //PE1_TI_CTRL_0
	                       // [    0]=0x1(1) : enable
	...
	{0x5544, 0x00000000},  //PE1_TI_CTRL_1
	                       // [    0]=0x1(1) : gain0_en
	                       // [    1]=0x1(1) : gain1_en
	                       // [ 5: 4]=0x0(0) : output_mux
	                       // [23:16]=0x20(32) : gain0_th0
	                       // [31:24]=0x50(80) : gain0_th1
	{0x5548, 0x05034428},  //PE1_TI_CTRL_2
	                       // [ 1: 0]=0x0(0) : gain1_div_mode
	{0x5550, 0x140C0002},  //PE1_BLUR_CTRL
	                       // [    0]=0x0(0) : enable
	                       // [    1]=0x1(1) : coring_en
	                       // [ 5: 4]=0x0(0) : direction
	                       // [15: 8]=0x0(0) : gain
	                       // [23:16]=0xc(12) : coring_min
	                       // [31:24]=0x14(20) : coring_max
	{0x5560, 0x00000000},  //PE1_CORING_CTRL_00
	                       // [ 5: 0]=0x28(40) : ga_max
	                       // [15: 8]=0xd(13) : ga_th0
	...
	{0x5564, 0x00000200},  //PE1_CORING_CTRL_01
	                       // [ 2: 0]=0x0(0) : max_sel
	                       // [ 5: 4]=0x0(0) : avg_sel
	                       // [13: 8]=0x2(2) : a2tw_min
	                       // [23:16]=0x10(16) : a2tw_th0
	                       // [31:24]=0x40(64) : a2tw_th1
	...
	{0x556C, 0x00040C01},  //PE1_CORING_CTRL_03
	                       ...
	                       // [13: 8]=0xc(12) : nrh_th1
	                       // [21:16]=0x4(4) : nrh_th2
	{0x5570, 0x00200003},  //PE1_CORING_CTRL_04
	                       // [ 1: 0]=0x3(3) : dflt_sel
	                       // [14: 4]=0x70(112) : var_th
	                       // [17:16]=0x1(1) : coring_mode1
	                       // [19:18]=0x0(0) : coring_mode2
	                       // [   20]=0x0(0) : ac_direction
	                       // [   21]=0x1(1) : tflt_en
	                       // [25:24]=0x0(0) : exp_mode
	{0x5574, 0x00000000},  //PE1_CORING_CTRL_05
	                       // [ 5: 0]=0xd(13) : gt_max
	                       // [15: 8]=0x1(1) : gt_th0
	                       // [23:16]=0x10(16) : gt_th1
	                       // [   24]=0x1(1) : a2tw_en
	{0x5578, 0x00000000},  //PE1_CORING_CTRL_06
	                       // [ 7: 0]=0x2(2) : gt_th0a
	                       // [15: 8]=0x8(8) : gt_th0b
	                       // [21:16]=0x4(4) : gt_gain0a
	                       // [29:24]=0x8(8) : gt_gain0b
	{0x557C, 0x00000000},  //PE1_CORING_CTRL_07
	                       // [ 7: 0]=0x2a(42) : g_th0
	                       // [15: 8]=0x3b(59) : g_th1
	                       // [22:16]=0x40(64) : amap_gain
	                       // [30:24]=0x38(56) : tmap_gain
	...
	{0x5584, 0x00000000},  //PE1_CORING_CTRL_09
	                       // [ 6: 0]=0x0(0) : edge_gain_b
	                       // [14: 8]=0x0(0) : edge_gain_w
	                       // [22:16]=0x58(88) : texture_gain_b
	                       // [30:24]=0x5b(91) : texture_gain_w
	{0x5590, 0x00000024},  //PE1_DJ_CTRL_00
	                       // [    0]=0x1(1) : edf_en
	...
	{0x5594, 0x00000000},  //PE1_DJ_CTRL_01
	                       // [ 7: 0]=0x0(0) : level_th
	                       // [15: 8]=0x10(16) : protect_th
	                       // [23:16]=0x0(0) : n_avg_gain
	{0x5598, 0x00000000},  //PE1_DJ_CTRL_02
	                       // [ 4: 0]=0xb(11) : edf_count_min
	                       // [12: 8]=0x10(16) : edf_count_max
	{0x559C, 0x00000000},  //PE1_DJ_CTRL_03
	                       // [ 4: 0]=0xb(11) : dj_h_count_min
	                       // [12: 8]=0x10(16) : dj_h_count_max
	                       // [20:16]=0xb(11) : dj_v_count_min
	                       // [28:24]=0x10(16) : dj_v_count_max
};
