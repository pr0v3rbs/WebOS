const PE_REG_PARAM_T shp_l_hdmi_hd_default_h13b0[] =
{
	...
	{0x53D0, 0x04030109},  //PE1_DERH_CTRL_00
	                       // [ 1: 0]=0x1(1) : vsum_mode
	                       // [ 3: 2]=0x2(2) : hsum_mode
	                       // [    4]=0x0(0) : vsum121_en
	...
	{0x5400, 0x0010100F},  //PE1_DERV_CTRL_0
	                       // [    0]: der_v_en
	                       // [ 2: 1]: der_gain_mapping
	                       // [    3]: bif_en
	                       // [ 7: 4]: output_mux
	                       // [15: 8]) : bif_manual_th
	                       // [21:16]: th_gain
	                       // [   24]: th_mode
	{0x5404, 0x00000020},  //PE1_DERV_CTRL_1
	                       // [ 5: 0]=0x10(16) : csft_gain
	                       // [    8]=0x0(0) : csft_mode
	{0x5408, 0x40200123},  //PE1_DERV_CTRL_2
	                       // [ 2: 0]=0x7(7) : mmd_sel
	                       // [ 6: 4]=0x0(0) : max_sel
	                       // [ 9: 8]=0x0(0) : avg_sel
	...
	{0x5414, 0x765C0000},  //PE1_DP_CTRL_01
	...
	{0x54F0, 0x00000001},  //PE1_MP_CTRL_00
	                       // [    0]=0x1(1) : edge_enhance_enable
	                       // [13:12]=0x0(0) : Edge_operator_selection
	{0x54F4, 0x00101010},  //PE1_MP_CTRL_01
	                       // [ 6: 0]=0x8(8) : white_gain
	                       // [14: 8]=0x8(8) : black_gain
	                       // [23:16]=0x20(32) : horizontal_gain
	                       // [31:24]=0x20(32) : vertical_gain
	{0x54F8, 0x20012020},  //PE1_MP_CTRL_02
	...
	{0x5524, 0x0000FFFF},  //PE1_MP_CTRL_0C
	                       // [ 7: 0]=0xff(255) : lum2_y1
	                       // [15: 8]=0xff(255) : lum2_y2
	{0x5530, 0x80203061},  //PE1_CTI_CTRL_00
	                       // [    0]=0x1(1) : cti_en
	...
	{0x5540, 0x30300051},  //PE1_TI_CTRL_0
	                       // [    0]=0x1(1) : enable
	...
	{0x557C, 0x38403B2A},  //PE1_CORING_CTRL_07
	                       // [ 7: 0]=0x2a(42) : g_th0
	                       // [15: 8]=0x3b(59) : g_th1
	...
	{0x5584, 0x30303030},  //PE1_CORING_CTRL_09
	                       // [ 6: 0]=0x0(0) : edge_gain_b
	                       // [14: 8]=0x0(0) : edge_gain_w
	                       // [22:16]=0x58(88) : texture_gain_b
	                       // [30:24]=0x5b(91) : texture_gain_w
	{0x5590, 0xB0500165},  //PE1_DJ_CTRL_00
	                       // [    0]=0x1(1) : edf_en
	...
	{0x5594, 0x00802800},  //PE1_DJ_CTRL_01
	                       // [ 7: 0]=0x0(0) : level_th
	                       // [15: 8]=0x10(16) : protect_th
	                       // [23:16]=0x0(0) : n_avg_gain
	{0x5598, 0x00001A14},  //PE1_DJ_CTRL_02
