...
#ifndef _PE_CVI_REG_H13A0_H_
#define _PE_CVI_REG_H13A0_H_
...
} PE_H13A0_CVA_PIX_SUM_STATUS0_T;
...
} PE_H13A0_CVA_PIX_SUM_STATUS1_T;
...
} PE_H13A0_CVA_PIX_SUM_STATUS2_T;
...
} PE_H13A0_CVA_SYNC_FIL_STATUS_T;
...
} PE_H13A0_CVA_SYNC_REPEAT_CTRL_T;
...
} PE_H13A0_CVA_SYNC_REPEAT_SIZE0_T;
...
} PE_H13A0_CVA_SYNC_REPEAT_SIZE1_T;
...
} PE_H13A0_CVA_SYNC_REPEAT_SIZE2_T;
...
} PE_H13A0_CVA_SYNC_REPEAT_SIZE3_T;
...
} PE_H13A0_CVA_SYNC_REPEAT_SIZE4_T;
...
typedef struct {
	UINT32 avg_pixel_cb                    : 21;  //  0:20
} PE_H13A0_CVA_SYNC_REPEAT_SIZE5_T;
...
} PE_H13A0_CVA_SIZE_DETECT_CTRL_T;
...
} PE_H13A0_CVA_SIZE_DETECT_READ_T;
...
} PE_H13A0_CVA_SIZE_DETECT_CTRL1_T;
...
} PE_H13A0_CVA_SIZE_DETECT_CTRL2_T;
...
} PE_H13A0_CVA_PSEUDO_SYNC_CTRL0_T;
...
} PE_H13A0_CVA_PSEUDO_SYNC_CTRL1_T;
...
} PE_H13A0_CVA_PSEUDO_SYNC_CTRL2_T;
...
} PE_H13A0_CVA_PSEUDO_SYNC_CTRL3_T;
...
} PE_H13A0_CVA_PSEUDO_SYNC_CTRL4_T;
...
typedef struct {
	UINT32 pix_sum_g                       : 32;  //  0:31
} PE_H13A0_CVB_PIX_SUM_STATUS0_T;
...
typedef struct {
	UINT32 pix_sum_b                       : 32;  //  0:31
} PE_H13A0_CVB_PIX_SUM_STATUS1_T;
...
typedef struct {
	UINT32 pix_sum_r                       : 32;  //  0:31
} PE_H13A0_CVB_PIX_SUM_STATUS2_T;
...
typedef struct {
	...
	UINT32 de_counter                      : 8;   // 16:23
	UINT32 field_counter                   : 8;   // 24:31
} PE_H13A0_CVB_SYNC_FIL_STATUS_T;
...
typedef struct {
	...
	UINT32 repeat_threshold_c              : 6;   // 20:25
	UINT32 avg_threshold_c                 : 6;   // 26:31
} PE_H13A0_CVB_SYNC_REPEAT_CTRL_T;
...
typedef struct {
	UINT32 repeat_pixel_y                  : 21;  //  0:20
} PE_H13A0_CVB_SYNC_REPEAT_SIZE0_T;
...
typedef struct {
	UINT32 avg_pixel_y                     : 21;  //  0:20
} PE_H13A0_CVB_SYNC_REPEAT_SIZE1_T;
...
typedef struct {
	UINT32 repeat_pixel_cb                 : 21;  //  0:20
} PE_H13A0_CVB_SYNC_REPEAT_SIZE2_T;
...
typedef struct {
	UINT32 avg_pixel_cb                    : 21;  //  0:20
} PE_H13A0_CVB_SYNC_REPEAT_SIZE3_T;
...
typedef struct {
	UINT32 repeat_pixel_cr                 : 21;  //  0:20
} PE_H13A0_CVB_SYNC_REPEAT_SIZE4_T;
...
typedef struct {
	UINT32 avg_pixel_cb                    : 21;  //  0:20
} PE_H13A0_CVB_SYNC_REPEAT_SIZE5_T;
...
typedef struct {
	...
	UINT32 nosig_duration_hsync            : 2;   // 28:29
	UINT32 nosig_duration_vsync            : 2;   // 30:31
} PE_H13A0_CVB_SIZE_DETECT_CTRL_T;
...
typedef struct {
	UINT32 line_num_read                   : 16;  //  0:15
	UINT32 line_width_read                 : 16;  // 16:31
} PE_H13A0_CVB_SIZE_DETECT_READ_T;
...
typedef struct {
	...
	UINT32 ext_clk_valid_count             : 15;  // 16:30
	UINT32 ext_clk_valid                   : 1;   //    31
} PE_H13A0_CVB_SIZE_DETECT_CTRL1_T;
...
typedef struct {
	...
	UINT32 abnormal_in_v                   : 8;   // 16:23
	UINT32 abnormal_out_v                  : 8;   // 24:31
} PE_H13A0_CVB_SIZE_DETECT_CTRL2_T;
...
typedef struct {
	...
	UINT32 pseudo_cb                       : 4;   // 24:27
	UINT32 pseudo_cr                       : 4;   // 28:31
} PE_H13A0_CVB_PSEUDO_SYNC_CTRL0_T;
...
typedef struct {
	...
	UINT32                                 : 2;   // 14:15 reserved
	UINT32 pseudo_hsync                    : 14;  // 16:29
} PE_H13A0_CVB_PSEUDO_SYNC_CTRL1_T;
...
typedef struct {
	...
	UINT32                                 : 2;   // 14:15 reserved
	UINT32 pseudo_hn                       : 14;  // 16:29
} PE_H13A0_CVB_PSEUDO_SYNC_CTRL2_T;
...
typedef struct {
	...
	UINT32                                 : 4;   // 12:15 reserved
	UINT32 pseudo_vsync                    : 12;  // 16:27
} PE_H13A0_CVB_PSEUDO_SYNC_CTRL3_T;
...
typedef struct {
	...
	UINT32                                 : 4;   // 12:15 reserved
	UINT32 pseudo_vn                       : 12;  // 16:27
} PE_H13A0_CVB_PSEUDO_SYNC_CTRL4_T;

typedef struct {
	PE_H13A0_CVA_TOP_CTRL_T            cva_top_ctrl;                    // 0x0100
	PE_H13A0_CVA_OFFSET_CTRL_T         cva_offset_ctrl;                 // 0x0104
	PE_H13A0_CVA_SIZE_CTRL_T           cva_size_ctrl;                   // 0x0108
	PE_H13A0_CVA_INT_SYNC_CTRL0_T      cva_int_sync_ctrl0;              // 0x010c
	PE_H13A0_CVA_INT_SYNC_CTRL1_T      cva_int_sync_ctrl1;              // 0x0110
	PE_H13A0_CVA_DIG_FILT_CTRL0_T      cva_dig_filt_ctrl0;              // 0x0114
	PE_H13A0_CVA_DIG_FILT_CTRL1_T      cva_dig_filt_ctrl1;              // 0x0118
	PE_H13A0_CVA_DIG_FILT_CTRL2_T      cva_dig_filt_ctrl2;              // 0x011c
	PE_H13A0_CVA_DIG_FILT_CTRL3_T      cva_dig_filt_ctrl3;              // 0x0120
	PE_H13A0_CVA_CSC_CTRL0_T           cva_csc_ctrl0;                   // 0x0124
	PE_H13A0_CVA_CSC_CTRL1_T           cva_csc_ctrl1;                   // 0x0128
	PE_H13A0_CVA_CSC_CTRL2_T           cva_csc_ctrl2;                   // 0x012c
	PE_H13A0_CVA_CSC_CTRL3_T           cva_csc_ctrl3;                   // 0x0130
	PE_H13A0_CVA_CSC_CTRL4_T           cva_csc_ctrl4;                   // 0x0134
	PE_H13A0_CVA_CSC_CTRL5_T           cva_csc_ctrl5;                   // 0x0138
	PE_H13A0_CVA_CSC_CTRL6_T           cva_csc_ctrl6;                   // 0x013c
	PE_H13A0_CVA_CSC_CTRL7_T           cva_csc_ctrl7;                   // 0x0140
	PE_H13A0_CVA_MISC_CTRL_T           cva_misc_ctrl;                   // 0x0144
	PE_H13A0_CVA_OFFSET_READ_T         cva_offset_read;                 // 0x0148
	PE_H13A0_CVA_PRE3D_CTRL0_T         cva_pre3d_ctrl0;                 // 0x014c
	PE_H13A0_CVA_PRE3D_CTRL1_T         cva_pre3d_ctrl1;                 // 0x0150
	PE_H13A0_CVA_PRE3D_CTRL2_T         cva_pre3d_ctrl2;                 // 0x0154
	PE_H13A0_CVA_SIZE_STATUS1_T        cva_size_status1;                // 0x0158
	PE_H13A0_CVA_SIZE_STATUS2_T        cva_size_status2;                // 0x015c
	PE_H13A0_CVA_SIZE_STATUS3_T        cva_size_status3;                // 0x0160
	PE_H13A0_CVA_SIZE_STATUS4_T        cva_size_status4;                // 0x0164
	PE_H13A0_CVA_PIX_SUM_CTRL0_T       cva_pix_sum_ctrl0;               // 0x0168
	PE_H13A0_CVA_PIX_SUM_CTRL1_T       cva_pix_sum_ctrl1;               // 0x016c
	PE_H13A0_CVA_PIX_SUM_STATUS0_T     cva_pix_sum_status0;             // 0x0170
	PE_H13A0_CVA_PIX_SUM_STATUS1_T     cva_pix_sum_status1;             // 0x0174
	PE_H13A0_CVA_PIX_SUM_STATUS2_T     cva_pix_sum_status2;             // 0x0178
	PE_H13A0_CVA_SYNC_FIL_CTRL_T       cva_sync_fil_ctrl;               // 0x017c
	PE_H13A0_CVA_SYNC_FIL_STATUS_T     cva_sync_fil_status;             // 0x0180
	PE_H13A0_CVA_CTI_CTRL_T            cva_cti_ctrl;                    // 0x0184
	UINT32                             reserved0[2];                    // 0x0188~0x018c
	PE_H13A0_CVA_SYNC_REPEAT_CTRL_T    cva_sync_repeat_ctrl;            // 0x0190
	PE_H13A0_CVA_SYNC_REPEAT_SIZE0_T   cva_sync_repeat_size0;           // 0x0194
	PE_H13A0_CVA_SYNC_REPEAT_SIZE1_T   cva_sync_repeat_size1;           // 0x0198
	PE_H13A0_CVA_SYNC_REPEAT_SIZE2_T   cva_sync_repeat_size2;           // 0x019c
	PE_H13A0_CVA_SYNC_REPEAT_SIZE3_T   cva_sync_repeat_size3;           // 0x01a0
	PE_H13A0_CVA_SYNC_REPEAT_SIZE4_T   cva_sync_repeat_size4;           // 0x01a4
	PE_H13A0_CVA_SYNC_REPEAT_SIZE5_T   cva_sync_repeat_size5;           // 0x01a8
	PE_H13A0_CVA_DIG_FILT_CTRL4_T      cva_dig_filt_ctrl4;              // 0x01ac
	PE_H13A0_CVA_DIG_FILT_CTRL5_T      cva_dig_filt_ctrl5;              // 0x01b0
	PE_H13A0_CVA_DIG_FILT_CTRL6_T      cva_dig_filt_ctrl6;              // 0x01b4
	UINT32                             reserved1[2];                    // 0x01b8~0x01bc
	PE_H13A0_CVA_SIZE_DETECT_CTRL_T    cva_size_detect_ctrl;            // 0x01c0
	PE_H13A0_CVA_SIZE_DETECT_READ_T    cva_size_detect_read;            // 0x01c4
	PE_H13A0_CVA_SIZE_STATUS0_T        cva_size_status0;                // 0x01c8
	PE_H13A0_CVA_SIZE_STATUS5_T        cva_size_status5;                // 0x01cc
	PE_H13A0_CVA_SIZE_STATUS6_T        cva_size_status6;                // 0x01d0
	PE_H13A0_CVA_SIZE_DETECT_CTRL1_T   cva_size_detect_ctrl1;           // 0x01d4
	PE_H13A0_CVA_SIZE_DETECT_CTRL2_T   cva_size_detect_ctrl2;           // 0x01d8
	PE_H13A0_CVA_PSEUDO_SYNC_CTRL0_T   cva_pseudo_sync_ctrl0;           // 0x01dc
	PE_H13A0_CVA_PSEUDO_SYNC_CTRL1_T   cva_pseudo_sync_ctrl1;           // 0x01e0
	PE_H13A0_CVA_PSEUDO_SYNC_CTRL2_T   cva_pseudo_sync_ctrl2;           // 0x01e4
	PE_H13A0_CVA_PSEUDO_SYNC_CTRL3_T   cva_pseudo_sync_ctrl3;           // 0x01e8
	PE_H13A0_CVA_PSEUDO_SYNC_CTRL4_T   cva_pseudo_sync_ctrl4;           // 0x01ec
} PE_CVA_REG_H13A0_T;

typedef struct {
	PE_H13A0_CVB_TOP_CTRL_T            cvb_top_ctrl;                    // 0x0200
	PE_H13A0_CVB_OFFSET_CTRL_T         cvb_offset_ctrl;                 // 0x0204
	PE_H13A0_CVB_SIZE_CTRL_T           cvb_size_ctrl;                   // 0x0208
	PE_H13A0_CVB_INT_SYNC_CTRL0_T      cvb_int_sync_ctrl0;              // 0x020c
	PE_H13A0_CVB_INT_SYNC_CTRL1_T      cvb_int_sync_ctrl1;              // 0x0210
	PE_H13A0_CVB_DIG_FILT_CTRL0_T      cvb_dig_filt_ctrl0;              // 0x0214
	PE_H13A0_CVB_DIG_FILT_CTRL1_T      cvb_dig_filt_ctrl1;              // 0x0218
	PE_H13A0_CVB_DIG_FILT_CTRL2_T      cvb_dig_filt_ctrl2;              // 0x021c
	PE_H13A0_CVB_DIG_FILT_CTRL3_T      cvb_dig_filt_ctrl3;              // 0x0220
	PE_H13A0_CVB_CSC_CTRL0_T           cvb_csc_ctrl0;                   // 0x0224
	PE_H13A0_CVB_CSC_CTRL1_T           cvb_csc_ctrl1;                   // 0x0228
	PE_H13A0_CVB_CSC_CTRL2_T           cvb_csc_ctrl2;                   // 0x022c
	PE_H13A0_CVB_CSC_CTRL3_T           cvb_csc_ctrl3;                   // 0x0230
	PE_H13A0_CVB_CSC_CTRL4_T           cvb_csc_ctrl4;                   // 0x0234
	PE_H13A0_CVB_CSC_CTRL5_T           cvb_csc_ctrl5;                   // 0x0238
	PE_H13A0_CVB_CSC_CTRL6_T           cvb_csc_ctrl6;                   // 0x023c
	PE_H13A0_CVB_CSC_CTRL7_T           cvb_csc_ctrl7;                   // 0x0240
	PE_H13A0_CVB_MISC_CTRL_T           cvb_misc_ctrl;                   // 0x0244
	PE_H13A0_CVB_OFFSET_READ_T         cvb_offset_read;                 // 0x0248
	PE_H13A0_CVB_PRE3D_CTRL0_T         cvb_pre3d_ctrl0;                 // 0x024c
	PE_H13A0_CVB_PRE3D_CTRL1_T         cvb_pre3d_ctrl1;                 // 0x0250
	PE_H13A0_CVB_PRE3D_CTRL2_T         cvb_pre3d_ctrl2;                 // 0x0254
	PE_H13A0_CVB_SIZE_STATUS1_T        cvb_size_status1;                // 0x0258
	PE_H13A0_CVB_SIZE_STATUS2_T        cvb_size_status2;                // 0x025c
	PE_H13A0_CVB_SIZE_STATUS3_T        cvb_size_status3;                // 0x0260
	PE_H13A0_CVB_SIZE_STATUS4_T        cvb_size_status4;                // 0x0264
	PE_H13A0_CVB_PIX_SUM_CTRL0_T       cvb_pix_sum_ctrl0;               // 0x0268
	PE_H13A0_CVB_PIX_SUM_CTRL1_T       cvb_pix_sum_ctrl1;               // 0x026c
	PE_H13A0_CVB_PIX_SUM_STATUS0_T     cvb_pix_sum_status0;             // 0x0270
	PE_H13A0_CVB_PIX_SUM_STATUS1_T     cvb_pix_sum_status1;             // 0x0274
	PE_H13A0_CVB_PIX_SUM_STATUS2_T     cvb_pix_sum_status2;             // 0x0278
	PE_H13A0_CVB_SYNC_FIL_CTRL_T       cvb_sync_fil_ctrl;               // 0x027c
	PE_H13A0_CVB_SYNC_FIL_STATUS_T     cvb_sync_fil_status;             // 0x0280
	PE_H13A0_CVB_CTI_CTRL_T            cvb_cti_ctrl;                    // 0x0284
	UINT32                             reserved2[2];                    // 0x0288~0x028c
	PE_H13A0_CVB_SYNC_REPEAT_CTRL_T    cvb_sync_repeat_ctrl;            // 0x0290
	PE_H13A0_CVB_SYNC_REPEAT_SIZE0_T   cvb_sync_repeat_size0;           // 0x0294
	PE_H13A0_CVB_SYNC_REPEAT_SIZE1_T   cvb_sync_repeat_size1;           // 0x0298
	PE_H13A0_CVB_SYNC_REPEAT_SIZE2_T   cvb_sync_repeat_size2;           // 0x029c
	PE_H13A0_CVB_SYNC_REPEAT_SIZE3_T   cvb_sync_repeat_size3;           // 0x02a0
	PE_H13A0_CVB_SYNC_REPEAT_SIZE4_T   cvb_sync_repeat_size4;           // 0x02a4
	PE_H13A0_CVB_SYNC_REPEAT_SIZE5_T   cvb_sync_repeat_size5;           // 0x02a8
	PE_H13A0_CVB_DIG_FILT_CTRL4_T      cvb_dig_filt_ctrl4;              // 0x02ac
	PE_H13A0_CVB_DIG_FILT_CTRL5_T      cvb_dig_filt_ctrl5;              // 0x02b0
	PE_H13A0_CVB_DIG_FILT_CTRL6_T      cvb_dig_filt_ctrl6;              // 0x02b4
	UINT32                             reserved3[2];                    // 0x02b8~0x02bc
	PE_H13A0_CVB_SIZE_DETECT_CTRL_T    cvb_size_detect_ctrl;            // 0x02c0
	PE_H13A0_CVB_SIZE_DETECT_READ_T    cvb_size_detect_read;            // 0x02c4
	PE_H13A0_CVB_SIZE_STATUS0_T        cvb_size_status0;                // 0x02c8
	PE_H13A0_CVB_SIZE_STATUS5_T        cvb_size_status5;                // 0x02cc
	PE_H13A0_CVB_SIZE_STATUS6_T        cvb_size_status6;                // 0x02d0
	PE_H13A0_CVB_SIZE_DETECT_CTRL1_T   cvb_size_detect_ctrl1;           // 0x02d4
	PE_H13A0_CVB_SIZE_DETECT_CTRL2_T   cvb_size_detect_ctrl2;           // 0x02d8
	PE_H13A0_CVB_PSEUDO_SYNC_CTRL0_T   cvb_pseudo_sync_ctrl0;           // 0x02dc
	PE_H13A0_CVB_PSEUDO_SYNC_CTRL1_T   cvb_pseudo_sync_ctrl1;           // 0x02e0
	PE_H13A0_CVB_PSEUDO_SYNC_CTRL2_T   cvb_pseudo_sync_ctrl2;           // 0x02e4
	PE_H13A0_CVB_PSEUDO_SYNC_CTRL3_T   cvb_pseudo_sync_ctrl3;           // 0x02e8
	PE_H13A0_CVB_PSEUDO_SYNC_CTRL4_T   cvb_pseudo_sync_ctrl4;           // 0x02ec
} PE_CVB_REG_H13A0_T;
