...
int PE_DCM_HW_H13_Init(PE_CFG_CTRL_T *pstParams)
{
	...
	do{
		...
		if(PE_KDRV_VER_H13BX)
		{
			...
			memset0(_g_pe_dcm_hw_h13_info);
			_g_pe_dcm_hw_h13_info.cur_blur_gain = 0xf;
			_g_pe_dcm_hw_h13_info.pre_blur_gain = 0xf;
			...
			PE_DCM_HW_H13_CHECK_CODE(ret, break, \
				"[%s,%d][win all] PE_DCM_HW_H13_SetDceConfig() error.\n",__F__,__L__);
			/* dce lut init */
			...
			{
				PE_P1L_H13B0_Wr01(pe1_dce_ia_data,	hif_dyc_wdata_y,dce_lut_data[count]);	//y data
				PE_P1L_H13B0_Wr01(pe1_dce_ia_data,	hif_dyc_wdata_x,dce_lut_data[count]);	//x data
				PE_P1L_H13B0_WrFL(pe1_dce_ia_data);
			}
			PE_P1L_H13B0_Wr01(pe1_dce_ctrl_08,	hif_dyc_wdata_y_32nd,	1023);	//y data
			PE_P1L_H13B0_Wr01(pe1_dce_ctrl_08,	hif_dyc_wdata_x_32nd,	1023);	//x data
			...
			PE_P1L_H13B0_RdFL(pe1_dse_ctrl_02);
			...
			for(count=0;count<32;count++)
			{
				PE_P1L_H13B0_Wr01(pe1_dse_ia_data,	hif_dse_wdata_y,dse_lut_data[count]);	//y data
				PE_P1L_H13B0_Wr01(pe1_dse_ia_data,	hif_dse_wdata_x,dse_lut_data[count]);	//x data
				PE_P1L_H13B0_WrFL(pe1_dse_ia_data);
			}
			PE_P1L_H13B0_Wr01(pe1_dse_ctrl_02,	hif_dse_wdata_y_32nd,	1023);	//y data
			PE_P1L_H13B0_Wr01(pe1_dse_ctrl_02,	hif_dse_wdata_x_32nd,	1023);	//x data
		...
		else if(PE_KDRV_VER_H13AX)
		{
			...
			for(count=0;count<32;count++)
			{
				PE_P1L_H13_Wr01(pe1_dce_ia_data,	hif_dyc_wdata_y,dce_lut_data[count]);	//y data
				PE_P1L_H13_Wr01(pe1_dce_ia_data,	hif_dyc_wdata_x,dce_lut_data[count]);	//x data
				PE_P1L_H13_WrFL(pe1_dce_ia_data);
			}				
			PE_P1L_H13_Wr01(pe1_dce_ctrl_08,	hif_dyc_wdata_y_32nd,	1023);	//y data
			PE_P1L_H13_Wr01(pe1_dce_ctrl_08,	hif_dyc_wdata_x_32nd,	1023);	//x data
			...
			PE_P1L_H13_RdFL(pe1_dse_ctrl_02);
			...
			for(count=0;count<32;count++)
			{
				PE_P1L_H13_Wr01(pe1_dse_ia_data,	hif_dse_wdata_y,dse_lut_data[count]);	//y data
				PE_P1L_H13_Wr01(pe1_dse_ia_data,	hif_dse_wdata_x,dse_lut_data[count]);	//x data
				PE_P1L_H13_WrFL(pe1_dse_ia_data);
			}
			PE_P1L_H13_Wr01(pe1_dse_ctrl_02,	hif_dse_wdata_y_32nd,	1023);	//y data
			PE_P1L_H13_Wr01(pe1_dse_ctrl_02,	hif_dse_wdata_x_32nd,	1023);	//x data
...
int PE_DCM_HW_H13_SetDebugSettings(LX_PE_DBG_SETTINGS_T *pstParams)
{
	...
	do{
		...
		PE_DCM_HW_H13_DBG_PRINT("wid:%d,type:0x%x,[0x%x]print:0x%x,bypass:0x%x\n",\
			pstParams->win_id,pstParams->type,(0x1<<PE_ITEM_PKTMODL(DCM)),\
			pstParams->print_lvl,pstParams->bypass);
		/* set print level */
		if(pstParams->type&LX_PE_DBG_LV)
		{
			_g_dcm_hw_h13_trace = (pstParams->print_lvl & (0x1<<PE_ITEM_PKTMODL(DCM)))? 0x1:0x0;
		}
		/* set bypass */
		if(pstParams->type&LX_PE_DBG_BY)
		{
			if(PE_KDRV_VER_H13BX)
			{
				...
				{
					PE_DCM_HW_H13_DBG_PRINT("dynamic_contrast_en : disable.\n");
				...
				{
					PE_DCM_HW_H13_DBG_PRINT("dynamic_contrast_en : enable.\n");
					if(PE_CHECK_WIN0(pstParams->win_id))
					{
...
{
	int ret = RET_OK;
	UINT32 domain,min_pos,max_pos,is_tpg_pe1_out;
	do {
		CHECK_KNULL(pstParams);
		PE_CHECK_WINID(pstParams->win_id);
		...
		PE_DCM_HW_H13_DBG_PRINT("[win id:%d] domain:%d, min:%d, max:%d\n",\
		...
		if(PE_KDRV_VER_H13BX)
		{
			if(PE_CHECK_WIN0(pstParams->win_id))
			{
				...
				/* fix tpg position on pe1 out because of 2d to 3d black bar */
				is_tpg_pe1_out = 0x1;	//pe1 in(0),out(1)
				#else
				/* tpg position(related with apl position for yc) */
				is_tpg_pe1_out = (domain==1)? 0x0:0x1;	//pe1 in(0),out(1)
				#endif
				PE_P1L_H13B0_RdFL(pe1_top_ctrl_02);
				PE_P1L_H13B0_Wr01(pe1_top_ctrl_02,	tpg_positon,	is_tpg_pe1_out);
				PE_P1L_H13B0_WrFL(pe1_top_ctrl_02);
				if(is_tpg_pe1_out)	//rgb domain
				{
					PE_P1L_H13B0_RdFL(pe1_tpg_ctrl_04);
					PE_P1L_H13B0_Wr01(pe1_tpg_ctrl_04,	bg_color_r,	0x0);
					PE_P1L_H13B0_Wr01(pe1_tpg_ctrl_04,	bg_color_b,	0x0);
					PE_P1L_H13B0_Wr01(pe1_tpg_ctrl_04,	bg_color_g,	0x0);
					PE_P1L_H13B0_WrFL(pe1_tpg_ctrl_04);
				}
				else	//ycbcr domain
				{
					PE_P1L_H13B0_RdFL(pe1_tpg_ctrl_04);
					PE_P1L_H13B0_Wr01(pe1_tpg_ctrl_04,	bg_color_r,	0x200);
					PE_P1L_H13B0_Wr01(pe1_tpg_ctrl_04,	bg_color_b,	0x200);
					PE_P1L_H13B0_Wr01(pe1_tpg_ctrl_04,	bg_color_g,	0x0);
					PE_P1L_H13B0_WrFL(pe1_tpg_ctrl_04);
				}
				/* dce config */
				...
				PE_P1L_H13B0_Wr01(pe1_dce_ctrl_00,	hist_bin_mode,			0x0);					//32bin mode
				...
				#ifdef PE_HW_H13B_USE_PE0_APL_FOR_DCE
				PE_P1L_H13B0_Wr01(pe1_apl_ctrl_02,	apl_position,			0x3);	//0x0:PE1 input(Y/C),0x3:xvycc out(RGB)
				#else
		...
		else if(PE_KDRV_VER_H13AX)
		{
			if(PE_CHECK_WIN0(pstParams->win_id))
			{
				...
				PE_P1L_H13_Wr01(pe1_dce_ctrl_00,	hist_bin_mode,			0x0);					//32bin mode
...
int PE_DCM_HW_H13_SetDceLut(LX_PE_DCM_DCE_LUT_T *pstParams)
{
	...
	do {
		CHECK_KNULL(pstParams);
		PE_CHECK_WINID(pstParams->win_id);
		PE_DCM_HW_H13_CHECK_CODE((pstParams->size>PE_DCM_HW_H13_LUT_MAX), break, \
		...
		if(PE_KDRV_VER_H13BX)
		{
			if(PE_CHECK_WIN0(pstParams->win_id))
			{
				...
				for(count=0;count<(pstParams->size);count++)
				{
					...
					if (count<(PE_DCM_HW_H13_LUT_MAX-1))
					{
					...
					else	//count == (PE_DCM_HW_H13_LUT_MAX-1)
					{
						PE_P1L_H13B0_Wr01(pe1_dce_ctrl_08,hif_dyc_wdata_y_32nd,GET_BITS(lut_data,0,10));//y data
						PE_P1L_H13B0_Wr01(pe1_dce_ctrl_08,hif_dyc_wdata_x_32nd,GET_BITS(lut_data,16,10));//x data
						PE_P1L_H13B0_WrFL(pe1_dce_ctrl_08);
					}
				}
				PE_P1L_H13B0_Wr01(pe1_dce_ia_ctrl,	hif_dce_enable, 	0x1);	//0:host access, 1:normal mode
		...
		else if(PE_KDRV_VER_H13AX)
		{
			if(PE_CHECK_WIN0(pstParams->win_id))
			{
				...
				for(count=0;count<(pstParams->size);count++)
				{
					...
					{
						PE_P1L_H13_Wr01(pe1_dce_ctrl_08,hif_dyc_wdata_y_32nd,GET_BITS(lut_data,0,10));//y data
						PE_P1L_H13_Wr01(pe1_dce_ctrl_08,hif_dyc_wdata_x_32nd,GET_BITS(lut_data,16,10));//x data
						PE_P1L_H13_WrFL(pe1_dce_ctrl_08);
					}
				}
				PE_P1L_H13_Wr01(pe1_dce_ia_ctrl,	hif_dce_enable, 	0x1);	//0:host access, 1:normal mode
		...
		if(PE_KDRV_VER_H13BX)
		{
			if(PE_CHECK_WIN0(win_id))
			{
				...
				for(count=0;count<(pstParams->size);count++)
				{
					...
					{
						PE_P1L_H13B0_RdFL(pe1_dce_ctrl_08);
						pstParams->data[count] = PE_P1L_H13B0_Rd(pe1_dce_ctrl_08);
					}
				}
				PE_P1L_H13B0_Wr01(pe1_dce_ia_ctrl,	hif_dce_enable, 	0x1);	//0:host access, 1:normal mode
				PE_P1L_H13B0_WrFL(pe1_dce_ia_ctrl);
		...
		else if(PE_KDRV_VER_H13AX)
		{
			if(PE_CHECK_WIN0(win_id))
			{
				...
				for(count=0;count<(pstParams->size);count++)
				{
					...
					{
						PE_P1L_H13_RdFL(pe1_dce_ctrl_08);
						pstParams->data[count] = PE_P1L_H13_Rd(pe1_dce_ctrl_08);
					}
				}
				PE_P1L_H13_Wr01(pe1_dce_ia_ctrl,	hif_dce_enable, 	0x1);	//0:host access, 1:normal mode
				PE_P1L_H13_WrFL(pe1_dce_ia_ctrl);
		...
		if(PE_KDRV_VER_H13BX)
		{
			if(PE_CHECK_WIN0(pstParams->win_id))
			{
				...
				for(count=0;count<(pstParams->size);count++)
				{
					...
					{
						PE_P1L_H13B0_Wr01(pe1_dse_ctrl_02,hif_dse_wdata_y_32nd,GET_BITS(lut_data,0,10));//y data
						PE_P1L_H13B0_Wr01(pe1_dse_ctrl_02,hif_dse_wdata_x_32nd,GET_BITS(lut_data,16,10));//x data
						PE_P1L_H13B0_WrFL(pe1_dse_ctrl_02);
					}
				}
				PE_P1L_H13B0_Wr01(pe1_dse_ia_ctrl,	hif_dse_enable, 	0x1);	//0:host access, 1:normal mode
		...
		else if(PE_KDRV_VER_H13AX)
		{
			if(PE_CHECK_WIN0(pstParams->win_id))
			{
				...
				for(count=0;count<(pstParams->size);count++)
				{
					...
					{
						PE_P1L_H13_Wr01(pe1_dse_ctrl_02,hif_dse_wdata_y_32nd,GET_BITS(lut_data,0,10));//y data
						PE_P1L_H13_Wr01(pe1_dse_ctrl_02,hif_dse_wdata_x_32nd,GET_BITS(lut_data,16,10));//x data
						PE_P1L_H13_WrFL(pe1_dse_ctrl_02);
					}
				}
				PE_P1L_H13_Wr01(pe1_dse_ia_ctrl,	hif_dse_enable, 	0x1);	//0:host access, 1:normal mode
		...
		if(PE_KDRV_VER_H13BX)
		{
			if(PE_CHECK_WIN0(win_id))
			{
				...
				for(count=0;count<(pstParams->size);count++)
				{
					...
					{
						PE_P1L_H13B0_RdFL(pe1_dse_ia_data);
						pstParams->data[count] = PE_P1L_H13B0_Rd(pe1_dse_ia_data);
					}
					else	//count == (PE_DCM_HW_H13_LUT_MAX-1)
					{
						PE_P1L_H13B0_RdFL(pe1_dse_ctrl_02);
						pstParams->data[count] = PE_P1L_H13B0_Rd(pe1_dse_ctrl_02);
					}
				}
				PE_P1L_H13B0_Wr01(pe1_dse_ia_ctrl,	hif_dse_enable, 	0x1);	//0:host access, 1:normal mode
				PE_P1L_H13B0_Wr01(pe1_dse_ia_ctrl,	hif_dse_load,	 	0x1);	//0:clear, 1:enable
		...
		else if(PE_KDRV_VER_H13AX)
		{
			if(PE_CHECK_WIN0(win_id))
			{
				...
				for(count=0;count<(pstParams->size);count++)
				{
					...
					{
						PE_P1L_H13_RdFL(pe1_dse_ia_data);
						pstParams->data[count] = PE_P1L_H13_Rd(pe1_dse_ia_data);
					}
					else	//count == (PE_DCM_HW_H13_LUT_MAX-1)
					{
						PE_P1L_H13_RdFL(pe1_dse_ctrl_02);
						pstParams->data[count] = PE_P1L_H13_Rd(pe1_dse_ctrl_02);
					}
				}
				PE_P1L_H13_Wr01(pe1_dse_ia_ctrl,	hif_dse_enable, 	0x1);	//0:host access, 1:normal mode
				PE_P1L_H13_Wr01(pe1_dse_ia_ctrl,	hif_dse_load,	 	0x1);	//0:clear, 1:enable
...
int PE_DCM_HW_H13_SetDceSmoothCtrl(void *pstParams)
{
	...
	do {
		...
		if(PE_KDRV_VER_H13BX)
		{
			...
			{
				PE_P1L_H13B0_QWr02(pe1_dce_blur_ctrl_00, avg_filter_tap,	GET_BITS(pp->avg_filter_tap,0,2),\
														 edge_map_tap,		GET_BITS(pp->edge_map_tap,0,2));
				PE_P1L_H13B0_QWr04(pe1_dce_blur_ctrl_01, e_to_w_th_x0,		GET_BITS(pp->e_to_w_th_x0,0,8),\
				...
				PE_P1L_H13B0_QWr01(pe1_dce_blur_ctrl_02, chroma_blur_mode, 	GET_BITS(pp->chroma_blur_mode,0,2));
				#ifdef PE_DCM_HW_H13_SET_BLUR_GAIN_ON_TASK
				pInfo->cur_blur_gain = GET_BITS(pp->blur_v_gain,0,4);
				#else
				PE_P1L_H13B0_QWr01(pe1_dce_ctrl_01,		 blur_v_gain, 	 	GET_BITS(pp->blur_v_gain,0,4));
				#endif
			}
		}
		else
...
int PE_DCM_HW_H13_GetDceSmoothCtrl(void *pstParams)
{
	...
	do {
		...
		if(PE_KDRV_VER_H13BX)
		{
			...
			if(PE_CHECK_WIN0(pp->win_id))
			{
				PE_P1L_H13B0_QRd02(pe1_dce_blur_ctrl_00, avg_filter_tap,	pp->avg_filter_tap,\
														 edge_map_tap,		pp->edge_map_tap);
				PE_P1L_H13B0_QRd04(pe1_dce_blur_ctrl_01, e_to_w_th_x0,		pp->e_to_w_th_x0,\
														 e_to_w_th_x1,		pp->e_to_w_th_x1,\
														 e_to_w_th_y0,		pp->e_to_w_th_y0,\
														 e_to_w_th_y1,		pp->e_to_w_th_y1);
				PE_P1L_H13B0_QRd01(pe1_dce_blur_ctrl_02, chroma_blur_mode, 	pp->chroma_blur_mode);
				PE_P1L_H13B0_QRd01(pe1_dce_ctrl_01,		 blur_v_gain, 	 	pp->blur_v_gain);
			}
			PE_DCM_HW_H13_DBG_PRINT("get[%d] : \n"\
				"avg,e_tap:%d,%d, th:%d,%d,%d,%d, c_blur_md:%d, blur_v_g:%d\n", \
				pp->win_id, pp->avg_filter_tap, pp->edge_map_tap, pp->e_to_w_th_x0, \
				pp->e_to_w_th_x1, pp->e_to_w_th_y0, pp->e_to_w_th_y1, \
				pp->chroma_blur_mode, pp->blur_v_gain);
...
int PE_DCM_HW_H13_SetBlurGain(PE_TSK_H13_CFG_T *pCfg)
{
	...
	static UINT32 sat_th = PE_DCM_HW_H13_SAT_STATUS_DTV_TH;		//pre threshold
	...
	do{
		...
		{
			sat_th = (is_atv_case)? PE_DCM_HW_H13_SAT_STATUS_ATV_HIGH_TH:PE_DCM_HW_H13_SAT_STATUS_DTV_HIGH_TH;
			pre_src_type=disp0_info->src_type;
			blur_gain = (ctrl0_info->sat_status>sat_th)? PE_DCM_HW_H13_BLUR_ORG_VAL:pInfo->cur_blur_gain;
		...
		else	// apply hysterisis : increase:use high th, decrease:use low th
		{
			...
			{
				high_val = PE_DCM_HW_H13_BLUR_ORG_VAL;
				...
				if(is_atv_case)
				{
					if(pre_sat_st<ctrl0_info->sat_status)	//increase
					{
						...
						blur_gain = (ctrl0_info->sat_status>PE_DCM_HW_H13_SAT_STATUS_ATV_HIGH_TH)? high_val:mid_val;
					}
					else	//decrease
					{
						/* if lower than lo_th, use low val, else mid_val */
						blur_gain = (ctrl0_info->sat_status>PE_DCM_HW_H13_SAT_STATUS_ATV_LOW_TH)? mid_val:low_val;
					}
				}
				else
				{
					...
					{
						/* if higher than hi_th, use high val, else mid_val */
						blur_gain = (ctrl0_info->sat_status>PE_DCM_HW_H13_SAT_STATUS_DTV_HIGH_TH)? high_val:mid_val;
					}
					else	//decrease
					{
						/* if lower than lo_th, use low val, else mid_val */
						blur_gain = (ctrl0_info->sat_status>PE_DCM_HW_H13_SAT_STATUS_DTV_LOW_TH)? mid_val:low_val;
					}
				}
				/*PE_DCM_HW_H13_DBG_PRINT("[inf ] sat:%d -> %d, blur_gain:%d -> %d\n",\
		...
		{
			PE_DCM_HW_H13_DBG_PRINT("[set ] src:%d(atv_case:%d), sat:%d(th:%d), cur_gain:%d, blur_gain:%d -> %d\n",\
				disp0_info->src_type,is_atv_case,ctrl0_info->sat_status,sat_th,\
				pInfo->cur_blur_gain,pInfo->pre_blur_gain,blur_gain);
			PE_P1L_H13B0_QWr01(pe1_dce_ctrl_01,		 blur_v_gain, 	 	GET_BITS(blur_gain,0,4));
		...
		if(_g_dcm_hw_h13_trace)
		{
			...
			{
				PE_DCM_HW_H13_DBG_PRINT("[info] src:%d(atv_case:%d), sat:%d(th:%d), cur_gain:%d, blur_gain:%d\n",\
...
int PE_DCM_HW_H13_SetDceBlendingCtrl(LX_PE_DCM_BLENDING_T *pstParams)
{
	...
	do {
		...
		PE_DCM_HW_H13_DBG_PRINT("[wid:%d] set: color_out_gain:%d, color_sel:0x%08x\n"\
			"color_region_en: %d\n"\
		...
		if(PE_KDRV_VER_H13BX)
		{
			if(PE_CHECK_WIN0(pstParams->win_id))
			{
				...
				PE_P1L_H13B0_WrFL(pe1_dce_ctrl_00);
				PE_P1L_H13B0_WrFL(pe1_dce_ctrl_01);
				PE_P1L_H13B0_QWr04(pe1_dce_ctrl_02,	color_region_en,	GET_BITS(pstParams->color_region_en,0,1),\
				...
				PE_P1L_H13B0_QWr02(pe1_dce_ctrl_03,	y_range_min,		GET_BITS(pstParams->y_range_min,0,10),\
													y_range_max,		GET_BITS(pstParams->y_range_max,0,10));
				PE_P1L_H13B0_QWr02(pe1_dce_ctrl_04,	cb_range_min,		GET_BITS(pstParams->cb_range_min,0,10),\
													cb_range_max,		GET_BITS(pstParams->cb_range_max,0,10));
				PE_P1L_H13B0_QWr02(pe1_dce_ctrl_05,	cr_range_min,		GET_BITS(pstParams->cr_range_min,0,10),\
		...
		else if(PE_KDRV_VER_H13AX)
		{
			if(PE_CHECK_WIN0(pstParams->win_id))
			{
				...
				PE_P1L_H13_WrFL(pe1_dce_ctrl_00);
				PE_P1L_H13_WrFL(pe1_dce_ctrl_01);
				PE_P1L_H13_QWr04(pe1_dce_ctrl_02,	color_region_en,	GET_BITS(pstParams->color_region_en,0,1),\
													y_grad_gain,		GET_BITS(pstParams->y_grad_gain,0,2),\
													cb_grad_gain,		GET_BITS(pstParams->cb_grad_gain,0,2),\
													cr_grad_gain,		GET_BITS(pstParams->cr_grad_gain,0,2));
				PE_P1L_H13_QWr02(pe1_dce_ctrl_03,	y_range_min,		GET_BITS(pstParams->y_range_min,0,10),\
													y_range_max,		GET_BITS(pstParams->y_range_max,0,10));
				PE_P1L_H13_QWr02(pe1_dce_ctrl_04,	cb_range_min,		GET_BITS(pstParams->cb_range_min,0,10),\
													cb_range_max,		GET_BITS(pstParams->cb_range_max,0,10));
				PE_P1L_H13_QWr02(pe1_dce_ctrl_05,	cr_range_min,		GET_BITS(pstParams->cr_range_min,0,10),\
													cr_range_max,		GET_BITS(pstParams->cr_range_max,0,10));
			}
		}
		else
	...
	do {
		...
		if(PE_KDRV_VER_H13BX)
		{
			if(PE_CHECK_WIN0(win_id))
			{
				...
				PE_P1L_H13B0_QRd04(pe1_dce_ctrl_02,	color_region_en,	pstParams->color_region_en,\
													y_grad_gain,		pstParams->y_grad_gain,\
													cb_grad_gain,		pstParams->cb_grad_gain,\
													cr_grad_gain,		pstParams->cr_grad_gain);
				PE_P1L_H13B0_QRd02(pe1_dce_ctrl_03,	y_range_min,		pstParams->y_range_min,\
													y_range_max,		pstParams->y_range_max);
				PE_P1L_H13B0_QRd02(pe1_dce_ctrl_04,	cb_range_min,		pstParams->cb_range_min,\
													cb_range_max,		pstParams->cb_range_max);
				PE_P1L_H13B0_QRd02(pe1_dce_ctrl_05,	cr_range_min,		pstParams->cr_range_min,\
		...
		else if(PE_KDRV_VER_H13AX)
		{
			if(PE_CHECK_WIN0(win_id))
			{
				...
				pstParams->region_sel = GET_BITS(r_data,8,16);	//[23:8]
				PE_P1L_H13_QRd04(pe1_dce_ctrl_02,	color_region_en,	pstParams->color_region_en,\
													y_grad_gain,		pstParams->y_grad_gain,\
													cb_grad_gain,		pstParams->cb_grad_gain,\
													cr_grad_gain,		pstParams->cr_grad_gain);
				PE_P1L_H13_QRd02(pe1_dce_ctrl_03,	y_range_min,		pstParams->y_range_min,\
													y_range_max,		pstParams->y_range_max);
				PE_P1L_H13_QRd02(pe1_dce_ctrl_04,	cb_range_min,		pstParams->cb_range_min,\
													cb_range_max,		pstParams->cb_range_max);
				PE_P1L_H13_QRd02(pe1_dce_ctrl_05,	cr_range_min,		pstParams->cr_range_min,\
													cr_range_max,		pstParams->cr_range_max);
			}
		}
		else
		...
		PE_DCM_HW_H13_DBG_PRINT("[wid:%d] get: color_out_gain:%d, color_sel:0x%08x\n"\
			"color_region_en: %d\n"\
			"grad_gain(y,cb,cr):%d,%d,%d\n"\
			"y_range(min,max):%d,%d, cb_range:%d,%d, cr_range:%d,%d\n",\
