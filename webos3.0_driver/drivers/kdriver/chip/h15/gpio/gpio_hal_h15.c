...
#include "../../chip/h15/os/linux_irqs.h"
...
----------------------------------------------------------------------------------------*/
#ifdef INCLUDE_H15_CHIP_KDRV
UINT32 		gpio_intr_num_h15[GPIO_IRQ_NUM_NR] = {H15_IRQ_GPIO0_2,H15_IRQ_GPIO3_5,H15_IRQ_GPIO6_8,H15_IRQ_GPIO9_11,H15_IRQ_GPIO12_14,H15_IRQ_GPIO15_17};
...
========================================================================================*/
 ...
 void _GPIO_ISR_GPIO_H15( unsigned int ui32IRQNum, unsigned int IntData )
{
	UINT32	gpio_array_n;
	...
	if (ui32IRQNum >= H15_IRQ_GPIO0_2 && ui32IRQNum <=H15_IRQ_GPIO15_17)
		gpio_array_n = ui32IRQNum-H15_IRQ_GPIO0_2;
	else
	{
	...
	switch( ui32IRQNum )
	{
		case H15_IRQ_GPIO0_2 :
			gpio_array_n = 0;
			break;
		case H15_IRQ_GPIO3_5 :
			gpio_array_n = 3;
			break;
		case H15_IRQ_GPIO6_8 :
			gpio_array_n = 6;
			break;
		case H15_IRQ_GPIO9_11 :
			gpio_array_n = 9;
			break;
		case H15_IRQ_GPIO12_14 :
			gpio_array_n = 12;
			break;
		case H15_IRQ_GPIO15_17 :
			gpio_array_n = 15;
			break;
		...
		if ( ui32Status & ( 1 << ucGpio ) )
		{
			...
			if ( GPIONIE(gpio_array_n) & ( 1 << ucGpio ) )
			{
				...
				if (gpio_isr_info[realGpio].count_enable == 0)
				{
					...
					GPIO_DEBUG("_GPIO_ISR_GPIO_H15 		pin[%d] value[%d]\n",realGpio, value);
