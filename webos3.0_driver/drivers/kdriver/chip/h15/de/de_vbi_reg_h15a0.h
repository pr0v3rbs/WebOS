...
#ifndef _REG_VBI_H15A0_H_
#define _REG_VBI_H15A0_H_
/*-----------------------------------------------------------------------------
		0xc8000f00L ctrl_cgms0 ''
-----------------------------------------------------------------------------*/
typedef struct {
...
typedef struct {
	H15A0_CTRL_CGMS0_T                 	ctrl_cgms0;                   //0xc8000f00L
	H15A0_CTRL_CGMS1_T                 	ctrl_cgms1;                   //0xc8000f04L
	H15A0_DATA_CGMS0_T                 	data_cgms0;                   //0xc8000f08L
	H15A0_DATA_CGMS1_T                 	data_cgms1;                   //0xc8000f0cL
	H15A0_CTRL_WSS0_T                  	ctrl_wss0;                    //0xc8000f10L
	H15A0_CTRL_WSS1_T                  	ctrl_wss1;                    //0xc8000f14L
	H15A0_CTRL_WSS2_T                  	ctrl_wss2;                    //0xc8000f18L
	H15A0_DATA_WSS0_T                  	data_wss0;                    //0xc8000f1cL
	H15A0_DATA_WSS1_T                  	data_wss1;                    //0xc8000f20L
} DE_VBI_REG_H15A0_T;
