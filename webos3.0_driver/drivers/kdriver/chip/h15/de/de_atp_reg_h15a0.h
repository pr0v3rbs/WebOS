...
#ifndef _REG_ATP_H15A0_h
#define _REG_ATP_H15A0_h
...
typedef struct {
	...
	UINT32 y_delay                     : 2;   //  8: 9
	UINT32 c_delay                     : 2;   // 10:11
...
} H15A0_A_TOP_STATUS_T;

typedef struct {
	H15A0_TTX_VER_CTRL0_T   ttx_ver_ctrl0;           // 0x3800
	H15A0_TTX_VER_CTRL1_T   ttx_ver_ctrl1;           // 0x3804
	H15A0_WSS_DATA_T        wss_data;                // 0x3808
	H15A0_CGMS_DATA_T       cgms_data;               // 0x380c
	H15A0_CVE_CONFIG_T      cve_config;              // 0x3810
	H15A0_PHASE_INCR_T      phase_incr;              // 0x3814
	H15A0_DENC_VBI_CTRL_T   denc_vbi_ctrl;           // 0x3818
	H15A0_CC_DATA_T         cc_data;                 // 0x381c
	H15A0_MV_N0_3_T         mv_n0_3;                 // 0x3820
	H15A0_MV_N4_9_T         mv_n4_9;                 // 0x3824
	H15A0_MV_N10_11_T       mv_n10_11;               // 0x3828
	H15A0_MV_N12_14_T       mv_n12_14;               // 0x382c
	H15A0_MV_N15_20_T       mv_n15_20;               // 0x3830
	H15A0_VPS_CTRL_T        vps_ctrl;                // 0x3834
	H15A0_TTX_DATA_T        ttx_data;                // 0x3838
	H15A0_TTX_LOAD_T        ttx_load;                // 0x383c
	UINT32                  reserved0[4];            // 0x3840~0x384c
	H15A0_TTX_DDRU_T        ttx_ddru;                // 0x3850
	UINT32                  reserved1[11];           // 0x3854~0x387c
	H15A0_ADDR_DBG_T        addr_dbg;                // 0x3880
	H15A0_A_TOP_STATUS_T    a_top_status;            // 0x3884
} DE_ATP_REG_H15A0_T;
