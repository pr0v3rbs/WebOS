 ...
 */
int DE_IPC_H15_Init(UINT32 mcu_id,           \
   ...
   switch(mcu_id)
   {
	   case 0:
		   *pVideoBuffToMCU = (UINT32)ioremap( \
				   DTVSOC_IPC_FROM_CPU_H15_BASE,\
				   DTVSOC_IPC_FROM_CPU_SIZE);
		   *pVideoBuffFrMCU = (UINT32)ioremap(\
				   DTVSOC_IPC_FROM_MCU_H15_BASE,\
 ...
 * @return RET_OK(0) if success, none zero for otherwise
 */
int DE_IPC_H15_Free(UINT32 *pVideoBuffToMCU, UINT32 *pVideoBuffFrMCU)
{
#ifdef USE_QEMU_SYSTEM
