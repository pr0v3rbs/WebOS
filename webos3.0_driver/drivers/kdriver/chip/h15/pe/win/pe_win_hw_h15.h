...
#ifndef	_PE_WIN_HW_H15_H_
#define	_PE_WIN_HW_H15_H_
...
typedef struct
{
	PE_WIN_HW_H15_CTRL_T win_inf;			///< window info
	PE_WIN_HW_H15_LRCR_CTRL_T lrcr_inf;		///< lrcr win info
	PE_WIN_HW_H15_TNR_CTRL_T tnr_inf;		///< tnr measure win info
}
PE_WIN_HW_H15_SETTINGS_T;
