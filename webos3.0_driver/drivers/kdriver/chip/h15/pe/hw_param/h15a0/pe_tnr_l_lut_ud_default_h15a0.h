...
const PE_REG_PARAM_T tnr_l_lut_ud_default_h15a0[] =
{
	/* nd tnr lut */
	...
	{0x41D4, 0xFF004A30},	//TNR_MAIN_LUT_01, 04. x5y5 x4y4 reg_p2_dist_max_pt
	{0x41D4, 0x40303C1D},	//TNR_MAIN_LUT_01, 05. x3y3 x2y2 reg_p2_dist_max_pt
	{0x41D4, 0x281D0000},	//TNR_MAIN_LUT_01, 06. x1y1 x0y0 reg_p2_dist_max_pt
	{0x41D4, 0x60004B00},	//TNR_MAIN_LUT_01, 07. x7y7 x6y6 reg_detail_iir_pt
	{0x41D4, 0x3C402C50},	//TNR_MAIN_LUT_01, 08. x5y5 x4y4 reg_detail_iir_pt
	{0x41D4, 0x14900AB0},	//TNR_MAIN_LUT_01, 09. x3y3 x2y2 reg_detail_iir_pt
	{0x41D4, 0x04B00300},	//TNR_MAIN_LUT_01, 10. x1y1 x0y0 reg_detail_iir_pt
	...
	{0x41D4, 0x20301060},	//TNR_MAIN_LUT_01, 13. x3y3 x2y2 reg_detail_cir_pt
	{0x41D4, 0x089004B0},	//TNR_MAIN_LUT_01, 14. x1y1 x0y0 reg_detail_cir_pt
	{0x41D4, 0x60004B00},	//TNR_MAIN_LUT_01, 15. x7y7 x6y6 reg_flat_iir_pt
	{0x41D4, 0x3C402C50},	//TNR_MAIN_LUT_01, 16. x5y5 x4y4 reg_flat_iir_pt
	{0x41D4, 0x14900AB0},	//TNR_MAIN_LUT_01, 17. x3y3 x2y2 reg_flat_iir_pt
	{0x41D4, 0x04B00300},	//TNR_MAIN_LUT_01, 18. x1y1 x0y0 reg_flat_iir_pt
	{0x41D4, 0xCA00931E},	//TNR_MAIN_LUT_01, 19. x7y7 x6y6 reg_flat_cir_pt
	{0x41D4, 0x6E465664},	//TNR_MAIN_LUT_01, 20. x5y5 x4y4 reg_flat_cir_pt
	{0x41D4, 0x45783396},	//TNR_MAIN_LUT_01, 21. x3y3 x2y2 reg_flat_cir_pt
	{0x41D4, 0x17BE0CDC},	//TNR_MAIN_LUT_01, 22. x1y1 x0y0 reg_flat_cir_pt
	...
	{0x41D4, 0xA098908A},	//TNR_MAIN_LUT_01, 26. x3x2 x1x0 reg_skin_gain_ctrl_cr
	{0x41D4, 0x30800840},	//TNR_MAIN_LUT_01, 27. x1y1 x0y0 reg_skin_motion_ctrl
	...
	{0x41D4, 0xFF004A30},	//TNR_MAIN_LUT_01, 31. x5y5 x4y4 reg_cc_dist_max_pt
	{0x41D4, 0x40303C1D},	//TNR_MAIN_LUT_01, 32. x3y3 x2y2 reg_cc_dist_max_pt
