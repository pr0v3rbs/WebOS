...
const PE_REG_PARAM_T tnr_l_ud_default_h15a0[] =
{
	/* nd tnr */
	//{0x4110, 0x0000202F},	//PE0_OPMODE
	{0x4140, 0x8049C995},	//TNR_CTRL_00,1124[2]sc_detect_hres:0->1
	{0x4144, 0x011CF410},	//TNR_CTRL_01
	{0x4148, 0x200C490E},	//TNR_CTRL_02 sc_scale3->0,L/R mismatch by js.kim,1121 sc_en 1->0 for fw sc
