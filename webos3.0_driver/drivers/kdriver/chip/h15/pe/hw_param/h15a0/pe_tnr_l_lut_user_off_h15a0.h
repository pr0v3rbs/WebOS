...
const PE_REG_PARAM_T tnr_l_lut_user_off_h15a0[] =
{
	/* nd tnr lut */
	{0x41D4, 0xFF00C000},	//TNR_MAIN_LUT_01, 00. x7y7 x6y6 reg_p2_blend_ctrl_pt
	{0x41D4, 0xA0008000},	//TNR_MAIN_LUT_01, 01. x5y5 x4y4 reg_p2_blend_ctrl_pt
	{0x41D4, 0x60004000},	//TNR_MAIN_LUT_01, 02. x3y3 x2y2 reg_p2_blend_ctrl_pt
	{0x41D4, 0x1E000000},	//TNR_MAIN_LUT_01, 03. x1y1 x0y0 reg_p2_blend_ctrl_pt
	...
	{0x41D4, 0x3C002C00},	//TNR_MAIN_LUT_01, 09. x3y3 x2y2 reg_detail_iir_pt
	{0x41D4, 0x14000A00},	//TNR_MAIN_LUT_01, 10. x1y1 x0y0 reg_detail_iir_pt
	...
	{0x41D4, 0x3C002C00},	//TNR_MAIN_LUT_01, 13. x3y3 x2y2 reg_detail_cir_pt
	{0x41D4, 0x14000A00},	//TNR_MAIN_LUT_01, 14. x1y1 x0y0 reg_detail_cir_pt
	...
	{0x41D4, 0x3C002C00},	//TNR_MAIN_LUT_01, 17. x3y3 x2y2 reg_flat_iir_pt
	{0x41D4, 0x14000A00},	//TNR_MAIN_LUT_01, 18. x1y1 x0y0 reg_flat_iir_pt
	...
	{0x41D4, 0x3C002C00},	//TNR_MAIN_LUT_01, 21. x3y3 x2y2 reg_flat_cir_pt
	{0x41D4, 0x14000A00},	//TNR_MAIN_LUT_01, 22. x1y1 x0y0 reg_flat_cir_pt
	...
	{0x41D4, 0xFF006400},	//TNR_MAIN_LUT_01, 31. x5y5 x4y4 reg_cc_dist_max_pt
	{0x41D4, 0x50003C00},	//TNR_MAIN_LUT_01, 32. x3y3 x2y2 reg_cc_dist_max_pt
	{0x41D4, 0x28000000},	//TNR_MAIN_LUT_01, 33. x1y1 x0y0 reg_cc_dist_max_pt
	...
	{0x41D4, 0x80006000},	//TNR_MAIN_LUT_01, 39. x7y7 x6y6 reg_simple_ma_iir_pt
	{0x41D4, 0x48003800},	//TNR_MAIN_LUT_01, 40. x5y5 x4y4 reg_simple_ma_iir_pt
	{0x41D4, 0x20001000},	//TNR_MAIN_LUT_01, 41. x3y3 x2y2 reg_simple_ma_iir_pt
	{0x41D4, 0x08000400},	//TNR_MAIN_LUT_01, 42. x1y1 x0y0 reg_simple_ma_iir_pt
};
