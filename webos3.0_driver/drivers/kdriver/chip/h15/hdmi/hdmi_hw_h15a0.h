 ...
 * @{
 */
#ifndef  HDMI_HW_H15A0_INC
#define  HDMI_HW_H15A0_INC
...
int HDMI_H15A0_PowerConsumption(UINT32 power);
int HDMI_H15A0_SetUDn3DControl(LX_HDMI_UD_3D_MODE_T *udn3d);


void HDMI_H15A0_SetPixelRepetition(void);
void HDMI_H15A0_SetAutoSyncPolarity(void);
