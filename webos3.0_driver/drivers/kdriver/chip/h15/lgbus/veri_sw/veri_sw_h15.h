...
/*!
    ...
    @author	jaehyun1001.jeong@lge.com
    @date	2014/01/11
    @brief
    		h15 lgbus bandwidth monitoring header file.
...
#ifndef _BUS_BW_DRV_H_
#define _BUS_BW_DRV_H_
...
#define H15_IRQ_GBUS_TIMER      91
#define H15_IRQ_EBUS_TIMER      92
...
//typedef struct {
//	domain_port_t result[MEM_MAX_IDX];
//} port_num_t;
...
#define IOCTL_LGBUS_MON_INIT		_IO(LGBUS_IOC_MAGIC, 0)
#define IOCTL_LGBUS_MON_START		_IO(LGBUS_IOC_MAGIC, 1)
#define IOCTL_LGBUS_MON_STOP		_IO(LGBUS_IOC_MAGIC, 2)
#define IOCTL_LGBUS_MON_READ		_IOR(LGBUS_IOC_MAGIC, 3, bw_reply_t)
#define IOCTL_LGBUS_MON_PORT		_IOR(LGBUS_IOC_MAGIC, 4, port_t)
