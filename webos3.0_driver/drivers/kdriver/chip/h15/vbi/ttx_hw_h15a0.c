...
int g_H15Ax_enable_vps_slicer = 0;

/*----------------------------------------------------------------------------------------
	global Variables
----------------------------------------------------------------------------------------*/
int gTTXCountOfLine318_H15A0;
int gTTXCountOfOtherLine_H15A0;
...
int TTX_HWInitialize_H15Ax(void)
{
	...
	TTX_PRINT("VBI TTX Initialize for H15Ax entered!\n");

	gTTXCountOfLine318_H15A0 = 0;
	...
	CVD_H15Ax_Wr01(vbi_ctrl_001, reg_vbi_little_endian, 0);
	...
	TTX_PRINT("VBI TTX Initialize for H15Ax is succefully done!\n");
	return ret;
}

int TTX_HWUninitialize_H15Ax(void)
{
	int ret = 0;
...
int TTX_SetInputFormat_H15Ax(eVBIDataType type)
{
	...
	switch(type)
	{
		...
		case eTTX625B:
			...
			CVD_H15Ax_RdFL(vbi_004);
			CVD_H15Ax_RdFL(vbi_013);
			CVD_H15Ax_RdFL(vbi_012);

			/* Added for H15Ax on improving performance & bugs... */
			/* 2012.10.22 won.hur */
			CVD_H15Ax_RdFL(vbi_021);
			...
			CVD_H15Ax_Wr(vbi_007, 0x66666666);
			CVD_H15Ax_Wr(vbi_008, 0x66666666);
			// 110917 by dws : Enable 16, 329 line TTX Slicing
			CVD_H15Ax_Wr(vbi_009, 0x66666666);
			//CVD_H15Ax_Wr(vbi_009, 0x66663366);
			CVD_H15Ax_Wr(vbi_010, 0x66666666);
			// 110917 by dws : Disable 336 line WSS Slicing
			CVD_H15Ax_Wr(vbi_011, 0x660C0000);
			//CVD_H15Ax_Wr(vbi_011, 0x66cc0000);
			// vbi_data_hlvl & start_code
			CVD_H15Ax_Wr(vbi_006, 0x2736);
			// reg_vps_start & reg_teletext_start & reg_wss625_start & vbi_020
			CVD_H15Ax_Wr(vbi_020, 0x54845a5a);
			CVD_H15Ax_Wr(vbi_014, 0x35A00F91);

			//CVD_H15Ax_Wr(vbi_015, 0x2066159a);
			// 110712 : WSS malfunction on green/red pattern
			//CVD_H15Ax_Wr01(vbi_015, reg_wss625_dto, 0x205A);		//13.48MHz
			CVD_H15Ax_Wr01(vbi_015, reg_wss625_dto, 0x2066);		//13.5MHz
			CVD_H15Ax_Wr01(vbi_015, reg_vps_dto, 0x159a);

			CVD_H15Ax_Wr01(vbi_016, reg_wss625_frame_start, 0x2);
			CVD_H15Ax_Wr01(iris_040, reg_vsync_vbi_max, 0x25);

			// 110712 : WSS malfunction on green/red pattern
			CVD_H15Ax_Wr01(vbi_013, reg_vbi_wss_slicer_mode, 0x1);

			CVD_H15Ax_Wr01(vbi_004, reg_vbi_muxout, 0);
			CVD_H15Ax_Wr01(vbi_004, reg_vbi_hsyncout, 0);
			...
			CVD_H15Ax_WrFL(vbi_004);
			CVD_H15Ax_WrFL(vbi_013);

			/* Added for H15Ax on improving performance & bugs... */
			/* 2012.10.22 won.hur */
			CVD_H15Ax_Wr(vbi_021, 0x00011044);
			CVD_H15Ax_Wr(vbi_023, 0x5F0A0110);
			...
			CVD_H15Ax_Wr(vbi_028, 0x40000501); // 20131210 won.hur : Changed TTX AGC gain from 6A->50 due to pyeongtek issue
			...
			CVD_H15Ax_Wr(vbi_037, 0x00000000);
			CVD_H15Ax_Wr(vbi_038, 0x00000111);

			CVD_H15Ax_WrFL(vbi_021);
			...
			CVD_H15Ax_Wr(vbi_012, 0x00006600);
			CVD_H15Ax_WrFL(vbi_012);
...
int TTX_SetInterrupt_H15Ax(int on_off)
{
	...
	if(on_off)
	{
		...
		CVD_H15Ax_Wr(cvd_intr1_enable1, (intr_vp1_en |= H15A0_VBI_INTERRUPT_MASK));
...
int TTX_ParsingVBIData_H15Ax(sHeaderData *data )
{
	...
	switch(buffer_number)
	{
		case 0:
			...
			CVD_H15Ax_Rd01(vbi_ctrl_002, reg_vbi0_start_addr, data->start);
			CVD_H15Ax_Rd01(vbi_ctrl_003, reg_vbi0_end_addr, data->end);
			CVD_H15Ax_Rd01(vbi_ctrl_002, reg_vbi0_data_cnt, data->count);
			break;
		case 1:
			CVD_H15Ax_RdFL(vbi_ctrl_004);
			CVD_H15Ax_RdFL(vbi_ctrl_005);

			CVD_H15Ax_Rd01(vbi_ctrl_004, reg_vbi1_start_addr, data->start);
			CVD_H15Ax_Rd01(vbi_ctrl_005, reg_vbi1_end_addr, data->end);
			CVD_H15Ax_Rd01(vbi_ctrl_004, reg_vbi1_data_cnt, data->count);
			break;
		case 2:
			CVD_H15Ax_RdFL(vbi_ctrl_006);
			CVD_H15Ax_RdFL(vbi_ctrl_007);

			CVD_H15Ax_Rd01(vbi_ctrl_006, reg_vbi2_start_addr, data->start);
			CVD_H15Ax_Rd01(vbi_ctrl_007, reg_vbi2_end_addr, data->end);
			CVD_H15Ax_Rd01(vbi_ctrl_006, reg_vbi2_data_cnt, data->count);
			break;
		case 3:
			CVD_H15Ax_RdFL(vbi_ctrl_008);
			CVD_H15Ax_RdFL(vbi_ctrl_009);

			CVD_H15Ax_Rd01(vbi_ctrl_008, reg_vbi3_start_addr, data->start);
			CVD_H15Ax_Rd01(vbi_ctrl_009, reg_vbi3_end_addr, data->end);
			CVD_H15Ax_Rd01(vbi_ctrl_008, reg_vbi3_data_cnt, data->count);
		break;
	}
	...
	else
	{
		...
		for(i=0;i<MAX_PACKET_NUM;i++)
		{
			...
			if( ( *(ucPacket + iHeaderPos + 0) == 0x00) && ( *(ucPacket + iHeaderPos + 1) == 0xff) && (*(ucPacket+iHeaderPos+2) == 0xff))
			{
				...
				if( ( *(ucPacket + iHeaderPos + 6) == 0x01) && ( *(ucPacket + iHeaderPos + 5) == 0x3e)) gTTXCountOfLine318_H15A0++;
				else gTTXCountOfOtherLine_H15A0++;
...
int TTX_Enable_VPS_Slicer_H15Ax(BOOLEAN Enable)
{
	...
	if(Enable){
		CVD_H15Ax_Wr01(vbi_009, reg_vbil16, 0x63);	// Enable VPS Slicing on Line #16
		g_H15Ax_enable_vps_slicer = 1;
	}
	else{
 		VBI_TTX_ClearVPSMemory();
		CVD_H15Ax_Wr01(vbi_009, reg_vbil16, 0x66);	// Enable TTX Slicing on Line #16
		g_H15Ax_enable_vps_slicer = 0;
	}
	CVD_H15Ax_WrFL(vbi_009);
...
int TTX_SetVBILPF_H15Ax(int onoff)
{
	...
	CVD_H15Ax_RdFL(vbi_005);

	if(onoff)
	{
		CVD_H15Ax_Wr(vbi_005, 0x00000001);
	}
	else
	{
		CVD_H15Ax_Wr(vbi_005, 0x00000000);
	}

	CVD_H15Ax_WrFL(vbi_005);
...
int TTX_CheckOnLine318_H15Ax(int mode)
{
	...
	if(mode)
	{
		...
		gTTXCountOfLine318_H15A0 = 0;
		gTTXCountOfOtherLine_H15A0 = 0;
		ret = 1;
	}
	else
	{
		//TTX_PRINT("Count of line 318 vs Other is [%d]/[%d]\n", gTTXCountOfLine318, gTTXCountOfOtherLine);
		if(gTTXCountOfLine318_H15A0 > 10)
		{
			if(gTTXCountOfOtherLine_H15A0 > 10) ret = 4;   // Case when data is also in line 318.
...
int TTX_SetTypeLine318_H15Ax(int onoff)
{
	...
	if(onoff)
	{
		...
		CVD_H15Ax_Wr(vbi_012, 0x00000060);
	}
	else
	{
		//TTX_PRINT("Detection for line 318 is off.\n");
		CVD_H15Ax_Wr(vbi_012, 0x00000000);
	}
...
int TTX_Set_TT_Slicer_Mode_H15Ax(unsigned int mode)
{
	...
	if(mode < 4)
	{
		CVD_H15Ax_Wr01(vbi_013, reg_vbi_tt_slicer_mode, mode);
		CVD_H15Ax_WrFL(vbi_013);
		ret = 0;
	}
	else
...
int TTX_CheckVline625_H15Ax(void)
{
	...
	if(g_H15Ax_enable_vps_slicer == 1) {
			CVD_H15Ax_RdFL(vbi_007);
			CVD_H15Ax_RdFL(vbi_008);
			CVD_H15Ax_RdFL(vbi_009);
			CVD_H15Ax_RdFL(vbi_010);
			...
			CVD_H15Ax_Wr01(vbi_009, reg_vbil16, 0x63);
			CVD_H15Ax_Wr01(vbi_015, reg_wss625_dto, 0x2066);		//13.5MHz
	...
	if(isVline625 == 0)
	{
		if(isVline625 != gPrevVline625)
		{
			...
			CVD_H15Ax_Wr(vbi_007, 0x00000000);
			CVD_H15Ax_Wr(vbi_008, 0x00000000);
			CVD_H15Ax_Wr(vbi_009, 0x00000000);
			CVD_H15Ax_Wr(vbi_010, 0x1100DD11);	// Becareful of RTL bug
			CVD_H15Ax_Wr(vbi_011, 0x00000000);
			CVD_H15Ax_Wr01(vbi_015, reg_wss625_dto, 0x1E2B);		//13.5MHz
...
int TTX_RunResume_H15Ax(void)
{
	...
	TTX_SetInputFormat_H15Ax(CURRENT_TTX);
