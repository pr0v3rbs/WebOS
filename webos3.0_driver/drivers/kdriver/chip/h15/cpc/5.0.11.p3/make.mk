...
DDK_CFLAGS	+= -DLINUX -DDRIVER
DDK_CFLAGS	+= -DDBG=1 -DDEBUG -D_DEBUG
...
DDK_OBJS	+= os/linux/kernel/gc_hal_kernel_probe.o
DDK_OBJS	+= os/linux/kernel/platform/default/gc_hal_kernel_platform_default.o
