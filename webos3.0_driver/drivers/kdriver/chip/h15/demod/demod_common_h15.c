...
UINT8 gPowerOnInitH15gbb = 1;


/***********************************************************************************
************************************************************************************/
/**
 * DEMOD_H15GBB_ResetHW.
 * Reset GBB demod ID.
 *
 * @param none  [IN/OUT]
...
int DEMOD_H15GBB_ResetHW(void)
{
	...
	ACE_REG_H15A0_RdFL(gbb_0);

	ACE_REG_H15A0_Wr01(gbb_0, reset, 1);

	ACE_REG_H15A0_WrFL(gbb_0);

	OS_MsecSleep(10);


	ACE_REG_H15A0_Wr01(gbb_0, reset, 0);
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_SetI2C(void)
{
	DEMOD_PRINT("[KDRV_DEMOD] DEMOD_SetI2C Start !! \n");

	ACE_REG_H15A0_RdFL(gbb_0);

	ACE_REG_H15A0_Wr01(gbb_0, i2csel, 0);
...
int DEMOD_H15GBB_SetInclk(LX_DEMOD_INCLK_SEL_T *inclk)
{

	DEMOD_PRINT("[KDRV_DEMOD] DEMOD_SetInclk Start !! \n");

	ACE_REG_H15A0_RdFL(gbb_afe_0);

	switch(*inclk)
	{
		case LX_DEMOD_ARM_SETTING:
		{
			ACE_REG_H15A0_Wr01(gbb_afe_0, inck_sel, 0);
		}
		break;
		...
		case LX_DEMOD_EXTERN_PIN:
		{
			...
			ACE_REG_H15A0_Wr01(gbb_afe_0, inck_sel, 1);
		}
		break;
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_RepeaterEnable(BOOLEAN bEnable)
{
	UINT8 ni2crpten;
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_SoftwareReset(void)
{
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_Serial_Control(BOOLEAN bEnable)
{
	...
	DEMOD_PRINT("^r^[DEMOD H15 DTV] success!!  DEMOD_H15GBB_VQI_Serial_Control =  %s ", (bEnable == TRUE)? "SERIAL":"PARALLEL");
...
int DEMOD_H15GBB_Power_Save(BOOLEAN bEnable)
{

	UINT8 	gbbpdb;
	UINT8	softrstb;

	DEMOD_PRINT("[DEMOD H15 DTV] @ ######chungiii   %s =====\n",__F__);
	...
	DEMOD_PRINT("[DEMOD H13] success!!  DEMOD_H15GBB_Power_Save =  %s  %d\n ", (bEnable == TRUE)? "ON":"OFF", gbbpdb);
...
************************************************************************************/
/**
 * DEMOD_H15GBB_StdOperModeContrl
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_StdOperModeContrl( LX_DEMOD_OPER_MODE_T operMode, LX_DEMOD_BWMODE_T bandWd, LX_DEMOD_SYMRDET_MODE_T symbr)
{
	UINT8 	stdopmode_7_0;
 ...
 * @author 	Jeongpil.yun(jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_NeverlockScan(DEMOD_CTX_T *pDemodInfo, LX_DEMOD_FLAG_T ResetOn, LX_DEMOD_FLAG_T *pScanProcessing, LX_DEMOD_LOCK_STATE_T *pScanLock)
{
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_TPOutEnable(BOOLEAN bEnable)
{

	UINT8 	tpouten;

	DEMOD_PRINT(" @DEMOD_H15GBB_TPOutCLKEnable\n");
	...
	DEMOD_TRACE(" DEMOD_H15GBB_TPOutEnable(%s)\n",(bEnable == TRUE) ? "ENABLE":"DISABLE");
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_Set_IF_Frq(UINT32 ifFrq)
{
	...
	DEMOD_PRINT(" @DEMOD_H15GBB_Set_IF_Frq\n");
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_Set_AGCPolarity(LX_DEMOD_AGC_POLAR_T agcPola)
{

	UINT8 	agcoutpol;

	DEMOD_PRINT(" @DEMOD_H15GBB_DVBT_Set_AGCPolarity\n");
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_Set_SpectrumCtrl(BOOLEAN bAutoEnable, BOOLEAN bSpecInvEnable)
{
	...
	if(bAutoEnable == TRUE)
	{
		...
		Common_WrFL(common_ctrl2);
		DEMOD_PRINT( "[DEMOD H15 DTV] Success  AUTO -> %s !!!\n", (bAutoEnable == TRUE)?"ON":"OFF");
	}
	else
	{
		...
		DEMOD_PRINT( "[DEMOD H15 DTV] Success Auto -> manual, Inversion ->  %s !!!\n",(bSpecInvEnable == TRUE)?"ON":"OFF");
	}
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_Get_Id(UINT16 *pId)
{
...
************************************************************************************/
/**
 * DEMOD_H15GBB_Get_SpectrumInvStatus
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_Get_SpectrumStatus(LX_DEMOD_LOCK_STATE_T *pSpectrumAuto, LX_DEMOD_LOCK_STATE_T *pSpectrumInv)
{
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_Get_IFAGC(UINT16 *pIfAgc)
{
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_Get_OperMode(LX_DEMOD_OPER_MODE_T *pOperMode)
{
...
************************************************************************************/
/**
 * DEMOD_H15GBB_Get_NeverLockStatus
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_Get_NeverLockStatus(LX_DEMOD_OPER_MODE_T scanMode, LX_DEMOD_LOCK_STATE_T *pNeverLockStatus)
{
	UINT8 neverlock_1_0;
	UINT8 srdstatus_1_0;
	UINT8 tpslockeq_d;
...
************************************************************************************/
/**
 * DEMOD_H15GBB_Get_CarrierFreqOffset
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_Get_CarrierFreqOffset(SINT32 *pFreqOff)
{
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_Get_TPIFStatus(BOOLEAN *pbEnable)
{
	UINT8 	tpifen;
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_Get_VABER(UINT32 *pVber)
{
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_Get_Packet_Error(UINT32 *pError)
{
...
************************************************************************************/
/**
 * DEMOD_H15GBB_Get_BandWidthMode
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_Get_BandWidthMode( LX_DEMOD_BWMODE_T *ChannelBW )
{
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_Get_QAMMode( LX_DEMOD_RF_MODE_T *pQamMode )
{
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_Get_MseInfo( LX_DEMOD_MSE_T *pSigMse)
{
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_Get_Lock(LX_DEMOD_LOCK_STATUS_T whatLock, LX_DEMOD_LOCK_STATE_T *lockState)
{
...
//	DEMOD_PRINT("[DEMOD H15 DTV] @ %s =====\n",__F__);
	...
	if (RET_OK != DEMOD_H15GBB_Get_OperMode(&operMode))
	{
		DEMOD_PRINT("[DEMOD H13] FAIL (%s:%d) DEMOD_H15GBB_GetOperMode() !!!\n", __F__, __L__);
		...
		case LX_DEMOD_PSYNC_LOCK:
			{
				...
				{
//					DEMOD_H15GBB_DVBT_Get_IFO_LOCK(&ifoLock);
...
int DEMOD_H15GBB_VSB_Get_SysLockTime(UINT16 *pSyslocktime)
{
	UINT8	syslocktime_15_8;
	UINT8	syslocktime_7_0;
	UINT16	syslocktime;

	DEMOD_PRINT("[DEMOD H15GBB DTV] @ %s =====\n",__F__);
...
int DEMOD_H15GBB_VSB_Get_FecLockTime(UINT16 *pFeclocktime)
{
