 ...
 ************************************************************************************/
 ...
 UINT16 _gH15gbbFullDVBPkerrCount = 9;
UINT16 _gH15gbbFullDVBPkerrThreshold = 170;

extern UINT8 gPowerOnInitH15gbb;
unsigned int gH15gbbPowerOnInitStartTimeDVB = 0;


/***********************************************************************************
	Static Variable & Function Prototypes Declarations
 ************************************************************************************/
static	UINT16			_gH15gbb_DVB_UnlockCount_full_packeterr	= 0;


/***********************************************************************************
************************************************************************************/
/**
 * DEMOD_H15GBB_DVBC_AutoSymbolRateDet
...
*/
int DEMOD_H15GBB_DVBC_AutoSymbolRateDet(LX_DEMOD_SYMRDET_MODE_T symrateMode, UINT16 SymbolRate )
{
...
************************************************************************************/
/**
 * DEMOD_H15GBB_DVBC_IsSymbolRateAuto
 * Enable/Diable automatic symbol rate detection on DVB-C mode.
 *
 * @param  *bAuto - BOOLEAN.
 * @return if Succeeded - RET_OK else-RET_ERROR
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_DVBC_IsSymbolRateAuto(BOOLEAN *bAuto)
{
...
************************************************************************************/
/**
 * DEMOD_H15GBB_DVBC_IsQammodeAutoDet
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_DVBC_IsQammodeAutoDet (BOOLEAN *bAutoQam)
{
...
************************************************************************************/
/**
 * DEMOD_H15GBB_DVBC_Set_DefaultRegisterValue
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_DVBC_Set_DefaultRegisterValue(void)
{
...
/*****************************************************************************************/
	...
	_gH15gbb_DVB_UnlockCount_full_packeterr = 0;
...
************************************************************************************/
/**
 * DEMOD_H15GBB_DVBC_Set_Config_auto
 * Control automatic setting of DVBC config.
 *
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_DVBC_Set_Config_auto (BOOLEAN bAutoDetect)
{
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_DVBC_Set_QamMode (LX_DEMOD_RF_MODE_T constel)
{
...
************************************************************************************/
/**
 * DEMOD_H15GBB_DVBC_Set_NeverLockWaitTime
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_DVBC_Set_NeverLockWaitTime(UINT32 waitMs)
{
...
************************************************************************************/
/**
 * DEMOD_H15GBB_DVBC_Get_SymbolRateDetect
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_DVBC_Get_SymbolRateDetect(UINT16 *pSymbolRate)
{
...
************************************************************************************/
/**
 * DEMOD_H15GBB_DVBC_Get_SymbolRateStatus
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_DVBC_Get_SymbolRateStatus(LX_DEMOD_SYMBOLRATE_STATE_T *pSymbolRateDet)
{
	...
	if(1 == srdlock)
	{
		...
		if (RET_OK != DEMOD_H15GBB_DVBC_Get_SymbolRateDetect(&symbolRate))
		{
...
************************************************************************************/
/**
 * DEMOD_H15GBB_DVBC_Get_QamModeDetectStatus
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_DVBC_Get_QamModeDetectStatus(LX_DEMOD_QAMMODE_STATE_T *pQamModeDet)
{
	...
	if(qmden == 1)
	{
		...
		switch(qmdstatus_1_0)
		{
			...
			case 0x02 :
			{
				...
				if (RET_OK != DEMOD_H15GBB_Get_QAMMode(&qamMode ))
				{
					DEMOD_PRINT("[DEMOD H13] FAIL (%s:%d) DEMOD_H15GBB_DVB_Get_QAMMode() !!!\n", __F__, __L__);
					return RET_ERROR;
				}
...
************************************************************************************/
/**
 * DEMOD_H15GBB_DVBC_Obtaining_Signal_Lock.
...
int DEMOD_H15GBB_DVBC_Obtaining_Signal_Lock(DEMOD_CTX_T *pDemodInfo)
{
		...
		case LX_DEMOD_RETUNE_RF:			/***************************************************/
			{
				...
				if(RET_OK != DEMOD_H15GBB_DVBC_Set_DefaultRegisterValue())
				{
					DEMOD_PRINT("[DEMOD H13] FAIL (%s:%d) DEMOD_H15GBB_DVBC_Set_DefaultRegisterValue() !!!\n", __F__, __L__);
					DEMOD_RETURN_FAIL(__F__);
				}

				if(RET_OK != DEMOD_H15GBB_DVBC_Set_NeverLockWaitTime(LX_DEMOD_DVBC_NEVERLOCK_WAIT_TIME))
				{
					DEMOD_PRINT("[DEMOD H13] FAIL (%s:%d) DEMOD_H15GBB_DVBC_Set_NeverLockWaitTime() !!!\n", __F__, __L__);
					DEMOD_RETURN_FAIL(__F__);
				}
				if(LX_DEMOD_TUNE_NORMAL != pDemodInfo->setCfgParam.dvbc.tuneMode)
				{
					if(RET_OK != DEMOD_H15GBB_DVBC_Set_Config_auto(TRUE))
					{
						DEMOD_PRINT("[DEMOD H13] FAIL (%s:%d) DEMOD_H15GBB_DVBC_Set_Config_auto() !!!\n", __F__, __L__);
						DEMOD_RETURN_FAIL(__F__);
					}

					if(RET_OK != DEMOD_H15GBB_DVBC_AutoSymbolRateDet(LX_DEMOD_SYMR_FULL_SCAN_MODE, LX_DEMOD_SYMBOL_RATE_6900_KHZ))
					{
						DEMOD_PRINT("[DEMOD H13] FAIL (%s:%d) DEMOD_H15GBB_DVBC_AutoSymbolRateDet() !!!\n", __F__, __L__);
						DEMOD_RETURN_FAIL(__F__);
					}
...
#else
					if(RET_OK != DEMOD_H15GBB_DVBC_Set_Config_auto(FALSE))
					{
						DEMOD_PRINT("[DEMOD H13] FAIL (%s:%d) DEMOD_H15GBB_DVBT_Set_Config_auto() !!!\n", __F__, __L__);
						DEMOD_RETURN_FAIL(__F__);
					}

					if(RET_OK != DEMOD_H15GBB_DVBC_AutoSymbolRateDet(LX_DEMOD_SYMR_FIXED_MODE, pDemodInfo->setCfgParam.dvbc.symbolRate))
					{
						DEMOD_PRINT("[DEMOD H13] FAIL (%s:%d) DEMOD_H15GBB_DVBC_AutoSymbolRateDet() !!!\n", __F__, __L__);
						DEMOD_RETURN_FAIL(__F__);
					}

					if(RET_OK != DEMOD_H15GBB_DVBC_Set_QamMode(pDemodInfo->setCfgParam.dvbc.qamMode))
					{
						DEMOD_PRINT("[DEMOD H13] FAIL (%s:%d) DEMOD_H15GBB_DVBC_Set_QamMode() !!!\n", __F__, __L__);
						DEMOD_RETURN_FAIL(__F__);
					}
...
int DEMOD_H15GBB_DVBC_Monitoring_Signal_Lock(DEMOD_CTX_T *pDemodInfo)
{
	...
	if(LX_DEMOD_LOCKED == lockState)
	{
		...
		if(pDemodInfo->signalStatus.packetError >= _gH15gbbFullDVBPkerrThreshold)
		{
			_gH15gbb_DVB_UnlockCount_full_packeterr++;
			DEMOD_PRINT( "^r^[DEMOD H13](%s) _gH15gbb_DVB_UnlockCount_full_packeterr = %d !!!\n", __F__,_gH15gbb_DVB_UnlockCount_full_packeterr);

			if(_gH15gbb_DVB_UnlockCount_full_packeterr == _gH15gbbFullDVBPkerrCount)
			{
				...
				DEMOD_PRINT("[DEMOD H13](%s) DEMOD_H15GBB_DVBT_Set_Config_auto(TRUE) !!!\n", __F__);
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_DVBC_Get_DvbInfo(void)

{
	...
	//IF AGC
	if (RET_OK != DEMOD_H15GBB_Get_IFAGC(&ifAGCGain))
	{
	...
	DEMOD_PRINT("[DEMOD H13] IF AGC Gain = 0x%x !!!\n",ifAGCGain);
 	...
 	//NeverLock status
	if (RET_OK != DEMOD_H15GBB_Get_NeverLockStatus(LX_DEMOD_DVBC, &neverLockStatus))
	{

		DEMOD_PRINT("[DEMOD H13] FAIL (%s:%d) DEMOD_H15GBB_DVBC_Get_NeverLockStatus() !!!\n", __F__, __L__);
	...
	if (RET_OK != DEMOD_H15GBB_Get_Lock(LX_DEMOD_CARR_LOCK,&carrLockState) )
	{
		DEMOD_PRINT("[LX_DEMOD_DTV] FAIL (%s:%d) DEMOD_H15GBB_Get_Lock() !!!\n", __F__, __L__);
		return RET_ERROR;
	...
	if (RET_OK != DEMOD_H15GBB_Get_Lock( LX_DEMOD_TR_LOCK, &samplingLock))
	{
	...
	if (RET_OK != DEMOD_H15GBB_DVBC_IsSymbolRateAuto(&isAutoSymbol))
	{

		DEMOD_PRINT("[DEMOD H13] FAIL (%s:%d) DEMOD_H15GBB_DVBC_Get_SymbolRateStatus() !!!\n", __F__, __L__);
	...
	{
		if (RET_OK != DEMOD_H15GBB_DVBC_Get_SymbolRateStatus(&symbolRateDet))
	...
	if (RET_OK != DEMOD_H15GBB_DVBC_IsQammodeAutoDet(&isAutoQammode))
	{

		DEMOD_PRINT("[DEMOD H13] FAIL (%s:%d) DEMOD_H15GBB_DVBC_IsQammodeAutoDet() !!!\n", __F__, __L__);
	...
	if(TRUE == isAutoQammode)
	{
		...
		if (RET_OK != DEMOD_H15GBB_DVBC_Get_QamModeDetectStatus(&qamModeDet))
		{
			DEMOD_PRINT("[DEMOD H13] FAIL (%s:%d) DEMOD_H15GBB_DVBC_Get_QamModeDetectStatus() !!!\n", __F__, __L__);
	...
	//Frame lock status
	if (RET_OK != DEMOD_H15GBB_Get_Lock(LX_DEMOD_FEC_LOCK, &fecLockState) )
	{
		DEMOD_PRINT("[LX_DEMOD_DTV] FAIL (%s:%d) DEMOD_H15GBB_Get_Lock() !!!\n", __F__, __L__);
		return RET_ERROR;
	...
	DEMOD_PRINT("[DEMOD H13] mse = %d, constPwr = %d, !!!\n",sigMse.mse, sigMse.constPwr);
 	...
 	//BER after Viterbi
	if (RET_OK != DEMOD_H15GBB_Get_VABER(&vBer))
	{
		DEMOD_PRINT("[DEMOD H13] FAIL (%s:%d) DEMOD_H15GBB_DVBC_Get_SNR() !!!\n", __F__, __L__);
	...
	printk("[DEMOD H15 DTV] Spectrum auto = %s, Inversion  = %s !!!\n",(spectrumAuto == LX_DEMOD_AUTO) ? " Auto" : " Manual",
...
/**
 * DEMOD_H15GBB_DVBT_Set_DefaultRegisterValue
 * Set defualt register value on DVB-T.
 * This function is applied only to A0 version, not to A1 version.
 *
 * @param none
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_DVBT_Set_DefaultRegisterValue(LX_DEMOD_BWMODE_T band)
{
	UINT8 adcsel1v;
	UINT8 adcclkpllsel;
   ...
   // TXPCCTH_DI[7:0] : TPS/TMCC confidence counter value set
	...
	if(gPowerOnInitH15gbb == 1)
	{
		...
		gH15gbbPowerOnInitStartTimeDVB = jiffies_to_msecs(jiffies);
	}
	...
	{
		powerOnElapsedTime = jiffies_to_msecs(jiffies) - gH15gbbPowerOnInitStartTimeDVB;
		...
		if(powerOnElapsedTime >= 15000)
		{
			...
			if (RET_OK != DEMOD_H15GBB_DVBT_Set_CrGearshEn(TRUE ))
			{
				DEMOD_PRINT("[DEMOD H13] FAIL (%s:%d) DEMOD_H15GBB_DVBT_Set_CrGearshEn() !!!\n", __F__, __L__);
				DEMOD_RETURN_FAIL(__F__);
			}
		}
...
************************************************************************************/
/**
 * DEMOD_H15GBB_DVBT_Set_Config_auto
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_DVBT_Set_Config_auto (BOOLEAN bAutoDetect)
...
************************************************************************************/
/**
 * DEMOD_H15GBB_DVBT_Set_PartialConfig
 * Set hierachical signal path and bandwidth.
 * This function is used when LX_DEMOD_H15GBB_DVBT_Set_Config_auto is enabled.
 *
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_DVBT_Set_PartialConfig (LX_DEMOD_DVBT_CONFIG_T *pDvbtConfigParam)
{
...
************************************************************************************/
/**
 * DEMOD_H15GBB_DVBT_Set_FullConfig
 * Set all config parameters on DVB-T.
 * This function is used when LX_DEMOD_H15GBB_DVBT_Set_Config_auto is disabled.
 *
 * @param *pDvbtConfigParam 	[IN] LX_DEMOD_DVBT_CONFIG_T - DVB-T config. structure
 * @return if Succeeded - RET_OK else-RET_ERROR
 * @see
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_DVBT_Set_FullConfig (LX_DEMOD_DVBT_CONFIG_T *pDvbtConfigParam)
{
...
************************************************************************************/
/**
 * DEMOD_H15GBB_DVBT_Set_NeverLockWaitTime
 * Set neverlock waiting period.
 *
 * @param waitMs 	[IN] UINT32 - unit: ms
 * @return if Succeeded - RET_OK else-RET_ERROR
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_DVBT_Set_NeverLockWaitTime(UINT32 waitMs)
{
	UINT8 scsyslockchktime_7_0;
...
************************************************************************************/
/**
 * DEMOD_H15GBB_DVBT_Set_TafcWaitSymbol
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_DVBT_Set_TafcWaitSymbol(BOOLEAN bDelayed)
{
	UINT8 crtafcwaittime_di_7_0;
...
************************************************************************************/
/**
 * DEMOD_H15GBB_DVBT_Set_CTFNR_Control
 * Set TAFC wait symbol number.
 *
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_DVBT_Set_CTFNR_Control(LX_DEMOD_CTFNR_CTRL_T ctfnrCtrl)
{
	UINT8 ctfnrlen_2_0;
...
************************************************************************************/
/**
 * DEMOD_H15GBB_DVBT_Set_CirPwrControl
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_DVBT_Set_CirPwrControl(LX_DEMOD_CIR_POWER_CTRL_T cirPwrCtrl)
{
	UINT8 cirnrctrl_d_2_0;
	UINT8 cirpwrctrl_d_3_0;
...
************************************************************************************/
/**
 * DEMOD_H15GBB_DVBT_Set_CrGearshEn
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_DVBT_Set_CrGearshEn(BOOLEAN bEnable)
{
	UINT8 crgearshen;
...
************************************************************************************/
/**
 * DEMOD_H15GBB_DVBT_Set_CirNormalize
 * Set Cir Power level and NR level
 *
 * @param none 	[IN] void
 * @return if Succeeded - RET_OK else-RET_ERROR
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_DVBT_Set_CirNormalize(void)
{
	...
	if(RET_OK != DEMOD_H15GBB_DVBT_Get_DelaySpreadStatus(&delaySpread))
	{
		DEMOD_PRINT("[DEMOD H13] FAIL (%s:%d) DEMOD_H15GBB_DVBT_Get_DelaySpreadStatus() !!!\n", __F__, __L__);
		DEMOD_RETURN_FAIL(__F__);
	}

	if(delaySpread <= 430)
	{
		if (RET_OK != DEMOD_H15GBB_DVBT_Set_CTFNR_Control(LX_DEMOD_CTFNR_1_16))
		{
			DEMOD_PRINT("[DEMOD H14] FAIL (%s:%d) DEMOD_H15GBB_DVBT_Set_CTFNR_Control !!!\n", __F__, __L__);
			return RET_ERROR;
		}
	...
	DEMOD_PRINT("[DEMOD H15 DTV](%s) validCirCount = %d \n",__F__,validCirCount);
	DEMOD_PRINT("[DEMOD H15 DTV](%s) maxCir = %d, minCir = %d \n",__F__, maxCir, minCir);
	...
	if(validCirCount != 2 )
	{
		...
		DEMOD_PRINT("[DEMOD H15 DTV](%s) delay spread = %d \n",__F__,delaySpread);

		if(/*(delaySpread <= 600) ||*/ (delaySpread > 2048))
		{
			if (RET_OK != DEMOD_H15GBB_DVBT_Set_CirPwrControl(LX_DEMOD_CIR_POWER_MID))
			{
				DEMOD_PRINT("[DEMOD H14] FAIL (%s:%d) DEMOD_H15GBB_DVBT_Set_CirPwrControl !!!\n", __F__, __L__);
				return RET_ERROR;
			}
		...
		{
			if(RET_OK != DEMOD_H15GBB_DVBT_Get_PreGhostDetection(&IsPreGhostExist))
			{
				DEMOD_PRINT("[DEMOD H13] FAIL (%s:%d) DEMOD_H15GBB_DVBT_Get_DelaySpreadStatus() !!!\n", __F__, __L__);
				DEMOD_RETURN_FAIL(__F__);
			}
	...
	{
		if (RET_OK != DEMOD_H15GBB_DVBT_Get_CirPwrControl(&cirPwrCtrl))
		{
			DEMOD_PRINT("[DEMOD H14] FAIL (%s:%d) DEMOD_H15GBB_DVBT_Set_CirPwrControl !!!\n", __F__, __L__);
			return RET_ERROR;
		}
		...
		if(cirPwrCtrl == LX_DEMOD_CIR_POWER_HIGH)
		{
		    ...
		    {
				if (RET_OK != DEMOD_H15GBB_DVBT_Set_CirPwrControl(LX_DEMOD_CIR_POWER_LOW))
				{
					DEMOD_PRINT("[DEMOD H14] FAIL (%s:%d) DEMOD_H15GBB_DVBT_Set_CirPwrControl !!!\n", __F__, __L__);
					return RET_ERROR;
				}
...
************************************************************************************/
/**
 * DEMOD_H15GBB_DVBT_Get_CirPwrControl
 * Set Cir Power level and NR level
 *
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_DVBT_Get_CirPwrControl(LX_DEMOD_CIR_POWER_CTRL_T *pCirPwrCtrl)
{
	UINT8 cirnrctrl_d_2_0;
...
************************************************************************************/
/**
 * DEMOD_H15GBB_DVBT_Get_PreGhostDetection
 * Set Cir Power level and NR level
 *
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_DVBT_Get_PreGhostDetection(BOOLEAN *pIsExist)
{
	...
	DEMOD_PRINT("[DEMOD H15 DTV](%s) stocurstatus_1_0 = %d, pIsExist = %s \n",__F__, stocurstatus_1_0, (*pIsExist == TRUE) ? "TRUE" : "FALSE");
...
************************************************************************************/
/**
 * DEMOD_H15GBB_DVBT_Get_DelaySpreadStatus
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_DVBT_Get_DelaySpreadStatus(UINT16 *pDelaySpread)
{
...
************************************************************************************/
/**
 * DEMOD_H15GBB_DVBT_Get_Hierach_HPSel
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_DVBT_Get_Hierach_HPSel( BOOLEAN *pBSetHp )
{
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_DVBT_Get_FFTMode( LX_DEMOD_LOCK_STATE_T *pTxModeLock, LX_DEMOD_FFTMODE_T *pFftMode )
{
...
************************************************************************************/
/**
 * DEMOD_H15GBB_DVBT_Get_GuradIntervalMode
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_DVBT_Get_GuradIntervalMode( LX_DEMOD_GIMODE_T *pGIMode )
{
...
************************************************************************************/
/**
 * DEMOD_H15GBB_DVBT_Get_HierachyMode
 * Get the information of hierachical mode on DVB-T.
 *
 * @param *pHierachMode[OUT] DEMOD_H15GBB_DVB_TPS_HIERACHY_T - alpha = none, 1, 2 and 4.
 * @return if Succeeded - RET_OK else-RET_ERROR
 * @see
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_DVBT_Get_HierachyMode( LX_DEMOD_DVB_TPS_HIERACHY_T *pHierachMode )
{
...
************************************************************************************/
/**
 * DEMOD_H15GBB_DVBT_Get_LpCoderRate
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_DVBT_Get_LpCoderRate( LX_DEMOD_CODERATE_T *pLpCodeRate )
{
...
************************************************************************************/
/**
 * DEMOD_H15GBB_DVBT_Get_HpCoderRate
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_DVBT_Get_HpCoderRate( LX_DEMOD_CODERATE_T *pHpCodeRate )
{
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_DVBT_Get_CellId(UINT8 *pCellIDLength, UINT16 *cell_id)
{
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_DVBT_Get_TpsInfo( LX_DEMOD_DVBT_CONFIG_T *pTpsParams)
{
	BOOLEAN bSetHp = TRUE;
	...
	if(NULL == pTpsParams)
	{
		DEMOD_PRINT("[DEMOD H13] ERROR, DEMOD_H15GBB_DVBT_CONFIG_T TpsParams is NULL !!!\n");
		return RET_ERROR;
	}

	// Get bSetHp

	if (RET_OK != DEMOD_H15GBB_DVBT_Get_Hierach_HPSel( &bSetHp ))
	{
		DEMOD_PRINT("[DEMOD H13] FAIL (%s:%d) DEMOD_H15GBB_DVBT_Get_Hierach_HPSel() !!!\n", __F__, __L__);
		return RET_ERROR;
	}
	...
	// Get FFT mode
	if (RET_OK != DEMOD_H15GBB_DVBT_Get_FFTMode( &txModeLock, &FFTMode ))
	{
		DEMOD_PRINT("[DEMOD H13] FAIL (%s:%d) DEMOD_H15GBB_DVBT_Get_FFTMode() !!!\n", __F__, __L__);
		return RET_ERROR;
	}
	...
	if (RET_OK != DEMOD_H15GBB_DVBT_Get_GuradIntervalMode( &gIMode ))
	{
	...
	if (RET_OK != DEMOD_H15GBB_DVBT_Get_HierachyMode( &hierachMode ))
	{
		DEMOD_PRINT("[DEMOD H13] FAIL (%s:%d) DEMOD_H15GBB_DVBT_Get_HierachyMode() !!!\n", __F__, __L__);
		return RET_ERROR;
	}
	...
	// Get LP coder rate
	if (RET_OK != DEMOD_H15GBB_DVBT_Get_LpCoderRate( &lpCodeRate ))
	{
		DEMOD_PRINT("[DEMOD H13] FAIL (%s:%d) DEMOD_H15GBB_DVBT_Get_LpCoderRate() !!!\n", __F__, __L__);
		return RET_ERROR;
	}
	...
	if (RET_OK != DEMOD_H15GBB_DVBT_Get_HpCoderRate( &hpCodeRate ))
	{
		DEMOD_PRINT("[DEMOD H13] FAIL (%s:%d) DEMOD_H15GBB_DVBT_Get_HpCoderRate() !!!\n", __F__, __L__);
		return RET_ERROR;
	}
...
************************************************************************************/
/**
 * DEMOD_H15GBB_DVBT_Get_TotalInfo
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_DVBT_Get_TotalInfo( void)
{
	...
	if (RET_OK != DEMOD_H15GBB_Get_NeverLockStatus(LX_DEMOD_DVBT, &neverLockStatus))
	{
		DEMOD_PRINT("[DEMOD H13] FAIL (%s:%d) DEMOD_H15GBB_DVB_Get_NeverLockStatus() !!!\n", __F__, __L__);
	...
	if (RET_OK != DEMOD_H15GBB_DVBT_Get_FFTMode( &txModeLock, &fftMode ))
	{
		DEMOD_PRINT("[DEMOD H13] FAIL (%s:%d) DEMOD_H15GBB_DVBT_Get_SpectrumInvStatus() !!!\n", __F__, __L__);
		delaySpread = 0xffff;
	}
	//TP Error count
	errorMode = LX_DEMOD_I2C_READ_BASED;
	if (RET_OK !=  DEMOD_H15GBB_Get_Packet_Error(&errorCount))
	{
		DEMOD_PRINT("[DEMOD H13] FAIL (%s:%d) DEMOD_H15GBB_DVBT_Get_TPError() !!!\n", __F__, __L__);
		return RET_ERROR;
	}
	DEMOD_PRINT("[DEMOD H13] TP Error Count= %d !!!\n",errorCount);
	...
	if (RET_OK != DEMOD_H15GBB_DVBT_Get_TpsInfo( &tppsParams))
	{
		DEMOD_PRINT("[DEMOD H13] FAIL (%s:%d) DEMOD_H15GBB_DVBT_Get_TpsInfo() !!!\n", __F__, __L__);
		return RET_ERROR;
	}
...
************************************************************************************/
/**
 * DEMOD_H15GBB_DVBT_Get_IFO_LOCK
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_DVBT_Get_IFO_LOCK( BOOLEAN *pIfoLock)
{
	UINT8	syslock;
...
************************************************************************************/
/**
 * DEMOD_H15GBB_DVBT_Get_CochanDetIndicator
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_DVBT_Get_CochanDetIndicator( BOOLEAN *pDetStatus)
{
...
************************************************************************************/
/**
 * DEMOD_H15GBB_DVBT_EqualizereReset.
 ...
 * @author 	Jeongpil.yun (jeongpil.yun@lge.com)
*/
int DEMOD_H15GBB_DVBT_EqualizereReset(void)
{
...
************************************************************************************/
/**
 * DEMOD_H15GBB_DVBT_Obtaining_Signal_Lock.
 * Set channel change parameters
 *
 * @param *pDemodInfo [IN] DEMOD_CTX_T
 * @return if Succeeded - RET_OK else-RET_ERROR
...
int DEMOD_H15GBB_DVBT_Obtaining_Signal_Lock(DEMOD_CTX_T *pDemodInfo)
{
		...
		case LX_DEMOD_RETUNE_RF:			/***************************************************/
			{
				...
				if(RET_OK != DEMOD_H15GBB_DVBT_Set_DefaultRegisterValue(pDemodInfo->setCfgParam.dvbt.channelBW))
				{
					DEMOD_PRINT("[DEMOD H13] FAIL (%s:%d) DEMOD_H15GBB_DVBT_Set_DefaultRegisterValue() !!!\n", __F__, __L__);
					DEMOD_RETURN_FAIL(__F__);
				}

				DEMOD_PRINT("[DEMOD H13] [DEMOD H13] MONITORING FUNC : change to CIR power level(0x86) !!!\n");
				if(RET_OK != DEMOD_H15GBB_DVBT_Set_NeverLockWaitTime(LX_DEMOD_DVBT_NEVERLOCK_WAIT_TIME))
				{
					DEMOD_PRINT("[DEMOD H13] FAIL (%s:%d) DEMOD_H15GBB_DVBT_Set_NeverLockWaitTime() !!!\n", __F__, __L__);
					DEMOD_RETURN_FAIL(__F__);
				}

				if(LX_DEMOD_TUNE_NORMAL != pDemodInfo->setCfgParam.dvbt.tuneMode)
				{
					if(RET_OK != DEMOD_H15GBB_DVBT_Set_Config_auto(TRUE))
					{
						DEMOD_PRINT("[DEMOD H13] FAIL (%s:%d) DEMOD_DVBT_Set_Config_auto() !!!\n", __F__, __L__);
						DEMOD_RETURN_FAIL(__F__);
					}

					if(RET_OK != DEMOD_H15GBB_DVBT_Set_PartialConfig(&(pDemodInfo->setCfgParam.dvbt)))
					{
				...
				else
				{
					...
					if(RET_OK != DEMOD_H15GBB_DVBT_Set_PartialConfig(&(pDemodInfo->setCfgParam.dvbt)))
					{
						DEMOD_PRINT("[DEMOD H13] FAIL (%s:%d) DEMOD_H15GBB_DVBT_Set_PartialConfig() !!!\n", __F__, __L__);
						DEMOD_RETURN_FAIL(__F__);
					}

#else
					if(RET_OK != DEMOD_H15GBB_DVBT_Set_Config_auto(FALSE))
					{
						DEMOD_PRINT("[DEMOD H13] FAIL (%s:%d) DEMOD_H15GBB_DVBT_Set_Config_auto() !!!\n", __F__, __L__);
						DEMOD_RETURN_FAIL(__F__);
					}

					if(RET_OK != DEMOD_H15GBB_DVBT_Set_FullConfig(&(pDemodInfo->setCfgParam.dvbt)))
					{
						DEMOD_PRINT("[DEMOD H13] FAIL (%s:%d) DEMOD_H15GBB_DVBT_Set_FullConfig() !!!\n", __F__, __L__);
						DEMOD_RETURN_FAIL(__F__);
					}
		...
		case LX_DEMOD_SYNC_CHECKING : 		/********************************************/
			{
				...
				if(LX_DEMOD_LOCKED == lockState)
				{
					DEMOD_H15GBB_DVBT_Set_TafcWaitSymbol(TRUE);
					...
					if(fftMode == LX_DEMOD_DVBT_ISDBT_FFT_2K)
					{
						...
						tiauto_2_0 = 0x5;
						EQ_DI_RdFL(eq_di_ctrl47); //regAddr = 0x222f, EQ_DI_CTRL[47]
						EQ_DI_Wr01(eq_di_ctrl47,tiauto_2_0, tiauto_2_0);
						EQ_DI_WrFL(eq_di_ctrl47);
						...
						mbupth2k_3_0 = 0x7;
						EQ_DI_RdFL(eq_di_ctrl50); //regAddr = 0x2232, EQ_DI_CTRL[50]
						EQ_DI_Wr01(eq_di_ctrl50,mbupth2k_3_0, mbupth2k_3_0);
						EQ_DI_WrFL(eq_di_ctrl50);
						...
						mblockctrl = 0x0;
						EQ_DI_RdFL(eq_di_ctrl53); //regAddr = 0x2235, EQ_DI_CTRL[53]
						EQ_DI_Wr01(eq_di_ctrl53,mblockctrl,mblockctrl );
						EQ_DI_WrFL(eq_di_ctrl53);
						...
						else
						{
							...
							if(packetError < LX_DEMOD_PACKET_ERROR_THD)
							{
								...
								if((LX_DEMOD_BW_6MHZ == pDemodInfo->setCfgParam.dvbt.channelBW) /* && (LX_DEMOD_TUNE_NORMAL == pDemodInfo->setCfgParam.dvbt.tuneMode)*/)
								{
									...
									if (RET_OK != DEMOD_H15GBB_Get_QAMMode( &qamMode ))
									{
										DEMOD_PRINT("[DEMOD H13] FAIL (%s:%d) DEMOD_H15GBB_Get_QAMMode() !!!\n", __F__, __L__);
										DEMOD_RETURN_FAIL(__F__);
									}
									...
									{	// To resolve pre-echo stream TW 8K, 1/4
										...
										if (RET_OK != DEMOD_H15GBB_DVBT_Set_CirNormalize())
										{
											DEMOD_PRINT("[DEMOD H13] FAIL (%s:%d) DEMOD_H15GBB_DVBT_Set_CirNormalize() !!!\n", __F__, __L__);
											DEMOD_RETURN_FAIL(__F__);
										}
										DEMOD_PRINT("[DEMOD H13] (%s) DEMOD_H15GBB_DVBT_Set_CirNormalize() !!!\n", __F__ );
...
************************************************************************************/
/**
 * DEMOD_H15GBB_DVBT_Monitoring_Signal_Lock.
 * Set channel change parameters
 *
 * @param *pDemodInfo [IN] DEMOD_CTX_T
 * @return if Succeeded - RET_OK else-RET_ERROR
...
int DEMOD_H15GBB_DVBT_Monitoring_Signal_Lock(DEMOD_CTX_T *pDemodInfo)
{
