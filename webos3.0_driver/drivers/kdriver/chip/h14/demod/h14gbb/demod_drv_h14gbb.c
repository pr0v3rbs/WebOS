...
LX_DEMOD_COMMON_REG_T 	*gpRegH14GBBCOMMON_Ax;
LX_DEMOD_SYNC_REG_T 	*gpRegH14GBBSYNC_Ax;	
LX_DEMOD_EQ_V_REG_T 	*gpRegH14GBBEQ_V_Ax; 
LX_DEMOD_EQ_DI_REG_T 	*gpRegH14GBBEQ_DI_Ax;
LX_DEMOD_EQ_CQS_REG_T 	*gpRegH14GBBCQS_Ax; 	
LX_DEMOD_FEC_REG_T	 	*gpRegH14GBBFEC_Ax; 	
...
{
	gpRegH14GBBCOMMON_Ax 	=   (LX_DEMOD_COMMON_REG_T*)OS_KMalloc(sizeof(LX_DEMOD_COMMON_REG_T));
	gpRegH14GBBSYNC_Ax		=   (LX_DEMOD_SYNC_REG_T*)OS_KMalloc(sizeof(LX_DEMOD_SYNC_REG_T));
	gpRegH14GBBEQ_V_Ax 		=   (LX_DEMOD_EQ_V_REG_T*)OS_KMalloc(sizeof(LX_DEMOD_EQ_V_REG_T));
	gpRegH14GBBEQ_DI_Ax		=   (LX_DEMOD_EQ_DI_REG_T*)OS_KMalloc(sizeof(LX_DEMOD_EQ_DI_REG_T));
	gpRegH14GBBCQS_Ax 		=   (LX_DEMOD_EQ_CQS_REG_T*)OS_KMalloc(sizeof(LX_DEMOD_EQ_CQS_REG_T));
	gpRegH14GBBFEC_Ax 		=   (LX_DEMOD_FEC_REG_T*)OS_KMalloc(sizeof(LX_DEMOD_FEC_REG_T));
