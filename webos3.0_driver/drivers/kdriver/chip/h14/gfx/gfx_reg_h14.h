...
#ifndef _GFX_REG_H14_H_
#define _GFX_REG_H14_H_
...
typedef struct {
	UINT32
	csc_coef_xx                     :15,	//  0:14 , raxis.lim -- not used !!
	                                : 1,	//    15 reserved
	csc_coef_8                      :15;	// 16:30
} WR_CSC_COEF_04;
...
typedef struct {
	UINT32
/* raxis.lim -- reg manual bug & fix register conversion bug fix */
...
typedef struct {
	...
	UINT32                          	r0_base_addr                    ;	// 0x0050 : ''
	R0_STRIDE                       	r0_stride                       ;	// 0x0054 : ''
	R0_PFORMAT                      	r0_pformat                      ;	// 0x0058 : ''
#if 1	/* raxis.lim -- UINT32 is suitable for reg access */
	UINT32 		                      	r0_galpha                       ;	// 0x005c : ''
#else
	R0_GALPHA                       	r0_galpha                       ;	// 0x005c : ''
#endif
	R0_CLUT_CTRL                    	r0_clut_ctrl                    ;	// 0x0060 : ''
	UINT32                          	r0_clut_data                    ;	// 0x0064 : ''
	R0_CTRL                         	r0_ctrl                         ;	// 0x0068 : ''
	UINT32                          	r0_ckey_key0                    ;	// 0x006c : ''
	UINT32                          	r0_ckey_key1                    ;	// 0x0070 : ''
	UINT32                          	r0_ckey_replace_color           ;	// 0x0074 : ''
	UINT32                          	r0_bitmask                      ;	// 0x0078 : ''
#if 1	/* raxis.lim -- UINT32 is suitable for reg access */
	UINT32		                     	r0_coc_ctrl                     ;	// 0x007c : ''
#else
	R0_COC_CTRL                     	r0_coc_ctrl                     ;	// 0x007c : ''
#endif

	UINT32                          	r1_base_addr                    ;	// 0x0080 : ''
	R1_STRIDE                       	r1_stride                       ;	// 0x0084 : ''
	R1_PFORMAT                      	r1_pformat                      ;	// 0x0088 : ''
#if 1	/* raxis.lim -- UINT32 is suitable for reg access */
	UINT32		                       	r1_galpha                       ;	// 0x008c : ''
#else
	R1_GALPHA                       	r1_galpha                       ;	// 0x008c : ''
#endif
	R1_CLUT_CTRL                    	r1_clut_ctrl                    ;	// 0x0090 : ''
	UINT32                          	r1_clut_data                    ;	// 0x0094 : ''
	R1_CTRL                         	r1_ctrl                         ;	// 0x0098 : ''
	UINT32                          	r1_ckey_key0                    ;	// 0x009c : ''
	UINT32                          	r1_ckey_key1                    ;	// 0x00a0 : ''
	UINT32                          	r1_ckey_replace_color           ;	// 0x00a4 : ''
	UINT32                          	r1_bitmask                      ;	// 0x00a8 : ''
#if 1	/* raxis.lim -- UINT32 is suitable for reg access */
	UINT32		                     	r1_coc_ctrl                     ;	// 0x00ac : ''
#else
	R1_COC_CTRL                     	r1_coc_ctrl                     ;	// 0x00ac : ''
#endif

	UINT32                          	r2_base_addr                    ;	// 0x00b0 : ''
	R2_STRIDE                       	r2_stride                       ;	// 0x00b4 : ''
	R2_PFORMAT                      	r2_pformat                      ;	// 0x00b8 : ''
#if 1	/* raxis.lim -- UINT32 is suitable for reg access */
	UINT32		                       	r2_galpha                       ;	// 0x00bc : ''
#else
	R2_GALPHA                       	r2_galpha                       ;	// 0x00bc : ''
#endif

	UINT32                          	                 __rsvd_01[  16];	// 0x00c0 ~ 0x00fc
	...
	UINT32                          	                 __rsvd_02[   3];	// 0x0114 ~ 0x011c
	UINT32                          	wr_base_addr                    ;	// 0x0120 : ''
	WR_STRIDE                       	wr_stride                       ;	// 0x0124 : ''
	WR_PFORMAT                      	wr_pformat                      ;	// 0x0128 : ''
	WR_SIZE                         	wr_size                         ;	// 0x012c : ''
#if 1	/* raxis.lim -- UINT32 is suitable for reg access */
	UINT32		                       	wr_galpha                       ;	// 0x0130 : ''
#else
	WR_GALPHA                       	wr_galpha                       ;	// 0x0130 : ''
#endif
	WR_CTRL                         	wr_ctrl                         ;	// 0x0134 : ''
#if 1	/* raxis.lim -- UINT32 is suitable for reg access */
	UINT32 		                    	wr_coc_ctrl                     ;	// 0x0138 : ''
#else
	WR_COC_CTRL                     	wr_coc_ctrl                     ;	// 0x0138 : ''
#endif
	UINT32                          	                 __rsvd_03[   1];	// 0x013c
#if 1	/* raxis.lim -- UINT32 is suitable for reg access */
	UINT32       			           	wr_csc_coef_00                  ;	// 0x0140 : ''
	UINT32             			     	wr_csc_coef_01                  ;	// 0x0144 : ''
	UINT32             	   			  	wr_csc_coef_02                  ;	// 0x0148 : ''
	UINT32             	     			wr_csc_coef_03                  ;	// 0x014c : ''
	UINT32             	    		 	wr_csc_coef_04                  ;	// 0x0150 : ''
	UINT32                  			wr_csc_coef_05                  ;	// 0x0154 : ''
	UINT32                  			wr_csc_coef_06                  ;	// 0x0158 : ''
	UINT32                  			wr_csc_coef_07                  ;	// 0x015c : ''
#else
...
#endif
	UINT32                          	                 __rsvd_04[   8];	// 0x0160 ~ 0x017c
...
#if 1	/* raxis.lim -- UINT32 is suitable for reg access */
	UINT32				              	scaler_hphase_addr              ;	// 0x01c0 : ''
	UINT32				             	scaler_hphase_data2             ;	// 0x01c4 : ''
	UINT32                          	scaler_hphase_data1             ;	// 0x01c8 : ''
	UINT32                          	scaler_hphase_data0             ;	// 0x01cc : ''
	UINT32				              	scaler_vphase_addr              ;	// 0x01d0 : ''
	UINT32				             	scaler_vphase_data1             ;	// 0x01d4 : ''
	UINT32                          	scaler_vphase_data0             ;	// 0x01d8 : ''
	UINT32                          	                 __rsvd_05[   1];	// 0x01dc
#else
	...
	UINT32                          	                 __rsvd_05[   1];	// 0x01dc
#endif
	BUS_ACCESS_GATING               	bus_access_gating               ;	// 0x01e0 : ''
	BUS_ACCESS_GATING_MON           	bus_access_gating_mon           ;	// 0x01e4 : ''
	UINT32                          	                 __rsvd_06[   2];	// 0x01e8 ~ 0x01ec
	DISABLE_LS                      	disable_ls                      ;	// 0x01f0 : '' raxis.lim -- HW guy said this reg is removed !!
 ...
 * g_gfx_reg_h14 : real register of GFX.
 * g_gfx_reg_h14_cache     : shadow register.
 *
 * @def GFX_RdFL: Read  FLushing : Shadow <- Real.
 * @def GFX_WrFL: Write FLushing : Shadow -> Real.
 * @def GFX_Rd  : Read  whole register(UINT32) from Shadow register.
 * @def GFX_Wr  : Write whole register(UINT32) from Shadow register.
 ...
 * */
#define GFX_RdFL(_r)			((g_gfx_reg_h14_cache->_r)=(g_gfx_reg_h14->_r))
#define GFX_WrFL(_r)			((g_gfx_reg_h14->_r)=(g_gfx_reg_h14_cache->_r))

#define GFX_Rd(_r)				*((UINT32*)(&(g_gfx_reg_h14_cache->_r)))
#define GFX_Wr(_r,_v)			((GFX_Rd(_r))=((UINT32)(_v)))
...
#define GFX_Rd01(_r,_f01,_v01)													\
								do { 											\
									(_v01) = (g_gfx_reg_h14_cache->_r._f01);				\
								} while(0)

#define GFX_Rd02(_r,_f01,_v01,_f02,_v02)										\
								do { 											\
									(_v01) = (g_gfx_reg_h14_cache->_r._f01);				\
									(_v02) = (g_gfx_reg_h14_cache->_r._f02);				\
								} while(0)
...
#define GFX_Rd03(_r,_f01,_v01,_f02,_v02,_f03,_v03)								\
								do { 											\
									(_v01) = (g_gfx_reg_h14_cache->_r._f01);				\
									(_v02) = (g_gfx_reg_h14_cache->_r._f02);				\
									(_v03) = (g_gfx_reg_h14_cache->_r._f03);				\
								} while(0)
...
#define GFX_Rd04(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04)					\
								do { 											\
									...
									(_v02) = (g_gfx_reg_h14_cache->_r._f02);				\
									(_v03) = (g_gfx_reg_h14_cache->_r._f03);				\
									(_v04) = (g_gfx_reg_h14_cache->_r._f04);				\
								} while(0)
...
#define GFX_Rd05(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05)													\
								do { 											\
									...
									(_v03) = (g_gfx_reg_h14_cache->_r._f03);				\
									(_v04) = (g_gfx_reg_h14_cache->_r._f04);				\
									(_v05) = (g_gfx_reg_h14_cache->_r._f05);				\
								} while(0)
...
#define GFX_Rd06(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06)										\
								do { 											\
									...
									(_v04) = (g_gfx_reg_h14_cache->_r._f04);				\
									(_v05) = (g_gfx_reg_h14_cache->_r._f05);				\
									(_v06) = (g_gfx_reg_h14_cache->_r._f06);				\
								} while(0)
...
#define GFX_Rd07(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07)								\
								do { 											\
									...
									(_v05) = (g_gfx_reg_h14_cache->_r._f05);				\
									(_v06) = (g_gfx_reg_h14_cache->_r._f06);				\
									(_v07) = (g_gfx_reg_h14_cache->_r._f07);				\
								} while(0)
...
#define GFX_Rd08(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08)					\
								do { 											\
									...
									(_v06) = (g_gfx_reg_h14_cache->_r._f06);				\
									(_v07) = (g_gfx_reg_h14_cache->_r._f07);				\
									(_v08) = (g_gfx_reg_h14_cache->_r._f08);				\
								} while(0)
...
#define GFX_Rd09(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					...
					_f09,_v09)													\
								do { 											\
									...
									(_v07) = (g_gfx_reg_h14_cache->_r._f07);				\
									(_v08) = (g_gfx_reg_h14_cache->_r._f08);				\
									(_v09) = (g_gfx_reg_h14_cache->_r._f09);				\
								} while(0)
...
#define GFX_Rd10(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					...
					_f09,_v09,_f10,_v10)										\
								do { 											\
									...
									(_v08) = (g_gfx_reg_h14_cache->_r._f08);				\
									(_v09) = (g_gfx_reg_h14_cache->_r._f09);				\
									(_v10) = (g_gfx_reg_h14_cache->_r._f10);				\
								} while(0)
...
#define GFX_Rd11(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					...
					_f09,_v09,_f10,_v10,_f11,_v11)								\
								do { 											\
									...
									(_v09) = (g_gfx_reg_h14_cache->_r._f09);				\
									(_v10) = (g_gfx_reg_h14_cache->_r._f10);				\
									(_v11) = (g_gfx_reg_h14_cache->_r._f11);				\
								} while(0)
...
#define GFX_Rd12(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					...
					_f09,_v09,_f10,_v10,_f11,_v11,_f12,_v12)					\
								do { 											\
									...
									(_v10) = (g_gfx_reg_h14_cache->_r._f10);				\
									(_v11) = (g_gfx_reg_h14_cache->_r._f11);				\
									(_v12) = (g_gfx_reg_h14_cache->_r._f12);				\
								} while(0)
...
#define GFX_Rd13(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					...
					_f13,_v13)													\
								do { 											\
									...
									(_v11) = (g_gfx_reg_h14_cache->_r._f11);				\
									(_v12) = (g_gfx_reg_h14_cache->_r._f12);				\
									(_v13) = (g_gfx_reg_h14_cache->_r._f13);				\
								} while(0)
...
#define GFX_Rd14(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					...
					_f13,_v13,_f14,_v14)										\
								do { 											\
									...
									(_v12) = (g_gfx_reg_h14_cache->_r._f12);				\
									(_v13) = (g_gfx_reg_h14_cache->_r._f13);				\
									(_v14) = (g_gfx_reg_h14_cache->_r._f14);				\
								} while(0)
...
#define GFX_Rd15(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					...
					_f13,_v13,_f14,_v14,_f15,_v15)								\
								do { 											\
									...
									(_v13) = (g_gfx_reg_h14_cache->_r._f13);				\
									(_v14) = (g_gfx_reg_h14_cache->_r._f14);				\
									(_v15) = (g_gfx_reg_h14_cache->_r._f15);				\
								} while(0)
...
#define GFX_Rd16(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					...
					_f13,_v13,_f14,_v14,_f15,_v15,_f16,_v16)					\
								do { 											\
									...
									(_v14) = (g_gfx_reg_h14_cache->_r._f14);				\
									(_v15) = (g_gfx_reg_h14_cache->_r._f15);				\
									(_v16) = (g_gfx_reg_h14_cache->_r._f16);				\
								} while(0)


#define GFX_Wr01(_r,_f01,_v01)													\
								do { 											\
									(g_gfx_reg_h14_cache->_r._f01) = (_v01);				\
								} while(0)

#define GFX_Wr02(_r,_f01,_v01,_f02,_v02)										\
								do { 											\
									(g_gfx_reg_h14_cache->_r._f01) = (_v01);				\
									(g_gfx_reg_h14_cache->_r._f02) = (_v02);				\
								} while(0)
...
#define GFX_Wr03(_r,_f01,_v01,_f02,_v02,_f03,_v03)								\
								do { 											\
									(g_gfx_reg_h14_cache->_r._f01) = (_v01);				\
									(g_gfx_reg_h14_cache->_r._f02) = (_v02);				\
									(g_gfx_reg_h14_cache->_r._f03) = (_v03);				\
								} while(0)
...
#define GFX_Wr04(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04)					\
								do { 											\
									...
									(g_gfx_reg_h14_cache->_r._f02) = (_v02);				\
									(g_gfx_reg_h14_cache->_r._f03) = (_v03);				\
									(g_gfx_reg_h14_cache->_r._f04) = (_v04);				\
								} while(0)
...
#define GFX_Wr05(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05)													\
								do { 											\
									...
									(g_gfx_reg_h14_cache->_r._f03) = (_v03);				\
									(g_gfx_reg_h14_cache->_r._f04) = (_v04);				\
									(g_gfx_reg_h14_cache->_r._f05) = (_v05);				\
								} while(0)
...
#define GFX_Wr06(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06)										\
								do { 											\
									...
									(g_gfx_reg_h14_cache->_r._f04) = (_v04);				\
									(g_gfx_reg_h14_cache->_r._f05) = (_v05);				\
									(g_gfx_reg_h14_cache->_r._f06) = (_v06);				\
								} while(0)
...
#define GFX_Wr07(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07)								\
								do { 											\
									...
									(g_gfx_reg_h14_cache->_r._f05) = (_v05);				\
									(g_gfx_reg_h14_cache->_r._f06) = (_v06);				\
									(g_gfx_reg_h14_cache->_r._f07) = (_v07);				\
								} while(0)
...
#define GFX_Wr08(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08)					\
								do { 											\
									...
									(g_gfx_reg_h14_cache->_r._f06) = (_v06);				\
									(g_gfx_reg_h14_cache->_r._f07) = (_v07);				\
									(g_gfx_reg_h14_cache->_r._f08) = (_v08);				\
								} while(0)
...
#define GFX_Wr09(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					...
					_f09,_v09)													\
								do { 											\
									...
									(g_gfx_reg_h14_cache->_r._f07) = (_v07);				\
									(g_gfx_reg_h14_cache->_r._f08) = (_v08);				\
									(g_gfx_reg_h14_cache->_r._f09) = (_v09);				\
								} while(0)
...
#define GFX_Wr10(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					...
					_f09,_v09,_f10,_v10)										\
								do { 											\
									...
									(g_gfx_reg_h14_cache->_r._f08) = (_v08);				\
									(g_gfx_reg_h14_cache->_r._f09) = (_v09);				\
									(g_gfx_reg_h14_cache->_r._f10) = (_v10);				\
								} while(0)
...
#define GFX_Wr11(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					...
					_f09,_v09,_f10,_v10,_f11,_v11)								\
								do { 											\
									...
									(g_gfx_reg_h14_cache->_r._f09) = (_v09);				\
									(g_gfx_reg_h14_cache->_r._f10) = (_v10);				\
									(g_gfx_reg_h14_cache->_r._f11) = (_v11);				\
								} while(0)
...
#define GFX_Wr12(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					...
					_f09,_v09,_f10,_v10,_f11,_v11,_f12,_v12)					\
								do { 											\
									...
									(g_gfx_reg_h14_cache->_r._f10) = (_v10);				\
									(g_gfx_reg_h14_cache->_r._f11) = (_v11);				\
									(g_gfx_reg_h14_cache->_r._f12) = (_v12);				\
								} while(0)
...
#define GFX_Wr13(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					...
					_f13,_v13)													\
								do { 											\
									...
									(g_gfx_reg_h14_cache->_r._f11) = (_v11);				\
									(g_gfx_reg_h14_cache->_r._f12) = (_v12);				\
									(g_gfx_reg_h14_cache->_r._f13) = (_v13);				\
								} while(0)
...
#define GFX_Wr14(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					...
					_f13,_v13,_f14,_v14)										\
								do { 											\
									...
									(g_gfx_reg_h14_cache->_r._f12) = (_v12);				\
									(g_gfx_reg_h14_cache->_r._f13) = (_v13);				\
									(g_gfx_reg_h14_cache->_r._f14) = (_v14);				\
								} while(0)
...
#define GFX_Wr15(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					...
					_f13,_v13,_f14,_v14,_f15,_v15)								\
								do { 											\
									...
									(g_gfx_reg_h14_cache->_r._f13) = (_v13);				\
									(g_gfx_reg_h14_cache->_r._f14) = (_v14);				\
									(g_gfx_reg_h14_cache->_r._f15) = (_v15);				\
								} while(0)
...
#define GFX_Wr16(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					...
					_f13,_v13,_f14,_v14,_f15,_v15,_f16,_v16)					\
								do { 											\
									...
									(g_gfx_reg_h14_cache->_r._f14) = (_v14);				\
									(g_gfx_reg_h14_cache->_r._f15) = (_v15);				\
									(g_gfx_reg_h14_cache->_r._f16) = (_v16);				\
								} while(0)
 ...
 * _rwname: name of rw    bit field : shall be 0 after GFX_Wind(), 1 for GFX_Rind()
 * _iname : name of index bit field
 * _ival  : index value
 * _fname : field name
 * _fval  : field variable that field value shall be stored.
 *
 * GFX_Rind : General indexed register Read.(
 * GFX_Wind : General indexed register Read.
 *
 * GFX_Ridx : For 'index', 'rw', 'load' field name
 * GFX_Widx : For 'index', 'rw', 'load' field name and NO_LOAD.
 */
#define GFX_Rind(_r, _lname, _rwname, _iname, _ival, _fname, _fval)				\
							do {												\
								GFX_Wr03(_r,_lname,0,_rwname,1,_iname,_ival);	\
								GFX_WrFL(_r);									\
								GFX_RdFL(_r);									\
								GFX_Rd01(_r,_fname,_fval);						\
							} while (0)

#define GFX_Wind(_r, _lname, _rwname, _iname, _ival, _fname, _fval)				\
				GFX_Wr04(_r, _lname,0, _rwname,0, _iname,_ival, _fname,_fval)


#define GFX_Ridx(_r, _ival, _fname, _fval)	GFX_Rind(_r,load,rw,index,_ival,_fname,_fval)

#define GFX_Widx(_r, _ival, _fname, _fval)	GFX_Wind(_r,load,rw,index,_ival,_fname,_fval)
...
#endif	/* _GFX_REG_H14_H_ */

/* from 'gfx.csv'  대한민국 표준시 by getregs v2.8 */
