...
#ifndef	_PE_WIN_HW_H14_H_
#define	_PE_WIN_HW_H14_H_
...
typedef struct
{
	PE_WIN_HW_H14_CTRL_T win_inf;			///< window info
	PE_WIN_HW_H14_LRCR_CTRL_T lrcr_inf;		///< lrcr win info
	PE_WIN_HW_H14_TNR_CTRL_T tnr_inf;		///< tnr measure win info
}
PE_WIN_HW_H14_SETTINGS_T;
