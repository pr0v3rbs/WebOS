...
#ifndef	_PE_FWI_H14_H_
#define	_PE_FWI_H14_H_
...
----------------------------------------------------------------------------------------*/
#define PE_FWI_H14_BASE_OFFSET				0
#define PE_FWI_H14_TNR_CTRL_OFFSET			PE_FWI_H14_BASE_OFFSET
#define PE_FWI_H14_FW_CTRL_OFFSET			(PE_FWI_H14_TNR_CTRL_OFFSET+sizeof(PE_FWI_H14_TNR_CTRL))
#define PE_FWI_H14_HOR_CTRL_OFFSET			(PE_FWI_H14_FW_CTRL_OFFSET+sizeof(PE_FWI_H14_FW_CTRL))
#define PE_FWI_H14_MISC_CTRL_OFFSET			(PE_FWI_H14_HOR_CTRL_OFFSET+sizeof(PE_FWI_H14_HOR_CTRL))
#define PE_FWI_H14_EDGE_GAIN_OFFSET			(PE_FWI_H14_MISC_CTRL_OFFSET+sizeof(PE_FWI_H14_MISC_CTRL))
#define PE_FWI_H14_TEXTURE_GAIN_OFFSET		(PE_FWI_H14_EDGE_GAIN_OFFSET+sizeof(PE_FWI_H14_EDGE_GAIN))
#define PE_FWI_H14_SRC_INFO_OFFSET			(PE_FWI_H14_TEXTURE_GAIN_OFFSET+sizeof(PE_FWI_H14_TEXTURE_GAIN))
#define PE_FWI_H14_CEN_CTRL_OFFSET			(PE_FWI_H14_SRC_INFO_OFFSET+sizeof(PE_FWI_H14_SRC_INFO))

#define PE_FWI_H14_CEN_RGN_NUM		16
...
*/
#define PE_FWI_H14_USE_SHP_CTRL_WHEN_PQFW_OFF

/**	20130219, sj.youm,
*	define for cen region ctrl because of noise issue on gain ctrl
*/
#define PE_FWI_H14_USE_CEN_RGN_CTRL

/**	20130220, sj.youm,
*	Define for cen region ctrl on be(frc) fw, because of noise issue on gain ctrl,
*	should be turned on only when PE_FWI_H14_USE_CEN_RGN_CTRL defined
*/
#ifdef PE_FWI_H14_USE_CEN_RGN_CTRL
#define PE_FWI_H14_USE_CEN_RGN_CTRL_BY_BE_FW
#else
#undef PE_FWI_H14_USE_CEN_RGN_CTRL_BY_BE_FW
#endif
 ...
 */
typedef struct {
	PE_FWI_H14_TNR_CTRL			tnr_ctrl;		///< tnr ctrl
	PE_FWI_H14_FW_CTRL			fw_ctrl;		///< fwi ctrl
	PE_FWI_H14_HOR_CTRL			shp_h_ctrl;		///< hor ctrl
	PE_FWI_H14_MISC_CTRL		shp_m_ctrl;		///< misc ctrl
	PE_FWI_H14_EDGE_GAIN		shp_e_ctrl;		///< edge ctrl
	PE_FWI_H14_TEXTURE_GAIN		shp_t_ctrl;		///< texture ctrl
	PE_FWI_H14_SRC_INFO			src_info;		///< src info
	#ifdef PE_FWI_H14_USE_CEN_RGN_CTRL
	PE_FWI_H14_CEN_CTRL			cen_ctrl;		///< cen ctrl
	#endif
}
PE_FWI_H14_PQ_IPC_CTRL;
...
typedef struct
{
	PE_FWI_H14_TNR_CTRL		tnr_ctrl[LX_PE_WIN_NUM];		///< tnr ctrl
	PE_FWI_H14_FW_CTRL		fw_ctrl;						///< fwi ctrl
	PE_FWI_H14_HOR_CTRL		shp_h_ctrl;						///< hor ctrl
	PE_FWI_H14_MISC_CTRL	shp_m_ctrl;						///< misc ctrl
	PE_FWI_H14_EDGE_GAIN	shp_e_ctrl;						///< edge ctrl
	PE_FWI_H14_TEXTURE_GAIN	shp_t_ctrl;						///< texture ctrl
	PE_FWI_H14_SRC_INFO		src_info;						///< src info
	PE_FWI_H14_CEN_CTRL		cen_ctrl[LX_PE_CMG_REGION_NUM];	///< cen ctrl
}
PE_FWI_H14_SETTINGS_T;
