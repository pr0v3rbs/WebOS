...
#ifndef	_PE_TSK_H14_H_
#define	_PE_TSK_H14_H_
...
PE_TSK_H14_LRC_HST_CTRL_T;

/**
 *	pe task h14 cfg type
 */
typedef struct {
	PE_INF_H14_SETTINGS_T inf;
	PE_TSK_H14_OPR_T opr;
	PE_TSK_H14_LRC_HST_CTRL_T lrc;
}
PE_TSK_H14_CFG_T;
