...
/*----------------------------------------------------------------------------------------
	Static Variables
----------------------------------------------------------------------------------------*/
static BE_FRC_HW_H14_INFO_T _beFrcHwH14Info= {0,};

/*========================================================================================
	Implementation Group
========================================================================================*/
int BE_FRC_HW_H14_Initialize(void)
{
	int ret = RET_OK;
...
int BE_FRC_HW_H14_ControlMemc(LX_BE_FRC_MEMC_MODE_T *pstParams)
{
	int ret = RET_OK;
	...
	do {
		...
		{
			stHwParams.u8Blur			=	_beFrcHwH14Info.u8Blur;
			stHwParams.u8Judder		=	_beFrcHwH14Info.u8Judder;
			stHwParams.u8MemcType	=	_beFrcHwH14Info.u8MemcType;
		}
		else
		{
			if (stHwParams.u8Blur != 0xFF)
			_beFrcHwH14Info.u8Blur 	= stHwParams.u8Blur;

			if (stHwParams.u8Judder != 0xFF)
			_beFrcHwH14Info.u8Judder 	= stHwParams.u8Judder;

			if (stHwParams.u8MemcType != 0xFF)
			_beFrcHwH14Info.u8MemcType  = stHwParams.u8MemcType;
		}
...
int BE_FRC_HW_H14_Set_Demo_Mode(LX_BE_FRC_DEMO_MODE_T *pstParams)
{
	int ret = RET_OK;
...
int BE_FRC_HW_H14_Set_Debug_Box(LX_BE_FRC_ENABLE_DEBUG_BOX_T *pstParams)
{
	int ret = RET_OK;
...
int BE_FRC_HW_H14_Set_Bypass_Memc_Reg(LX_BE_FRC_MEMC_BYPASS_REGION_T *pstParams)
{
	int ret = RET_OK;
...
int BE_FRC_HW_H14_Set_YUV_444_Mode(LX_BE_FRC_COLOR_YUV444_T *pstParams)
{
	int ret = RET_OK;
...
int BE_FRC_HW_H14_Set_Low_Delay(LX_BE_FRC_LOW_DELAY_T *pstParams)
{
	int ret = RET_OK;
...
int BE_FRC_HW_H14_Get_Firmware_Ver(LX_BE_FRC_VERSION_T *pstParams)
{
	int ret = RET_OK;
...
int BE_FRC_HW_H14_Force_Frame_Rate(LX_BE_FRC_FRAME_RATE_T *pstParams)
{
	int ret = RET_OK;
