...
#else
	*pIPCBuffToMCU = (UINT32)ioremap(BE_IPC_FROM_CPU_H14A0_BASE, IPC_FROM_CPU_SIZE);
	*pIPCBuffFrMCU = (UINT32)ioremap(BE_IPC_FROM_MCU_H14A0_BASE, IPC_FROM_MCU_SIZE);
#endif
	return RET_OK;
}
