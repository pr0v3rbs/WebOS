...
#include "be_def.h"
#include "be_pwm_hw_h14.h"

#include "../reg/be_reg_frc_h14.h"
...
/*----------------------------------------------------------------------------------------
	External Variables
----------------------------------------------------------------------------------------*/
extern FRC_DVO_REG_H14_T gFRC_DVO_H14;
...
int BE_PWM_HW_H14_SetPwmAdaptFreqControl(BE_PWM_ADAPT_FREQ_CTRL_T *pstParams)
{
	...
	do {	
		...
		if (freqSet)
		{
			...
			ret = BE_PWM_HW_H14_SetPwmSync(&stParams);
...
int BE_PWM_HW_H14_SetPwmFrequency(BE_PWM_FREQ_T *pstParams)
{
	...
	do {
		...
		ret = BE_PWM_HW_H14_SetPwmDutyCycle(&stParams);
			...
			&& (u32PrevFrequency != pstParams->frequency)) 
		{
			...
			{
				case BE_PWM0 :
					FRC_DVO_H14_RdFL(dvo_pwm0_ctrl0);
					FRC_DVO_H14_Wr01(dvo_pwm0_ctrl0, pwm0_en, 0);
					FRC_DVO_H14_WrFL(dvo_pwm0_ctrl0);

					FRC_DVO_H14_RdFL(dvo_pwm0_ctrl0);
					FRC_DVO_H14_Wr01(dvo_pwm0_ctrl0, pwm0_en, gPwmInfo[nPort].ctrl.pwm_en);
					FRC_DVO_H14_WrFL(dvo_pwm0_ctrl0);
					break;

				case BE_PWM1 :
					FRC_DVO_H14_RdFL(dvo_pwm1_ctrl0);
					FRC_DVO_H14_Wr01(dvo_pwm1_ctrl0, pwm1_en, 0);
					FRC_DVO_H14_WrFL(dvo_pwm1_ctrl0);

					FRC_DVO_H14_RdFL(dvo_pwm1_ctrl0);
					FRC_DVO_H14_Wr01(dvo_pwm1_ctrl0, pwm1_en, gPwmInfo[nPort].ctrl.pwm_en);
					FRC_DVO_H14_WrFL(dvo_pwm1_ctrl0);
					break;

				case BE_PWM2 :
					FRC_DVO_H14_RdFL(dvo_pwm2_ctrl0);
					FRC_DVO_H14_Wr01(dvo_pwm2_ctrl0, pwm2_en, 0);
					FRC_DVO_H14_WrFL(dvo_pwm2_ctrl0);

					FRC_DVO_H14_RdFL(dvo_pwm2_ctrl0);
					FRC_DVO_H14_Wr01(dvo_pwm2_ctrl0, pwm2_en, gPwmInfo[nPort].ctrl.pwm_en);
					FRC_DVO_H14_WrFL(dvo_pwm2_ctrl0);
					break;
...
int BE_PWM_HW_H14_SetPwmSync(BE_PWM_FREQ_T *pstParams)
{
	...
	do {
			...
			i<(port < BE_PWM_MAX ? port+1 : BE_PWM_MAX); i++)
		{
			...
			ret = BE_PWM_HW_H14_SetPwmFrequency(&stParams);
			if(ret) break;
		}
		if(ret) BREAK_WRONG(ret);
	} while(0);
...
static int _REG_SetPwmCtrl(UINT32 pwmId, BOOLEAN zeroDuty)
{
	...
	switch (pwmId) {
		case 0 :
			FRC_DVO_H14_RdFL(dvo_pwm0_ctrl0);
			FRC_DVO_H14_RdFL(dvo_pwm0_ctrl1);
			FRC_DVO_H14_RdFL(dvo_pwm0_ctrl2);
			FRC_DVO_H14_Wr01(dvo_pwm0_ctrl0, pwm0_en, gPwmInfo[pwmId].ctrl.pwm_en);
			FRC_DVO_H14_Wr01(dvo_pwm0_ctrl0, pwm0_freq_mode, gPwmInfo[pwmId].ctrl.pwm_freq_mode);
			FRC_DVO_H14_Wr01(dvo_pwm0_ctrl0, pwm0_resolution, gPwmInfo[pwmId].ctrl.pwm_resolution);
			FRC_DVO_H14_Wr01(dvo_pwm0_ctrl0, pwm0_inv, gPwmInfo[pwmId].ctrl.pwm_inv);
			FRC_DVO_H14_Wr01(dvo_pwm0_ctrl0, pwm0_sel, gPwmInfo[pwmId].ctrl.pwm_sel);
			FRC_DVO_H14_Wr01(dvo_pwm0_ctrl0, pwm0_width_falling_pos, gPwmInfo[pwmId].ctrl.pwm_width_falling_pos);
			FRC_DVO_H14_Wr01(dvo_pwm0_ctrl1, pwm0_free_width, gPwmInfo[pwmId].ctrl.pwm_free_width);
			FRC_DVO_H14_Wr01(dvo_pwm0_ctrl2, pwm0_method, gPwmInfo[pwmId].ctrl.pwm_method);
			FRC_DVO_H14_Wr01(dvo_pwm0_ctrl2, pwm0_fc_h_disp, gPwmInfo[pwmId].ctrl.pwm_fc_h_disp);
			if(zeroDuty && (!gPwmInfo[pwmId].ctrl.pwm_fc_h_disp))
			{
				FRC_DVO_H14_Wr01(dvo_pwm0_ctrl2, pwm0_fc_l_disp, 1);
			}
			else
			{
				FRC_DVO_H14_Wr01(dvo_pwm0_ctrl2, pwm0_fc_l_disp, gPwmInfo[pwmId].ctrl.pwm_fc_l_disp);
			}
			FRC_DVO_H14_WrFL(dvo_pwm0_ctrl0);
			FRC_DVO_H14_WrFL(dvo_pwm0_ctrl1);
			FRC_DVO_H14_WrFL(dvo_pwm0_ctrl2);
			break;
		case 1 :
			FRC_DVO_H14_RdFL(dvo_pwm1_ctrl0);
			FRC_DVO_H14_RdFL(dvo_pwm1_ctrl1);
			FRC_DVO_H14_RdFL(dvo_pwm1_ctrl2);
			FRC_DVO_H14_Wr01(dvo_pwm1_ctrl0, pwm1_en, gPwmInfo[pwmId].ctrl.pwm_en);
			FRC_DVO_H14_Wr01(dvo_pwm1_ctrl0, pwm1_freq_mode, gPwmInfo[pwmId].ctrl.pwm_freq_mode);
			FRC_DVO_H14_Wr01(dvo_pwm1_ctrl0, pwm1_resolution, gPwmInfo[pwmId].ctrl.pwm_resolution);
			FRC_DVO_H14_Wr01(dvo_pwm1_ctrl0, pwm1_inv, gPwmInfo[pwmId].ctrl.pwm_inv);
			FRC_DVO_H14_Wr01(dvo_pwm1_ctrl0, pwm1_sel, gPwmInfo[pwmId].ctrl.pwm_sel);
			FRC_DVO_H14_Wr01(dvo_pwm1_ctrl0, pwm1_width_falling_pos, gPwmInfo[pwmId].ctrl.pwm_width_falling_pos);
			FRC_DVO_H14_Wr01(dvo_pwm1_ctrl1, pwm1_free_width, gPwmInfo[pwmId].ctrl.pwm_free_width);		
			FRC_DVO_H14_Wr01(dvo_pwm1_ctrl2, pwm1_method, gPwmInfo[pwmId].ctrl.pwm_method);		
			FRC_DVO_H14_Wr01(dvo_pwm1_ctrl2, pwm1_fc_h_disp, gPwmInfo[pwmId].ctrl.pwm_fc_h_disp);
			if(zeroDuty && (!gPwmInfo[pwmId].ctrl.pwm_fc_h_disp))
			{
				FRC_DVO_H14_Wr01(dvo_pwm1_ctrl2, pwm1_fc_l_disp, 1);
			}
			else
			{
				FRC_DVO_H14_Wr01(dvo_pwm1_ctrl2, pwm1_fc_l_disp, gPwmInfo[pwmId].ctrl.pwm_fc_l_disp);
			}
			FRC_DVO_H14_WrFL(dvo_pwm1_ctrl0);
			FRC_DVO_H14_WrFL(dvo_pwm1_ctrl1);
			FRC_DVO_H14_WrFL(dvo_pwm1_ctrl2);
			break;
		case 2 :
			FRC_DVO_H14_RdFL(dvo_pwm2_ctrl0);
			FRC_DVO_H14_RdFL(dvo_pwm2_ctrl1);
			FRC_DVO_H14_RdFL(dvo_pwm2_ctrl2);
			FRC_DVO_H14_Wr01(dvo_pwm2_ctrl0, pwm2_en, gPwmInfo[pwmId].ctrl.pwm_en);
			FRC_DVO_H14_Wr01(dvo_pwm2_ctrl0, pwm2_freq_mode, gPwmInfo[pwmId].ctrl.pwm_freq_mode);
			FRC_DVO_H14_Wr01(dvo_pwm2_ctrl0, pwm2_resolution, gPwmInfo[pwmId].ctrl.pwm_resolution);
			FRC_DVO_H14_Wr01(dvo_pwm2_ctrl0, pwm2_inv, gPwmInfo[pwmId].ctrl.pwm_inv);
			FRC_DVO_H14_Wr01(dvo_pwm2_ctrl0, pwm2_sel, gPwmInfo[pwmId].ctrl.pwm_sel);
			FRC_DVO_H14_Wr01(dvo_pwm2_ctrl0, pwm2_width_falling_pos, gPwmInfo[pwmId].ctrl.pwm_width_falling_pos);
			FRC_DVO_H14_Wr01(dvo_pwm2_ctrl1, pwm2_free_width, gPwmInfo[pwmId].ctrl.pwm_free_width);
			FRC_DVO_H14_Wr01(dvo_pwm2_ctrl2, pwm2_method, gPwmInfo[pwmId].ctrl.pwm_method);
			FRC_DVO_H14_Wr01(dvo_pwm2_ctrl2, pwm2_fc_h_disp, gPwmInfo[pwmId].ctrl.pwm_fc_h_disp);
			if(zeroDuty && (!gPwmInfo[pwmId].ctrl.pwm_fc_h_disp))
			{
				FRC_DVO_H14_Wr01(dvo_pwm2_ctrl2, pwm2_fc_l_disp, 1);
			}
			else
			{
				FRC_DVO_H14_Wr01(dvo_pwm2_ctrl2, pwm2_fc_l_disp, gPwmInfo[pwmId].ctrl.pwm_fc_l_disp);
			}
			FRC_DVO_H14_WrFL(dvo_pwm2_ctrl0);
			FRC_DVO_H14_WrFL(dvo_pwm2_ctrl1);
			FRC_DVO_H14_WrFL(dvo_pwm2_ctrl2);
			break;
		case 3 :
			FRC_DVO_H14_RdFL(dvo_pwm3_ctrl0);
			FRC_DVO_H14_Wr01(dvo_pwm3_ctrl0, pwm3_en, gPwmInfo[pwmId].ctrl.pwm_en);
			FRC_DVO_H14_Wr01(dvo_pwm3_ctrl0, pwm3_freq_mode, gPwmInfo[pwmId].ctrl.pwm_freq_mode);
			FRC_DVO_H14_WrFL(dvo_pwm3_ctrl0);
			break;
		default :
			break;
	}
...
static int _REG_SetPwmTiming(UINT32 pwmId)
{
	...
	switch (pwmId) {
		case 0 :
			FRC_DVO_H14_RdFL(dvo_pwm_v_load_write);
			FRC_DVO_H14_RdFL(dvo_pwm0_v_r);
			FRC_DVO_H14_RdFL(dvo_pwm0_v_f);
			FRC_DVO_H14_RdFL(dvo_pwm0_v_sub);
			FRC_DVO_H14_Wr01(dvo_pwm_v_load_write, pwm0_v_we, gPwmInfo[pwmId].t1st.pwm_v_we);
			FRC_DVO_H14_Wr01(dvo_pwm0_v_r, pwm0_v_r, gPwmInfo[pwmId].t1st.pwm_v_r);
			FRC_DVO_H14_Wr01(dvo_pwm0_v_r, pwm0_v_r_id, gPwmInfo[pwmId].t1st.pwm_v_id);
			FRC_DVO_H14_Wr01(dvo_pwm0_v_f, pwm0_v_f, gPwmInfo[pwmId].t1st.pwm_v_f);
			FRC_DVO_H14_Wr01(dvo_pwm0_v_f, pwm0_v_f_id, gPwmInfo[pwmId].t1st.pwm_v_id);
			FRC_DVO_H14_Wr01(dvo_pwm_v_load_write, pwm0_v_sub_we, gPwmInfo[pwmId].t2nd.pwm_v_we);
			FRC_DVO_H14_Wr01(dvo_pwm0_v_sub, pwm0_v_sub, gPwmInfo[pwmId].t2nd.pwm_v_r);
			FRC_DVO_H14_Wr01(dvo_pwm0_v_sub, pwm0_v_sub_id, gPwmInfo[pwmId].t2nd.pwm_v_id);
			FRC_DVO_H14_WrFL(dvo_pwm_v_load_write);
			FRC_DVO_H14_WrFL(dvo_pwm0_v_r);
			FRC_DVO_H14_WrFL(dvo_pwm0_v_f);
			FRC_DVO_H14_WrFL(dvo_pwm0_v_sub);
			break;
		case 1 :
			FRC_DVO_H14_RdFL(dvo_pwm_v_load_write);
			FRC_DVO_H14_RdFL(dvo_pwm1_v_r);
			FRC_DVO_H14_RdFL(dvo_pwm1_v_f);
			FRC_DVO_H14_RdFL(dvo_pwm1_v_sub);
			FRC_DVO_H14_Wr01(dvo_pwm_v_load_write, pwm1_v_we, gPwmInfo[pwmId].t1st.pwm_v_we);
			FRC_DVO_H14_Wr01(dvo_pwm1_v_r, pwm1_v_r, gPwmInfo[pwmId].t1st.pwm_v_r);
			FRC_DVO_H14_Wr01(dvo_pwm1_v_r, pwm1_v_r_id, gPwmInfo[pwmId].t1st.pwm_v_id);
			FRC_DVO_H14_Wr01(dvo_pwm1_v_f, pwm1_v_f, gPwmInfo[pwmId].t1st.pwm_v_f);
			FRC_DVO_H14_Wr01(dvo_pwm1_v_f, pwm1_v_f_id, gPwmInfo[pwmId].t1st.pwm_v_id);
			FRC_DVO_H14_Wr01(dvo_pwm_v_load_write, pwm1_v_sub_we, gPwmInfo[pwmId].t2nd.pwm_v_we);
			FRC_DVO_H14_Wr01(dvo_pwm1_v_sub, pwm1_v_sub, gPwmInfo[pwmId].t2nd.pwm_v_r);
			FRC_DVO_H14_Wr01(dvo_pwm1_v_sub, pwm1_v_sub_id, gPwmInfo[pwmId].t2nd.pwm_v_id);
			FRC_DVO_H14_WrFL(dvo_pwm_v_load_write);
			FRC_DVO_H14_WrFL(dvo_pwm1_v_r);
			FRC_DVO_H14_WrFL(dvo_pwm1_v_f);
			FRC_DVO_H14_WrFL(dvo_pwm1_v_sub);
			break;
		case 2 :
			FRC_DVO_H14_RdFL(dvo_pwm_v_load_write);
			FRC_DVO_H14_RdFL(dvo_pwm2_v_r);
			FRC_DVO_H14_RdFL(dvo_pwm2_v_f);
			FRC_DVO_H14_RdFL(dvo_pwm2_v_sub);
			FRC_DVO_H14_Wr01(dvo_pwm_v_load_write, pwm2_v_we, gPwmInfo[pwmId].t1st.pwm_v_we);
			FRC_DVO_H14_Wr01(dvo_pwm2_v_r, pwm2_v_r, gPwmInfo[pwmId].t1st.pwm_v_r);
			FRC_DVO_H14_Wr01(dvo_pwm2_v_r, pwm2_v_r_id, gPwmInfo[pwmId].t1st.pwm_v_id);
			FRC_DVO_H14_Wr01(dvo_pwm2_v_f, pwm2_v_f, gPwmInfo[pwmId].t1st.pwm_v_f);
			FRC_DVO_H14_Wr01(dvo_pwm2_v_f, pwm2_v_f_id, gPwmInfo[pwmId].t1st.pwm_v_id);
			FRC_DVO_H14_Wr01(dvo_pwm_v_load_write, pwm2_v_sub_we, gPwmInfo[pwmId].t2nd.pwm_v_we);
			FRC_DVO_H14_Wr01(dvo_pwm2_v_sub, pwm2_v_sub, gPwmInfo[pwmId].t2nd.pwm_v_r);
			FRC_DVO_H14_Wr01(dvo_pwm2_v_sub, pwm2_v_sub_id, gPwmInfo[pwmId].t2nd.pwm_v_id);
			FRC_DVO_H14_WrFL(dvo_pwm_v_load_write);
			FRC_DVO_H14_WrFL(dvo_pwm2_v_r);
			FRC_DVO_H14_WrFL(dvo_pwm2_v_f);
			FRC_DVO_H14_WrFL(dvo_pwm2_v_sub);
			break;
		default :
			break;
	}
...
static int _REG_GetPwmTiming(UINT32 freq_mode, UINT32 *pRising, UINT32 *pFall)
{
	...
	do {
		...
		{
			case 0 :
				FRC_DVO_H14_RdFL(dvo_pwm3_0_low);
				FRC_DVO_H14_RdFL(dvo_pwm3_0_high);
				FRC_DVO_H14_Rd01(dvo_pwm3_0_low, pwm3_0_low, *pRising);
				FRC_DVO_H14_Rd01(dvo_pwm3_0_high, pwm3_0_high, *pFall);
				break;
			case 1 :
				FRC_DVO_H14_RdFL(dvo_pwm3_1_low);
				FRC_DVO_H14_RdFL(dvo_pwm3_1_high);
				FRC_DVO_H14_Rd01(dvo_pwm3_1_low, pwm3_1_low, *pRising);
				FRC_DVO_H14_Rd01(dvo_pwm3_1_high, pwm3_1_high, *pFall);
				break;
			case 2 :
				FRC_DVO_H14_RdFL(dvo_pwm3_2_low);
				FRC_DVO_H14_RdFL(dvo_pwm3_2_high);
				FRC_DVO_H14_Rd01(dvo_pwm3_2_low, pwm3_2_low, *pRising);
				FRC_DVO_H14_Rd01(dvo_pwm3_2_high, pwm3_2_high, *pFall);
				break;
			case 3 :
				FRC_DVO_H14_RdFL(dvo_pwm3_3_low);
				FRC_DVO_H14_RdFL(dvo_pwm3_3_high);
				FRC_DVO_H14_Rd01(dvo_pwm3_3_low, pwm3_3_low, *pRising);
				FRC_DVO_H14_Rd01(dvo_pwm3_3_high, pwm3_3_high, *pFall);
				break;
			default :
