...
#ifndef _DE_CVD_REG_H14Ax_H_
#define _DE_CVD_REG_H14Ax_H_
/*-----------------------------------------------------------------------------
		0x4100 cvd_intr1_enable0 ''
-----------------------------------------------------------------------------*/
typedef struct {
	UINT32 cvd_intr1_enable0                  : 32;  // 31: 0     
} H14Ax_CVD_INTR1_ENABLE0_T;
...
typedef struct {
	...
	UINT32 reg_fb_off			              : 1 ;  //    28     	H14A0 Added
} H14Ax_IRIS_064_T;
...
typedef struct {
	...
	UINT32									  : 3 ;	//	25:27	reserved
	UINT32 reg_fb_off_md		              : 1 ;  //    28     	H14A0 Added
} H14Ax_IRIS_066_T;
...
typedef struct {
	...
	UINT32 reg_hw_rst_blk	                  : 8 ;  // 15: 8     H14A0 Added
} H14Ax_IRIS_175_T;
...
typedef struct {
	...
	UINT32									  : 3 ;	//	25:27	reserved
	UINT32 reg_cs_hw_rst		              : 1 ;  //    28     	H14A0 Added
} H14Ax_IRIS_180_T;
...
typedef struct {
	...
	UINT32									  : 3 ;	//	25:27	reserved
	UINT32 reg_cs1_hw_rst		              : 1 ;  //    28     	H14A0 Added
} H14Ax_IRIS_191_T;
...
-----------------------------------------------------------------------------*/
typedef struct {
	UINT32 reg_cti_ctrl2                : 32;  // 31: 0     H14A0 added
} H14Ax_IRIS_371_T;
...
-----------------------------------------------------------------------------*/
typedef struct {
	UINT32 reg_cdct_ifcomp_ctrl_1                : 32;  // 31: 0     H14A0 added
} H14Ax_IRIS_372_T;
...
} H14Ax_IRIS_HIF_CTRL1_001_T;
typedef struct {
	H14Ax_CVD_INTR1_ENABLE0_T          	cvd_intr1_enable0;            //0x4100
	H14Ax_CVD_INTR1_INTR0_T            	cvd_intr1_intr0;              //0x4104
	H14Ax_CVD_INTR1_CLEAR0_T           	cvd_intr1_clear0;             //0x4108
	H14Ax_CVD_INTR1_ENABLE1_T          	cvd_intr1_enable1;            //0x410c
	H14Ax_CVD_INTR1_INTR1_T            	cvd_intr1_intr1;              //0x4110
	H14Ax_CVD_INTR1_CLEAR1_T           	cvd_intr1_clear1;             //0x4114
	H14Ax_CVD_INTR2_ENABLE0_T          	cvd_intr2_enable0;            //0x4118
	H14Ax_CVD_INTR2_INTR0_T            	cvd_intr2_intr0;              //0x411c
	H14Ax_CVD_INTR2_CLEAR0_T           	cvd_intr2_clear0;             //0x4120
	H14Ax_CVD_INTR2_ENABLE1_T          	cvd_intr2_enable1;            //0x4124
	H14Ax_CVD_INTR2_INTR1_T            	cvd_intr2_intr1;              //0x4128
	H14Ax_CVD_INTR2_CLEAR1_T           	cvd_intr2_clear1;             //0x412c
	H14Ax_TOP_001_T                    	top_001;                      //0x4130
	UINT32                             	reserved00[3];                //0x4134~0x413c
	H14Ax_IRIS_MIF_GMUA_001_T          	iris_mif_gmua_001;            //0x4140
	H14Ax_IRIS_MIF_GMUA_002_T          	iris_mif_gmua_002;            //0x4144
	H14Ax_IRIS_MIF_GMUA_003_T          	iris_mif_gmua_003;            //0x4148
	H14Ax_IRIS_MIF_GMUA_004_T          	iris_mif_gmua_004;            //0x414c
	H14Ax_IRIS_MIF_GMUA_005_T          	iris_mif_gmua_005;            //0x4150
	H14Ax_IRIS_MIF_GMUA_006_T          	iris_mif_gmua_006;            //0x4154
	H14Ax_IRIS_MIF_GMUA_007_T          	iris_mif_gmua_007;            //0x4158
	H14Ax_IRIS_MIF_GMUA_008_T          	iris_mif_gmua_008;            //0x415c
	H14Ax_IRIS_MIF_GMUA_009_T          	iris_mif_gmua_009;            //0x4160
	H14Ax_IRIS_MIF_GMUA_010_T          	iris_mif_gmua_010;            //0x4164
	H14Ax_FASTBLANK_001_T              	fastblank_001;                //0x4168
	H14Ax_FASTBLANK_002_T              	fastblank_002;                //0x416c
	H14Ax_FASTBLANK_003_T              	fastblank_003;                //0x4170
	H14Ax_FASTBLANK_004_T              	fastblank_004;                //0x4174
	H14Ax_FASTBLANK_005_T              	fastblank_005;                //0x4178
	H14Ax_FASTBLANK_006_T              	fastblank_006;                //0x417c
	H14Ax_FASTBLANK_007_T              	fastblank_007;                //0x4180
	H14Ax_FASTBLANK_008_T              	fastblank_008;                //0x4184
	H14Ax_FASTBLANK_009_T              	fastblank_009;                //0x4188
	H14Ax_FASTBLANK_010_T              	fastblank_010;                //0x418c
	H14Ax_IRIS_DE_CTRL_001_T           	iris_de_ctrl_001;             //0x4190
	H14Ax_VBI_CTRL_001_T               	vbi_ctrl_001;                 //0x4194
	H14Ax_VBI_CTRL_002_T               	vbi_ctrl_002;                 //0x4198
	H14Ax_VBI_CTRL_003_T               	vbi_ctrl_003;                 //0x419c
	H14Ax_VBI_CTRL_004_T               	vbi_ctrl_004;                 //0x41a0
	H14Ax_VBI_CTRL_005_T               	vbi_ctrl_005;                 //0x41a4
	H14Ax_VBI_CTRL_006_T               	vbi_ctrl_006;                 //0x41a8
	H14Ax_VBI_CTRL_007_T               	vbi_ctrl_007;                 //0x41ac
	H14Ax_VBI_CTRL_008_T               	vbi_ctrl_008;                 //0x41b0
	H14Ax_VBI_CTRL_009_T               	vbi_ctrl_009;                 //0x41b4
	H14Ax_VBI_CTRL_010_T               	vbi_ctrl_010;                 //0x41b8
	UINT32                             	reserved01;                   //0x41bc
	H14Ax_FAST_BLANK_STATUS_001_T      	fast_blank_status_001;        //0x41c0
	H14Ax_CVBSAFE_001_T                	cvbsafe_001;                  //0x41c4
	H14Ax_IRIS_MIF_GMUA_MD_001_T       	iris_mif_gmua_md_001;         //0x41c8
	H14Ax_IRIS_MIF_GMUA_MD_002_T       	iris_mif_gmua_md_002;         //0x41cc
	H14Ax_IRIS_MIF_GMUA_MD_003_T       	iris_mif_gmua_md_003;         //0x41d0
	H14Ax_IRIS_MIF_GMUA_MD_004_T       	iris_mif_gmua_md_004;         //0x41d4
	H14Ax_IRIS_MIF_GMUA_MD_005_T       	iris_mif_gmua_md_005;         //0x41d8
	H14Ax_IRIS_MIF_GMUA_MD_006_T       	iris_mif_gmua_md_006;         //0x41dc
	H14Ax_IRIS_MIF_GMUA_MD_007_T       	iris_mif_gmua_md_007;         //0x41e0
	H14Ax_IRIS_MIF_GMUA_MD_008_T       	iris_mif_gmua_md_008;         //0x41e4
	H14Ax_IRIS_MIF_GMUA_MD_009_T       	iris_mif_gmua_md_009;         //0x41e8
	H14Ax_IRIS_MIF_GMUA_MD_010_T       	iris_mif_gmua_md_010;         //0x41ec
	H14Ax_IRIS_MIF_GMUA_MD_011_T       	iris_mif_gmua_md_011;         //0x41f0
	UINT32                             	reserved02[3];                //0x41f4~0x41fc
	H14Ax_IRIS_001_T                   	iris_001;                     //0x4200
	H14Ax_IRIS_002_T                   	iris_002;                     //0x4204
	H14Ax_IRIS_003_T                   	iris_003;                     //0x4208
	H14Ax_IRIS_004_T                   	iris_004;                     //0x420c
	H14Ax_IRIS_005_T                   	iris_005;                     //0x4210
	H14Ax_IRIS_006_T                   	iris_006;                     //0x4214
	H14Ax_IRIS_007_T                   	iris_007;                     //0x4218
	H14Ax_IRIS_008_T                   	iris_008;                     //0x421c
	H14Ax_IRIS_009_T                   	iris_009;                     //0x4220
	H14Ax_IRIS_010_T                   	iris_010;                     //0x4224
	H14Ax_IRIS_011_T                   	iris_011;                     //0x4228
	UINT32                             	reserved03;                   //0x422c
	H14Ax_IRIS_012_T                   	iris_012;                     //0x4230
	H14Ax_IRIS_013_T                   	iris_013;                     //0x4234
	H14Ax_IRIS_014_T                   	iris_014;                     //0x4238
	H14Ax_IRIS_015_T                   	iris_015;                     //0x423c
	H14Ax_IRIS_016_T                   	iris_016;                     //0x4240
	H14Ax_IRIS_017_T                   	iris_017;                     //0x4244
	H14Ax_IRIS_018_T                   	iris_018;                     //0x4248
	H14Ax_IRIS_019_T                   	iris_019;                     //0x424c
	H14Ax_IRIS_020_T                   	iris_020;                     //0x4250
	H14Ax_IRIS_021_T                   	iris_021;                     //0x4254
	H14Ax_IRIS_022_T                   	iris_022;                     //0x4258
	H14Ax_IRIS_023_T                   	iris_023;                     //0x425c
	H14Ax_IRIS_024_T                   	iris_024;                     //0x4260
	H14Ax_IRIS_025_T                   	iris_025;                     //0x4264
	H14Ax_IRIS_026_T                   	iris_026;                     //0x4268
	H14Ax_IRIS_027_T                   	iris_027;                     //0x426c
	H14Ax_IRIS_028_T                   	iris_028;                     //0x4270
	H14Ax_IRIS_029_T                   	iris_029;                     //0x4274
	H14Ax_IRIS_030_T                   	iris_030;                     //0x4278
	H14Ax_IRIS_031_T                   	iris_031;                     //0x427c
	H14Ax_IRIS_032_T                   	iris_032;                     //0x4280
	H14Ax_IRIS_033_T                   	iris_033;                     //0x4284
	H14Ax_IRIS_034_T                   	iris_034;                     //0x4288
	H14Ax_IRIS_035_T                   	iris_035;                     //0x428c
	H14Ax_IRIS_036_T                   	iris_036;                     //0x4290
	H14Ax_IRIS_037_T                   	iris_037;                     //0x4294
	H14Ax_IRIS_038_T                   	iris_038;                     //0x4298
	H14Ax_IRIS_039_T                   	iris_039;                     //0x429c
	H14Ax_IRIS_040_T                   	iris_040;                     //0x42a0
	H14Ax_IRIS_041_T                   	iris_041;                     //0x42a4
	H14Ax_IRIS_042_T                   	iris_042;                     //0x42a8
	H14Ax_IRIS_043_T                   	iris_043;                     //0x42ac
	H14Ax_IRIS_044_T                   	iris_044;                     //0x42b0
	H14Ax_IRIS_045_T                   	iris_045;                     //0x42b4
	H14Ax_IRIS_046_T                   	iris_046;                     //0x42b8
	H14Ax_IRIS_047_T                   	iris_047;                     //0x42bc
	H14Ax_IRIS_048_T                   	iris_048;                     //0x42c0
	H14Ax_IRIS_049_T                   	iris_049;                     //0x42c4
	H14Ax_IRIS_050_T                   	iris_050;                     //0x42c8
	H14Ax_IRIS_051_T                   	iris_051;                     //0x42cc
	H14Ax_IRIS_052_T                   	iris_052;                     //0x42d0
	H14Ax_IRIS_053_T                   	iris_053;                     //0x42d4
	H14Ax_IRIS_054_T                   	iris_054;                     //0x42d8
	H14Ax_IRIS_055_T                   	iris_055;                     //0x42dc
	H14Ax_IRIS_056_T                   	iris_056;                     //0x42e0
	H14Ax_IRIS_057_T                   	iris_057;                     //0x42e4
	H14Ax_IRIS_058_T                   	iris_058;                     //0x42e8
	H14Ax_IRIS_059_T                   	iris_059;                     //0x42ec
	H14Ax_IRIS_060_T                   	iris_060;                     //0x42f0
	H14Ax_IRIS_061_T                   	iris_061;                     //0x42f4
	H14Ax_IRIS_062_T                   	iris_062;                     //0x42f8
	H14Ax_IRIS_063_T                   	iris_063;                     //0x42fc
	H14Ax_IRIS_064_T                   	iris_064;                     //0x4300
	H14Ax_IRIS_065_T                   	iris_065;                     //0x4304
	H14Ax_IRIS_066_T                   	iris_066;                     //0x4308
	H14Ax_IRIS_067_T                   	iris_067;                     //0x430c
	H14Ax_IRIS_068_T                   	iris_068;                     //0x4310
	H14Ax_IRIS_069_T                   	iris_069;                     //0x4314
	H14Ax_IRIS_070_T                   	iris_070;                     //0x4318
	H14Ax_IRIS_071_T                   	iris_071;                     //0x431c
	H14Ax_IRIS_072_T                   	iris_072;                     //0x4320
	H14Ax_IRIS_073_T                   	iris_073;                     //0x4324
	H14Ax_IRIS_074_T                   	iris_074;                     //0x4328
	H14Ax_IRIS_075_T                   	iris_075;                     //0x432c
	H14Ax_IRIS_076_T                   	iris_076;                     //0x4330
	H14Ax_IRIS_077_T                   	iris_077;                     //0x4334
	H14Ax_IRIS_078_T                   	iris_078;                     //0x4338
	H14Ax_IRIS_079_T                   	iris_079;                     //0x433c
	H14Ax_IRIS_080_T                   	iris_080;                     //0x4340
	H14Ax_IRIS_081_T                   	iris_081;                     //0x4344
	H14Ax_IRIS_082_T                   	iris_082;                     //0x4348
	H14Ax_IRIS_083_T                   	iris_083;                     //0x434c
	H14Ax_IRIS_084_T                   	iris_084;                     //0x4350
	H14Ax_IRIS_085_T                   	iris_085;                     //0x4354
	H14Ax_IRIS_086_T                   	iris_086;                     //0x4358
	H14Ax_IRIS_087_T                   	iris_087;                     //0x435c
	H14Ax_IRIS_088_T                   	iris_088;                     //0x4360
	H14Ax_IRIS_089_T                   	iris_089;                     //0x4364
	H14Ax_IRIS_090_T                   	iris_090;                     //0x4368
	H14Ax_IRIS_091_T                   	iris_091;                     //0x436c
	H14Ax_IRIS_092_T                   	iris_092;                     //0x4370
	H14Ax_IRIS_093_T                   	iris_093;                     //0x4374
	H14Ax_IRIS_094_T                   	iris_094;                     //0x4378
	H14Ax_IRIS_095_T                   	iris_095;                     //0x437c
	H14Ax_IRIS_096_T                   	iris_096;                     //0x4380
	H14Ax_IRIS_097_T                   	iris_097;                     //0x4384
	H14Ax_IRIS_098_T                   	iris_098;                     //0x4388
	H14Ax_IRIS_099_T                   	iris_099;                     //0x438c
	H14Ax_IRIS_100_T                   	iris_100;                     //0x4390
	H14Ax_IRIS_101_T                   	iris_101;                     //0x4394
	H14Ax_IRIS_102_T                   	iris_102;                     //0x4398
	H14Ax_IRIS_103_T                   	iris_103;                     //0x439c
	H14Ax_IRIS_104_T                   	iris_104;                     //0x43a0
	H14Ax_IRIS_105_T                   	iris_105;                     //0x43a4
	H14Ax_IRIS_106_T                   	iris_106;                     //0x43a8
	H14Ax_IRIS_107_T                   	iris_107;                     //0x43ac
	H14Ax_IRIS_108_T                   	iris_108;                     //0x43b0
	H14Ax_IRIS_109_T                   	iris_109;                     //0x43b4
	H14Ax_IRIS_110_T                   	iris_110;                     //0x43b8
	H14Ax_IRIS_111_T                   	iris_111;                     //0x43bc
	H14Ax_IRIS_112_T                   	iris_112;                     //0x43c0
	H14Ax_IRIS_113_T                   	iris_113;                     //0x43c4
	H14Ax_IRIS_114_T                   	iris_114;                     //0x43c8
	H14Ax_IRIS_115_T                   	iris_115;                     //0x43cc
	H14Ax_IRIS_116_T                   	iris_116;                     //0x43d0
	H14Ax_IRIS_117_T                   	iris_117;                     //0x43d4
	H14Ax_IRIS_118_T                   	iris_118;                     //0x43d8
	H14Ax_IRIS_119_T                   	iris_119;                     //0x43dc
	H14Ax_IRIS_120_T                   	iris_120;                     //0x43e0
	H14Ax_IRIS_121_T                   	iris_121;                     //0x43e4
	H14Ax_IRIS_122_T                   	iris_122;                     //0x43e8
	H14Ax_IRIS_123_T                   	iris_123;                     //0x43ec
	H14Ax_IRIS_124_T                   	iris_124;                     //0x43f0
	H14Ax_IRIS_125_T                   	iris_125;                     //0x43f4
	H14Ax_IRIS_126_T                   	iris_126;                     //0x43f8
	H14Ax_IRIS_127_T                   	iris_127;                     //0x43fc
	H14Ax_IRIS_128_T                   	iris_128;                     //0x4400
	H14Ax_IRIS_129_T                   	iris_129;                     //0x4404
	H14Ax_IRIS_130_T                   	iris_130;                     //0x4408
	H14Ax_IRIS_131_T                   	iris_131;                     //0x440c
	H14Ax_IRIS_132_T                   	iris_132;                     //0x4410
	H14Ax_IRIS_133_T                   	iris_133;                     //0x4414
	H14Ax_IRIS_134_T                   	iris_134;                     //0x4418
	H14Ax_IRIS_135_T                   	iris_135;                     //0x441c
	H14Ax_IRIS_136_T                   	iris_136;                     //0x4420
	H14Ax_IRIS_137_T                   	iris_137;                     //0x4424
	H14Ax_IRIS_138_T                   	iris_138;                     //0x4428
	H14Ax_IRIS_139_T                   	iris_139;                     //0x442c
	H14Ax_IRIS_140_T                   	iris_140;                     //0x4430
	H14Ax_IRIS_141_T                   	iris_141;                     //0x4434
	H14Ax_IRIS_142_T                   	iris_142;                     //0x4438
	H14Ax_IRIS_143_T                   	iris_143;                     //0x443c
	H14Ax_IRIS_144_T                   	iris_144;                     //0x4440
	H14Ax_IRIS_145_T                   	iris_145;                     //0x4444
	H14Ax_IRIS_146_T                   	iris_146;                     //0x4448
	H14Ax_IRIS_147_T                   	iris_147;                     //0x444c
	H14Ax_IRIS_148_T                   	iris_148;                     //0x4450
	H14Ax_IRIS_149_T                   	iris_149;                     //0x4454
	H14Ax_IRIS_150_T                   	iris_150;                     //0x4458
	H14Ax_IRIS_151_T                   	iris_151;                     //0x445c
	H14Ax_IRIS_152_T                   	iris_152;                     //0x4460
	H14Ax_IRIS_153_T                   	iris_153;                     //0x4464
	H14Ax_IRIS_154_T                   	iris_154;                     //0x4468
	H14Ax_IRIS_155_T                   	iris_155;                     //0x446c
	H14Ax_IRIS_156_T                   	iris_156;                     //0x4470
	H14Ax_IRIS_157_T                   	iris_157;                     //0x4474
	H14Ax_IRIS_158_T                   	iris_158;                     //0x4478
	H14Ax_IRIS_159_T                   	iris_159;                     //0x447c
	H14Ax_IRIS_160_T                   	iris_160;                     //0x4480
	H14Ax_IRIS_161_T                   	iris_161;                     //0x4484
	H14Ax_IRIS_162_T                   	iris_162;                     //0x4488
	H14Ax_IRIS_163_T                   	iris_163;                     //0x448c
	H14Ax_IRIS_164_T                   	iris_164;                     //0x4490
	H14Ax_IRIS_165_T                   	iris_165;                     //0x4494
	H14Ax_IRIS_166_T                   	iris_166;                     //0x4498
	H14Ax_IRIS_167_T                   	iris_167;                     //0x449c
	H14Ax_IRIS_168_T                   	iris_168;                     //0x44a0
	H14Ax_IRIS_169_T                   	iris_169;                     //0x44a4
	H14Ax_IRIS_170_T                   	iris_170;                     //0x44a8
	H14Ax_IRIS_171_T                   	iris_171;                     //0x44ac
	H14Ax_IRIS_172_T                   	iris_172;                     //0x44b0
	H14Ax_IRIS_173_T                   	iris_173;                     //0x44b4
	H14Ax_IRIS_174_T                   	iris_174;                     //0x44b8
	H14Ax_IRIS_175_T                   	iris_175;                     //0x44bc
	UINT32                             	reserved04[2];                //0x44c0~0x44c4
	H14Ax_IRIS_178_T                   	iris_178;                     //0x44c8
	H14Ax_IRIS_179_T                   	iris_179;                     //0x44cc
	H14Ax_IRIS_180_T                   	iris_180;                     //0x44d0
	H14Ax_IRIS_181_T                   	iris_181;                     //0x44d4
	H14Ax_IRIS_182_T                   	iris_182;                     //0x44d8
	H14Ax_IRIS_183_T                   	iris_183;                     //0x44dc
	H14Ax_IRIS_184_T                   	iris_184;                     //0x44e0
	H14Ax_IRIS_185_T                   	iris_185;                     //0x44e4
	H14Ax_IRIS_186_T                   	iris_186;                     //0x44e8
	H14Ax_IRIS_187_T                   	iris_187;                     //0x44ec
	H14Ax_IRIS_188_T                   	iris_188;                     //0x44f0
	H14Ax_IRIS_189_T                   	iris_189;                     //0x44f4
	H14Ax_IRIS_190_T                   	iris_190;                     //0x44f8
	H14Ax_IRIS_191_T                   	iris_191;                     //0x44fc
	H14Ax_IRIS_192_T                   	iris_192;                     //0x4500
	H14Ax_IRIS_193_T                   	iris_193;                     //0x4504
	H14Ax_IRIS_194_T                   	iris_194;                     //0x4508
	H14Ax_IRIS_195_T                   	iris_195;                     //0x450c
	H14Ax_IRIS_196_T                   	iris_196;                     //0x4510
	H14Ax_IRIS_197_T                   	iris_197;                     //0x4514
	H14Ax_IRIS_198_T                   	iris_198;                     //0x4518
	H14Ax_IRIS_199_T                   	iris_199;                     //0x451c
	H14Ax_IRIS_200_T                   	iris_200;                     //0x4520
	H14Ax_IRIS_201_T                   	iris_201;                     //0x4524
	H14Ax_IRIS_202_T                   	iris_202;                     //0x4528
	H14Ax_IRIS_203_T                   	iris_203;                     //0x452c
	H14Ax_IRIS_204_T                   	iris_204;                     //0x4530
	H14Ax_IRIS_205_T                   	iris_205;                     //0x4534
	H14Ax_IRIS_206_T                   	iris_206;                     //0x4538
	H14Ax_IRIS_207_T                   	iris_207;                     //0x453c
	H14Ax_IRIS_208_T                   	iris_208;                     //0x4540
	H14Ax_IRIS_209_T                   	iris_209;                     //0x4544
	H14Ax_IRIS_210_T                   	iris_210;                     //0x4548
	H14Ax_IRIS_211_T                   	iris_211;                     //0x454c
	H14Ax_IRIS_212_T                   	iris_212;                     //0x4550
	H14Ax_IRIS_213_T                   	iris_213;                     //0x4554
	H14Ax_IRIS_214_T                   	iris_214;                     //0x4558
	H14Ax_IRIS_215_T                   	iris_215;                     //0x455c
	H14Ax_IRIS_216_T                   	iris_216;                     //0x4560
	H14Ax_IRIS_217_T                   	iris_217;                     //0x4564
	H14Ax_IRIS_218_T                   	iris_218;                     //0x4568
	H14Ax_IRIS_219_T                   	iris_219;                     //0x456c
	H14Ax_IRIS_220_T                   	iris_220;                     //0x4570
	H14Ax_IRIS_221_T                   	iris_221;                     //0x4574
	H14Ax_IRIS_222_T                   	iris_222;                     //0x4578
	H14Ax_IRIS_223_T                   	iris_223;                     //0x457c
	H14Ax_IRIS_224_T                   	iris_224;                     //0x4580
	H14Ax_IRIS_225_T                   	iris_225;                     //0x4584
	H14Ax_IRIS_226_T                   	iris_226;                     //0x4588
	H14Ax_IRIS_227_T                   	iris_227;                     //0x458c
	H14Ax_IRIS_228_T                   	iris_228;                     //0x4590
	H14Ax_IRIS_229_T                   	iris_229;                     //0x4594
	H14Ax_IRIS_230_T                   	iris_230;                     //0x4598
	H14Ax_IRIS_231_T                   	iris_231;                     //0x459c
	H14Ax_IRIS_232_T                   	iris_232;                     //0x45a0
	H14Ax_IRIS_233_T                   	iris_233;                     //0x45a4
	H14Ax_IRIS_234_T                   	iris_234;                     //0x45a8
	H14Ax_IRIS_235_T                   	iris_235;                     //0x45ac
	H14Ax_IRIS_236_T                   	iris_236;                     //0x45b0
	H14Ax_IRIS_237_T                   	iris_237;                     //0x45b4
	H14Ax_IRIS_238_T                   	iris_238;                     //0x45b8
	H14Ax_IRIS_239_T                   	iris_239;                     //0x45bc
	H14Ax_IRIS_240_T                   	iris_240;                     //0x45c0
	H14Ax_IRIS_241_T                   	iris_241;                     //0x45c4
	H14Ax_IRIS_242_T                   	iris_242;                     //0x45c8
	H14Ax_IRIS_243_T                   	iris_243;                     //0x45cc
	H14Ax_IRIS_244_T                   	iris_244;                     //0x45d0
	H14Ax_IRIS_245_T                   	iris_245;                     //0x45d4
	H14Ax_IRIS_246_T                   	iris_246;                     //0x45d8
	H14Ax_IRIS_247_T                   	iris_247;                     //0x45dc
	H14Ax_IRIS_248_T                   	iris_248;                     //0x45e0
	H14Ax_IRIS_249_T                   	iris_249;                     //0x45e4
	H14Ax_IRIS_250_T                   	iris_250;                     //0x45e8
	H14Ax_IRIS_251_T                   	iris_251;                     //0x45ec
	H14Ax_IRIS_252_T                   	iris_252;                     //0x45f0
	H14Ax_IRIS_253_T                   	iris_253;                     //0x45f4
	H14Ax_IRIS_254_T                   	iris_254;                     //0x45f8
	H14Ax_IRIS_255_T                   	iris_255;                     //0x45fc
	H14Ax_IRIS_256_T                   	iris_256;                     //0x4600
	H14Ax_IRIS_257_T                   	iris_257;                     //0x4604
	H14Ax_IRIS_258_T                   	iris_258;                     //0x4608
	H14Ax_IRIS_259_T                   	iris_259;                     //0x460c
	H14Ax_IRIS_260_T                   	iris_260;                     //0x4610
	H14Ax_IRIS_261_T                   	iris_261;                     //0x4614
	H14Ax_IRIS_262_T                   	iris_262;                     //0x4618
	H14Ax_IRIS_263_T                   	iris_263;                     //0x461c
	H14Ax_IRIS_264_T                   	iris_264;                     //0x4620
	H14Ax_IRIS_265_T                   	iris_265;                     //0x4624
	UINT32                             	reserved05[2];                //0x4628~0x462c
	H14Ax_IRIS_266_T                   	iris_266;                     //0x4630
	H14Ax_IRIS_267_T                   	iris_267;                     //0x4634
	H14Ax_IRIS_268_T                   	iris_268;                     //0x4638
	H14Ax_IRIS_269_T                   	iris_269;                     //0x463c
	H14Ax_IRIS_270_T                   	iris_270;                     //0x4640
	H14Ax_IRIS_271_T                   	iris_271;                     //0x4644
	H14Ax_IRIS_272_T                   	iris_272;                     //0x4648
	H14Ax_IRIS_273_T                   	iris_273;                     //0x464c
	H14Ax_IRIS_274_T                   	iris_274;                     //0x4650
	H14Ax_IRIS_275_T                   	iris_275;                     //0x4654
	H14Ax_IRIS_276_T                   	iris_276;                     //0x4658
	H14Ax_IRIS_277_T                   	iris_277;                     //0x465c
	H14Ax_IRIS_278_T                   	iris_278;                     //0x4660
	H14Ax_IRIS_279_T                   	iris_279;                     //0x4664
	H14Ax_IRIS_280_T                   	iris_280;                     //0x4668
	H14Ax_IRIS_281_T                   	iris_281;                     //0x466c
	H14Ax_IRIS_282_T                   	iris_282;                     //0x4670
	H14Ax_IRIS_283_T                   	iris_283;                     //0x4674
	H14Ax_IRIS_284_T                   	iris_284;                     //0x4678
	H14Ax_IRIS_285_T                   	iris_285;                     //0x467c
	H14Ax_IRIS_286_T                   	iris_286;                     //0x4680
	H14Ax_IRIS_287_T                   	iris_287;                     //0x4684
	H14Ax_IRIS_288_T                   	iris_288;                     //0x4688
	H14Ax_IRIS_289_T                   	iris_289;                     //0x468c
	H14Ax_IRIS_290_T                   	iris_290;                     //0x4690
	H14Ax_IRIS_291_T                   	iris_291;                     //0x4694
	H14Ax_IRIS_292_T                   	iris_292;                     //0x4698
	H14Ax_IRIS_293_T                   	iris_293;                     //0x469c
	H14Ax_IRIS_294_T                   	iris_294;                     //0x46a0
	H14Ax_IRIS_295_T                   	iris_295;                     //0x46a4
	H14Ax_IRIS_296_T                   	iris_296;                     //0x46a8
	H14Ax_IRIS_297_T                   	iris_297;                     //0x46ac
	H14Ax_IRIS_298_T                   	iris_298;                     //0x46b0
	H14Ax_IRIS_299_T                   	iris_299;                     //0x46b4
	H14Ax_IRIS_300_T                   	iris_300;                     //0x46b8
	H14Ax_IRIS_301_T                   	iris_301;                     //0x46bc
	H14Ax_IRIS_302_T                   	iris_302;                     //0x46c0
	H14Ax_IRIS_303_T                   	iris_303;                     //0x46c4
	H14Ax_IRIS_304_T                   	iris_304;                     //0x46c8
	H14Ax_IRIS_305_T                   	iris_305;                     //0x46cc
	H14Ax_IRIS_306_T                   	iris_306;                     //0x46d0
	H14Ax_IRIS_307_T                   	iris_307;                     //0x46d4
	H14Ax_IRIS_308_T                   	iris_308;                     //0x46d8
	H14Ax_IRIS_309_T                   	iris_309;                     //0x46dc
	H14Ax_IRIS_310_T                   	iris_310;                     //0x46e0
	H14Ax_IRIS_311_T                   	iris_311;                     //0x46e4
	H14Ax_IRIS_312_T                   	iris_312;                     //0x46e8
	H14Ax_IRIS_313_T                   	iris_313;                     //0x46ec
	H14Ax_IRIS_314_T                   	iris_314;                     //0x46f0
	H14Ax_IRIS_315_T                   	iris_315;                     //0x46f4
	H14Ax_IRIS_316_T                   	iris_316;                     //0x46f8
	H14Ax_IRIS_317_T                   	iris_317;                     //0x46fc
	H14Ax_IRIS_318_T                   	iris_318;                     //0x4700
	H14Ax_IRIS_319_T                   	iris_319;                     //0x4704
	H14Ax_IRIS_320_T                   	iris_320;                     //0x4708
	H14Ax_IRIS_321_T                   	iris_321;                     //0x470c
	H14Ax_IRIS_322_T                   	iris_322;                     //0x4710
	H14Ax_IRIS_323_T                   	iris_323;                     //0x4714
	H14Ax_IRIS_324_T                   	iris_324;                     //0x4718
	H14Ax_IRIS_325_T                   	iris_325;                     //0x471c
	H14Ax_IRIS_326_T                   	iris_326;                     //0x4720
	H14Ax_IRIS_327_T                   	iris_327;                     //0x4724
	H14Ax_IRIS_328_T                   	iris_328;                     //0x4728
	H14Ax_IRIS_329_T                   	iris_329;                     //0x472c
	H14Ax_IRIS_330_T                   	iris_330;                     //0x4730
	H14Ax_IRIS_331_T                   	iris_331;                     //0x4734
	H14Ax_IRIS_332_T                   	iris_332;                     //0x4738
	H14Ax_IRIS_333_T                   	iris_333;                     //0x473c
	H14Ax_IRIS_334_T                   	iris_334;                     //0x4740
	H14Ax_IRIS_335_T                   	iris_335;                     //0x4744
	H14Ax_IRIS_336_T                   	iris_336;                     //0x4748
	H14Ax_IRIS_337_T                   	iris_337;                     //0x474c
	H14Ax_IRIS_338_T                   	iris_338;                     //0x4750
	H14Ax_IRIS_339_T                   	iris_339;                     //0x4754
	H14Ax_IRIS_340_T                   	iris_340;                     //0x4758
	H14Ax_IRIS_341_T                   	iris_341;                     //0x475c
	H14Ax_IRIS_342_T                   	iris_342;                     //0x4760
	H14Ax_IRIS_343_T                   	iris_343;                     //0x4764
	H14Ax_IRIS_344_T                   	iris_344;                     //0x4768
	H14Ax_IRIS_345_T                   	iris_345;                     //0x476c
	H14Ax_IRIS_346_T                   	iris_346;                     //0x4770
	H14Ax_IRIS_347_T                   	iris_347;                     //0x4774
	H14Ax_IRIS_348_T                   	iris_348;                     //0x4778
	H14Ax_IRIS_349_T                   	iris_349;                     //0x477c
	H14Ax_IRIS_350_T                   	iris_350;                     //0x4780
	H14Ax_IRIS_351_T                   	iris_351;                     //0x4784
	H14Ax_IRIS_352_T                   	iris_352;                     //0x4788
	H14Ax_IRIS_353_T                   	iris_353;                     //0x478c
	H14Ax_IRIS_354_T                   	iris_354;                     //0x4790
	H14Ax_IRIS_355_T                   	iris_355;                     //0x4794
	H14Ax_IRIS_356_T                   	iris_356;                     //0x4798
	H14Ax_IRIS_357_T                   	iris_357;                     //0x479c
	H14Ax_IRIS_358_T                   	iris_358;                     //0x47a0
	H14Ax_IRIS_359_T                   	iris_359;                     //0x47a4
	H14Ax_IRIS_360_T                   	iris_360;                     //0x47a8
	H14Ax_IRIS_361_T                   	iris_361;                     //0x47ac
	H14Ax_IRIS_362_T                   	iris_362;                     //0x47b0
	H14Ax_IRIS_363_T                   	iris_363;                     //0x47b4
	H14Ax_IRIS_364_T                   	iris_364;                     //0x47b8
	H14Ax_IRIS_365_T                   	iris_365;                     //0x47bc
	H14Ax_IRIS_366_T                   	iris_366;                     //0x47c0
	H14Ax_IRIS_367_T                   	iris_367;                     //0x47c4
	H14Ax_IRIS_368_T                   	iris_368;                     //0x47c8
	H14Ax_IRIS_369_T                   	iris_369;                     //0x47cc
	H14Ax_IRIS_370_T                   	iris_370;                     //0x47d0
	H14Ax_IRIS_371_T                   	iris_371;                     //0x47d4
	H14Ax_IRIS_372_T                   	iris_372;                     //0x47d8
	UINT32                             	reserved06[9];               //0x47dC~0x47fc
	H14Ax_VBI_001_T                    	vbi_001;                      //0x4800
	H14Ax_VBI_002_T                    	vbi_002;                      //0x4804
	H14Ax_VBI_003_T                    	vbi_003;                      //0x4808
	H14Ax_VBI_004_T                    	vbi_004;                      //0x480c
	H14Ax_VBI_005_T                    	vbi_005;                      //0x4810
	H14Ax_VBI_006_T                    	vbi_006;                      //0x4814
	H14Ax_VBI_007_T                    	vbi_007;                      //0x4818
	H14Ax_VBI_008_T                    	vbi_008;                      //0x481c
	H14Ax_VBI_009_T                    	vbi_009;                      //0x4820
	H14Ax_VBI_010_T                    	vbi_010;                      //0x4824
	H14Ax_VBI_011_T                    	vbi_011;                      //0x4828
	H14Ax_VBI_012_T                    	vbi_012;                      //0x482c
	H14Ax_VBI_013_T                    	vbi_013;                      //0x4830
	H14Ax_VBI_014_T                    	vbi_014;                      //0x4834
	H14Ax_VBI_015_T                    	vbi_015;                      //0x4838
	H14Ax_VBI_016_T                    	vbi_016;                      //0x483c
	H14Ax_VBI_017_T                    	vbi_017;                      //0x4840
	H14Ax_VBI_018_T                    	vbi_018;                      //0x4844
	H14Ax_VBI_019_T                    	vbi_019;                      //0x4848
	H14Ax_VBI_020_T                    	vbi_020;                      //0x484c
	H14Ax_VBI_021_T                    	vbi_021;                      //0x4850
	H14Ax_VBI_022_T                    	vbi_022;                      //0x4854
	H14Ax_VBI_023_T                    	vbi_023;                      //0x4858
	H14Ax_VBI_024_T                    	vbi_024;                      //0x485c
	H14Ax_VBI_025_T                    	vbi_025;                      //0x4860
	H14Ax_VBI_026_T                    	vbi_026;                      //0x4864
	H14Ax_VBI_027_T                    	vbi_027;                      //0x4868
	H14Ax_VBI_028_T                    	vbi_028;                      //0x486c
	H14Ax_VBI_029_T                    	vbi_029;                      //0x4870
	H14Ax_VBI_030_T                    	vbi_030;                      //0x4874
	H14Ax_VBI_031_T                    	vbi_031;                      //0x4878
	H14Ax_VBI_032_T                    	vbi_032;                      //0x487c
	H14Ax_VBI_033_T                    	vbi_033;                      //0x4880
	H14Ax_VBI_034_T                    	vbi_034;                      //0x4884
	H14Ax_VBI_035_T                    	vbi_035;                      //0x4888
	H14Ax_VBI_036_T                    	vbi_036;                      //0x488c
	H14Ax_VBI_037_T                    	vbi_037;                      //0x4890
	H14Ax_VBI_038_T                    	vbi_038;                      //0x4894
	H14Ax_AGC_001_T                    	agc_001;                      //0x4898
	H14Ax_LVL_001_T                    	lvl_001;                      //0x489c
	H14Ax_LVL_002_T                    	lvl_002;                      //0x48a0
	H14Ax_LVL_003_T                    	lvl_003;                      //0x48a4
	H14Ax_LVL_004_T                    	lvl_004;                      //0x48a8
	H14Ax_LVL_005_T                    	lvl_005;                      //0x48ac
	H14Ax_LVL_006_T                    	lvl_006;                      //0x48b0
	H14Ax_LVL_007_T                    	lvl_007;                      //0x48b4
	H14Ax_LVL_008_T                    	lvl_008;                      //0x48b8
	H14Ax_LVL_009_T                    	lvl_009;                      //0x48bc
	H14Ax_LVL_010_T                    	lvl_010;                      //0x48c0
	H14Ax_LVL_011_T                    	lvl_011;                      //0x48c4
	H14Ax_LVL_012_T                    	lvl_012;                      //0x48c8
	H14Ax_LVL_013_T                    	lvl_013;                      //0x48cc
	H14Ax_LVL_014_T                    	lvl_014;                      //0x48d0
	H14Ax_LVL_015_T                    	lvl_015;                      //0x48d4
	H14Ax_LVL_016_T                    	lvl_016;                      //0x48d8
	H14Ax_LVL_017_T                    	lvl_017;                      //0x48dc
	H14Ax_LVL_018_T                    	lvl_018;                      //0x48e0
	H14Ax_LVL_019_T                    	lvl_019;                      //0x48e4
	H14Ax_LVL_020_T                    	lvl_020;                      //0x48e8
	H14Ax_LVL_021_T                    	lvl_021;                      //0x48ec
	H14Ax_IRIS_MIF_GMUA_MON_001_T      	iris_mif_gmua_mon_001;        //0x48f0
	H14Ax_IRIS_MIF_GMUA_MON_002_T      	iris_mif_gmua_mon_002;        //0x48f4
	H14Ax_IRIS_MIF_GMUA_MON_003_T      	iris_mif_gmua_mon_003;        //0x48f8
	H14Ax_IRIS_MIF_GMUA_MON_004_T      	iris_mif_gmua_mon_004;        //0x48fc
	H14Ax_IRIS_MIF_GMUA_MON_005_T      	iris_mif_gmua_mon_005;        //0x4900
	H14Ax_IRIS_MIF_GMUA_MON_006_T      	iris_mif_gmua_mon_006;        //0x4904
	H14Ax_IRIS_MIF_GMUA_MON_007_T      	iris_mif_gmua_mon_007;        //0x4908
	H14Ax_IRIS_HIF_CTRL0_001_T         	iris_hif_ctrl0_001;           //0x490c
	H14Ax_IRIS_HIF_CTRL1_001_T         	iris_hif_ctrl1_001;           //0x4910
}DE_CVD_REG_H14Ax_T;

/*
 * @{
 * Naming for register pointer.
 * gpRealRegCVD_H14Ax : real register of VPORT_L9B0.
 * gpRegCVD_H14Ax     : shadow register.
 *
 * @def CVD_H14Ax_RdFL: Read  FLushing : Shadow <- Real.
 * @def CVD_H14Ax_WrFL: Write FLushing : Shadow -> Real.
 * @def CVD_H14Ax_Rd  : Read  whole register(UINT32) from Shadow register.
 * @def CVD_H14Ax_Wr  : Write whole register(UINT32) from Shadow register.
 * @def CVD_H14Ax_Rd01 ~ CVD_H14Ax_Rdnn: Read  given '01~nn' fields from Shadow register.
 * @def CVD_H14Ax_Wr01 ~ CVD_H14Ax_Wrnn: Write given '01~nn' fields to   Shadow register.
 * */
#define CVD_H14Ax_RdFL(_r)			((gpRegCVD_H14Ax->_r)=(gpRealRegCVD_H14Ax->_r))
#define CVD_H14Ax_WrFL(_r)			((gpRealRegCVD_H14Ax->_r)=(gpRegCVD_H14Ax->_r))

#define CVD_H14Ax_Rd(_r)			*((UINT32*)(&(gpRegCVD_H14Ax->_r)))
#define CVD_H14Ax_Wr(_r,_v)			((CVD_H14Ax_Rd(_r))=((UINT32)(_v)))

#define CVD_H14Ax_Rd01(_r,_f01,_v01)													\
								do { 											\
									(_v01) = (gpRegCVD_H14Ax->_r._f01);				\
								} while(0)

#define CVD_H14Ax_Rd02(_r,_f01,_v01,_f02,_v02)										\
								do { 											\
									(_v01) = (gpRegCVD_H14Ax->_r._f01);				\
									(_v02) = (gpRegCVD_H14Ax->_r._f02);				\
								} while(0)

#define CVD_H14Ax_Rd03(_r,_f01,_v01,_f02,_v02,_f03,_v03)								\
								do { 											\
									(_v01) = (gpRegCVD_H14Ax->_r._f01);				\
									(_v02) = (gpRegCVD_H14Ax->_r._f02);				\
									(_v03) = (gpRegCVD_H14Ax->_r._f03);				\
								} while(0)

#define CVD_H14Ax_Rd04(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04)					\
								do { 											\
									(_v01) = (gpRegCVD_H14Ax->_r._f01);				\
									(_v02) = (gpRegCVD_H14Ax->_r._f02);				\
									(_v03) = (gpRegCVD_H14Ax->_r._f03);				\
									(_v04) = (gpRegCVD_H14Ax->_r._f04);				\
								} while(0)

#define CVD_H14Ax_Rd05(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05)													\
								do { 											\
									(_v01) = (gpRegCVD_H14Ax->_r._f01);				\
									(_v02) = (gpRegCVD_H14Ax->_r._f02);				\
									(_v03) = (gpRegCVD_H14Ax->_r._f03);				\
									(_v04) = (gpRegCVD_H14Ax->_r._f04);				\
									(_v05) = (gpRegCVD_H14Ax->_r._f05);				\
								} while(0)

#define CVD_H14Ax_Rd06(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06)										\
								do { 											\
									(_v01) = (gpRegCVD_H14Ax->_r._f01);				\
									(_v02) = (gpRegCVD_H14Ax->_r._f02);				\
									...
									(_v04) = (gpRegCVD_H14Ax->_r._f04);				\
									(_v05) = (gpRegCVD_H14Ax->_r._f05);				\
									(_v06) = (gpRegCVD_H14Ax->_r._f06);				\
								} while(0)

#define CVD_H14Ax_Rd07(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07)								\
								do { 											\
									...
									(_v05) = (gpRegCVD_H14Ax->_r._f05);				\
									(_v06) = (gpRegCVD_H14Ax->_r._f06);				\
									(_v07) = (gpRegCVD_H14Ax->_r._f07);				\
								} while(0)

#define CVD_H14Ax_Rd08(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08)					\
								do { 											\
									...
									(_v06) = (gpRegCVD_H14Ax->_r._f06);				\
									(_v07) = (gpRegCVD_H14Ax->_r._f07);				\
									(_v08) = (gpRegCVD_H14Ax->_r._f08);				\
								} while(0)

#define CVD_H14Ax_Rd09(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08,					\
					_f09,_v09)													\
								do { 											\
									(_v01) = (gpRegCVD_H14Ax->_r._f01);				\
									...
									(_v07) = (gpRegCVD_H14Ax->_r._f07);				\
									(_v08) = (gpRegCVD_H14Ax->_r._f08);				\
									(_v09) = (gpRegCVD_H14Ax->_r._f09);				\
								} while(0)

#define CVD_H14Ax_Rd10(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08,					\
					_f09,_v09,_f10,_v10)										\
								do { 											\
									(_v01) = (gpRegCVD_H14Ax->_r._f01);				\
									...
									(_v08) = (gpRegCVD_H14Ax->_r._f08);				\
									(_v09) = (gpRegCVD_H14Ax->_r._f09);				\
									(_v10) = (gpRegCVD_H14Ax->_r._f10);				\
								} while(0)

#define CVD_H14Ax_Rd11(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08,					\
					_f09,_v09,_f10,_v10,_f11,_v11)								\
								do { 											\
									...
									(_v09) = (gpRegCVD_H14Ax->_r._f09);				\
									(_v10) = (gpRegCVD_H14Ax->_r._f10);				\
									(_v11) = (gpRegCVD_H14Ax->_r._f11);				\
								} while(0)

#define CVD_H14Ax_Rd12(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08,					\
					_f09,_v09,_f10,_v10,_f11,_v11,_f12,_v12)					\
								do { 											\
									...
									(_v10) = (gpRegCVD_H14Ax->_r._f10);				\
									(_v11) = (gpRegCVD_H14Ax->_r._f11);				\
									(_v12) = (gpRegCVD_H14Ax->_r._f12);				\
								} while(0)

#define CVD_H14Ax_Rd13(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08,					\
					_f09,_v09,_f10,_v10,_f11,_v11,_f12,_v12,					\
					_f13,_v13)													\
								do { 											\
									...
									(_v11) = (gpRegCVD_H14Ax->_r._f11);				\
									(_v12) = (gpRegCVD_H14Ax->_r._f12);				\
									(_v13) = (gpRegCVD_H14Ax->_r._f13);				\
								} while(0)

#define CVD_H14Ax_Rd14(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08,					\
					_f09,_v09,_f10,_v10,_f11,_v11,_f12,_v12,					\
					_f13,_v13,_f14,_v14)										\
								do { 											\
									...
									(_v12) = (gpRegCVD_H14Ax->_r._f12);				\
									(_v13) = (gpRegCVD_H14Ax->_r._f13);				\
									(_v14) = (gpRegCVD_H14Ax->_r._f14);				\
								} while(0)

#define CVD_H14Ax_Rd15(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08,					\
					_f09,_v09,_f10,_v10,_f11,_v11,_f12,_v12,					\
					_f13,_v13,_f14,_v14,_f15,_v15)								\
								do { 											\
									...
									(_v13) = (gpRegCVD_H14Ax->_r._f13);				\
									(_v14) = (gpRegCVD_H14Ax->_r._f14);				\
									(_v15) = (gpRegCVD_H14Ax->_r._f15);				\
								} while(0)

#define CVD_H14Ax_Rd16(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08,					\
					_f09,_v09,_f10,_v10,_f11,_v11,_f12,_v12,					\
					_f13,_v13,_f14,_v14,_f15,_v15,_f16,_v16)					\
								do { 											\
									...
									(_v14) = (gpRegCVD_H14Ax->_r._f14);				\
									(_v15) = (gpRegCVD_H14Ax->_r._f15);				\
									(_v16) = (gpRegCVD_H14Ax->_r._f16);				\
								} while(0)


#define CVD_H14Ax_Wr01(_r,_f01,_v01)													\
								do { 											\
									(gpRegCVD_H14Ax->_r._f01) = (_v01);				\
								} while(0)

#define CVD_H14Ax_Wr02(_r,_f01,_v01,_f02,_v02)										\
								do { 											\
									(gpRegCVD_H14Ax->_r._f01) = (_v01);				\
									(gpRegCVD_H14Ax->_r._f02) = (_v02);				\
								} while(0)

#define CVD_H14Ax_Wr03(_r,_f01,_v01,_f02,_v02,_f03,_v03)								\
								do { 											\
									(gpRegCVD_H14Ax->_r._f01) = (_v01);				\
									(gpRegCVD_H14Ax->_r._f02) = (_v02);				\
									(gpRegCVD_H14Ax->_r._f03) = (_v03);				\
								} while(0)

#define CVD_H14Ax_Wr04(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04)					\
								do { 											\
									(gpRegCVD_H14Ax->_r._f01) = (_v01);				\
									(gpRegCVD_H14Ax->_r._f02) = (_v02);				\
									(gpRegCVD_H14Ax->_r._f03) = (_v03);				\
									(gpRegCVD_H14Ax->_r._f04) = (_v04);				\
								} while(0)

#define CVD_H14Ax_Wr05(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05)													\
								do { 											\
									(gpRegCVD_H14Ax->_r._f01) = (_v01);				\
									(gpRegCVD_H14Ax->_r._f02) = (_v02);				\
									(gpRegCVD_H14Ax->_r._f03) = (_v03);				\
									(gpRegCVD_H14Ax->_r._f04) = (_v04);				\
									(gpRegCVD_H14Ax->_r._f05) = (_v05);				\
								} while(0)

#define CVD_H14Ax_Wr06(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06)										\
								do { 											\
									(gpRegCVD_H14Ax->_r._f01) = (_v01);				\
									(gpRegCVD_H14Ax->_r._f02) = (_v02);				\
									...
									(gpRegCVD_H14Ax->_r._f04) = (_v04);				\
									(gpRegCVD_H14Ax->_r._f05) = (_v05);				\
									(gpRegCVD_H14Ax->_r._f06) = (_v06);				\
								} while(0)

#define CVD_H14Ax_Wr07(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07)								\
								do { 											\
									(gpRegCVD_H14Ax->_r._f01) = (_v01);				\
									(gpRegCVD_H14Ax->_r._f02) = (_v02);				\
									...
									(gpRegCVD_H14Ax->_r._f05) = (_v05);				\
									(gpRegCVD_H14Ax->_r._f06) = (_v06);				\
									(gpRegCVD_H14Ax->_r._f07) = (_v07);				\
								} while(0)

#define CVD_H14Ax_Wr08(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08)					\
								do { 											\
									(gpRegCVD_H14Ax->_r._f01) = (_v01);				\
									(gpRegCVD_H14Ax->_r._f02) = (_v02);				\
									...
									(gpRegCVD_H14Ax->_r._f06) = (_v06);				\
									(gpRegCVD_H14Ax->_r._f07) = (_v07);				\
									(gpRegCVD_H14Ax->_r._f08) = (_v08);				\
								} while(0)

#define CVD_H14Ax_Wr09(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08,					\
					_f09,_v09)													\
								do { 											\
									(gpRegCVD_H14Ax->_r._f01) = (_v01);				\
									...
									(gpRegCVD_H14Ax->_r._f07) = (_v07);				\
									(gpRegCVD_H14Ax->_r._f08) = (_v08);				\
									(gpRegCVD_H14Ax->_r._f09) = (_v09);				\
								} while(0)

#define CVD_H14Ax_Wr10(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08,					\
					_f09,_v09,_f10,_v10)										\
								do { 											\
									(gpRegCVD_H14Ax->_r._f01) = (_v01);				\
									...
									(gpRegCVD_H14Ax->_r._f08) = (_v08);				\
									(gpRegCVD_H14Ax->_r._f09) = (_v09);				\
									(gpRegCVD_H14Ax->_r._f10) = (_v10);				\
								} while(0)

#define CVD_H14Ax_Wr11(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08,					\
					_f09,_v09,_f10,_v10,_f11,_v11)								\
								do { 											\
									(gpRegCVD_H14Ax->_r._f01) = (_v01);				\
									...
									(gpRegCVD_H14Ax->_r._f09) = (_v09);				\
									(gpRegCVD_H14Ax->_r._f10) = (_v10);				\
									(gpRegCVD_H14Ax->_r._f11) = (_v11);				\
								} while(0)

#define CVD_H14Ax_Wr12(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08,					\
					_f09,_v09,_f10,_v10,_f11,_v11,_f12,_v12)					\
								do { 											\
									(gpRegCVD_H14Ax->_r._f01) = (_v01);				\
									...
									(gpRegCVD_H14Ax->_r._f10) = (_v10);				\
									(gpRegCVD_H14Ax->_r._f11) = (_v11);				\
									(gpRegCVD_H14Ax->_r._f12) = (_v12);				\
								} while(0)

#define CVD_H14Ax_Wr13(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08,					\
					_f09,_v09,_f10,_v10,_f11,_v11,_f12,_v12,					\
					_f13,_v13)													\
								do { 											\
									...
									(gpRegCVD_H14Ax->_r._f11) = (_v11);				\
									(gpRegCVD_H14Ax->_r._f12) = (_v12);				\
									(gpRegCVD_H14Ax->_r._f13) = (_v13);				\
								} while(0)

#define CVD_H14Ax_Wr14(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08,					\
					_f09,_v09,_f10,_v10,_f11,_v11,_f12,_v12,					\
					_f13,_v13,_f14,_v14)										\
								do { 											\
									...
									(gpRegCVD_H14Ax->_r._f12) = (_v12);				\
									(gpRegCVD_H14Ax->_r._f13) = (_v13);				\
									(gpRegCVD_H14Ax->_r._f14) = (_v14);				\
								} while(0)

#define CVD_H14Ax_Wr15(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08,					\
					_f09,_v09,_f10,_v10,_f11,_v11,_f12,_v12,					\
					_f13,_v13,_f14,_v14,_f15,_v15)								\
								do { 											\
									...
									(gpRegCVD_H14Ax->_r._f13) = (_v13);				\
									(gpRegCVD_H14Ax->_r._f14) = (_v14);				\
									(gpRegCVD_H14Ax->_r._f15) = (_v15);				\
								} while(0)

#define CVD_H14Ax_Wr16(_r,_f01,_v01,_f02,_v02,_f03,_v03,_f04,_v04,					\
					_f05,_v05,_f06,_v06,_f07,_v07,_f08,_v08,					\
					_f09,_v09,_f10,_v10,_f11,_v11,_f12,_v12,					\
					_f13,_v13,_f14,_v14,_f15,_v15,_f16,_v16)					\
								do { 											\
 ...
 * _rwname: name of rw    bit field : shall be 0 after CVD_H14Ax_Wind(), 1 for CVD_H14Ax_Rind()
 * _iname : name of index bit field
 * _ival  : index value
 * _fname : field name
 * _fval  : field variable that field value shall be stored.
 *
 * CVD_H14Ax_Rind : General indexed register Read.(
 * CVD_H14Ax_Wind : General indexed register Read.
 *
 * CVD_H14Ax_Ridx : For 'index', 'rw', 'load' field name
 * CVD_H14Ax_Widx : For 'index', 'rw', 'load' field name and NO_LOAD.
 */
#define CVD_H14Ax_Rind(_r, _lname, _rwname, _iname, _ival, _fname, _fval)				\
							do {												\
								CVD_H14Ax_Wr03(_r,_lname,0,_rwname,1,_iname,_ival);	\
								CVD_H14Ax_WrFL(_r);									\
								CVD_H14Ax_RdFL(_r);									\
								CVD_H14Ax_Rd01(_r,_fname,_fval);						\
							} while (0)

#define CVD_H14Ax_Wind(_r, _lname, _rwname, _iname, _ival, _fname, _fval)				\
				CVD_H14Ax_Wr04(_r, _lname,0, _rwname,0, _iname,_ival, _fname,_fval)


#define CVD_H14Ax_Ridx(_r, _ival, _fname, _fval)	CVD_H14Ax_Rind(_r,load,rw,index,_ival,_fname,_fval)

#define CVD_H14Ax_Widx(_r, _ival, _fname, _fval)	CVD_H14Ax_Wind(_r,load,rw,index,_ival,_fname,_fval)
