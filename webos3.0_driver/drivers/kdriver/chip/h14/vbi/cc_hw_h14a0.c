...
int CC_H14Ax_HWInitialize(void)
{
	...
	CVD_H14Ax_Wr01(vbi_ctrl_001, reg_vbi_little_endian, 1);
	CVD_H14Ax_WrFL(vbi_ctrl_001);

	//111128 wonsik.do : enabled one bit error ignore from H14Ax revision.
...
int CC_H14Ax_HWUninitialize(void)
{
	int ret = 0;
...
int CC_H14Ax_SetInputFormat(eVBIDataType type)
{
	...
	switch(type)
	{
		...
		case eClosedCaptionEURO:
			...
			CVD_H14Ax_Wr(vbi_010, 0x1100DD11);
			//CVD_H14Ax_Wr(vbi_011, 0x11001111);
			CVD_H14Ax_Wr(vbi_011, 0x11000000);
			//CVD_H14Ax_Wr(vbi_010, 0x11);
			//CVD_H14Ax_Wr(vbi_011, 0);
			CVD_H14Ax_Wr(vbi_014, 0x35A012DB);
			CVD_H14Ax_Wr(vbi_015, 0x1E2B159A);	// 120531 : won.hur Changed DTO value for CGMS slicing
			//CVD_H14Ax_Wr(vbi_015, 0x2066159A);
			//CVD_H14Ax_Wr(vbi_020, 0x54548282);
			CVD_H14Ax_Wr(vbi_020, 0x5A548282);    // 2011.12.10 won.hur : Changed CC find start h-sync value
			CVD_H14Ax_Wr01(vbi_016, reg_wss625_frame_start, 0x2);
			CVD_H14Ax_Wr01(iris_040, reg_vsync_vbi_max, 0x25);

			/* Added for H14Ax on improving performance & bugs... */
			/* 2012.10.22 won.hur */
			CVD_H14Ax_Wr(vbi_023, 0x5F1B6110);
			...
			CVD_H14Ax_Wr(vbi_037, 0x00000001);
		...
		case eWSS625	:
			...
			CVD_H14Ax_RdFL(vbi_015);
			CVD_H14Ax_Wr01(vbi_015, reg_wss625_dto, 0x1599);
			CVD_H14Ax_WrFL(vbi_015);
...
int CC_H14Ax_SetInterrupt(int on_off)
{
	...
	if(on_off)
	{
		...
		CVD_H14Ax_Wr(cvd_intr1_enable1, (intr_vp1_en |= L9_VBI_INTERRUPT_MASK));
...
int CC_H14Ax_ParsingVBIData(unsigned int *packet_array)
{
	int ret = 0;
	...
	switch(buffer_number)
	{
		case 0:
			...
			CVD_H14Ax_Rd01(vbi_ctrl_002, reg_vbi0_start_addr, start);
			CVD_H14Ax_Rd01(vbi_ctrl_003, reg_vbi0_end_addr, end);
			CVD_H14Ax_Rd01(vbi_ctrl_002, reg_vbi0_data_cnt, count);
		...
		case 1:
			...
			CVD_H14Ax_Rd01(vbi_ctrl_004, reg_vbi1_start_addr, start);
			CVD_H14Ax_Rd01(vbi_ctrl_005, reg_vbi1_end_addr, end);
			CVD_H14Ax_Rd01(vbi_ctrl_004, reg_vbi1_data_cnt, count);
		...
		case 2:
			...
			CVD_H14Ax_Rd01(vbi_ctrl_006, reg_vbi2_start_addr, start);
			CVD_H14Ax_Rd01(vbi_ctrl_007, reg_vbi2_end_addr, end);
			CVD_H14Ax_Rd01(vbi_ctrl_006, reg_vbi2_data_cnt, count);
		...
		case 3:
			...
			CVD_H14Ax_Rd01(vbi_ctrl_008, reg_vbi3_start_addr, start);
			CVD_H14Ax_Rd01(vbi_ctrl_009, reg_vbi3_end_addr, end);
			CVD_H14Ax_Rd01(vbi_ctrl_008, reg_vbi3_data_cnt, count);
...
int CC_H14Ax_CheckVline625(void)
{
	...
	if(isVline625 != 0)
	{
		if(isVline625 != gPrevVline625)
		{
			...
			CVD_H14Ax_Wr(vbi_010, 0x0000DD00);
			CVD_H14Ax_Wr(vbi_011, 0x000C0000);
			CVD_H14Ax_Wr(vbi_015, 0x2066159A);
	...
	else
	{
		if(isVline625 != gPrevVline625)
		{
			...
			CVD_H14Ax_Wr(vbi_010, 0x1100DD11);
			CVD_H14Ax_Wr(vbi_011, 0x11000000);
			CVD_H14Ax_Wr(vbi_015, 0x1E2B159A);
...
int CC_H14Ax_RunResume(void)
{
	...
	CC_H14Ax_SetInputFormat(eClosedCaptionUS);
