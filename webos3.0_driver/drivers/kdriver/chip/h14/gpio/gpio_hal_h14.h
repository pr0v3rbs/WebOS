...
#ifndef	_GPIO_DRV_HAL_H14_A0_H_
#define	_GPIO_DRV_HAL_H14_A0_H_
...
extern UINT32 		gpio_intr_num_h14[GPIO_IRQ_NUM_NR];
extern void _GPIO_ISR_GPIO_H14( unsigned int ui32IRQNum, unsigned int IntData );
#endif
