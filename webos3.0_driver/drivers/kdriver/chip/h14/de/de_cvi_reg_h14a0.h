...
#ifndef _REG_CVI_H14A0_h
#define _REG_CVI_H14A0_h
...
} H14A0_CVA_PSEUDO_SYNC_CTRL4_T;

/*-----------------------------------------------------------------------------
	0x01f0 cva_size_detect_ctrl3 ''
------------------------------------------------------------------------------*/
typedef struct {
...
typedef struct {
	...
	UINT32                                 : 4;   // 12:15 reserved
	UINT32 pseudo_vn                       : 12;  // 16:27
} H14A0_CVB_PSEUDO_SYNC_CTRL4_T;

/*-----------------------------------------------------------------------------
	0x02f0 cvb_size_detect_ctrl3 ''
------------------------------------------------------------------------------*/
typedef struct {
	UINT32 interrupt_mask_method           : 1;   //     0
	UINT32                                 : 3;   //  1: 3 reserved
	UINT32 interrupt_mask_count            : 12;  //  4:15
	UINT32 diff_hsize                      : 14;  // 16:29
} H14A0_CVB_SIZE_DETECT_CTRL3_T;

typedef struct {
	H14A0_CVA_TOP_CTRL_T            cva_top_ctrl;                    // 0x0100
	H14A0_CVA_OFFSET_CTRL_T         cva_offset_ctrl;                 // 0x0104
	H14A0_CVA_SIZE_CTRL_T           cva_size_ctrl;                   // 0x0108
	H14A0_CVA_INT_SYNC_CTRL0_T      cva_int_sync_ctrl0;              // 0x010c
	H14A0_CVA_INT_SYNC_CTRL1_T      cva_int_sync_ctrl1;              // 0x0110
	H14A0_CVA_DIG_FILT_CTRL0_T      cva_dig_filt_ctrl0;              // 0x0114
	H14A0_CVA_DIG_FILT_CTRL1_T      cva_dig_filt_ctrl1;              // 0x0118
	H14A0_CVA_DIG_FILT_CTRL2_T      cva_dig_filt_ctrl2;              // 0x011c
	H14A0_CVA_DIG_FILT_CTRL3_T      cva_dig_filt_ctrl3;              // 0x0120
	H14A0_CVA_CSC_CTRL0_T           cva_csc_ctrl0;                   // 0x0124
	H14A0_CVA_CSC_CTRL1_T           cva_csc_ctrl1;                   // 0x0128
	H14A0_CVA_CSC_CTRL2_T           cva_csc_ctrl2;                   // 0x012c
	H14A0_CVA_CSC_CTRL3_T           cva_csc_ctrl3;                   // 0x0130
	H14A0_CVA_CSC_CTRL4_T           cva_csc_ctrl4;                   // 0x0134
	H14A0_CVA_CSC_CTRL5_T           cva_csc_ctrl5;                   // 0x0138
	H14A0_CVA_CSC_CTRL6_T           cva_csc_ctrl6;                   // 0x013c
	H14A0_CVA_CSC_CTRL7_T           cva_csc_ctrl7;                   // 0x0140
	H14A0_CVA_MISC_CTRL_T           cva_misc_ctrl;                   // 0x0144
	H14A0_CVA_OFFSET_READ_T         cva_offset_read;                 // 0x0148
	H14A0_CVA_PRE3D_CTRL0_T         cva_pre3d_ctrl0;                 // 0x014c
	H14A0_CVA_PRE3D_CTRL1_T         cva_pre3d_ctrl1;                 // 0x0150
	H14A0_CVA_PRE3D_CTRL2_T         cva_pre3d_ctrl2;                 // 0x0154
	H14A0_CVA_SIZE_STATUS1_T        cva_size_status1;                // 0x0158
	H14A0_CVA_SIZE_STATUS2_T        cva_size_status2;                // 0x015c
	H14A0_CVA_SIZE_STATUS3_T        cva_size_status3;                // 0x0160
	H14A0_CVA_SIZE_STATUS4_T        cva_size_status4;                // 0x0164
	H14A0_CVA_PIX_SUM_CTRL0_T       cva_pix_sum_ctrl0;               // 0x0168
	H14A0_CVA_PIX_SUM_CTRL1_T       cva_pix_sum_ctrl1;               // 0x016c
	H14A0_CVA_PIX_SUM_STATUS0_T     cva_pix_sum_status0;             // 0x0170
	H14A0_CVA_PIX_SUM_STATUS1_T     cva_pix_sum_status1;             // 0x0174
	H14A0_CVA_PIX_SUM_STATUS2_T     cva_pix_sum_status2;             // 0x0178
	H14A0_CVA_SYNC_FIL_CTRL_T       cva_sync_fil_ctrl;               // 0x017c
	H14A0_CVA_SYNC_FIL_STATUS_T     cva_sync_fil_status;             // 0x0180
	H14A0_CVA_CTI_CTRL_T            cva_cti_ctrl;                    // 0x0184
	UINT32                          reserved0[2];                    // 0x0188~0x018c
	H14A0_CVA_SYNC_REPEAT_CTRL_T    cva_sync_repeat_ctrl;            // 0x0190
	H14A0_CVA_SYNC_REPEAT_SIZE0_T   cva_sync_repeat_size0;           // 0x0194
	H14A0_CVA_SYNC_REPEAT_SIZE1_T   cva_sync_repeat_size1;           // 0x0198
	H14A0_CVA_SYNC_REPEAT_SIZE2_T   cva_sync_repeat_size2;           // 0x019c
	H14A0_CVA_SYNC_REPEAT_SIZE3_T   cva_sync_repeat_size3;           // 0x01a0
	H14A0_CVA_SYNC_REPEAT_SIZE4_T   cva_sync_repeat_size4;           // 0x01a4
	H14A0_CVA_SYNC_REPEAT_SIZE5_T   cva_sync_repeat_size5;           // 0x01a8
	H14A0_CVA_DIG_FILT_CTRL4_T      cva_dig_filt_ctrl4;              // 0x01ac
	H14A0_CVA_DIG_FILT_CTRL5_T      cva_dig_filt_ctrl5;              // 0x01b0
	H14A0_CVA_DIG_FILT_CTRL6_T      cva_dig_filt_ctrl6;              // 0x01b4
	UINT32                          reserved1[2];                    // 0x01b8~0x01bc
	H14A0_CVA_SIZE_DETECT_CTRL_T    cva_size_detect_ctrl;            // 0x01c0
	H14A0_CVA_SIZE_DETECT_READ_T    cva_size_detect_read;            // 0x01c4
	H14A0_CVA_SIZE_STATUS0_T        cva_size_status0;                // 0x01c8
	H14A0_CVA_SIZE_STATUS5_T        cva_size_status5;                // 0x01cc
	H14A0_CVA_SIZE_STATUS6_T        cva_size_status6;                // 0x01d0
	H14A0_CVA_SIZE_DETECT_CTRL1_T   cva_size_detect_ctrl1;           // 0x01d4
	H14A0_CVA_SIZE_DETECT_CTRL2_T   cva_size_detect_ctrl2;           // 0x01d8
	H14A0_CVA_PSEUDO_SYNC_CTRL0_T   cva_pseudo_sync_ctrl0;           // 0x01dc
	H14A0_CVA_PSEUDO_SYNC_CTRL1_T   cva_pseudo_sync_ctrl1;           // 0x01e0
	H14A0_CVA_PSEUDO_SYNC_CTRL2_T   cva_pseudo_sync_ctrl2;           // 0x01e4
	H14A0_CVA_PSEUDO_SYNC_CTRL3_T   cva_pseudo_sync_ctrl3;           // 0x01e8
	H14A0_CVA_PSEUDO_SYNC_CTRL4_T   cva_pseudo_sync_ctrl4;           // 0x01ec
	H14A0_CVA_SIZE_DETECT_CTRL3_T   cva_size_detect_ctrl3;           // 0x01f0
} DE_CVA_REG_H14A0_T;

typedef struct {
	H14A0_CVB_TOP_CTRL_T            cvb_top_ctrl;                    // 0x0200
	H14A0_CVB_OFFSET_CTRL_T         cvb_offset_ctrl;                 // 0x0204
	H14A0_CVB_SIZE_CTRL_T           cvb_size_ctrl;                   // 0x0208
	H14A0_CVB_INT_SYNC_CTRL0_T      cvb_int_sync_ctrl0;              // 0x020c
	H14A0_CVB_INT_SYNC_CTRL1_T      cvb_int_sync_ctrl1;              // 0x0210
	H14A0_CVB_DIG_FILT_CTRL0_T      cvb_dig_filt_ctrl0;              // 0x0214
	H14A0_CVB_DIG_FILT_CTRL1_T      cvb_dig_filt_ctrl1;              // 0x0218
	H14A0_CVB_DIG_FILT_CTRL2_T      cvb_dig_filt_ctrl2;              // 0x021c
	H14A0_CVB_DIG_FILT_CTRL3_T      cvb_dig_filt_ctrl3;              // 0x0220
	H14A0_CVB_CSC_CTRL0_T           cvb_csc_ctrl0;                   // 0x0224
	H14A0_CVB_CSC_CTRL1_T           cvb_csc_ctrl1;                   // 0x0228
	H14A0_CVB_CSC_CTRL2_T           cvb_csc_ctrl2;                   // 0x022c
	H14A0_CVB_CSC_CTRL3_T           cvb_csc_ctrl3;                   // 0x0230
	H14A0_CVB_CSC_CTRL4_T           cvb_csc_ctrl4;                   // 0x0234
	H14A0_CVB_CSC_CTRL5_T           cvb_csc_ctrl5;                   // 0x0238
	H14A0_CVB_CSC_CTRL6_T           cvb_csc_ctrl6;                   // 0x023c
	H14A0_CVB_CSC_CTRL7_T           cvb_csc_ctrl7;                   // 0x0240
	H14A0_CVB_MISC_CTRL_T           cvb_misc_ctrl;                   // 0x0244
	H14A0_CVB_OFFSET_READ_T         cvb_offset_read;                 // 0x0248
	H14A0_CVB_PRE3D_CTRL0_T         cvb_pre3d_ctrl0;                 // 0x024c
	H14A0_CVB_PRE3D_CTRL1_T         cvb_pre3d_ctrl1;                 // 0x0250
	H14A0_CVB_PRE3D_CTRL2_T         cvb_pre3d_ctrl2;                 // 0x0254
	H14A0_CVB_SIZE_STATUS1_T        cvb_size_status1;                // 0x0258
	H14A0_CVB_SIZE_STATUS2_T        cvb_size_status2;                // 0x025c
	H14A0_CVB_SIZE_STATUS3_T        cvb_size_status3;                // 0x0260
	H14A0_CVB_SIZE_STATUS4_T        cvb_size_status4;                // 0x0264
	H14A0_CVB_PIX_SUM_CTRL0_T       cvb_pix_sum_ctrl0;               // 0x0268
	H14A0_CVB_PIX_SUM_CTRL1_T       cvb_pix_sum_ctrl1;               // 0x026c
	H14A0_CVB_PIX_SUM_STATUS0_T     cvb_pix_sum_status0;             // 0x0270
	H14A0_CVB_PIX_SUM_STATUS1_T     cvb_pix_sum_status1;             // 0x0274
	H14A0_CVB_PIX_SUM_STATUS2_T     cvb_pix_sum_status2;             // 0x0278
	H14A0_CVB_SYNC_FIL_CTRL_T       cvb_sync_fil_ctrl;               // 0x027c
	H14A0_CVB_SYNC_FIL_STATUS_T     cvb_sync_fil_status;             // 0x0280
	H14A0_CVB_CTI_CTRL_T            cvb_cti_ctrl;                    // 0x0284
	UINT32                          reserved2[2];                    // 0x0288~0x028c
	H14A0_CVB_SYNC_REPEAT_CTRL_T    cvb_sync_repeat_ctrl;            // 0x0290
	H14A0_CVB_SYNC_REPEAT_SIZE0_T   cvb_sync_repeat_size0;           // 0x0294
	H14A0_CVB_SYNC_REPEAT_SIZE1_T   cvb_sync_repeat_size1;           // 0x0298
	H14A0_CVB_SYNC_REPEAT_SIZE2_T   cvb_sync_repeat_size2;           // 0x029c
	H14A0_CVB_SYNC_REPEAT_SIZE3_T   cvb_sync_repeat_size3;           // 0x02a0
	H14A0_CVB_SYNC_REPEAT_SIZE4_T   cvb_sync_repeat_size4;           // 0x02a4
	H14A0_CVB_SYNC_REPEAT_SIZE5_T   cvb_sync_repeat_size5;           // 0x02a8
	H14A0_CVB_DIG_FILT_CTRL4_T      cvb_dig_filt_ctrl4;              // 0x02ac
	H14A0_CVB_DIG_FILT_CTRL5_T      cvb_dig_filt_ctrl5;              // 0x02b0
	H14A0_CVB_DIG_FILT_CTRL6_T      cvb_dig_filt_ctrl6;              // 0x02b4
	UINT32                          reserved3[2];                    // 0x02b8~0x02bc
	H14A0_CVB_SIZE_DETECT_CTRL_T    cvb_size_detect_ctrl;            // 0x02c0
	H14A0_CVB_SIZE_DETECT_READ_T    cvb_size_detect_read;            // 0x02c4
	H14A0_CVB_SIZE_STATUS0_T        cvb_size_status0;                // 0x02c8
	H14A0_CVB_SIZE_STATUS5_T        cvb_size_status5;                // 0x02cc
	H14A0_CVB_SIZE_STATUS6_T        cvb_size_status6;                // 0x02d0
	H14A0_CVB_SIZE_DETECT_CTRL1_T   cvb_size_detect_ctrl1;           // 0x02d4
	H14A0_CVB_SIZE_DETECT_CTRL2_T   cvb_size_detect_ctrl2;           // 0x02d8
	H14A0_CVB_PSEUDO_SYNC_CTRL0_T   cvb_pseudo_sync_ctrl0;           // 0x02dc
	H14A0_CVB_PSEUDO_SYNC_CTRL1_T   cvb_pseudo_sync_ctrl1;           // 0x02e0
	H14A0_CVB_PSEUDO_SYNC_CTRL2_T   cvb_pseudo_sync_ctrl2;           // 0x02e4
	H14A0_CVB_PSEUDO_SYNC_CTRL3_T   cvb_pseudo_sync_ctrl3;           // 0x02e8
	H14A0_CVB_PSEUDO_SYNC_CTRL4_T   cvb_pseudo_sync_ctrl4;           // 0x02ec
	H14A0_CVB_SIZE_DETECT_CTRL3_T   cvb_size_detect_ctrl3;           // 0x02f0
} DE_CVB_REG_H14A0_T;
