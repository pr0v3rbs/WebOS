...
#ifdef VDEC_USE_MCU
static MMCU_LOCK_T					*gpstApbMcuLock;
#endif
...
#ifdef VDEC_USE_MCU
	gpstApbMcuLock = mcu_lock_open("vdo_lock");
#endif
...
{
// LQ is no using block in h15 project
/*
