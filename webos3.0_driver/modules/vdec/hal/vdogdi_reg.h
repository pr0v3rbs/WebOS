...
#define VDEC_VDO_GDI_BASE	(VDEC_BASE + 0x1200)
...
/////////////////////////////////////////////////////////
#define VDO_GDI_INFO_CONTROL(frame_num)  (*(volatile UINT32 *)(stpVdoGdiReg + frame_num*20 + 0x000)) // 0x400
#define VDO_GDI_INFO_PIC_SIZE(frame_num) (*(volatile UINT32 *)(stpVdoGdiReg + frame_num*20 + 0x004)) // 0x400
#define VDO_GDI_INFO_BASE_Y(frame_num)   (*(volatile UINT32 *)(stpVdoGdiReg + frame_num*20 + 0x008)) // 0x400
#define VDO_GDI_INFO_BASE_CB(frame_num)  (*(volatile UINT32 *)(stpVdoGdiReg + frame_num*20 + 0x00C)) // 0x400
#define VDO_GDI_INFO_BASE_CR(frame_num)  (*(volatile UINT32 *)(stpVdoGdiReg + frame_num*20 + 0x010)) // 0x400
