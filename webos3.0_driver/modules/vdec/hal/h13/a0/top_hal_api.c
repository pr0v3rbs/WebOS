...
{
	stpRC0_Reg		= (volatile RC0_REG_T *)VDEC_TranselateVirualAddr(VDEC_REG_RC0_BASE, 0x100);
	stpRC1_Reg		= (volatile RC1_REG_T *)VDEC_TranselateVirualAddr(VDEC_REG_RC1_BASE, 0x100);
...
void TOP_HAL_SetLQSyncMode(UINT8 ui8LQCh, UINT8 ui8sync)
{
	...
	{
	case 0:
		RC0_Wr01(lq_in_conf, reg_lqc0_sync_mode, ui8sync&0x3);
		break;
	case 1:
		RC0_Wr01(lq_in_conf, reg_lqc1_sync_mode, ui8sync&0x3);
		break;
	case 2:
		RC0_Wr01(lq_in_conf, reg_lqc2_sync_mode, ui8sync&0x3);
		break;
	case 3:
		RC0_Wr01(lq_in_conf, reg_lqc3_sync_mode, ui8sync&0x3);
		break;
	}
	RC0_WrFL(lq_in_conf);
}
