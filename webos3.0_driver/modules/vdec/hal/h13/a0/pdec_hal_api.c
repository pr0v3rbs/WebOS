...
void PDEC_HAL_Init(void)
{
	...
	{
		gsPdecHal[ui8PdecCh].stpReg = (volatile PDEC_REG_T *)VDEC_TranselateVirualAddr(PDEC_BASE(ui8PdecCh), 0x100);
...
static void _PDEC_UTIL_AUI_Parse(UINT32 *pui32PdecAuiVirPtr, S_PDEC_AUI_T *pPdecAui)
{
	...
	pPdecAui->ui32DTS = pui32PdecAuiVirPtr[1] & 0x7FFFFFFF;
	pPdecAui->ui32PTS = pui32PdecAuiVirPtr[2] & 0x7FFFFFFF;
