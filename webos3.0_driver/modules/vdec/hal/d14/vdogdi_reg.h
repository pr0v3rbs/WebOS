...
static UINT32 vdogdi_reg_offset[2] = {0x00, 0x1000}; 
...
/////////////////////////////////////////////////////////
#define VDO_GDI_PRI_RD_PRIO_L(i)            (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x000))
#define VDO_GDI_PRI_RD_PRIO_H(i)            (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x004))

#define VDO_GDI_PRI_RD_LOCK_CNT(i)          (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x010))

#define VDO_GDI_PIC_INIT_HOST(i)            (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x038))

#define VDO_GDI_CONFIG_REPORT_0(i)          (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x040))
#define VDO_GDI_CONFIG_REPORT_1(i)          (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x044))
#define VDO_GDI_CONFIG_REPORT_2(i)          (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x048))
#define VDO_GDI_CONFIG_REPORT_3(i)          (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x04C))

#define VDO_GDI_CONFIG_REPORT_4(i)          (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x050))
#define VDO_GDI_CONFIG_REPORT_5(i)          (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x054))
#define VDO_GDI_CONFIG_REPORT_6(i)          (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x058))
#define VDO_GDI_CONFIG_REPORT_7(i)          (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x05C))

#define VDO_GDI_PINFO_REQ(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x060))
#define VDO_GDI_PINFO_ACK(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x064))
#define VDO_GDI_PINFO_ADDR(i)               (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x068))
#define VDO_GDI_PINFO_DATA(i)               (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x06C))

/////////////////////////////////////////////////////////
// Must set RC0 APB_CONF register
// reg_apb_vdo_offset [31:29] = 0x4
/////////////////////////////////////////////////////////
#define VDO_GDI_INFO_CONTROL(frame_num,i)  	(*(volatile UINT32 *)(stpVdoGdiReg + frame_num*0x20 + vdogdi_reg_offset[i] + 0x400)) // 0x400
#define VDO_GDI_INFO_PIC_SIZE(frame_num,i) 	(*(volatile UINT32 *)(stpVdoGdiReg + frame_num*0x20 + vdogdi_reg_offset[i] + 0x404)) // 0x400
#define VDO_GDI_INFO_BASE_Y(frame_num,i)   	(*(volatile UINT32 *)(stpVdoGdiReg + frame_num*0x20 + vdogdi_reg_offset[i] + 0x408)) // 0x400
#define VDO_GDI_INFO_BASE_CB(frame_num,i)  	(*(volatile UINT32 *)(stpVdoGdiReg + frame_num*0x20 + vdogdi_reg_offset[i] + 0x40C)) // 0x400
#define VDO_GDI_INFO_BASE_CR(frame_num,i) 	(*(volatile UINT32 *)(stpVdoGdiReg + frame_num*0x20 + vdogdi_reg_offset[i] + 0x410)) // 0x400
#define VDO_GDI_INFO_BASE_Y_BOT(frame_num,i)   (*(volatile UINT32 *)(stpVdoGdiReg + frame_num*0x20 + vdogdi_reg_offset[i] + 0x414)) // 0x400
#define VDO_GDI_INFO_BASE_CB_BOT(frame_num,i)  (*(volatile UINT32 *)(stpVdoGdiReg + frame_num*0x20 + vdogdi_reg_offset[i] + 0x418)) // 0x400
#define VDO_GDI_INFO_BASE_CR_BOT(frame_num,i)  (*(volatile UINT32 *)(stpVdoGdiReg + frame_num*0x20 + vdogdi_reg_offset[i] + 0x41C)) // 0x400
...
// D13 VDO GDI
#define VDO_GDI_CH0_XY2_AXI_LUM_00(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x800))  //800
#define VDO_GDI_CH0_XY2_AXI_LUM_01(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x804))  //800
#define VDO_GDI_CH0_XY2_AXI_LUM_02(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x808))  //800
#define VDO_GDI_CH0_XY2_AXI_LUM_03(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x80C))  //800
#define VDO_GDI_CH0_XY2_AXI_LUM_04(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x810))  //800
#define VDO_GDI_CH0_XY2_AXI_LUM_05(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x814))  //800
#define VDO_GDI_CH0_XY2_AXI_LUM_06(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x818))  //800
#define VDO_GDI_CH0_XY2_AXI_LUM_07(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x81C))  //800
#define VDO_GDI_CH0_XY2_AXI_LUM_08(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x820))  //800
#define VDO_GDI_CH0_XY2_AXI_LUM_09(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x824))  //800
#define VDO_GDI_CH0_XY2_AXI_LUM_0A(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x828))  //800
#define VDO_GDI_CH0_XY2_AXI_LUM_0B(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x82C))  //800
#define VDO_GDI_CH0_XY2_AXI_LUM_0C(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x830))  //800
#define VDO_GDI_CH0_XY2_AXI_LUM_0D(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x834))  //800
#define VDO_GDI_CH0_XY2_AXI_LUM_0E(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x838))  //800
#define VDO_GDI_CH0_XY2_AXI_LUM_0F(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x83C))  //800
#define VDO_GDI_CH0_XY2_AXI_LUM_10(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x840))  //800
#define VDO_GDI_CH0_XY2_AXI_LUM_11(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x844))  //800
#define VDO_GDI_CH0_XY2_AXI_LUM_12(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x848))  //800
#define VDO_GDI_CH0_XY2_AXI_LUM_13(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x84C))  //800
#define VDO_GDI_CH0_XY2_AXI_LUM_14(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x850))  //800
#define VDO_GDI_CH0_XY2_AXI_LUM_15(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x854))  //800
#define VDO_GDI_CH0_XY2_AXI_LUM_16(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x858))  //800
#define VDO_GDI_CH0_XY2_AXI_LUM_17(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x85C))  //800
#define VDO_GDI_CH0_XY2_AXI_LUM_18(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x860))  //800
#define VDO_GDI_CH0_XY2_AXI_LUM_19(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x864))  //800
#define VDO_GDI_CH0_XY2_AXI_LUM_1A(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x868))  //800
#define VDO_GDI_CH0_XY2_AXI_LUM_1B(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x86C))  //800
#define VDO_GDI_CH0_XY2_AXI_LUM_1C(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x870))  //800
#define VDO_GDI_CH0_XY2_AXI_LUM_1D(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x874))  //800
#define VDO_GDI_CH0_XY2_AXI_LUM_1E(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x878))  //800
#define VDO_GDI_CH0_XY2_AXI_LUM_1F(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x87C))  //800

#define VDO_GDI_CH0_XY2_AXI_CHR_00(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x880))  //800
#define VDO_GDI_CH0_XY2_AXI_CHR_01(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x884))  //800
#define VDO_GDI_CH0_XY2_AXI_CHR_02(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x888))  //800
#define VDO_GDI_CH0_XY2_AXI_CHR_03(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x88C))  //800
#define VDO_GDI_CH0_XY2_AXI_CHR_04(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x890))  //800
#define VDO_GDI_CH0_XY2_AXI_CHR_05(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x894))  //800
#define VDO_GDI_CH0_XY2_AXI_CHR_06(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x898))  //800
#define VDO_GDI_CH0_XY2_AXI_CHR_07(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x89C))  //800
#define VDO_GDI_CH0_XY2_AXI_CHR_08(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x8A0))  //800
#define VDO_GDI_CH0_XY2_AXI_CHR_09(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x8A4))  //800
#define VDO_GDI_CH0_XY2_AXI_CHR_0A(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x8A8))  //800
#define VDO_GDI_CH0_XY2_AXI_CHR_0B(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x8AC))  //800
#define VDO_GDI_CH0_XY2_AXI_CHR_0C(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x8B0))  //800
#define VDO_GDI_CH0_XY2_AXI_CHR_0D(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x8B4))  //800
#define VDO_GDI_CH0_XY2_AXI_CHR_0E(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x8B8))  //800
#define VDO_GDI_CH0_XY2_AXI_CHR_0F(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x8BC))  //800
#define VDO_GDI_CH0_XY2_AXI_CHR_10(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x8C0))  //800
#define VDO_GDI_CH0_XY2_AXI_CHR_11(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x8C4))  //800
#define VDO_GDI_CH0_XY2_AXI_CHR_12(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x8C8))  //800
#define VDO_GDI_CH0_XY2_AXI_CHR_13(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x8CC))  //800
#define VDO_GDI_CH0_XY2_AXI_CHR_14(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x8D0))  //800
#define VDO_GDI_CH0_XY2_AXI_CHR_15(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x8D4))  //800
#define VDO_GDI_CH0_XY2_AXI_CHR_16(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x8D8))  //800
#define VDO_GDI_CH0_XY2_AXI_CHR_17(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x8DC))  //800
#define VDO_GDI_CH0_XY2_AXI_CHR_18(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x8E0))  //800
#define VDO_GDI_CH0_XY2_AXI_CHR_19(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x8E4))  //800
#define VDO_GDI_CH0_XY2_AXI_CHR_1A(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x8E8))  //800
#define VDO_GDI_CH0_XY2_AXI_CHR_1B(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x8EC))  //800
#define VDO_GDI_CH0_XY2_AXI_CHR_1C(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x8F0))  //800
#define VDO_GDI_CH0_XY2_AXI_CHR_1D(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x8F4))  //800
#define VDO_GDI_CH0_XY2_AXI_CHR_1E(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x8F8))  //800
#define VDO_GDI_CH0_XY2_AXI_CHR_1F(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x8FC))  //800

#define VDO_GDI_CH0_XY2_AXI_CONFIG(i)           	  (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0x900))  //900
/* Reserved */
#define VDO_GDI_CH1_XY2_AXI_LUM_00(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xA00))  //A00
#define VDO_GDI_CH1_XY2_AXI_LUM_01(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xA04))  //A00
#define VDO_GDI_CH1_XY2_AXI_LUM_02(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xA08))  //A00
#define VDO_GDI_CH1_XY2_AXI_LUM_03(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xA0C))  //A00
#define VDO_GDI_CH1_XY2_AXI_LUM_04(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xA10))  //A00
#define VDO_GDI_CH1_XY2_AXI_LUM_05(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xA14))  //A00
#define VDO_GDI_CH1_XY2_AXI_LUM_06(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xA18))  //A00
#define VDO_GDI_CH1_XY2_AXI_LUM_07(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xA1C))  //A00
#define VDO_GDI_CH1_XY2_AXI_LUM_08(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xA20))  //A00
#define VDO_GDI_CH1_XY2_AXI_LUM_09(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xA24))  //A00
#define VDO_GDI_CH1_XY2_AXI_LUM_0A(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xA28))  //A00
#define VDO_GDI_CH1_XY2_AXI_LUM_0B(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xA2C))  //A00
#define VDO_GDI_CH1_XY2_AXI_LUM_0C(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xA30))  //A00
#define VDO_GDI_CH1_XY2_AXI_LUM_0D(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xA34))  //A00
#define VDO_GDI_CH1_XY2_AXI_LUM_0E(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xA38))  //A00
#define VDO_GDI_CH1_XY2_AXI_LUM_0F(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xA3C))  //A00
#define VDO_GDI_CH1_XY2_AXI_LUM_10(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xA40))  //A00
#define VDO_GDI_CH1_XY2_AXI_LUM_11(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xA44))  //A00
#define VDO_GDI_CH1_XY2_AXI_LUM_12(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xA48))  //A00
#define VDO_GDI_CH1_XY2_AXI_LUM_13(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xA4C))  //A00
#define VDO_GDI_CH1_XY2_AXI_LUM_14(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xA50))  //A00
#define VDO_GDI_CH1_XY2_AXI_LUM_15(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xA54))  //A00
#define VDO_GDI_CH1_XY2_AXI_LUM_16(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xA58))  //A00
#define VDO_GDI_CH1_XY2_AXI_LUM_17(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xA5C))  //A00
#define VDO_GDI_CH1_XY2_AXI_LUM_18(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xA60))  //A00
#define VDO_GDI_CH1_XY2_AXI_LUM_19(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xA64))  //A00
#define VDO_GDI_CH1_XY2_AXI_LUM_1A(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xA68))  //A00
#define VDO_GDI_CH1_XY2_AXI_LUM_1B(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xA6C))  //A00
#define VDO_GDI_CH1_XY2_AXI_LUM_1C(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xA70))  //A00
#define VDO_GDI_CH1_XY2_AXI_LUM_1D(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xA74))  //A00
#define VDO_GDI_CH1_XY2_AXI_LUM_1E(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xA78))  //A00
#define VDO_GDI_CH1_XY2_AXI_LUM_1F(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xA7C))  //A00

#define VDO_GDI_CH1_XY2_AXI_CHR_00(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xA80))  //A00
#define VDO_GDI_CH1_XY2_AXI_CHR_01(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xA84))  //A00
#define VDO_GDI_CH1_XY2_AXI_CHR_02(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xA88))  //A00
#define VDO_GDI_CH1_XY2_AXI_CHR_03(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xA8C))  //A00
#define VDO_GDI_CH1_XY2_AXI_CHR_04(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xA90))  //A00
#define VDO_GDI_CH1_XY2_AXI_CHR_05(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xA94))  //A00
#define VDO_GDI_CH1_XY2_AXI_CHR_06(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xA98))  //A00
#define VDO_GDI_CH1_XY2_AXI_CHR_07(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xA9C))  //A00
#define VDO_GDI_CH1_XY2_AXI_CHR_08(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xAA0))  //A00
#define VDO_GDI_CH1_XY2_AXI_CHR_09(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xAA4))  //A00
#define VDO_GDI_CH1_XY2_AXI_CHR_0A(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xAA8))  //A00
#define VDO_GDI_CH1_XY2_AXI_CHR_0B(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xAAC))  //A00
#define VDO_GDI_CH1_XY2_AXI_CHR_0C(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xAB0))  //A00
#define VDO_GDI_CH1_XY2_AXI_CHR_0D(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xAB4))  //A00
#define VDO_GDI_CH1_XY2_AXI_CHR_0E(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xAB8))  //A00
#define VDO_GDI_CH1_XY2_AXI_CHR_0F(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xABC))  //A00
#define VDO_GDI_CH1_XY2_AXI_CHR_10(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xAC0))  //A00
#define VDO_GDI_CH1_XY2_AXI_CHR_11(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xAC4))  //A00
#define VDO_GDI_CH1_XY2_AXI_CHR_12(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xAC8))  //A00
#define VDO_GDI_CH1_XY2_AXI_CHR_13(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xACC))  //A00
#define VDO_GDI_CH1_XY2_AXI_CHR_14(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xAD0))  //A00
#define VDO_GDI_CH1_XY2_AXI_CHR_15(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xAD4))  //A00
#define VDO_GDI_CH1_XY2_AXI_CHR_16(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xAD8))  //A00
#define VDO_GDI_CH1_XY2_AXI_CHR_17(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xADC))  //A00
#define VDO_GDI_CH1_XY2_AXI_CHR_18(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xAE0))  //A00
#define VDO_GDI_CH1_XY2_AXI_CHR_19(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xAE4))  //A00
#define VDO_GDI_CH1_XY2_AXI_CHR_1A(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xAE8))  //A00
#define VDO_GDI_CH1_XY2_AXI_CHR_1B(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xAEC))  //A00
#define VDO_GDI_CH1_XY2_AXI_CHR_1C(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xAF0))  //A00
#define VDO_GDI_CH1_XY2_AXI_CHR_1D(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xAF4))  //A00
#define VDO_GDI_CH1_XY2_AXI_CHR_1E(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xAF8))  //A00
#define VDO_GDI_CH1_XY2_AXI_CHR_1F(i)                (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xAFC))  //A00

#define VDO_GDI_CH1_XY2_AXI_CONFIG(i)           	  (*(volatile UINT32 *)(stpVdoGdiReg + vdogdi_reg_offset[i] + 0xB00))  //B00
