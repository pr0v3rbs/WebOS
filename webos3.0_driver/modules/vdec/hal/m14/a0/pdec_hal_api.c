...
void PDEC_HAL_SetVideoStandard(UINT8 ui8PdecCh, UINT8 ui8Vcodec)
{
	...
	// Workaround for AVS+
	if( ui8Vcodec == PDEC_CODEC_AVS ) {	// 5
		gsPdecHal[ui8PdecCh].stpReg->reg_aux_mode |= 0x00400000;
		gsPdecHal[ui8PdecCh].stpReg->reg_udef_scd0.reg_udef_scd0 = 0x000001B6;
		gsPdecHal[ui8PdecCh].stpReg->reg_udef_scd_num.reg_udef_scd0 = 4;
	}
}
...
{
	if( vdec_chip_rev() >= VDEC_CHIP_REV( M14, B0 ))
	{
